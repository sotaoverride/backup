...
#define HAVE_cmpsi2_addneg                                                     \
    (TARGET_32BIT && (INTVAL(operands[2]) ==                                   \
...
#define HAVE_andsi_not_shiftsi_si_scc                                          \
    (TARGET_ARM || (TARGET_THUMB2 && CONST_INT_P(operands[2])))
...
#define HAVE_no_literal_pool_df_immediate                                      \
    (arm_disable_literal_pool && TARGET_HARD_FLOAT &&                          \
...
#define HAVE_mulv8qi3addv8qi_neon                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv16qi3addv16qi_neon                                            \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv4hi3addv4hi_neon                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv8hi3addv8hi_neon                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv2si3addv2si_neon                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv4si3addv4si_neon                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv2sf3addv2sf_neon                                              \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_mulv4sf3addv4sf_neon                                              \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_mulv8hf3addv8hf_neon                                              \
    (TARGET_NEON_FP16INST && (!true || flag_unsafe_math_optimizations))
#define HAVE_mulv4hf3addv4hf_neon                                              \
    (TARGET_NEON_FP16INST && (!true || flag_unsafe_math_optimizations))
#define HAVE_mulv8qi3negv8qiaddv8qi_neon                                       \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv16qi3negv16qiaddv16qi_neon                                    \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv4hi3negv4hiaddv4hi_neon                                       \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv8hi3negv8hiaddv8hi_neon                                       \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv2si3negv2siaddv2si_neon                                       \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv4si3negv4siaddv4si_neon                                       \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_mulv2sf3negv2sfaddv2sf_neon                                       \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_mulv4sf3negv4sfaddv4sf_neon                                       \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_fmav2sf4                                                          \
    (TARGET_NEON && TARGET_FMA && flag_unsafe_math_optimizations)
#define HAVE_fmav4sf4                                                          \
    (TARGET_NEON && TARGET_FMA && flag_unsafe_math_optimizations)
...
#define HAVE_ashrdi3_neon_imm_noclobber                                        \
    (TARGET_NEON && reload_completed && INTVAL(operands[2]) > 0 &&             \
...
#define HAVE_quad_halves_plusv4sf                                              \
    (TARGET_NEON && flag_unsafe_math_optimizations)
#define HAVE_quad_halves_sminv4sf                                              \
    (TARGET_NEON && flag_unsafe_math_optimizations)
#define HAVE_quad_halves_smaxv4sf                                              \
    (TARGET_NEON && flag_unsafe_math_optimizations)
...
#define HAVE_neon_vcagtv8hf_fp16insn                                           \
    (TARGET_NEON_FP16INST && flag_unsafe_math_optimizations)
#define HAVE_neon_vcagev8hf_fp16insn                                           \
    (TARGET_NEON_FP16INST && flag_unsafe_math_optimizations)
#define HAVE_neon_vcaltv8hf_fp16insn                                           \
    (TARGET_NEON_FP16INST && flag_unsafe_math_optimizations)
#define HAVE_neon_vcalev8hf_fp16insn                                           \
    (TARGET_NEON_FP16INST && flag_unsafe_math_optimizations)
#define HAVE_neon_vcagtv4hf_fp16insn                                           \
    (TARGET_NEON_FP16INST && flag_unsafe_math_optimizations)
#define HAVE_neon_vcagev4hf_fp16insn                                           \
    (TARGET_NEON_FP16INST && flag_unsafe_math_optimizations)
#define HAVE_neon_vcaltv4hf_fp16insn                                           \
    (TARGET_NEON_FP16INST && flag_unsafe_math_optimizations)
#define HAVE_neon_vcalev4hf_fp16insn                                           \
    (TARGET_NEON_FP16INST && flag_unsafe_math_optimizations)
...
#define HAVE_atomic_compare_and_swapt1di_1                                     \
    ((TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER) && (TARGET_THUMB1))
#define HAVE_atomic_exchangeqi                                                 \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_exchangehi                                                 \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_atomic_adddi                                                      \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_subdi                                                      \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_ordi                                                       \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_xordi                                                      \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_anddi                                                      \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_atomic_nanddi                                                     \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_addqi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_subqi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_orqi                                                 \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_xorqi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_andqi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_addhi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_subhi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_orhi                                                 \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_xorhi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_andhi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_addsi                                                \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_subsi                                                \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_orsi (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_xorsi                                                \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_andsi                                                \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_atomic_fetch_anddi                                                \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_nandqi                                               \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_nandhi                                               \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_nandsi                                               \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_nanddi                                               \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_add_fetchqi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_sub_fetchqi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_or_fetchqi                                                 \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_xor_fetchqi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_and_fetchqi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_add_fetchhi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_sub_fetchhi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_or_fetchhi                                                 \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_xor_fetchhi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_and_fetchhi                                                \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_add_fetchsi                                                \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_sub_fetchsi                                                \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_or_fetchsi (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_xor_fetchsi                                                \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_and_fetchsi                                                \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_atomic_and_fetchdi                                                \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_nand_fetchqi                                               \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_nand_fetchhi                                               \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_nand_fetchsi                                               \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_arm_load_acquire_exclusivedi                                      \
    (TARGET_HAVE_LDACQEXD && ARM_DOUBLEWORD_ALIGN)
#define HAVE_arm_store_exclusiveqi                                             \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_arm_store_exclusivehi                                             \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_arm_store_exclusivesi                                             \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_arm_store_exclusivedi                                             \
    (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_arm_store_release_exclusivedi                                     \
    (TARGET_HAVE_LDACQEXD && ARM_DOUBLEWORD_ALIGN)
...
#define HAVE_fix_truncdfsi2                                                    \
    (TARGET_32BIT && TARGET_HARD_FLOAT && !TARGET_VFP_SINGLE)
#define HAVE_truncdfsf2                                                        \
    (TARGET_32BIT && TARGET_HARD_FLOAT && !TARGET_VFP_SINGLE)
...
#define HAVE_movv2di                                                           \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2DImode)))
#define HAVE_movv2si                                                           \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_movv4hi                                                           \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_movv8qi                                                           \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_movv2sf                                                           \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SFmode)))
#define HAVE_movv4si                                                           \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_movv8hi                                                           \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_movv16qi                                                          \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
#define HAVE_movv4sf                                                           \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SFmode)))
...
#define HAVE_sminv4sf3                                                         \
    ((TARGET_NEON && ((V4SFmode != V2SFmode && V4SFmode != V4SFmode) ||        \
                      flag_unsafe_math_optimizations)) ||                      \
     (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SFmode)))
#define HAVE_uminv2si3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_uminv4hi3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_uminv8qi3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_uminv4si3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_uminv8hi3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
...
#define HAVE_smaxv4sf3                                                         \
    ((TARGET_NEON && ((V4SFmode != V2SFmode && V4SFmode != V4SFmode) ||        \
                      flag_unsafe_math_optimizations)) ||                      \
     (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SFmode)))
#define HAVE_umaxv2si3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_umaxv4hi3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_umaxv8qi3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_umaxv4si3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_umaxv8hi3                                                         \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_umaxv16qi3                                                        \
    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
...
#define HAVE_movmisalignv8qi                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv16qi                                                  \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv4hi                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv8hi                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv2si                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv4si                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv4hf                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv8hf                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv2sf                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv4sf                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisaligndi                                                     \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
#define HAVE_movmisalignv2di                                                   \
    (TARGET_NEON && !BYTES_BIG_ENDIAN && unaligned_access)
...
#define HAVE_reduc_plus_scal_v8qi                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_plus_scal_v4hi                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_plus_scal_v2si                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_plus_scal_v2sf                                              \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
...
#define HAVE_reduc_smin_scal_v8qi                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_smin_scal_v4hi                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_smin_scal_v2si                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_smin_scal_v2sf                                              \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
...
#define HAVE_reduc_smin_scal_v4sf                                              \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations) &&               \
     !BYTES_BIG_ENDIAN)
#define HAVE_reduc_smax_scal_v8qi                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_smax_scal_v4hi                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_smax_scal_v2si                                              \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_reduc_smax_scal_v2sf                                              \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
...
#define HAVE_vcondv8qiv8qi                                                     \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_vcondv16qiv16qi                                                   \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_vcondv4hiv4hi                                                     \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_vcondv8hiv8hi                                                     \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_vcondv2siv2si                                                     \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_vcondv4siv4si                                                     \
    (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_vcondv2sfv2sf                                                     \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_vcondv4sfv4sf                                                     \
    (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
...
#define HAVE_atomic_compare_and_swapqi                                         \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_compare_and_swaphi                                         \
    (TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_compare_and_swapsi                                         \
    (TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER)
...
static inline rtx gen_pic_offset_arm(rtx ARG_UNUSED(a), rtx ARG_UNUSED(b),
                                     rtx ARG_UNUSED(c))
{
    return 0;
}
...
extern rtx gen_atomic_compare_and_swap32qi_1(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                             rtx);
extern rtx gen_atomic_compare_and_swap32hi_1(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                             rtx);
extern rtx gen_atomic_compare_and_swapt1qi_1(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                             rtx);
extern rtx gen_atomic_compare_and_swapt1hi_1(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                             rtx);
extern rtx gen_atomic_compare_and_swap32si_1(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                             rtx);
extern rtx gen_atomic_compare_and_swap32di_1(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                             rtx);
extern rtx gen_atomic_compare_and_swapt1si_1(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                             rtx);
extern rtx gen_atomic_compare_and_swapt1di_1(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                             rtx);
...
extern rtx gen_atomic_compare_and_swapqi(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                         rtx);
extern rtx gen_atomic_compare_and_swaphi(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                         rtx);
extern rtx gen_atomic_compare_and_swapsi(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                         rtx);
extern rtx gen_atomic_compare_and_swapdi(rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                         rtx);
