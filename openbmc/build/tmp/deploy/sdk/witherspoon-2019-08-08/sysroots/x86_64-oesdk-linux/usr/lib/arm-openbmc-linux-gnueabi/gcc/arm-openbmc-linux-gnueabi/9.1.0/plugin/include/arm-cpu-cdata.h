...
static const cpu_alias cpu_aliastab_strongarm[] = {{"strongarm110", true},
                                                   {"strongarm1100", false},
                                                   {"strongarm1110", false},
                                                   {NULL, false}};

static const cpu_alias cpu_aliastab_arm7tdmi[] = {{"arm7tdmi-s", true},
                                                  {NULL, false}};

static const cpu_alias cpu_aliastab_arm710t[] = {
    {"arm720t", true}, {"arm740t", true}, {NULL, false}};

static const cpu_alias cpu_aliastab_arm920t[] = {{"arm920", true},
                                                 {"arm922t", true},
                                                 {"arm940t", true},
                                                 {"ep9312", true},
                                                 {NULL, false}};

static const cpu_alias cpu_aliastab_arm10tdmi[] = {{"arm1020t", true},
                                                   {NULL, false}};
...
static const cpu_arch_extension cpu_opttab_arm9e[] = {
    {"nofp",
     ...
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_fp16,
      isa_bit_crypto, isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4,
      isa_bit_neon, isa_nobit}},
    {NULL, false, false, {isa_nobit}}};

static const cpu_alias cpu_aliastab_arm9e[] = {{"arm946e-s", true},
                                               {"arm966e-s", true},
                                               {"arm968e-s", true},
                                               {NULL, false}};
...
static const cpu_alias cpu_aliastab_arm10e[] = {
    {"arm1020e", true}, {"arm1022e", true}, {NULL, false}};
...
static const cpu_arch_extension cpu_opttab_genericv7a[] = {
    {"mp", false, false, {isa_bit_mp, isa_nobit}},
    {"sec", false, false, {isa_bit_sec, isa_nobit}},
    {"vfpv3-d16",
     false,
     false,
    ...
    {"vfpv3",
     false,
     false,
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
    {"vfpv3-d16-fp16",
     false,
     false,
...
static const cpu_arch_extension cpu_opttab_cortexr5[] = {
    {"nofp.dp", true, false, {isa_bit_fp_dbl, isa_nobit}},
    {"nofp",
     true,
     false,
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_fp16,
...
static const cpu_arch_extension cpu_opttab_cortexa32[] = {
    {"crypto",
     ...
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_crypto,
      isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4, isa_bit_neon,
      isa_nobit}},
    {"nofp",
     true,
     false,
...
static const cpu_alias cpu_aliastab_neoversen1[] = {{"ares", false},
                                                    {NULL, false}};
...
static const cpu_arch_extension cpu_opttab_cortexm33[] = {
    {"nofp",
     ...
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_fp16,
      isa_bit_crypto, isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4,
      isa_bit_neon, isa_nobit}},
    {"nodsp", true, false, {isa_bit_armv7em, isa_nobit}},
    {NULL, false, false, {isa_nobit}}};
...
const cpu_option all_cores[] = {
    {{"arm8", NULL, {isa_bit_notm, isa_bit_armv4, isa_nobit}},
     NULL,
     TARGET_ARCH_armv4},
    {{"arm810", NULL, {isa_bit_notm, isa_bit_armv4, isa_nobit}},
     NULL,
     TARGET_ARCH_armv4},
    {{"strongarm", NULL, {isa_bit_notm, isa_bit_armv4, isa_nobit}},
     cpu_aliastab_strongarm,
     TARGET_ARCH_armv4},
    {{"fa526", NULL, {isa_bit_notm, isa_bit_armv4, isa_nobit}},
     NULL,
     TARGET_ARCH_armv4},
    {{"fa626", NULL, {isa_bit_notm, isa_bit_armv4, isa_nobit}},
     NULL,
     TARGET_ARCH_armv4},
    {{"arm7tdmi",
      NULL,
     ...
     TARGET_ARCH_armv4t},
    {{"arm710t", NULL, {isa_bit_notm, isa_bit_armv4, isa_bit_thumb, isa_nobit}},
     cpu_aliastab_arm710t,
     TARGET_ARCH_armv4t},
    {{"arm9", NULL, {isa_bit_notm, isa_bit_armv4, isa_bit_thumb, isa_nobit}},
     NULL,
     TARGET_ARCH_armv4t},
    {{"arm9tdmi",
      NULL,
     ...
     NULL,
     TARGET_ARCH_armv4t},
    {{"arm920t", NULL, {isa_bit_notm, isa_bit_armv4, isa_bit_thumb, isa_nobit}},
     cpu_aliastab_arm920t,
     TARGET_ARCH_armv4t},
    {{"arm10tdmi",
      NULL,
      {isa_bit_notm, isa_bit_armv4, isa_bit_thumb, isa_bit_armv5t, isa_nobit}},
    ...
    {{"arm1136jf-s",
      NULL,
      {isa_bit_notm, isa_bit_fp_dbl, isa_bit_armv5te, isa_bit_armv4,
       isa_bit_vfpv2, isa_bit_thumb, isa_bit_armv6, isa_bit_armv5t, isa_bit_be8,
       isa_nobit}},
     NULL,
     TARGET_ARCH_armv6j},
    {{"arm1176jz-s",
      ...
      {isa_bit_quirk_armv6kz, isa_bit_notm, isa_bit_armv6k, isa_bit_armv5te,
       isa_bit_armv4, isa_bit_thumb, isa_bit_armv6, isa_bit_armv5t, isa_bit_be8,
       isa_nobit}},
     NULL,
     TARGET_ARCH_armv6kz},
    {{"arm1176jzf-s",
    ...
    {{"mpcorenovfp",
      ...
      {isa_bit_armv6k, isa_bit_notm, isa_bit_armv5te, isa_bit_armv4,
       isa_bit_thumb, isa_bit_armv6, isa_bit_armv5t, isa_bit_be8, isa_nobit}},
     NULL,
     TARGET_ARCH_armv6k},
    {{"mpcore",
      NULL,
    ...
    {{"arm1156t2-s",
      ...
      {isa_bit_notm, isa_bit_armv4, isa_bit_armv5te, isa_bit_thumb,
       isa_bit_armv6, isa_bit_thumb2, isa_bit_armv5t, isa_bit_be8, isa_nobit}},
     NULL,
     TARGET_ARCH_armv6t2},
    {{"arm1156t2f-s",
      NULL,
    ...
    {{"cortex-a5",
      cpu_opttab_cortexa5,
      {isa_bit_mp, isa_bit_fp_d32, isa_bit_armv6k, isa_bit_notm, isa_bit_fp_dbl,
       isa_bit_fp16conv, isa_bit_armv4, isa_bit_armv5te, isa_bit_vfpv2,
       isa_bit_thumb, isa_bit_vfpv3, isa_bit_sec, isa_bit_armv6, isa_bit_thumb2,
       isa_bit_armv7, isa_bit_armv5t, isa_bit_be8, isa_bit_neon, isa_nobit}},
     NULL,
     TARGET_ARCH_armv7_a},
    {{"cortex-a7",
      cpu_opttab_cortexa7,
    ...
    {{"cortex-a8",
      ...
      {isa_bit_fp_d32, isa_bit_armv6k, isa_bit_notm, isa_bit_fp_dbl,
       ...
       isa_bit_vfpv3, isa_bit_sec, isa_bit_armv6, isa_bit_thumb2, isa_bit_armv7,
       isa_bit_armv5t, isa_bit_be8, isa_bit_neon, isa_nobit}},
     NULL,
     TARGET_ARCH_armv7_a},
    {{"cortex-a9",
      cpu_opttab_cortexa9,
    ...
    {{"cortex-r7",
      ...
      {isa_bit_notm, isa_bit_armv6k, isa_bit_fp_dbl, isa_bit_fp16conv,
       ...
       isa_bit_armv7, isa_bit_adiv, isa_bit_be8, isa_bit_tdiv, isa_nobit}},
     NULL,
     TARGET_ARCH_armv7_r},
    {{"cortex-r8",
      cpu_opttab_cortexr8,
    ...
    {{"cortex-m7",
      cpu_opttab_cortexm7,
      {isa_bit_quirk_no_volatile_ce, isa_bit_fp_dbl, isa_bit_fp16conv,
    ...
    {{"marvell-pj4",
      NULL,
      {isa_bit_mp, isa_bit_armv6k, isa_bit_notm, isa_bit_armv4, isa_bit_armv5te,
       isa_bit_thumb, isa_bit_sec, isa_bit_armv6, isa_bit_thumb2, isa_bit_armv7,
       isa_bit_armv5t, isa_bit_be8, isa_nobit}},
     NULL,
     TARGET_ARCH_armv7_a},
    ...
    {{"cortex-m23",
      ...
      {isa_bit_cmse, isa_bit_armv5te, isa_bit_armv4, isa_bit_thumb,
       isa_bit_armv6, isa_bit_armv5t, isa_bit_be8, isa_bit_armv8, isa_bit_tdiv,
       isa_nobit}},
     NULL,
    ...
    {{"cortex-m33",
      ...
      {isa_bit_fp16conv, isa_bit_cmse, isa_bit_fpv5, isa_bit_armv4,
       ...
       isa_bit_armv7, isa_bit_armv5t, isa_bit_be8, isa_bit_armv8, isa_bit_tdiv,
       isa_nobit}},
     NULL,
...
static const struct cpu_arch_extension arch_opttab_armv5te[] = {
    {"fp", false, false, {isa_bit_fp_dbl, isa_bit_vfpv2, isa_nobit}},
    {"nofp",
     true,
     false,
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_fp16,
      isa_bit_crypto, isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4,
      isa_bit_neon, isa_nobit}},
    {"vfpv2", false, true, {isa_bit_fp_dbl, isa_bit_vfpv2, isa_nobit}},
    {NULL, false, false, {isa_nobit}}};
...
static const struct cpu_arch_extension arch_opttab_armv7_r[] = {
    {"fp.sp", false, false, {isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
    {"fp",
     false,
     false,
     {isa_bit_fp_dbl, isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
    ...
    {"vfpv3-d16-fp16",
     ...
     {isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_vfpv2, isa_bit_vfpv3,
      isa_nobit}},
    {"idiv", false, false, {isa_bit_adiv, isa_nobit}},
    {"nofp",
     true,
     false,
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_fp16,
      isa_bit_crypto, isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4,
      isa_bit_neon, isa_nobit}},
    {"noidiv", true, false, {isa_bit_adiv, isa_nobit}},
    {"vfpv3xd", false, true, {isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
    {"vfpv3-d16",
     false,
     true,
     {isa_bit_fp_dbl, isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
...
static const struct cpu_arch_extension arch_opttab_armv8_a[] = {
    {"crc", false, false, {isa_bit_crc32, isa_nobit}},
    {"simd",
     false,
     false,
    ...
    {"crypto",
     ...
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_crypto,
      isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4, isa_bit_neon,
      isa_nobit}},
    {"nocrypto", true, false, {isa_bit_crypto, isa_nobit}},
    {"nofp",
     true,
     false,
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_fp16,
      isa_bit_crypto, isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_vfpv4,
      isa_bit_neon, isa_nobit}},
    {"sb", false, false, {isa_bit_sb, isa_nobit}},
    {"predres", false, false, {isa_bit_predres, isa_nobit}},
    {NULL, false, false, {isa_nobit}}};
...
static const struct cpu_arch_extension arch_opttab_armv8_4_a[] = {
    ...
    {"fp16",
     ...
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_fp16fml,
      isa_bit_fp16, isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3, isa_bit_dotprod,
      isa_bit_vfpv4, isa_bit_neon, isa_nobit}},
    {"crypto",
     false,
     false,
...
static const struct cpu_arch_extension arch_opttab_armv8_m_main[] = {
    {"dsp", false, false, {isa_bit_armv7em, isa_nobit}},
    {"fp",
     false,
     false,
     {isa_bit_fp16conv, isa_bit_fpv5, isa_bit_vfpv2, isa_bit_vfpv3,
...
const arch_option all_architectures[] = {
    ...
    },
    {
        ...
        {isa_bit_armv5te, isa_bit_armv4, isa_bit_thumb, isa_bit_thumb2,
         isa_bit_armv6, isa_bit_armv5t, isa_bit_armv7, isa_bit_be8, isa_nobit},
        "7",
        BASE_ARCH_7,
        0,
        TARGET_CPU_cortexa8,
    ...
    },
    {
        ...
        {isa_bit_mp, isa_bit_armv6k, isa_bit_notm, isa_bit_armv5te,
         ...
         isa_bit_sec, isa_bit_armv5t, isa_bit_armv7, isa_bit_be8, isa_bit_adiv,
    ...
    },
    {
        ...
        {isa_bit_mp, isa_bit_armv6k, isa_bit_notm, isa_bit_armv5te,
         ...
         isa_bit_be8, isa_bit_adiv, isa_bit_lpae, isa_bit_tdiv, isa_nobit},
        "8A",
        BASE_ARCH_8A,
        'A',
    ...
    },
    {
        ...
        {isa_bit_mp, isa_bit_armv8_1, isa_bit_armv6k, isa_bit_notm,
         ...
         isa_bit_armv5t, isa_bit_armv8, isa_bit_be8, isa_bit_adiv, isa_bit_lpae,
         isa_bit_tdiv, isa_nobit},
        "8A",
        BASE_ARCH_8A,
        'A',
    ...
    },
    {
        ...
        {isa_bit_mp, isa_bit_armv6k, isa_bit_notm, isa_bit_armv4,
         ...
         isa_bit_lpae, isa_bit_be8, isa_bit_armv8, isa_bit_tdiv, isa_nobit},
        "8R",
        BASE_ARCH_8R,
        'R',
    ...
    {{NULL, NULL, {isa_nobit}}, NULL, BASE_ARCH_0, 0, TARGET_CPU_arm_none}};

const arm_fpu_desc all_fpus[] = {
    {"vfp", {isa_bit_fp_dbl, isa_bit_vfpv2, isa_nobit}},
    {"vfpv2", {isa_bit_fp_dbl, isa_bit_vfpv2, isa_nobit}},
    {"vfpv3",
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
    {"vfpv3-fp16",
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_vfpv2,
      isa_bit_vfpv3, isa_nobit}},
    {"vfpv3-d16", {isa_bit_fp_dbl, isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
    {"vfpv3-d16-fp16",
     {isa_bit_fp_dbl, isa_bit_fp16conv, isa_bit_vfpv2, isa_bit_vfpv3,
      isa_nobit}},
    {"vfpv3xd", {isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
    {"vfpv3xd-fp16",
     {isa_bit_fp16conv, isa_bit_vfpv2, isa_bit_vfpv3, isa_nobit}},
    {"neon",
     {isa_bit_fp_d32, isa_bit_fp_dbl, isa_bit_vfpv2, isa_bit_vfpv3,
