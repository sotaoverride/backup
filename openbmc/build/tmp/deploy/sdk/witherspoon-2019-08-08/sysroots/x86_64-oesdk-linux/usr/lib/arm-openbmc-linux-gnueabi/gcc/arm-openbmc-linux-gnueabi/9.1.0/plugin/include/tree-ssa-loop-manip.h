...
static inline void checking_verify_loop_closed_ssa(bool verify_ssa_p,
...
extern void standard_iv_increment_position(struct loop*, gimple_stmt_iterator*,
                                           bool*);
extern bool gimple_duplicate_loop_to_header_edge(struct loop*, edge,
                                                 unsigned int, sbitmap, edge,
                                                 vec<edge>*, int);
...
extern void tree_transform_and_unroll_loop(struct loop*, unsigned, edge,
                                           struct tree_niter_desc*,
                                           transform_callback, void*);
extern void tree_unroll_loop(struct loop*, unsigned, edge,
                             struct tree_niter_desc*);
