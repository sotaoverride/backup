...
static void gt_ggc_ma_order(ATTRIBUTE_UNUSED void* x_p)
{
    if (order != NULL)
    {
        size_t i0;
...
static void gt_pch_pa_order(void*, void*, gt_pointer_operator, void*);
...
static void gt_pch_na_order(ATTRIBUTE_UNUSED void* x_p)
{
    if (order != NULL)
    {
        size_t i0;
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_passes_h[] = {
    {&order, 1, sizeof(order), &gt_ggc_ma_order, &gt_pch_na_order},
    LAST_GGC_ROOT_TAB};
