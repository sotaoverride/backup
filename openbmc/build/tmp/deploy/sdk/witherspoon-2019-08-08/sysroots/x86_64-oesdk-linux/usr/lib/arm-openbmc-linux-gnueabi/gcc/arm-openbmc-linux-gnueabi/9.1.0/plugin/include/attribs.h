...
extern struct scoped_attributes*
    register_scoped_attributes(const struct attribute_spec*, const char*);
...
static inline bool cmp_attribs(const char* attr1, size_t attr1_len,
