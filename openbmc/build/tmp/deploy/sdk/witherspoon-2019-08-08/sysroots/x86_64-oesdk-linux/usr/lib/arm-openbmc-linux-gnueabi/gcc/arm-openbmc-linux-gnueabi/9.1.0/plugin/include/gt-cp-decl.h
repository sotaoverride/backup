...
void gt_ggc_mx_named_label_entry(void* x_p)
{
...
void gt_ggc_mx(struct named_label_entry& x_r ATTRIBUTE_UNUSED)
{
...
void gt_ggc_mx(struct named_label_entry*& x)
{
    if (x)
        gt_ggc_mx_named_label_entry((void*)x);
}

void gt_ggc_mx_named_label_use_entry(void* x_p)
{
...
void gt_ggc_mx_vec_incomplete_var_va_gc_(void* x_p)
{
...
void gt_ggc_mx(struct incomplete_var& x_r ATTRIBUTE_UNUSED)
{
...
void gt_ggc_mx_hash_table_typename_hasher_(void* x_p)
{
...
void gt_ggc_mx(struct typename_hasher& x_r ATTRIBUTE_UNUSED)
{
    struct typename_hasher* ATTRIBUTE_UNUSED x = &x_r;
}

void gt_pch_nx_named_label_entry(void* x_p)
{
    struct named_label_entry* const x = (struct named_label_entry*)x_p;
...
void gt_pch_nx(struct named_label_entry& x_r ATTRIBUTE_UNUSED)
{
    struct named_label_entry* ATTRIBUTE_UNUSED x = &x_r;
    gt_pch_n_9tree_node((*x).name);
    gt_pch_n_9tree_node((*x).label_decl);
...
void gt_pch_nx(struct named_label_entry*& x)
{
    if (x)
        gt_pch_nx_named_label_entry((void*)x);
}

void gt_pch_nx_named_label_use_entry(void* x_p)
{
    struct named_label_use_entry* x = (struct named_label_use_entry*)x_p;
    struct named_label_use_entry* xlimit = x;
...
void gt_pch_nx_vec_incomplete_var_va_gc_(void* x_p)
{
    vec<incomplete_var, va_gc>* const x = (vec<incomplete_var, va_gc>*)x_p;
...
void gt_pch_nx(struct incomplete_var& x_r ATTRIBUTE_UNUSED)
{
    struct incomplete_var* ATTRIBUTE_UNUSED x = &x_r;
...
void gt_pch_nx_hash_table_typename_hasher_(void* x_p)
{
    hash_table<typename_hasher>* const x = (hash_table<typename_hasher>*)x_p;
...
void gt_pch_nx(struct typename_hasher& x_r ATTRIBUTE_UNUSED)
{
    struct typename_hasher* ATTRIBUTE_UNUSED x = &x_r;
}

void gt_pch_p_17named_label_entry(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                  ATTRIBUTE_UNUSED gt_pointer_operator op,
                                  ATTRIBUTE_UNUSED void* cookie)
{
    struct named_label_entry* x ATTRIBUTE_UNUSED =
        (struct named_label_entry*)x_p;
    if ((void*)(x) == this_obj)
        op(&((*x).name), cookie);
    if ((void*)(x) == this_obj)
...
void gt_pch_nx(struct named_label_entry* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
    op(&((*x).name), cookie);
...
void gt_pch_p_21named_label_use_entry(ATTRIBUTE_UNUSED void* this_obj,
                                      void* x_p,
                                      ATTRIBUTE_UNUSED gt_pointer_operator op,
                                      ATTRIBUTE_UNUSED void* cookie)
{
    struct named_label_use_entry* x ATTRIBUTE_UNUSED =
        (struct named_label_use_entry*)x_p;
    if ((void*)(x) == this_obj)
        op(&((*x).next), cookie);
    if ((void*)(x) == this_obj)
        op(&((*x).binding_level), cookie);
...
void gt_pch_p_25vec_incomplete_var_va_gc_(
    ATTRIBUTE_UNUSED void* this_obj, void* x_p,
    ATTRIBUTE_UNUSED gt_pointer_operator op, ATTRIBUTE_UNUSED void* cookie)
{
    struct vec<incomplete_var, va_gc>* x ATTRIBUTE_UNUSED =
        (struct vec<incomplete_var, va_gc>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_nx(struct incomplete_var* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
    op(&((*x).decl), cookie);
...
void gt_pch_p_27hash_table_typename_hasher_(
    ATTRIBUTE_UNUSED void* this_obj, void* x_p,
    ATTRIBUTE_UNUSED gt_pointer_operator op, ATTRIBUTE_UNUSED void* cookie)
{
    struct hash_table<typename_hasher>* x ATTRIBUTE_UNUSED =
        (struct hash_table<typename_hasher>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_nx(struct typename_hasher* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
}
...
void gt_clear_caches_gt_cp_decl_h()
{
