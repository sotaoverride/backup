...
void gt_ggc_mx_lang_tree_node(void* x_p)
{
    ...
    while (x != xlimit)
    {
        switch ((int)(TREE_CODE(&((*x)).generic) == IDENTIFIER_NODE))
        {
            ...
            case 1:
                gt_ggc_m_9tree_node(
                    (*x).identifier.common_id.common.typed.type);
                ...
                switch ((int)(((*x).identifier.common_id.node).type))
                {
                    case NT_VOID:
                        gt_ggc_m_9cpp_macro(
                            (*x).identifier.common_id.node.value.answers);
                        break;
                    case NT_USER_MACRO:
                        gt_ggc_m_9cpp_macro(
                            (*x).identifier.common_id.node.value.macro);
                        break;
...
void gt_ggc_mx_vec_c_goto_bindings_p_va_gc_(void* x_p)
{
    vec<c_goto_bindings_p, va_gc>* const x =
        (vec<c_goto_bindings_p, va_gc>*)x_p;
    if (ggc_test_and_set_mark(x))
    {
        gt_ggc_mx(x);
    }
...
void gt_ggc_mx(struct c_goto_bindings*& x)
{
    if (x)
...
void gt_ggc_mx_sorted_fields_type(void* x_p)
{
...
void gt_pch_nx_vec_c_goto_bindings_p_va_gc_(void* x_p)
{
    vec<c_goto_bindings_p, va_gc>* const x =
        (vec<c_goto_bindings_p, va_gc>*)x_p;
...
void gt_pch_nx(struct c_goto_bindings*& x)
{
    if (x)
...
void gt_pch_nx_sorted_fields_type(void* x_p)
{
    struct sorted_fields_type* const x = (struct sorted_fields_type*)x_p;
    ...
    switch ((int)(TREE_CODE(&((*x)).generic) == IDENTIFIER_NODE))
    {
        ...
        case 1:
            ...
            switch ((int)(((*x).identifier.common_id.node).type))
            {
                case NT_VOID:
                    if ((void*)(x) == this_obj)
                        op(&((*x).identifier.common_id.node.value.answers),
                           cookie);
                    break;
                case NT_USER_MACRO:
                    if ((void*)(x) == this_obj)
                        op(&((*x).identifier.common_id.node.value.macro),
                           cookie);
                    break;
                case NT_BUILTIN_MACRO:
                    break;
...
void gt_pch_p_12c_label_vars(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                             ATTRIBUTE_UNUSED gt_pointer_operator op,
                             ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_9c_binding(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                         ATTRIBUTE_UNUSED gt_pointer_operator op,
                         ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_7c_scope(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                       ATTRIBUTE_UNUSED gt_pointer_operator op,
                       ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_15c_goto_bindings(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                ATTRIBUTE_UNUSED gt_pointer_operator op,
                                ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_28vec_c_goto_bindings_p_va_gc_(
    ATTRIBUTE_UNUSED void* this_obj, void* x_p,
    ATTRIBUTE_UNUSED gt_pointer_operator op, ATTRIBUTE_UNUSED void* cookie)
{
    struct vec<c_goto_bindings_p, va_gc>* x ATTRIBUTE_UNUSED =
        (struct vec<c_goto_bindings_p, va_gc>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_p_15c_inline_static(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                ATTRIBUTE_UNUSED gt_pointer_operator op,
                                ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_18sorted_fields_type(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                   ATTRIBUTE_UNUSED gt_pointer_operator op,
                                   ATTRIBUTE_UNUSED void* cookie)
{
    struct sorted_fields_type* x ATTRIBUTE_UNUSED =
        (struct sorted_fields_type*)x_p;
    {
        size_t l0 = (size_t)(((*x)).len);
        {
            size_t i0;
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_c_c_decl_h[] = {
    {&ext_block, 1, sizeof(ext_block), &gt_ggc_mx_tree_node,
     &gt_pch_nx_tree_node},
    {&last_structptr_types[0], 1 * (6), sizeof(last_structptr_types[0]),
     &gt_ggc_mx_tree_node, &gt_pch_nx_tree_node},
    {&c_inline_statics, 1, sizeof(c_inline_statics), &gt_ggc_mx_c_inline_static,
     &gt_pch_nx_c_inline_static},
    {&external_scope, 1, sizeof(external_scope), &gt_ggc_mx_c_scope,
     &gt_pch_nx_c_scope},
    {&file_scope, 1, sizeof(file_scope), &gt_ggc_mx_c_scope,
     &gt_pch_nx_c_scope},
    {&current_function_scope, 1, sizeof(current_function_scope),
     &gt_ggc_mx_c_scope, &gt_pch_nx_c_scope},
    {&current_scope, 1, sizeof(current_scope), &gt_ggc_mx_c_scope,
     &gt_pch_nx_c_scope},
    {&visible_builtins, 1, sizeof(visible_builtins), &gt_ggc_mx_tree_node,
     &gt_pch_nx_tree_node},
    {&c_stmt_tree.x_cur_stmt_list, 1, sizeof(c_stmt_tree.x_cur_stmt_list),
...
EXPORTED_CONST struct ggc_root_tab gt_pch_rs_gt_c_c_decl_h[] = {
    {&current_omp_declare_target_attribute, 1,
     sizeof(current_omp_declare_target_attribute), NULL, NULL},
