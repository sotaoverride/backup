...
struct GTY(()) rtl_data
{
    ...
    /* Offset to end of allocated area of stack frame.
       ...
       allocated. If stack grows up, this is the address for the next slot.  */
    ...
    /* Nonzero if the function being compiled has undergone hot/cold
       partitioning (under flag_reorder_blocks_and_partition) and has at least
       one cold block.  */
...
extern rtx adjust_address_1(rtx, machine_mode, poly_int64, int, int, int,
                            poly_int64);
