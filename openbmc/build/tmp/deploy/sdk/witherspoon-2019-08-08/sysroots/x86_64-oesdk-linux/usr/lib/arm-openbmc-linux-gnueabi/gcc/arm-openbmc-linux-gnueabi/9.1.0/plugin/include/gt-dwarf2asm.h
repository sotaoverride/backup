...
void gt_ggc_mx_hash_map_char__tree_(void* x_p)
{
...
void gt_pch_nx_hash_map_char__tree_(void* x_p)
{
    hash_map<char*, tree>* const x = (hash_map<char*, tree>*)x_p;
...
void gt_pch_p_20hash_map_char__tree_(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                     ATTRIBUTE_UNUSED gt_pointer_operator op,
                                     ATTRIBUTE_UNUSED void* cookie)
{
    struct hash_map<char*, tree>* x ATTRIBUTE_UNUSED =
        (struct hash_map<char*, tree>*)x_p;
    if ((void*)(x) == this_obj)
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_dwarf2asm_h[] = {
    {&indirect_pool, 1, sizeof(indirect_pool), &gt_ggc_mx_hash_map_char__tree_,
