...
extern tree fold_unary_ignore_overflow_loc(location_t, enum tree_code, tree,
                                           tree);
...
extern tree fold_build2_initializer_loc(location_t, enum tree_code, tree, tree,
                                        tree);
...
extern tree fold_build_call_array_initializer_loc(location_t, tree, tree, int,
                                                  tree*);
...
extern enum tree_code fold_div_compare(enum tree_code, tree, tree, tree*, tree*,
                                       bool*);
...
extern tree fold_bit_and_mask(tree, tree, enum tree_code, tree, enum tree_code,
                              tree, tree, tree, enum tree_code, tree, tree,
                              tree*);
...
extern bool tree_call_nonnegative_warnv_p(tree, combined_fn, tree, tree, bool*,
                                          int);
...
extern tree make_range_step(location_t, enum tree_code, tree, tree, tree, tree*,
                            tree*, int*, bool*);
...
/* Build and fold a POINTER_PLUS_EXPR at LOC offsetting PTR by OFF.  */
extern tree fold_build_pointer_plus_hwi_loc(location_t loc, tree ptr,
                                            HOST_WIDE_INT off);
