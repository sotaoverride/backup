...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_cp_mangle_h[] = {
    {&subst_identifiers[0], 1 * (SUBID_MAX), sizeof(subst_identifiers[0]),
     &gt_ggc_mx_tree_node, &gt_pch_nx_tree_node},
    {&G.substitutions, 1, sizeof(G.substitutions), &gt_ggc_mx_vec_tree_va_gc_,
     &gt_pch_nx_vec_tree_va_gc_},
    LAST_GGC_ROOT_TAB};

EXPORTED_CONST struct ggc_root_tab gt_pch_rs_gt_cp_mangle_h[] = {
    {&G, 1, sizeof(G), NULL, NULL}, LAST_GGC_ROOT_TAB};
