...
struct cpp_options
{
    ...
    struct
    {
        ...
        /* If true, intend to use the preprocessor output (e.g., for
           compilation) in addition to the dependency info.  */
...
struct cpp_callbacks
{
    ...
    bool (*diagnostic)(cpp_reader*, enum cpp_diagnostic_level,
                       ...
                       va_list*) ATTRIBUTE_FPTR_PRINTF(5, 0);
...
extern void cpp_register_deferred_pragma(cpp_reader*, const char*, const char*,
                                         unsigned, bool, bool);
...
extern unsigned cpp_classify_number(cpp_reader*, const cpp_token*, const char**,
                                    location_t);
...
extern bool cpp_pedwarning(cpp_reader*, enum cpp_warning_reason,
                           const char* msgid, ...) ATTRIBUTE_PRINTF_3;
