...
extern void gimple_check_failed(const gimple*, const char*, int, const char*,
                                enum gimple_code, enum tree_code)
...
struct GTY((desc("gimple_statement_structure (&%h)"), tag("GSS_BASE"),
            chain_next("%h.next"), variable_size)) gimple
{
    /* [ WORD 1 ]
...
struct GTY((tag("GSS_OMP_CRITICAL"))) gomp_critical
...
/* GIMPLE_OMP_PARALLEL */
struct GTY((tag("GSS_OMP_PARALLEL_LAYOUT"))) gomp_parallel
...
struct GTY((tag("GSS_OMP_TASK"))) gomp_task
    : public gimple_statement_omp_taskreg
{
...
struct GTY((tag("GSS_OMP_SECTIONS"))) gomp_sections
    : public gimple_statement_omp
{
    /* [ WORD 1-7 ] : base class */
...
struct GTY((tag("GSS_OMP_SINGLE_LAYOUT"))) gomp_single
...
struct GTY((tag("GSS_OMP_PARALLEL_LAYOUT"))) gomp_teams
    : public gimple_statement_omp_taskreg
{
    /* No extra fields; adds invariant:
         stmt->code == GIMPLE_OMP_TEAMS.  */
...
struct GTY((tag("GSS_TRANSACTION"))) gtransaction
    : public gimple_statement_with_memory_ops_base
{
    /* [ WORD 1-9 ] : base class */
...
struct GTY((tag("GSS_WITH_MEM_OPS"))) gassign
...
struct GTY((tag("GSS_WITH_MEM_OPS"))) greturn
    : public gimple_statement_with_memory_ops
{
    /* no additional fields; this uses the layout for GSS_WITH_MEM_OPS. */
};
...
template <>
template <>
inline bool is_a_helper<gasm*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gassign*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<const gassign*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_ASSIGN;
}
...
template <>
template <>
inline bool is_a_helper<gbind*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gcall*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gcatch*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gcond*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<const gcond*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_COND;
}
...
template <>
template <>
inline bool is_a_helper<gdebug*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<ggoto*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<glabel*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gresx*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<geh_dispatch*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<geh_else*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<geh_filter*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<geh_mnt*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_atomic_load*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_atomic_store*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gimple_statement_omp_return*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_continue*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_critical*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_ordered*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_for*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gimple_statement_omp_taskreg*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_parallel*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_target*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_sections*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_single*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_teams*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gomp_task*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gphi*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<greturn*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gswitch*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gtransaction*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gtry*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<gimple_statement_wce*>::test(gimple* gs)
{
...
template <>
template <>
inline bool is_a_helper<const gasm*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_ASM;
}
...
template <>
template <>
inline bool is_a_helper<const gbind*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_BIND;
}
...
template <>
template <>
inline bool is_a_helper<const gcall*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_CALL;
}
...
template <>
template <>
inline bool is_a_helper<const gcatch*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_CATCH;
}
...
template <>
template <>
inline bool is_a_helper<const gresx*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_RESX;
}
...
template <>
template <>
inline bool is_a_helper<const geh_dispatch*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_EH_DISPATCH;
}
...
template <>
template <>
inline bool is_a_helper<const geh_filter*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_EH_FILTER;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_atomic_load*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_ATOMIC_LOAD;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_atomic_store*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_ATOMIC_STORE;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_continue*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_CONTINUE;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_critical*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_CRITICAL;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_ordered*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_ORDERED;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_for*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_FOR;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_parallel*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_PARALLEL;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_target*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_TARGET;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_sections*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_SECTIONS;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_single*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_SINGLE;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_teams*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_TEAMS;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_task*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_OMP_TASK;
}
...
template <>
template <>
inline bool is_a_helper<const gphi*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_PHI;
}
...
template <>
template <>
inline bool is_a_helper<const gtransaction*>::test(const gimple* gs)
{
    return gs->code == GIMPLE_TRANSACTION;
}
...
gassign* gimple_build_assign(tree, enum tree_code, tree, tree,
...
gasm* gimple_build_asm_vec(const char*, vec<tree, va_gc>*, vec<tree, va_gc>*,
...
gomp_task* gimple_build_omp_task(gimple_seq, tree, tree, tree, tree, tree,
                                 tree);
...
void gimple_assign_set_rhs_with_ops(gimple_stmt_iterator*, enum tree_code, tree,
                                    tree, tree);
...
{
    gcc_gimple_checking_assert((unsigned int)code <
                               LAST_AND_UNUSED_GIMPLE_CODE);
...
template <>
template <>
inline bool is_a_helper<gimple_statement_with_ops*>::test(gimple* gs)
{
    return gimple_has_ops(gs);
}
...
static inline void gimple_omp_parallel_set_combined_p(gimple* g,
                                                      bool combined_p)
{
    GIMPLE_CHECK(g, GIMPLE_OMP_PARALLEL);
    if (combined_p)
    ...
    gimple_omp_atomic_memory_order(const gimple* g)
{
    if (gimple_code(g) != GIMPLE_OMP_ATOMIC_LOAD)
        GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_STORE);
    return (enum omp_memory_order)(gimple_omp_subcode(g) &
                                   GF_OMP_ATOMIC_MEMORY_ORDER);
}

/* Set the memory order on G.  */

static inline void gimple_omp_atomic_set_memory_order(gimple* g,
...
static inline void gimple_assign_set_rhs_with_ops(gimple_stmt_iterator* gsi,
...
static inline void gimple_assign_set_nontemporal_move(gimple* gs,
                                                      bool nontemporal)
{
...
static inline bool gimple_assign_load_p(const gimple* gs)
{
    ...
    return (DECL_P(rhs) || TREE_CODE(rhs) == MEM_REF ||
...
static inline bool gimple_assign_cast_p(const gimple* s)
{
    if (is_gimple_assign(s))
    {
        ...
        return CONVERT_EXPR_CODE_P(sc) || sc == VIEW_CONVERT_EXPR ||
               sc == FIX_TRUNC_EXPR;
    }
...
static inline void gimple_call_set_ctrl_altering(gimple* s,
...
static inline void gimple_call_set_internal_fn(gcall* call_stmt,
                                               enum internal_fn fn)
{
    gcc_gimple_checking_assert(gimple_call_internal_p(call_stmt));
...
static inline void gimple_call_set_return_slot_opt(gcall* s,
...
static inline void gimple_cond_set_condition(gcond* stmt, enum tree_code code,
                                             tree lhs, tree rhs)
{
...
static inline void gimple_asm_set_input_op(gasm* asm_stmt, unsigned index,
                                           tree in_op)
{
    gcc_gimple_checking_assert(index < asm_stmt->ni &&
...
static inline void gimple_asm_set_output_op(gasm* asm_stmt, unsigned index,
                                            tree out_op)
{
    gcc_gimple_checking_assert(index < asm_stmt->no &&
...
static inline void gimple_asm_set_clobber_op(gasm* asm_stmt, unsigned index,
                                             tree clobber_op)
{
    gcc_gimple_checking_assert(index < asm_stmt->nc &&
...
static inline void gimple_asm_set_label_op(gasm* asm_stmt, unsigned index,
                                           tree label_op)
{
    gcc_gimple_checking_assert(index < asm_stmt->nl &&
...
static inline void gimple_catch_set_handler(gcatch* catch_stmt,
                                            gimple_seq handler)
{
...
static inline void gimple_eh_filter_set_types(geh_filter* eh_filter_stmt,
                                              tree types)
{
...
static inline void gimple_eh_filter_set_failure(geh_filter* eh_filter_stmt,
                                                gimple_seq failure)
{
...
static inline void gimple_eh_must_not_throw_set_fndecl(geh_mnt* eh_mnt_stmt,
                                                       tree decl)
{
...
static inline void gimple_eh_else_set_n_body(geh_else* eh_else_stmt,
                                             gimple_seq seq)
{
    eh_else_stmt->n_body = seq;
}

static inline void gimple_eh_else_set_e_body(geh_else* eh_else_stmt,
                                             gimple_seq seq)
{
...
static inline void gimple_try_set_catch_is_cleanup(gtry* g,
...
static inline void gimple_phi_set_arg(gphi* phi, unsigned index,
...
static inline void gimple_phi_arg_set_location(gphi* phi, size_t i,
                                               location_t loc)
{
...
static inline void gimple_eh_dispatch_set_region(geh_dispatch* eh_dispatch_stmt,
                                                 int region)
{
...
static inline void gimple_switch_set_label(gswitch* gs, unsigned index,
                                           tree label)
{
    gcc_gimple_checking_assert(
        gimple_num_ops(gs) > index + 1 &&
...
static inline void gimple_omp_critical_set_name(gomp_critical* crit_stmt,
                                                tree name)
{
    crit_stmt->name = name;
}
...
static inline void gimple_omp_critical_set_clauses(gomp_critical* crit_stmt,
                                                   tree clauses)
{
...
static inline void gimple_omp_ordered_set_clauses(gomp_ordered* ord_stmt,
                                                  tree clauses)
{
...
{
    g->subcode =
        (g->subcode & ~GF_OMP_FOR_KIND_MASK) | (kind & GF_OMP_FOR_KIND_MASK);
}
...
static inline void gimple_omp_for_set_combined_into_p(gomp_for* g,
                                                      bool combined_p)
{
    if (combined_p)
...
static inline void gimple_omp_for_set_cond(gimple* gs, size_t i,
                                           enum tree_code cond)
{
    gomp_for* omp_for_stmt = as_a<gomp_for*>(gs);
...
static inline void gimple_omp_for_set_initial(gimple* gs, size_t i,
                                              tree initial)
{
    gomp_for* omp_for_stmt = as_a<gomp_for*>(gs);
    gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
static inline void gimple_omp_for_set_grid_intra_group(gomp_for* omp_for,
                                                       bool value)
{
    gcc_checking_assert(gimple_omp_for_kind(omp_for) ==
                        GF_OMP_FOR_KIND_GRID_LOOP);
...
static inline void gimple_omp_for_set_grid_group_iter(gomp_for* omp_for,
                                                      bool value)
{
    gcc_checking_assert(gimple_omp_for_kind(omp_for) ==
                        GF_OMP_FOR_KIND_GRID_LOOP);
...
static inline void gimple_omp_parallel_set_grid_phony(gomp_parallel* stmt,
                                                      bool value)
{
    if (value)
...
static inline void gimple_omp_target_set_clauses(gomp_target* omp_target_stmt,
                                                 tree clauses)
{
...
static inline void gimple_omp_target_set_child_fn(gomp_target* omp_target_stmt,
                                                  tree child_fn)
{
...
static inline void gimple_omp_target_set_data_arg(gomp_target* omp_target_stmt,
                                                  tree data_arg)
{
...
static inline void gimple_omp_teams_set_child_fn(gomp_teams* omp_teams_stmt,
                                                 tree child_fn)
{
...
static inline void gimple_omp_teams_set_data_arg(gomp_teams* omp_teams_stmt,
                                                 tree data_arg)
{
...
static inline void gimple_omp_teams_set_grid_phony(gomp_teams* omp_teams_stmt,
                                                   bool value)
{
    if (value)
...
static inline void gimple_omp_teams_set_host(gomp_teams* omp_teams_stmt,
                                             bool value)
{
    if (value)
...
static inline void gimple_omp_atomic_load_set_lhs(gomp_atomic_load* load_stmt,
                                                  tree lhs)
{
    load_stmt->lhs = lhs;
}
...
static inline void gimple_omp_atomic_load_set_rhs(gomp_atomic_load* load_stmt,
                                                  tree rhs)
{
    load_stmt->rhs = rhs;
}
...
static inline void gimple_omp_continue_set_control_def(gomp_continue* cont_stmt,
                                                       tree def)
{
...
static inline void gimple_omp_continue_set_control_use(gomp_continue* cont_stmt,
                                                       tree use)
{
...
static inline void gimple_transaction_set_body(gtransaction* transaction_stmt,
                                               gimple_seq body)
{
...
static inline void
    gimple_transaction_set_label_norm(gtransaction* transaction_stmt,
                                      tree label)
{
...
static inline void
    gimple_transaction_set_label_uninst(gtransaction* transaction_stmt,
                                        tree label)
{
...
static inline void
    gimple_transaction_set_label_over(gtransaction* transaction_stmt,
                                      tree label)
{
