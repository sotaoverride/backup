...
#define EXTRA_TARGET_D_OS_VERSIONS() ANDROID_TARGET_D_OS_VERSIONS();
...
#undef LINK_SPEC
#define LINK_SPEC                                                              \
    TARGET_FIX_V4BX_SPEC EABI_LINK_SPEC LINUX_OR_ANDROID_LD(                   \
...
#define CC1PLUS_SPEC LINUX_OR_ANDROID_CC("", ANDROID_CC1PLUS_SPEC)
