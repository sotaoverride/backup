...
#define VEC_WIDEN_MULT_EVEN_EXPR_CHECK(t)                                      \
    TREE_CHECK(t, VEC_WIDEN_MULT_EVEN_EXPR)
...
#define VEC_UNPACK_FLOAT_HI_EXPR_CHECK(t)                                      \
    TREE_CHECK(t, VEC_UNPACK_FLOAT_HI_EXPR)
#define VEC_UNPACK_FLOAT_LO_EXPR_CHECK(t)                                      \
    TREE_CHECK(t, VEC_UNPACK_FLOAT_LO_EXPR)
#define VEC_UNPACK_FIX_TRUNC_HI_EXPR_CHECK(t)                                  \
    TREE_CHECK(t, VEC_UNPACK_FIX_TRUNC_HI_EXPR)
#define VEC_UNPACK_FIX_TRUNC_LO_EXPR_CHECK(t)                                  \
    TREE_CHECK(t, VEC_UNPACK_FIX_TRUNC_LO_EXPR)
...
#define VEC_WIDEN_LSHIFT_HI_EXPR_CHECK(t)                                      \
    TREE_CHECK(t, VEC_WIDEN_LSHIFT_HI_EXPR)
#define VEC_WIDEN_LSHIFT_LO_EXPR_CHECK(t)                                      \
    TREE_CHECK(t, VEC_WIDEN_LSHIFT_LO_EXPR)
...
#define UNCONSTRAINED_ARRAY_TYPE_CHECK(t)                                      \
    TREE_CHECK(t, UNCONSTRAINED_ARRAY_TYPE)
...
#define BOUND_TEMPLATE_TEMPLATE_PARM_CHECK(t)                                  \
    TREE_CHECK(t, BOUND_TEMPLATE_TEMPLATE_PARM)
...
#define CLASS_IMPLEMENTATION_TYPE_CHECK(t)                                     \
    TREE_CHECK(t, CLASS_IMPLEMENTATION_TYPE)
#define CATEGORY_INTERFACE_TYPE_CHECK(t) TREE_CHECK(t, CATEGORY_INTERFACE_TYPE)
#define CATEGORY_IMPLEMENTATION_TYPE_CHECK(t)                                  \
    TREE_CHECK(t, CATEGORY_IMPLEMENTATION_TYPE)
