...
static inline void output_buffer_append_r(output_buffer* buff,
...
typedef bool (*printer_fn)(pretty_printer*, text_info*, const char*, int, bool,
...
#define pp_identifier(PP, ID)                                                  \
    pp_string(                                                                 \
        PP, (pp_translate_identifiers(PP) ? identifier_to_locale(ID) : (ID)))
