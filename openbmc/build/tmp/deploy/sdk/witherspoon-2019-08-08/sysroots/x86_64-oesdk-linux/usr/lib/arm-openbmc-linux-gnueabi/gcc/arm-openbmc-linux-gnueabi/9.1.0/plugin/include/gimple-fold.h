...
extern tree
    gimple_fold_stmt_to_constant_1(gimple*, tree (*)(tree),
...
inline tree gimple_build(gimple_seq* seq, enum tree_code code, tree type,
                         tree op0)
{
...
/* In gimple-match.c.  */
extern tree gimple_simplify(enum tree_code, tree, tree, gimple_seq*,
                            tree (*)(tree));
extern tree gimple_simplify(enum tree_code, tree, tree, tree, gimple_seq*,
                            tree (*)(tree));
extern tree gimple_simplify(enum tree_code, tree, tree, tree, tree, gimple_seq*,
                            tree (*)(tree));
extern tree gimple_simplify(combined_fn, tree, tree, gimple_seq*,
                            tree (*)(tree));
extern tree gimple_simplify(combined_fn, tree, tree, tree, gimple_seq*,
                            tree (*)(tree));
extern tree gimple_simplify(combined_fn, tree, tree, tree, tree, gimple_seq*,
                            tree (*)(tree));
