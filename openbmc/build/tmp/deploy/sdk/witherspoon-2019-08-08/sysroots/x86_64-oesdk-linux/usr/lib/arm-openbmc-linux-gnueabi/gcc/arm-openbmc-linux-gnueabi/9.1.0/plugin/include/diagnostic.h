...
typedef void (*diagnostic_finalizer_fn)(diagnostic_context*, diagnostic_info*,
                                        diagnostic_t);
...
static inline void diagnostic_override_option_index(diagnostic_info* info,
                                                    int optidx)
{
...
#endif
extern char* diagnostic_build_prefix(diagnostic_context*,
...
static inline location_t diagnostic_location(const diagnostic_info* diagnostic,
                                             int which = 0)
{
...
static inline bool diagnostic_same_line(const diagnostic_context* context,
                                        expanded_location s1,
                                        expanded_location s2)
{
    return s2.column && s1.line == s2.line &&
           context->caret_max_width - CARET_LINE_MARGIN >
