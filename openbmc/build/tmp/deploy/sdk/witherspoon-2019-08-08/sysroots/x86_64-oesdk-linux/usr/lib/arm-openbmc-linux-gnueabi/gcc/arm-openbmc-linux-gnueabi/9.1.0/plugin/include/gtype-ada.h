...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_ada_h[] = {
    {&gnat_raise_decls_ext[0], 1 * ((int)LAST_REASON_CODE + 1),
     sizeof(gnat_raise_decls_ext[0]), &gt_ggc_mx_tree_node,
     &gt_pch_nx_tree_node},
    {&gnat_raise_decls[0], 1 * ((int)LAST_REASON_CODE + 1),
     sizeof(gnat_raise_decls[0]), &gt_ggc_mx_tree_node, &gt_pch_nx_tree_node},
    {&gnat_std_decls[0], 1 * ((int)ADT_LAST), sizeof(gnat_std_decls[0]),
...
EXPORTED_CONST struct ggc_root_tab* const gt_ggc_deletable_rtab[] = {
    ...
    gt_ggc_rd_gt_tree_phinodes_h, gt_ggc_rd_gt_ada_trans_h,
    gt_ggc_rd_gt_ada_utils_h,     NULL};
