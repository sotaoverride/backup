...
struct gcc_debug_hooks
{
    ...
    void (*imported_module_or_decl)(tree decl, tree name, tree context,
    ...
    /* Called from finalize_size_functions for size functions so that their body
       can be encoded in the debug info to describe the layout of
...
extern void debug_nothing_int_int_charstar_int_bool(unsigned int, unsigned int,
                                                    const char*, int, bool);
...
extern void debug_nothing_tree_tree_tree_bool_bool(tree, tree, tree, bool,
                                                   bool);
