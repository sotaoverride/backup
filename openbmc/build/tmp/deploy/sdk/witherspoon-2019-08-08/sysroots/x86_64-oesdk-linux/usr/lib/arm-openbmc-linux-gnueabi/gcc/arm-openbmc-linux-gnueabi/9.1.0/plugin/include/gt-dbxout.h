...
void gt_ggc_mx_typeinfo(void* x_p)
{
...
void gt_pch_nx_typeinfo(void* x_p)
{
    struct typeinfo* const x = (struct typeinfo*)x_p;
...
void gt_pch_p_8typeinfo(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
...
static void gt_ggc_ma_typevec(ATTRIBUTE_UNUSED void* x_p)
{
    if (typevec != NULL)
    {
        size_t i0;
...
static void gt_pch_pa_typevec(void*, void*, gt_pointer_operator, void*);
                              ...
                              ATTRIBUTE_UNUSED void* cookie)
{
    if (typevec != NULL)
    {
        size_t i0;
        for (i0 = 0;
             i0 != (size_t)(typevec_len) && ((void*)typevec == this_obj); i0++)
        {
        }
...
static void gt_pch_na_typevec(ATTRIBUTE_UNUSED void* x_p)
{
    if (typevec != NULL)
    {
        size_t i0;
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_dbxout_h[] = {
    {&lastfile, 1, sizeof(lastfile), (gt_pointer_walker)&gt_ggc_m_S,
     (gt_pointer_walker)&gt_pch_n_S},
    {&preinit_symbols, 1, sizeof(preinit_symbols), &gt_ggc_mx_tree_node,
     &gt_pch_nx_tree_node},
    {&typevec, 1, sizeof(typevec), &gt_ggc_ma_typevec, &gt_pch_na_typevec},
    LAST_GGC_ROOT_TAB};
...
EXPORTED_CONST struct ggc_root_tab gt_pch_rs_gt_dbxout_h[] = {
    ...
    {&dbxout_source_line_counter, 1, sizeof(dbxout_source_line_counter), NULL,
     NULL},
