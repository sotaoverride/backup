...
extern rtx arm_expand_builtin(tree exp, rtx target,
...
extern int arm_split_constant(RTX_CODE, machine_mode, rtx, HOST_WIDE_INT, rtx,
                              rtx, int);
...
extern char* neon_output_logic_immediate(const char*, rtx*, machine_mode, int,
                                         int);
extern char* neon_output_shift_immediate(const char*, char, rtx*, machine_mode,
                                         int, bool);
...
const arch_option* arm_parse_arch_option_name(const arch_option*, const char*,
                                              const char*, bool = true);
