...
struct double_int
{
    ...
    double_int divmod_with_overflow(double_int, bool, unsigned, double_int*,
                                    bool*) const;
...
inline double_int double_int::from_pair(HOST_WIDE_INT high,
                                        unsigned HOST_WIDE_INT low)
{
    double_int r;
    r.low = low;
...
inline wi::storage_ref
    wi::int_traits<double_int>::decompose(HOST_WIDE_INT* scratch,
                                          unsigned int p, const double_int& x)
{
