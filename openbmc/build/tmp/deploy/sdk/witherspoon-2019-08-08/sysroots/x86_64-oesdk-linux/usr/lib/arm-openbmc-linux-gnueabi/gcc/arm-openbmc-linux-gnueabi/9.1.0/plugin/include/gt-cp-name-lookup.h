...
void gt_ggc_mx_binding_table_s(void* x_p)
{
...
void gt_ggc_mx_binding_entry_s(void* x_p)
{
...
void gt_ggc_mx_cxx_binding(void* x_p)
{
...
void gt_ggc_mx_cp_binding_level(void* x_p)
{
...
void gt_ggc_mx_vec_cp_class_binding_va_gc_(void* x_p)
{
...
void gt_ggc_mx(struct cp_class_binding& x_r ATTRIBUTE_UNUSED)
{
...
void gt_pch_nx_binding_table_s(void* x_p)
{
    struct binding_table_s* const x = (struct binding_table_s*)x_p;
...
void gt_pch_nx_binding_entry_s(void* x_p)
{
    struct binding_entry_s* const x = (struct binding_entry_s*)x_p;
...
void gt_pch_nx_cxx_binding(void* x_p)
{
    struct cxx_binding* const x = (struct cxx_binding*)x_p;
...
void gt_pch_nx_cp_binding_level(void* x_p)
{
    struct cp_binding_level* const x = (struct cp_binding_level*)x_p;
...
void gt_pch_nx_vec_cp_class_binding_va_gc_(void* x_p)
{
    vec<cp_class_binding, va_gc>* const x = (vec<cp_class_binding, va_gc>*)x_p;
...
void gt_pch_nx(struct cp_class_binding& x_r ATTRIBUTE_UNUSED)
{
    struct cp_class_binding* ATTRIBUTE_UNUSED x = &x_r;
...
void gt_pch_p_15binding_table_s(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                ...
                                ATTRIBUTE_UNUSED void* cookie)
{
    struct binding_table_s* x ATTRIBUTE_UNUSED = (struct binding_table_s*)x_p;
    {
        ...
        {
            size_t i0;
            for (i0 = 0; i0 != (size_t)(l0) && ((void*)(*x).chain == this_obj);
                 i0++)
            {
...
void gt_pch_p_15binding_entry_s(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                ATTRIBUTE_UNUSED gt_pointer_operator op,
                                ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_11cxx_binding(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                            ATTRIBUTE_UNUSED gt_pointer_operator op,
                            ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_16cp_binding_level(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                 ATTRIBUTE_UNUSED gt_pointer_operator op,
                                 ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_27vec_cp_class_binding_va_gc_(
    ATTRIBUTE_UNUSED void* this_obj, void* x_p,
    ATTRIBUTE_UNUSED gt_pointer_operator op, ATTRIBUTE_UNUSED void* cookie)
{
    struct vec<cp_class_binding, va_gc>* x ATTRIBUTE_UNUSED =
        (struct vec<cp_class_binding, va_gc>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_nx(struct cp_class_binding* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
    op(&((*x).base), cookie);
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_cp_name_lookup_h[] = {
    {&extern_c_decls, 1, sizeof(extern_c_decls),
