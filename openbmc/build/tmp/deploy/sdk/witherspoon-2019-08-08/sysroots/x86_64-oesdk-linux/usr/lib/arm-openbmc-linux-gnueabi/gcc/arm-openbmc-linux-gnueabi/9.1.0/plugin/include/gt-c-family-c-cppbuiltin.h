...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_c_family_c_cppbuiltin_h[] = {
    {&lazy_hex_fp_values[0].hex_str, 1 * (LAZY_HEX_FP_VALUES_CNT),
     sizeof(lazy_hex_fp_values[0]), (gt_pointer_walker)&gt_ggc_m_S,
     (gt_pointer_walker)&gt_pch_n_S},
    {&lazy_hex_fp_values[0].fp_suffix, 1 * (LAZY_HEX_FP_VALUES_CNT),
     sizeof(lazy_hex_fp_values[0]), (gt_pointer_walker)&gt_ggc_m_S,
     (gt_pointer_walker)&gt_pch_n_S},
    LAST_GGC_ROOT_TAB};
