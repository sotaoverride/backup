...
void gt_ggc_mx_odr_type_d(void* x_p)
{
...
void gt_ggc_mx_vec_odr_type_va_gc_(void* x_p)
{
...
void gt_ggc_mx(struct odr_type_d*& x)
{
    if (x)
        gt_ggc_mx_odr_type_d((void*)x);
}

void gt_pch_nx_odr_type_d(void* x_p)
{
    struct odr_type_d* const x = (struct odr_type_d*)x_p;
...
void gt_pch_nx_vec_odr_type_va_gc_(void* x_p)
{
    vec<odr_type, va_gc>* const x = (vec<odr_type, va_gc>*)x_p;
...
void gt_pch_nx(struct odr_type_d*& x)
{
    if (x)
        gt_pch_nx_odr_type_d((void*)x);
}

void gt_pch_p_10odr_type_d(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
...
void gt_pch_p_19vec_odr_type_va_gc_(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                    ATTRIBUTE_UNUSED gt_pointer_operator op,
                                    ATTRIBUTE_UNUSED void* cookie)
{
    struct vec<odr_type, va_gc>* x ATTRIBUTE_UNUSED =
        (struct vec<odr_type, va_gc>*)x_p;
    if ((void*)(x) == this_obj)
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_ipa_devirt_h[] = {
    {&odr_types_ptr, 1, sizeof(odr_types_ptr), &gt_ggc_mx_vec_odr_type_va_gc_,
