...
struct obstack /* control current object in current chunk */
{
    ...
    unsigned
        maybe_empty_object : 1; /* There is a possibility that the current
...
#define obstack_make_room(h, length)                                           \
    ((h)->temp.i = (length),                                                   \
     ((obstack_room(h) < (h)->temp.i) ? (_obstack_newchunk(h, (h)->temp.i), 0) \
                                      : 0),                                    \
     (void)0)
...
#define obstack_grow(h, where, length)                                         \
    ((h)->temp.i = (length),                                                   \
     ((obstack_room(h) < (h)->temp.i)                                          \
          ? (_obstack_newchunk((h), (h)->temp.i), 0)                           \
          : 0),                                                                \
     memcpy((h)->next_free, where, (h)->temp.i),                               \
     (h)->next_free += (h)->temp.i, (void)0)

#define obstack_grow0(h, where, length)                                        \
    ((h)->temp.i = (length),                                                   \
     ((obstack_room(h) < (h)->temp.i + 1)                                      \
          ? (_obstack_newchunk((h), (h)->temp.i + 1), 0)                       \
          : 0),                                                                \
     memcpy((h)->next_free, where, (h)->temp.i),                               \
     (h)->next_free += (h)->temp.i, *((h)->next_free)++ = 0, (void)0)

#define obstack_1grow(h, datum)                                                \
    (((obstack_room(h) < 1) ? (_obstack_newchunk((h), 1), 0) : 0),             \
