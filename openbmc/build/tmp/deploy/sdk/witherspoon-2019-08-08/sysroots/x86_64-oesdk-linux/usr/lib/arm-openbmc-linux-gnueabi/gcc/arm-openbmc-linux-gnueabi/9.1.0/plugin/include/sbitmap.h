...
static inline void bmp_iter_set_init(sbitmap_iterator* i, const_sbitmap bmp,
                                     unsigned int min,
...
static inline void bmp_iter_next(sbitmap_iterator* i,
                                 unsigned* bit_no ATTRIBUTE_UNUSED)
{
    i->word >>= 1;
    i->bit_num++;
...
extern bool bitmap_ior_and_compl(sbitmap, const_sbitmap, const_sbitmap,
                                 const_sbitmap);
