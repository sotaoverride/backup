...
void gt_ggc_mx_c_parser(void* x_p)
{
...
void gt_pch_nx_c_parser(void* x_p)
{
    struct c_parser* const x = (struct c_parser*)x_p;
...
void gt_pch_p_8c_parser(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_c_c_parser_h[] = {
    {&the_parser, 1, sizeof(the_parser), &gt_ggc_mx_c_parser,
     &gt_pch_nx_c_parser},
    LAST_GGC_ROOT_TAB};
