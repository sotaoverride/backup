...
#define MARK_TS_TYPED(C)                                                       \
    (MARK_TS_BASE(C), tree_contains_struct[C][TS_TYPED] = true)

#define MARK_TS_COMMON(C)                                                      \
    (MARK_TS_TYPED(C), tree_contains_struct[C][TS_COMMON] = true)

#define MARK_TS_TYPE_COMMON(C)                                                 \
    (MARK_TS_COMMON(C), tree_contains_struct[C][TS_TYPE_COMMON] = true)
...
#define MARK_TS_DECL_MINIMAL(C)                                                \
    (MARK_TS_COMMON(C), tree_contains_struct[C][TS_DECL_MINIMAL] = true)

#define MARK_TS_DECL_COMMON(C)                                                 \
    (MARK_TS_DECL_MINIMAL(C), tree_contains_struct[C][TS_DECL_COMMON] = true)

#define MARK_TS_DECL_WRTL(C)                                                   \
    (MARK_TS_DECL_COMMON(C), tree_contains_struct[C][TS_DECL_WRTL] = true)
...
#define TREE_NOT_CHECK3(T, CODE1, CODE2, CODE3)                                \
    (tree_not_check3((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2),  \
                     (CODE3)))

#define TREE_CHECK4(T, CODE1, CODE2, CODE3, CODE4)                             \
    (tree_check4((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2),      \
                 (CODE3), (CODE4)))

#define TREE_NOT_CHECK4(T, CODE1, CODE2, CODE3, CODE4)                         \
    (tree_not_check4((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2),  \
                     (CODE3), (CODE4)))

#define TREE_CHECK5(T, CODE1, CODE2, CODE3, CODE4, CODE5)                      \
    (tree_check5((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2),      \
                 (CODE3), (CODE4), (CODE5)))

#define TREE_NOT_CHECK5(T, CODE1, CODE2, CODE3, CODE4, CODE5)                  \
    (tree_not_check5((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2),  \
                     (CODE3), (CODE4), (CODE5)))
...
#define OMP_CLAUSE_RANGE_CHECK(T, CODE1, CODE2)                                \
    (omp_clause_range_check((T), (CODE1), (CODE2), __FILE__, __LINE__,         \
                            __FUNCTION__))
...
#define TREE_OPERAND_CHECK_CODE(T, CODE, I)                                    \
    (*(tree_operand_check_code((T), (CODE), (I), __FILE__, __LINE__,           \
                               __FUNCTION__)))
...
extern void tree_contains_struct_check_failed(
    const_tree, const enum tree_node_structure_enum, const char*, int,
...
extern void tree_not_check_failed(const_tree, const char*, int, const char*,
                                  ...) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void
    tree_class_check_failed(const_tree, const enum tree_code_class, const char*,
                            int, const char*) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_range_check_failed(const_tree, const char*, int, const char*,
                                    enum tree_code, enum tree_code)
    ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_not_class_check_failed(const_tree, const enum tree_code_class,
                                        const char*, int, const char*)
    ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_int_cst_elt_check_failed(
    int, int, const char*, int, const char*) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_vec_elt_check_failed(int, int, const char*, int, const char*)
    ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void phi_node_elt_check_failed(int, int, const char*, int, const char*)
    ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void
    tree_operand_check_failed(int, const_tree, const char*, int,
                              const char*) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
...
extern void omp_clause_operand_check_failed(int, const_tree, const char*, int,
                                            const char*)
    ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void omp_clause_range_check_failed(
    const_tree, const char*, int, const char*, enum omp_clause_code,
...
#define ANY_INTEGRAL_TYPE_P(TYPE)                                              \
    (INTEGRAL_TYPE_P(TYPE) ||                                                  \
     ((TREE_CODE(TYPE) == COMPLEX_TYPE || VECTOR_TYPE_P(TYPE)) &&              \
...
#define VECTOR_FLOAT_TYPE_P(TYPE)                                              \
    (VECTOR_TYPE_P(TYPE) && TREE_CODE(TREE_TYPE(TYPE)) == REAL_TYPE)
...
#define DECL_NONSHAREABLE(NODE)                                                \
    (TREE_CHECK2(NODE, VAR_DECL, RESULT_DECL)                                  \
...
#define EXPR_HAS_LOCATION(NODE)                                                \
    (LOCATION_LOCUS(EXPR_LOCATION(NODE)) != UNKNOWN_LOCATION)
/* The location to be used in a diagnostic about this expression.  Do not
   use this macro if the location will be assigned to other expressions.  */
#define EXPR_LOC_OR_LOC(NODE, LOCUS)                                           \
    (EXPR_HAS_LOCATION(NODE) ? (NODE)->exp.locus : (LOCUS))
...
#define OMP_ATOMIC_MEMORY_ORDER(NODE)                                          \
    (TREE_RANGE_CHECK(NODE, OMP_ATOMIC, OMP_ATOMIC_CAPTURE_NEW)                \
...
#define OMP_CLAUSE_LASTPRIVATE_STMT(NODE)                                      \
    OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_LASTPRIVATE), \
                       1)
...
#define OMP_CLAUSE_NUM_THREADS_EXPR(NODE)                                      \
    OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_NUM_THREADS), \
                       0)
...
#define OMP_CLAUSE_NUM_WORKERS_EXPR(NODE)                                      \
    OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_NUM_WORKERS), \
                       0)
...
#define OMP_CLAUSE_SET_MAP_KIND(NODE, MAP_KIND)                                \
    (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_MAP)                            \
         ->omp_clause.subcode.map_kind = (unsigned int)(MAP_KIND))
...
#define OMP_CLAUSE_PROC_BIND_KIND(NODE)                                        \
    (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_PROC_BIND)                      \
...
#define OMP_CLAUSE_LINEAR_KIND(NODE)                                           \
    (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_LINEAR)                         \
...
#define OMP_CLAUSE_THREAD_LIMIT_EXPR(NODE)                                     \
    OMP_CLAUSE_OPERAND(                                                        \
        OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_THREAD_LIMIT), 0)
...
#define OMP_CLAUSE_DIST_SCHEDULE_CHUNK_EXPR(NODE)                              \
    OMP_CLAUSE_OPERAND(                                                        \
        OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DIST_SCHEDULE), 0)
...
#define OMP_CLAUSE_SCHEDULE_KIND(NODE)                                         \
    (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_SCHEDULE)                       \
...
#define OMP_CLAUSE_DEFAULT_KIND(NODE)                                          \
    (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DEFAULT)                        \
         ->omp_clause.subcode.default_kind)

#define OMP_CLAUSE_DEFAULTMAP_KIND(NODE)                                       \
    (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DEFAULTMAP)                     \
...
#define TYPE_MODE(NODE)                                                        \
    (VECTOR_TYPE_P(TYPE_CHECK(NODE)) ? vector_type_mode(NODE)                  \
                                     : (NODE)->type_common.mode)
...
#define TYPE_IDENTIFIER(NODE)                                                  \
    (TYPE_NAME(NODE) && DECL_P(TYPE_NAME(NODE)) ? DECL_NAME(TYPE_NAME(NODE))   \
                                                : TYPE_NAME(NODE))
...
inline tree tree_not_check(tree __t, const char* __f, int __l, const char* __g,
                           enum tree_code __c)
{
    if (TREE_CODE(__t) == __c)
...
inline tree tree_check2(tree __t, const char* __f, int __l, const char* __g,
...
inline tree tree_check3(tree __t, const char* __f, int __l, const char* __g,
                        enum tree_code __c1, enum tree_code __c2,
                        enum tree_code __c3)
{
    if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 &&
...
inline tree tree_check4(tree __t, const char* __f, int __l, const char* __g,
                        enum tree_code __c1, enum tree_code __c2,
                        enum tree_code __c3, enum tree_code __c4)
{
    if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 &&
        TREE_CODE(__t) != __c3 && TREE_CODE(__t) != __c4)
...
inline tree tree_check5(tree __t, const char* __f, int __l, const char* __g,
                        enum tree_code __c1, enum tree_code __c2,
                        enum tree_code __c3, enum tree_code __c4,
                        enum tree_code __c5)
{
...
inline tree contains_struct_check(tree __t,
...
inline tree tree_class_check(tree __t, const enum tree_code_class __class,
                             const char* __f, int __l, const char* __g)
{
...
inline tree tree_range_check(tree __t, enum tree_code __code1,
                             enum tree_code __code2, const char* __f, int __l,
                             const char* __g)
{
...
inline tree omp_clause_subcode_check(tree __t, enum omp_clause_code __code,
                                     const char* __f, int __l, const char* __g)
{
...
inline const HOST_WIDE_INT* tree_int_cst_elt_check(const_tree __t, int __i,
                                                   const char* __f, int __l,
                                                   const char* __g)
{
    if (TREE_CODE(__t) != INTEGER_CST)
        tree_check_failed(__t, __f, __l, __g, INTEGER_CST, 0);
    if (__i < 0 || __i >= __t->base.u.int_length.extended)
        tree_int_cst_elt_check_failed(__i, __t->base.u.int_length.extended, __f,
                                      __l, __g);
    return &CONST_CAST_TREE(__t)->int_cst.val[__i];
}

inline HOST_WIDE_INT* tree_int_cst_elt_check(tree __t, int __i, const char* __f,
...
inline tree* tree_vec_elt_check(tree __t, int __i, const char* __f, int __l,
                                const char* __g)
{
...
inline tree* omp_clause_elt_check(tree __t, int __i, const char* __f, int __l,
                                  const char* __g)
{
    if (TREE_CODE(__t) != OMP_CLAUSE)
        tree_check_failed(__t, __f, __l, __g, OMP_CLAUSE, 0);
...
inline tree any_integral_type_check(tree __t, const char* __f, int __l,
                                    const char* __g)
{
...
inline const_tree tree_check(const_tree __t, const char* __f, int __l,
...
inline const_tree tree_not_check(const_tree __t, const char* __f, int __l,
                                 const char* __g, enum tree_code __c)
{
    if (TREE_CODE(__t) == __c)
        tree_not_check_failed(__t, __f, __l, __g, __c, 0);
    return __t;
...
inline const_tree tree_check2(const_tree __t, const char* __f, int __l,
                              const char* __g, enum tree_code __c1,
                              enum tree_code __c2)
{
    if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2)
        tree_check_failed(__t, __f, __l, __g, __c1, __c2, 0);
...
inline const_tree tree_not_check2(const_tree __t, const char* __f, int __l,
                                  const char* __g, enum tree_code __c1,
                                  enum tree_code __c2)
{
    if (TREE_CODE(__t) == __c1 || TREE_CODE(__t) == __c2)
...
inline const_tree tree_check3(const_tree __t, const char* __f, int __l,
                              const char* __g, enum tree_code __c1,
...
inline const_tree tree_not_check3(const_tree __t, const char* __f, int __l,
                                  const char* __g, enum tree_code __c1,
                                  enum tree_code __c2, enum tree_code __c3)
{
    if (TREE_CODE(__t) == __c1 || TREE_CODE(__t) == __c2 ||
...
inline const_tree tree_check4(const_tree __t, const char* __f, int __l,
                              const char* __g, enum tree_code __c1,
                              enum tree_code __c2, enum tree_code __c3,
                              enum tree_code __c4)
{
...
inline const_tree tree_not_check4(const_tree __t, const char* __f, int __l,
                                  const char* __g, enum tree_code __c1,
                                  enum tree_code __c2, enum tree_code __c3,
                                  enum tree_code __c4)
{
...
inline const_tree tree_check5(const_tree __t, const char* __f, int __l,
                              const char* __g, enum tree_code __c1,
                              enum tree_code __c2, enum tree_code __c3,
...
inline const_tree tree_not_check5(const_tree __t, const char* __f, int __l,
                                  const char* __g, enum tree_code __c1,
                                  enum tree_code __c2, enum tree_code __c3,
                                  enum tree_code __c4, enum tree_code __c5)
{
...
inline const_tree contains_struct_check(const_tree __t,
                                        const enum tree_node_structure_enum __s,
                                        const char* __f, int __l,
                                        const char* __g)
{
...
inline const_tree tree_class_check(const_tree __t,
...
inline const_tree tree_range_check(const_tree __t, enum tree_code __code1,
                                   enum tree_code __code2, const char* __f,
                                   int __l, const char* __g)
{
    if (TREE_CODE(__t) < __code1 || TREE_CODE(__t) > __code2)
        tree_range_check_failed(__t, __f, __l, __g, __code1, __code2);
...
inline const_tree omp_clause_subcode_check(const_tree __t,
...
inline const_tree omp_clause_range_check(const_tree __t,
...
inline const_tree expr_check(const_tree __t, const char* __f, int __l,
                             const char* __g)
{
    char const __c = TREE_CODE_CLASS(TREE_CODE(__t));
    if (!IS_EXPR_CODE_CLASS(__c))
...
inline const_tree non_type_check(const_tree __t, const char* __f, int __l,
                                 const char* __g)
{
    if (TYPE_P(__t))
        tree_not_class_check_failed(__t, tcc_type, __f, __l, __g);
...
inline const_tree* tree_vec_elt_check(const_tree __t, int __i, const char* __f,
                                      int __l, const char* __g)
{
    if (TREE_CODE(__t) != TREE_VEC)
        tree_check_failed(__t, __f, __l, __g, TREE_VEC, 0);
...
inline const_tree* omp_clause_elt_check(const_tree __t, int __i,
                                        const char* __f, int __l,
                                        const char* __g)
{
    if (TREE_CODE(__t) != OMP_CLAUSE)
...
inline const_tree any_integral_type_check(const_tree __t, const char* __f,
                                          int __l, const char* __g)
{
    if (!ANY_INTEGRAL_TYPE_P(__t))
        tree_check_failed(__t, __f, __l, __g, BOOLEAN_TYPE, ENUMERAL_TYPE,
...
/* Special checks for TREE_OPERANDs.  */
inline tree* tree_operand_check(tree __t, int __i, const char* __f, int __l,
                                const char* __g)
{
...
inline tree* tree_operand_check_code(tree __t, enum tree_code __code, int __i,
                                     const char* __f, int __l, const char* __g)
{
...
inline const_tree* tree_operand_check(const_tree __t, int __i, const char* __f,
                                      int __l, const char* __g)
{
    const_tree __u = EXPR_CHECK(__t);
    if (__i < 0 || __i >= TREE_OPERAND_LENGTH(__u))
...
inline const_tree* tree_operand_check_code(const_tree __t,
                                           enum tree_code __code, int __i,
                                           const char* __f, int __l,
                                           const char* __g)
{
    if (TREE_CODE(__t) != __code)
...
static inline tree build2_loc(location_t loc, enum tree_code code, tree type,
                              tree arg0, tree arg1 CXX_MEM_STAT_INFO)
{
...
static inline tree build3_loc(location_t loc, enum tree_code code, tree type,
                              tree arg0, tree arg1, tree arg2 CXX_MEM_STAT_INFO)
{
...
static inline tree build4_loc(location_t loc, enum tree_code code, tree type,
...
static inline tree build5_loc(location_t loc, enum tree_code code, tree type,
                              tree arg0, tree arg1, tree arg2, tree arg3,
...
extern tree build_decl(location_t, enum tree_code, tree,
                       tree CXX_MEM_STAT_INFO);
...
extern tree build_call_expr_internal_loc(location_t, enum internal_fn, tree,
                                         int, ...);
...
static inline void function_args_iter_init(function_args_iterator* i,
                                           const_tree fntype)
{
...
static inline bool truth_value_p(enum tree_code code)
{
    return (TREE_CODE_CLASS(code) == tcc_comparison || code == TRUTH_AND_EXPR ||
            code == TRUTH_ANDIF_EXPR || code == TRUTH_OR_EXPR ||
            code == TRUTH_ORIF_EXPR || code == TRUTH_XOR_EXPR ||
            code == TRUTH_NOT_EXPR);
}
...
extern bool
    gimple_canonical_types_compatible_p(const_tree, const_tree,
...
{
    return !(POINTER_TYPE_P(t) || TREE_CODE(t) == ARRAY_TYPE ||
...
static inline void init_call_expr_arg_iterator(tree exp,
...
static inline const_tree
    first_const_call_expr_arg(const_tree exp,
                              const_call_expr_arg_iterator* iter)
{
...
static inline void set_builtin_decl(enum built_in_function fncode, tree decl,
                                    bool implicit_p)
{
...
static inline void set_builtin_decl_implicit_p(enum built_in_function fncode,
                                               bool implicit_p)
{
    size_t uns_fncode = (size_t)fncode;
...
static inline void set_builtin_decl_declared_p(enum built_in_function fncode,
                                               bool declared_p)
{
    size_t uns_fncode = (size_t)fncode;
...
static inline bool may_be_aliased(const_tree var)
{
    return (TREE_CODE(var) != CONST_DECL &&
            ...
            !((TREE_STATIC(var) || TREE_PUBLIC(var) || DECL_EXTERNAL(var)) &&
              (TREE_READONLY(var) ||
               (TREE_CODE(var) == VAR_DECL && DECL_NONALIASED(var)))));
}
...
template <int N>
inline wi::extended_tree<N>::extended_tree(const_tree t) : m_t(t)
{
    gcc_checking_assert(TYPE_PRECISION(TREE_TYPE(t)) <= N);
}

template <int N>
inline unsigned int wi::extended_tree<N>::get_precision() const
{
    return N;
}

template <int N>
inline const HOST_WIDE_INT* wi::extended_tree<N>::get_val() const
{
    return &TREE_INT_CST_ELT(m_t, 0);
}

template <int N>
inline unsigned int wi::extended_tree<N>::get_len() const
{
...
inline wi::tree_to_poly_widest_ref wi::to_poly_widest(const_tree t)
{
    if (POLY_INT_CST_P(t))
    {
        poly_int<NUM_POLY_INT_COEFFS, generic_wide_int<widest_extended_tree>>
            res;
        for (unsigned int i = 0; i < NUM_POLY_INT_COEFFS; ++i)
...
inline wi::tree_to_poly_offset_ref wi::to_poly_offset(const_tree t)
{
    if (POLY_INT_CST_P(t))
    {
        poly_int<NUM_POLY_INT_COEFFS, generic_wide_int<offset_extended_tree>>
            res;
        for (unsigned int i = 0; i < NUM_POLY_INT_COEFFS; ++i)
            res.coeffs[i] = POLY_INT_CST_COEFF(t, i);
        return res;
...
template <typename T>
bool wi::fits_to_boolean_p(const T& x, const_tree type)
{
...
extern tree get_inner_reference(tree, poly_int64_pod*, poly_int64_pod*, tree*,
...
extern location_t set_source_range(tree expr, location_t start,
                                   location_t finish);
