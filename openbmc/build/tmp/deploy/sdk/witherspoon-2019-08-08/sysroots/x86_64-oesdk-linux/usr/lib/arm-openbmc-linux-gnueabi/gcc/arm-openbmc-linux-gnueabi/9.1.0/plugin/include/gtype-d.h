...
void gt_ggc_mx_lang_tree_node(void* x_p)
{
    ...
    while (ggc_test_and_set_mark(xlimit))
        xlimit = (CODE_CONTAINS_STRUCT(TREE_CODE(&(*xlimit).generic), TS_COMMON)
                      ? ((union lang_tree_node*)TREE_CHAIN(&(*xlimit).generic))
                      : NULL);
    while (x != xlimit)
    {
        ...
        x = (CODE_CONTAINS_STRUCT(TREE_CODE(&(*x).generic), TS_COMMON)
                 ? ((union lang_tree_node*)TREE_CHAIN(&(*x).generic))
                 : NULL);
    }
}
...
void gt_ggc_mx_Statement(void* x_p)
{
...
void gt_ggc_mx_binding_level(void* x_p)
{
...
void gt_ggc_mx_d_label_use_entry(void* x_p)
{
...
void gt_ggc_mx_hash_map_Statement__d_label_entry_(void* x_p)
{
    hash_map<Statement*, d_label_entry>* const x =
        (hash_map<Statement*, d_label_entry>*)x_p;
    if (ggc_test_and_set_mark(x))
    {
        gt_ggc_mx(x);
    }
...
void gt_ggc_mx(struct d_label_entry& x_r ATTRIBUTE_UNUSED)
{
...
void gt_ggc_mx(struct Statement*& x)
{
    if (x)
...
void gt_pch_nx_Statement(void* x_p)
{
    struct Statement* const x = (struct Statement*)x_p;
...
void gt_pch_nx_binding_level(void* x_p)
{
    struct binding_level* x = (struct binding_level*)x_p;
    struct binding_level* xlimit = x;
...
void gt_pch_nx_d_label_use_entry(void* x_p)
{
    struct d_label_use_entry* x = (struct d_label_use_entry*)x_p;
    struct d_label_use_entry* xlimit = x;
...
void gt_pch_nx_hash_map_Statement__d_label_entry_(void* x_p)
{
    hash_map<Statement*, d_label_entry>* const x =
        (hash_map<Statement*, d_label_entry>*)x_p;
...
void gt_pch_nx(struct d_label_entry& x_r ATTRIBUTE_UNUSED)
{
    struct d_label_entry* ATTRIBUTE_UNUSED x = &x_r;
...
void gt_pch_nx(struct Statement*& x)
{
    if (x)
...
void gt_pch_p_9Statement(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                         ATTRIBUTE_UNUSED gt_pointer_operator op,
                         ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_13binding_level(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                              ATTRIBUTE_UNUSED gt_pointer_operator op,
                              ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_17d_label_use_entry(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                  ATTRIBUTE_UNUSED gt_pointer_operator op,
                                  ATTRIBUTE_UNUSED void* cookie)
{
    struct d_label_use_entry* x ATTRIBUTE_UNUSED =
        (struct d_label_use_entry*)x_p;
    if ((void*)(x) == this_obj)
        op(&((*x).next), cookie);
    if ((void*)(x) == this_obj)
        op(&((*x).level), cookie);
...
void gt_pch_p_34hash_map_Statement__d_label_entry_(
    ATTRIBUTE_UNUSED void* this_obj, void* x_p,
    ATTRIBUTE_UNUSED gt_pointer_operator op, ATTRIBUTE_UNUSED void* cookie)
{
    struct hash_map<Statement*, d_label_entry>* x ATTRIBUTE_UNUSED =
        (struct hash_map<Statement*, d_label_entry>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_nx(struct d_label_entry* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
    op(&((*x).label), cookie);
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_d_h[] = {
    {&d_global_trees[0], 1 * (DTI_MAX), sizeof(d_global_trees[0]),
     &gt_ggc_mx_tree_node, &gt_pch_nx_tree_node},
    {&global_binding_level, 1, sizeof(global_binding_level),
     &gt_ggc_mx_binding_level, &gt_pch_nx_binding_level},
    {&current_binding_level, 1, sizeof(current_binding_level),
     &gt_ggc_mx_binding_level, &gt_pch_nx_binding_level},
    LAST_GGC_ROOT_TAB};
...
extern const struct ggc_root_tab gt_ggc_r_gt_d_modules_h[];
...
EXPORTED_CONST struct ggc_root_tab* const gt_ggc_deletable_rtab[] = {
    gt_ggc_rd_gt_alias_h,         gt_ggc_rd_gt_bitmap_h,
    gt_ggc_rd_gt_emit_rtl_h,      gt_ggc_rd_gt_ggc_tests_h,
    gt_ggc_rd_gt_lists_h,         gt_ggc_rd_gt_tree_iterator_h,
    gt_ggc_rd_gt_tree_phinodes_h, NULL};
...
EXPORTED_CONST struct ggc_root_tab* const gt_pch_scalar_rtab[] = {
    gt_pch_rs_gt_alias_h,     gt_pch_rs_gt_dbxout_h,
    gt_pch_rs_gt_dwarf2asm_h, gt_pch_rs_gt_dwarf2cfi_h,
    gt_pch_rs_gt_dwarf2out_h, gt_pch_rs_gt_tree_vect_generic_h,
    gt_pch_rs_gt_emit_rtl_h,  gt_pch_rs_gt_function_h,
    gt_pch_rs_gt_except_h,    gt_pch_rs_gt_tree_h,
    gt_pch_rs_gt_varasm_h,    gt_pch_rs_gt_gimple_expr_h,
    gt_pch_rs_gt_arm_h,       gt_pch_rs_gt_ubsan_h,
    gt_pch_rs_gtype_desc_c,   NULL};
