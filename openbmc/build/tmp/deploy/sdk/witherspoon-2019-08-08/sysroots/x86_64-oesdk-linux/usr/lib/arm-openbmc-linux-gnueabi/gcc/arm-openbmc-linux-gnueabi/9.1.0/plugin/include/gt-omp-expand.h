...
void gt_ggc_mx_grid_launch_attributes_trees(void* x_p)
{
    struct grid_launch_attributes_trees* const x =
        (struct grid_launch_attributes_trees*)x_p;
...
void gt_pch_nx_grid_launch_attributes_trees(void* x_p)
{
    struct grid_launch_attributes_trees* const x =
        (struct grid_launch_attributes_trees*)x_p;
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_omp_expand_h[] = {
    {&grid_attr_trees, 1, sizeof(grid_attr_trees),
