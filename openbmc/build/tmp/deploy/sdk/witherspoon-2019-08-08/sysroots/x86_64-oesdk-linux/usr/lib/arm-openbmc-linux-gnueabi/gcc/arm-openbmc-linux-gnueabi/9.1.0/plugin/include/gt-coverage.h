...
void gt_ggc_mx_coverage_data(void* x_p)
{
...
void gt_pch_nx_coverage_data(void* x_p)
{
    struct coverage_data* x = (struct coverage_data*)x_p;
    struct coverage_data* xlimit = x;
...
void gt_pch_p_13coverage_data(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_coverage_h[] = {
    {&gcov_fn_info_ptr_type, 1, sizeof(gcov_fn_info_ptr_type),
     &gt_ggc_mx_tree_node, &gt_pch_nx_tree_node},
    {&gcov_fn_info_type, 1, sizeof(gcov_fn_info_type), &gt_ggc_mx_tree_node,
     &gt_pch_nx_tree_node},
    {&gcov_info_var, 1, sizeof(gcov_info_var), &gt_ggc_mx_tree_node,
     &gt_pch_nx_tree_node},
    {&fn_v_ctrs[0], 1 * (GCOV_COUNTERS), sizeof(fn_v_ctrs[0]),
     &gt_ggc_mx_tree_node, &gt_pch_nx_tree_node},
    {&functions_head, 1, sizeof(functions_head), &gt_ggc_mx_coverage_data,
