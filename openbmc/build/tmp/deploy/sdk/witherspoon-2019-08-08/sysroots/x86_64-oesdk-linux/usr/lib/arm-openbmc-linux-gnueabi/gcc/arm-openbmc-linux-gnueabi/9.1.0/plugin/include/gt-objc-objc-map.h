...
void gt_ggc_mx_objc_map_private(void* x_p)
{
...
void gt_pch_nx_objc_map_private(void* x_p)
{
    struct objc_map_private* const x = (struct objc_map_private*)x_p;
...
void gt_pch_p_16objc_map_private(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                 ...
                                 ATTRIBUTE_UNUSED void* cookie)
{
    struct objc_map_private* x ATTRIBUTE_UNUSED = (struct objc_map_private*)x_p;
    {
        ...
        {
            size_t i0;
            for (i0 = 0; i0 != (size_t)(l0) && ((void*)(*x).slots == this_obj);
                 i0++)
            {
        ...
        {
            size_t i1;
            for (i1 = 0; i1 != (size_t)(l1) && ((void*)(*x).values == this_obj);
                 i1++)
            {
