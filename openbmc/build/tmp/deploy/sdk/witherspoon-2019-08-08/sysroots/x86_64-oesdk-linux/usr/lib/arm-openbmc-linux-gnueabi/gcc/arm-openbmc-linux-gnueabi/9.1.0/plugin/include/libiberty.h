...
extern char* make_temp_file_with_prefix(const char*,
                                        const char*) ATTRIBUTE_MALLOC;
...
extern char* xstrndup(const char*,
...
extern const char* pex_one(int flags, const char* executable, char* const* argv,
                           const char* pname, const char* outname,
...
extern int pexecute(const char*, char* const*, const char*, const char*, char**,
                    char**, int);
...
__extension__ extern long long int strtoll(const char* nptr, char** endptr,
                                           int base);
#endif

#if defined(HAVE_LONG_LONG) && defined(HAVE_DECL_STRTOULL) &&                  \
    !HAVE_DECL_STRTOULL
__extension__ extern unsigned long long int strtoull(const char* nptr,
