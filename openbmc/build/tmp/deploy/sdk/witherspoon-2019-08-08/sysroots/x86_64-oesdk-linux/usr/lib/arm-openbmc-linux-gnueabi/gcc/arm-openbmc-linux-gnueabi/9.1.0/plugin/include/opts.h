...
#define CL_PARAMS                                                              \
    (1U << 16) /* Fake entry.  Used to display --param info with --help.  */
...
extern HOST_WIDE_INT integral_argument(const char* arg, int* = NULL,
                                       bool = false);
...
extern void decode_cmdline_options_to_array_default_mask(
...
extern void set_option(struct gcc_options* opts, struct gcc_options* opts_set,
                       int opt_index, HOST_WIDE_INT value, const char* arg,
                       int kind, location_t loc, diagnostic_context* dc);
extern void* option_flag_var(int opt_index, struct gcc_options* opts);
bool handle_generated_option(struct gcc_options* opts,
                             struct gcc_options* opts_set, size_t opt_index,
...
unsigned int parse_sanitizer_options(const char*, location_t, int, unsigned int,
                                     int, bool);
...
extern bool target_handle_option(
    struct gcc_options* opts, struct gcc_options* opts_set,
    const struct cl_decoded_option* decoded, unsigned int lang_mask, int kind,
    location_t loc, const struct cl_option_handlers* handlers,
    diagnostic_context* dc, void (*target_option_override_hook)(void));
...
extern void set_struct_debug_option(struct gcc_options* opts, location_t loc,
                                    const char* value);
...
extern bool parse_and_check_align_values(const char* flag, const char* name,
                                         ...
                                         bool report_error, location_t loc);
