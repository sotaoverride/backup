...
{
    __m64 result;
    __asm__ __volatile__("waddhc	%0, %1, %2"
                         : "=y"(result)
                         : "y"(a), "y"(b));
    return result;
}
...
{
    __m64 result;
    __asm__ __volatile__("waddwc	%0, %1, %2"
                         : "=y"(result)
                         : "y"(a), "y"(b));
    return result;
}
...
#define _mm_qmiabb_pi32(acc, m1, m2)                                           \
    ({                                                                         \
        ...
        __m64 _m1 = m1;                                                        \
        __m64 _m2 = m2;                                                        \
        _acc = (__m64)__builtin_arm_wqmiabb((__v2si)_acc, (__v4hi)_m1,         \
                                            (__v4hi)_m2);                      \
        _acc;                                                                  \
    })
...
#define _mm_qmiabbn_pi32(acc, m1, m2)                                          \
    ({                                                                         \
        ...
        __m64 _m1 = m1;                                                        \
        __m64 _m2 = m2;                                                        \
        _acc = (__m64)__builtin_arm_wqmiabbn((__v2si)_acc, (__v4hi)_m1,        \
                                             (__v4hi)_m2);                     \
        _acc;                                                                  \
    })
...
#define _mm_qmiabt_pi32(acc, m1, m2)                                           \
    ({                                                                         \
        ...
        __m64 _m1 = m1;                                                        \
        __m64 _m2 = m2;                                                        \
        _acc = (__m64)__builtin_arm_wqmiabt((__v2si)_acc, (__v4hi)_m1,         \
                                            (__v4hi)_m2);                      \
        _acc;                                                                  \
    })
...
#define _mm_qmiabtn_pi32(acc, m1, m2)                                          \
    ({                                                                         \
        ...
        __m64 _m1 = m1;                                                        \
        __m64 _m2 = m2;                                                        \
        _acc = (__m64)__builtin_arm_wqmiabtn((__v2si)_acc, (__v4hi)_m1,        \
                                             (__v4hi)_m2);                     \
        _acc;                                                                  \
    })
...
#define _mm_qmiatb_pi32(acc, m1, m2)                                           \
    ({                                                                         \
        ...
        __m64 _m1 = m1;                                                        \
        __m64 _m2 = m2;                                                        \
        _acc = (__m64)__builtin_arm_wqmiatb((__v2si)_acc, (__v4hi)_m1,         \
                                            (__v4hi)_m2);                      \
        _acc;                                                                  \
    })
...
#define _mm_qmiatbn_pi32(acc, m1, m2)                                          \
    ({                                                                         \
        ...
        __m64 _m1 = m1;                                                        \
        __m64 _m2 = m2;                                                        \
        _acc = (__m64)__builtin_arm_wqmiatbn((__v2si)_acc, (__v4hi)_m1,        \
                                             (__v4hi)_m2);                     \
        _acc;                                                                  \
    })
...
#define _mm_qmiatt_pi32(acc, m1, m2)                                           \
    ({                                                                         \
        ...
        __m64 _m1 = m1;                                                        \
        __m64 _m2 = m2;                                                        \
        _acc = (__m64)__builtin_arm_wqmiatt((__v2si)_acc, (__v4hi)_m1,         \
                                            (__v4hi)_m2);                      \
        _acc;                                                                  \
    })
...
#define _mm_qmiattn_pi32(acc, m1, m2)                                          \
    ({                                                                         \
        ...
        __m64 _m1 = m1;                                                        \
        __m64 _m2 = m2;                                                        \
        _acc = (__m64)__builtin_arm_wqmiattn((__v2si)_acc, (__v4hi)_m1,        \
                                             (__v4hi)_m2);                     \
        _acc;                                                                  \
    })
