...
void gt_ggc_mx_test_struct(void* x_p)
{
...
void gt_ggc_mx_test_of_length(void* x_p)
{
...
void gt_ggc_mx_test_other(void* x_p)
{
...
void gt_ggc_mx_test_of_union(void* x_p)
{
...
void gt_ggc_mx_example_base(void* x_p)
{
...
void gt_ggc_mx_test_node(void* x_p)
{
...
void gt_ggc_mx_user_struct(void* x_p)
{
...
void gt_pch_nx_test_struct(void* x_p)
{
    struct test_struct* const x = (struct test_struct*)x_p;
...
void gt_pch_nx_test_of_length(void* x_p)
{
    struct test_of_length* const x = (struct test_of_length*)x_p;
...
void gt_pch_nx_test_other(void* x_p)
{
    struct test_other* const x = (struct test_other*)x_p;
...
void gt_pch_nx_test_of_union(void* x_p)
{
    struct test_of_union* const x = (struct test_of_union*)x_p;
...
void gt_pch_nx_example_base(void* x_p)
{
    struct example_base* const x = (struct example_base*)x_p;
...
void gt_pch_nx_test_node(void* x_p)
{
    struct test_node* x = (struct test_node*)x_p;
    struct test_node* xlimit = x;
...
void gt_pch_nx_user_struct(void* x_p)
{
    user_struct* const x = (user_struct*)x_p;
...
void gt_pch_p_11test_struct(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
...
void gt_pch_p_14test_of_length(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                               ATTRIBUTE_UNUSED gt_pointer_operator op,
                               ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_10test_other(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                           ATTRIBUTE_UNUSED gt_pointer_operator op,
                           ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_13test_of_union(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                              ATTRIBUTE_UNUSED gt_pointer_operator op,
                              ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_12example_base(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                             ATTRIBUTE_UNUSED gt_pointer_operator op,
                             ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_9test_node(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                         ATTRIBUTE_UNUSED gt_pointer_operator op,
                         ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_11user_struct(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                            ATTRIBUTE_UNUSED gt_pointer_operator op,
                            ATTRIBUTE_UNUSED void* cookie)
{
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_ggc_tests_h[] = {
    {&dummy_unittesting_tree, 1, sizeof(dummy_unittesting_tree),
     &gt_ggc_mx_tree_node, &gt_pch_nx_tree_node},
    {&root_user_struct_ptr, 1, sizeof(root_user_struct_ptr),
     &gt_ggc_mx_user_struct, &gt_pch_nx_user_struct},
    {&root_test_node, 1, sizeof(root_test_node), &gt_ggc_mx_test_node,
     &gt_pch_nx_test_node},
    {&test_some_other_subclass_as_base_ptr, 1,
     sizeof(test_some_other_subclass_as_base_ptr), &gt_ggc_mx_example_base,
     &gt_pch_nx_example_base},
    {&test_some_subclass_as_base_ptr, 1, sizeof(test_some_subclass_as_base_ptr),
     &gt_ggc_mx_example_base, &gt_pch_nx_example_base},
    {&test_some_other_subclass, 1, sizeof(test_some_other_subclass),
     &gt_ggc_mx_example_base, &gt_pch_nx_example_base},
    {&test_some_subclass, 1, sizeof(test_some_subclass),
     &gt_ggc_mx_example_base, &gt_pch_nx_example_base},
    {&test_example_base, 1, sizeof(test_example_base), &gt_ggc_mx_example_base,
     &gt_pch_nx_example_base},
    {&root_test_of_union_2, 1, sizeof(root_test_of_union_2),
     &gt_ggc_mx_test_of_union, &gt_pch_nx_test_of_union},
    {&root_test_of_union_1, 1, sizeof(root_test_of_union_1),
     &gt_ggc_mx_test_of_union, &gt_pch_nx_test_of_union},
    {&root_test_of_length, 1, sizeof(root_test_of_length),
     &gt_ggc_mx_test_of_length, &gt_pch_nx_test_of_length},
    {&root_test_struct, 1, sizeof(root_test_struct), &gt_ggc_mx_test_struct,
