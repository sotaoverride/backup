...
void gt_ggc_mx_dw_cfa_location(void* x_p)
{
...
void gt_ggc_mx_dw_cfi_row(void* x_p)
{
...
void gt_ggc_mx_reg_saved_in_data(void* x_p)
{
...
void gt_pch_nx_dw_cfa_location(void* x_p)
{
    struct dw_cfa_location* const x = (struct dw_cfa_location*)x_p;
...
void gt_pch_nx_dw_cfi_row(void* x_p)
{
    struct dw_cfi_row* const x = (struct dw_cfi_row*)x_p;
...
void gt_pch_nx_reg_saved_in_data(void* x_p)
{
    struct reg_saved_in_data* const x = (struct reg_saved_in_data*)x_p;
...
void gt_pch_p_15dw_cfa_location(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
...
void gt_pch_p_10dw_cfi_row(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                           ATTRIBUTE_UNUSED gt_pointer_operator op,
                           ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_17reg_saved_in_data(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                  ATTRIBUTE_UNUSED gt_pointer_operator op,
                                  ATTRIBUTE_UNUSED void* cookie)
{
    struct reg_saved_in_data* x ATTRIBUTE_UNUSED =
        (struct reg_saved_in_data*)x_p;
    if ((void*)(x) == this_obj)
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_dwarf2cfi_h[] = {
    {&cie_return_save, 1, sizeof(cie_return_save), &gt_ggc_mx_reg_saved_in_data,
     &gt_pch_nx_reg_saved_in_data},
    {&cie_cfi_row, 1, sizeof(cie_cfi_row), &gt_ggc_mx_dw_cfi_row,
