...
static inline rtx_insn* insnify(rtx x)
{
    if (!x)
        return NULL;
...
static rtx_insn* invalid_rtx_rtx(rtx, rtx)
{
    gcc_unreachable();
}
...
static rtx_insn* invalid_rtx_rtx_rtx(rtx, rtx, rtx)
{
    gcc_unreachable();
}
...
static rtx_insn* invalid_rtx(rtx)
{
    gcc_unreachable();
}
...
static bool target_have_builtin_setjmp_receiver(void)
{
    return
#line 6323 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/arm.md"
        (flag_pic);
}

static rtx_insn* target_gen_builtin_setjmp_receiver(rtx x0)
{
...
static rtx_insn* target_gen_call(rtx x0, rtx opt1, rtx opt2, rtx)
{
...
static rtx_insn* invalid_rtx_rtx_rtx_rtx(rtx, rtx, rtx, rtx)
{
    gcc_unreachable();
}
...
static rtx_insn* target_gen_call_value(rtx x0, rtx x1, rtx opt2, rtx opt3, rtx)
{
...
static rtx_insn* invalid_rtx_rtx_rtx_rtx_rtx(rtx, rtx, rtx, rtx, rtx)
{
    gcc_unreachable();
}
...
static bool target_have_casesi(void)
{
    return
#line 8897 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/arm.md"
        ((TARGET_32BIT || optimize_size || flag_pic) && !target_pure_code);
}

static rtx_insn* target_gen_casesi(rtx x0, rtx x1, rtx x2, rtx x3, rtx x4)
{
...
static bool target_have_doloop_end(void)
{
    return
#line 1662 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/thumb2.md"
        (TARGET_32BIT);
}

static rtx_insn* target_gen_doloop_end(rtx x0, rtx x1)
{
...
static rtx_insn* target_gen_eh_return(rtx x0)
{
...
static rtx_insn* target_gen_epilogue(void)
{
...
static rtx_insn* invalid_void(void)
{
    gcc_unreachable();
}
...
static bool target_have_extv(void)
{
    return
#line 4418 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/arm.md"
        (arm_arch_thumb2);
}

static rtx_insn* target_gen_extv(rtx x0, rtx x1, rtx x2, rtx x3)
{
...
static bool target_have_extzv(void)
{
    return
#line 4327 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/arm.md"
        (TARGET_THUMB1 || arm_arch_thumb2);
}

static rtx_insn* target_gen_extzv(rtx x0, rtx x1, rtx x2, rtx x3)
{
...
static rtx_insn* target_gen_indirect_jump(rtx x0)
{
...
static bool target_have_insv(void)
{
    return
#line 2734 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/arm.md"
        (TARGET_ARM || arm_arch_thumb2);
}

static rtx_insn* target_gen_insv(rtx x0, rtx x1, rtx x2, rtx x3)
{
...
static rtx_insn* target_gen_jump(rtx x0)
{
...
static rtx_insn* target_gen_load_multiple(rtx x0, rtx x1, rtx x2)
{
...
static bool target_have_memory_barrier(void)
{
    return
#line 40 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/sync.md"
        (TARGET_HAVE_MEMORY_BARRIER);
}

static rtx_insn* target_gen_memory_barrier(void)
{
...
static bool target_have_prefetch(void)
{
    return
#line 11586 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/arm.md"
        (TARGET_32BIT && arm_arch5te);
}

static rtx_insn* target_gen_prefetch(rtx x0, rtx x1, rtx x2)
{
...
static rtx_insn* target_gen_probe_stack(rtx x0)
{
...
static rtx_insn* target_gen_prologue(void)
{
...
static bool target_have_return(void)
{
    return
#line 8456 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/arm.md"
        ((TARGET_ARM ||
          (TARGET_THUMB2 &&
...
static rtx_insn* target_gen_return(void)
{
...
static rtx_insn* target_gen_sibcall(rtx x0, rtx opt1, rtx opt2, rtx)
{
...
static rtx_insn* target_gen_sibcall_epilogue(void)
{
...
static rtx_insn* target_gen_sibcall_value(rtx x0, rtx x1, rtx opt2, rtx opt3,
                                          rtx)
{
...
static bool target_have_simple_return(void)
{
    return
#line 8456 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/arm.md"
        ((TARGET_ARM ||
...
static rtx_insn* target_gen_simple_return(void)
{
...
static rtx_insn* target_gen_stack_protect_combined_set(rtx x0, rtx x1)
{
...
#define TARGET_GEN_STACK_PROTECT_COMBINED_SET                                  \
    target_gen_stack_protect_combined_set
#undef TARGET_CODE_FOR_STACK_PROTECT_COMBINED_SET
#define TARGET_CODE_FOR_STACK_PROTECT_COMBINED_SET                             \
    CODE_FOR_stack_protect_combined_set
...
static rtx_insn* target_gen_stack_protect_combined_test(rtx x0, rtx x1, rtx x2)
{
...
#define TARGET_GEN_STACK_PROTECT_COMBINED_TEST                                 \
    target_gen_stack_protect_combined_test
#undef TARGET_CODE_FOR_STACK_PROTECT_COMBINED_TEST
#define TARGET_CODE_FOR_STACK_PROTECT_COMBINED_TEST                            \
    CODE_FOR_stack_protect_combined_test
...
static rtx_insn* target_gen_store_multiple(rtx x0, rtx x1, rtx x2)
{
...
static bool target_have_tablejump(void)
{
    return
#line 1916 "../../../../../../../work-shared/gcc-9.1.0-r0/gcc-9.1.0/gcc/config/arm/thumb1.md"
        (TARGET_THUMB1);
}

static rtx_insn* target_gen_tablejump(rtx x0, rtx x1)
{
...
static rtx_insn* target_gen_trap(void)
{
...
static rtx_insn* target_gen_untyped_call(rtx x0, rtx x1, rtx x2)
{
...
static rtx_insn* target_gen_untyped_return(rtx x0, rtx x1)
{
