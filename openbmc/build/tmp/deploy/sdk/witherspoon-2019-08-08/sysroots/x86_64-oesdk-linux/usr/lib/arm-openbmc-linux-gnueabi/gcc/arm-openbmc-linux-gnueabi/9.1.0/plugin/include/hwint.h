...
#define HOST_WIDE_INT_MIN                                                      \
    (HOST_WIDE_INT)(HOST_WIDE_INT_1U << (HOST_BITS_PER_WIDE_INT - 1))
...
static inline HOST_WIDE_INT sext_hwi(HOST_WIDE_INT src, unsigned int prec)
{
...
#else
    {
        ...
        HOST_WIDE_INT value_mask =
            (HOST_WIDE_INT_1U << prec) - HOST_WIDE_INT_1U;
...
static inline unsigned HOST_WIDE_INT zext_hwi(unsigned HOST_WIDE_INT src,
                                              unsigned int prec)
{
    if (prec == HOST_BITS_PER_WIDE_INT)
        return src;
