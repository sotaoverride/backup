...
static inline enum constraint_num lookup_constraint(const char* p)
{
    ...
    return (index == UCHAR_MAX ? lookup_constraint_1(p)
...
static inline void insn_extra_constraint_allows_reg_mem(enum constraint_num c,
                                                        bool* allows_reg,
                                                        bool* allows_mem)
{
...
static inline size_t insn_constraint_len(char fc,
...
extern bool insn_const_int_ok_for_constraint(HOST_WIDE_INT,
                                             enum constraint_num);
