              ...
              YYSTYPE* yyvalp]b4_locuser_formals[)
{
    yybool yynormal YY_ATTRIBUTE_UNUSED =
        (yybool)(yystackp->yysplitPoint == YY_NULLPTR);
    int yylow;
...
yygetLRActions (yyStateNum yystate, yySymbol yytoken, const short** yyconflicts)
{
    ...
    if (yyisDefaultedState(yystate) || yyindex < 0 || YYLAST < yyindex ||
    ...
    if (0 < yyn1)
    {
      ...
      if (!yys1->yyresolved)
      {
          ...
          if (0 < yynrhs)
          {
              ...
              for (yys = yyoption->yystate, yyn = yynrhs; yyn > 0;
...
yycompressStack (yyGLRStack* yystackp)
{
    ...
    for (yyp = yystackp->yytops.yystates[0], yyq = yyp->yypred,
        yyr = YY_NULLPTR;
            ...
            if (!yypact_value_is_default(yyn))
            {
                ...
                for (yyx = yyxbegin; yyx < yyxend; ++yyx)
                        ...
                        !yytable_value_is_error(yytable[yyx + yyn]))
                    {
                        ...
                        {
                            size_t yysz = yysize + yytnamerr(YY_NULLPTR,
                                                             yytokenName(yyx));
                            if (yysz < yysize)
  ...
  while (yytrue)
    {
        ...
        while (yytrue)
        {
            ...
            for (yys = 0; yys < yystack.yytops.yysize; yys += 1)
                yystackp->yytops.yylookaheadNeeds[yys] =
                    (yybool)(yychar != YYEMPTY);
            ...
            /* yyprocessOneStack returns one of three things:
                ...
                - yyok, but yyprocessOneStack has invoked yymarkStackDeleted
                  (&yystack, yys), which sets the top state of yys to NULL.
               Thus, yyparse's following invocation of yyremoveDeletes will
               remove the stack.
