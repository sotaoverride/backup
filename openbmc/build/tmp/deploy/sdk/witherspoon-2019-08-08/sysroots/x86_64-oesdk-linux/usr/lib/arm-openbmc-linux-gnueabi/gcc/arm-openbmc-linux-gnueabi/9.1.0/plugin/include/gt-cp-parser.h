...
void gt_ggc_mx_cp_token_cache(void* x_p)
{
...
void gt_ggc_mx_vec_deferred_access_check_va_gc_(void* x_p)
{
    vec<deferred_access_check, va_gc>* const x =
        (vec<deferred_access_check, va_gc>*)x_p;
    if (ggc_test_and_set_mark(x))
    {
        gt_ggc_mx(x);
    }
...
void gt_ggc_mx(struct deferred_access_check& x_r ATTRIBUTE_UNUSED)
{
...
void gt_ggc_mx_tree_check(void* x_p)
{
...
void gt_ggc_mx_vec_cp_token_va_gc_(void* x_p)
{
...
void gt_ggc_mx(struct cp_token& x_r ATTRIBUTE_UNUSED)
{
    struct cp_token* ATTRIBUTE_UNUSED x = &x_r;
    switch ((int)((((*x)).type == CPP_TEMPLATE_ID) ||
                  (((*x)).type == CPP_NESTED_NAME_SPECIFIER) ||
                  (((*x)).type == CPP_DECLTYPE)))
    {
        case 1:
...
void gt_ggc_mx_cp_lexer(void* x_p)
{
...
void gt_ggc_mx_vec_cp_default_arg_entry_va_gc_(void* x_p)
{
    vec<cp_default_arg_entry, va_gc>* const x =
        (vec<cp_default_arg_entry, va_gc>*)x_p;
    if (ggc_test_and_set_mark(x))
    {
        gt_ggc_mx(x);
    }
...
void gt_ggc_mx(struct cp_default_arg_entry& x_r ATTRIBUTE_UNUSED)
{
...
void gt_ggc_mx_cp_parser_context(void* x_p)
{
...
void gt_ggc_mx_vec_cp_unparsed_functions_entry_va_gc_(void* x_p)
{
    vec<cp_unparsed_functions_entry, va_gc>* const x =
        (vec<cp_unparsed_functions_entry, va_gc>*)x_p;
    if (ggc_test_and_set_mark(x))
    {
        gt_ggc_mx(x);
    }
...
void gt_ggc_mx(struct cp_unparsed_functions_entry& x_r ATTRIBUTE_UNUSED)
{
...
void gt_ggc_mx_cp_parser(void* x_p)
{
...
void gt_pch_nx_cp_token_cache(void* x_p)
{
    struct cp_token_cache* const x = (struct cp_token_cache*)x_p;
...
void gt_pch_nx_vec_deferred_access_check_va_gc_(void* x_p)
{
    vec<deferred_access_check, va_gc>* const x =
        (vec<deferred_access_check, va_gc>*)x_p;
...
void gt_pch_nx(struct deferred_access_check& x_r ATTRIBUTE_UNUSED)
{
    struct deferred_access_check* ATTRIBUTE_UNUSED x = &x_r;
...
void gt_pch_nx_tree_check(void* x_p)
{
    struct tree_check* const x = (struct tree_check*)x_p;
...
void gt_pch_nx_vec_cp_token_va_gc_(void* x_p)
{
    vec<cp_token, va_gc>* const x = (vec<cp_token, va_gc>*)x_p;
...
void gt_pch_nx(struct cp_token& x_r ATTRIBUTE_UNUSED)
{
    struct cp_token* ATTRIBUTE_UNUSED x = &x_r;
    switch ((int)((((*x)).type == CPP_TEMPLATE_ID) ||
                  (((*x)).type == CPP_NESTED_NAME_SPECIFIER) ||
...
void gt_pch_nx_cp_lexer(void* x_p)
{
    struct cp_lexer* const x = (struct cp_lexer*)x_p;
...
void gt_pch_nx_vec_cp_default_arg_entry_va_gc_(void* x_p)
{
    vec<cp_default_arg_entry, va_gc>* const x =
        (vec<cp_default_arg_entry, va_gc>*)x_p;
...
void gt_pch_nx(struct cp_default_arg_entry& x_r ATTRIBUTE_UNUSED)
{
    struct cp_default_arg_entry* ATTRIBUTE_UNUSED x = &x_r;
...
void gt_pch_nx_cp_parser_context(void* x_p)
{
    struct cp_parser_context* const x = (struct cp_parser_context*)x_p;
...
void gt_pch_nx_vec_cp_unparsed_functions_entry_va_gc_(void* x_p)
{
    vec<cp_unparsed_functions_entry, va_gc>* const x =
        (vec<cp_unparsed_functions_entry, va_gc>*)x_p;
    if (gt_pch_note_object(x, x,
                           gt_pch_p_38vec_cp_unparsed_functions_entry_va_gc_))
    {
        gt_pch_nx(x);
    }
}

void gt_pch_nx(struct cp_unparsed_functions_entry& x_r ATTRIBUTE_UNUSED)
{
    struct cp_unparsed_functions_entry* ATTRIBUTE_UNUSED x = &x_r;
...
void gt_pch_nx_cp_parser(void* x_p)
{
    struct cp_parser* const x = (struct cp_parser*)x_p;
...
void gt_pch_p_14cp_token_cache(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
...
void gt_pch_p_32vec_deferred_access_check_va_gc_(
    ATTRIBUTE_UNUSED void* this_obj, void* x_p,
    ATTRIBUTE_UNUSED gt_pointer_operator op, ATTRIBUTE_UNUSED void* cookie)
{
    struct vec<deferred_access_check, va_gc>* x ATTRIBUTE_UNUSED =
        (struct vec<deferred_access_check, va_gc>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_nx(struct deferred_access_check* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
    op(&((*x).binfo), cookie);
...
void gt_pch_p_10tree_check(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                           ATTRIBUTE_UNUSED gt_pointer_operator op,
                           ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_19vec_cp_token_va_gc_(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                    ATTRIBUTE_UNUSED gt_pointer_operator op,
                                    ATTRIBUTE_UNUSED void* cookie)
{
    struct vec<cp_token, va_gc>* x ATTRIBUTE_UNUSED =
        (struct vec<cp_token, va_gc>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_nx(struct cp_token* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
    switch ((int)((((*x)).type == CPP_TEMPLATE_ID) ||
...
void gt_pch_p_8cp_lexer(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                        ATTRIBUTE_UNUSED gt_pointer_operator op,
                        ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_31vec_cp_default_arg_entry_va_gc_(
    ATTRIBUTE_UNUSED void* this_obj, void* x_p,
    ATTRIBUTE_UNUSED gt_pointer_operator op, ATTRIBUTE_UNUSED void* cookie)
{
    struct vec<cp_default_arg_entry, va_gc>* x ATTRIBUTE_UNUSED =
        (struct vec<cp_default_arg_entry, va_gc>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_nx(struct cp_default_arg_entry* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_17cp_parser_context(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                                  ATTRIBUTE_UNUSED gt_pointer_operator op,
                                  ATTRIBUTE_UNUSED void* cookie)
{
    struct cp_parser_context* x ATTRIBUTE_UNUSED =
        (struct cp_parser_context*)x_p;
    if ((void*)(x) == this_obj)
...
void gt_pch_p_38vec_cp_unparsed_functions_entry_va_gc_(
    ATTRIBUTE_UNUSED void* this_obj, void* x_p,
    ATTRIBUTE_UNUSED gt_pointer_operator op, ATTRIBUTE_UNUSED void* cookie)
{
    struct vec<cp_unparsed_functions_entry, va_gc>* x ATTRIBUTE_UNUSED =
        (struct vec<cp_unparsed_functions_entry, va_gc>*)x_p;
    if ((void*)(x) == this_obj)
        gt_pch_nx(&((*x)), op, cookie);
}

void gt_pch_nx(struct cp_unparsed_functions_entry* x ATTRIBUTE_UNUSED,
               ATTRIBUTE_UNUSED gt_pointer_operator op,
               ATTRIBUTE_UNUSED void* cookie)
{
...
void gt_pch_p_9cp_parser(ATTRIBUTE_UNUSED void* this_obj, void* x_p,
                         ATTRIBUTE_UNUSED gt_pointer_operator op,
                         ATTRIBUTE_UNUSED void* cookie)
{
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_cp_parser_h[] = {
    {&the_parser, 1, sizeof(the_parser), &gt_ggc_mx_cp_parser,
     &gt_pch_nx_cp_parser},
    LAST_GGC_ROOT_TAB};

EXPORTED_CONST struct ggc_root_tab gt_ggc_rd_gt_cp_parser_h[] = {
    {&cp_parser_context_free_list, 1, sizeof(cp_parser_context_free_list), NULL,
     NULL},
    LAST_GGC_ROOT_TAB};
