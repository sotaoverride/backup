...
struct value_type
{
    ...
    typedef typename mpl::if_c<is_noncopyable<T>::value, reference, value>::type
        type;
};
...
#define BOOST_PROTO_DEFINE_ENV_VAR(TAG, NAME)                                  \
    ...
    {                                                                          \
        ...
        typename boost::disable_if_c<                                          \
            ...
            boost::proto::env<TAG, typename boost::proto::detail::value_type<  \
                                       Value>::type>>::type const              \
            operator=(Value& value) const                                      \
        {                                                                      \
            return boost::proto::env<                                          \
                TAG, typename boost::proto::detail::value_type<Value>::type>(  \
                value);                                                        \
        }                                                                      \
        template <typename Value>                                              \
        boost::proto::env<TAG, typename boost::proto::detail::value_type<      \
        ...
        {                                                                      \
            return boost::proto::env<                                          \
                TAG,                                                           \
                typename boost::proto::detail::value_type<Value const>::type>( \
                value);                                                        \
        }                                                                      \
    };                                                                         \
                                                                               \
...
struct env : private Base
{
  ...
  public:
    ...
    typedef typename add_reference<typename add_const<Value>::type>::type
        const_reference;
    ...
    struct lookup
        : mpl::if_c<is_same<OtherKey, Key>::value, found,
...
struct as_env
{
    ...
    struct impl
    {
        typedef env<data_type, typename detail::value_type<T>::type>
            result_type;
    ...
    {
        typedef
            typename impl<typename detail::normalize_arg<T>::type>::result_type
                type;
    };
    ...
    template <typename T>
    typename impl<
        typename detail::normalize_arg<T const&>::type>::result_type const
        operator()(T const& t) const
    {
        return impl<typename detail::normalize_arg<T const&>::type>()(
            static_cast<typename detail::normalize_arg<T const&>::reference>(
                t));
    }
};
...
struct has_env_var<data_type> : detail::poly_function<has_env_var<data_type>>
{
    ...
    struct impl
    {
        typedef mpl::not_<is_same<typename remove_reference<Env>::type::
                                      template lookup<data_type>::type,
                                  key_not_found>>
            result_type;
...
struct env_var : detail::poly_function<env_var<Key>>
{
    ...
    struct impl
    {
        typedef typename remove_reference<Env>::type::template lookup<Key>::type
            result_type;
...
struct env_var<data_type> : detail::poly_function<env_var<data_type>>
{
    ...
    {
        typedef typename remove_reference<Env>::type::template lookup<
            data_type>::type result_type;
...
// as_env
template <typename T>
typename proto::result_of::as_env<T&>::type const
    as_env(T& t BOOST_PROTO_DISABLE_IF_IS_CONST(T))
{
...
typename proto::result_of::has_env_var<Env&, Key>::type
    has_env_var(Env& e BOOST_PROTO_DISABLE_IF_IS_CONST(Env))
{
...
// env_var
template <typename Key, typename Env>
typename proto::result_of::env_var<Env&, Key>::type
    env_var(Env& e BOOST_PROTO_DISABLE_IF_IS_CONST(Env))
{
...
inline typename disable_if_c<is_const<T>::value, env<T1, V1, BOOST_PROTO_UNCVREF(typename result_of::as_env<T&>::type)>>::type const operator,(
    T& t, env<T1, V1> const& head)
{
    return env<T1, V1,
               BOOST_PROTO_UNCVREF(typename result_of::as_env<T&>::type)>(
        head[T1()], proto::as_env(t));
}

template <typename T, typename T1, typename V1>
inline env<T1, V1, BOOST_PROTO_UNCVREF(typename result_of::as_env<T const&>::type)> const operator,(
    T const& t, env<T1, V1> const& head)
{
    return env<T1, V1,
               BOOST_PROTO_UNCVREF(typename result_of::as_env<T const&>::type)>(
        head[T1()], proto::as_env(t));
}
} // namespace envns_
...
struct _env_var : proto::transform<_env_var<Key>>
{
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
        ...
        BOOST_MPL_ASSERT_NOT(
            (is_same<result_type, key_not_found>)); // lookup failed
