...
{
    T& t;
    explicit thread_move_t(T& t_) : t(t_)
    {
    }
...
{
template <typename T>
BOOST_THREAD_RV_REF(typename ::boost::remove_cv<
...
//  template <typename T>
//  BOOST_THREAD_RV_REF(typename ::boost::remove_cv<typename
//  ::boost::remove_reference<T>::type>::type) make_rv_ref(T &v)  BOOST_NOEXCEPT
//  {
//    return (BOOST_THREAD_RV_REF(typename ::boost::remove_cv<typename
//    ::boost::remove_reference<T>::type>::type))(v);
//  }
//  template <typename T>
//  const BOOST_THREAD_RV_REF(typename ::boost::remove_cv<typename
//  ::boost::remove_reference<T>::type>::type) make_rv_ref(T const&v)
//  BOOST_NOEXCEPT
//  {
...
struct decay
{
  ...
  public:
    typedef typename conditional<
        is_array<Up>::value, typename remove_extent<Up>::type*,
        typename conditional<is_function<Up>::value,
