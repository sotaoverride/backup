...
#define G_TLS_CLIENT_CONNECTION(inst)                                          \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_TLS_CLIENT_CONNECTION,          \
                                GTlsClientConnection))
#define G_IS_TLS_CLIENT_CONNECTION(inst)                                       \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_TLS_CLIENT_CONNECTION))
#define G_TLS_CLIENT_CONNECTION_GET_INTERFACE(inst)                            \
    (G_TYPE_INSTANCE_GET_INTERFACE((inst), G_TYPE_TLS_CLIENT_CONNECTION,       \
 ...
 * @copy_session_state: Copies session state from one #GTlsClientConnection to
 * another.
 *
