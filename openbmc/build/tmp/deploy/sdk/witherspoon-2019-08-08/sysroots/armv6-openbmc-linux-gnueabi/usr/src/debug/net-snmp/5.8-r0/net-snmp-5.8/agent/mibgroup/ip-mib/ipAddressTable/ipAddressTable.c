...
void initialize_table_ipAddressTable(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressTable:initialize_table_ipAddressTable", "called\n"));
 ...
 */
int ipAddressTable_rowreq_ctx_init(ipAddressTable_rowreq_ctx* rowreq_ctx,
                                   void* user_init_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_rowreq_ctx_init", "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:210:o: |-> Perform extra ipAddressTable rowreq initialization. (eg
     * DEFVALS)
     */
 ...
 *
 */
void ipAddressTable_rowreq_ctx_cleanup(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
 ...
 */
int ipAddressTable_pre_request(ipAddressTable_registration* user_context)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_pre_request", "called\n"));
 ...
 */
int ipAddressTable_post_request(ipAddressTable_registration* user_context,
                                int rc)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_post_request", "called\n"));
...
ipAddressTable_data* ipAddressTable_allocate_data(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_allocate_data", "called\n"));
 ...
 */
void ipAddressTable_release_data(ipAddressTable_data* data)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_release_data", "called\n"));
 ...
 *   settable   0
 *
 * Enum range: 5/8. Values:  unknown(0), ipv4(1), ipv6(2), ipv4z(3), ipv6z(4),
dns(16)
 *
 ...
 */
int ipAddressAddrType_map(long* mib_ipAddressAddrType_val_ptr,
                          long raw_ipAddressAddrType_val)
{
    netsnmp_assert(NULL != mib_ipAddressAddrType_val_ptr);

    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressAddrType_map", "called\n"));
 ...
 */
int ipAddressTable_indexes_set_tbl_idx(ipAddressTable_mib_index* tbl_idx,
                                       long ipAddressAddrType_val,
                                       u_char* ipAddressAddr_val_ptr,
                                       size_t ipAddressAddr_val_ptr_len)
{
    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressTable_indexes_set_tbl_idx",
                "called\n"));
     ...
     */
    tbl_idx->ipAddressAddr_len =
        sizeof(tbl_idx->ipAddressAddr) /
        sizeof(tbl_idx->ipAddressAddr[0]); /* max length */
    /** WARNING: this code might not work for netsnmp_ipaddress_entry */
    /*
 ...
 *  from the mib index.
 */
int ipAddressTable_indexes_set(ipAddressTable_rowreq_ctx* rowreq_ctx,
                               u_long ipAddressAddrType_val,
                               u_char* ipAddressAddr_val_ptr,
                               size_t ipAddressAddr_val_ptr_len)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_indexes_set", "called\n"));

    if (MFD_SUCCESS != ipAddressTable_indexes_set_tbl_idx(
                           &rowreq_ctx->tbl_idx, ipAddressAddrType_val,
                           ipAddressAddr_val_ptr, ipAddressAddr_val_ptr_len))
        return MFD_ERROR;
    ...
    if (0 !=
        ipAddressTable_index_to_oid(&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressIfIndex_get(ipAddressTable_rowreq_ctx* rowreq_ctx,
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressType_get(ipAddressTable_rowreq_ctx* rowreq_ctx,
 ...
 * @retval MFD_ERROR           : Any other error
 *
 * @note If you need more than (*ipAddressPrefix_val_ptr_len_ptr) bytes of
 * memory, allocate it using malloc() and update ipAddressPrefix_val_ptr_ptr.
                        ...
                        size_t* ipAddressPrefix_val_ptr_len_ptr)
{
     ...
     * copy (* ipAddressPrefix_val_ptr_ptr ) data and (*
     * ipAddressPrefix_val_ptr_len_ptr ) from rowreq_ctx->data
     */
    dst = &tmp_oid[10];
    ...
    *(dst++) = rowreq_ctx->data->ia_address_len;
    netsnmp_ipaddress_prefix_copy(
        tmp_buf, (u_char*)rowreq_ctx->tbl_idx.ipAddressAddr,
        rowreq_ctx->data->ia_address_len, rowreq_ctx->data->ia_prefix_len);
 ...
 *   settable   0
 *
 * Enum range: 4/8. Values:  other(1), manual(2), dhcp(4), linklayer(5),
random(6)
 *
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressOrigin_get(ipAddressTable_rowreq_ctx* rowreq_ctx,
 ...
 *   defval: preferred
 *
 * Enum range: 5/8. Values:  preferred(1), invalid(3), inaccessible(4),
unknown(5), tentative(6), duplicate(7)
 *
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressStatus_get(ipAddressTable_rowreq_ctx* rowreq_ctx,
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressCreated_get(ipAddressTable_rowreq_ctx* rowreq_ctx,
                         u_long* ipAddressCreated_val_ptr)
{
    /** we should have a non-NULL pointer */
    netsnmp_assert(NULL != ipAddressCreated_val_ptr);

    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressCreated_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressLastChanged_get(ipAddressTable_rowreq_ctx* rowreq_ctx,
                             u_long* ipAddressLastChanged_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipAddressLastChanged
     * data. copy (* ipAddressLastChanged_val_ptr ) from rowreq_ctx->data
     */
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressRowStatus_get(ipAddressTable_rowreq_ctx* rowreq_ctx,
 ...
 *   defval: volatile
 *
 * Enum range: 4/8. Values:  other(1), volatile(2), nonVolatile(3),
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressStorageType_get(ipAddressTable_rowreq_ctx* rowreq_ctx,
                             u_long* ipAddressStorageType_val_ptr)
{
    /** we should have a non-NULL pointer */
    netsnmp_assert(NULL != ipAddressStorageType_val_ptr);

    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressStorageType_get", "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:231:o: |-> Extract the current value of the ipAddressStorageType
     * data. copy (* ipAddressStorageType_val_ptr ) from rowreq_ctx->data
     */
 ...
 */
int ipAddressTable_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
     ...
     */
    rc =
        netsnmp_access_ipaddress_entry_copy(rowreq_ctx->undo, rowreq_ctx->data);
 ...
 * @retval MFD_ERROR   : error. set will fail.
 */
int ipAddressTable_undo(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 */
int ipAddressTable_undo_cleanup(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_undo_cleanup", "called\n"));
 ...
 * @retval MFD_ERROR   : error
 */
int ipAddressTable_commit(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressTable_commit", "called\n"));
 ...
 * @retval MFD_ERROR   : error
 */
int ipAddressTable_undo_commit(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
...
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressIfIndex_check_value", "called\n"));
    ...
    if (!(rowreq_ctx->rowreq_flags & MFD_ROW_CREATED))
    {
        DEBUGMSGT(("ipAddressTable", "changing ifIndex value not supported\n"));
        return MFD_NOT_VALID_EVER;
    }
 ...
 */
int ipAddressIfIndex_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressIfIndex_undo_setup", "called\n"));
                         ...
                         long ipAddressIfIndex_val)
{
    ...
    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressIfIndex_set", "called\n"));
 ...
 *        Pointer to the users context.
 */
int ipAddressIfIndex_undo(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
     ...
     * set rowreq_ctx->data->ipAddressIfIndex from
     * rowreq_ctx->undo->ipAddressIfIndex
     */
 ...
 *
 */
int ipAddressType_check_value(ipAddressTable_rowreq_ctx* rowreq_ctx,
                              u_long ipAddressType_val)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressType_check_value", "called\n"));
 ...
 * won't be done unless it is necessary.
 */
int ipAddressType_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
 ...
 *        Pointer to the users context.
 */
int ipAddressType_undo(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
 ...
 * The following checks have already been done for you:
 *    The syntax is ASN_INTEGER
 *    The value is one of  preferred(1), invalid(3), inaccessible(4),
 *unknown(5), tentative(6), duplicate(7)
 *
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 *
...
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressStatus_check_value", "called\n"));
 ...
 * won't be done unless it is necessary.
 */
int ipAddressStatus_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressStatus_undo_setup", "called\n"));
 ...
 *        Pointer to the users context.
 */
int ipAddressStatus_undo(ipAddressTable_rowreq_ctx* rowreq_ctx)
{

    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressStatus_undo", "called\n"));
     ...
     * set rowreq_ctx->data->ipAddressStatus from
     * rowreq_ctx->undo->ipAddressStatus
     */
                                   ...
                                   u_long ipAddressRowStatus_val)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressRowStatus_check_value", "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL(("ipAddressTable", "row status transition from %d to %lu\n",
 ...
 * won't be done unless it is necessary.
 */
int ipAddressRowStatus_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressRowStatus_undo_setup", "called\n"));
                           ...
                           u_long ipAddressRowStatus_val)
{
    ...
    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressRowStatus_set", "called\n"));
 ...
 *        Pointer to the users context.
 */
int ipAddressRowStatus_undo(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
     ...
     * set rowreq_ctx->data->ipAddressRowStatus from
     * rowreq_ctx->undo->ipAddressRowStatus
     */
 ...
 * The following checks have already been done for you:
 *    The syntax is ASN_INTEGER
 *    The value is one of  other(1), volatile(2), nonVolatile(3), permanent(4),
 *readOnly(5)
 *
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 *
 */
int ipAddressStorageType_check_value(ipAddressTable_rowreq_ctx* rowreq_ctx,
 ...
 * won't be done unless it is necessary.
 */
int ipAddressStorageType_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressStorageType_undo_setup", "called\n"));
                             ...
                             u_long ipAddressStorageType_val)
{
    ...
    DEBUGMSGTL(("verbose:ipAddressTable:ipAddressStorageType_set", "called\n"));
 ...
 *        Pointer to the users context.
 */
int ipAddressStorageType_undo(ipAddressTable_rowreq_ctx* rowreq_ctx)
{

    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressStorageType_undo", "called\n"));
     ...
     * set rowreq_ctx->data->ipAddressStorageType from
     * rowreq_ctx->undo->ipAddressStorageType
     */
 ...
 */
int ipAddressTable_check_dependencies(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("internal:ipAddressTable:ipAddressTable_check_dependencies",
                "called\n"));
    ...
    if (rowreq_ctx->column_set_flags & COLUMN_IPADDRESSROWSTATUS_FLAG)
    {
        ...
        if (rowreq_ctx->rowreq_flags & MFD_ROW_CREATED)
        {
            ...
            else if (ROWSTATUS_CREATEANDGO == rowreq_ctx->ipAddressRowStatus)
            {
        ...
        else
        {
            ...
            {
                if (rowreq_ctx->column_set_flags &
                    ~COLUMN_IPADDRESSROWSTATUS_FLAG)
                {
                    DEBUGMSGTL(("ipAddressTable",
    ...
    else
    {
        ...
        {
            DEBUGMSGTL(
                ("ipAddressTable", "must use RowStatus to create rows\n"));
            return MFD_CANNOT_CREATE_NOW;
        }
    } /* row status not set */
