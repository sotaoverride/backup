...
#ifdef USE_NEON
unsigned int _gcry_sha1_transform_armv7_neon(void* state,
                                             const unsigned char* data,
                                             size_t nblks);
#endif

#ifdef USE_ARM_CE
unsigned int _gcry_sha1_transform_armv8_ce(void* state,
                                           const unsigned char* data,
                                           size_t nblks);
#endif
...
#ifdef USE_SSSE3
unsigned int _gcry_sha1_transform_amd64_ssse3(void* state,
                                              const unsigned char* data,
                                              size_t nblks) ASM_FUNC_ABI;
#endif

#ifdef USE_AVX
unsigned int _gcry_sha1_transform_amd64_avx(void* state,
                                            const unsigned char* data,
                                            size_t nblks) ASM_FUNC_ABI;
#endif

#ifdef USE_BMI2
unsigned int _gcry_sha1_transform_amd64_avx_bmi2(void* state,
                                                 const unsigned char* data,
                                                 size_t nblks) ASM_FUNC_ABI;
#endif
...
static unsigned char* sha1_read(void* context)
{
    SHA1_CONTEXT* hd = context;
...
void _gcry_sha1_hash_buffers(void* outbuf, const gcry_buffer_t* iov, int iovcnt)
{
    SHA1_CONTEXT hd;
...
static gpg_err_code_t selftests_sha1(int extended,
...
gcry_md_spec_t _gcry_digest_spec_sha1 = {GCRY_MD_SHA1,
                                         {0, 1},
                                         "SHA1",
                                         asn,
                                         DIM(asn),
