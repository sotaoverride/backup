...
static void FT_GlyphLoader_Adjust_Points(FT_GlyphLoader loader)
{
    ...
    if (loader->use_extra)
    {
        ...
        loader->current.extra_points2 =
            loader->base.extra_points2 + base->n_points;
    }
}
...
FT_GlyphLoader_CreateExtra(FT_GlyphLoader loader)
{
    ...
    {
        loader->use_extra = 1;
        loader->base.extra_points2 =
            loader->base.extra_points + loader->max_points;
                           ...
                           FT_UInt n_contours)
{
    ...
    /* check points & tags */
    new_max = (FT_UInt)base->n_points + (FT_UInt)current->n_points + n_points;
    ...
    if (new_max > old_max)
    {
        ...
        if (loader->use_extra)
        {
            if (FT_RENEW_ARRAY(loader->base.extra_points, old_max * 2,
                               new_max * 2))
                goto Exit;
    ...
    new_max =
        (FT_UInt)base->n_contours + (FT_UInt)current->n_contours + n_contours;
    if (new_max > old_max)
    {
