...
libc_hidden_proto(__register_printf_specifier) int __register_printf_function(
    int, printf_function, printf_arginfo_function);
                                ...
                                printf_arginfo_size_function arginfo)
{
    ...
    {
        __printf_arginfo_table = (printf_arginfo_size_function**)calloc(
            UCHAR_MAX + 1, sizeof(void*) * 2);
        ...
        __printf_function_table =
            (printf_function**)(__printf_arginfo_table + UCHAR_MAX + 1);
    }
