...
#define G_NETWORK_MONITOR_NM(o)                                                \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_NETWORK_MONITOR_NM,                \
                                GNetworkMonitorNM))
#define G_NETWORK_MONITOR_NM_CLASS(k)                                          \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_NETWORK_MONITOR_NM,                   \
                             GNetworkMonitorNMClass))
#define G_IS_NETWORK_MONITOR_NM(o)                                             \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_NETWORK_MONITOR_NM))
#define G_IS_NETWORK_MONITOR_NM_CLASS(k)                                       \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_NETWORK_MONITOR_NM))
#define G_NETWORK_MONITOR_NM_GET_CLASS(o)                                      \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_NETWORK_MONITOR_NM,                 \
                               GNetworkMonitorNMClass))
#define G_NETWORK_MONITOR_NM_GET_INITABLE_IFACE(o)                             \
