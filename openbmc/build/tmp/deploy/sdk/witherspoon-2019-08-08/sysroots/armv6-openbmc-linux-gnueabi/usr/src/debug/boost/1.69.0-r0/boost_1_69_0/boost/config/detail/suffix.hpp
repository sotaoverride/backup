...
// BOOST_MAY_ALIAS -----------------------------------------------//
// The macro expands to an attribute to mark a type that is allowed to alias
// other types. The macro is defined in the compiler-specific headers.
...
// These macros are intended to wrap conditional expressions that yield true or
// false
//
...
// Lack of non-public defaulted functions is implied by the lack of any
// defaulted functions
...
// Lack of defaulted moves is implied by the lack of either rvalue references or
// any defaulted functions
...
// will expand to a private function declaration, if the compiler doesn't
// support deleted functions. Because of this it is recommended to use
// BOOST_DELETED_FUNCTION in the end of the class definition.
//
//  class my_class
//  {
//  public:
...
//  Use BOOST_NO_CXX11_HDR_INITIALIZER_LIST instead of
...
#endif
//  Use BOOST_NO_CXX11_HDR_CONDITION_VARIABLE instead of
//  BOOST_NO_0X_HDR_CONDITION_VARIABLE
#if defined(BOOST_NO_CXX11_HDR_CONDITION_VARIABLE) &&                          \
    !defined(BOOST_NO_0X_HDR_CONDITION_VARIABLE)
...
//  Use BOOST_NO_CXX11_HDR_FORWARD_LIST instead of BOOST_NO_0X_HDR_FORWARD_LIST
    ...
    !defined(BOOST_NO_0X_HDR_FORWARD_LIST)
...
//  Use BOOST_NO_CXX11_HDR_SYSTEM_ERROR instead of BOOST_NO_0X_HDR_SYSTEM_ERROR
    ...
    !defined(BOOST_NO_0X_HDR_SYSTEM_ERROR)
...
#endif
//  Use BOOST_NO_CXX11_HDR_UNORDERED_MAP instead of
//  BOOST_NO_0X_HDR_UNORDERED_MAP
#if defined(BOOST_NO_CXX11_HDR_UNORDERED_MAP) &&                               \
    !defined(BOOST_NO_0X_HDR_UNORDERED_MAP)
#define BOOST_NO_0X_HDR_UNORDERED_MAP
#endif
//  Use BOOST_NO_CXX11_HDR_UNORDERED_SET instead of
//  BOOST_NO_0X_HDR_UNORDERED_SET
#if defined(BOOST_NO_CXX11_HDR_UNORDERED_SET) &&                               \
    !defined(BOOST_NO_0X_HDR_UNORDERED_SET)
...
//  Use     BOOST_NO_CXX11_AUTO_DECLARATIONS instead of
//  BOOST_NO_AUTO_DECLARATIONS
#if defined(BOOST_NO_CXX11_AUTO_DECLARATIONS) &&                               \
    !defined(BOOST_NO_AUTO_DECLARATIONS)
#define BOOST_NO_AUTO_DECLARATIONS
#endif
//  Use     BOOST_NO_CXX11_AUTO_MULTIDECLARATIONS instead of
//  BOOST_NO_AUTO_MULTIDECLARATIONS
#if defined(BOOST_NO_CXX11_AUTO_MULTIDECLARATIONS) &&                          \
    !defined(BOOST_NO_AUTO_MULTIDECLARATIONS)
...
#endif
//  Use     BOOST_NO_CXX11_DEFAULTED_FUNCTIONS instead of
//  BOOST_NO_DEFAULTED_FUNCTIONS
#if defined(BOOST_NO_CXX11_DEFAULTED_FUNCTIONS) &&                             \
    !defined(BOOST_NO_DEFAULTED_FUNCTIONS)
#define BOOST_NO_DEFAULTED_FUNCTIONS
#endif
//  Use     BOOST_NO_CXX11_DELETED_FUNCTIONS instead of
//  BOOST_NO_DELETED_FUNCTIONS
#if defined(BOOST_NO_CXX11_DELETED_FUNCTIONS) &&                               \
    !defined(BOOST_NO_DELETED_FUNCTIONS)
#define BOOST_NO_DELETED_FUNCTIONS
#endif
//  Use     BOOST_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS instead of
...
//  Use     BOOST_NO_CXX11_EXTERN_TEMPLATE instead of   BOOST_NO_EXTERN_TEMPLATE
    ...
    !defined(BOOST_NO_EXTERN_TEMPLATE)
#define BOOST_NO_EXTERN_TEMPLATE
#endif
//  Use     BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS instead of
...
#endif
//  Use     BOOST_NO_CXX11_LOCAL_CLASS_TEMPLATE_PARAMETERS instead of
//  BOOST_NO_LOCAL_CLASS_TEMPLATE_PARAMETERS
#if defined(BOOST_NO_CXX11_LOCAL_CLASS_TEMPLATE_PARAMETERS) &&                 \
    !defined(BOOST_NO_LOCAL_CLASS_TEMPLATE_PARAMETERS)
...
#endif
//  Use     BOOST_NO_CXX11_RVALUE_REFERENCES instead of
...
#endif
//  Use     BOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX instead of
//  BOOST_NO_UNIFIED_INITIALIZATION_SYNTAX
#if defined(BOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX) &&                   \
    !defined(BOOST_NO_UNIFIED_INITIALIZATION_SYNTAX)
#define BOOST_NO_UNIFIED_INITIALIZATION_SYNTAX
#endif
//  Use     BOOST_NO_CXX11_VARIADIC_TEMPLATES instead of
...
#endif
//  Use     BOOST_NO_CXX11_NUMERIC_LIMITS instead of
...
//
// Set BOOST_HAS_RVALUE_REFS when BOOST_NO_CXX11_RVALUE_REFERENCES is not
// defined
//
#if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) &&                              \
...
//
// Set BOOST_HAS_VARIADIC_TMPL when BOOST_NO_CXX11_VARIADIC_TEMPLATES is not
// defined
//
#if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) &&                             \
    !defined(BOOST_HAS_VARIADIC_TMPL)
...
//
#if defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) &&                       \
    !defined(BOOST_CONFIG_ALLOW_DEPRECATED)
#error                                                                         \
    "You are using a compiler which lacks features which are now a minimum requirement in order to use Boost, define BOOST_CONFIG_ALLOW_DEPRECATED if you want to continue at your own risk!!!"
#endif
