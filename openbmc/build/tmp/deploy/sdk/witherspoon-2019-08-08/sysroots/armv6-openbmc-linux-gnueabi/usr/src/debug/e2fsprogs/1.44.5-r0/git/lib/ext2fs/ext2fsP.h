...
extern int ext2fs_process_dir_block(ext2_filsys fs, blk64_t* blocknr,
...
extern int ext2fs_inline_data_dir_iterate(ext2_filsys fs, ext2_ino_t ino,
                                          void* priv_data);
...
struct ext2fs_progress_ops
{
    ...
    void (*update)(ext2_filsys fs,
                   struct ext2fs_numeric_progress_struct* progress, __u64 val);
...
extern errcode_t ext2fs_fudge_generic_bmap_end(ext2fs_generic_bitmap bitmap,
                                               errcode_t neq, __u64 end,
                                               __u64* oend);
extern int ext2fs_mark_generic_bmap(ext2fs_generic_bitmap bitmap, __u64 arg);
extern int ext2fs_unmark_generic_bmap(ext2fs_generic_bitmap bitmap, __u64 arg);
extern int ext2fs_test_generic_bmap(ext2fs_generic_bitmap bitmap, __u64 arg);
...
extern errcode_t ext2fs_get_generic_bmap_range(ext2fs_generic_bitmap bitmap,
                                               __u64 start, unsigned int num,
                                               void* out);
extern void ext2fs_warn_bitmap32(ext2fs_generic_bitmap bitmap,
                                 const char* func);
