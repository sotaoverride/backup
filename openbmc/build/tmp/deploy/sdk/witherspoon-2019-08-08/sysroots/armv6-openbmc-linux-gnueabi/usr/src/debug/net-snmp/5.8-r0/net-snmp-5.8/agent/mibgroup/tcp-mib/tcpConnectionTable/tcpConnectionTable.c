...
{
    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:init_tcpConnectionTable", "called\n"));
...
void initialize_table_tcpConnectionTable(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:initialize_table_tcpConnectionTable",
         "called\n"));
...
void shutdown_table_tcpConnectionTable(void)
{
     ...
     */
    _tcpConnectionTable_shutdown_interface(&tcpConnectionTable_user_context);
}
 ...
 */
int tcpConnectionTable_rowreq_ctx_init(
    tcpConnectionTable_rowreq_ctx* rowreq_ctx, void* user_init_ctx)
{
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_rowreq_ctx_init",
                "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:210:o: |-> Perform extra tcpConnectionTable rowreq initialization.
     * (eg DEFVALS)
     */
 ...
 *
 */
void tcpConnectionTable_rowreq_ctx_cleanup(
    tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionTable_rowreq_ctx_cleanup",
         "called\n"));
 ...
 */
int tcpConnectionTable_pre_request(
    tcpConnectionTable_registration* user_context)
{
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_pre_request",
                "called\n"));
 ...
 */
int tcpConnectionTable_post_request(
    tcpConnectionTable_registration* user_context, int rc)
{
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_post_request",
                "called\n"));
...
tcpConnectionTable_data* tcpConnectionTable_allocate_data(void)
{
     ...
     */
    tcpConnectionTable_data* rtn = SNMP_MALLOC_TYPEDEF(tcpConnectionTable_data);

    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_allocate_data",
                "called\n"));
 ...
 */
void tcpConnectionTable_release_data(tcpConnectionTable_data* data)
{
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_release_data",
                "called\n"));
 ...
 */
int tcpConnectionTable_indexes_set_tbl_idx(
    tcpConnectionTable_mib_index* tbl_idx,
    u_long tcpConnectionLocalAddressType_val,
    const void* tcpConnectionLocalAddress_val_ptr,
    size_t tcpConnectionLocalAddress_val_ptr_len,
    u_long tcpConnectionLocalPort_val, u_long tcpConnectionRemAddressType_val,
    const void* tcpConnectionRemAddress_val_ptr,
    size_t tcpConnectionRemAddress_val_ptr_len, u_long tcpConnectionRemPort_val)
{
    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionTable_indexes_set_tbl_idx",
         "called\n"));
    ...
    tbl_idx->tcpConnectionLocalAddress_len =
        ...
        sizeof(tbl_idx->tcpConnectionLocalAddress[0]); /* max length */
    /** WARNING: this code might not work for netsnmp_tcpconn_entry */
    /*
    ...
    tbl_idx->tcpConnectionRemAddress_len =
        ...
        sizeof(tbl_idx->tcpConnectionRemAddress[0]); /* max length */
    /** WARNING: this code might not work for netsnmp_tcpconn_entry */
    /*
    ...
    tbl_idx->tcpConnectionRemAddress_len = tcpConnectionRemAddress_val_ptr_len;
    memcpy(tbl_idx->tcpConnectionRemAddress, tcpConnectionRemAddress_val_ptr,
           tcpConnectionRemAddress_val_ptr_len);
 ...
 *  from the mib index.
 */
int tcpConnectionTable_indexes_set(
    tcpConnectionTable_rowreq_ctx* rowreq_ctx,
    u_long tcpConnectionLocalAddressType_val,
    const void* tcpConnectionLocalAddress_val_ptr,
    size_t tcpConnectionLocalAddress_val_ptr_len,
    ...
    size_t tcpConnectionRemAddress_val_ptr_len, u_long tcpConnectionRemPort_val)
{
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_indexes_set",
                "called\n"));

    if (MFD_SUCCESS !=
        tcpConnectionTable_indexes_set_tbl_idx(
            &rowreq_ctx->tbl_idx, tcpConnectionLocalAddressType_val,
            tcpConnectionLocalAddress_val_ptr,
            tcpConnectionLocalAddress_val_ptr_len, tcpConnectionLocalPort_val,
            tcpConnectionRemAddressType_val, tcpConnectionRemAddress_val_ptr,
            tcpConnectionRemAddress_val_ptr_len, tcpConnectionRemPort_val))
        return MFD_ERROR;
 ...
 *   settable   1
 *
 * Enum range: 9/16. Values:  closed(1), listen(2), synSent(3), synReceived(4),
 ...
 */
int tcpConnectionState_get(tcpConnectionTable_rowreq_ctx* rowreq_ctx,
                           u_long* tcpConnectionState_val_ptr)
{
    ...
    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionState_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int tcpConnectionProcess_get(tcpConnectionTable_rowreq_ctx* rowreq_ctx,
                             u_long* tcpConnectionProcess_val_ptr)
{
    ...
    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionProcess_get", "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:231:o: |-> Extract the current value of the tcpConnectionProcess
     * data. copy (* tcpConnectionProcess_val_ptr ) from rowreq_ctx->data
     */
 ...
 */
int tcpConnectionTable_undo_setup(tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 * @retval MFD_ERROR   : error. set will fail.
 */
int tcpConnectionTable_undo(tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 */
int tcpConnectionTable_undo_cleanup(tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_undo_cleanup",
                "called\n"));
 ...
 * @retval MFD_ERROR   : error
 */
int tcpConnectionTable_commit(tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    int save_flags;

    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionTable_commit", "called\n"));
    ...
    {
        save_flags &=
            ~COLUMN_TCPCONNECTIONSTATE_FLAG; /* clear tcpConnectionState */
        /*
 ...
 * @retval MFD_ERROR   : error
 */
int tcpConnectionTable_undo_commit(tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_undo_commit",
                "called\n"));
 ...
 *    The value is one of  closed(1), listen(2), synSent(3), synReceived(4),
 ...
 *
 */
int tcpConnectionState_check_value(tcpConnectionTable_rowreq_ctx* rowreq_ctx,
                                   u_long tcpConnectionState_val)
{
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionState_check_value",
                "called\n"));
 ...
 */
int tcpConnectionState_undo_setup(tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
     ...
     * set rowreq_ctx->undo->tcpConnectionState from
     * rowreq_ctx->data->tcpConnectionState
     */
 ...
 *        A long containing the new value.
 */
int tcpConnectionState_set(tcpConnectionTable_rowreq_ctx* rowreq_ctx,
                           u_long tcpConnectionState_val)
{

    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionState_set", "called\n"));
 ...
 *        Pointer to the users context.
 */
int tcpConnectionState_undo(tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{

    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionState_undo", "called\n"));
    ...
    /*
     * copy tcpConnectionState data
     * set rowreq_ctx->data->tcpConnectionState from
     * rowreq_ctx->undo->tcpConnectionState
     */
 ...
 */
int tcpConnectionTable_check_dependencies(
    tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(
        ("internal:tcpConnectionTable:tcpConnectionTable_check_dependencies",
         "called\n"));
