...
#define G_NETWORK_MONITOR_PORTAL(o)                                            \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_NETWORK_MONITOR_PORTAL,            \
                                GNetworkMonitorPortal))
#define G_NETWORK_MONITOR_PORTAL_CLASS(k)                                      \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_NETWORK_MONITOR_PORTAL,               \
                             GNetworkMonitorPortalClass))
#define G_IS_NETWORK_MONITOR_PORTAL(o)                                         \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_NETWORK_MONITOR_PORTAL))
#define G_IS_NETWORK_MONITOR_PORTAL_CLASS(k)                                   \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_NETWORK_MONITOR_PORTAL))
#define G_NETWORK_MONITOR_PORTAL_GET_CLASS(o)                                  \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_NETWORK_MONITOR_PORTAL,             \
                               GNetworkMonitorPortalClass))
#define G_NETWORK_MONITOR_PORTAL_GET_INITABLE_IFACE(o)                         \
    (G_TYPE_INSTANCE_GET_INTERFACE((o), G_TYPE_INITABLE, GInitable))
