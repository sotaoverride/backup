...
config_require(ip - mib / data_access / defaultrouter)
    config_require(ip -
                   mib / ipDefaultRouterTable / ipDefaultRouterTable_interface)
        config_require(ip - mib / ipDefaultRouterTable /
                                ipDefaultRouterTable_data_access)
            config_require(ip - mib / ipDefaultRouterTable /
                                    ipDefaultRouterTable_data_get)
/* *INDENT-ON*  */
...
typedef struct ipDefaultRouterTable_rowreq_ctx_s
{
    ...
    /*
     * TODO:131:o: |   |-> Add useful data to ipDefaultRouterTable rowreq
     * context.
     */
