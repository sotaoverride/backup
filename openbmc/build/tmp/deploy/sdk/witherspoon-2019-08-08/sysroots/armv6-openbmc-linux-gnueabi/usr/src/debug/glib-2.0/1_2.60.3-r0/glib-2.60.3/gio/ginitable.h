...
#define G_INITABLE(obj)                                                        \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_INITABLE, GInitable))
#define G_IS_INITABLE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_INITABLE))
#define G_INITABLE_GET_IFACE(obj)                                              \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_INITABLE, GInitableIface))
...
GLIB_AVAILABLE_IN_ALL
gboolean g_initable_init(GInitable* initable, GCancellable* cancellable,
                         GError** error);

GLIB_AVAILABLE_IN_ALL
gpointer g_initable_new(GType object_type, GCancellable* cancellable,
                        GError** error, const gchar* first_property_name, ...);

GLIB_DEPRECATED_IN_2_54_FOR(g_object_new_with_properties and g_initable_init)
gpointer g_initable_newv(GType object_type, guint n_parameters,
                         GParameter* parameters, GCancellable* cancellable,
                         GError** error);
GLIB_AVAILABLE_IN_ALL
