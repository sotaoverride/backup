...
#define G_ACTION_MAP(inst)                                                     \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_ACTION_MAP, GActionMap))
#define G_IS_ACTION_MAP(inst)                                                  \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_ACTION_MAP))
#define G_ACTION_MAP_GET_IFACE(inst)                                           \
    (G_TYPE_INSTANCE_GET_INTERFACE((inst), G_TYPE_ACTION_MAP,                  \
                                   GActionMapInterface))
