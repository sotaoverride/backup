...
class BOOST_SYMBOL_VISIBLE basic_xml_grammar
{
  ...
  private:
    ...
    rule_t Reference, Eq, STag, ETag, LetterOrUnderscoreOrColon, AttValue,
        ...
        ClassNameChar, ClassName, Name, XMLDecl, XMLDeclChars, DocTypeDecl,
        DocTypeDeclChars, ClassIDAttribute, ObjectIDAttribute,
        ClassNameAttribute, TrackingAttribute, VersionAttribute,
        UnusedAttribute, Attribute, SignatureAttribute, SerializationWrapper,
        NameHead, NameTail, AttributeList, S;
    ...
    bool my_parse(IStream& is, const rule_t& rule_,
                  const CharType delimiter = L'>') const;
