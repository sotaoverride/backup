...
int ipAddressTable_init_data(ipAddressTable_registration* ipAddressTable_reg);
...
int ipAddressTable_cache_load(netsnmp_container* container);
...
int ipAddressAddrType_check_index(
    ipAddressTable_rowreq_ctx* rowreq_ctx); /* internal */
int ipAddressAddr_check_index(
    ipAddressTable_rowreq_ctx* rowreq_ctx); /* internal */
