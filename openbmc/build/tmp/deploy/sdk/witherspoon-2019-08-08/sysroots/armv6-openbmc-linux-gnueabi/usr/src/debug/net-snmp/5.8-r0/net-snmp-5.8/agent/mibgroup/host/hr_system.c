...
static int set_solaris_bootcommand_parameter(int action, u_char* var_val,
                                             u_char var_val_type,
...
struct variable2 hrsystem_variables[] = {
    {HRSYS_UPTIME, ASN_TIMETICKS, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {1}},
    {HRSYS_DATE, ASN_OCTET_STR, NETSNMP_OLDAPI_RWRITE, var_hrsys, 1, {2}},
    {HRSYS_LOAD_DEV, ASN_INTEGER, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {3}},
    {HRSYS_LOAD_PARAM, ASN_OCTET_STR, NETSNMP_OLDAPI_RWRITE, var_hrsys, 1, {4}},
    {HRSYS_USERS, ASN_GAUGE, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {5}},
    {HRSYS_PROCS, ASN_GAUGE, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {6}},
    {HRSYS_MAXPROCS, ASN_INTEGER, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {7}}};
#else  /* !NETSNMP_NO_WRITE_SUPPORT */
struct variable2 hrsystem_variables[] = {
    {HRSYS_UPTIME, ASN_TIMETICKS, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {1}},
    {HRSYS_DATE, ASN_OCTET_STR, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {2}},
    {HRSYS_LOAD_DEV, ASN_INTEGER, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {3}},
    {HRSYS_LOAD_PARAM, ASN_OCTET_STR, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {4}},
    {HRSYS_USERS, ASN_GAUGE, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {5}},
    {HRSYS_PROCS, ASN_GAUGE, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {6}},
    {HRSYS_MAXPROCS, ASN_INTEGER, NETSNMP_OLDAPI_RONLY, var_hrsys, 1, {7}}};
#endif /* !NETSNMP_NO_WRITE_SUPPORT */
...
void init_hr_system(void)
{
    ...
    snmpd_register_const_config_handler(
        "count_kthreads", parse_count_kthreads, NULL,
...
int header_hrsys(struct variable* vp, oid* name, size_t* length, int exact,
...
u_char* var_hrsys(struct variable* vp, oid* name, size_t* length, int exact,
                  size_t* var_len, WriteMethod** write_method)
{
    ...
    switch (vp->magic)
    {
        ...
        default:
            DEBUGMSGTL(
                ("snmpd", "unknown sub-id %d in var_hrsys\n", vp->magic));
    }
    return NULL;
} /* end var_hrsys */
                                             ...
                                             oid* name, size_t name_len)
{
    ...
    switch (action)
    {
        case RESERVE1:
            ...
            {
                snmp_log(LOG_ERR, "write to set_solaris_bootcommand_parameter "
                                  "not ASN_OCTET_STR\n");
        ...
        case ACTION:
        {
            status = set_solaris_eeprom_parameter("boot-command",
        ...
        case UNDO:
        {
            ...
            if (p_old_value)
            {
                status = set_solaris_eeprom_parameter(
                    "boot-command", (char*)p_old_value, strlen(p_old_value));
...
#if defined(HAVE_MKTIME) && defined(HAVE_STIME)
#ifndef NETSNMP_NO_WRITE_SUPPORT
int ns_set_time(int action, u_char* var_val, u_char var_val_type,
