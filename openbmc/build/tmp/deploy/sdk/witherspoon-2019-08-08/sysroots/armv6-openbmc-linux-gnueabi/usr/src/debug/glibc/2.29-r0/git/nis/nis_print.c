...
libnsl_hidden_nolink_def(nis_print_rights, GLIBC_2_1)
    ...
    void nis_print_directory(const directory_obj* dir)
{
    nis_server* sptr;
    unsigned int i;
...
libnsl_hidden_nolink_def(nis_print_directory, GLIBC_2_1)
    ...
    void nis_print_group(const group_obj* obj)
{
    unsigned int i;
...
libnsl_hidden_nolink_def(nis_print_group, GLIBC_2_1)
    ...
    void nis_print_table(const table_obj* obj)
{
    unsigned int i;
...
libnsl_hidden_nolink_def(nis_print_table, GLIBC_2_1)
    ...
    void nis_print_link(const link_obj* obj)
{
...
libnsl_hidden_nolink_def(nis_print_link, GLIBC_2_1)
    ...
    void nis_print_entry(const entry_obj* obj)
{
    unsigned int i;
    ...
    for (i = 0; i < obj->en_cols.en_cols_len; i++)
    {
        ...
        else if ((obj->en_cols.en_cols_val[i].ec_flags & EN_BINARY) ==
                 EN_BINARY)
            fputs(_("Binary data\n"), stdout);
...
libnsl_hidden_nolink_def(nis_print_object, GLIBC_2_1)
    ...
    void nis_print_result(const nis_result* res)
{
    unsigned int i;
