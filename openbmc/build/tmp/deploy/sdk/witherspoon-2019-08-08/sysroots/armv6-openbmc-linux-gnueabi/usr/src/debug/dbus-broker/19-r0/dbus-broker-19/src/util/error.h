...
#define ERROR_ORIGIN(r)                                                        \
    (_c_likely_(!r) ? 0 : error_slow_origin(r, __func__, __FILE__, __LINE__))
...
#define ERROR_TRACE(r)                                                         \
    (_c_likely_(r >= 0) ? r : error_slow_trace(r, __func__, __FILE__, __LINE__))
...
#define ERROR_FOLD(r)                                                          \
    (_c_likely_(!r) ? 0 : error_slow_fold(r, __func__, __FILE__, __LINE__))
