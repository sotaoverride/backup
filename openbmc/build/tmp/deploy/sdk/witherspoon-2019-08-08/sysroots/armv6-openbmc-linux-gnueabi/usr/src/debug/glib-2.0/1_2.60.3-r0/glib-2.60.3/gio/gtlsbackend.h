...
#define G_TLS_BACKEND(obj)                                                     \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_TLS_BACKEND, GTlsBackend))
#define G_IS_TLS_BACKEND(obj)                                                  \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_TLS_BACKEND))
#define G_TLS_BACKEND_GET_INTERFACE(obj)                                       \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_TLS_BACKEND,                  \
 ...
 * @get_client_connection_type: returns the #GTlsClientConnection implementation
 * type
 * @get_server_connection_type: returns the #GTlsServerConnection implementation
 * type
 * @get_file_database_type: returns the #GTlsFileDatabase implementation type.
 * @get_dtls_client_connection_type: returns the #GDtlsClientConnection
 * implementation type
 * @get_dtls_server_connection_type: returns the #GDtlsServerConnection
 * implementation type
 *
