...
extern int nfnlmsg_queue_msg_parse(struct nlmsghdr*, struct nfnl_queue_msg**);
...
extern const struct timeval*
    nfnl_queue_msg_get_timestamp(const struct nfnl_queue_msg*);
...
extern const uint8_t* nfnl_queue_msg_get_hwaddr(const struct nfnl_queue_msg*,
                                                int*);
...
extern const void* nfnl_queue_msg_get_payload(const struct nfnl_queue_msg*,
                                              int*);

extern void nfnl_queue_msg_set_verdict(struct nfnl_queue_msg*, unsigned int);
