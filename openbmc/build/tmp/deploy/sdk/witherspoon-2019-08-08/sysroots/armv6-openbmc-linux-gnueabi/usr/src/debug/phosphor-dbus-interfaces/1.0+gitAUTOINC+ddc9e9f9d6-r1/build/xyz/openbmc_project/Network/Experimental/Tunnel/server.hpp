...
class Tunnel
{
  public:
    ...
    using PropertiesVariant =
        std::variant<IPv6Tunnel, bool, uint32_t, std::string>;
    ...
    virtual std::string local(std::string value, bool skipSignal);
    /** Set value of Local */
    ...
    virtual bool discoverPathMTU(bool value, bool skipSignal);
    ...
    virtual uint32_t iPv6FlowLabel(uint32_t value, bool skipSignal);
    ...
    virtual bool copyDSCP(bool value, bool skipSignal);
    ...
    virtual uint32_t encapsulationLimit(uint32_t value, bool skipSignal);
    ...
    virtual std::string key(std::string value, bool skipSignal);
    /** Set value of Key */
    ...
    virtual std::string inputKey(std::string value, bool skipSignal);
    ...
    virtual std::string outputKey(std::string value, bool skipSignal);
    ...
    virtual IPv6Tunnel mode(IPv6Tunnel value, bool skipSignal);
    /** Set value of Mode */
     ...
     *                 "xyz.openbmc_project.Network.Experimental.Tunnel.<value
     * name>"
  ...
  private:
    ...
    static int _callback_get_Local(sd_bus*, const char*, const char*,
                                   const char*, sd_bus_message*, void*,
                                   sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Local' */
    static int _callback_set_Local(sd_bus*, const char*, const char*,
                                   const char*, sd_bus_message*, void*,
                                   sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Remote' */
    static int _callback_get_Remote(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Remote' */
    static int _callback_set_Remote(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);

    /** @brief sd-bus callback for get-property 'TOS' */
    static int _callback_get_TOS(sd_bus*, const char*, const char*, const char*,
                                 sd_bus_message*, void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'TOS' */
    static int _callback_set_TOS(sd_bus*, const char*, const char*, const char*,
                                 sd_bus_message*, void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'TTL' */
    static int _callback_get_TTL(sd_bus*, const char*, const char*, const char*,
                                 sd_bus_message*, void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'TTL' */
    static int _callback_set_TTL(sd_bus*, const char*, const char*, const char*,
                                 sd_bus_message*, void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'DiscoverPathMTU' */
    static int _callback_get_DiscoverPathMTU(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'DiscoverPathMTU' */
    static int _callback_set_DiscoverPathMTU(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'IPv6FlowLabel' */
    static int _callback_get_IPv6FlowLabel(sd_bus*, const char*, const char*,
                                           const char*, sd_bus_message*, void*,
                                           sd_bus_error*);
    /** @brief sd-bus callback for set-property 'IPv6FlowLabel' */
    static int _callback_set_IPv6FlowLabel(sd_bus*, const char*, const char*,
                                           const char*, sd_bus_message*, void*,
                                           sd_bus_error*);

    /** @brief sd-bus callback for get-property 'CopyDSCP' */
    static int _callback_get_CopyDSCP(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'CopyDSCP' */
    static int _callback_set_CopyDSCP(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);

    /** @brief sd-bus callback for get-property 'EncapsulationLimit' */
    static int _callback_get_EncapsulationLimit(sd_bus*, const char*,
                                                const char*, const char*,
                                                sd_bus_message*, void*,
                                                sd_bus_error*);
    /** @brief sd-bus callback for set-property 'EncapsulationLimit' */
    static int _callback_set_EncapsulationLimit(sd_bus*, const char*,
                                                const char*, const char*,
                                                sd_bus_message*, void*,
                                                sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Key' */
    static int _callback_get_Key(sd_bus*, const char*, const char*, const char*,
                                 sd_bus_message*, void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Key' */
    static int _callback_set_Key(sd_bus*, const char*, const char*, const char*,
                                 sd_bus_message*, void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'InputKey' */
    static int _callback_get_InputKey(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'InputKey' */
    static int _callback_set_InputKey(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);

    /** @brief sd-bus callback for get-property 'OutputKey' */
    static int _callback_get_OutputKey(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    /** @brief sd-bus callback for set-property 'OutputKey' */
    static int _callback_set_OutputKey(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Mode' */
    static int _callback_get_Mode(sd_bus*, const char*, const char*,
                                  const char*, sd_bus_message*, void*,
                                  sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Mode' */
    static int _callback_set_Mode(sd_bus*, const char*, const char*,
                                  const char*, sd_bus_message*, void*,
                                  sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Network_Experimental_Tunnel_interface;
