...
/**
 * GAsyncReadyCallback:
 * @source_object: (nullable): the object the asynchronous operation was started
 *with.
 * @res: a #GAsyncResult.
 ...
 **/
typedef void (*GAsyncReadyCallback)(GObject* source_object, GAsyncResult* res,
                                    gpointer user_data);
 ...
 *any more data from the file should be loaded. A #GFileReadMoreCallback
 ...
 **/
typedef void (*GSimpleAsyncThreadFunc)(GSimpleAsyncResult* res, GObject* object,
                                       GCancellable* cancellable);
 ...
 * Since: 2.22
 */
typedef gboolean (*GSocketSourceFunc)(GSocket* socket, GIOCondition condition,
                                      gpointer user_data);
 ...
 * @interface_name: (nullable): The interface name of the remote object or %NULL
 * if a #GDBusObjectProxy #GType is requested.
 * @user_data: User data.
 *
