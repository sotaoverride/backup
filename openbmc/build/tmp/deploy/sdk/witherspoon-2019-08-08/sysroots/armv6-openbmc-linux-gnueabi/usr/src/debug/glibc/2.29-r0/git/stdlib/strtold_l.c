...
extern double INTERNAL(__STRTOD)(const STRING_TYPE*, STRING_TYPE**, int,
                                 locale_t);

/* There is no `long double' type, use the `double' implementations.  */
long double INTERNAL(__STRTOLD)(const STRING_TYPE* nptr, STRING_TYPE** endptr,
