...
#define G_DBUS_MESSAGE(o)                                                      \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_MESSAGE, GDBusMessage))
#define G_IS_DBUS_MESSAGE(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_MESSAGE))
...
GLIB_AVAILABLE_IN_ALL
gssize g_dbus_message_bytes_needed(guchar* blob, gsize blob_len,
                                   GError** error);
