...
extern struct rtnl_qdisc* rtnl_qdisc_get_by_parent(struct nl_cache*, int,
                                                   uint32_t);
...
extern int rtnl_qdisc_build_delete_request(struct rtnl_qdisc*, struct nl_msg**);
...
extern int rtnl_qdisc_build_change_request(struct rtnl_qdisc*,
                                           struct rtnl_qdisc*, struct nl_msg**)
    __attribute__((deprecated));
