...
static void me(void)
{
    ...
    mmapp = (void* (*)(void*, size_t, int, int, int, off_t))dlsym(RTLD_NEXT,
                                                                  "mmap");
    mmap64p = (void* (*)(void*, size_t, int, int, int, off64_t))dlsym(RTLD_NEXT,
                                                                      "mmap64");
...
void* mmap(void* start, size_t len, int prot, int flags, int fd, off_t offset)
{
    ...
    {
        int idx =
            (flags & MAP_ANON ? idx_mmap_a
                              : prot & PROT_WRITE ? idx_mmap_w : idx_mmap_r);
...
\e[00;34m   free|\e[0m %10lu   %12llu\n",
            ...
            (unsigned long int)peak_stack, (unsigned long int)calls[idx_malloc],
            ...
            (unsigned long int)failed[idx_realloc], (unsigned long int)inplace,
            (unsigned long int)decreasing, (unsigned long int)realloc_free,
