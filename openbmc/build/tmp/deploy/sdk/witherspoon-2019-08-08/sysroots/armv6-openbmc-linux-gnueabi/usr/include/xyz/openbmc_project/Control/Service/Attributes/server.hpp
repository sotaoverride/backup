...
class Attributes
{
     ...
     *                 "xyz.openbmc_project.Control.Service.Attributes.<value name>"
     *  @return - The enum value.
     */
    static SupportedStates convertSupportedStatesFromString(const std::string& s);
    ...
    private:
        ...
        static constexpr auto _interface = "xyz.openbmc_project.Control.Service.Attributes";
