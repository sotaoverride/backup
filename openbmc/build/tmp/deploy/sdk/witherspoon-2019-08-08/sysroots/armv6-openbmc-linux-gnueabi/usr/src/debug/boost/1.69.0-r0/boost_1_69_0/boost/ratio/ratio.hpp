...
class ratio
{
    ...
    BOOST_RATIO_STATIC_ASSERT(ABS_N >= 0, BOOST_RATIO_NUMERATOR_IS_OUT_OF_RANGE,
                              ());
    BOOST_RATIO_STATIC_ASSERT(ABS_D > 0,
                              BOOST_RATIO_DENOMINATOR_IS_OUT_OF_RANGE, ());
    BOOST_RATIO_STATIC_ASSERT(D != 0, BOOST_RATIO_DIVIDE_BY_0, ());
    static const boost::intmax_t SIGN_N =
        mpl::sign_c<boost::intmax_t, N>::value *
        mpl::sign_c<boost::intmax_t, D>::value;
    static const boost::intmax_t GCD =
        mpl::gcd_c<boost::intmax_t, ABS_N, ABS_D>::value;
...
struct ratio_add : boost::ratio_detail::ratio_add<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_subtract : boost::ratio_detail::ratio_subtract<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_multiply : boost::ratio_detail::ratio_multiply<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_divide : boost::ratio_detail::ratio_divide<R1, R2>::type
{
};
...
template <class R1, class R2>
struct ratio_equal
    : public boost::integral_constant<bool, (R1::num == R2::num &&
                                             R1::den == R2::den)>
{
};
...
struct ratio_less
    : boost::integral_constant<bool,
                               boost::ratio_detail::ratio_less<R1, R2>::value>
{
};
...
template <class R1, class R2>
struct ratio_greater : boost::integral_constant<bool, ratio_less<R2, R1>::value>
{
};
...
#ifdef BOOST_RATIO_EXTENSIONS
template <class R>
struct ratio_negate : ratio<-R::num, R::den>::type
{
};
template <class R>
struct ratio_abs
...
template <class R>
struct ratio_sign : mpl::sign_c<boost::intmax_t, R::num>
{
};

template <class R>
struct ratio_inverse : ratio<R::den, R::num>::type
{
};
...
struct ratio_power
    : ratio_multiply<typename ratio_power<R, p % 2>::type,
                     typename ratio_power<typename ratio_multiply<R, R>::type,
                                          p / 2>::type>::type
{
};
