...
#define BOOST_FILESYSTEM_C_STR                                                 \
    string().c_str() // use narrow, since wide not available
...
class basic_filebuf : public std::basic_filebuf<charT, traits>
{
  ...
  public:
    ...
    {
        return std::basic_filebuf<charT, traits>::open(p.BOOST_FILESYSTEM_C_STR,
                                                       mode)
                   ? this
                   : 0;
    }
...
class basic_ifstream : public std::basic_ifstream<charT, traits>
{
  ...
  public:
    ...
    explicit basic_ifstream(const path& p) :
        std::basic_ifstream<charT, traits>(p.BOOST_FILESYSTEM_C_STR,
                                           std::ios_base::in)
    {
    }
    ...
    {
        std::basic_ifstream<charT, traits>::open(p.BOOST_FILESYSTEM_C_STR,
                                                 std::ios_base::in);
    }
...
class basic_ofstream : public std::basic_ofstream<charT, traits>
{
  ...
  public:
    ...
    explicit basic_ofstream(const path& p) :
        std::basic_ofstream<charT, traits>(p.BOOST_FILESYSTEM_C_STR,
                                           std::ios_base::out)
    {
    }
    ...
    void open(const path& p)
    {
        std::basic_ofstream<charT, traits>::open(p.BOOST_FILESYSTEM_C_STR,
                                                 std::ios_base::out);
    }
  ...
  public:
    ...
    explicit basic_fstream(const path& p) :
        std::basic_fstream<charT, traits>(
            p.BOOST_FILESYSTEM_C_STR, std::ios_base::in | std::ios_base::out)
    {
    }
