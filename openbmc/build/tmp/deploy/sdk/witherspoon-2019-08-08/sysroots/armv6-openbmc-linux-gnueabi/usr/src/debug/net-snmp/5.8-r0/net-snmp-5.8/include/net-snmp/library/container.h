 ...
 */
typedef int(netsnmp_container_option)(struct netsnmp_container_s*, int set,
                                      u_int flags);
 ...
 */
typedef int(netsnmp_container_da_op)(struct netsnmp_container_s*, size_t pos,
                                     void* data);
 ...
 */
typedef netsnmp_void_array*(netsnmp_container_set)(struct netsnmp_container_s*,
                                                   void* data);

/*
 * function returning an int for a comparison between two objects
 */
typedef int(netsnmp_container_compare)(const void* lhs, const void* rhs);
...
#define CONTAINER_SET_OPTIONS(x, o, rc)                                        \
    do                                                                         \
    {                                                                          \
        if (NULL == (x)->options)                                              \
            rc = -1;                                                           \
...
#define CONTAINER_CHECK_OPTION(x, o, rc)                                       \
    do                                                                         \
    {                                                                          \
        rc = x->flags & 0;                                                     \
    } while (0)
