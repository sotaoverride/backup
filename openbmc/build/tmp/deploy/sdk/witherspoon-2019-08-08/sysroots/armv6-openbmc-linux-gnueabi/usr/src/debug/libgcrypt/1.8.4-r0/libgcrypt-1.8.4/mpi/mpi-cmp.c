...
int _gcry_mpi_cmp_ui(gcry_mpi_t u, unsigned long v)
{
    mpi_limb_t limb = v;
...
static int do_mpi_cmp(gcry_mpi_t u, gcry_mpi_t v, int absmode)
{
    mpi_size_t usize;
    mpi_size_t vsize;
    int usign;
...
int _gcry_mpi_cmp(gcry_mpi_t u, gcry_mpi_t v)
{
