...
struct netstrm_s
{
    BEGINobjInstance; /* Data to implement generic object - MUST be the first
                         data element! */
    nsd_t* pDrvrData; /**< the driver's data elements (at most other places,
                         this is called pNsd) */
...
rsRetVal (*Connect)(netstrm_t* pThis, int family, unsigned char* port,
...
rsRetVal (*CheckConnection)(
    netstrm_t* pThis); /* This is a trick mostly for plain tcp syslog */
 ...
 * it at all. Once the imgssapi problem is solved, GetSock should be removed
 * from this interface. -- rgerhards, 2008-05-05
 */
...
rsRetVal (*LstnInit)(netstrms_t* pNS, void* pUsr,
                     rsRetVal (*)(void*, netstrm_t*), uchar* pLstnPort,
                     uchar* pLstnIP, int iSessMax, uchar* pszLstnPortFileName);
ENDinterface(netstrm)
#define netstrmCURR_IF_VERSION                                                 \
    11 /* increment whenever you change the interface structure! */
    /* interface version 3 added GetRemAddr()
     * interface version 4 added EnableKeepAlive() -- rgerhards, 2009-06-02
     * interface version 5 changed return of CheckConnection from void to
     * rsRetVal -- alorbach, 2012-09-06 interface version 6 changed signature of
     * GetRemoteIP() -- rgerhards, 2013-01-21 interface version 7 added
     * KeepAlive parameter set functions interface version 8 changed signature
     * of Connect() -- dsa, 2016-11-14 interface version 9 added
     * SetGnutlsPriorityString -- PascalWithopf, 2017-08-08 interface version 10
     * added oserr parameter to Rcv() -- rgerhards, 2017-09-04
     * */
