...
G_DEFINE_BOXED_TYPE(GIOChannel, g_io_channel, g_io_channel_ref,
                    g_io_channel_unref)
...
GType g_io_condition_get_type(void)
{
    ...
    {
        static const GFlagsValue values[] = {{G_IO_IN, "G_IO_IN", "in"},
 ...
 * instance object.
 */
static void source_closure_marshal_BOOLEAN__VOID(
...
static gboolean io_watch_closure_callback(GIOChannel* channel,
...
static gboolean g_child_watch_closure_callback(GPid pid, gint status,
                                               gpointer data)
{
    GClosure* closure = data;
...
#ifdef G_OS_UNIX
static gboolean g_unix_fd_source_closure_callback(int fd,
...
static gboolean source_closure_callback(gpointer data)
{
    GClosure* closure = data;
    GValue result_value = G_VALUE_INIT;
    gboolean result;
...
static void closure_callback_get(gpointer cb_data, GSource* source,
...
static GSourceCallbackFuncs closure_callback_funcs = {
    (void (*)(gpointer))g_closure_ref, (void (*)(gpointer))g_closure_unref,
    closure_callback_get};

static void closure_invalidated(gpointer user_data, GClosure* closure)
{
...
void g_source_set_closure(GSource* source, GClosure* closure)
{
    ...
    if (!source->source_funcs->closure_callback &&
        ...
        source->source_funcs != &g_idle_funcs)
    {
        g_critical(G_STRLOC ": closure cannot be set on GSource without "
                            "GSourceFuncs::closure_callback");
        return;
    }
...
static void dummy_closure_marshal(GClosure* closure, GValue* return_value,
