...
extern int nl_addr_cmp(const struct nl_addr*, const struct nl_addr*);
extern int nl_addr_cmp_prefix(const struct nl_addr*, const struct nl_addr*);
...
extern int nl_addr_fill_sockaddr(const struct nl_addr*, struct sockaddr*,
                                 socklen_t*);
extern int nl_addr_info(const struct nl_addr*, struct addrinfo**);
...
extern int nl_addr_set_binary_addr(struct nl_addr*, const void*, size_t);
