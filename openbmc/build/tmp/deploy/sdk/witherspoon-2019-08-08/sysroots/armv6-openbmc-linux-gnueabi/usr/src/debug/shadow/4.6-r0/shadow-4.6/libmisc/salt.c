...
static /*@observer@*/ const char*
    SHA_salt_rounds(/*@null@*/ int* prefered_rounds);
#endif /* USE_SHA_CRYPT */
 ...
 * Add the salt prefix.
 */
#define MAGNUM(array, ch)                                                      \
    (array)[0] = (array)[2] = '$', (array)[1] = (ch), (array)[3] = '\0'
    ...
    SHA_salt_rounds(/*@null@*/ int* prefered_rounds)
{
    ...
    (void)snprintf(rounds_prefix, sizeof rounds_prefix, "rounds=%ld$", rounds);
                    ...
                    /*@null@*/ void* arg)
{
    ...
    strncat(result, gensalt(salt_len), sizeof(result) - strlen(result) - 1);
