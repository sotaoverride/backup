...
class Power
{
  ...
  private:
     ...
     */
    static int _callback_SimPress(sd_bus_message*, void*, sd_bus_error*);

    /** @brief sd-bus callback for simLongPress
     */
    static int _callback_SimLongPress(sd_bus_message*, void*, sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Chassis_Buttons_Power_interface;
