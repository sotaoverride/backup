...
libc_hidden_proto(hstrerror) libc_hidden_proto(innetgr)
    libc_hidden_proto(rcmd_af) libc_hidden_proto(rexec_af)
        libc_hidden_proto(rresvport_af) libc_hidden_proto(ruserok_af)

            libc_hidden_proto(getaddrinfo) libc_hidden_proto(getnameinfo)
                libc_hidden_proto(freeaddrinfo) libc_hidden_proto(gai_strerror)
...
extern int __gethostbyaddr_r(const void* __restrict __addr, socklen_t __len,
                             int __type,
                             struct hostent* __restrict __result_buf,
                             char* __restrict __buf, size_t __buflen,
                             struct hostent** __restrict __result,
                             int* __restrict __h_errnop) attribute_hidden;
extern int __old_gethostbyaddr_r(const void* __restrict __addr, socklen_t __len,
                                 int __type,
                                 struct hostent* __restrict __result_buf,
                                 char* __restrict __buf, size_t __buflen,
                                 struct hostent** __restrict __result,
...
extern int __gethostbyaddr2_r(const void* __restrict __addr, socklen_t __len,
                              int __type,
                              struct hostent* __restrict __result_buf,
                              char* __restrict __buf, size_t __buflen,
                              struct hostent** __restrict __result,
                              int* __restrict __h_errnop, int32_t* ttlp);
...
extern int
    __getservent_r(struct servent* __restrict __result_buf,
                   char* __restrict __buf, size_t __buflen,
                   struct servent** __restrict __result) attribute_hidden;
extern int __old_getservent_r(struct servent* __restrict __result_buf,
                              char* __restrict __buf, size_t __buflen,
                              struct servent** __restrict __result);

extern int __getservbyname_r(
    const char* __restrict __name, const char* __restrict __proto,
    struct servent* __restrict __result_buf, char* __restrict __buf,
    size_t __buflen, struct servent** __restrict __result) attribute_hidden;
...
extern int
    __getservbyport_r(int __port, const char* __restrict __proto,
                      struct servent* __restrict __result_buf,
                      char* __restrict __buf, size_t __buflen,
                      struct servent** __restrict __result) attribute_hidden;
extern int __old_getservbyport_r(int __port, const char* __restrict __proto,
                                 struct servent* __restrict __result_buf,
                                 char* __restrict __buf, size_t __buflen,
                                 struct servent** __restrict __result);

extern int
    __getprotoent_r(struct protoent* __restrict __result_buf,
                    char* __restrict __buf, size_t __buflen,
                    struct protoent** __restrict __result) attribute_hidden;
extern int __old_getprotoent_r(struct protoent* __restrict __result_buf,
                               char* __restrict __buf, size_t __buflen,
                               struct protoent** __restrict __result);

extern int
    __getprotobyname_r(const char* __restrict __name,
...
extern int __getprotobynumber_r(
    int __proto, struct protoent* __restrict __res_buf, char* __restrict __buf,
    size_t __buflen, struct protoent** __restrict __result) attribute_hidden;
extern int __old_getprotobynumber_r(int __proto,
                                    struct protoent* __restrict __res_buf,
                                    char* __restrict __buf, size_t __buflen,
                                    struct protoent** __restrict __result);

extern int __getnetgrent_r(char** __restrict __hostp, char** __restrict __userp,
                           char** __restrict __domainp,
                           char* __restrict __buffer,
                           size_t __buflen) attribute_hidden;
...
#define DECLARE_NSS_PROTOTYPES(service)                                        \
    ...
    extern enum nss_status _nss_##service##_getprotoent_r(                     \
        struct protoent* proto, char* buffer, size_t buflen, int* errnop);     \
    extern enum nss_status _nss_##service##_getprotobyname_r(                  \
        const char* name, struct protoent* proto, char* buffer, size_t buflen, \
        int* errnop);                                                          \
    extern enum nss_status _nss_##service##_getprotobynumber_r(                \
        int number, struct protoent* proto, char* buffer, size_t buflen,       \
        int* errnop);                                                          \
    ...
    extern enum nss_status _nss_##service##_gethostbyname_r(                   \
        const char* name, struct hostent* host, char* buffer, size_t buflen,   \
    ...
    extern enum nss_status _nss_##service##_getservbyname_r(                   \
        const char* name, const char* protocol, struct servent* serv,          \
        char* buffer, size_t buflen, int* errnop);                             \
    extern enum nss_status _nss_##service##_getservbyport_r(                   \
        int port, const char* protocol, struct servent* serv, char* buffer,    \
    ...
    extern enum nss_status _nss_##service##_getnetent_r(                       \
        struct netent* net, char* buffer, size_t buflen, int* errnop,          \
        int* herrnop);                                                         \
    extern enum nss_status _nss_##service##_getnetbyname_r(                    \
        const char* name, struct netent* net, char* buffer, size_t buflen,     \
        int* errnop, int* herrnop);                                            \
    extern enum nss_status _nss_##service##_getnetbyaddr_r(                    \
        uint32_t addr, int type, struct netent* net, char* buffer,             \
        size_t buflen, int* errnop, int* herrnop);

                DECLARE_NSS_PROTOTYPES(compat) DECLARE_NSS_PROTOTYPES(dns)
                    DECLARE_NSS_PROTOTYPES(files) DECLARE_NSS_PROTOTYPES(hesiod)
