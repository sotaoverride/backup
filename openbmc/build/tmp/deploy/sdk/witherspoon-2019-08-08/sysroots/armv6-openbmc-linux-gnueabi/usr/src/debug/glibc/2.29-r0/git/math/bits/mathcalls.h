...
__MATHDECL_1(int, setpayloadsig, , (_Mdouble_ * __x, _Mdouble_ __payload));
     ...
     (defined __USE_XOPEN_EXTENDED && __MATH_DECLARING_DOUBLE &&               \
