...
struct ls_zeros
{
    static const std::size_t value =
        (S & std::size_t(1)) ? 0 : (1 + ls_zeros<(S >> 1u)>::value);
};
    ...
    {                                                                          \
        ...
        {                                                                      \
            typedef DefaultType TNAME;                                         \
                                                                               ...
                                                                               \
        typedef typename ::boost::intrusive::detail::if_c<                     \
            boost_intrusive_has_type_##TNAME<T>::value, T,                     \
            DefaultWrap>::type::TNAME type;                                    \
    };                                                                         \
    //
...
#define BOOST_INTRUSIVE_INSTANTIATE_EVAL_DEFAULT_TYPE_TMPLT(TNAME)             \
    ...
    {                                                                          \
        ...
        static const bool value = (1 == sizeof(test<T>(0, 0)));                \
                                                                               \
        typedef typename ::boost::intrusive::detail::eval_if_c<                \
            value, ::boost::intrusive::detail::identity<T>,                    \
            ::boost::intrusive::detail::identity<DefaultWrap>>::type::TNAME    \
            type;                                                              \
    };                                                                         \
    //
...
#define BOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(TRAITS_NAME,          \
    ...
    {                                                                          \
      private:                                                                 \
        ...
        struct helper;                                                         \
        template <typename T>                                                  \
        static ::boost::intrusive::detail::yes_type                            \
            test(helper<&T::FUNC_NAME>*);                                      \
        template <typename T>                                                  \
        static ::boost::intrusive::detail::no_type test(...);                  \
                                                                               \
      public:                                                                  \
        static const bool value =                                              \
            sizeof(test<U>(0)) ==                                              \
            sizeof(::boost::intrusive::detail::yes_type);                      \
    };                                                                         \
    //
...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNC_CALLED(TRAITS_NAME, FUNC_NAME)         \
    ...
    {                                                                          \
        ...
        template <typename U>                                                  \
        static ::boost::intrusive::detail::no_type                             \
            test(U*, Helper<void (BaseMixin::*)(), &U::FUNC_NAME>* = 0);       \
...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNC_CALLED_IGNORE_SIGNATURE(TRAITS_NAME,   \
                                                                FUNC_NAME)     \
    BOOST_INTRUSIVE_HAS_MEMBER_FUNC_CALLED(TRAITS_NAME##_ignore_signature,     \
                                           FUNC_NAME)                          \
                                                                               \
    template <typename Type, class>                                            \
    struct TRAITS_NAME : public TRAITS_NAME##_ignore_signature<Type>           \
    {                                                                          \
    };                                                                         \
    //
