...
#define G_SOCKET_OUTPUT_STREAM(inst)                                           \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_SOCKET_OUTPUT_STREAM,           \
                                GSocketOutputStream))
#define G_SOCKET_OUTPUT_STREAM_CLASS(class)                                    \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_SOCKET_OUTPUT_STREAM,             \
                             GSocketOutputStreamClass))
#define G_IS_SOCKET_OUTPUT_STREAM(inst)                                        \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_SOCKET_OUTPUT_STREAM))
#define G_IS_SOCKET_OUTPUT_STREAM_CLASS(class)                                 \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_SOCKET_OUTPUT_STREAM))
#define G_SOCKET_OUTPUT_STREAM_GET_CLASS(inst)                                 \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_SOCKET_OUTPUT_STREAM,            \
                               GSocketOutputStreamClass))
