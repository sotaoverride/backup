...
{
  private:
    typedef typename sp_aligned_storage<
        sizeof(T), ::boost::alignment_of<T>::value>::type storage_type;
  ...
  public:
    ...
    template <class A>
    explicit sp_ms_deleter(A const&) BOOST_SP_NOEXCEPT : initialized_(false)
    {
    }
...
class sp_as_deleter
{
  ...
  public:
    ...
    // optimization: do not copy storage_
    sp_as_deleter(sp_as_deleter const& r) BOOST_SP_NOEXCEPT
        : a_(r.a_),
          initialized_(false)
    {
    }
                                                                 ...
                                                                 Args&&... args)
{
    ...
    boost::shared_ptr<T> pt(static_cast<T*>(0),
                            boost::detail::sp_inplace_tag<D>(), a2);
...
#else // !defined( BOOST_NO_CXX11_VARIADIC_TEMPLATES ) && !defined(
      // BOOST_NO_CXX11_RVALUE_REFERENCES )

// Common zero-argument versions

template <class T>
typename boost::detail::sp_if_not_array<T>::type make_shared()
{
    boost::shared_ptr<T> pt(static_cast<T*>(0), BOOST_SP_MSD(T));
...
typename boost::detail::sp_if_not_array<T>::type make_shared(BOOST_FWD_REF(A1)
                                                                 a1)
{
    boost::shared_ptr<T> pt(static_cast<T*>(0), BOOST_SP_MSD(T));
...
typename boost::detail::sp_if_not_array<T>::type
    allocate_shared(A const& a, BOOST_FWD_REF(A1) a1)
{
    boost::shared_ptr<T> pt(static_cast<T*>(0), BOOST_SP_MSD(T), a);
...
typename boost::detail::sp_if_not_array<T>::type
    make_shared(BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
{
    boost::shared_ptr<T> pt(static_cast<T*>(0), BOOST_SP_MSD(T));
    ...
    ::new (pv) T(boost::forward<A1>(a1), boost::forward<A2>(a2));
...
typename boost::detail::sp_if_not_array<T>::type
    allocate_shared(A const& a, BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
{
    boost::shared_ptr<T> pt(static_cast<T*>(0), BOOST_SP_MSD(T), a);
...
typename boost::detail::sp_if_not_array<T>::type
    make_shared(BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2,
                BOOST_FWD_REF(A3) a3, BOOST_FWD_REF(A4) a4,
                BOOST_FWD_REF(A5) a5, BOOST_FWD_REF(A6) a6)
{
    boost::shared_ptr<T> pt(static_cast<T*>(0), BOOST_SP_MSD(T));
    ...
    ::new (pv) T(boost::forward<A1>(a1), boost::forward<A2>(a2),
                 boost::forward<A3>(a3), boost::forward<A4>(a4),
                 boost::forward<A5>(a5), boost::forward<A6>(a6));
...
typename boost::detail::sp_if_not_array<T>::type
    make_shared(BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2,
                BOOST_FWD_REF(A3) a3, BOOST_FWD_REF(A4) a4,
                BOOST_FWD_REF(A5) a5, BOOST_FWD_REF(A6) a6,
                BOOST_FWD_REF(A7) a7, BOOST_FWD_REF(A8) a8)
{
    boost::shared_ptr<T> pt(static_cast<T*>(0), BOOST_SP_MSD(T));
    ...
    ::new (pv) T(boost::forward<A1>(a1), boost::forward<A2>(a2),
                 boost::forward<A3>(a3), boost::forward<A4>(a4),
                 boost::forward<A5>(a5), boost::forward<A6>(a6),
                 boost::forward<A7>(a7), boost::forward<A8>(a8));
...
typename boost::detail::sp_if_not_array<T>::type make_shared(
    BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2, BOOST_FWD_REF(A3) a3,
    BOOST_FWD_REF(A4) a4, BOOST_FWD_REF(A5) a5, BOOST_FWD_REF(A6) a6,
    BOOST_FWD_REF(A7) a7, BOOST_FWD_REF(A8) a8, BOOST_FWD_REF(A9) a9)
{
    boost::shared_ptr<T> pt(static_cast<T*>(0), BOOST_SP_MSD(T));
    ...
    ::new (pv) T(
        ...
        boost::forward<A4>(a4), boost::forward<A5>(a5), boost::forward<A6>(a6),
        boost::forward<A7>(a7), boost::forward<A8>(a8), boost::forward<A9>(a9));
...
#endif // !defined( BOOST_NO_CXX11_VARIADIC_TEMPLATES ) && !defined(
       // BOOST_NO_CXX11_RVALUE_REFERENCES )
