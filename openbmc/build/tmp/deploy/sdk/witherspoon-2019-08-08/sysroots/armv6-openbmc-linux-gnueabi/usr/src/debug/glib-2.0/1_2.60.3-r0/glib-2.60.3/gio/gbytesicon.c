...
G_DEFINE_TYPE_WITH_CODE(
    GBytesIcon, g_bytes_icon, G_TYPE_OBJECT,
...
static void g_bytes_icon_get_property(GObject* object, guint prop_id,
...
static void g_bytes_icon_set_property(GObject* object, guint prop_id,
...
static void g_bytes_icon_finalize(GObject* object)
{
    GBytesIcon* icon;
...
static void g_bytes_icon_class_init(GBytesIconClass* klass)
{
    ...
    g_object_class_install_property(
        ...
        g_param_spec_boxed("bytes", P_("bytes"),
                           P_("The bytes containing the icon"), G_TYPE_BYTES,
                           G_PARAM_CONSTRUCT_ONLY | G_PARAM_READWRITE |
                               G_PARAM_STATIC_STRINGS));
}

static void g_bytes_icon_init(GBytesIcon* bytes)
{
}
...
static guint g_bytes_icon_hash(GIcon* icon)
{
...
static gboolean g_bytes_icon_equal(GIcon* icon1, GIcon* icon2)
{
...
static GInputStream* g_bytes_icon_load(GLoadableIcon* icon, int size,
...
static void g_bytes_icon_load_async(GLoadableIcon* icon, int size,
                                    ...
                                    gpointer user_data)
{
    ...
    g_task_return_pointer(
        task, g_memory_input_stream_new_from_bytes(bytes_icon->bytes),
        g_object_unref);
    g_object_unref(task);
}

static GInputStream* g_bytes_icon_load_finish(GLoadableIcon* icon,
