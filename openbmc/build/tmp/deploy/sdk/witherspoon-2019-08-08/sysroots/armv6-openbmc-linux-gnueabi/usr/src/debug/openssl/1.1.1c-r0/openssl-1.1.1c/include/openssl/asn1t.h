...
#define static_ASN1_ITEM_TEMPLATE_END(tname)                                   \
    ;                                                                          \
    static_ASN1_ITEM_start(tname) ASN1_ITYPE_PRIMITIVE, -1, &tname##_item_tt,  \
        0, NULL, 0, #tname ASN1_ITEM_end(tname)
...
#define static_ASN1_NDEF_SEQUENCE_END(tname)                                   \
    ;                                                                          \
    static_ASN1_ITEM_start(tname) ASN1_ITYPE_NDEF_SEQUENCE, V_ASN1_SEQUENCE,   \
        tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL,  \
        sizeof(tname), #tname ASN1_ITEM_end(tname)
...
#define ASN1_SEQUENCE_END_ref(stname, tname)                                   \
    ...
    ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE,               \
        ...
        &tname##_aux, sizeof(stname), #tname ASN1_ITEM_end(tname)
