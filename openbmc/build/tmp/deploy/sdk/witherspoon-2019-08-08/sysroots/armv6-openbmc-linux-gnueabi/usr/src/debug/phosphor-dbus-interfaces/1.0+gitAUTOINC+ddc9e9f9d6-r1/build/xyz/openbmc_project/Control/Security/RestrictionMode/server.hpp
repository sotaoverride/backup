...
class RestrictionMode
{
  public:
    ...
    using PropertiesVariant = std::variant<Modes>;
    ...
    virtual Modes restrictionMode(Modes value, bool skipSignal);
     ...
     *                 "xyz.openbmc_project.Control.Security.RestrictionMode.<value
     * name>"
  ...
  private:
    ...
    static int _callback_get_RestrictionMode(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'RestrictionMode' */
    static int _callback_set_RestrictionMode(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Control_Security_RestrictionMode_interface;
