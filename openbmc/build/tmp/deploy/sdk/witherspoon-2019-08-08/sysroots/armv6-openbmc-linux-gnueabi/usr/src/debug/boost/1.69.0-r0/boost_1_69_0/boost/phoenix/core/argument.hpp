...
{
template <int I>
struct is_placeholder<phoenix::argument<I>> : mpl::int_<I>
{
};
} // namespace boost
...
{
template <int I>
struct argument : expression::terminal<phoenix::argument<I>>
{
...
#pragma wave option(                                                           \
    preserve : 2, line : 0, output                                             \
    : "detail/cpp03/preprocessed/argument_predefined_" BOOST_PHOENIX_LIMIT_STR \
      ".hpp")
#endif
/*==============================================================================
    Copyright (c) 2001-2010 Joel de Guzman
...
#pragma wave option(                                                              \
    preserve : 2, line : 0, output                                                \
    : "detail/cpp03/preprocessed/argument_no_predefined_" BOOST_PHOENIX_LIMIT_STR \
      ".hpp")
#endif
/*==============================================================================
    Copyright (c) 2001-2010 Joel de Guzman
