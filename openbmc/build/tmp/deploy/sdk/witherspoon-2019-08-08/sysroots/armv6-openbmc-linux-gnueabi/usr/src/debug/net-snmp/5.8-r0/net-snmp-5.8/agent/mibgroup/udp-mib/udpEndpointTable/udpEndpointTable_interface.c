...
netsnmp_feature_child_of(udpEndpointTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_child_of(udpEndpointTable_container_size,
                                 udpEndpointTable_external_access)
            netsnmp_feature_child_of(udpEndpointTable_registration_set,
                                     udpEndpointTable_external_access)
                netsnmp_feature_child_of(udpEndpointTable_registration_get,
                                         udpEndpointTable_external_access)
                    netsnmp_feature_child_of(udpEndpointTable_container_get,
                                             udpEndpointTable_external_access)
...
static void _udpEndpointTable_container_shutdown(
 ...
 */
void _udpEndpointTable_initialize_interface(
    udpEndpointTable_registration* reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods* access_multiplexer =
    ...
    DEBUGMSGTL(
        ("internal:udpEndpointTable:_udpEndpointTable_initialize_interface",
         "called\n"));
    ...
    reginfo = netsnmp_handler_registration_create(
        "udpEndpointTable", handler, udpEndpointTable_oid,
        udpEndpointTable_oid_size, HANDLER_CAN_BABY_STEP | HANDLER_CAN_RONLY);
    if (NULL == reginfo)
    {
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, udpEndpointTable_if_ctx.container,
 ...
 */
void _udpEndpointTable_shutdown_interface(
    udpEndpointTable_registration* reg_ptr)
{
    /*
...
void udpEndpointTable_valid_columns_set(netsnmp_column_info* vc)
{
                                  ...
                                  udpEndpointTable_mib_index* mib_idx)
{
    ...
    memset(&var_udpEndpointLocalPort, 0x00, sizeof(var_udpEndpointLocalPort));
    ...
    memset(&var_udpEndpointRemotePort, 0x00, sizeof(var_udpEndpointRemotePort));
    var_udpEndpointRemotePort.type = ASN_UNSIGNED;
    memset(&var_udpEndpointInstance, 0x00, sizeof(var_udpEndpointInstance));
    ...
    var_udpEndpointLocalPort.next_variable = &var_udpEndpointRemoteAddressType;
    var_udpEndpointRemoteAddressType.next_variable =
        &var_udpEndpointRemoteAddress;
    var_udpEndpointRemoteAddress.next_variable = &var_udpEndpointRemotePort;
    var_udpEndpointRemotePort.next_variable = &var_udpEndpointInstance;
    var_udpEndpointInstance.next_variable = NULL;

    DEBUGMSGTL(
        ("verbose:udpEndpointTable:udpEndpointTable_index_to_oid", "called\n"));
 ...
 */
int udpEndpointTable_index_from_oid(netsnmp_index* oid_idx,
                                    udpEndpointTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
 ...
 */
udpEndpointTable_rowreq_ctx* udpEndpointTable_allocate_rowreq_ctx(void)
{
    udpEndpointTable_rowreq_ctx* rowreq_ctx =
        SNMP_MALLOC_TYPEDEF(udpEndpointTable_rowreq_ctx);

    DEBUGMSGTL(
        ("internal:udpEndpointTable:udpEndpointTable_allocate_rowreq_ctx",
         "called\n"));
 ...
 */
void udpEndpointTable_release_rowreq_ctx(
    udpEndpointTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("internal:udpEndpointTable:udpEndpointTable_release_rowreq_ctx",
                "called\n"));
 ...
 * wrapper
 */
static int _mfd_udpEndpointTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:udpEndpointTable:_mfd_udpEndpointTable_pre_request",
                "called\n"));

    if (1 != netsnmp_row_merge_status_first(reginfo, agtreq_info))
    {
        DEBUGMSGTL(
            ("internal:udpEndpointTable", "skipping additional pre_request\n"));
 ...
 * wrapper
 */
static int _mfd_udpEndpointTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    udpEndpointTable_rowreq_ctx* rowreq_ctx =
        (udpEndpointTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    int rc, packet_rc;

    DEBUGMSGTL(("internal:udpEndpointTable:_mfd_udpEndpointTable_post_request",
                "called\n"));
    ...
    {
        DEBUGMSGTL(
            ("internal:udpEndpointTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
 ...
 * wrapper
 */
static int _mfd_udpEndpointTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:udpEndpointTable:_mfd_udpEndpointTable_object_lookup",
                "called\n"));
                                 ...
                                 netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(("internal:udpEndpointTable:_mfd_udpEndpointTable_get_column",
                "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_UDPENDPOINTPROCESS:
            ...
            rc = udpEndpointProcess_get(rowreq_ctx, (u_long*)var->val.string);
            break;
...
int _mfd_udpEndpointTable_get_values(netsnmp_mib_handler* handler,
                                     netsnmp_handler_registration* reginfo,
                                     ...
                                     netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:udpEndpointTable:_mfd_udpEndpointTable_get_values",
                "called\n"));
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
    ...
    {
        snmp_log(LOG_ERR, "invalid cache for udpEndpointTable_cache_load\n");
        return -1;
    }
     ...
     * call user code
     */
    return udpEndpointTable_container_load((netsnmp_container*)cache->magic);
} /* _cache_load */
...
static void _cache_free(netsnmp_cache* cache, void* magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log(LOG_ERR, "invalid cache in udpEndpointTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free(udpEndpointTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(("internal:udpEndpointTable:_container_item_free", "called\n"));
...
{
    DEBUGMSGTL(("internal:udpEndpointTable:_udpEndpointTable_container_init",
                "called\n"));
    ...
    if_ctx->cache =
        netsnmp_cache_create(30, /* timeout in seconds */
                             _cache_load, _cache_free, udpEndpointTable_oid,
...
{
    DEBUGMSGTL(
        ("internal:udpEndpointTable:_udpEndpointTable_container_shutdown",
         "called\n"));
...
udpEndpointTable_rowreq_ctx*
    udpEndpointTable_row_find_by_mib_index(udpEndpointTable_mib_index* mib_idx)
{
    udpEndpointTable_rowreq_ctx* rowreq_ctx;
    ...
    rowreq_ctx = (udpEndpointTable_rowreq_ctx*)CONTAINER_FIND(
        udpEndpointTable_if_ctx.container, &oid_idx);
