...
ASN1_SEQUENCE(X509_REVOKED) =
    {ASN1_EMBED(X509_REVOKED, serialNumber, ASN1_INTEGER),
     ...
     ASN1_SEQUENCE_OF_OPT(X509_REVOKED, extensions,
                          X509_EXTENSION)} ASN1_SEQUENCE_END(X509_REVOKED)
...
ASN1_SEQUENCE_enc(X509_CRL_INFO, enc, crl_inf_cb) =
    {ASN1_OPT(X509_CRL_INFO, version, ASN1_INTEGER),
     ...
     ASN1_EXP_SEQUENCE_OF_OPT(X509_CRL_INFO, extensions, X509_EXTENSION,
                              0)} ASN1_SEQUENCE_END_enc(X509_CRL_INFO,
                                                        X509_CRL_INFO)
                  ...
                  void* exarg)
{
    ...
    switch (operation)
    {
        ...
        case ASN1_OP_D2I_POST:
            ...
            crl->akid = X509_CRL_get_ext_d2i(crl, NID_authority_key_identifier,
                                             NULL, NULL);

            crl->crl_number =
                X509_CRL_get_ext_d2i(crl, NID_crl_number, NULL, NULL);

            crl->base_crl_number =
                X509_CRL_get_ext_d2i(crl, NID_delta_crl, NULL, NULL);
...
ASN1_SEQUENCE_ref(X509_CRL, crl_cb) =
    {ASN1_EMBED(X509_CRL, crl, X509_CRL_INFO),
     ...
     ASN1_EMBED(X509_CRL, signature,
                ASN1_BIT_STRING)} ASN1_SEQUENCE_END_ref(X509_CRL, X509_CRL)
...
{
    if (crl->meth->crl_lookup)
        return crl->meth->crl_lookup(crl, ret, X509_get_serialNumber(x),
