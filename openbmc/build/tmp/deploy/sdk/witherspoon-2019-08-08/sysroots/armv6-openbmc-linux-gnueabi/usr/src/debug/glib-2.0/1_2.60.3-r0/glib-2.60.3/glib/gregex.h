 ...
 * @G_REGEX_ERROR_NUMBER_TOO_BIG: number is too big in escape sequence.
 * Since: 2.34
 ...
 * @G_REGEX_ERROR_BACKTRACKING_CONTROL_VERB_ARGUMENT_REQUIRED: the backtracing
 ...
 * @G_REGEX_ERROR_NOT_SUPPORTED_IN_CLASS: "\\N" is not supported in a class.
 * Since: 2.34
 ...
 *     is recognised. If this option is set, then "\R" only recognizes the
 ...
 * @G_REGEX_MATCH_BSR_ANYCRLF: Overrides the newline definition for "\R" set
 ...
 * and the single characters U+000B LINE TABULATION, U+000C FORM FEED (FF),
 *     U+0085 NEXT LINE (NEL), U+2028 LINE SEPARATOR and
 *     U+2029 PARAGRAPH SEPARATOR. Since: 2.34
 * @G_REGEX_MATCH_PARTIAL_SOFT: An alias for #G_REGEX_MATCH_PARTIAL. Since: 2.34
 * @G_REGEX_MATCH_PARTIAL_HARD: Turns on the partial matching feature. In
 * contrast to to #G_REGEX_MATCH_PARTIAL_SOFT, this stops matching as soon as a
 * partial match is found, without continuing to search for a possible complete
 * match. See g_match_info_is_partial_match() for more information. Since: 2.34
 * @G_REGEX_MATCH_NOTEMPTY_ATSTART: Like #G_REGEX_MATCH_NOTEMPTY, but only
 * applied to the start of the matched string. For anchored patterns this can
 * only happen for pattern containing "\K". Since: 2.34
 *
