...
bool_t _xdr_nis_server(XDR* xdrs, nis_server* objp)
{
    ...
    if (__builtin_expect(res, TRUE))
    {
        res = xdr_array(xdrs, (void*)&objp->ep.ep_val, &objp->ep.ep_len, ~0,
    ...
    if (__builtin_expect(res, TRUE))
    {
        ...
        if (__builtin_expect(res, TRUE))
        {
            ...
            if (__builtin_expect(res, TRUE))
            {
                ...
                if (__builtin_expect(res, TRUE))
                    res = xdr_array(xdrs, (void*)&objp->do_armask.do_armask_val,
...
static bool_t xdr_entry_obj(XDR* xdrs, entry_obj* objp)
{
    ...
    if (__builtin_expect(res, TRUE))
        res = xdr_array(xdrs, (void*)&objp->en_cols.en_cols_val,
                        &objp->en_cols.en_cols_len, ~0, sizeof(entry_col),
                        (xdrproc_t)xdr_entry_col);
    return res;
}
...
static bool_t xdr_group_obj(XDR* xdrs, group_obj* objp)
{
    ...
    if (__builtin_expect(res, TRUE))
        res = xdr_array(xdrs, (void*)&objp->gr_members.gr_members_val,
                        &objp->gr_members.gr_members_len, ~0, sizeof(nis_name),
...
static bool_t xdr_link_obj(XDR* xdrs, link_obj* objp)
{
    ...
    if (__builtin_expect(res, TRUE))
    {
        res = xdr_array(xdrs, (void*)&objp->li_attrs.li_attrs_val,
                        &objp->li_attrs.li_attrs_len, ~0, sizeof(nis_attr),
                        (xdrproc_t)xdr_nis_attr);
        if (__builtin_expect(res, TRUE))
...
bool_t _xdr_nis_result(XDR* xdrs, nis_result* objp)
{
    ...
    if (__builtin_expect(res, TRUE))
    {
        res = xdr_array(xdrs, (void*)&objp->objects.objects_val,
                        &objp->objects.objects_len, ~0, sizeof(nis_object),
...
libnsl_hidden_nolink_def(_xdr_nis_result, GLIBC_PRIVATE)
    ...
    bool_t _xdr_ns_request(XDR* xdrs, ns_request* objp)
{
    bool_t res = xdr_nis_name(xdrs, &objp->ns_name);
    if (__builtin_expect(res, TRUE))
        res = xdr_array(xdrs, (void*)&objp->ns_object.ns_object_val,
                        &objp->ns_object.ns_object_len, 1, sizeof(nis_object),
                        (xdrproc_t)_xdr_nis_object);
    return res;
}
...
bool_t _xdr_ib_request(XDR* xdrs, ib_request* objp)
{
    ...
    if (__builtin_expect(res, TRUE))
    {
        res = xdr_array(xdrs, (void*)&objp->ibr_srch.ibr_srch_val,
                        &objp->ibr_srch.ibr_srch_len, ~0, sizeof(nis_attr),
                        (xdrproc_t)xdr_nis_attr);
        if (__builtin_expect(res, TRUE))
        {
            ...
            if (__builtin_expect(res, TRUE))
            {
                ...
                {
                    res = xdr_array(
                        xdrs, (void*)&objp->ibr_cbhost.ibr_cbhost_val,
                        &objp->ibr_cbhost.ibr_cbhost_len, 1, sizeof(nis_server),
...
libnsl_hidden_nolink_def(_xdr_ib_request, GLIBC_PRIVATE)
    ...
    bool_t _xdr_ping_args(XDR* xdrs, ping_args* objp)
{
...
{
    return xdr_array(xdrs, (void*)&objp->tags.tags_val, &objp->tags.tags_len,
                     ~0, sizeof(nis_tag), (xdrproc_t)_xdr_nis_tag);
}
...
libnsl_hidden_nolink_def(xdr_obj_p, GLIBC_2_1)
    ...
    bool_t xdr_cback_data(XDR* xdrs, cback_data* objp)
{
    return xdr_array(xdrs, (void*)&objp->entries.entries_val,
                     &objp->entries.entries_len, ~0, sizeof(obj_p),
                     (xdrproc_t)xdr_obj_p);
}
