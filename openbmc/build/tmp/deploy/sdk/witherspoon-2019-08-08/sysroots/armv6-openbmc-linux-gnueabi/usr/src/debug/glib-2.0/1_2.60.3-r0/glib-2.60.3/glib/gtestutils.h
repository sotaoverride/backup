...
#define g_assert_cmpvariant(v1, v2)                                            \
    ...
    {                                                                          \
        ...
        {                                                                      \
            ...
            __msg = g_strdup_printf("assertion failed (" #v1 " == " #v2        \
                                    "): %s does not equal %s",                 \
                                    __s1, __s2);                               \
            g_assertion_message(G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC,   \
                                __msg);                                        \
...
GLIB_AVAILABLE_IN_ALL
void g_test_init(int* argc, char*** argv, ...) G_GNUC_NULL_TERMINATED;
...
#define g_test_init(argc, argv, ...)                                           \
    G_STMT_START                                                               \
    {                                                                          \
        g_printerr("Tests were compiled with G_DISABLE_ASSERT and are likely " \
                   "no-ops. Aborting.\n");                                     \
        exit(1);                                                               \
    }                                                                          \
    G_STMT_END
    ...
    {                                                                          \
        void (*add_vtable)(const char*, gsize, gconstpointer,                  \
            ...
            (void (*)(const gchar*, gsize, gconstpointer,                      \
                      void (*)(Fixture*, gconstpointer),                       \
                      void (*)(Fixture*, gconstpointer),                       \
                      void (*)(Fixture*, gconstpointer)))g_test_add_vtable;    \
        add_vtable(testpath, sizeof(Fixture), tdata, fsetup, ftest,            \
                   fteardown);                                                 \
    }                                                                          \
    G_STMT_END
...
#define g_test_trap_assert_passed()                                            \
    g_test_trap_assertions(G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 0, 0)
#define g_test_trap_assert_failed()                                            \
    g_test_trap_assertions(G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 1, 0)
#define g_test_trap_assert_stdout(soutpattern)                                 \
    g_test_trap_assertions(G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 2,     \
                           soutpattern)
#define g_test_trap_assert_stdout_unmatched(soutpattern)                       \
    g_test_trap_assertions(G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 3,     \
                           soutpattern)
#define g_test_trap_assert_stderr(serrpattern)                                 \
    g_test_trap_assertions(G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 4,     \
                           serrpattern)
#define g_test_trap_assert_stderr_unmatched(serrpattern)                       \
    g_test_trap_assertions(G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 5,     \
                           serrpattern)
