...
static OM_uint32 val_dsp_name_args(OM_uint32* minor_status,
...
OM_uint32 KRB5_CALLCONV gss_display_name(minor_status, input_name,
...

{
    ...
    if (union_name->mech_type)
    {
         ...
         */
        return (gssint_display_internal_name(
            minor_status, union_name->mech_type, union_name->mech_name,
            output_name_buffer, output_name_type));
    }
