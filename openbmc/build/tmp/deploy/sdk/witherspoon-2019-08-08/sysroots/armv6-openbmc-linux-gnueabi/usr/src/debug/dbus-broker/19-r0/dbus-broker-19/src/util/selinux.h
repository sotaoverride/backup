...
int bus_selinux_registry_new(BusSELinuxRegistry** registryp,
...
int bus_selinux_registry_add_name(BusSELinuxRegistry* registry,
                                  const char* name, const char* context);

int bus_selinux_check_own(BusSELinuxRegistry* registry,
                          const char* context_owner, const char* name);
