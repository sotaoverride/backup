                                   ...
                                   const Policy& pol)
{
    ...
    T leg = detail::legendre_p_imp(
        n, m, x, static_cast<T>(pow(fabs(sin_theta), T(m))), pol);

    T prefix = boost::math::tgamma_delta_ratio(static_cast<T>(n - m + 1),
                                               static_cast<T>(2 * m), pol);
...
T spherical_harmonic_r(unsigned n, int m, T theta, T phi, const Policy& pol)
{
    ...
    if (m & 1)
    {
        ...
        T mod = boost::math::tools::fmod_workaround(theta,
                                                    T(2 * constants::pi<T>()));
        if (mod < 0)
                                   ...
                                   const Policy& pol)
{
    ...
    {
        // Check phase if theta is outside [0, PI]:
        U mod = boost::math::tools::fmod_workaround(theta,
                                                    U(2 * constants::pi<U>()));
        if (mod < 0)
    ...
    static const char* function =
        "boost::math::spherical_harmonic<%1%>(int, int, %1%, %1%)";
    return std::complex<T>(
        policies::checked_narrowing_cast<T, Policy>(r, function),
        policies::checked_narrowing_cast<T, Policy>(i, function));
}
    ...
    spherical_harmonic(unsigned n, int m, T1 theta, T2 phi, const Policy& pol)
{
    ...
    return detail::spherical_harmonic<result_type, value_type>(
        n, m, static_cast<value_type>(theta), static_cast<value_type>(phi),
        pol);
}
    ...
    spherical_harmonic_r(unsigned n, int m, T1 theta, T2 phi, const Policy& pol)
{
    ...
    return policies::checked_narrowing_cast<result_type, Policy>(
        detail::spherical_harmonic_r(n, m, static_cast<value_type>(theta),
                                     static_cast<value_type>(phi), pol),
        "bost::math::spherical_harmonic_r<%1%>(unsigned, int, %1%, %1%)");
}
    ...
    spherical_harmonic_i(unsigned n, int m, T1 theta, T2 phi, const Policy& pol)
{
    ...
    typedef typename policies::evaluation<result_type, Policy>::type value_type;
    return policies::checked_narrowing_cast<result_type, Policy>(
        detail::spherical_harmonic_i(n, m, static_cast<value_type>(theta),
                                     static_cast<value_type>(phi), pol),
        "boost::math::spherical_harmonic_i<%1%>(unsigned, int, %1%, %1%)");
}
