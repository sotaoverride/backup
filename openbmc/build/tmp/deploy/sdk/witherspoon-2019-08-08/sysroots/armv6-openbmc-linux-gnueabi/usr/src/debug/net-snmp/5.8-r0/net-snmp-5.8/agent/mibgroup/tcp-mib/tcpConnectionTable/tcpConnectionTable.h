...
config_require(tcp - mib / data_access / tcpConn)
    config_require(tcp -
                   mib / tcpConnectionTable / tcpConnectionTable_interface)
        config_require(tcp - mib / tcpConnectionTable /
                                 tcpConnectionTable_data_access)
/* *INDENT-ON*  */
...
int
        ...
        tcpConnectionProcess_undo_setup(tcpConnectionTable_rowreq_ctx *
                                        rowreq_ctx);
int tcpConnectionProcess_set(tcpConnectionTable_rowreq_ctx* rowreq_ctx,
                             u_long tcpConnectionProcess_val);
int tcpConnectionProcess_undo(tcpConnectionTable_rowreq_ctx* rowreq_ctx);
