...
class epoll_reactor : public execution_context_service_base<epoll_reactor>
{
  ...
  public:
    ...
    class descriptor_state : operation
    {
        ...
        BOOST_ASIO_DECL static void
            do_complete(void* owner, operation* base,
    ...
    BOOST_ASIO_DECL void
        notify_fork(boost::asio::execution_context::fork_event fork_ev);
    ...
    // code on failure.
    BOOST_ASIO_DECL int
        register_descriptor(socket_type descriptor,
    ...
    BOOST_ASIO_DECL void
        deregister_descriptor(socket_type descriptor,
                              per_descriptor_data& descriptor_data,
                              bool closing);
