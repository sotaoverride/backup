...
OM_uint32 KRB5_CALLCONV gss_unwrap(minor_status, context_handle,
...

{
    ...
    if (mech)
    {
        ...
        {
            status = gssint_unwrap_aead(
                mech, minor_status, ctx, input_message_buffer, GSS_C_NO_BUFFER,
...
OM_uint32 KRB5_CALLCONV gss_unseal(minor_status, context_handle,
                                   input_message_buffer, output_message_buffer,
                                   conf_state, qop_state)
