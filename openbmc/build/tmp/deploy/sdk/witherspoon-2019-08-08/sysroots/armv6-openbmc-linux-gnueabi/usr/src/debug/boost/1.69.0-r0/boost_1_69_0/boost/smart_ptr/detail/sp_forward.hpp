...
// GCC 4.4 supports an outdated version of rvalue references and creates a copy
// of the forwarded object. This results in warnings 'returning reference to
// temporary'. Therefore we use a special version similar to std::forward.
template <class T>
