...
#define AVAHI_DBUS_INTERFACE_SERVICE_TYPE_BROWSER                              \
    AVAHI_DBUS_NAME ".ServiceTypeBrowser"
...
#define AVAHI_DBUS_INTERFACE_HOST_NAME_RESOLVER                                \
    AVAHI_DBUS_NAME ".HostNameResolver"
...
#define AVAHI_DBUS_ERR_INVALID_HOST_NAME                                       \
    "org.freedesktop.Avahi.InvalidHostNameError"
#define AVAHI_DBUS_ERR_INVALID_DOMAIN_NAME                                     \
...
#define AVAHI_DBUS_ERR_INVALID_SERVICE_NAME                                    \
    "org.freedesktop.Avahi.InvalidServiceNameError"
#define AVAHI_DBUS_ERR_INVALID_SERVICE_TYPE                                    \
...
#define AVAHI_DBUS_ERR_INVALID_ADDRESS                                         \
    "org.freedesktop.Avahi.InvalidAddressError"
#define AVAHI_DBUS_ERR_TIMEOUT "org.freedesktop.Avahi.TimeoutError"
#define AVAHI_DBUS_ERR_TOO_MANY_CLIENTS                                        \
    "org.freedesktop.Avahi.TooManyClientsError"
#define AVAHI_DBUS_ERR_TOO_MANY_OBJECTS                                        \
...
#define AVAHI_DBUS_ERR_INVALID_OPERATION                                       \
...
#define AVAHI_DBUS_ERR_INVALID_INTERFACE                                       \
    "org.freedesktop.Avahi.InvalidInterfaceError"
#define AVAHI_DBUS_ERR_INVALID_PROTOCOL                                        \
...
#define AVAHI_DBUS_ERR_INVALID_CONFIG                                          \
    "org.freedesktop.Avahi.InvalidConfigurationError"
#define AVAHI_DBUS_ERR_VERSION_MISMATCH                                        \
    "org.freedesktop.Avahi.VersionMismatchError"
#define AVAHI_DBUS_ERR_INVALID_SERVICE_SUBTYPE                                 \
...
#define AVAHI_DBUS_ERR_INVALID_DNS_ERROR                                       \
...
#define AVAHI_DBUS_ERR_INVALID_DNS_CLASS                                       \
    "org.freedesktop.Avahi.InvalidDNSClassError"
#define AVAHI_DBUS_ERR_INVALID_DNS_TYPE                                        \
...
#define AVAHI_DBUS_ERR_INVALID_ARGUMENT                                        \
...
/** Convert an Avahi error number into a DBus error string.  Result should not
 * be freed */
