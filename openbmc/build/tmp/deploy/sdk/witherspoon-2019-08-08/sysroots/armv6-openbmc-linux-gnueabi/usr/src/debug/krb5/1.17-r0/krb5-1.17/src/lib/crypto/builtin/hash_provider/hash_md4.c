...
static krb5_error_code k5_md4_hash(const krb5_crypto_iov* data, size_t num_data,
                                   krb5_data* output)
{
    krb5_MD4_CTX ctx;
    unsigned int i;
...
const struct krb5_hash_provider krb5int_hash_md4 = {"MD4", RSA_MD4_CKSUM_LENGTH,
                                                    64, k5_md4_hash};
