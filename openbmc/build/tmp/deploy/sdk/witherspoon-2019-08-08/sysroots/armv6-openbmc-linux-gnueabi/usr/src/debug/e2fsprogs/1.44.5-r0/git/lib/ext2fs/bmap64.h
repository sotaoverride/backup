...
struct ext2_bitmap_ops
{
    ...
    errcode_t (*resize_bmap)(ext2fs_generic_bitmap bitmap, __u64 new_end,
                             __u64 new_real_end);
    ...
    void (*unmark_bmap_extent)(ext2fs_generic_bitmap bitmap, __u64 arg,
                               unsigned int num);
    int (*test_clear_bmap_extent)(ext2fs_generic_bitmap bitmap, __u64 arg,
                                  unsigned int num);
    errcode_t (*set_bmap_range)(ext2fs_generic_bitmap bitmap, __u64 start,
                                size_t num, void* in);
    errcode_t (*get_bmap_range)(ext2fs_generic_bitmap bitmap, __u64 start,
                                size_t num, void* out);
    ...
    errcode_t (*find_first_zero)(ext2fs_generic_bitmap bitmap, __u64 start,
                                 __u64 end, __u64* out);
    /* Find the first set bit between start and end, inclusive.
     * May be NULL, in which case a generic function is used. */
    errcode_t (*find_first_set)(ext2fs_generic_bitmap bitmap, __u64 start,
                                __u64 end, __u64* out);
};
