 ...
 * @get_action_parameter_type: the virtual function pointer for
 *g_action_group_get_action_parameter_type()
 * @get_action_state_type: the virtual function pointer for
 *g_action_group_get_action_state_type()
 * @get_action_state_hint: the virtual function pointer for
 *g_action_group_get_action_state_hint()
 * @get_action_enabled: the virtual function pointer for
 *g_action_group_get_action_enabled()
 * @get_action_state: the virtual function pointer for
 *g_action_group_get_action_state()
 * @change_action_state: the virtual function pointer for
 *g_action_group_change_action_state()
 * @query_action: the virtual function pointer for g_action_group_query_action()
 * @activate_action: the virtual function pointer for
 *g_action_group_activate_action()
 * @change_action_state: the virtual function pointer for
 *g_action_group_change_action_state()
 * @action_added: the class closure for the #GActionGroup::action-added signal
 * @action_removed: the class closure for the #GActionGroup::action-removed
 *signal
 * @action_enabled_changed: the class closure for the
 *#GActionGroup::action-enabled-changed signal
 * @action_state_changed: the class closure for the
 *#GActionGroup::action-enabled-changed signal
 *
...
static gboolean g_action_group_real_has_action(GActionGroup* action_group,
                                               const gchar* action_name)
{
    return g_action_group_query_action(action_group, action_name, NULL, NULL,
                                       NULL, NULL, NULL);
}
                                           ...
                                           const gchar* action_name)
{
    ...
    g_action_group_query_action(action_group, action_name, &enabled, NULL, NULL,
                                NULL, NULL);
                                                  ...
                                                  const gchar* action_name)
{
    ...
    g_action_group_query_action(action_group, action_name, NULL, &type, NULL,
                                NULL, NULL);
                                              ...
                                              const gchar* action_name)
{
    ...
    g_action_group_query_action(action_group, action_name, NULL, NULL, &type,
                                NULL, NULL);
                                              ...
                                              const gchar* action_name)
{
    ...
    g_action_group_query_action(action_group, action_name, NULL, NULL, NULL,
                                &hint, NULL);
...
static gboolean g_action_group_real_query_action(
    ...
    GVariant** state_hint, GVariant** state)
{
     ...
     */
    if
        G_UNLIKELY(iface->has_action == g_action_group_real_has_action ||
        ...
        {
            g_critical("Class '%s' implements GActionGroup interface without "
                       "overriding "
                       "query_action() method -- bailing out to avoid infinite "
                       "recursion.",
    ...
    if (parameter_type != NULL)
        *parameter_type =
            (*iface->get_action_parameter_type)(action_group, action_name);

    if (state_type != NULL)
        *state_type =
            (*iface->get_action_state_type)(action_group, action_name);

    if (state_hint != NULL)
        *state_hint =
            (*iface->get_action_state_hint)(action_group, action_name);
...
static void g_action_group_default_init(GActionGroupInterface* iface)
{
     ...
     * Since: 2.28
     **/
    g_action_group_signals[SIGNAL_ACTION_ADDED] = g_signal_new(
        I_("action-added"), G_TYPE_ACTION_GROUP,
        G_SIGNAL_RUN_LAST | G_SIGNAL_DETAILED,
        G_STRUCT_OFFSET(GActionGroupInterface, action_added), NULL, NULL,
     ...
     * Since: 2.28
     **/
    g_action_group_signals[SIGNAL_ACTION_REMOVED] = g_signal_new(
        I_("action-removed"), G_TYPE_ACTION_GROUP,
        G_SIGNAL_RUN_LAST | G_SIGNAL_DETAILED,
        G_STRUCT_OFFSET(GActionGroupInterface, action_removed), NULL, NULL,
        g_cclosure_marshal_VOID__STRING, G_TYPE_NONE, 1, G_TYPE_STRING);
     ...
     * Since: 2.28
     **/
    g_action_group_signals[SIGNAL_ACTION_ENABLED_CHANGED] = g_signal_new(
        I_("action-enabled-changed"), G_TYPE_ACTION_GROUP,
        G_SIGNAL_RUN_LAST | G_SIGNAL_DETAILED,
        G_STRUCT_OFFSET(GActionGroupInterface, action_enabled_changed), NULL,
     ...
     * Since: 2.28
     **/
    g_action_group_signals[SIGNAL_ACTION_STATE_CHANGED] = g_signal_new(
        I_("action-state-changed"), G_TYPE_ACTION_GROUP,
        G_SIGNAL_RUN_LAST | G_SIGNAL_DETAILED | G_SIGNAL_MUST_COLLECT,
        G_STRUCT_OFFSET(GActionGroupInterface, action_state_changed), NULL,
        NULL, NULL, G_TYPE_NONE, 2, G_TYPE_STRING, G_TYPE_VARIANT);
}
                                 ...
                                 const gchar* action_name)
{
    ...
    g_signal_emit(action_group, g_action_group_signals[SIGNAL_ACTION_ADDED],
                                   ...
                                   const gchar* action_name)
{
    ...
    g_signal_emit(action_group, g_action_group_signals[SIGNAL_ACTION_REMOVED],
                  g_quark_try_string(action_name), action_name);
}
                                           ...
                                           gboolean enabled)
{
    ...
    g_signal_emit(action_group,
                  ...
                  g_quark_try_string(action_name), action_name, enabled);
}
                                         ...
                                         GVariant* state)
{
    ...
    g_signal_emit(action_group,
                  ...
                  g_quark_try_string(action_name), action_name, state);
}
 ...
 * @parameter_type: (out) (optional): the parameter type, or %NULL if none
 *needed
...
{
    return G_ACTION_GROUP_GET_IFACE(action_group)
        ->query_action(action_group, action_name, enabled, parameter_type,
