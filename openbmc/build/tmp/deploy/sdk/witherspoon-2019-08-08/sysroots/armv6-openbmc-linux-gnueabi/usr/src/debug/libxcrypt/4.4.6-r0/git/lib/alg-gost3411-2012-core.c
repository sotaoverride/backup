...
static inline void add512(const uint512_u* x, const uint512_u* y, uint512_u* r)
{
...
static void g(uint512_u* h, const uint512_u* N, const unsigned char* m)
{
...
static inline void stage3(GOST34112012Context* CTX)
{
    ...
    add512(&(CTX->Sigma), (const uint512_u*)&CTX->buffer[0], &(CTX->Sigma));
