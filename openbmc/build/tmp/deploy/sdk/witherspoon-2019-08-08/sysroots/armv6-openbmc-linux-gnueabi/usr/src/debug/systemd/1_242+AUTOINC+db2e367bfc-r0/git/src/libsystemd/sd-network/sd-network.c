...
_public_ int sd_network_link_get_required_operstate_for_online(int ifindex,
                                                               char** state)
{
    _cleanup_free_ char* s = NULL;
    int r;
...
_public_ int sd_network_link_get_dnssec_negative_trust_anchors(int ifindex,
                                                               char*** nta)
{
...
static int monitor_add_inotify_watch(int fd)
{
    ...
    k = inotify_add_watch(fd, "/run/systemd/netif/links/",
...
_public_ int sd_network_monitor_new(sd_network_monitor** m,
                                    const char* category)
{
...
_public_ int sd_network_monitor_get_timeout(sd_network_monitor* m,
