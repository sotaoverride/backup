...
#endif
const X509V3_EXT_METHOD v3_sxnet = {NID_sxnet,
        ...
        IMPLEMENT_ASN1_FUNCTIONS(SXNETID)
            ...
            ASN1_SEQUENCE(SXNET) =
                {ASN1_SIMPLE(SXNET, version, ASN1_INTEGER),
                 ASN1_SEQUENCE_OF(SXNET, ids, SXNETID)} ASN1_SEQUENCE_END(SXNET)

                    IMPLEMENT_ASN1_FUNCTIONS(SXNET)

                        static int sxnet_i2r(X509V3_EXT_METHOD * method,
                                             SXNET* sx, BIO* out, int indent)
{
    long v;
    char* tmp;
    SXNETID* id;
                       ...
                       int userlen)
{
    ...
    if ((izone = ASN1_INTEGER_new()) == NULL || !ASN1_INTEGER_set(izone, lzone))
    {
