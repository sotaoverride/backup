...
ASN1_SEQUENCE(SSL_SESSION_ASN1) =
    {ASN1_EMBED(SSL_SESSION_ASN1, version, UINT32),
...
#endif
     ASN1_EXP_OPT_EMBED(SSL_SESSION_ASN1, tlsext_tick_lifetime_hint, ZUINT64,
                        9),
     ...
     ASN1_EXP_OPT_EMBED(SSL_SESSION_ASN1, tlsext_max_fragment_len_mode, ZUINT32,
                        17),
     ASN1_EXP_OPT(SSL_SESSION_ASN1, ticket_appdata, ASN1_OCTET_STRING,
                  18)} static_ASN1_SEQUENCE_END(SSL_SESSION_ASN1)
    ...
    static void ssl_session_oinit(ASN1_OCTET_STRING * *dest,
                                  ASN1_OCTET_STRING* os, unsigned char* data,
                                  size_t len)
{
    os->data = data;
    os->length = (int)len;
