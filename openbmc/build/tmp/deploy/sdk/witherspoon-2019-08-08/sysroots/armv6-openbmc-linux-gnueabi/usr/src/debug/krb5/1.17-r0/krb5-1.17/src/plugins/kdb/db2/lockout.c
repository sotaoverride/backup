...
static krb5_error_code lookup_lockout_policy(krb5_context context,
                                             krb5_db_entry* entry,
...
static krb5_boolean locked_check_p(krb5_context context, krb5_timestamp stamp,
                                   krb5_kvno max_fail,
                                       ...
                                       krb5_error_code status)
{
    ...
    {
        if (krb5_dbe_lookup_last_admin_unlock(context, entry, &unlock_time) ==
                0 &&
            !ts_after(entry->last_failed, unlock_time))
        {
