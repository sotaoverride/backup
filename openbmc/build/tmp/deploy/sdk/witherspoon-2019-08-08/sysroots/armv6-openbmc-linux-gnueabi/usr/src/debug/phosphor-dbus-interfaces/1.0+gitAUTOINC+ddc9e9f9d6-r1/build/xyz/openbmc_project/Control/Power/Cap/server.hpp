...
class Cap
{
  public:
     ...
     */
    Cap(bus::bus& bus, const char* path);

    using PropertiesVariant = std::variant<bool, uint32_t>;
    ...
    virtual uint32_t powerCap(uint32_t value, bool skipSignal);
    ...
    virtual bool powerCapEnable(bool value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_PowerCap(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'PowerCap' */
    static int _callback_set_PowerCap(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);

    /** @brief sd-bus callback for get-property 'PowerCapEnable' */
    static int _callback_get_PowerCapEnable(sd_bus*, const char*, const char*,
                                            const char*, sd_bus_message*, void*,
                                            sd_bus_error*);
    /** @brief sd-bus callback for set-property 'PowerCapEnable' */
    static int _callback_set_PowerCapEnable(sd_bus*, const char*, const char*,
                                            const char*, sd_bus_message*, void*,
                                            sd_bus_error*);

    static constexpr auto _interface = "xyz.openbmc_project.Control.Power.Cap";
    static const vtable::vtable_t _vtable[];
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Control_Power_Cap_interface;
