...
///////////////////////////////////////////////////////////////////////////////
inline language_support enable_variadics(language_support language,
                                         bool enable = true)
{
    return language;
}
...
//
///////////////////////////////////////////////////////////////////////////////
inline language_support set_support_options(language_support language,
                                            language_support option)
{
    return static_cast<language_support>((language & ~support_option_mask) |
                                         (option & support_option_mask));
}
...
#define BOOST_WAVE_ENABLE_OPTION(option)                                       \
    inline language_support enable_##option(language_support language,         \
                                            bool enable = true)                \
    {                                                                          \
        if (enable)                                                            \
            return static_cast<language_support>(language |                    \
                                                 support_option_##option);     \
        return static_cast<language_support>(language &                        \
                                             ~support_option_##option);        \
    }                                                                          \
    /**/
...
BOOST_WAVE_OPTION(
    include_guard_detection) // support_option_include_guard_detection
#endif
#if BOOST_WAVE_SUPPORT_VARIADICS_PLACEMARKERS != 0
