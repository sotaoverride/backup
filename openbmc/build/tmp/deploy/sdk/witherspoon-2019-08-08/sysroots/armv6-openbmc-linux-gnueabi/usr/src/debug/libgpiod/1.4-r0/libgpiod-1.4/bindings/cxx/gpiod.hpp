...
class chip
{
  public:
     ...
     */
    GPIOD_API line_bulk
        get_lines(const ::std::vector<unsigned int>& offsets) const;
     ...
     */
    GPIOD_API line_bulk
        find_lines(const ::std::vector<::std::string>& names) const;
...
class line_bulk
{
  public:
     ...
     */
    GPIOD_API void
        request(const line_request& config,
     ...
     */
    GPIOD_API line_bulk
        event_wait(const ::std::chrono::nanoseconds& timeout) const;
