 ...
 */
static krb5_error_code krb5_keyblock_size(krb5_context, krb5_pointer, size_t*);
static krb5_error_code krb5_keyblock_externalize(krb5_context, krb5_pointer,
                                                 krb5_octet**, size_t*);
static krb5_error_code krb5_keyblock_internalize(krb5_context, krb5_pointer*,
                                                 krb5_octet**, size_t*);
 ...
 *                                the krb5_keyblock.
 */
static krb5_error_code krb5_keyblock_size(krb5_context kcontext,
                                          krb5_pointer arg, size_t* sizep)
{
    ...
    {
        *sizep += (sizeof(krb5_int32) + sizeof(krb5_int32) +
                   sizeof(krb5_int32) + sizeof(krb5_int32) +
                   sizeof(krb5_int32) + (size_t)keyblock->length);
        kret = 0;
    }
    return (kret);
}
 ...
 */
static krb5_error_code krb5_keyblock_externalize(krb5_context kcontext,
                                                 krb5_pointer arg,
                                                 krb5_octet** buffer,
                                                 size_t* lenremain)
{
    ...
    if ((keyblock = (krb5_keyblock*)arg))
    {
            ...
            (required <= remain))
        {
            ...
            /* Our enctype */
            (void)krb5_ser_pack_int32((krb5_int32)keyblock->enctype, &bp,
                                      &remain);

            /* Our length */
            (void)krb5_ser_pack_int32((krb5_int32)keyblock->length, &bp,
                                      &remain);

            /* Our contents */
            (void)krb5_ser_pack_bytes(keyblock->contents,
                                      (size_t)keyblock->length, &bp, &remain);
 ...
 */
static krb5_error_code krb5_keyblock_internalize(krb5_context kcontext,
                                                 krb5_pointer* argp,
                                                 krb5_octet** buffer,
                                                 size_t* lenremain)
{
    ...
    if (ibuf == KV5M_KEYBLOCK)
    {
            ...
            (keyblock = (krb5_keyblock*)calloc(1, sizeof(krb5_keyblock))))
        {
            ...
            if ((keyblock->contents = (krb5_octet*)malloc((size_t)(ibuf))) &&
                !(kret = krb5_ser_unpack_bytes(keyblock->contents, (size_t)ibuf,
                                               &bp, &remain)))
            {
 ...
 */
krb5_error_code krb5_ser_keyblock_init(krb5_context kcontext)
{
