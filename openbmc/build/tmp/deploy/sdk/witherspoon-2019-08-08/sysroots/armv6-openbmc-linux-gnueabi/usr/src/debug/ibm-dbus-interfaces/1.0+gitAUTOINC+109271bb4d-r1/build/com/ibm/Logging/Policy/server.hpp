...
class Policy
{
  public:
    ...
    virtual std::string eventID(std::string value, bool skipSignal);
    ...
    virtual std::string description(std::string value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_EventID(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);
    /** @brief sd-bus callback for set-property 'EventID' */
    static int _callback_set_EventID(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Description' */
    static int _callback_get_Description(sd_bus*, const char*, const char*,
                                         const char*, sd_bus_message*, void*,
                                         sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Description' */
    static int _callback_set_Description(sd_bus*, const char*, const char*,
                                         const char*, sd_bus_message*, void*,
                                         sd_bus_error*);

    static constexpr auto _interface = "com.ibm.Logging.Policy";
    static const vtable::vtable_t _vtable[];
    sdbusplus::server::interface::interface _com_ibm_Logging_Policy_interface;
