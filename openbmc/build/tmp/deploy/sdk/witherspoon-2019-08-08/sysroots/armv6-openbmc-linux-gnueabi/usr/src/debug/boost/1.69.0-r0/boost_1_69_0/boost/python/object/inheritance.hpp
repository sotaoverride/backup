...
struct dynamic_id_generator
    : mpl::if_<boost::python::detail::is_polymorphic<T>,
...
struct cast_generator
    : mpl::if_<boost::python::detail::is_base_and_derived<Target, Source>,
    ...
    Source* = 0, Target* = 0)
{
    ...
    add_cast(python::type_id<Source>(), python::type_id<Target>(),
             &generator::execute, is_downcast);
}
