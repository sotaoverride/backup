...
static inline char** gsserrmap_find(struct gsserrmap__head* head, OM_uint32 key)
{
...
static inline int gsserrmap__copy_key(OM_uint32* out, OM_uint32 in)
{
...
/* Returns 0 or error code.  */
static inline int gsserrmap_replace_or_insert(struct gsserrmap__head* head,
