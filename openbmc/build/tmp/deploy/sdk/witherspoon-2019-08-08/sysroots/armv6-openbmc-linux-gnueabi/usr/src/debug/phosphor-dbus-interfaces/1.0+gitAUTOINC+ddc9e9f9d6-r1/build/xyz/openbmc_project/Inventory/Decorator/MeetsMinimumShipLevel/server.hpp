...
class MeetsMinimumShipLevel
{
  public:
    ...
    virtual bool meetsMinimumShipLevel(bool value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_MeetsMinimumShipLevel(sd_bus*, const char*,
                                                   const char*, const char*,
                                                   sd_bus_message*, void*,
                                                   sd_bus_error*);
    /** @brief sd-bus callback for set-property 'MeetsMinimumShipLevel' */
    static int _callback_set_MeetsMinimumShipLevel(sd_bus*, const char*,
                                                   const char*, const char*,
                                                   sd_bus_message*, void*,
                                                   sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Inventory_Decorator_MeetsMinimumShipLevel_interface;
