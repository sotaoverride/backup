 ...
 */
static krb5_error_code decrypt_encpart(krb5_context context,
                                       krb5_enc_data* ctext,
                                       krb5_auth_context authcon,
                                       krb5_cred_enc_part** encpart_out)
{
    krb5_error_code ret;
...
static krb5_error_code make_cred_list(krb5_context context, krb5_cred* krbcred,
