...
{
    /* ftruncate() and friends take an unsigned file size, but actually cannot
     * deal with file sizes larger than
     * 2^63 since the kernel internally handles it as signed value. This call
     * allows checking for this early. */
