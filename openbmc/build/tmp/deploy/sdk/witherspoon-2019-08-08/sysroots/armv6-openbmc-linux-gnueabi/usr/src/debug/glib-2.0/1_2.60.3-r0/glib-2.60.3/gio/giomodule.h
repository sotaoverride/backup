...
#define G_IO_MODULE(o)                                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_IO_TYPE_MODULE, GIOModule))
#define G_IO_MODULE_CLASS(k)                                                   \
    (G_TYPE_CHECK_CLASS_CAST((k), G_IO_TYPE_MODULE, GIOModuleClass))
...
#define G_IO_MODULE_GET_CLASS(o)                                               \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_IO_TYPE_MODULE, GIOModuleClass))
