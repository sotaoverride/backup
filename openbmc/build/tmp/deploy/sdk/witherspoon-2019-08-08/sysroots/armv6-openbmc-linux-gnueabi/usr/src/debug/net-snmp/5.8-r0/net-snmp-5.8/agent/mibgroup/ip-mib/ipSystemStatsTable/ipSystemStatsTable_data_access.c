 ...
 */
static void _check_for_updates(ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
                               netsnmp_container* stats)
{
    ...
    {
        DEBUGMSGTL(("ipSystemStatsTable:access", "updating missing entry\n"));
    ...
    {
        DEBUGMSGTL(("ipSystemStatsTable:access", "updating existing entry\n"));
 ...
 * add new entry
 */
static void _add_new(netsnmp_systemstats_entry* systemstats_entry,
                     netsnmp_container* container)
{
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS == ipSystemStatsTable_indexes_set(
                            rowreq_ctx, systemstats_entry->index[0])))
    {
        rowreq_ctx->ipSystemStatsRefreshRate =
            ipss_cache_refresh * 1000; /* milli-seconds */
