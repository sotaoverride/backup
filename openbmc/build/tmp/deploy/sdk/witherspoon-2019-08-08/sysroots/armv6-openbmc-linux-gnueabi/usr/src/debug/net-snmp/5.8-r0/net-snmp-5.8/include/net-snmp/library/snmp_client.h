...
netsnmp_pdu* snmp_split_pdu(netsnmp_pdu*, int skipCount, int copyCount);

unsigned long snmp_varbind_len(netsnmp_pdu* pdu);
NETSNMP_IMPORT
int snmp_clone_var(netsnmp_variable_list*, netsnmp_variable_list*);
NETSNMP_IMPORT
int snmp_synch_response_cb(netsnmp_session*, netsnmp_pdu*, netsnmp_pdu**,
                           snmp_callback);
NETSNMP_IMPORT
...
typedef int(netsnmp_state_machine_func)(
    struct netsnmp_state_machine_input_s* input,
...
NETSNMP_IMPORT int netsnmp_row_create(netsnmp_session* sess,
