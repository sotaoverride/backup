 ...
 *
 * This file implements MurmurHash3 hash function implementation. See
...
//! 32-bit MurmurHash3 algorithm implementation
//! (https://en.wikipedia.org/wiki/MurmurHash)
class murmur3_32
{
  private:
  ...
  public:
    explicit BOOST_CONSTEXPR murmur3_32(uint32_t seed) BOOST_NOEXCEPT
        : m_state(seed),
          m_len(0u)
    {
    }
