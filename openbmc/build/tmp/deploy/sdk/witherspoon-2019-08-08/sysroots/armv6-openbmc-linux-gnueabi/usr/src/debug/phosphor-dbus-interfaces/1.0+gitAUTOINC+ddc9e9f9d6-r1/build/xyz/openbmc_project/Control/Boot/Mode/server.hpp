...
class Mode
{
  public:
    ...
    virtual Modes bootMode(Modes value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_BootMode(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'BootMode' */
    static int _callback_set_BootMode(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Control_Boot_Mode_interface;
