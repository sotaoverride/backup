...
extern int rtnl_class_alloc_cache(struct nl_sock*, int, struct nl_cache**);
...
extern int rtnl_class_build_delete_request(struct rtnl_class*, struct nl_msg**);
...
extern void rtnl_class_foreach_cls(struct rtnl_class*, struct nl_cache*,
                                   void (*cb)(struct nl_object*, void*), void*)
