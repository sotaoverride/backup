...
extern int nfnlmsg_log_parse(struct nlmsghdr*, struct nfnl_log**);
...
extern void nfnl_log_set_copy_mode(struct nfnl_log*, enum nfnl_log_copy_mode);
...
extern char* nfnl_log_copy_mode2str(enum nfnl_log_copy_mode, char*, size_t);
