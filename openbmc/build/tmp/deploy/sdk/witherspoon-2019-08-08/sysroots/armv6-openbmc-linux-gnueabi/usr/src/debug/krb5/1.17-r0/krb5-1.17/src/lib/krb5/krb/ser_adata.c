 ...
 */
static krb5_error_code krb5_authdata_size(krb5_context, krb5_pointer, size_t*);
static krb5_error_code krb5_authdata_externalize(krb5_context, krb5_pointer,
                                                 krb5_octet**, size_t*);
static krb5_error_code krb5_authdata_internalize(krb5_context, krb5_pointer*,
                                                 krb5_octet**, size_t*);
 ...
 *                                the krb5_authdata.
 */
static krb5_error_code krb5_authdata_size(krb5_context kcontext,
                                          krb5_pointer arg, size_t* sizep)
{
    ...
    {
        *sizep +=
            (sizeof(krb5_int32) + sizeof(krb5_int32) + sizeof(krb5_int32) +
             sizeof(krb5_int32) + (size_t)authdata->length);
        kret = 0;
    }
    return (kret);
}
 ...
 */
static krb5_error_code krb5_authdata_externalize(krb5_context kcontext,
                                                 krb5_pointer arg,
                                                 krb5_octet** buffer,
                                                 size_t* lenremain)
{
    ...
    if ((authdata = (krb5_authdata*)arg))
    {
            ...
            (required <= remain))
        {
            ...
            /* Our ad_type */
            (void)krb5_ser_pack_int32((krb5_int32)authdata->ad_type, &bp,
                                      &remain);

            /* Our length */
            (void)krb5_ser_pack_int32((krb5_int32)authdata->length, &bp,
                                      &remain);

            /* Our contents */
            (void)krb5_ser_pack_bytes(authdata->contents,
                                      (size_t)authdata->length, &bp, &remain);
 ...
 */
static krb5_error_code krb5_authdata_internalize(krb5_context kcontext,
                                                 krb5_pointer* argp,
                                                 krb5_octet** buffer,
                                                 size_t* lenremain)
{
    ...
    if (ibuf == KV5M_AUTHDATA)
    {
            ...
            (authdata = (krb5_authdata*)calloc(1, sizeof(krb5_authdata))))
        {
            ...
            /* Get the string */
            if ((authdata->contents = (krb5_octet*)malloc((size_t)(ibuf))) &&
                !(kret = krb5_ser_unpack_bytes(authdata->contents, (size_t)ibuf,
                                               &bp, &remain)))
            {
 ...
 */
krb5_error_code krb5_ser_authdata_init(krb5_context kcontext)
{
