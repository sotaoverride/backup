...
/* v11, 2017-10-05 */
int (*formatUnixTimeFromTime_t)(time_t time, const char* format, char* pBuf,
                                uint pBufMax);
ENDinterface(datetime)
#define datetimeCURR_IF_VERSION                                                \
    11 /* increment whenever you change the interface structure! */
/* interface changes:
 * 1 - initial version
 * 2 - not compatible to 1 - bugfix required ParseTIMESTAMP3164 to accept char
 * ** as last parameter. Did not try to remain compatible as this is not
 * something any third-party module should call. -- rgerhards, 2008.-09-12 3 -
 * taken by v5 branch! 4 - formatTimestamp3164 takes a third int parameter 5 -
 * merge of versions 3 + 4 (2010-03-09) 6 - see above 8 - ParseTIMESTAMP3164 has
 * addtl parameter to permit TZ string parsing 9 - ParseTIMESTAMP3164 has addtl
 * parameter to permit year parsing 10 - functions having addtl paramater inUTC
 * to emit time in UTC: timeval2syslogTime, getCurrtime 11 - Add
 * formatUnixTimeFromTime_t
 */
