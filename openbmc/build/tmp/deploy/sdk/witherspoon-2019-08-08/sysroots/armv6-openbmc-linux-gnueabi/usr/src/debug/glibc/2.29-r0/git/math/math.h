...
#undef __MATH_DECLARING_FLOATN
    ...
    defined __LDBL_COMPAT || defined _LIBC_TEST
#ifdef __LDBL_COMPAT
...
extern float __REDIRECT_NTH(nexttowardf, (float __x, long double __y),
                            __nldbl_nexttowardf) __attribute__((__const__));
extern double __REDIRECT_NTH(nexttoward, (double __x, long double __y),
                             nextafter) __attribute__((__const__));
extern long double __REDIRECT_NTH(nexttowardl,
                                  (long double __x, long double __y), nextafter)
    __attribute__((__const__));
#endif
#endif
...
#if (__HAVE_DISTINCT_FLOAT16 || __HAVE_DISTINCT_FLOAT32 ||                     \
     __HAVE_DISTINCT_FLOAT64 || __HAVE_DISTINCT_FLOAT32X ||                    \
...
#endif
#define __MATH_TG(TG_ARG, FUNC, ARGS)                                          \
    _Generic((TG_ARG), float                                                   \
             : FUNC##f ARGS, __MATH_TG_F32(FUNC, ARGS) default                 \
             : FUNC ARGS, long double                                          \
             : FUNC##l ARGS, __MATH_TG_F64X(FUNC, ARGS) _Float128              \
             : FUNC##f128 ARGS)
#else
...
#define __MATH_TG(TG_ARG, FUNC, ARGS)                                          \
    __builtin_choose_expr(                                                     \
        __builtin_types_compatible_p(__typeof(TG_ARG), float), FUNC##f ARGS,   \
        __builtin_choose_expr(                                                 \
            __builtin_types_compatible_p(__typeof(TG_ARG), double), FUNC ARGS, \
            __builtin_choose_expr(                                             \
                __builtin_types_compatible_p(__typeof(TG_ARG), long double),   \
                FUNC##l ARGS, FUNC##f128 ARGS)))
#endif
#else
#define __MATH_TG(TG_ARG, FUNC, ARGS)                                          \
...
#define M_2_SQRTPIf16                                                          \
    __f16(1.128379167095512573896158903121545172) /* 2/sqrt(pi) */
#define M_SQRT2f16 __f16(1.414213562373095048801688724209698079) /* sqrt(2) */
#define M_SQRT1_2f16                                                           \
    __f16(0.707106781186547524400844362104849039) /* 1/sqrt(2) */
#endif
...
#define M_2_SQRTPIf32                                                          \
    __f32(1.128379167095512573896158903121545172) /* 2/sqrt(pi) */
#define M_SQRT2f32 __f32(1.414213562373095048801688724209698079) /* sqrt(2) */
#define M_SQRT1_2f32                                                           \
    __f32(0.707106781186547524400844362104849039) /* 1/sqrt(2) */
#endif
...
#define M_2_SQRTPIf64                                                          \
    __f64(1.128379167095512573896158903121545172) /* 2/sqrt(pi) */
#define M_SQRT2f64 __f64(1.414213562373095048801688724209698079) /* sqrt(2) */
#define M_SQRT1_2f64                                                           \
    __f64(0.707106781186547524400844362104849039) /* 1/sqrt(2) */
#endif
...
#define M_LOG2Ef128 __f128(1.442695040888963407359924681001892137) /* log_2 e  \
                                                                    */
#define M_LOG10Ef128                                                           \
    __f128(0.434294481903251827651128918916605082)                /* log_10 e */
...
#define M_2_SQRTPIf128                                                         \
    __f128(1.128379167095512573896158903121545172) /* 2/sqrt(pi) */
#define M_SQRT2f128 __f128(1.414213562373095048801688724209698079) /* sqrt(2)  \
                                                                    */
#define M_SQRT1_2f128                                                          \
    __f128(0.707106781186547524400844362104849039) /* 1/sqrt(2) */
#endif
...
#define M_LOG2Ef32x __f32x(1.442695040888963407359924681001892137) /* log_2 e  \
                                                                    */
#define M_LOG10Ef32x                                                           \
    __f32x(0.434294481903251827651128918916605082)                /* log_10 e */
...
#define M_2_SQRTPIf32x                                                         \
    __f32x(1.128379167095512573896158903121545172) /* 2/sqrt(pi) */
#define M_SQRT2f32x __f32x(1.414213562373095048801688724209698079) /* sqrt(2)  \
                                                                    */
#define M_SQRT1_2f32x                                                          \
    __f32x(0.707106781186547524400844362104849039) /* 1/sqrt(2) */
#endif
...
#define M_LOG2Ef64x __f64x(1.442695040888963407359924681001892137) /* log_2 e  \
                                                                    */
#define M_LOG10Ef64x                                                           \
    __f64x(0.434294481903251827651128918916605082)                /* log_10 e */
...
#define M_2_SQRTPIf64x                                                         \
    __f64x(1.128379167095512573896158903121545172) /* 2/sqrt(pi) */
#define M_SQRT2f64x __f64x(1.414213562373095048801688724209698079) /* sqrt(2)  \
                                                                    */
#define M_SQRT1_2f64x                                                          \
    __f64x(0.707106781186547524400844362104849039) /* 1/sqrt(2) */
#endif
