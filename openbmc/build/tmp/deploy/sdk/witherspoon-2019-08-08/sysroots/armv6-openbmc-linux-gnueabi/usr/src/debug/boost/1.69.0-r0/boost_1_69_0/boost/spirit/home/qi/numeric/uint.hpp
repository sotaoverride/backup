...
template <typename T, unsigned Radix, unsigned MinDigits, int MaxDigits,
          typename A0>
struct use_terminal<
    qi::domain, terminal_ex<tag::uint_parser<T, Radix, MinDigits, MaxDigits>,
...
struct literal_uint_parser
    : primitive_parser<
          literal_uint_parser<T, Radix, MinDigits, MaxDigits, no_attribute>>
{
    // check template parameter 'Radix' for validity
    BOOST_SPIRIT_ASSERT_MSG(Radix == 2 || Radix == 8 || Radix == 10 ||
                                Radix == 16,
                            not_supported_radix, ());
...
template <typename T, unsigned Radix, unsigned MinDigits, int MaxDigits,
          typename Modifiers>
struct make_primitive<tag::uint_parser<T, Radix, MinDigits, MaxDigits>,
                      Modifiers> : make_uint<T, Radix, MinDigits, MaxDigits>
{
};
...
struct make_primitive<terminal_ex<tag::ulong_long, fusion::vector1<A0>>,
                      Modifiers> : make_direct_uint<boost::ulong_long_type>
{
};
#endif
} // namespace qi
