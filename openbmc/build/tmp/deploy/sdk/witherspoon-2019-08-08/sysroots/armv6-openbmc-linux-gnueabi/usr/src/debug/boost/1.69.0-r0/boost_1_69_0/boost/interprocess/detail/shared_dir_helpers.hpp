...
#if defined(BOOST_INTERPROCESS_SHARED_DIR_FUNC) &&                             \
    defined(BOOST_INTERPROCESS_SHARED_DIR_PATH)
#error                                                                         \
    "Error: Both BOOST_INTERPROCESS_SHARED_DIR_FUNC and BOOST_INTERPROCESS_SHARED_DIR_PATH defined!"
#endif
...
{
#if defined(BOOST_INTERPROCESS_SHARED_DIR_PATH) ||                             \
    defined(BOOST_INTERPROCESS_SHARED_DIR_FUNC)
...
inline void
    create_shared_dir_cleaning_old_and_get_filepath(const char* filename,
