...
static gcry_err_code_t camellia_setkey(void* c, const byte* key,
                                       unsigned keylen)
{
...
#endif
    {
        ...
        _gcry_burn_stack(
            (19 + 34 + 34) * sizeof(u32) +
            2 * sizeof(void*)                            /* camellia_setup256 */
...
static unsigned int camellia_encrypt(void* c, byte* outbuf, const byte* inbuf)
{
    CAMELLIA_context* ctx = c;
...
static unsigned int camellia_decrypt(void* c, byte* outbuf, const byte* inbuf)
{
    CAMELLIA_context* ctx = c;
...
#define CAMELLIA_encrypt_stack_burn_size                                       \
    (sizeof(int) + 2 * sizeof(unsigned char*) +                                \
     sizeof(void* /*KEY_TABLE_TYPE*/) + 4 * sizeof(u32) + 4 * sizeof(u32) +    \
                            ...
                            const void* inbuf_arg, size_t nblocks)
{
    ...
    if (ctx->use_aesni_avx)
    {
        ...
        {
            int avx_burn_stack_depth =
                16 * CAMELLIA_BLOCK_SIZE + 2 * sizeof(void*) + ASM_EXTRA_STACK;
                                ...
                                int encrypt)
{
    ...
    if (ctx->use_aesni_avx2)
    {
                ...
                *l = (uintptr_t)(void*)ocb_get_l(c, blkn - blkn % 32);
                ...
                if (encrypt)
                    _gcry_camellia_aesni_avx2_ocb_enc(
                        ctx, outbuf, inbuf, c->u_iv.iv, c->u_ctr.ctr, Ls);
                else
        ...
        if (did_use_aesni_avx2)
        {
            int avx2_burn_stack_depth =
                32 * CAMELLIA_BLOCK_SIZE + 2 * sizeof(void*) + ASM_EXTRA_STACK;
...
static const char* selftest_ctr_128(void)
{
    ...
    return _gcry_selftest_helper_ctr("CAMELLIA", &camellia_setkey,
                                     &camellia_encrypt, &_gcry_camellia_ctr_enc,
...
static const char* selftest_cbc_128(void)
{
    ...
    return _gcry_selftest_helper_cbc("CAMELLIA", &camellia_setkey,
                                     &camellia_encrypt, &_gcry_camellia_cbc_dec,
                                     nblocks, blocksize, context_size);
}
...
static const char* selftest_cfb_128(void)
{
    ...
    return _gcry_selftest_helper_cfb("CAMELLIA", &camellia_setkey,
                                     &camellia_encrypt, &_gcry_camellia_cfb_dec,
                                     nblocks, blocksize, context_size);
}
...
static const char* selftest(void)
{
    ...
    static const byte plaintext[] = {0x01, 0x23, 0x45, 0x67, 0x89, 0xab,
                                     0xcd, 0xef, 0xfe, 0xdc, 0xba, 0x98,
                                     0x76, 0x54, 0x32, 0x10};
    static const byte key_128[] = {0x01, 0x23, 0x45, 0x67, 0x89, 0xab,
                                   0xcd, 0xef, 0xfe, 0xdc, 0xba, 0x98,
                                   0x76, 0x54, 0x32, 0x10};
    static const byte ciphertext_128[] = {0x67, 0x67, 0x31, 0x38, 0x54, 0x96,
                                          0x69, 0x73, 0x08, 0x57, 0x06, 0x56,
                                          0x48, 0xea, 0xbe, 0x43};
    static const byte key_192[] = {
        0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0xfe, 0xdc, 0xba, 0x98,
        0x76, 0x54, 0x32, 0x10, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77};
    static const byte ciphertext_192[] = {0xb4, 0x99, 0x34, 0x01, 0xb3, 0xe9,
                                          0x96, 0xf8, 0x4e, 0xe5, 0xce, 0xe7,
                                          0xd7, 0x9b, 0x09, 0xb9};
    static const byte key_256[] = {
        0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0xfe, 0xdc, 0xba,
        0x98, 0x76, 0x54, 0x32, 0x10, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55,
        0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff};
    static const byte ciphertext_256[] = {0x9a, 0xcc, 0x23, 0x7d, 0xff, 0x16,
                                          0xd7, 0x6c, 0x20, 0xef, 0x7c, 0x91,
                                          0x9e, 0x3a, 0x75, 0x09};
...
gcry_cipher_spec_t _gcry_cipher_spec_camellia128 = {GCRY_CIPHER_CAMELLIA128,
                                                    {0, 0},
                                                    "CAMELLIA128",
                                                    NULL,
                                                    camellia128_oids,
...
gcry_cipher_spec_t _gcry_cipher_spec_camellia192 = {GCRY_CIPHER_CAMELLIA192,
                                                    {0, 0},
                                                    "CAMELLIA192",
                                                    NULL,
                                                    camellia192_oids,
...
gcry_cipher_spec_t _gcry_cipher_spec_camellia256 = {GCRY_CIPHER_CAMELLIA256,
                                                    {0, 0},
                                                    "CAMELLIA256",
                                                    NULL,
                                                    camellia256_oids,
