...
class BOOST_SYMBOL_VISIBLE date
    : private boost::less_than_comparable<T, boost::equality_comparable<T>>
{
  public:
    ...
    date(const ymd_type& ymd) : days_(calendar::day_number(ymd))
    {
    }
    ...
    duration_type operator-(const date_type& d) const
    {
        ...
        {
            // The duration underlying type may be wider than the date
            // underlying type. Thus we calculate the difference in terms of two
            // durations from some common fixed base date.
            typedef typename duration_type::duration_rep_type duration_rep_type;
            return duration_type(static_cast<duration_rep_type>(days_) -
                                 static_cast<duration_rep_type>(d.days_));
        }
        else
        {
    ...
    date_type operator-(const duration_type& dd) const
    {
        ...
        return date_type(date_rep_type(days_) -
                         static_cast<date_int_type>(dd.days()));
    }
