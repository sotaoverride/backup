                                                 ...
                                                 char const* to_type_name)
{
    ...
    text << "incompatible contracted virtual function result type "
         << "conversion from '" << from_type_name << "' to '" << to_type_name
         << "'";
    what_ = text.str();
}
...
BOOST_CONTRACT_DETAIL_DECLINLINE
char const* assertion_failure::file() const
{
    return file_;
}

BOOST_CONTRACT_DETAIL_DECLINLINE
unsigned long assertion_failure::line() const
{
    return line_;
}

BOOST_CONTRACT_DETAIL_DECLINLINE
char const* assertion_failure::code() const
{
    return code_;
}
...
void default_handler()
{
    ...
    switch (Key)
    {
        case check_failure_key:
            k = "check ";
            break;
        case pre_failure_key:
            k = "precondition ";
            break;
        case post_failure_key:
            k = "postcondition ";
            break;
        case except_failure_key:
            k = "except ";
            break;
        case old_failure_key:
            k = "old copy ";
            break;
        case entry_inv_failure_key:
            k = "entry invariant ";
            break;
        case exit_inv_failure_key:
            k = "exit invariant ";
            break;
    ...
    { // old_failure_key prints this, not above.
...
template <failure_key Key>
void default_from_handler(from)
{
    default_handler<Key>();
}
...
typedef boost::contract::detail::static_local_var_init<
    check_failure_handler_tag, failure_handler, void (*)(),
...
failure_handler const&
    set_check_failure_locked(failure_handler const& f) BOOST_NOEXCEPT_OR_NOTHROW
{
...
typedef boost::contract::detail::static_local_var_init<
    pre_failure_handler_tag, from_failure_handler, void (*)(from),
...
typedef boost::contract::detail::static_local_var_init<
    post_failure_handler_tag, from_failure_handler, void (*)(from),
...
typedef boost::contract::detail::static_local_var<except_failure_mutex_tag,
                                                  boost::mutex>
    except_failure_mutex;

struct except_failure_handler_tag;
typedef boost::contract::detail::static_local_var_init<
    except_failure_handler_tag, from_failure_handler, void (*)(from),
...
BOOST_CONTRACT_DETAIL_DECLINLINE
from_failure_handler get_except_failure_unlocked() BOOST_NOEXCEPT_OR_NOTHROW
{
...
typedef boost::contract::detail::static_local_var_init<
    old_failure_handler_tag, from_failure_handler, void (*)(from),
...
typedef boost::contract::detail::static_local_var<entry_inv_failure_mutex_tag,
                                                  boost::mutex>
    entry_inv_failure_mutex;

struct entry_inv_failure_handler_tag;
typedef boost::contract::detail::static_local_var_init<
    entry_inv_failure_handler_tag, from_failure_handler, void (*)(from),
...
BOOST_CONTRACT_DETAIL_DECLINLINE
from_failure_handler get_entry_inv_failure_unlocked() BOOST_NOEXCEPT_OR_NOTHROW
{
    return entry_inv_failure_handler::ref();
}

BOOST_CONTRACT_DETAIL_DECLINLINE
from_failure_handler get_entry_inv_failure_locked() BOOST_NOEXCEPT_OR_NOTHROW
{
    boost::lock_guard<boost::mutex> lock(entry_inv_failure_mutex::ref());
...
typedef boost::contract::detail::static_local_var<exit_inv_failure_mutex_tag,
                                                  boost::mutex>
    exit_inv_failure_mutex;

struct exit_inv_failure_handler_tag;
typedef boost::contract::detail::static_local_var_init<
    exit_inv_failure_handler_tag, from_failure_handler, void (*)(from),
...
BOOST_CONTRACT_DETAIL_DECLINLINE
from_failure_handler get_exit_inv_failure_unlocked() BOOST_NOEXCEPT_OR_NOTHROW
{
    return exit_inv_failure_handler::ref();
}

BOOST_CONTRACT_DETAIL_DECLINLINE
from_failure_handler get_exit_inv_failure_locked() BOOST_NOEXCEPT_OR_NOTHROW
{
    boost::lock_guard<boost::mutex> lock(exit_inv_failure_mutex::ref());
