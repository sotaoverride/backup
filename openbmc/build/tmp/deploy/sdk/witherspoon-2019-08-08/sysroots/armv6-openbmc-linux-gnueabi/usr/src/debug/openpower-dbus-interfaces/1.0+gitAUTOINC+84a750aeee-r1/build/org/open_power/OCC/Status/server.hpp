...
class Status
{
  public:
    ...
    virtual bool occActive(bool value, bool skipSignal);
    ...
    virtual bool throttleProcTemp(bool value, bool skipSignal);
    ...
    virtual bool throttleProcPower(bool value, bool skipSignal);
    ...
    virtual bool throttleMemTemp(bool value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_OccActive(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    /** @brief sd-bus callback for set-property 'OccActive' */
    static int _callback_set_OccActive(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);

    /** @brief sd-bus callback for get-property 'ThrottleProcTemp' */
    static int _callback_get_ThrottleProcTemp(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'ThrottleProcTemp' */
    static int _callback_set_ThrottleProcTemp(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'ThrottleProcPower' */
    static int _callback_get_ThrottleProcPower(sd_bus*, const char*,
                                               const char*, const char*,
                                               sd_bus_message*, void*,
                                               sd_bus_error*);
    /** @brief sd-bus callback for set-property 'ThrottleProcPower' */
    static int _callback_set_ThrottleProcPower(sd_bus*, const char*,
                                               const char*, const char*,
                                               sd_bus_message*, void*,
                                               sd_bus_error*);

    /** @brief sd-bus callback for get-property 'ThrottleMemTemp' */
    static int _callback_get_ThrottleMemTemp(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'ThrottleMemTemp' */
    static int _callback_set_ThrottleMemTemp(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _org_open_power_OCC_Status_interface;
