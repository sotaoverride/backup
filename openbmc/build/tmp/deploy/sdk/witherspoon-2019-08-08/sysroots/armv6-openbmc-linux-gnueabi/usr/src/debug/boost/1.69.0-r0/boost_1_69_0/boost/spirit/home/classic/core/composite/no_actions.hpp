...
struct no_actions_action_policy : public BaseT
{
    ...
    void do_action(ActorT const& /*actor*/, AttrT& /*val*/,
                   IteratorT const& /*first*/, IteratorT const& /*last*/) const
    {
    }
};
...
struct no_actions_scanner
{
    typedef scanner_policies<typename ScannerT::iteration_policy_t,
                             ...
                             typename detail::compute_no_actions_action_policy<
                                 typename ScannerT::action_policy_t>::type>
        policies_t;
...
{
    typedef scanner_list<ScannerT, typename no_actions_scanner<ScannerT>::type>
        type;
};
