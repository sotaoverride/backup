...
static void print_usage(void)
{
    printf(
        ...
        "     --replace-only        Only replace or update qdisc, never create "
        "it.\n"
        " -d, --dev=DEV             Network device the qdisc should be "
        "attached to.\n"
        " -i, --id=ID               ID of new qdisc (default: "
        "auto-generated)r\n"
