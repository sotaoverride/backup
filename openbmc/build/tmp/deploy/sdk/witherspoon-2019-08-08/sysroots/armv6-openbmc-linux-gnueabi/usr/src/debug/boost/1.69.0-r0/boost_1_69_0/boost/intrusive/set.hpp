...
{
    /// @cond
    typedef bstree_impl<ValueTraits, VoidOrKeyOfValue, Compare, SizeType,
                        ConstantTimeSize, RbTreeAlgorithms, HeaderHolder>
        tree_type;
  ...
  public:
    ...
    typedef typename implementation_defined::const_reverse_iterator
  ...
  public:
    ...
    //! @copydoc ::boost::intrusive::rbtree::rbtree(const key_compare &,const
    //! value_traits &)
    ...
    //! @copydoc ::boost::intrusive::rbtree::rbtree(bool,Iterator,Iterator,const
    //! key_compare &,const value_traits &)
    template <class Iterator>
    set_impl(Iterator b, Iterator e, const key_compare& cmp = key_compare(),
             const value_traits& v_traits = value_traits()) :
    ...
    {
        return static_cast<set_impl&>(
            tree_type::operator=(BOOST_MOVE_BASE(tree_type, x)));
    }
    ...
    //! @copydoc
    //! ::boost::intrusive::rbtree::container_from_end_iterator(iterator)
    static set_impl& container_from_end_iterator(iterator end_iterator);

    //! @copydoc
    //! ::boost::intrusive::rbtree::container_from_end_iterator(const_iterator)
    static const set_impl&
    ...
    //! @copydoc
    //! ::boost::intrusive::rbtree::container_from_iterator(const_iterator)
    ...
    //! @copydoc ::boost::intrusive::rbtree::clone_from(const
    //! rbtree&,Cloner,Disposer)
    ...
    //! @copydoc
    //! ::boost::intrusive::rbtree::clone_from(rbtree&&,Cloner,Disposer)
    template <class Cloner, class Disposer>
    void clone_from(BOOST_RV_REF(set_impl) src, Cloner cloner,
                    Disposer disposer)
    {
    ...
    //! @copydoc
    //! ::boost::intrusive::rbtree::insert_unique(const_iterator,reference)
    iterator insert(const_iterator hint, reference value)
    {
        return tree_type::insert_unique(hint, value);
    }

    //! @copydoc ::boost::intrusive::rbtree::insert_unique_check(const
    //! key_type&,insert_commit_data&)
    std::pair<iterator, bool> insert_check(const key_type& key,
    ...
    //! @copydoc
    //! ::boost::intrusive::rbtree::insert_unique_check(const_iterator,const
    //! key_type&,insert_commit_data&)
    std::pair<iterator, bool> insert_check(const_iterator hint,
                                           const key_type& key,
                                           insert_commit_data& commit_data)
    {
    ...
    //! @copydoc ::boost::intrusive::rbtree::insert_unique_check(const
    //! KeyType&,KeyTypeKeyCompare,insert_commit_data&)
    template <class KeyType, class KeyTypeKeyCompare>
    std::pair<iterator, bool> insert_check(const KeyType& key,
    ...
    //! @copydoc
    //! ::boost::intrusive::rbtree::erase(const_iterator,const_iterator)
    iterator erase(const_iterator b, const_iterator e);

    //! @copydoc ::boost::intrusive::rbtree::erase(const key_type &)
    size_type erase(const key_type& key);

    //! @copydoc ::boost::intrusive::rbtree::erase(const
    //! KeyType&,KeyTypeKeyCompare)
    template <class KeyType, class KeyTypeKeyCompare>
    size_type erase(const KeyType& key, KeyTypeKeyCompare comp);

    //! @copydoc
    //! ::boost::intrusive::rbtree::erase_and_dispose(const_iterator,Disposer)
    template <class Disposer>
    iterator erase_and_dispose(const_iterator i, Disposer disposer);

    //! @copydoc
    //! ::boost::intrusive::rbtree::erase_and_dispose(const_iterator,const_iterator,Disposer)
    template <class Disposer>
    iterator erase_and_dispose(const_iterator b, const_iterator e,
                               Disposer disposer);

    //! @copydoc ::boost::intrusive::rbtree::erase_and_dispose(const key_type &,
    //! Disposer)
    template <class Disposer>
    size_type erase_and_dispose(const key_type& key, Disposer disposer);

    //! @copydoc ::boost::intrusive::rbtree::erase_and_dispose(const
    //! KeyType&,KeyTypeKeyCompare,Disposer)
    ...
    {
        return static_cast<size_type>(this->tree_type::find(key) !=
                                      this->tree_type::cend());
    }

    //! @copydoc ::boost::intrusive::rbtree::count(const
    //! KeyType&,KeyTypeKeyCompare)const
    template <class KeyType, class KeyTypeKeyCompare>
    size_type count(const KeyType& key, KeyTypeKeyCompare comp) const
    {
        return static_cast<size_type>(this->tree_type::find(key, comp) !=
                                      this->tree_type::cend());
    }
    ...
    //! @copydoc ::boost::intrusive::rbtree::lower_bound(const
    //! KeyType&,KeyTypeKeyCompare)
    template <class KeyType, class KeyTypeKeyCompare>
    ...
    //! @copydoc ::boost::intrusive::rbtree::upper_bound(const
    //! KeyType&,KeyTypeKeyCompare)
    template <class KeyType, class KeyTypeKeyCompare>
    ...
    //! @copydoc ::boost::intrusive::rbtree::find(const
    //! KeyType&,KeyTypeKeyCompare)
    template <class KeyType, class KeyTypeKeyCompare>
    ...
    //! @copydoc ::boost::intrusive::rbtree::equal_range(const
    //! KeyType&,KeyTypeKeyCompare)
    template <class KeyType, class KeyTypeKeyCompare>
    ...
    //! @copydoc ::boost::intrusive::rbtree::bounded_range(const key_type
    ...
    //! @copydoc ::boost::intrusive::rbtree::bounded_range(const KeyType&,const
    ...
    void merge(set_impl<ValueTraits, VoidOrKeyOfValue, Compare2, SizeType,
                        ConstantTimeSize, HeaderHolder>& source)
    {
        return tree_type::merge_unique(source);
    }

    template <class Compare2>
    void merge(multiset_impl<ValueTraits, VoidOrKeyOfValue, Compare2, SizeType,
                             ConstantTimeSize, HeaderHolder>& source)
    {
        return tree_type::merge_unique(source);
    }
...
template <class T, class... Options>
bool operator!=(const set_impl<T, Options...>& x,
                const set_impl<T, Options...>& y);
...
{
    /// @cond
    typedef typename pack_options<rbtree_defaults,
    ...
    typedef set_impl<value_traits, typename packed_options::key_of_value,
                            ...
                            >::type
{
  ...
  public:
    ...
    set(BOOST_RV_REF(set) x) : Base(BOOST_MOVE_BASE(Base, x))
    {
    }
...
#endif
{
  ...
  public:
    ...
    {
        return static_cast<multiset_impl&>(
            tree_type::operator=(BOOST_MOVE_BASE(tree_type, x)));
    }
    ...
    //! ::boost::intrusive::rbtree::clone_from(rbtree&&,Cloner,Disposer)
    template <class Cloner, class Disposer>
    void clone_from(BOOST_RV_REF(multiset_impl) src, Cloner cloner,
                    Disposer disposer)
    {
        tree_type::clone_from(BOOST_MOVE_BASE(tree_type, src), cloner,
                              disposer);
    ...
    //! @copydoc
    //! ::boost::intrusive::rbtree::insert_equal(const_iterator,reference)
    iterator insert(const_iterator hint, reference value)
    {
...
template <class T, class... Options>
bool operator!=(const multiset_impl<T, Options...>& x,
                const multiset_impl<T, Options...>& y);
...
//! Helper metafunction to define a \c multiset that yields to the same type
//! when the same options (either explicitly or implicitly) are used.
#if defined(BOOST_INTRUSIVE_DOXYGEN_INVOKED) ||                                \
    defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
template <class T, class... Options>
#else
...
struct make_multiset
{
    ...
    typedef multiset_impl<value_traits, typename packed_options::key_of_value,
                          typename packed_options::compare,
                          typename packed_options::size_type,
                          packed_options::constant_time_size,
                          typename packed_options::header_holder_type>
...
template <class T, class... Options>
#endif
class multiset : public make_multiset<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                      O1, O2, O3, O4, O5, O6
#else
                                      Options...
                                      ...
                                      >::type
{
  ...
  public:
    ...
    multiset(BOOST_RV_REF(multiset) x) : Base(BOOST_MOVE_BASE(Base, x))
    {
    }

    multiset& operator=(BOOST_RV_REF(multiset) x)
    {
        return static_cast<multiset&>(
            this->Base::operator=(BOOST_MOVE_BASE(Base, x)));
    }
    ...
    template <class Cloner, class Disposer>
    void clone_from(BOOST_RV_REF(multiset) src, Cloner cloner,
                    Disposer disposer)
    {
        Base::clone_from(BOOST_MOVE_BASE(Base, src), cloner, disposer);
    }
    ...
    static const multiset&
        container_from_end_iterator(const_iterator end_iterator)
    {
        return static_cast<const multiset&>(
            Base::container_from_end_iterator(end_iterator));
    }
