 ...
 * certain runtime checks to identify invalid casts.
 */
#define G_INITIALLY_UNOWNED(object)                                            \
    (G_TYPE_CHECK_INSTANCE_CAST((object), G_TYPE_INITIALLY_UNOWNED,            \
                                GInitiallyUnowned))
/**
 ...
 */
#define G_INITIALLY_UNOWNED_CLASS(class)                                       \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_INITIALLY_UNOWNED,                \
 ...
 * %G_TYPE_INITIALLY_UNOWNED.
 */
#define G_IS_INITIALLY_UNOWNED(object)                                         \
    (G_TYPE_CHECK_INSTANCE_TYPE((object), G_TYPE_INITIALLY_UNOWNED))
/**
 ...
 */
#define G_IS_INITIALLY_UNOWNED_CLASS(class)                                    \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_INITIALLY_UNOWNED))
/**
 ...
 * Returns: pointer to object class structure.
 */
#define G_INITIALLY_UNOWNED_GET_CLASS(object)                                  \
    (G_TYPE_INSTANCE_GET_CLASS((object), G_TYPE_INITIALLY_UNOWNED,             \
                               GInitiallyUnownedClass))
...
#define G_OBJECT_WARN_INVALID_PSPEC(object, pname, property_id, pspec)         \
    ...
    {                                                                          \
        ...
        g_warning("%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'",   \
                  __FILE__, __LINE__, (pname), _glib__property_id,             \
                  _glib__pspec->name,                                          \
 ...
 * Since: 2.44
 */
static inline gboolean(g_set_object)(GObject** object_ptr, GObject* new_object)
{
...
#define g_set_object(object_ptr, new_object)                                   \
    (/* Check types match. */                                                  \
     0 ? *(object_ptr) = (new_object),                                         \
     FALSE : (g_set_object)((GObject**)(object_ptr), (GObject*)(new_object)))
 ...
 * Since: 2.56
 */
static inline void(g_clear_weak_pointer)(gpointer* weak_pointer_location)
{
 ...
 * ]|
 *
 * Returns: %TRUE if the value of @weak_pointer_location changed, %FALSE
 * otherwise
 *
 * Since: 2.56
 */
static inline gboolean(g_set_weak_pointer)(gpointer* weak_pointer_location,
                                           GObject* new_object)
{
