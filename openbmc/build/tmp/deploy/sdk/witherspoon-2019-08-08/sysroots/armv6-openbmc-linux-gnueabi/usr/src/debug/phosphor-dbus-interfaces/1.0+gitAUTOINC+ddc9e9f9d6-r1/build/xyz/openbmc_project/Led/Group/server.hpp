...
class Group
{
  public:
    ...
    virtual bool asserted(bool value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_Asserted(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Asserted' */
    static int _callback_set_Asserted(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Led_Group_interface;
