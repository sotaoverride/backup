...
/// the underlying object has the same constness as the pointer itself (unlike
/// an ordinary pointer).
///
template <typename T>
class hold_ptr
{
  ...
  public:
    ...
    ///
    /// Create a pointer that holds \a v, ownership is transferred to smart
    /// pointer
    ///
    ...
    ///
    /// Set new value to pointer, previous object is destroyed, ownership on new
