 ...
 * @activate_action_full: the virtual function pointer for
...
G_DEFINE_INTERFACE(GRemoteActionGroup, g_remote_action_group,
                   G_TYPE_ACTION_GROUP)
...
{
    G_REMOTE_ACTION_GROUP_GET_IFACE(remote)->activate_action_full(
        remote, action_name, parameter, platform_data);
}
...
void g_remote_action_group_change_action_state_full(GRemoteActionGroup* remote,
                                                    ...
                                                    GVariant* platform_data)
{
    G_REMOTE_ACTION_GROUP_GET_IFACE(remote)->change_action_state_full(
        remote, action_name, value, platform_data);
}
