...
#define G_TLS_CERTIFICATE(inst)                                                \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_TLS_CERTIFICATE,                \
                                GTlsCertificate))
#define G_TLS_CERTIFICATE_CLASS(class)                                         \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_TLS_CERTIFICATE,                  \
                             GTlsCertificateClass))
#define G_IS_TLS_CERTIFICATE(inst)                                             \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_TLS_CERTIFICATE))
#define G_IS_TLS_CERTIFICATE_CLASS(class)                                      \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_TLS_CERTIFICATE))
#define G_TLS_CERTIFICATE_GET_CLASS(inst)                                      \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_TLS_CERTIFICATE,                 \
                               GTlsCertificateClass))
