...
class severity_logger
    : public basic_composite_logger<char, severity_logger<LevelT>,
                                    single_thread_model,
                                    features<severity<LevelT>>>
{
  ...
  public:
    ...
    explicit severity_logger(LevelT level) :
        base_type(keywords::severity = level)
    {
    }
};
...
class severity_logger_mt
    : public basic_composite_logger<
          char, severity_logger_mt<LevelT>,
...
class wseverity_logger
    : public basic_composite_logger<wchar_t, wseverity_logger<LevelT>,
                                    single_thread_model,
                                    features<severity<LevelT>>>
{
...
class wseverity_logger_mt
    : public basic_composite_logger<
          wchar_t, wseverity_logger_mt<LevelT>,
          multi_thread_model<boost::log::aux::light_rw_mutex>,
          features<severity<LevelT>>>
{
...
/*!
 * \brief Narrow-char logger. Functionally equivalent to \c
                                    ...
                                    features<severity<LevelT>>>
{
  public:
    ...
    /*!
     * The constructor creates the logger with the specified default severity
     * level
     *
...
/*!
 * \brief Narrow-char thread-safe logger. Functionally equivalent to \c
 * basic_severity_logger.
 *
 * See \c severity class template for a more detailed description
 */
template <typename LevelT = int>
class severity_logger_mt
    : public basic_composite_logger<char, severity_logger_mt<LevelT>,
...
/*!
 * \brief Wide-char thread-safe logger. Functionally equivalent to \c
 * basic_severity_logger.
 *
 * See \c severity class template for a more detailed description
 */
template <typename LevelT = int>
class wseverity_logger_mt
    : public basic_composite_logger<wchar_t, wseverity_logger_mt<LevelT>,
                                    multi_thread_model<implementation_defined>,
                                    features<severity<LevelT>>>
{
  public:
