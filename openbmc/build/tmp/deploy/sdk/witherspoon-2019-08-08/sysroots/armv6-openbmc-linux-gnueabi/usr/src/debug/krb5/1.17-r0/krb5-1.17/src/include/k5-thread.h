...
#define K5_OS_MUTEX_PARTIAL_INITIALIZER K5_OS_NOTHREAD_MUTEX_PARTIAL_INITIALIZER
...
#define K5_ONCE_INIT                                                           \
    {                                                                          \
        PTHREAD_ONCE_INIT, K5_OS_NOTHREAD_ONCE_INIT                            \
    }
...
#define k5_once pthread_once
    ...
    (defined(_SYSTYPE_SVR4) || defined(__SYSTYPE_SVR4__))
#ifndef HAVE_PRAGMA_WEAK_REF
#if defined(__GNUC__) && __GNUC__ < 3
#error                                                                         \
    "Please update to a newer gcc with weak symbol support, or switch to native cc, reconfigure and recompile."
#else
...
#define K5_OS_MUTEX_PARTIAL_INITIALIZER PTHREAD_MUTEX_INITIALIZER
...
#define k5_os_mutex_unlock(M)                                                  \
    (assert((M)->is_locked == 1), (M)->is_locked = 0,                          \
...
#define k5_mutex_destroy(M) (k5_os_mutex_destroy(M))
