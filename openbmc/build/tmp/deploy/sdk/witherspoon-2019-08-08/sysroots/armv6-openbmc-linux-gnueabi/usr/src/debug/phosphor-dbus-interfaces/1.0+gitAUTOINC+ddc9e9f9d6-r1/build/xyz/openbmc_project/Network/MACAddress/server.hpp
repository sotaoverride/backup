...
class MACAddress
{
  public:
    ...
    MACAddress(MACAddress&&) = delete;
    MACAddress& operator=(MACAddress&&) = delete;
     ...
     */
    MACAddress(bus::bus& bus, const char* path);
  ...
  private:
    ...
    static constexpr auto _interface = "xyz.openbmc_project.Network.MACAddress";
    static const vtable::vtable_t _vtable[];
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Network_MACAddress_interface;
