...
#define G_DBUS_AUTH(o)                                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_AUTH, GDBusAuth))
#define G_DBUS_AUTH_CLASS(k)                                                   \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_DBUS_AUTH, GDBusAuthClass))
#define G_DBUS_AUTH_GET_CLASS(o)                                               \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DBUS_AUTH, GDBusAuthClass))
...
/* TODO: need a way to convey negotiated features (e.g. returning flags from
 * e.g. GDBusConnectionFeatures) */

/* TODO: need to expose encode()/decode() from the AuthMechanism (and whether it
 * is needed at all) */
