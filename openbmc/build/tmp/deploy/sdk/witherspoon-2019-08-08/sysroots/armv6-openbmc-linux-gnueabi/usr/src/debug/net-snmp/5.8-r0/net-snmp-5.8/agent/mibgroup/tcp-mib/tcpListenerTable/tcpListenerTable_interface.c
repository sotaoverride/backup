...
netsnmp_feature_child_of(tcpListenerTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_child_of(tcpListenerTable_container_size,
                                 tcpListenerTable_external_access)
            netsnmp_feature_child_of(tcpListenerTable_registration_set,
                                     tcpListenerTable_external_access)
                netsnmp_feature_child_of(tcpListenerTable_registration_get,
                                         tcpListenerTable_external_access)
                    netsnmp_feature_child_of(tcpListenerTable_container_get,
                                             tcpListenerTable_external_access)
...
static void _tcpListenerTable_container_shutdown(
 ...
 */
void _tcpListenerTable_initialize_interface(
    tcpListenerTable_registration* reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods* access_multiplexer =
    ...
    DEBUGMSGTL(
        ("internal:tcpListenerTable:_tcpListenerTable_initialize_interface",
         "called\n"));
    ...
    reginfo = netsnmp_handler_registration_create(
        "tcpListenerTable", handler, tcpListenerTable_oid,
        tcpListenerTable_oid_size, HANDLER_CAN_BABY_STEP | HANDLER_CAN_RONLY);
    if (NULL == reginfo)
    {
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, tcpListenerTable_if_ctx.container,
 ...
 */
void _tcpListenerTable_shutdown_interface(
    tcpListenerTable_registration* reg_ptr)
{
    /*
...
void tcpListenerTable_valid_columns_set(netsnmp_column_info* vc)
{
                                  ...
                                  tcpListenerTable_mib_index* mib_idx)
{
    ...
    memset(&var_tcpListenerLocalPort, 0x00, sizeof(var_tcpListenerLocalPort));
    ...
    DEBUGMSGTL(
        ("verbose:tcpListenerTable:tcpListenerTable_index_to_oid", "called\n"));
 ...
 */
int tcpListenerTable_index_from_oid(netsnmp_index* oid_idx,
                                    tcpListenerTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
                                         ...
                                         void* user_init_ctx)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpListenerTable:tcpListenerTable_allocate_rowreq_ctx",
         "called\n"));
 ...
 */
void tcpListenerTable_release_rowreq_ctx(
    tcpListenerTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("internal:tcpListenerTable:tcpListenerTable_release_rowreq_ctx",
                "called\n"));
 ...
 * wrapper
 */
static int _mfd_tcpListenerTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:tcpListenerTable:_mfd_tcpListenerTable_pre_request",
                "called\n"));

    if (1 != netsnmp_row_merge_status_first(reginfo, agtreq_info))
    {
        DEBUGMSGTL(
            ("internal:tcpListenerTable", "skipping additional pre_request\n"));
 ...
 * wrapper
 */
static int _mfd_tcpListenerTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    tcpListenerTable_rowreq_ctx* rowreq_ctx =
        (tcpListenerTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    int rc, packet_rc;

    DEBUGMSGTL(("internal:tcpListenerTable:_mfd_tcpListenerTable_post_request",
                "called\n"));
    ...
    {
        DEBUGMSGTL(
            ("internal:tcpListenerTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
 ...
 * wrapper
 */
static int _mfd_tcpListenerTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:tcpListenerTable:_mfd_tcpListenerTable_object_lookup",
                "called\n"));
                                 ...
                                 netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(("internal:tcpListenerTable:_mfd_tcpListenerTable_get_column",
                "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_TCPLISTENERPROCESS:
            ...
            rc = tcpListenerProcess_get(rowreq_ctx, (u_long*)var->val.string);
            break;
...
int _mfd_tcpListenerTable_get_values(netsnmp_mib_handler* handler,
                                     netsnmp_handler_registration* reginfo,
                                     ...
                                     netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:tcpListenerTable:_mfd_tcpListenerTable_get_values",
                "called\n"));
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
    ...
    {
        snmp_log(LOG_ERR, "invalid cache for tcpListenerTable_cache_load\n");
        return -1;
    }
     ...
     * call user code
     */
    return tcpListenerTable_container_load((netsnmp_container*)cache->magic);
} /* _cache_load */
...
static void _cache_free(netsnmp_cache* cache, void* magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log(LOG_ERR, "invalid cache in tcpListenerTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free(tcpListenerTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(("internal:tcpListenerTable:_container_item_free", "called\n"));
...
{
    DEBUGMSGTL(("internal:tcpListenerTable:_tcpListenerTable_container_init",
                "called\n"));
    ...
    if_ctx->cache =
        netsnmp_cache_create(30, /* timeout in seconds */
                             _cache_load, _cache_free, tcpListenerTable_oid,
...
{
    DEBUGMSGTL(
        ("internal:tcpListenerTable:_tcpListenerTable_container_shutdown",
         "called\n"));
...
tcpListenerTable_rowreq_ctx*
    tcpListenerTable_row_find_by_mib_index(tcpListenerTable_mib_index* mib_idx)
{
    tcpListenerTable_rowreq_ctx* rowreq_ctx;
    ...
    rowreq_ctx = (tcpListenerTable_rowreq_ctx*)CONTAINER_FIND(
        tcpListenerTable_if_ctx.container, &oid_idx);
