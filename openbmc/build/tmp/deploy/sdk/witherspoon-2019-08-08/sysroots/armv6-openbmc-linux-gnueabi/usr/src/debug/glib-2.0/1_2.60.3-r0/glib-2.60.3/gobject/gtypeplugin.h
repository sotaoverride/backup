...
#define G_TYPE_PLUGIN(inst)                                                    \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_TYPE_PLUGIN, GTypePlugin))
#define G_TYPE_PLUGIN_CLASS(vtable)                                            \
    (G_TYPE_CHECK_CLASS_CAST((vtable), G_TYPE_TYPE_PLUGIN, GTypePluginClass))
 ...
 */
typedef void (*GTypePluginCompleteTypeInfo)(GTypePlugin* plugin, GType g_type,
                                            GTypeInfo* info,
...
GLIB_AVAILABLE_IN_ALL
void g_type_plugin_complete_type_info(GTypePlugin* plugin, GType g_type,
                                      GTypeInfo* info,
                                      GTypeValueTable* value_table);
GLIB_AVAILABLE_IN_ALL
