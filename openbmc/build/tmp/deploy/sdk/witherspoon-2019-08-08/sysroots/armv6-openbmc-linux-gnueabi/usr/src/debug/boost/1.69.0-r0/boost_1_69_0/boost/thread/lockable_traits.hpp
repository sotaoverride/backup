...
struct has_member_lock<T, true>
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = sizeof(has_member_lock<T>::has_member(
                                            &T::lock)) == sizeof(true_type));
};
...
struct has_member_unlock<T, true>
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = sizeof(has_member_unlock<T>::has_member(
                                            &T::unlock)) == sizeof(true_type));
};
...
struct has_member_try_lock<T, true>
{
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = sizeof(has_member_try_lock<T>::has_member(
                                      &T::try_lock)) == sizeof(true_type));
};
#else
...
template <typename T>
struct has_member_lock<T, decltype(void(boost::declval<T&>().lock()))>
    : true_type
{
};
...
template <typename T>
struct has_member_unlock<T, decltype(void(boost::declval<T&>().unlock()))>
    : true_type
{
};
...
template <typename T>
struct has_member_try_lock<T, decltype(bool(boost::declval<T&>().try_lock()))>
    : true_type
{
};
#endif
...
{
    BOOST_STATIC_CONSTANT(bool,
                          value = is_basic_lockable<T>::value &&
