                                    ...
                                    size_t __dynarray_used)
{
    ...
    for (size_t __dynarray_i = 0; __dynarray_i < __dynarray_used;
         ++__dynarray_i)
...
static inline void DYNARRAY_NAME(free__array__)(struct DYNARRAY_STRUCT* list)
{
#if DYNARRAY_HAVE_SCRATCH
...
__attribute__((unused, nonnull(1))) static void
...
/* Return the number of elements which have been added to the dynamic
   array.  */
__attribute__((nonnull(1))) static inline size_t
...
__attribute__((nonnull(1))) static inline DYNARRAY_ELEMENT*
...
static void DYNARRAY_NAME(add__)(struct DYNARRAY_STRUCT* list,
                                 DYNARRAY_ELEMENT item)
{
    if (__glibc_unlikely(!__libc_dynarray_emplace_enlarge(
            &list->dynarray_abstract, DYNARRAY_SCRATCH(list),
...
/* Add ITEM at the end of the array, enlarging it by one element.
   ...
   increased.  */
__attribute__((unused, nonnull(1))) static inline void
...
static DYNARRAY_ELEMENT* DYNARRAY_NAME(emplace__)(struct DYNARRAY_STRUCT* list)
{
    if (__glibc_unlikely(!__libc_dynarray_emplace_enlarge(
            &list->dynarray_abstract, DYNARRAY_SCRATCH(list),
            sizeof(DYNARRAY_ELEMENT))))
...
__attribute__((unused, warn_unused_result, nonnull(1))) static
/* Avoid inlining with the larger initialization code.  */
#if !(defined(DYNARRAY_ELEMENT_INIT) || defined(DYNARRAY_ELEMENT_FREE))
    inline
#endif
    DYNARRAY_ELEMENT* DYNARRAY_NAME(emplace)(struct DYNARRAY_STRUCT* list)
{
    /* Do nothing in case of previous error.  */
    if (DYNARRAY_NAME(has_failed)(list))
        return NULL;
...
__attribute__((unused, nonnull(1))) static bool
    DYNARRAY_NAME(resize)(struct DYNARRAY_STRUCT* list, size_t size)
{
    if (size > list->dynarray_header.used)
    {
        ...
        ok = __libc_dynarray_resize(&list->dynarray_abstract, size,
        ...
        /* Zero initialization is needed so that the elements can be
           safely freed.  */
        ok = __libc_dynarray_resize_clear(&list->dynarray_abstract, size,
                                          DYNARRAY_SCRATCH(list),
                                          sizeof(DYNARRAY_ELEMENT));
#else
        ok = __libc_dynarray_resize(&list->dynarray_abstract, size,
    ...
    else
    {
        ...
        DYNARRAY_NAME(free__elements__)
        (list->dynarray_header.array + size, list->dynarray_header.used - size);
...
/* Transfer the dynamic array to a permanent location at *RESULT.
   ...
   free.  */
__attribute__((unused, warn_unused_result, nonnull(1, 2))) static bool
...
/* Transfer the dynamic array to a heap-allocated array and return a
   ...
   reused.  */
__attribute__((unused, warn_unused_result, nonnull(1))) static DYNARRAY_ELEMENT*
