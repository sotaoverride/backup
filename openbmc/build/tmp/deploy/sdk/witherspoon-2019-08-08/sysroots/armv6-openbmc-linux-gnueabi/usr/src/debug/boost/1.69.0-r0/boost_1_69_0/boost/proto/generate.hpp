...
struct by_value_generator_<proto::expr<Tag, term<Arg>, 0>>
{
    typedef proto::expr<Tag,
                        term<typename detail::term_traits<Arg>::value_type>, 0>
        type;
...
struct by_value_generator_<proto::basic_expr<Tag, term<Arg>, 0>>
{
    typedef proto::basic_expr<
        Tag, term<typename detail::term_traits<Arg>::value_type>, 0>
        type;
...
struct default_generator
{
    ...
    /// \return expr
    template <typename Expr>
    BOOST_FORCEINLINE BOOST_PROTO_RETURN_TYPE_STRICT_LOOSE(Expr, Expr const&)
...
struct pod_generator
{
    ...
    BOOST_FORCEINLINE Extends<expr<tag::terminal, proto::term<Member Class::*>>>
        operator()(
            expr<tag::terminal, proto::term<Member Class::*>> const& e) const
    {
    ...
    template <typename Class, typename Member>
    BOOST_FORCEINLINE
        Extends<basic_expr<tag::terminal, proto::term<Member Class::*>>>
        operator()(basic_expr<tag::terminal,
                              proto::term<Member Class::*>> const& e) const
    {
...
struct by_value_generator
{
    ...
    template <typename Expr>
    BOOST_FORCEINLINE typename result<by_value_generator(Expr)>::type
        operator()(Expr const& e) const
    {
...
struct compose_generators
{
    ...
    struct result<This(Expr)>
    {
        typedef typename Second::template result<Second(
            typename First::template result<First(Expr)>::type)>::type type;
    };
    ...
    template <typename Expr>
    BOOST_FORCEINLINE typename result<compose_generators(Expr)>::type
        operator()(Expr const& e) const
    {
