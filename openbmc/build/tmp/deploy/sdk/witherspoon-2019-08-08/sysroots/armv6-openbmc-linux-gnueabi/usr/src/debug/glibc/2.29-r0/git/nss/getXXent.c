...
extern int INTERNAL(REENTRANT_GETNAME)(
    LOOKUP_TYPE* resbuf, char* buffer, size_t buflen,
...
LOOKUP_TYPE* GETFUNC_NAME(void)
{
    ...
    result = (LOOKUP_TYPE*)__nss_getent(
        (getent_r_function)INTERNAL(REENTRANT_GETNAME), &resbuf.ptr, &buffer,
        BUFLEN, &buffer_size, H_ERRNO_VAR);
