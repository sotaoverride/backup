...
static void g_simple_io_stream_finalize(GObject* object)
{
...
static void g_simple_io_stream_set_property(GObject* object, guint prop_id,
                                            const GValue* value,
                                            GParamSpec* pspec)
{
    GSimpleIOStream* stream = G_SIMPLE_IO_STREAM(object);
...
static void g_simple_io_stream_get_property(GObject* object, guint prop_id,
...
static GInputStream* g_simple_io_stream_get_input_stream(GIOStream* stream)
{
...
static GOutputStream* g_simple_io_stream_get_output_stream(GIOStream* stream)
{
    GSimpleIOStream* simple_stream = G_SIMPLE_IO_STREAM(stream);
...
static void g_simple_io_stream_class_init(GSimpleIOStreamClass* class)
{
...
static void g_simple_io_stream_init(GSimpleIOStream* stream)
{
}
...
GIOStream* g_simple_io_stream_new(GInputStream* input_stream,
                                  GOutputStream* output_stream)
{
    return g_object_new(G_TYPE_SIMPLE_IO_STREAM, "input-stream", input_stream,
                        "output-stream", output_stream, NULL);
}
