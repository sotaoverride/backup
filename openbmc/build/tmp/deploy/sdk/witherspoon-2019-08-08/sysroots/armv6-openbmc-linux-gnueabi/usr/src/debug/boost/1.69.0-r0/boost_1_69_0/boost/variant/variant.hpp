...
struct add_alignment
{
    ...
    struct apply : mpl::size_t<::boost::integer::static_lcm<
...
struct find_fallback_type
{
  private: // helpers, for metafunction result (below)
    ...
    typedef typename mpl::iter_fold_if<
        Types, mpl::int_<0>, mpl::protect<mpl::next<>>,
    ...
    typedef typename mpl::iter_fold_if<
        mpl::iterator_range<first_result_it, end_it>, first_result_index,
  ...
  public: // metafunction result
    ...
    typedef typename mpl::eval_if<
        ...
        mpl::if_<is_same<first_result_it, end_it>,
                 mpl::pair<no_fallback_type, no_fallback_type>, first_result_>,
...
struct is_variant_move_noexcept_constructible
{
    typedef typename boost::mpl::find_if<
        Types,
        mpl::not_<boost::is_nothrow_move_constructible<boost::mpl::_1>>>::type
        iterator_t;
...
struct is_variant_move_noexcept_assignable
{
    typedef typename boost::mpl::find_if<
        Types,
        mpl::not_<boost::is_nothrow_move_assignable<boost::mpl::_1>>>::type
        iterator_t;
...
//
// Derives from true_type if at least one variant's type is constructible from
// T.
//
template <class T1, class T2>
struct is_constructible_ext
    : boost::mpl::or_<boost::is_constructible<T1, T2>,
                      boost::is_constructible<
                          T1, typename boost::add_lvalue_reference<T2>::type>>
{
};
...
struct is_variant_constructible_from
    : boost::mpl::not_<boost::is_same<
          typename boost::mpl::find_if<
              Types, is_constructible_ext<boost::mpl::_1, T>>::type,
...
struct is_variant_constructible_from<
    ...
    : boost::is_same<
          typename boost::mpl::find_if<
              typename boost::variant<BOOST_VARIANT_ENUM_PARAMS(
                  T)>::recursive_enabled_types,
              mpl::not_<is_variant_constructible_from<boost::mpl::_1, Types>>>::
              type,
          typename boost::mpl::end<typename boost::variant<
              BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types>::type>
{
};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from<
    const boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>&, Types>
    : is_variant_constructible_from<
          boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types>
{
};
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from<
    boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const&&, Types>
    : is_variant_constructible_from<
          boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types>
{
};
...
struct make_storage
{
  private: // helpers, for metafunction result (below)
    typedef typename mpl::eval_if<
        NeverUsesBackupFlag, mpl::identity<Types>,
    ...
    typedef typename mpl::fold<types, mpl::size_t<1>, add_alignment>::type
        max_alignment;
  ...
  public: // metafunction result
    typedef ::boost::aligned_storage<BOOST_MPL_AUX_VALUE_WKND(max_size)::value,
...
struct destroyer : public static_visitor<>
{
  public: // visitor interfaces
    template <typename T>
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE internal_visit(T& operand,
                                                      int) const BOOST_NOEXCEPT
    {
...
class copy_into : public static_visitor<>
{
  ...
  public: // internal visitor interface
    ...
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE
        internal_visit(boost::detail::variant::backup_holder<T>& operand,
                       long) const
    {
    ...
    template <typename T>
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE
        internal_visit(const boost::detail::variant::backup_holder<T>& operand,
                       long) const
    {
        new (storage_) T(operand.get());
        BOOST_VARIANT_AUX_RETURN_VOID;
    ...
    template <typename T>
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE internal_visit(const T& operand,
                                                      int) const
    {
...
class move_into : public static_visitor<>
{
  ...
  public: // internal visitor interface
    ...
    template <typename T>
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE internal_visit(T& operand, int) const
...
struct assign_storage : public static_visitor<>
{
  ...
  public: // internal visitor interfaces
    ...
    template <typename T>
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE internal_visit(T& lhs_content, int) const
    {
        // NOTE TO USER :
...
struct move_storage : public static_visitor<>
{
  ...
  public: // internal visitor interfaces
    ...
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE
        internal_visit(backup_holder<T>& lhs_content, long) const
    {
        lhs_content.get() = ::boost::detail::variant::move(
            static_cast<backup_holder<T>*>(rhs_storage_)->get());
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
    ...
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE internal_visit(T& lhs_content, int) const
    {
        ...
        //
        lhs_content =
            ::boost::detail::variant::move(*static_cast<T*>(rhs_storage_));
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
};
...
class backup_assigner : public static_visitor<>
{
  ...
  public: // structors
    ...
    backup_assigner(Variant& lhs, int rhs_which, const RhsT& rhs_content) :
        lhs_(lhs), rhs_which_(rhs_which), rhs_content_(&rhs_content),
  ...
  private: // helpers, for visitor interface (below)
    ...
    void backup_assign_impl(backup_holder<LhsT>& lhs_content,
                            ...
                            int)
    {
        ...
        LhsT backup_lhs_content(
            ::boost::detail::variant::move(lhs_content)); // nothrow
        ...
        BOOST_CATCH(...)
        {
            ...
            new (lhs_.storage_.address()) LhsT(
                ::boost::detail::variant::move(backup_lhs_content)); // nothrow
...
class invoke_visitor
{
  ...
  public: // internal visitor interfaces
    ...
    // using workaround with is_same<T, T> to prenvent compilation error,
    // because we need to use T in enable_if to make SFINAE work
    template <typename T>
    typename enable_if_c<MoveSemantics && is_same<T, T>::value,
                         result_type>::type
    ...
    // because we need to use T in enable_if to make SFINAE work
    template <typename T>
    typename disable_if_c<MoveSemantics && is_same<T, T>::value,
                          result_type>::type
        internal_visit(T&& operand, int)
    {
  ...
  private: // helpers, for internal visitor interfaces (below)
    ...
    // because we need to use T in enable_if to make SFINAE work
    template <typename T>
    typename enable_if<mpl::and_<MoveSemantics && is_same<T, T>::value>,
                       BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)>::type
    ...
    template <typename T>
    typename enable_if_c<MoveSemantics && is_same<T, T>::value,
                         BOOST_VARIANT_AUX_RETURN_VOID_TYPE>::type
    ...
    typename disable_if_c<
        MoveSemantics && is_same<T, T>::value,
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)>::type
        visit_impl(T&& operand, mpl::false_)
    {
        return visitor_(operand);
    ...
    // because we need to use T in enable_if to make SFINAE work
    template <typename T>
    typename disable_if<MoveSemantics && is_same<T, T>::value,
                        BOOST_VARIANT_AUX_RETURN_VOID_TYPE>::type
        visit_impl(T&& operand, mpl::true_)
    {
        visitor_(operand);
    ...
    template <typename T>
    BOOST_VARIANT_AUX_RETURN_VOID_TYPE visit_impl(T& operand, mpl::true_)
    {
        visitor_(operand);
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
  ...
  public: // internal visitor interfaces
    ...
    internal_visit(T& operand, int)
    {
        typedef typename is_same<result_type, void>::type has_void_result_type;
...
class variant
{
  private: // helpers, for typedefs (below)
    ...
    typedef typename mpl::eval_if<is_recursive_, T0_, mpl::identity<T0_>>::type
        unwrapped_T0_;
  ...
  private: // helpers, for typedefs (below)
    typedef typename mpl::eval_if<
        is_sequence_based_, unwrapped_T0_ // over_sequence<...>::type
        ,
        detail::variant::make_variant_list<
            unwrapped_T0_, BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)>>::type
        specified_types;
  ...
  public: // public typedefs
    typedef typename mpl::eval_if<
        is_recursive_,
        mpl::transform<specified_types,
                       mpl::protect<detail::variant::quoted_enable_recursive<
                           wknd_self_t>>>,
        mpl::identity<specified_types>>::type
        recursive_enabled_types; // used by is_variant_constructible_from<>
                                 // trait

    typedef typename mpl::transform<recursive_enabled_types,
                                    unwrap_recursive<mpl::_1>>::type types;

  private: // internal typedefs
    typedef typename mpl::transform<
        recursive_enabled_types,
        mpl::protect<detail::make_reference_content<>>>::type internal_types;
...
#define BOOST_VARIANT_AUX_ENABLE_RECURSIVE_TYPEDEFS(z, N, _)                   \
    typedef typename mpl::eval_if<                                             \
        is_recursive_,                                                         \
        detail::variant::enable_recursive<BOOST_PP_CAT(T, N), wknd_self_t>,    \
        mpl::identity<BOOST_PP_CAT(T, N)>>::type                               \
        BOOST_PP_CAT(recursive_enabled_T, N);                                  \
    /**/

    BOOST_PP_REPEAT(BOOST_VARIANT_LIMIT_TYPES,
                    BOOST_VARIANT_AUX_ENABLE_RECURSIVE_TYPEDEFS, _)

#undef BOOST_VARIANT_AUX_ENABLE_RECURSIVE_TYPEDEFS

#define BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS(z, N, _)                   \
    typedef                                                                    \
        typename unwrap_recursive<BOOST_PP_CAT(recursive_enabled_T, N)>::type  \
            BOOST_PP_CAT(public_T, N);                                         \
    /**/

    BOOST_PP_REPEAT(BOOST_VARIANT_LIMIT_TYPES,
                    BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS, _)

#undef BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS

  public: // public typedefs
    typedef
        typename detail::variant::make_variant_list<BOOST_VARIANT_ENUM_PARAMS(
            public_T)>::type types;

  private: // helpers, for internal typedefs (below)

#define BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS(z, N, _)             \
    typedef detail::make_reference_content<BOOST_PP_CAT(                       \
        recursive_enabled_T, N)>::type BOOST_PP_CAT(internal_T, N);            \
    /**/

    BOOST_PP_REPEAT(BOOST_VARIANT_LIMIT_TYPES,
                    BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS, _)
...
#undef BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS
  ...
  private: // internal typedefs
    typedef
        typename detail::variant::make_variant_list<BOOST_VARIANT_ENUM_PARAMS(
            internal_T)>::type internal_types;
  ...
  private: // helpers, for representation (below)
    typedef typename detail::variant::find_fallback_type<internal_types>::type
        fallback_type_result_;
    ...
    struct has_fallback_type_
        : mpl::not_<is_same<fallback_type_, detail::variant::no_fallback_type>>
    {
    };
    ...
    typedef typename detail::variant::make_storage<
        internal_types, never_uses_backup_flag>::type storage_t;
  ...
  private: // helpers, for representation (below)
    ...
    typedef typename mpl::eval_if<
        ...
        mpl::identity<int>,
        mpl::if_<mpl::less<mpl::O1_size<internal_types>, mpl::int_<SCHAR_MAX>>,
                 signed char, int>>::type which_t;
...
// representation -- private when possible
  ...
  private: // helpers, for structors (below)
    struct initializer
        : BOOST_VARIANT_AUX_INITIALIZER_T(recursive_enabled_types,
                                          recursive_enabled_T)
    {
    };
...
#pragma warning(pop)
  ...
  private: // helpers, for structors, cont. (below)
    class convert_copy_into : public static_visitor<int>
    {
      ...
      public: // internal visitor interfaces (below)
        ...
        template <typename T>
        int internal_visit(boost::detail::reference_content<T>& operand,
                           long) const
        {
            return internal_visit(operand.get(), 1L);
        }
        ...
        template <typename T>
        int internal_visit(const boost::detail::reference_content<T>& operand,
                           long) const
        {
            return internal_visit(operand.get(), 1L);
        }
        ...
        template <typename T>
        int internal_visit(boost::detail::variant::backup_holder<T>& operand,
                           long) const
        {
            return internal_visit(operand.get(), 1L);
        }
        ...
        template <typename T>
        int internal_visit(
            const boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit(operand.get(), 1L);
        }
        ...
        template <typename T>
        int internal_visit(const boost::recursive_wrapper<T>& operand,
                           long) const
        {
            return internal_visit(operand.get(), 1L);
        }
    ...
    class convert_move_into : public static_visitor<int>
    {
      ...
      public: // internal visitor interfaces (below)
        ...
        int internal_visit(T& operand, int) const
        {
            ...
            // types (or that no conversion exists).
            //
            return initializer::initialize(storage_,
  ...
  private: // helpers, for structors, below
    ...
    typename boost::enable_if<boost::is_rvalue_reference<T&&>>::type
        convert_construct(T&& operand, int,
                          mpl::false_ = mpl::false_() // is_foreign_variant
        )
    {
        // NOTE TO USER :
        ...
        // (or that no conversion exists).
        //
        indicate_which(initializer::initialize(storage_.address(),
                                               detail::variant::move(operand)));
    }
#endif

    template <typename Variant>
    void convert_construct(Variant& operand, long,
    ...
    typename boost::enable_if<boost::is_rvalue_reference<Variant&&>>::type
        convert_construct(Variant&& operand, long,
                          mpl::true_ // is_foreign_variant
        )
    {
    ...
    void convert_construct_variant(Variant& operand)
    {
        ...
        typedef typename mpl::find_if<
            types, is_same<add_const<mpl::_1>, const Variant>>::type found_it;
    ...
    typename boost::enable_if<mpl::or_<
        ...
        boost::detail::variant::is_variant_constructible_from<
            boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>>>::
        type
        convert_construct(boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand,
                          long)
    {
    ...
    typename boost::enable_if<mpl::or_<
        boost::is_same<boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        boost::detail::variant::is_variant_constructible_from<
            const boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&,
            internal_types>>>::type
        convert_construct(
    ...
    typename boost::enable_if<mpl::or_<
        ...
        type
        convert_construct(
            boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&& operand, long)
    {
  ...
  public: // structors, cont.
    ...
    variant(const T& operand,
            typename boost::enable_if<mpl::or_<
                mpl::and_<mpl::not_<boost::is_same<T, variant>>,
                          boost::detail::variant::is_variant_constructible_from<
                              const T&, internal_types>>,
    ...
    variant(T&& operand,
            typename boost::enable_if<mpl::or_<
                mpl::and_<boost::is_rvalue_reference<T&&>,
  ...
  public: // structors, cont.
    ...
    variant(variant&& operand)
        BOOST_NOEXCEPT_IF(variant_move_noexcept_constructible::type::value)
    {
  ...
  private: // helpers, for modifiers (below)
    ...
    class assigner : public static_visitor<>
    {
      ...
      protected: // helpers, for internal visitor interface (below)
        ...
        void assign_impl(const RhsT& rhs_content, mpl::true_ // has_nothrow_copy
                         ,
        ...
        void assign_impl(const RhsT& rhs_content,
        ...
        {
            // In case of failure, default-construct fallback type in lhs's
            // storage...
            new (lhs_.storage_.address()) fallback_type_; // nothrow

            // ...indicate construction of fallback type...
            lhs_.indicate_which(BOOST_MPL_AUX_VALUE_WKND(
                fallback_type_index_)::value); // nothrow
        }
        ...
        {
            detail::variant::backup_assigner<wknd_self_t> visitor(
                lhs_, rhs_which_, rhs_content);
      ...
      public: // internal visitor interfaces
            ...
            internal_visit(const RhsT& rhs_content, int) const
        {
            ...
            typedef typename mpl::or_< // reduces compile-time
                nothrow_copy, is_nothrow_move_constructible<RhsT>>::type
                nothrow_move_constructor;

            assign_impl(rhs_content, nothrow_copy(), nothrow_move_constructor(),
                        has_fallback_type_());
    ...
    // class move_assigner
    //
    // Internal visitor that "move assigns" the visited value to the given
    // variant by appropriate destruction and move-construction.
    //
    ...
    class move_assigner : public assigner
    {
      ...
      private: // helpers, for internal visitor interface (below)
        ...
        void assign_impl(RhsT& rhs_content, mpl::true_ // has_nothrow_copy
                         ,
                         mpl::false_ // is_nothrow_move_constructible
                         ,
                         B2 // has_fallback_type
        ...
        {
            assigner::assign_impl(rhs_content, mpl::true_(), mpl::false_(),
                                  B2());
        }

        template <typename RhsT, typename B, typename B2>
        void assign_impl(RhsT& rhs_content, B // has_nothrow_copy
                         ,
                         mpl::true_ // is_nothrow_move_constructible
                         ,
                         B2 // has_fallback_type
        ...
        template <typename RhsT>
        void assign_impl(RhsT& rhs_content, mpl::false_ // has_nothrow_copy
                         ,
                         mpl::false_ // is_nothrow_move_constructible
                         ,
                         mpl::true_ // has_fallback_type
        ...
        {
            assigner::assign_impl(rhs_content, mpl::false_(), mpl::false_(),
                                  mpl::false_());
        }

      public: // internal visitor interfaces
        template <typename RhsT>
        BOOST_VARIANT_AUX_RETURN_VOID_TYPE internal_visit(RhsT& rhs_content,
                                                          int) const
        {
            typedef typename is_nothrow_move_constructible<RhsT>::type
                nothrow_move_constructor;
            typedef typename mpl::or_< // reduces compile-time
                nothrow_move_constructor, has_nothrow_copy<RhsT>>::type
                nothrow_copy;
  ...
  public: // modifiers
    ...
    typename boost::enable_if<
        boost::mpl::and_<boost::is_rvalue_reference<T&&>,
                         mpl::not_<boost::is_const<T>>,
                         boost::detail::variant::is_variant_constructible_from<
                             T&&, internal_types>>,
        variant&>::type
    ...
    template <typename T>
    typename boost::enable_if<
        mpl::or_<boost::is_same<T, variant>,
                 boost::detail::variant::is_variant_constructible_from<
                     const T&, internal_types>>,
        variant&>::type
    ...
    defined(__clang__)
        BOOST_NOEXCEPT_IF(variant_move_noexcept_constructible::type::value&&
                              variant_move_noexcept_assignable::type::value)
#endif
    {
  ...
  public: // comparison operators
    ...
    bool operator==(const variant& rhs) const
    {
        ...
        detail::variant::comparer<variant, detail::variant::equal_comp> visitor(
            *this);
    ...
    bool operator<(const variant& rhs) const
    {
        ...
        detail::variant::comparer<variant, detail::variant::less_comp> visitor(
            *this);
        return rhs.apply_visitor(visitor);
    }
...
// helpers, for visitation support (below) -- private when possible
  ...
  public:
    ...
    static BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(typename Visitor::result_type)
        internal_apply_visitor_impl(int internal_which, int logical_which,
                                    Visitor& visitor, VoidPtrCV storage)
    {
        ...
        typedef detail::variant::visitation_impl_step<first_it, last_it>
            first_step;

        return detail::variant::visitation_impl(
            internal_which, logical_which, visitor, storage, mpl::false_(),
            never_uses_backup_flag(), static_cast<first_which*>(0),
    ...
    {
        return internal_apply_visitor_impl(which_, which(), visitor,
                                           storage_.address());
    }
...
struct make_variant_over
{
  private: // precondition assertions
    ...
    typedef typename boost::mpl::insert_range<
        boost::mpl::list<>, boost::mpl::end<boost::mpl::list<>>::type,
        Types>::type copied_sequence_t;
...
inline void swap(variant<BOOST_VARIANT_ENUM_PARAMS(T)>& lhs,
