...
static gboolean param_char_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_int =
        CLAMP(value->data[0].v_int, cspec->minimum, cspec->maximum);
...
static gboolean param_uchar_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_uint =
        CLAMP(value->data[0].v_uint, uspec->minimum, uspec->maximum);
...
static gboolean param_int_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_int =
        CLAMP(value->data[0].v_int, ispec->minimum, ispec->maximum);

    return value->data[0].v_int != oval;
}

static gint param_int_values_cmp(GParamSpec* pspec, const GValue* value1,
                                 const GValue* value2)
{
...
static gint param_uint_values_cmp(GParamSpec* pspec, const GValue* value1,
                                  const GValue* value2)
{
...
static gboolean param_long_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_long =
        CLAMP(value->data[0].v_long, lspec->minimum, lspec->maximum);

    return value->data[0].v_long != oval;
}

static gint param_long_values_cmp(GParamSpec* pspec, const GValue* value1,
                                  const GValue* value2)
{
...
static gboolean param_ulong_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_ulong =
        CLAMP(value->data[0].v_ulong, uspec->minimum, uspec->maximum);

    return value->data[0].v_ulong != oval;
}

static gint param_ulong_values_cmp(GParamSpec* pspec, const GValue* value1,
                                   const GValue* value2)
{
...
static gboolean param_int64_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_int64 =
        CLAMP(value->data[0].v_int64, lspec->minimum, lspec->maximum);

    return value->data[0].v_int64 != oval;
}

static gint param_int64_values_cmp(GParamSpec* pspec, const GValue* value1,
                                   const GValue* value2)
{
...
static gboolean param_uint64_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_uint64 =
        CLAMP(value->data[0].v_uint64, uspec->minimum, uspec->maximum);

    return value->data[0].v_uint64 != oval;
}

static gint param_uint64_values_cmp(GParamSpec* pspec, const GValue* value1,
                                    const GValue* value2)
{
...
static gint param_unichar_values_cmp(GParamSpec* pspec, const GValue* value1,
                                     const GValue* value2)
{
    if (value1->data[0].v_uint < value2->data[0].v_uint)
        return -1;
...
static gboolean param_float_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_float =
        CLAMP(value->data[0].v_float, fspec->minimum, fspec->maximum);

    return value->data[0].v_float != oval;
}

static gint param_float_values_cmp(GParamSpec* pspec, const GValue* value1,
                                   const GValue* value2)
{
...
static gboolean param_double_validate(GParamSpec* pspec, GValue* value)
{
    ...
    value->data[0].v_double =
        CLAMP(value->data[0].v_double, dspec->minimum, dspec->maximum);

    return value->data[0].v_double != oval;
}

static gint param_double_values_cmp(GParamSpec* pspec, const GValue* value1,
                                    const GValue* value2)
{
...
static void param_string_set_default(GParamSpec* pspec, GValue* value)
{
    value->data[0].v_pointer =
        g_strdup(G_PARAM_SPEC_STRING(pspec)->default_value);
}
...
static gint param_string_values_cmp(GParamSpec* pspec, const GValue* value1,
                                    const GValue* value2)
{
...
static gboolean param_param_validate(GParamSpec* pspec, GValue* value)
{
    ...
    if (param && !g_value_type_compatible(G_PARAM_SPEC_TYPE(param),
...
static gint param_boxed_values_cmp(GParamSpec* pspec, const GValue* value1,
                                   const GValue* value2)
{
...
static gint param_pointer_values_cmp(GParamSpec* pspec, const GValue* value1,
                                     const GValue* value2)
{
    guint8* p1 = value1->data[0].v_pointer;
    guint8* p2 = value2->data[0].v_pointer;
...
static inline guint value_array_ensure_size(GValueArray* value_array,
...
static void param_value_array_set_default(GParamSpec* pspec, GValue* value)
{
    ...
    if (value->data[0].v_pointer)
    {
        ...
        value_array_ensure_size(value->data[0].v_pointer,
...
static gboolean param_value_array_validate(GParamSpec* pspec, GValue* value)
{
    ...
    if (value->data[0].v_pointer)
    {
        ...
        changed +=
            value_array_ensure_size(value_array, aspec->fixed_n_elements);
        ...
        if (aspec->element_spec)
        {
            ...
            for (i = 0; i < value_array->n_values; i++)
            {
                ...
                /* need to fixup value type, or ensure that the array value is
                 * initialized at all */
                if (!g_value_type_compatible(
                        G_VALUE_TYPE(element),
                        G_PARAM_SPEC_VALUE_TYPE(element_spec)))
                {
                    if (G_VALUE_TYPE(element) != 0)
                        g_value_unset(element);
                    g_value_init(element,
                                 G_PARAM_SPEC_VALUE_TYPE(element_spec));
...
static gint param_value_array_values_cmp(GParamSpec* pspec,
                                         const GValue* value1,
                                         const GValue* value2)
{
    GParamSpecValueArray* aspec = G_PARAM_SPEC_VALUE_ARRAY(pspec);
    ...
    else if (!aspec->element_spec)
    {
         ...
         */
        return value_array1->n_values < value_array2->n_values
                   ? -1
                   : value_array1->n_values > value_array2->n_values;
    }
...
static gboolean param_object_validate(GParamSpec* pspec, GValue* value)
{
    ...
    if (object && !g_value_type_compatible(G_OBJECT_TYPE(object),
...
static gint param_object_values_cmp(GParamSpec* pspec, const GValue* value1,
                                    const GValue* value2)
{
    guint8* p1 = value1->data[0].v_pointer;
    guint8* p2 = value2->data[0].v_pointer;
...
static gint param_override_values_cmp(GParamSpec* pspec, const GValue* value1,
                                      const GValue* value2)
{
    GParamSpecOverride* ospec = G_PARAM_SPEC_OVERRIDE(pspec);
...
static gboolean param_gtype_validate(GParamSpec* pspec, GValue* value)
{
    ...
    if (tspec->is_a_type != G_TYPE_NONE &&
...
static gint param_gtype_values_cmp(GParamSpec* pspec, const GValue* value1,
                                   const GValue* value2)
{
...
static void param_variant_finalize(GParamSpec* pspec)
{
    GParamSpecVariant* vspec = G_PARAM_SPEC_VARIANT(pspec);
    GParamSpecClass* parent_class =
        g_type_class_peek(g_type_parent(G_TYPE_PARAM_VARIANT));
...
static gboolean variant_is_incomparable(GVariant* v)
{
...
static gint param_variant_values_cmp(GParamSpec* pspec, const GValue* value1,
                                     const GValue* value2)
{
    ...
    if (!g_variant_type_equal(g_variant_get_type(v1), g_variant_get_type(v2)) ||
        variant_is_incomparable(v1) || variant_is_incomparable(v2))
...
void _g_param_spec_types_init(void)
{
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamChar"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamUChar"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamBoolean"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(g_intern_static_string("GParamInt"),
                                            &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamUInt"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamLong"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamULong"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamInt64"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamEnum"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamFlags"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamDouble"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamString"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamParam"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamBoxed"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamPointer"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamValueArray"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamObject"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamOverride"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamGType"), &pspec_info);
        *spec_types++ = type;
     ...
     */
    {
        ...
        type = g_param_type_register_static(
            g_intern_static_string("GParamVariant"), &pspec_info);
        *spec_types++ = type;
...
GParamSpec* g_param_spec_char(const gchar* name, const gchar* nick,
                              const gchar* blurb, gint8 minimum, gint8 maximum,
...
GParamSpec* g_param_spec_boolean(const gchar* name, const gchar* nick,
                                 const gchar* blurb, gboolean default_value,
                                 GParamFlags flags)
{
    ...
    bspec =
        g_param_spec_internal(G_TYPE_PARAM_BOOLEAN, name, nick, blurb, flags);
    if (bspec == NULL)
        return NULL;
...
GParamSpec* g_param_spec_int(const gchar* name, const gchar* nick,
                             const gchar* blurb, gint minimum, gint maximum,
...
GParamSpec* g_param_spec_uint(const gchar* name, const gchar* nick,
                              const gchar* blurb, guint minimum, guint maximum,
...
GParamSpec* g_param_spec_long(const gchar* name, const gchar* nick,
                              const gchar* blurb, glong minimum, glong maximum,
                                ...
                                GParamFlags flags)
{
    ...
    uspec =
        g_param_spec_internal(G_TYPE_PARAM_UINT64, name, nick, blurb, flags);
    if (uspec == NULL)
        return NULL;
...
GParamSpec* g_param_spec_unichar(const gchar* name, const gchar* nick,
                                 const gchar* blurb, gunichar default_value,
                                 GParamFlags flags)
{
    GParamSpecUnichar* uspec;

    uspec =
        g_param_spec_internal(G_TYPE_PARAM_UNICHAR, name, nick, blurb, flags);
    if (uspec == NULL)
        return NULL;
...
GParamSpec* g_param_spec_flags(const gchar* name, const gchar* nick,
                               const gchar* blurb, GType flags_type,
                               guint default_value, GParamFlags flags)
{
    ...
    g_return_val_if_fail((default_value & flags_class->mask) == default_value,
                         NULL);
...
GParamSpec* g_param_spec_double(const gchar* name, const gchar* nick,
                                const gchar* blurb, gdouble minimum,
                                ...
                                GParamFlags flags)
{
    ...
    dspec =
        g_param_spec_internal(G_TYPE_PARAM_DOUBLE, name, nick, blurb, flags);
    if (dspec == NULL)
        return NULL;
                                ...
                                GParamFlags flags)
{
    GParamSpecString* sspec =
        g_param_spec_internal(G_TYPE_PARAM_STRING, name, nick, blurb, flags);
    if (sspec == NULL)
        return NULL;
...
GParamSpec* g_param_spec_param(const gchar* name, const gchar* nick,
                               const gchar* blurb, GType param_type,
                               GParamFlags flags)
{
...
GParamSpec* g_param_spec_boxed(const gchar* name, const gchar* nick,
                               const gchar* blurb, GType boxed_type,
                               GParamFlags flags)
{
                                 ...
                                 const gchar* blurb, GParamFlags flags)
{
    ...
    pspec =
        g_param_spec_internal(G_TYPE_PARAM_POINTER, name, nick, blurb, flags);
    if (pspec == NULL)
        return NULL;
 ...
 * Returns: (transfer full): a newly created parameter specification
 */
GParamSpec* g_param_spec_gtype(const gchar* name, const gchar* nick,
 ...
 */
GParamSpec* g_param_spec_value_array(const gchar* name, const gchar* nick,
                                     const gchar* blurb,
                                     ...
                                     GParamFlags flags)
{
    ...
    aspec = g_param_spec_internal(G_TYPE_PARAM_VALUE_ARRAY, name, nick, blurb,
                                  flags);
    if (aspec == NULL)
        return NULL;
                                ...
                                GParamFlags flags)
{
    ...
    ospec =
        g_param_spec_internal(G_TYPE_PARAM_OBJECT, name, nick, blurb, flags);
    if (ospec == NULL)
        return NULL;
...
GParamSpec* g_param_spec_override(const gchar* name, GParamSpec* overridden)
{
    ...
    pspec = g_param_spec_internal(G_TYPE_PARAM_OVERRIDE, name, NULL, NULL,
                                  overridden->flags);
    if (pspec == NULL)
        return NULL;
 ...
 * Since: 2.26
 */
GParamSpec* g_param_spec_variant(const gchar* name, const gchar* nick,
                                 const gchar* blurb, const GVariantType* type,
                                 GVariant* default_value, GParamFlags flags)
{
    GParamSpecVariant* vspec;

    g_return_val_if_fail(type != NULL, NULL);
    g_return_val_if_fail(default_value == NULL ||
                             g_variant_is_of_type(default_value, type),
                         NULL);

    vspec =
        g_param_spec_internal(G_TYPE_PARAM_VARIANT, name, nick, blurb, flags);
    if (vspec == NULL)
        return NULL;
