...
/* dbus-shared.h  Stuff used by both dbus/dbus.h low-level and C/C++ binding
 * APIs
 *
 ...
 * @ingroup  DBus
 *
 * @brief Shared header included by both libdbus and C/C++ bindings such as the
 * GLib bindings.
 *
 * Usually a C/C++ binding such as the GLib or Qt binding won't want to include
 * dbus.h in its public headers. However, a few constants and macros may be
 * useful to include; those are found here and in dbus-protocol.h
 *
 * @{
 */
...
typedef enum
{
    DBUS_HANDLER_RESULT_HANDLED, /**< Message has had its effect - no need to
                                    run more handlers. */
    ...
    DBUS_HANDLER_RESULT_NEED_MEMORY /**< Need more memory in order to return
                                       #DBUS_HANDLER_RESULT_HANDLED or
 ...
 */
/** The interface exported by the object with #DBUS_SERVICE_DBUS and
 * #DBUS_PATH_DBUS */
