...
static const char prefixes[] = "/etc\0"
                               "/run\0"
                               "/usr/local/lib\0"
                               "/usr/local/share\0"
                               "/usr/lib\0"
...
static const char suffixes[] = "sysctl.d\0"
                               "tmpfiles.d\0"
                               "modules-load.d\0"
                               "binfmt.d\0"
                               "systemd/system\0"
...
static enum {
    ...
    SHOW_DEFAULTS = (SHOW_MASKED | SHOW_EQUIVALENT | SHOW_REDIRECTED |
                     SHOW_OVERRIDDEN | SHOW_EXTENDED)
} arg_flags = 0;
...
static int notify_override_masked(const char* top, const char* bottom)
{
    ...
    printf("%s%s%s     %s %s %s\n", ansi_highlight_red(), "[MASKED]",
           ansi_normal(), top, special_glyph(SPECIAL_GLYPH_ARROW), bottom);
    return 1;
}
...
static int notify_override_equivalent(const char* top, const char* bottom)
{
    ...
    printf("%s%s%s %s %s %s\n", ansi_highlight_green(), "[EQUIVALENT]",
           ansi_normal(), top, special_glyph(SPECIAL_GLYPH_ARROW), bottom);
    return 1;
}
...
static int enumerate_dir_d(OrderedHashmap* top, OrderedHashmap* bottom,
                           OrderedHashmap* drops, const char* toppath,
                           const char* drop)
{
    ...
    *c = 0;
    ...
    STRV_FOREACH(file, list)
    {
        ...
        log_debug("Adding at top: %s %s %s", d,
                  special_glyph(SPECIAL_GLYPH_ARROW), p);
        ...
        log_debug("Adding at bottom: %s %s %s", d,
                  special_glyph(SPECIAL_GLYPH_ARROW), p);
        ...
        log_debug("Adding to drops: %s %s %s %s %s", unit,
                  special_glyph(SPECIAL_GLYPH_ARROW), basename(p),
                  special_glyph(SPECIAL_GLYPH_ARROW), p);
...
static int enumerate_dir(OrderedHashmap* top, OrderedHashmap* bottom,
                         OrderedHashmap* drops, const char* path, bool dropins)
{
