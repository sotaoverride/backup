...
class Owner
{
  public:
    ...
    using PropertiesVariant = std::variant<Owners>;
    ...
    virtual Owners timeOwner(Owners value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_TimeOwner(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    /** @brief sd-bus callback for set-property 'TimeOwner' */
    static int _callback_set_TimeOwner(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Time_Owner_interface;
