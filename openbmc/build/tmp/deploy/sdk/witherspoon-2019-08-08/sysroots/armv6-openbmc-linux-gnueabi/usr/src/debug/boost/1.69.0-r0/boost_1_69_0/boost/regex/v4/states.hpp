...
enum syntax_element_type
{
    ...
    // either a wide character set [..] or one with multicharacter collating
    // elements:
...
// dwa 09/26/00 - This is needed to suppress warnings about an ambiguous
// conversion
...
struct re_repeat : public re_alt
{
    ...
    bool leading; // True if this repeat is at the start of the machine (lets us
                  // optimize some searches)
...
/*** struct re_commit *************************************************
Used for the PRUNE, SKIP and COMMIT verbs which basically differ only in what
happens if no match is found and we start searching forward.
**********************************************************************/
enum commit_type
{
    commit_prune,
