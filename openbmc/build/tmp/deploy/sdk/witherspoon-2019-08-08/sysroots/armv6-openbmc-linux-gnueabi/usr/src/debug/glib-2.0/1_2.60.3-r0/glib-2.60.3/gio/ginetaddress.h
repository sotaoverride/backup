...
#define G_INET_ADDRESS(o)                                                      \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_INET_ADDRESS, GInetAddress))
#define G_INET_ADDRESS_CLASS(k)                                                \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_INET_ADDRESS, GInetAddressClass))
#define G_IS_INET_ADDRESS(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_INET_ADDRESS))
#define G_IS_INET_ADDRESS_CLASS(k)                                             \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_INET_ADDRESS))
#define G_INET_ADDRESS_GET_CLASS(o)                                            \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_INET_ADDRESS, GInetAddressClass))
