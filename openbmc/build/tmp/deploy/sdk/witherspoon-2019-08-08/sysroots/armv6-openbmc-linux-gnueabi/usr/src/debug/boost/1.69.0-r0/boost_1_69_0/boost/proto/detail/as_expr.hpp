...
struct as_expr<T, Generator, false>
{
    ...
    typedef typename Generator::template result<Generator(expr_type)>::type
        result_type;
...
{
    typedef typename term_traits<T&>::value_type value_type;
    typedef proto::basic_expr<proto::tag::terminal, term<value_type>, 0>
        expr_type;
    typedef typename Generator::template result<Generator(expr_type)>::type
        result_type;
...
struct as_child<T, Generator, true>
{
    ...
    typedef T& reference;
#endif
    typedef proto::basic_expr<proto::tag::terminal, term<reference>, 0>
        expr_type;
    typedef typename Generator::template result<Generator(expr_type)>::type
        result_type;
