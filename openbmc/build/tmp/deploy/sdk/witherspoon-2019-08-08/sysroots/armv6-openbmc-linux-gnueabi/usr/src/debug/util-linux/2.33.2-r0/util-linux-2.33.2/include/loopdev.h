...
extern char* loopdev_find_by_backing_file(const char* filename, uint64_t offset,
...
extern int loopcxt_find_by_backing_file(struct loopdev_cxt* lc,
                                        ...
                                        uint64_t sizelimit, int flags);
extern int loopcxt_find_overlap(struct loopdev_cxt* lc, const char* filename,
                                uint64_t offset, uint64_t sizelimit);

extern int loopcxt_is_used(struct loopdev_cxt* lc, struct stat* st,
