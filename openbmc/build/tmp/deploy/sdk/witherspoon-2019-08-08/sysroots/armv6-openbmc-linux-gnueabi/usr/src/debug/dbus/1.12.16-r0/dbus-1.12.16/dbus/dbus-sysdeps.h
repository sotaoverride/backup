...
/* dbus-sysdeps.h Wrappers around system/libc features (internal to D-Bus
 * implementation)
 *
...
dbus_bool_t _dbus_append_keyring_directory_for_credentials(
...
DBUS_PRIVATE_EXPORT
dbus_bool_t _dbus_split_paths_and_append(DBusString* dirs, const char* suffix,
                                         DBusList** dir_list);
