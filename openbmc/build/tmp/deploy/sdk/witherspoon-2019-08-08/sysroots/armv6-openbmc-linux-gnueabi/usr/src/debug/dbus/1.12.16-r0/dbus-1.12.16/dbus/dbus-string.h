...
#define _dbus_string_set_byte(s, i, b)                                         \
    ((((unsigned char*)(((DBusString*)(s))->dummy1))[(i)]) = (unsigned char)(b))
#define _dbus_string_get_byte(s, i)                                            \
    (((const unsigned char*)(((DBusString*)(s))->dummy1))[(i)])
#define _dbus_string_get_const_data(s)                                         \
    ((const char*)(((DBusString*)(s))->dummy1))
#define _dbus_string_get_const_data_len(s, start, len)                         \
    (((const char*)(((DBusString*)(s))->dummy1)) + (start))
#endif
...
dbus_bool_t _dbus_string_insert_bytes(DBusString* str, int i, int n_bytes,
                                      unsigned char byte);
DBUS_PRIVATE_EXPORT
dbus_bool_t _dbus_string_insert_byte(DBusString* str, int i,
                                     unsigned char byte);
DBUS_PRIVATE_EXPORT
...
dbus_bool_t _dbus_string_copy_data_len(const DBusString* str,
                                       char** data_return, int start, int len);
...
dbus_bool_t _dbus_string_split_on_byte(DBusString* source, unsigned char byte,
                                       DBusString* tail);
DBUS_PRIVATE_EXPORT
dbus_bool_t _dbus_string_parse_int(const DBusString* str, int start,
                                   long* value_return, int* end_return);
DBUS_PRIVATE_EXPORT
dbus_bool_t _dbus_string_parse_uint(const DBusString* str, int start,
...
dbus_bool_t _dbus_string_find_to(const DBusString* str, int start, int end,
                                 const char* substr, int* found);
dbus_bool_t _dbus_string_find_byte_backward(const DBusString* str, int start,
                                            unsigned char byte, int* found);
DBUS_PRIVATE_EXPORT
...
void _dbus_string_skip_white_reverse(const DBusString* str, int end,
                                     int* start);
DBUS_PRIVATE_EXPORT
...
dbus_bool_t _dbus_string_validate_utf8(const DBusString* str, int start,
                                       int len);
DBUS_PRIVATE_EXPORT
dbus_bool_t _dbus_string_validate_nul(const DBusString* str, int start,
                                      int len);
...
static inline unsigned char* _dbus_string_get_udata_len(DBusString* str,
                                                        int start, int len)
{
...
{
    return (const unsigned char*)_dbus_string_get_const_data_len(str, start,
                                                                 len);
}
