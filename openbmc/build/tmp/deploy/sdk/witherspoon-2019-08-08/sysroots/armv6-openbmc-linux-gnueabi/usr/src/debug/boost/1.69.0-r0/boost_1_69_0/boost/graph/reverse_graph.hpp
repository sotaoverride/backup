...
{
  public:
    EdgeDesc underlying_descx; // Odd name is because this needs to be public
                               // but shouldn't be exposed to users anymore
...
{
    typedef Desc type;
    static Desc convert(const Desc& d)
    {
        return d;
    }
};
...
template <>
struct choose_rev_edge_iter<true>
{
    template <class G>
    struct bind_
    {
...
template <>
struct choose_rev_edge_iter<false>
{
    template <class G>
    struct bind_
    {
...
template <class BidirectionalGraph, class GRef>
inline std::pair<typename graph_traits<
                     reverse_graph<BidirectionalGraph, GRef>>::edge_descriptor,
                 bool>
...
struct reverse_graph_edge_property_map
{
  ...
  public:
    ...
    friend reference get(const reverse_graph_edge_property_map& m,
                         const key_type& e)
    {
        return get(m.underlying_pm, e.underlying_descx);
    }

    friend void put(const reverse_graph_edge_property_map& m, const key_type& e,
                    const value_type& v)
    {
...
struct property_map<reverse_graph<BidirGraph, GRef>, Property>
{
    ...
    typedef typename boost::mpl::if_<
        is_ref_const, typename property_map<BidirGraph, Property>::const_type,
        typename property_map<BidirGraph, Property>::type>::type orig_type;
    typedef
        typename property_map<BidirGraph, Property>::const_type orig_const_type;
    typedef typename boost::mpl::if_<
        is_edge_prop, detail::reverse_graph_edge_property_map<orig_type>,
        orig_type>::type type;
    typedef typename boost::mpl::if_<
        is_edge_prop, detail::reverse_graph_edge_property_map<orig_const_type>,
...
typename disable_if<is_same<Property, edge_underlying_t>,
                    typename property_traits<typename property_map<
                        reverse_graph<BidirectionalGraph, GRef>,
...
template <typename T>
struct is_reverse_graph : boost::mpl::false_
{
};
