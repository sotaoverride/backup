...
netsnmp_feature_provide(watcher_all) netsnmp_feature_child_of(
    watcher_all, mib_helpers) netsnmp_feature_child_of(watcher_create_info6,
                                                       watcher_all)
    netsnmp_feature_child_of(
        watcher_register_timestamp,
        watcher_all) netsnmp_feature_child_of(watcher_ulong_scalar, watcher_all)
        netsnmp_feature_child_of(watcher_read_only_ulong_scalar, watcher_all)
            netsnmp_feature_child_of(watcher_read_only_int_scalar, watcher_all)
                netsnmp_feature_child_of(watcher_long_scalar, watcher_all)
                    netsnmp_feature_child_of(watcher_read_only_long_scalar,
                                             watcher_all)
                        netsnmp_feature_child_of(watcher_int_scalar,
                                                 watcher_all)
                            netsnmp_feature_child_of(read_only_counter32_scalar,
                                                     watcher_all)
                                netsnmp_feature_child_of(watcher_spinlock,
                                                         watcher_all)
    ...
    netsnmp_mib_handler* netsnmp_get_watcher_handler(void)
{
    ...
    ret = netsnmp_create_handler("watcher", netsnmp_watcher_helper_handler);
    if (ret)
    {
...
netsnmp_watcher_info* netsnmp_init_watcher_info6(netsnmp_watcher_info* winfo,
                                                 void* data, size_t size,
                                                 u_char type, int flags,
                                                 size_t max_size,
                                                 size_t* size_p)
{
    winfo->data = data;
...
netsnmp_watcher_info* netsnmp_create_watcher_info6(void* data, size_t size,
                                                   u_char type, int flags,
                                                   size_t max_size,
                                                   size_t* size_p)
{
...
netsnmp_watcher_info* netsnmp_init_watcher_info(netsnmp_watcher_info* winfo,
                                                void* data, size_t size,
                                                u_char type, int flags)
{
    return netsnmp_init_watcher_info6(winfo, data, size, type,
                                      (flags ? flags : WATCHER_FIXED_SIZE),
                                      size, /* Probably wrong for non-fixed
                                             * size data */
                                      NULL);
}

netsnmp_watcher_info* netsnmp_create_watcher_info(void* data, size_t size,
                                                  u_char type, int flags)
{
    netsnmp_watcher_info* winfo = SNMP_MALLOC_TYPEDEF(netsnmp_watcher_info);
    if (winfo)
...
/**
 * Register a watched scalar. Ownership of watchinfo is transferred to the
 * handler.
 *
...
NETSNMP_STATIC_INLINE size_t get_data_size(const netsnmp_watcher_info* winfo)
{
...
NETSNMP_STATIC_INLINE void set_data(netsnmp_watcher_info* winfo, void* data,
                                    size_t size)
{
...
{
    netsnmp_watcher_cache* res = (netsnmp_watcher_cache*)malloc(
        sizeof(netsnmp_watcher_cache) + size - 1);
    if (res)
    {
        res->size = size;
                                   ...
                                   netsnmp_request_info* requests)
{
    ...
    switch (reqinfo->mode)
    {
             ...
             */
        case MODE_GET:
            snmp_set_var_typed_value(requests->requestvb, winfo->type,
                                     winfo->data, get_data_size(winfo));
            break;
        ...
        case MODE_SET_RESERVE2:
            ...
            if (old_data == NULL)
            {
                ...
                netsnmp_request_add_list_data(
                    requests, netsnmp_create_data_list("watcher", old_data,
                                                       &free_wrapper));
            break;
        ...
        case MODE_SET_UNDO:
            old_data = (netsnmp_watcher_cache*)netsnmp_request_get_list_data(
                requests, "watcher");
        ...
        default:
            snmp_log(LOG_ERR,
                     "watcher handler called with an unknown mode: %d\n",
                     reqinfo->mode);
                                      ...
                                      netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("helper:watcher:timestamp", "Got request:  %d\n", reqinfo->mode));
    ...
    if (reginfo && spinlock)
    {
        ...
        if (whandler)
        {
            ...
            winfo = netsnmp_create_watcher_info(
                (void*)spinlock, sizeof(int), ASN_INTEGER, WATCHER_FIXED_SIZE);
            if (winfo &&
                                     ...
                                     netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("helper:watcher:spinlock", "Got request:  %d\n", reqinfo->mode));
...
netsnmp_watcher_info* netsnmp_clone_watcher_info(netsnmp_watcher_info* winfo)
{
...
static int register_scalar_watcher(const char* name, const oid* reg_oid,
                                   size_t reg_oid_len, void* data, size_t size,
                                   u_char type,
...
int netsnmp_register_ulong_scalar(const char* name, const oid* reg_oid,
                                  size_t reg_oid_len, u_long* it,
                                  Netsnmp_Node_Handler* subhandler)
{
    return register_scalar_watcher(name, reg_oid, reg_oid_len, (void*)it,
                                   sizeof(u_long), ASN_UNSIGNED, subhandler,
                                   HANDLER_CAN_RWRITE);
}
...
{
    return register_scalar_watcher(name, reg_oid, reg_oid_len, (void*)it,
                                   sizeof(long), ASN_INTEGER, subhandler,
                                   HANDLER_CAN_RWRITE);
}
#endif /* NETSNMP_FEATURE_REMOVE_WATCHER_LONG_SCALAR */

#ifndef NETSNMP_FEATURE_REMOVE_WATCHER_READ_ONLY_LONG_SCALAR
int netsnmp_register_read_only_long_scalar(const char* name, const oid* reg_oid,
                                           size_t reg_oid_len, long* it,
                                           Netsnmp_Node_Handler* subhandler)
{
    return register_scalar_watcher(name, reg_oid, reg_oid_len, (void*)it,
...
{
    return register_scalar_watcher(name, reg_oid, reg_oid_len, (void*)it,
                                   sizeof(int), ASN_INTEGER, subhandler,
                                   HANDLER_CAN_RWRITE);
}
#endif /* NETSNMP_FEATURE_REMOVE_WATCHER_INT_SCALAR */

#ifndef NETSNMP_FEATURE_REMOVE_WATCHER_READ_ONLY_INT_SCALAR
int netsnmp_register_read_only_int_scalar(const char* name, const oid* reg_oid,
                                          size_t reg_oid_len, int* it,
                                          Netsnmp_Node_Handler* subhandler)
{
    return register_scalar_watcher(name, reg_oid, reg_oid_len, (void*)it,
...
int netsnmp_register_read_only_counter32_scalar(
    const char* name, const oid* reg_oid, size_t reg_oid_len, u_long* it,
    Netsnmp_Node_Handler* subhandler)
{
    return register_scalar_watcher(name, reg_oid, reg_oid_len, (void*)it,
                                   sizeof(u_long), ASN_COUNTER, subhandler,
                                   HANDLER_CAN_RONLY);
}
