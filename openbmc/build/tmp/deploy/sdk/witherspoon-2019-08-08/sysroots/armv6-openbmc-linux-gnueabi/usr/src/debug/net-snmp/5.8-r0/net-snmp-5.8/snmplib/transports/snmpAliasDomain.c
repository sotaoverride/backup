...
/* An alias parser */
void parse_alias_config(const char* token, char* line)
{
    ...
    netsnmp_data_list_add_node(
        &alias_memory, netsnmp_create_data_list(aliasname, strdup(transportdef),
                                                &free_wrapper));
}

void free_alias_config(void)
{
...
netsnmp_transport* netsnmp_alias_create_tstring(const char* str, int local,
...
netsnmp_transport* netsnmp_alias_create_ostring(const void* o, size_t o_len,
                                                int local)
{
