...
LINE_PARSER("#", STRING_FIELD(result->p_name, isspace, 1);
...
static enum nss_status lookup(const char* name, const char* type,
                              struct protoent* proto, char* buffer,
...
enum nss_status _nss_hesiod_getprotobyname_r(const char* name,
...
enum nss_status _nss_hesiod_getprotobynumber_r(const int protocol,
                                               struct protoent* proto,
                                               char* buffer, size_t buflen,
                                               int* errnop)
{
