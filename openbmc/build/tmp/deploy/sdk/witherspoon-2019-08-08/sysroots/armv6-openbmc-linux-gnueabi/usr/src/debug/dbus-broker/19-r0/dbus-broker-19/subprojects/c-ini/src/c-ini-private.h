...
#define C_INI_ENTRY_NULL(_x)                                                   \
    {                                                                          \
        .n_refs = 1, .link_group = C_LIST_INIT((_x).link_group),               \
...
#define C_INI_GROUP_NULL(_x)                                                   \
    {                                                                          \
        .n_refs = 1, .link_domain = C_LIST_INIT((_x).link_domain),             \
...
#define C_INI_DOMAIN_NULL(_x)                                                  \
    {                                                                          \
        .n_refs = 1, .list_raws = C_LIST_INIT((_x).list_raws),                 \
