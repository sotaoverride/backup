...
static void g_tls_database_init(GTlsDatabase* cert)
{
}
...
static void async_verify_chain_free(gpointer data)
{
...
static void async_verify_chain_thread(GTask* task, gpointer object,
                                      gpointer task_data,
                                      GCancellable* cancellable)
{
    ...
    verify_result = g_tls_database_verify_chain(
        G_TLS_DATABASE(object), args->chain, args->purpose, args->identity,
        args->interaction, args->flags, cancellable, &error);
    if (error)
...
static void g_tls_database_real_verify_chain_async(
    GTlsDatabase* self, GTlsCertificate* chain, const gchar* purpose,
    GSocketConnectable* identity, GTlsInteraction* interaction,
    GTlsDatabaseVerifyFlags flags, GCancellable* cancellable,
...
static GTlsCertificateFlags g_tls_database_real_verify_chain_finish(
...
static void async_lookup_certificate_for_handle_free(gpointer data)
{
...
static void async_lookup_certificate_for_handle_thread(
    GTask* task, gpointer object, gpointer task_data, GCancellable* cancellable)
{
    AsyncLookupCertificateForHandle* args = task_data;
    GTlsCertificate* result;
    GError* error = NULL;

    result = g_tls_database_lookup_certificate_for_handle(
        G_TLS_DATABASE(object), args->handle, args->interaction, args->flags,
        cancellable, &error);
    if (result)
...
static void g_tls_database_real_lookup_certificate_for_handle_async(
    ...
    GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    g_task_set_source_tag(
        task, g_tls_database_real_lookup_certificate_for_handle_async);
...
static void async_lookup_certificate_issuer_free(gpointer data)
{
...
static void async_lookup_certificate_issuer_thread(GTask* task, gpointer object,
                                                   gpointer task_data,
                                                   GCancellable* cancellable)
{
    ...
    issuer = g_tls_database_lookup_certificate_issuer(
        G_TLS_DATABASE(object), args->certificate, args->interaction,
        args->flags, cancellable, &error);
    if (issuer)
...
static void g_tls_database_real_lookup_certificate_issuer_async(
...
static GTlsCertificate* g_tls_database_real_lookup_certificate_issuer_finish(
    GTlsDatabase* self, GAsyncResult* result, GError** error)
{
    g_return_val_if_fail(g_task_is_valid(result, self), NULL);
...
static void async_lookup_certificates_issued_by_free(gpointer data)
{
...
static void async_lookup_certificates_free_certificates(gpointer data)
{
    GList* list = data;
...
static void async_lookup_certificates_issued_by_thread(
    GTask* task, gpointer object, gpointer task_data, GCancellable* cancellable)
{
    ...
    results = g_tls_database_lookup_certificates_issued_by(
        G_TLS_DATABASE(object), args->issuer, args->interaction, args->flags,
        cancellable, &error);
    if (results)
...
static void g_tls_database_real_lookup_certificates_issued_by_async(
    GTlsDatabase* self, GByteArray* issuer, GTlsInteraction* interaction,
    GTlsDatabaseLookupFlags flags, GCancellable* cancellable,
    GAsyncReadyCallback callback, gpointer user_data)
{
    GTask* task;
    ...
    task = g_task_new(self, cancellable, callback, user_data);
    g_task_set_source_tag(
        task, g_tls_database_real_lookup_certificates_issued_by_async);
...
static void g_tls_database_class_init(GTlsDatabaseClass* klass)
{
 ...
 * certificate in the chain by its #GTlsCertificate:issuer property. The chain
 * may initially consist of one or more certificates. After the verification
 * process is complete, @chain may be modified by adding missing certificates,
 * or removing extra certificates. If a certificate anchor was found, then it is
 * added to the @chain.
 *
 * @purpose describes the purpose (or usage) for which the certificate
 * is being used. Typically @purpose will be set to
...
GTlsCertificateFlags g_tls_database_verify_chain(
    GTlsDatabase* self, GTlsCertificate* chain, const gchar* purpose,
    GSocketConnectable* identity, GTlsInteraction* interaction,
    GTlsDatabaseVerifyFlags flags, GCancellable* cancellable, GError** error)
{
    ...
    return G_TLS_DATABASE_GET_CLASS(self)->verify_chain(
    ...
    GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    G_TLS_DATABASE_GET_CLASS(self)->verify_chain_async(
        self, chain, purpose, identity, interaction, flags, cancellable,
        callback, user_data);
}
                                                        ...
                                                        GError** error)
{
    ...
    g_return_val_if_fail(G_TLS_DATABASE_GET_CLASS(self)->verify_chain_finish,
                         G_TLS_CERTIFICATE_GENERIC_ERROR);
    return G_TLS_DATABASE_GET_CLASS(self)->verify_chain_finish(self, result,
                                                               error);
}
                                                ...
                                                GTlsCertificate* certificate)
{
    ...
    g_return_val_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->create_certificate_handle, NULL);
    return G_TLS_DATABASE_GET_CLASS(self)->create_certificate_handle(
        self, certificate);
}
    ...
    GTlsDatabaseLookupFlags flags, GCancellable* cancellable, GError** error)
{
    ...
    g_return_val_if_fail(
        interaction == NULL || G_IS_TLS_INTERACTION(interaction), NULL);
    g_return_val_if_fail(cancellable == NULL || G_IS_CANCELLABLE(cancellable),
                         NULL);
    g_return_val_if_fail(error == NULL || *error == NULL, NULL);
    g_return_val_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_for_handle, NULL);
    return G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_for_handle(
    ...
    GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    g_return_if_fail(cancellable == NULL || G_IS_CANCELLABLE(cancellable));
    g_return_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_for_handle_async);
    G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_for_handle_async(
        self, handle, interaction, flags, cancellable, callback, user_data);
}
    ...
    GTlsDatabase* self, GAsyncResult* result, GError** error)
{
    ...
    g_return_val_if_fail(error == NULL || *error == NULL, NULL);
    g_return_val_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_for_handle_finish,
        NULL);
    return G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_for_handle_finish(
        self, result, error);
}
    ...
    GCancellable* cancellable, GError** error)
{
    ...
    g_return_val_if_fail(error == NULL || *error == NULL, NULL);
    g_return_val_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_issuer, NULL);
    return G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_issuer(
    ...
    GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    g_return_if_fail(callback != NULL);
    g_return_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_issuer_async);
    G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_issuer_async(
        self, certificate, interaction, flags, cancellable, callback,
        user_data);
}
    ...
    GTlsDatabase* self, GAsyncResult* result, GError** error)
{
    ...
    g_return_val_if_fail(error == NULL || *error == NULL, NULL);
    g_return_val_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_issuer_finish, NULL);
    return G_TLS_DATABASE_GET_CLASS(self)->lookup_certificate_issuer_finish(
        self, result, error);
}
 ...
 * operation asynchronously.
 *
 * Returns: (transfer full) (element-type GTlsCertificate): a newly allocated
 * list of #GTlsCertificate objects. Use g_object_unref() on each certificate,
 * and g_list_free() on the release the list.
 *
 * Since: 2.30
 */
    ...
    GTlsDatabaseLookupFlags flags, GCancellable* cancellable, GError** error)
{
    ...
    g_return_val_if_fail(error == NULL || *error == NULL, NULL);
    g_return_val_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificates_issued_by, NULL);
    return G_TLS_DATABASE_GET_CLASS(self)->lookup_certificates_issued_by(
        self, issuer_raw_dn, interaction, flags, cancellable, error);
}
    ...
    GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    g_return_if_fail(callback != NULL);
    g_return_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificates_issued_by_async);
    G_TLS_DATABASE_GET_CLASS(self)->lookup_certificates_issued_by_async(
        self, issuer_raw_dn, interaction, flags, cancellable, callback,
        user_data);
}
                                                           ...
                                                           GError** error)
{
    ...
    g_return_val_if_fail(error == NULL || *error == NULL, NULL);
    g_return_val_if_fail(
        G_TLS_DATABASE_GET_CLASS(self)->lookup_certificates_issued_by_finish,
        NULL);
    return G_TLS_DATABASE_GET_CLASS(self)->lookup_certificates_issued_by_finish(
        self, result, error);
}
