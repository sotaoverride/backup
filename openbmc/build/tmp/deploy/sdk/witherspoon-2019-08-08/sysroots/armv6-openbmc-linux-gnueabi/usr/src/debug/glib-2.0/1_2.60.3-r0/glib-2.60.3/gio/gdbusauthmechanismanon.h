...
#define G_DBUS_AUTH_MECHANISM_ANON(o)                                          \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_AUTH_MECHANISM_ANON,          \
                                GDBusAuthMechanismAnon))
#define G_DBUS_AUTH_MECHANISM_ANON_CLASS(k)                                    \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_DBUS_AUTH_MECHANISM_ANON,             \
                             GDBusAuthMechanismAnonClass))
#define G_DBUS_AUTH_MECHANISM_ANON_GET_CLASS(o)                                \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DBUS_AUTH_MECHANISM_ANON,           \
                               GDBusAuthMechanismAnonClass))
#define G_IS_DBUS_AUTH_MECHANISM_ANON(o)                                       \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_AUTH_MECHANISM_ANON))
#define G_IS_DBUS_AUTH_MECHANISM_ANON_CLASS(k)                                 \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_DBUS_AUTH_MECHANISM_ANON))
