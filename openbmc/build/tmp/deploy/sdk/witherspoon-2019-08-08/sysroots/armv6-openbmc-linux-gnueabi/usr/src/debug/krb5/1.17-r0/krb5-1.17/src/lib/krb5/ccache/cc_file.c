...
/*
 * Copyright 1990,1991,1992,1993,1994,2000,2004,2007 Massachusetts Institute of
...
static krb5_error_code set_errmsg_filename(krb5_context context,
                                           krb5_error_code ret,
                                           const char* fname)
{
    if (!ret)
...
static krb5_error_code get_size(krb5_context context, FILE* fp,
                                size_t* size_out)
{
    struct stat sb;
...
static krb5_error_code read_bytes(krb5_context context, FILE* fp, void* buf,
                                  size_t len)
{
    size_t nread;
...
static krb5_error_code read32(krb5_context context, FILE* fp, int version,
                              struct k5buf* buf, uint32_t* out)
{
    krb5_error_code ret;
    char bytes[4];
...
static krb5_error_code read16(krb5_context context, FILE* fp, int version,
                              uint16_t* out)
{
    krb5_error_code ret;
    char bytes[2];
...
static krb5_error_code load_bytes(krb5_context context, FILE* fp, size_t len,
                                  struct k5buf* buf)
{
    void* ptr;
 ...
 * than maxsize bytes. */
static krb5_error_code load_data(krb5_context context, FILE* fp, int version,
                                 size_t maxsize, struct k5buf* buf)
{
    krb5_error_code ret;
    uint32_t count;
 ...
 * unmarshalling it. */
static krb5_error_code load_principal(krb5_context context, FILE* fp,
                                      int version, size_t maxsize,
                                      struct k5buf* buf)
{
    krb5_error_code ret;
    uint32_t count;
 ...
 * unmarshalling it. */
static krb5_error_code load_cred(krb5_context context, FILE* fp, int version,
                                 size_t maxsize, struct k5buf* buf)
{
    krb5_error_code ret;
    uint32_t count, i;
...
static krb5_error_code read_principal(krb5_context context, FILE* fp,
                                      int version, krb5_principal* princ)
{
    krb5_error_code ret;
    struct k5buf buf;
    size_t maxsize;
 ...
 */
static krb5_error_code open_cache_file(krb5_context context,
                                       const char* filename,
...
static krb5_error_code close_cache_file(krb5_context context, FILE* fp)
{
    int st;
    krb5_error_code ret;
...
static krb5_error_code read_header(krb5_context context, FILE* fp,
                                   int* version_out)
{
    krb5_error_code ret;
...
static krb5_error_code KRB5_CALLCONV fcc_initialize(krb5_context context,
                                                    krb5_ccache id,
...
static void free_fccdata(krb5_context context, fcc_data* data)
{
...
static krb5_error_code KRB5_CALLCONV fcc_close(krb5_context context,
                                               krb5_ccache id)
{
...
static krb5_error_code KRB5_CALLCONV fcc_destroy(krb5_context context,
                                                 krb5_ccache id)
{
...
static krb5_error_code KRB5_CALLCONV fcc_resolve(krb5_context context,
                                                 krb5_ccache* id,
                                                 const char* residual)
{
    krb5_ccache lid;
...
static krb5_error_code KRB5_CALLCONV fcc_start_seq_get(krb5_context context,
                                                       krb5_ccache id,
...
static krb5_error_code KRB5_CALLCONV fcc_next_cred(krb5_context context,
                                                   krb5_ccache id,
                                                   krb5_cc_cursor* cursor,
                                                   krb5_creds* creds)
{
...
static krb5_error_code KRB5_CALLCONV fcc_end_seq_get(krb5_context context,
                                                     krb5_ccache id,
                                                     krb5_cc_cursor* cursor)
{
    krb5_fcc_cursor* fcursor = *cursor;
 ...
 */
static krb5_error_code KRB5_CALLCONV fcc_generate_new(krb5_context context,
                                                      krb5_ccache* id)
{
...
static const char* KRB5_CALLCONV fcc_get_name(krb5_context context,
                                              krb5_ccache id)
{
...
static krb5_error_code KRB5_CALLCONV fcc_get_principal(krb5_context context,
                                                       krb5_ccache id,
                                                       krb5_principal* princ)
{
    krb5_error_code ret;
...
static krb5_error_code KRB5_CALLCONV fcc_retrieve(krb5_context context,
                                                  krb5_ccache id,
...
static krb5_error_code KRB5_CALLCONV fcc_store(krb5_context context,
                                               krb5_ccache id,
                                               krb5_creds* creds)
{
...
static krb5_error_code KRB5_CALLCONV fcc_remove_cred(krb5_context context,
                                                     krb5_ccache cache,
                                                     krb5_flags flags,
                                                     krb5_creds* creds)
{
...
static krb5_error_code KRB5_CALLCONV fcc_set_flags(krb5_context context,
                                                   krb5_ccache id,
                                                   krb5_flags flags)
{
    return 0;
...
static krb5_error_code KRB5_CALLCONV fcc_get_flags(krb5_context context,
                                                   krb5_ccache id,
                                                   krb5_flags* flags)
{
    *flags = 0;
...
static krb5_error_code KRB5_CALLCONV fcc_ptcursor_new(krb5_context context,
...
static krb5_error_code KRB5_CALLCONV fcc_ptcursor_next(krb5_context context,
                                                       krb5_cc_ptcursor cursor,
...
static krb5_error_code KRB5_CALLCONV fcc_ptcursor_free(krb5_context context,
                                                       krb5_cc_ptcursor* cursor)
{
    if (*cursor == NULL)
        return 0;
...
static krb5_error_code KRB5_CALLCONV fcc_last_change_time(
...
static krb5_error_code KRB5_CALLCONV fcc_lock(krb5_context context,
                                              krb5_ccache id)
{
    fcc_data* data = id->data;
    k5_cc_mutex_lock(context, &data->lock);
...
static krb5_error_code KRB5_CALLCONV fcc_unlock(krb5_context context,
                                                krb5_ccache id)
{
    fcc_data* data = id->data;
    k5_cc_mutex_unlock(context, &data->lock);
...
static krb5_error_code interpret_errno(krb5_context context, int errnum)
{
    krb5_error_code ret;
