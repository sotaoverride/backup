...
static int ipv4ll_address_lost(Link* link)
{
    ...
    log_link_debug(link, "IPv4 link-local release %u.%u.%u.%u",
...
static int ipv4ll_route_handler(sd_netlink* rtnl, sd_netlink_message* m,
                                Link* link)
{
    int r;
...
static int ipv4ll_address_handler(sd_netlink* rtnl, sd_netlink_message* m,
                                  Link* link)
{
    int r;
...
static int ipv4ll_address_claimed(sd_ipv4ll* ll, Link* link)
{
    ...
    ll_addr->broadcast.s_addr = ll_addr->in_addr.in.s_addr |
                                htobe32(0xfffffffflu >> ll_addr->prefixlen);
