...
G_DEFINE_INTERFACE_WITH_CODE(
    GNetworkMonitor, g_network_monitor, G_TYPE_OBJECT,
...
static void g_network_monitor_real_can_reach_async(
                                       ...
                                       gpointer user_data)
{
    ...
    iface = G_NETWORK_MONITOR_GET_INTERFACE(monitor);
    iface->can_reach_async(monitor, connectable, cancellable, callback,
                           user_data);
}

static gboolean g_network_monitor_real_can_reach_finish(
...
static void g_network_monitor_default_init(GNetworkMonitorInterface* iface)
{
     ...
     * Since: 2.32
     */
    signals[NETWORK_CHANGED] = g_signal_new(
        I_("network-changed"), G_TYPE_NETWORK_MONITOR, G_SIGNAL_RUN_LAST,
        G_STRUCT_OFFSET(GNetworkMonitorInterface, network_changed), NULL, NULL,
    ...
    g_object_interface_install_property(
        iface,
        g_param_spec_boolean("network-available", P_("Network available"),
                             P_("Whether the network is available"), FALSE,
     ...
     */
    g_object_interface_install_property(
        iface, g_param_spec_boolean("network-metered", P_("Network metered"),
                                    P_("Whether the network is metered"), FALSE,
                                    G_PARAM_READABLE | G_PARAM_STATIC_STRINGS));
     ...
     */
    g_object_interface_install_property(
        iface, g_param_spec_enum("connectivity", P_("Network connectivity"),
