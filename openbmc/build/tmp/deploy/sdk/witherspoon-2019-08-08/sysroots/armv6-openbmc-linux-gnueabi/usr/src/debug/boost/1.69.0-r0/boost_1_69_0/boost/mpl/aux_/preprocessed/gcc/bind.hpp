...
template <int N, typename U1, typename U2, typename U3, typename U4,
          typename U5>
...
struct bind0
{
    template <typename U1 = na, typename U2 = na, typename U3 = na,
...
template <typename F, typename U1, typename U2, typename U3, typename U4,
          typename U5>
...
struct bind2
{
    ...
    struct apply
    {
      ...
      public:
        typedef
            typename apply_wrap2<f_, typename t1::type, typename t2::type>::type
                type;
    };
};
...
template <typename F, typename T1, typename T2, typename U1, typename U2,
...
struct bind3
{
    ...
    struct apply
    {
      private:
        ...
        ///
      public:
        typedef typename apply_wrap3<f_, typename t1::type, typename t2::type,
                                     typename t3::type>::type type;
    };
};
...
template <typename F, typename T1, typename T2, typename T3, typename U1,
...
struct bind4
{
    ...
    struct apply
    {
      private:
        ...
        ///
      public:
        typedef typename apply_wrap4<f_, typename t1::type, typename t2::type,
                                     typename t3::type, typename t4::type>::type
            type;
    };
};
...
struct bind5
{
    ...
    struct apply
    {
      private:
        ...
        ///
      public:
        typedef typename apply_wrap5<f_, typename t1::type, typename t2::type,
                                     typename t3::type, typename t4::type,
...
template <template <typename T1, typename T2, typename T3> class F,
          typename Tag>
struct quote3;
