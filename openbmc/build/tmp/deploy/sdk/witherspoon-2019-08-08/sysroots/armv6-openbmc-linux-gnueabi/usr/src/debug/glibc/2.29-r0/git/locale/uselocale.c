...
#define DEFINE_CATEGORY(category, category_name, items, a)                     \
    {                                                                          \
        ...
        weak_extern(_nl_current_##category##_used) weak_extern(                \
            _nl_current_##category) if (&_nl_current_##category##_used != 0)   \
...
libc_hidden_def(__uselocale) weak_alias(__uselocale, uselocale)
