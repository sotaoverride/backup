...
struct as_directive : unary_parser<as_directive<Subject, T>>
{
    ...
    as_directive(Subject const& subject_) : subject(subject_)
    {
    }
...
///////////////////////////////////////////////////////////////////////////
template <typename Subject, typename T, typename Attribute, typename Context,
          typename Iterator>
struct handles_container<qi::as_directive<Subject, T>, Attribute, Context,
                         Iterator> : mpl::false_
{
};
} // namespace traits
