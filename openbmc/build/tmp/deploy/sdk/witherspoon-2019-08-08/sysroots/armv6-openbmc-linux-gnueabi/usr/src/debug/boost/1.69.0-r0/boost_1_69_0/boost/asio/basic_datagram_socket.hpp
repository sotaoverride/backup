...
class basic_datagram_socket : public basic_socket<Protocol BOOST_ASIO_SVC_TARG>
{
  public:
...
#else
    typedef
        typename basic_socket<Protocol BOOST_ASIO_SVC_TARG>::native_handle_type
            native_handle_type;
#endif
    ...
    typename enable_if<is_convertible<Protocol1, Protocol>::value,
        ...
        operator=(basic_datagram_socket<Protocol1 BOOST_ASIO_SVC_TARG1>&& other)
    {
        basic_socket<Protocol BOOST_ASIO_SVC_TARG>::operator=(std::move(other));
        return *this;
    }
    ...
    std::size_t send(const ConstBufferSequence& buffers)
    {
        ...
        std::size_t s = this->get_service().send(this->get_implementation(),
                                                 buffers, 0, ec);
    ...
    std::size_t send(const ConstBufferSequence& buffers,
                     ...
                     boost::system::error_code& ec)
    {
        return this->get_service().send(this->get_implementation(), buffers,
                                        flags, ec);
    }
               ...
               BOOST_ASIO_MOVE_ARG(WriteHandler) handler)
    {
        ...
        this->get_service().async_send(this->get_implementation(), buffers,
                                       flags, init.completion_handler);
    ...
    std::size_t send_to(const ConstBufferSequence& buffers,
                        ...
                        boost::system::error_code& ec)
    {
        return this->get_service().send_to(this->get_implementation(), buffers,
    ...
    std::size_t receive(const MutableBufferSequence& buffers,
                        ...
                        boost::system::error_code& ec)
    {
        return this->get_service().receive(this->get_implementation(), buffers,
                                           flags, ec);
    }
