...
//
///////////////////////////////////////////////////////////////////////////////
template <typename OperationT, typename A = nil_t, typename B = nil_t,
          typename C = nil_t

#if PHOENIX_LIMIT > 3
          ,
          typename D = nil_t, typename E = nil_t, typename F = nil_t

#if PHOENIX_LIMIT > 6
          ,
          typename G = nil_t, typename H = nil_t, typename I = nil_t

#if PHOENIX_LIMIT > 9
          ,
          typename J = nil_t, typename K = nil_t, typename L = nil_t

#if PHOENIX_LIMIT > 12
          ,
          typename M = nil_t, typename N = nil_t, typename O = nil_t
...
struct composite<OperationT, nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    composite(OperationT const& op_) : op(op_)
    {
    }
...
struct composite1_result
{
    ...
    typedef typename OperationT::template result<
        typename actor_result<A, TupleT>::plain_type>::type type;
};

//////////////////////////////////
template <typename OperationT, typename A>
struct composite<OperationT, A, nil_t, nil_t,
#if PHOENIX_LIMIT > 3
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    composite(OperationT const& op_, A const& a_) : op(op_), a(a_)
    {
    }
...
struct composite<OperationT, A, B, nil_t,
#if PHOENIX_LIMIT > 3
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                 nil_t, nil_t, nil_t,
...
struct composite<OperationT, A, B, C,
#if PHOENIX_LIMIT > 3
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    struct result
    {
        ...
        typedef
            typename composite3_result<OperationT, TupleT, A, B, C>::type type;
    };
...
struct composite<OperationT, A, B, C, D, nil_t, nil_t,
#if PHOENIX_LIMIT > 6
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    struct result
    {
        ...
        typedef typename composite4_result<OperationT, TupleT, A, B, C, D>::type
            type;
    };
...
template <typename OperationT, typename A, typename B, typename C, typename D,
          typename E>
struct composite<OperationT, A, B, C, D, E, nil_t,
#if PHOENIX_LIMIT > 6
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    struct result
    {
        ...
        typedef
            typename composite5_result<OperationT, TupleT, A, B, C, D, E>::type
                type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_) :
        op(op_),
...
///////////////////////////////////////////////////////////////////////////////
template <typename OperationT, typename TupleT, typename A, typename B,
          typename C, typename D, typename E, typename F>
...
struct composite<OperationT, A, B, C, D, E, F,
#if PHOENIX_LIMIT > 6
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    struct result
    {
        ...
        typedef typename composite6_result<OperationT, TupleT, A, B, C, D, E,
                                           F>::type type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_, F const& f_) :
        op(op_),
...
///////////////////////////////////////////////////////////////////////////////
template <typename OperationT, typename TupleT, typename A, typename B,
          typename C, typename D, typename E, typename F, typename G>
...
struct composite<OperationT, A, B, C, D, E, F, G, nil_t, nil_t,
#if PHOENIX_LIMIT > 9
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    struct result
    {
        ...
        typedef typename composite7_result<OperationT, TupleT, A, B, C, D, E, F,
                                           G>::type type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_, F const& f_, G const& g_) :
        op(op_),
...
struct composite<OperationT, A, B, C, D, E, F, G, H, nil_t,
#if PHOENIX_LIMIT > 9
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    struct result
    {
        ...
        typedef typename composite8_result<OperationT, TupleT, A, B, C, D, E, F,
                                           G, H>::type type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_, F const& f_, G const& g_, H const& h_) :
        op(op_),
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I,
#if PHOENIX_LIMIT > 9
                 nil_t, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                 nil_t, nil_t, nil_t,
                 ...
                 >
{
    ...
    struct result
    {
        ...
        typedef typename composite9_result<OperationT, TupleT, A, B, C, D, E, F,
                                           G, H, I>::type type;
    };
...
template <typename OperationT, typename TupleT, typename A, typename B,
          typename C, typename D, typename E, typename F, typename G,
          typename H, typename I, typename J>
...
template <typename OperationT, typename A, typename B, typename C, typename D,
          typename E, typename F, typename G, typename H, typename I,
          typename J>
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, nil_t, nil_t,
#if PHOENIX_LIMIT > 12
                 nil_t, nil_t, nil_t,
#endif
                 nil_t //  Unused
                 >
{
    ...
    struct result
    {
        ...
        typedef typename composite10_result<OperationT, TupleT, A, B, C, D, E,
                                            F, G, H, I, J>::type type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_, F const& f_, G const& g_, H const& h_,
              I const& i_, J const& j_) :
        op(op_),
...
template <typename OperationT, typename TupleT, typename A, typename B,
          typename C, typename D, typename E, typename F, typename G,
          typename H, typename I, typename J, typename K>
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, nil_t,
#if PHOENIX_LIMIT > 12
                 nil_t, nil_t, nil_t,
#endif
                 nil_t //  Unused
                 >
{
    ...
    struct result
    {
        ...
        typedef typename composite11_result<OperationT, TupleT, A, B, C, D, E,
                                            F, G, H, I, J, K>::type type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_, F const& f_, G const& g_, H const& h_,
              I const& i_, J const& j_, K const& k_) :
        op(op_),
        a(a_), b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_), i(i_), j(j_),
        k(k_)
    {
...
template <typename OperationT, typename TupleT, typename A, typename B,
          typename C, typename D, typename E, typename F, typename G,
          typename H, typename I, typename J, typename K, typename L>
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L,
#if PHOENIX_LIMIT > 12
                 nil_t, nil_t, nil_t,
#endif
                 nil_t //  Unused
                 >
{
    ...
    struct result
    {
        ...
        typedef typename composite12_result<OperationT, TupleT, A, B, C, D, E,
                                            F, G, H, I, J, K, L>::type type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_, F const& f_, G const& g_, H const& h_,
              I const& i_, J const& j_, K const& k_, L const& l_) :
        op(op_),
        a(a_), b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_), i(i_), j(j_),
        k(k_), l(l_)
    {
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, nil_t,
                 nil_t, nil_t>
{
    ...
    struct result
    {
        ...
        typedef typename composite13_result<OperationT, TupleT, A, B, C, D, E,
                                            F, G, H, I, J, K, L, M>::type type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_, F const& f_, G const& g_, H const& h_,
              I const& i_, J const& j_, K const& k_, L const& l_, M const& m_) :
        op(op_),
        a(a_), b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_), i(i_), j(j_),
        k(k_), l(l_), m(m_)
    {
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, nil_t,
                 nil_t>
{

    typedef composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N>
        self_t;
    ...
    struct result
    {
        ...
        typedef
            typename composite14_result<OperationT, TupleT, A, B, C, D, E, F, G,
                                        H, I, J, K, L, M, N>::type type;
    };
...
struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, nil_t>
{
    ...
    typedef composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>
        self_t;
    ...
    struct result
    {
        ...
        typedef
            typename composite15_result<OperationT, TupleT, A, B, C, D, E, F, G,
                                        H, I, J, K, L, M, N, O>::type type;
    };

    composite(OperationT const& op_, A const& a_, B const& b_, C const& c_,
              D const& d_, E const& e_, F const& f_, G const& g_, H const& h_,
              I const& i_, J const& j_, K const& k_, L const& l_, M const& m_,
              N const& n_, O const& o_) :
        op(op_),
        a(a_), b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_), i(i_), j(j_),
...
struct make_composite
{
    ...
    typedef composite<OperationT, typename as_actor<A>::type,
                      typename as_actor<B>::type, typename as_actor<C>::type

#if PHOENIX_LIMIT > 3
                      ,
                      typename as_actor<D>::type, typename as_actor<E>::type,
                      typename as_actor<F>::type

#if PHOENIX_LIMIT > 6
                      ,
                      typename as_actor<G>::type, typename as_actor<H>::type,
                      typename as_actor<I>::type

#if PHOENIX_LIMIT > 9
                      ,
                      typename as_actor<J>::type, typename as_actor<K>::type,
                      typename as_actor<L>::type

#if PHOENIX_LIMIT > 12
                      ,
                      typename as_actor<M>::type, typename as_actor<N>::type,
...
struct make_unary
{
    ...
    {
        typedef
            typename make_composite<OperationT, actor<BaseT>>::composite_type
                ret_t;
...
struct make_binary1
{
    ...
    {
        typedef
            typename make_composite<OperationT, actor<BaseT>, B>::composite_type
                ret_t;
...
struct make_binary2
{
    ...
    {
        typedef
            typename make_composite<OperationT, A, actor<BaseT>>::composite_type
                ret_t;
...
struct make_binary3
{
    ...
    typedef
        typename make_composite<OperationT, actor<BaseA>, actor<BaseB>>::type
            type;

    static type construct(actor<BaseA> const& _0_, actor<BaseB> const& _1_)
    {
        typedef typename make_composite<OperationT, actor<BaseA>,
                                        actor<BaseB>>::composite_type ret_t;
