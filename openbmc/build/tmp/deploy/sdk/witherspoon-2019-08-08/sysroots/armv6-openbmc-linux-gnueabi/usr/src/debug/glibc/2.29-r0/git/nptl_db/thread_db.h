...
extern td_err_e td_ta_event_addr(const td_thragent_t* __ta, td_event_e __event,
                                 td_notify_t* __ptr);
...
extern td_err_e td_thr_setxregs(const td_thrhandle_t* __th, const void* __addr);
...
extern td_err_e td_thr_tsd(const td_thrhandle_t* __th, const thread_key_t __tk,
                           void** __data);
