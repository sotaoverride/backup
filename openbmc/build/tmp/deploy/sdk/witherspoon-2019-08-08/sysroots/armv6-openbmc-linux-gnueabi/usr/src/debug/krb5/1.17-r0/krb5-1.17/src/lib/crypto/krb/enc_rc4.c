...
krb5_keyusage krb5int_arcfour_translate_usage(krb5_keyusage usage)
{
    ...
    {
        case 1:
            return 1; /* AS-REQ PA-ENC-TIMESTAMP padata timestamp,  */
        case 2:
            return 2; /* ticket from kdc */
        case 3:
            return 8; /* as-rep encrypted part */
        case 4:
            return 4; /* tgs-req authz data */
        case 5:
            return 5; /* tgs-req authz data in subkey */
        case 6:
            return 6; /* tgs-req authenticator cksum */
        case 7:
            return 7; /* tgs-req authenticator */
        case 8:
            return 8;
        case 9:
            return 9; /* tgs-rep encrypted with subkey */
        case 10:
            return 10; /* ap-rep authentication cksum (never used by MS) */
        case 11:
            return 11; /* app-req authenticator */
        case 12:
            return 12; /* app-rep encrypted part */
        case 23:
            return 13; /* sign wrap token*/
        default:
            return usage;
    }
}
...
static krb5_error_code usage_key(const struct krb5_enc_provider* enc,
                                 const struct krb5_hash_provider* hash,
                                 const krb5_keyblock* session_keyblock,
                                 krb5_keyusage usage, krb5_keyblock* out)
{
    char salt_buf[14];
...
static krb5_error_code enc_key(const struct krb5_enc_provider* enc,
                               const struct krb5_hash_provider* hash,
...
static krb5_error_code keyblock_crypt(const struct krb5_enc_provider* enc,
                                        ...
                                        krb5_crypto_iov* data, size_t num_data)
{
    ...
    header->data.length = hash->hashsize + CONFOUNDERLENGTH;
    confounder =
        make_data(header->data.data + hash->hashsize, CONFOUNDERLENGTH);
