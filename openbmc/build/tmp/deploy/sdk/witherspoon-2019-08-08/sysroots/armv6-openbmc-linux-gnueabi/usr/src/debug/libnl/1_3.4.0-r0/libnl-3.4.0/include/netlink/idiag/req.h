...
extern void idiagnl_req_set_family(struct idiagnl_req*, uint8_t);
...
extern void idiagnl_req_set_ifindex(struct idiagnl_req*, uint32_t);
extern uint32_t idiagnl_req_get_states(const struct idiagnl_req*);
extern void idiagnl_req_set_states(struct idiagnl_req*, uint32_t);
...
extern int idiagnl_req_set_src(struct idiagnl_req*, struct nl_addr*);
extern struct nl_addr* idiagnl_req_get_dst(const struct idiagnl_req*);
extern int idiagnl_req_set_dst(struct idiagnl_req*, struct nl_addr*);

extern int idiagnl_req_parse(struct nlmsghdr* nlh, struct idiagnl_req** result);
