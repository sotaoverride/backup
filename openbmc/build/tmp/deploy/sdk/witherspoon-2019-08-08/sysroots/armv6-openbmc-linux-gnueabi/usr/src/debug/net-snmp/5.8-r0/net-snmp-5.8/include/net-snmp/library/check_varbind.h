...
int netsnmp_check_vb_range(const netsnmp_variable_list* var, size_t low,
                           size_t high);
int netsnmp_check_vb_size_range(const netsnmp_variable_list* var, size_t low,
                                size_t high);

NETSNMP_IMPORT
int netsnmp_check_vb_type_and_size(const netsnmp_variable_list* var, int type,
                                   size_t size);
NETSNMP_IMPORT
...
int netsnmp_check_vb_rowstatus_with_storagetype(
    const netsnmp_variable_list* var, int old_val, int old_storage);
