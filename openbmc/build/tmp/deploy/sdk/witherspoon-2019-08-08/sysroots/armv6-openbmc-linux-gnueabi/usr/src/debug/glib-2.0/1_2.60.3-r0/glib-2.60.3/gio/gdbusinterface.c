...
static void g_dbus_interface_default_init(GDBusInterfaceIface* iface)
{
}
...
GDBusObject* g_dbus_interface_dup_object(GDBusInterface* interface_)
{
    ...
    {
        g_warning("No dup_object() vfunc on type %s - using get_object() in a "
                  "way that is not thread-safe.",
