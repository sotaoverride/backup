...
#define G_DBUS_MENU_MODEL(inst)                                                \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_DBUS_MENU_MODEL, GDBusMenuModel))
#define G_IS_DBUS_MENU_MODEL(inst)                                             \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_DBUS_MENU_MODEL))
