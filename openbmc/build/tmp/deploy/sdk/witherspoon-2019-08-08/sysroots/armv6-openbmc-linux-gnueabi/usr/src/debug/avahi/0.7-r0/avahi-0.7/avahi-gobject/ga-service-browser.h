...
#define GA_SERVICE_BROWSER(obj)                                                \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), GA_TYPE_SERVICE_BROWSER,                \
                                GaServiceBrowser))
#define GA_SERVICE_BROWSER_CLASS(klass)                                        \
    (G_TYPE_CHECK_CLASS_CAST((klass), GA_TYPE_SERVICE_BROWSER,                 \
...
#define GA_SERVICE_BROWSER_GET_CLASS(obj)                                      \
    (G_TYPE_INSTANCE_GET_CLASS((obj), GA_TYPE_SERVICE_BROWSER,                 \
                               GaServiceBrowserClass))
