...
//
class BOOST_SYMBOL_VISIBLE archive_exception : public virtual std::exception
{
  private:
    char m_buffer[128];
  ...
  public:
    typedef enum
    {
        ...
        array_size_too_short,       // array being loaded doesn't fit in array
                                    // allocated
        ...
        unregistered_cast,  // base - derived relationship not registered with
                            // void_cast_register
        unsupported_class_version, // type saved with a version # greater than
                                   // the one used by the program.  This
                                   // indicates that the program needs to be
                                   // rebuilt.
        multiple_code_instantiation, // code for implementing serialization for
                                     // some type has been instantiated in more
                                     // than one module.
        output_stream_error // error on input stream
    } exception_code;
    exception_code code;

    BOOST_ARCHIVE_DECL archive_exception(exception_code c,
                                         const char* e1 = NULL,
                                         const char* e2 = NULL) BOOST_NOEXCEPT;
    BOOST_ARCHIVE_DECL
    ...
    virtual BOOST_ARCHIVE_DECL const char*
