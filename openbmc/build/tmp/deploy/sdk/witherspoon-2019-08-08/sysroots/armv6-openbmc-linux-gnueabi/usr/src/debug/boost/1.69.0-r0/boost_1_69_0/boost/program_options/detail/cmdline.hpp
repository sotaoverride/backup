...
class BOOST_PROGRAM_OPTIONS_DECL cmdline
{
  public:
    ...
    */
     ...
     * command_line_style In order of precedence: allow_long           :
     * allow_long allow_long_disguise  : allow_long_disguise
    ...
    std::vector<option>
        parse_disguised_long_option(std::vector<std::string>& args);
    std::vector<option> parse_terminator(std::vector<std::string>& args);
    std::vector<option>
        handle_additional_parser(std::vector<std::string>& args);
