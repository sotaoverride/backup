 ...
 */
#define NETSNMP_FS_TYPE_IGNORE                                                 \
    (1 | _NETSNMP_FS_TYPE_LOCAL | _NETSNMP_FS_TYPE_SKIP_BIT)

#define NETSNMP_FS_TYPE_PROC                                                   \
    (2 | _NETSNMP_FS_TYPE_LOCAL | _NETSNMP_FS_TYPE_SKIP_BIT)

#define NETSNMP_FS_TYPE_DEVPTS                                                 \
    (3 | _NETSNMP_FS_TYPE_LOCAL | _NETSNMP_FS_TYPE_SKIP_BIT)
#define NETSNMP_FS_TYPE_SYSFS                                                  \
    (4 | _NETSNMP_FS_TYPE_LOCAL | _NETSNMP_FS_TYPE_SKIP_BIT)
