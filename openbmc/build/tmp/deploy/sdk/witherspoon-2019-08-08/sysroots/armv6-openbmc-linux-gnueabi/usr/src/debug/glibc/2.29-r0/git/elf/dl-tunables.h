...
#if !HAVE_TUNABLES
static inline void __always_inline __tunables_init(char** unused
...
#define TUNABLE_ENUM_NAME(__top, __ns, __id)                                   \
    TUNABLE_ENUM_NAME1(__top, __ns, __id)
...
rtld_hidden_proto(__tunables_init) rtld_hidden_proto(__tunable_get_val)
