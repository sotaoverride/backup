    ...
    : spirit::terminal<tag::stateful_tag<BoolPolicies, tag::bool_, T>>
{
    ...
    bool_parser(BoolPolicies const& data) : spirit::terminal<tag_type>(data)
    {
    }
};
} // namespace qi
...
struct use_lazy_terminal<
    qi::domain, tag::stateful_tag<BoolPolicies, tag::bool_, T>, 1 // arity
    > : mpl::true_
{
};
} // namespace spirit
...
struct bool_impl
{
    ...
    static bool parse(Iterator& first, Iterator const& last, Attribute& attr,
                      BoolPolicies const& p, bool allow_true = true,
...
struct make_primitive<terminal_ex<tag::stateful_tag<Policies, tag::bool_, T>,
                                  fusion::vector1<A0>>,
