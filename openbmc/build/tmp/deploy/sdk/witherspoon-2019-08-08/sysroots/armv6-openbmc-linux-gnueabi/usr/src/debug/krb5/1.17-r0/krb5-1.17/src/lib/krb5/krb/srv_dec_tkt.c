...
#ifndef LEAN_CLIENT
static krb5_error_code decrypt_ticket_keyblock(krb5_context context,
...
krb5_error_code KRB5_CALLCONV krb5_server_decrypt_ticket_keytab(
    krb5_context context, const krb5_keytab keytab, krb5_ticket* ticket)
{
    krb5_error_code retval;
    ...
    {
        retval = krb5_kt_get_entry(context, keytab, ticket->server,
    ...
    else
    {
        ...
        while ((code = krb5_kt_next_entry(context, keytab, &ktent, &cursor)) ==
               0)
        {
