...
static COMP_METHOD zlib_method_nozlib = {
    NID_undef, "(undef)", NULL, NULL, NULL, NULL,
};
...
#define LIBZ "z"
    ...
    if (!zlib_loaded)
    {
        ...
        if (zlib_dso != NULL)
        {
            ...
            if (p_compress && p_inflateEnd && p_inflate && p_inflateInit_ &&
                p_deflateEnd && p_deflate && p_deflateInit_ && p_zError)
                zlib_loaded++;
