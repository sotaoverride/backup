...
static int dh_param_decode(EVP_PKEY* pkey, const unsigned char** pder,
                           int derlen)
{
    DH* dh;
...
const EVP_PKEY_ASN1_METHOD dh_asn1_meth = {EVP_PKEY_DH,
                                           EVP_PKEY_DH,
                                           0,
...
const EVP_PKEY_ASN1_METHOD dhx_asn1_meth = {EVP_PKEY_DHX,
                                            EVP_PKEY_DHX,
                                            0,
