...
class Replaceable
{
  public:
    ...
    virtual bool fieldReplaceable(bool value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_FieldReplaceable(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'FieldReplaceable' */
    static int _callback_set_FieldReplaceable(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Inventory_Decorator_Replaceable_interface;
