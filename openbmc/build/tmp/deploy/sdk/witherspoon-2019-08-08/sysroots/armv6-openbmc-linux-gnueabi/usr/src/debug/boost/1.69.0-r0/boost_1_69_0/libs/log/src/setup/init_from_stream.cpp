...
//! The function initializes the logging library from a stream containing
//! logging settings
...
template BOOST_LOG_SETUP_API void
    init_from_stream<char>(std::basic_istream<char>& strm);
#endif
#ifdef BOOST_LOG_USE_WCHAR_T
template BOOST_LOG_SETUP_API void
    init_from_stream<wchar_t>(std::basic_istream<wchar_t>& strm);
#endif
