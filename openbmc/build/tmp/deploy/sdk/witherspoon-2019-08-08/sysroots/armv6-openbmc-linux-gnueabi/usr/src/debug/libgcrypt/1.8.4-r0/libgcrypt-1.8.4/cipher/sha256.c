...
/*  Test vectors:
   ...
   f20015ad
    ...
    SHA256: 248d6a61 d20638b8 e5c02693 0c3e6039 a33ce459 64ff2167 f6ecedd4
   19db06c1

    "a" one million times
    SHA224: 20794655 980c91d8 bbb4c1ea 97618a4b f03f4258 1948b2ee 4ee7ad67
    SHA256: cdc76e5c 9914fb92 81a1c7e2 84d73e67 f1809a48 a497200e 046d39cc
   c7112cd0
...
#define W(i)                                                                   \
    (w[i & 0x0f] = S1(w[(i - 2) & 0x0f]) + w[(i - 7) & 0x0f] +                 \
                   S0(w[(i - 15) & 0x0f]) + w[(i - 16) & 0x0f])
...
static void sha256_final(void* context)
{
    SHA256_CONTEXT* hd = context;
    u32 t, th, msb, lsb;
    byte* p;
...
static byte* sha256_read(void* context)
{
    SHA256_CONTEXT* hd = context;
...
static gpg_err_code_t selftests_sha224(int extended,
...
static gpg_err_code_t selftests_sha256(int extended,
                                       selftest_report_func_t report)
{
    const char* what;
    const char* errtxt;
...
gcry_md_spec_t _gcry_digest_spec_sha224 = {GCRY_MD_SHA224,
                                           {0, 1},
                                           "SHA224",
                                           asn224,
                                           DIM(asn224),
...
gcry_md_spec_t _gcry_digest_spec_sha256 = {GCRY_MD_SHA256,
                                           {0, 1},
                                           "SHA256",
                                           asn256,
                                           DIM(asn256),
