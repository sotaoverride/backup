...
#define G_NATIVE_SOCKET_ADDRESS(o)                                             \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_NATIVE_SOCKET_ADDRESS,             \
                                GNativeSocketAddress))
#define G_NATIVE_SOCKET_ADDRESS_CLASS(k)                                       \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_NATIVE_SOCKET_ADDRESS,                \
                             GNativeSocketAddressClass))
#define G_IS_NATIVE_SOCKET_ADDRESS(o)                                          \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_NATIVE_SOCKET_ADDRESS))
#define G_IS_NATIVE_SOCKET_ADDRESS_CLASS(k)                                    \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_NATIVE_SOCKET_ADDRESS))
#define G_NATIVE_SOCKET_ADDRESS_GET_CLASS(o)                                   \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_NATIVE_SOCKET_ADDRESS,              \
                               GNativeSocketAddressClass))
