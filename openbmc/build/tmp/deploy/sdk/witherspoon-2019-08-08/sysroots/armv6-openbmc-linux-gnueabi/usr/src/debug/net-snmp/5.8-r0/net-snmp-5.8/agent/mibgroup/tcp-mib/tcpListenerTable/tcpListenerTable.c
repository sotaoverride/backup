...
void initialize_table_tcpListenerTable(void)
{
    ...
    DEBUGMSGTL(("verbose:tcpListenerTable:initialize_table_tcpListenerTable",
                "called\n"));
 ...
 */
int tcpListenerTable_rowreq_ctx_init(tcpListenerTable_rowreq_ctx* rowreq_ctx,
                                     void* user_init_ctx)
{
    DEBUGMSGTL(("verbose:tcpListenerTable:tcpListenerTable_rowreq_ctx_init",
                "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:210:o: |-> Perform extra tcpListenerTable rowreq initialization. (eg
     * DEFVALS)
     */
 ...
 *
 */
void tcpListenerTable_rowreq_ctx_cleanup(
    tcpListenerTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:tcpListenerTable:tcpListenerTable_rowreq_ctx_cleanup",
                "called\n"));
...
{
    DEBUGMSGTL(
        ("verbose:tcpListenerTable:tcpListenerTable_pre_request", "called\n"));
 ...
 */
int tcpListenerTable_post_request(tcpListenerTable_registration* user_context,
                                  int rc)
{
    DEBUGMSGTL(
        ("verbose:tcpListenerTable:tcpListenerTable_post_request", "called\n"));
...
{
    DEBUGMSGTL(
        ("verbose:tcpListenerTable:tcpListenerTable_release_data", "called\n"));
 ...
 */
int tcpListenerTable_indexes_set_tbl_idx(
    tcpListenerTable_mib_index* tbl_idx, u_long tcpListenerLocalAddressType_val,
    char* tcpListenerLocalAddress_val_ptr,
    size_t tcpListenerLocalAddress_val_ptr_len, u_long tcpListenerLocalPort_val)
{
    DEBUGMSGTL(("verbose:tcpListenerTable:tcpListenerTable_indexes_set_tbl_idx",
                "called\n"));
    ...
    tbl_idx->tcpListenerLocalAddress_len =
        ...
        sizeof(tbl_idx->tcpListenerLocalAddress[0]); /* max length */
    /** WARNING: this code might not work for netsnmp_tcpconn_entry */
    /*
    ...
    memcpy(tbl_idx->tcpListenerLocalAddress, tcpListenerLocalAddress_val_ptr,
           tcpListenerLocalAddress_val_ptr_len *
 ...
 *  from the mib index.
 */
int tcpListenerTable_indexes_set(tcpListenerTable_rowreq_ctx* rowreq_ctx,
...
{
    DEBUGMSGTL(
        ("verbose:tcpListenerTable:tcpListenerTable_indexes_set", "called\n"));

    if (MFD_SUCCESS !=
        tcpListenerTable_indexes_set_tbl_idx(
            &rowreq_ctx->tbl_idx, tcpListenerLocalAddressType_val,
 ...
 */
int tcpListenerProcess_get(tcpListenerTable_rowreq_ctx* rowreq_ctx,
