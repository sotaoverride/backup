...
#define ext2fs_rb_set_red(r)                                                   \
    do                                                                         \
    {                                                                          \
        (r)->rb_parent_color &= ~1;                                            \
    } while (0)
#define ext2fs_rb_set_black(r)                                                 \
    do                                                                         \
    {                                                                          \
        (r)->rb_parent_color |= 1;                                             \
    } while (0)
...
extern void ext2fs_rb_augment_insert(struct rb_node* node, rb_augment_f func,
                                     void* data);
extern struct rb_node* ext2fs_rb_augment_erase_begin(struct rb_node* node);
extern void ext2fs_rb_augment_erase_end(struct rb_node* node, rb_augment_f func,
                                        void* data);
