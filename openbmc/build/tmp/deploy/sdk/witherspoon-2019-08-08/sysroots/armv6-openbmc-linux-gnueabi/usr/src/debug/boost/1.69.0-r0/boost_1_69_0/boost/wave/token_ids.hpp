...
enum token_id
{
    ...
    T_AND_ALT =
        TOKEN_FROM_ID(T_FIRST_TOKEN, OperatorTokenType | AltExtTokenType),
    ...
    T_ORASSIGN_TRIGRAPH =
        TOKEN_FROM_ID(261, OperatorTokenType | TriGraphTokenType),
    ...
    T_XORASSIGN_TRIGRAPH =
        TOKEN_FROM_ID(263, OperatorTokenType | TriGraphTokenType),
    ...
    T_LEFTBRACE_TRIGRAPH =
        TOKEN_FROM_ID(274, OperatorTokenType | TriGraphTokenType),
    ...
    T_LEFTBRACKET_TRIGRAPH =
        TOKEN_FROM_ID(278, OperatorTokenType | TriGraphTokenType),
    ...
    T_RIGHTBRACE_TRIGRAPH =
        TOKEN_FROM_ID(293, OperatorTokenType | TriGraphTokenType),
    ...
    T_RIGHTBRACKET_TRIGRAPH =
        TOKEN_FROM_ID(295, OperatorTokenType | TriGraphTokenType),
    ...
    T_COMPL_TRIGRAPH =
        TOKEN_FROM_ID(303, OperatorTokenType | TriGraphTokenType),
    ...
    T_FIXEDPOINTLIT = TOKEN_FROM_ID(386, FloatingLiteralTokenType |
                                             AltTokenType), // IDL specific
    ...
    T_POUND_POUND_TRIGRAPH =
        TOKEN_FROM_ID(395, OperatorTokenType | TriGraphTokenType),
    T_POUND = TOKEN_FROM_ID(396, OperatorTokenType),
    T_POUND_ALT = TOKEN_FROM_ID(396, OperatorTokenType | AltTokenType),
    T_POUND_TRIGRAPH =
        TOKEN_FROM_ID(396, OperatorTokenType | TriGraphTokenType),
    ...
    T_NONREPLACABLE_IDENTIFIER =
        TOKEN_FROM_ID(T_LAST_TOKEN + 1, IdentifierTokenType),
...
#define IS_EXTCATEGORY(tok, cat)                                               \
    ((EXTCATEGORY_FROM_TOKEN(tok) == EXTCATEGORY_FROM_TOKEN(cat))              \
         ? true                                                                \
         : false) /**/
