...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
    __asm__("add.f	%1, %4, %5\n\tadc	%0, %2, %3"                               \
            ...
            : "%r"((USItype)(ah)), "rICal"((USItype)(bh)),                     \
              "%r"((USItype)(al)), "rICal"((USItype)(bl)))
#define sub_ddmmss(sh, sl, ah, al, bh, bl)                                     \
    __asm__("sub.f	%1, %4, %5\n\tsbc	%0, %2, %3"                               \
            : "=r"((USItype)(sh)), "=&r"((USItype)(sl))                        \
            : "r"((USItype)(ah)), "rICal"((USItype)(bh)), "r"((USItype)(al)),  \
              "rICal"((USItype)(bl)))
...
#define umul_ppmm(xh, xl, a, b)                                                \
    ...
    {                                                                          \
        ...
        __asm__("%@ Inlined umul_ppmm\n"                                       \
                ...
                "	adds	%1, %1, %3, lsl #16\n"                                  \
                "	adc	%0, %0, %3, lsr #16"                                     \
                : "=&r"((USItype)(xh)), "=r"((USItype)(xl)), "=&r"(__t0),      \
                  "=&r"(__t1), "=r"(__t2)                                      \
...
#define sdiv_qrnnd(q, r, n1, n0, d)                                            \
    ...
    {                                                                          \
        ...
        __x.__i.__h = n1;                                                      \
        __x.__i.__l = n0;                                                      \
        __asm__("dr %0,%2" : "=r"(__x.__ll) : "0"(__x.__ll), "r"(d));          \
        (q) = __x.__i.__l;                                                     \
        (r) = __x.__i.__h;                                                     \
    } while (0)
#else
#define smul_ppmm(xh, xl, m0, m1)                                              \
    ...
    {                                                                          \
        ...
        register SItype __r1 __asm__("1") = (m0);                              \
                                                                               \
        __asm__("mr\t%%r0,%3" : "=r"(__r0), "=r"(__r1) : "r"(__r1), "r"(m1));  \
        (xh) = __r0;                                                           \
        (xl) = __r1;                                                           \
    } while (0)
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
    __asm__("add{q} {%5,%1|%1,%5}\n\tadc{q} {%3,%0|%0,%3}"                     \
            ...
            : "%0"((UDItype)(ah)), "rme"((UDItype)(bh)), "%1"((UDItype)(al)),  \
              "rme"((UDItype)(bl)))
#define sub_ddmmss(sh, sl, ah, al, bh, bl)                                     \
...
#define umul_ppmm(w1, w0, u, v)                                                \
    __asm__("mul{q} %3"                                                        \
            : "=a"((UDItype)(w0)), "=d"((UDItype)(w1))                         \
            : "%0"((UDItype)(u)), "rm"((UDItype)(v)))
#define udiv_qrnnd(q, r, n1, n0, dv)                                           \
    __asm__("div{q} %4"                                                        \
            : "=a"((UDItype)(q)), "=d"((UDItype)(r))                           \
            : "0"((UDItype)(n0)), "1"((UDItype)(n1)), "rm"((UDItype)(dv)))
#define count_leading_zeros(count, x) ((count) = __builtin_clzll(x))
#define count_trailing_zeros(count, x) ((count) = __builtin_ctzll(x))
#define UMUL_TIME 40
#define UDIV_TIME 40
...
#define umul_ppmm(xh, xl, a, b)                                                \
    __asm__("| Inlined umul_ppmm\n"                                            \
            ...
            "	add%.l	%/d1,%/d0\n"                                              \
            "	move%.l	%/d0,%0"                                                 \
            : "=g"((USItype)(xh)), "=g"((USItype)(xl))                         \
            : "g"((USItype)(a)), "g"((USItype)(b))                             \
            : "d0", "d1", "d2", "d3", "d4")
...
#define count_leading_zeros(count, x)                                          \
    ...
    {                                                                          \
        USItype __cbtmp;                                                       \
        __asm__("ff1 %0,%1" : "=r"(__cbtmp) : "r"((USItype)(x)));              \
        (count) = __cbtmp ^ 31;                                                \
    } while (0)
...
#define umul_ppmm(ph, pl, m0, m1)                                              \
    ...
    {                                                                          \
        ...
        __asm__("s	r2,r2\n"                                                    \
                ...
                : "r2");                                                       \
        (ph) +=                                                                \
            ((((SItype)__m0 >> 31) & __m1) + (((SItype)__m1 >> 31) & __m0));   \
    } while (0)
#define UMUL_TIME 20
...
#define __muluw3(a, b)                                                         \
    ({                                                                         \
        ...
        asm volatile(MULUW3 : "+r"(__op0), "+r"(__op1) : : "ra", "a2", "a3");  \
        __op0;                                                                 \
    })
#endif /* __riscv_mul */
#define umul_ppmm(w1, w0, u, v)                                                \
...
#define udiv_qrnnd(__q, __r, __n1, __n0, __d)                                  \
    __asm__("mov\t%2,%%y\n\t"                                                  \
            ...
            "umul\t%0,%4,%1\n\t"                                               \
            "sub\t%3,%1,%1"                                                    \
            : "=&r"((USItype)(__q)), "=&r"((USItype)(__r))                     \
            : "r"((USItype)(__n1)), "r"((USItype)(__n0)), "r"((USItype)(__d)))
#else
...
#define count_leading_zeros(count, x)                                          \
    do                                                                         \
    {                                                                          \
        __asm__("scan %1,1,%0" : "=r"((USItype)(count)) : "r"((USItype)(x)));  \
    } while (0)
...
#define udiv_qrnnd(__q, __r, __n1, __n0, __d)                                  \
    __asm__("! Inlined udiv_qrnnd\n"                                           \
            ...
            : "=&r"((USItype)(__q)), "=&r"((USItype)(__r))                     \
            : "r"((USItype)(__d)), "1"((USItype)(__n1)), "0"((USItype)(__n0))  \
            : "g1" __AND_CLOBBER_CC)
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
    ...
    {                                                                          \
        ...
        __asm__("addcc\t%r5,%6,%1\n\t"                                         \
                ...
                "movcs\t%%xcc, 1, %2\n\t"                                      \
                "add\t%0, %2, %0"                                              \
                : "=r"((UDItype)(sh)), "=&r"((UDItype)(sl)), "+r"(__carry)     \
...
#define umul_ppmm(wh, wl, u, v)                                                \
    ...
    {                                                                          \
        ...
        __asm__ __volatile__(                                                  \
            ...
            "add %1,%3,%1\n\t"                                                 \
            "add %5,%2,%0"                                                     \
            : "=r"((UDItype)(wh)), "=&r"((UDItype)(wl)), "=&r"(tmp1),          \
              "=&r"(tmp2), "=&r"(tmp3), "=&r"(tmp4)                            \
            : "r"((UDItype)(u)), "r"((UDItype)(v))__CLOBBER_CC);               \
    } while (0)
#define UMUL_TIME 96
...
#define umul_ppmm(xh, xl, m0, m1)                                              \
    ...
    {                                                                          \
        ...
        USItype __m0 = (m0), __m1 = (m1);                                      \
        __asm__("emul %1,%2,$0,%0" : "=r"(__xx.__ll) : "g"(__m0), "g"(__m1));  \
        (xh) = __xx.__i.__h;                                                   \
        (xl) = __xx.__i.__l;                                                   \
        (xh) +=                                                                \
            ((((SItype)__m0 >> 31) & __m1) + (((SItype)__m1 >> 31) & __m0));   \
...
#define add_ssaaaa(sh, sl, ah, al, bh, bl)                                     \
    ...
    {                                                                          \
        UDItype __ll;                                                          \
        __asm__("addu .l1 %1, %2, %0" : "=a"(__ll) : "a"(al), "a"(bl));        \
        (sl) = (USItype)__ll;                                                  \
