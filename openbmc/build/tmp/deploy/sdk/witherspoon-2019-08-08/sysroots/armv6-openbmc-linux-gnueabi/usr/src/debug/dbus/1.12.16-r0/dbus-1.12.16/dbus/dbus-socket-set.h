...
struct DBusSocketSetClass
{
    ...
    dbus_bool_t (*add)(DBusSocketSet* self, DBusPollable fd, unsigned int flags,
                       dbus_bool_t enabled);
    ...
    int (*poll)(DBusSocketSet* self, DBusSocketEvent* revents, int max_events,
                int timeout_ms);
};
...
static inline dbus_bool_t _dbus_socket_set_add(DBusSocketSet* self,
                                               DBusPollable fd,
                                               unsigned int flags,
                                               dbus_bool_t enabled)
{
...
static inline void _dbus_socket_set_enable(DBusSocketSet* self, DBusPollable fd,
                                           unsigned int flags)
{
    (self->cls->enable)(self, fd, flags);
}

static inline void _dbus_socket_set_disable(DBusSocketSet* self,
                                            DBusPollable fd)
{
    (self->cls->disable)(self, fd);
}

static inline int _dbus_socket_set_poll(DBusSocketSet* self,
