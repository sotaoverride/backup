 ...
 */
netsnmp_container* netsnmp_access_scopezone_container_init(u_int flags)
{
                                             ...
                                             u_int free_flags)
{
    ...
    {
        snmp_log(LOG_ERR,
                 "invalid container for netsnmp_access_scopezone_free\n");
        return;
    }
...
/**
 */
netsnmp_v6scopezone_entry* netsnmp_access_scopezone_entry_create(void)
{
 ...
 * \internal
 */
static void _entry_release(netsnmp_v6scopezone_entry* entry, void* context)
{
