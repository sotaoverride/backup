...
//! config struct for additional duration types (ie months_duration<> &
//! years_duration<>)
...
{
  public:
    weeks_duration(duration_rep w) : date_duration(w * 7)
    {
    }
    weeks_duration(date_time::special_values sv) : date_duration(sv)
    {
    }
};
