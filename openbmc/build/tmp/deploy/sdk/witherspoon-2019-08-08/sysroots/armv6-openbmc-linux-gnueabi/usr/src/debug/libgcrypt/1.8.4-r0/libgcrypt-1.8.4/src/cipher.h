...
void _gcry_sha1_hash_buffers(void* outbuf, const gcry_buffer_t* iov,
                             int iovcnt);

/*-- sha256.c --*/
void _gcry_sha256_hash_buffer(void* outbuf, const void* buffer, size_t length);
void _gcry_sha256_hash_buffers(void* outbuf, const gcry_buffer_t* iov,
                               int iovcnt);

/*-- sha512.c --*/
void _gcry_sha512_hash_buffer(void* outbuf, const void* buffer, size_t length);
void _gcry_sha512_hash_buffers(void* outbuf, const gcry_buffer_t* iov,
                               int iovcnt);
...
/*-- rijndael.c --*/
void _gcry_aes_cfb_enc(void* context, unsigned char* iv, void* outbuf,
...
/*-- cast5.c --*/
void _gcry_cast5_cfb_dec(void* context, unsigned char* iv, void* outbuf_arg,
                         const void* inbuf_arg, size_t nblocks);

void _gcry_cast5_cbc_dec(void* context, unsigned char* iv, void* outbuf_arg,
                         const void* inbuf_arg, size_t nblocks);

void _gcry_cast5_ctr_enc(void* context, unsigned char* ctr, void* outbuf_arg,
                         const void* inbuf_arg, size_t nblocks);

/*-- camellia-glue.c --*/
void _gcry_camellia_ctr_enc(void* context, unsigned char* ctr, void* outbuf_arg,
                            const void* inbuf_arg, size_t nblocks);
void _gcry_camellia_cbc_dec(void* context, unsigned char* iv, void* outbuf_arg,
                            const void* inbuf_arg, size_t nblocks);
void _gcry_camellia_cfb_dec(void* context, unsigned char* iv, void* outbuf_arg,
                            const void* inbuf_arg, size_t nblocks);
...
/*-- ecc.c --*/
void _gcry_register_pk_ecc_progress(gcry_handler_progress_t cbc, void* cb_data);
