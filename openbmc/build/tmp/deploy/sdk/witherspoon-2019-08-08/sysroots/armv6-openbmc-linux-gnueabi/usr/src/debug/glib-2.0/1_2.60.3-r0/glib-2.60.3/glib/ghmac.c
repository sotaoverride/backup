 ...
 * Since: 2.30
 */
gchar* g_compute_hmac_for_data(GChecksumType digest_type, const guchar* key,
                               gsize key_len, const guchar* data, gsize length)
{
    GHmac* hmac;
    gchar* retval;
 ...
 * Since: 2.50
 */
gchar* g_compute_hmac_for_bytes(GChecksumType digest_type, GBytes* key,
                                GBytes* data)
{
    ...
    return g_compute_hmac_for_data(digest_type, key_data, key_len, byte_data,
                                   length);
}
 ...
 * Since: 2.30
 */
gchar* g_compute_hmac_for_string(GChecksumType digest_type, const guchar* key,
                                 gsize key_len, const gchar* str, gssize length)
{
