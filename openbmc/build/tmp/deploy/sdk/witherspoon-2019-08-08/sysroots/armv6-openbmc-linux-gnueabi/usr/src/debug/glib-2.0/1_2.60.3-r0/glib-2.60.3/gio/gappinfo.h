...
#define G_APP_INFO(obj)                                                        \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_APP_INFO, GAppInfo))
#define G_IS_APP_INFO(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_APP_INFO))
#define G_APP_INFO_GET_IFACE(obj)                                              \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_APP_INFO, GAppInfoIface))

#define G_TYPE_APP_LAUNCH_CONTEXT (g_app_launch_context_get_type())
#define G_APP_LAUNCH_CONTEXT(o)                                                \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_APP_LAUNCH_CONTEXT,                \
                                GAppLaunchContext))
#define G_APP_LAUNCH_CONTEXT_CLASS(k)                                          \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_APP_LAUNCH_CONTEXT,                   \
                             GAppLaunchContextClass))
#define G_IS_APP_LAUNCH_CONTEXT(o)                                             \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_APP_LAUNCH_CONTEXT))
#define G_IS_APP_LAUNCH_CONTEXT_CLASS(k)                                       \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_APP_LAUNCH_CONTEXT))
#define G_APP_LAUNCH_CONTEXT_GET_CLASS(o)                                      \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_APP_LAUNCH_CONTEXT,                 \
                               GAppLaunchContextClass))
 ...
 * @supports_uris: Indicates whether the application specified supports
 launching URIs.
 * @supports_files: Indicates whether the application specified accepts filename
 arguments.
 ...
 * @set_as_default_for_extension: Sets an application as default for a given
 file extension.
 * @add_supports_type: Adds to the #GAppInfo information about supported file
 types.
 * @can_remove_supports_type: Checks for support for removing supported file
 types from a #GAppInfo.
...
struct _GAppInfoIface
{
    ...
    gboolean (*launch)(GAppInfo* appinfo, GList* files,
                       GAppLaunchContext* context, GError** error);
    gboolean (*supports_uris)(GAppInfo* appinfo);
    gboolean (*supports_files)(GAppInfo* appinfo);
    gboolean (*launch_uris)(GAppInfo* appinfo, GList* uris,
                            GAppLaunchContext* context, GError** error);
    ...
    void (*launch_uris_async)(GAppInfo* appinfo, GList* uris,
                              GAppLaunchContext* context,
                              GCancellable* cancellable,
                              GAsyncReadyCallback callback, gpointer user_data);
    gboolean (*launch_uris_finish)(GAppInfo* appinfo, GAsyncResult* result,
                                   GError** error);
};
...
struct _GAppLaunchContextClass
{
    ...
    void (*launched)(GAppLaunchContext* context, GAppInfo* info,
...
#define G_APP_INFO_MONITOR(inst)                                               \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_APP_INFO_MONITOR,               \
                                GAppInfoMonitor))
#define G_IS_APP_INFO_MONITOR(inst)                                            \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_APP_INFO_MONITOR))
