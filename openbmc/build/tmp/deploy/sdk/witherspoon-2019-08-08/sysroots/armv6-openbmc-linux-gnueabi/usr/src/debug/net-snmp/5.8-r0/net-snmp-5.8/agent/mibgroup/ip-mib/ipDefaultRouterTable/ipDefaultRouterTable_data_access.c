...
netsnmp_feature_require(container_lifo)
     ...
     */
    int ipDefaultRouterTable_init_data(
        ipDefaultRouterTable_registration* ipDefaultRouterTable_reg)
{
    DEBUGMSGTL(("verbose:ipDefaultRouterTable:ipDefaultRouterTable_init_data",
                "called\n"));
 ...
 */
void ipDefaultRouterTable_container_init(netsnmp_container** container_ptr_ptr,
                                         netsnmp_cache* cache)
{
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_init",
         "called\n"));
 ...
 */
void ipDefaultRouterTable_container_shutdown(netsnmp_container* container_ptr)
{
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_shutdown",
         "called\n"));
                             ...
                             void** magic)
{
    ...
    {
        DEBUGMSGTL(
            ("ipDefaultRouterTable:access", "updating existing entry\n"));
 ...
 * add new entry
 */
static void _add_new_entry(netsnmp_defaultrouter_entry* defaultrouter_entry,
                           netsnmp_container* container)
{
     ...
     */
    rowreq_ctx =
        ipDefaultRouterTable_allocate_rowreq_ctx(defaultrouter_entry, NULL);
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS == ipDefaultRouterTable_indexes_set(
                            rowreq_ctx, defaultrouter_entry->dr_addresstype,
 ...
 *
 */
int ipDefaultRouterTable_container_load(netsnmp_container* container)
{
    netsnmp_container* defaultrouter_container;
    void* tmp_ptr[2];

    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_load",
         "called\n"));
     ...
     * the container.
     */
    defaultrouter_container = netsnmp_access_defaultrouter_container_load(
    ...
    netsnmp_access_defaultrouter_container_free(
        defaultrouter_container, NETSNMP_ACCESS_DEFAULTROUTER_FREE_DONT_CLEAR);
...
{
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_free",
         "called\n"));
 ...
 * @retval MFD_ERROR       : other error.
 */
int ipDefaultRouterTable_row_prep(ipDefaultRouterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:ipDefaultRouterTable:ipDefaultRouterTable_row_prep",
                "called\n"));
