...
const int inetNetToMediaTable_oid_size = OID_LENGTH(inetNetToMediaTable_oid);
...
void initialize_table_inetNetToMediaTable(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:initialize_table_inetNetToMediaTable",
         "called\n"));
 ...
 */
int inetNetToMediaTable_rowreq_ctx_init(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx, void* user_init_ctx)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_rowreq_ctx_init",
         "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:210:o: |-> Perform extra inetNetToMediaTable rowreq initialization.
     * (eg DEFVALS)
     */
 ...
 *
 */
void inetNetToMediaTable_rowreq_ctx_cleanup(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_rowreq_ctx_cleanup",
         "called\n"));
 ...
 */
int inetNetToMediaTable_pre_request(
    inetNetToMediaTable_registration* user_context)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_pre_request",
                "called\n"));
 ...
 */
int inetNetToMediaTable_post_request(
    inetNetToMediaTable_registration* user_context, int rc)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_post_request",
                "called\n"));
...
inetNetToMediaTable_data* inetNetToMediaTable_allocate_data(void)
{
    ...
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_allocate_data",
                "called\n"));
 ...
 */
void inetNetToMediaTable_release_data(inetNetToMediaTable_data* data)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_release_data",
                "called\n"));
 ...
 */
int inetNetToMediaTable_indexes_set_tbl_idx(
    inetNetToMediaTable_mib_index* tbl_idx, long inetNetToMediaIfIndex_val,
    u_long inetNetToMediaNetAddressType_val,
    char* inetNetToMediaNetAddress_val_ptr,
    size_t inetNetToMediaNetAddress_val_ptr_len)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_indexes_set_tbl_idx",
         "called\n"));
     ...
     */
    /** WARNING: this code might not work for netsnmp_arp_entry */
    tbl_idx->inetNetToMediaNetAddressType = inetNetToMediaNetAddressType_val;
    ...
    tbl_idx->inetNetToMediaNetAddress_len =
        ...
        sizeof(tbl_idx->inetNetToMediaNetAddress[0]); /* max length */
    /** WARNING: this code might not work for netsnmp_arp_entry */
    /*
    ...
    tbl_idx->inetNetToMediaNetAddress_len =
        inetNetToMediaNetAddress_val_ptr_len;
    memcpy(tbl_idx->inetNetToMediaNetAddress, inetNetToMediaNetAddress_val_ptr,
           inetNetToMediaNetAddress_val_ptr_len *
 ...
 *  from the mib index.
 */
int inetNetToMediaTable_indexes_set(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                    long inetNetToMediaIfIndex_val,
                                    u_long inetNetToMediaNetAddressType_val,
                                    char* inetNetToMediaNetAddress_val_ptr,
                                    size_t inetNetToMediaNetAddress_val_ptr_len)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_indexes_set",
                "called\n"));

    if (MFD_SUCCESS != inetNetToMediaTable_indexes_set_tbl_idx(
                           &rowreq_ctx->tbl_idx, inetNetToMediaIfIndex_val,
 ...
 *
 * @note If you need more than (*inetNetToMediaPhysAddress_val_ptr_len_ptr)
 * bytes of memory, allocate it using malloc() and update
 * inetNetToMediaPhysAddress_val_ptr_ptr. <b>DO NOT</b> free the previous
 * pointer. The MFD helper will release the memory you allocate.
 *
 ...
 */
int inetNetToMediaPhysAddress_get(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
    char** inetNetToMediaPhysAddress_val_ptr_ptr,
    size_t* inetNetToMediaPhysAddress_val_ptr_len_ptr)
{
     ...
     * inetNetToMediaPhysAddress data. copy (*
     * inetNetToMediaPhysAddress_val_ptr_ptr ) data and (*
     * inetNetToMediaPhysAddress_val_ptr_len_ptr ) from rowreq_ctx->data
     */
 ...
 * @retval MFD_ERROR           : Any other error
 */
int inetNetToMediaLastUpdated_get(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                  u_long* inetNetToMediaLastUpdated_val_ptr)
{
    /** we should have a non-NULL pointer */
    netsnmp_assert(NULL != inetNetToMediaLastUpdated_val_ptr);

    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaLastUpdated_get",
                "called\n"));
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * inetNetToMediaLastUpdated data. copy (* inetNetToMediaLastUpdated_val_ptr
 ...
 *   defval: static
 *
 * Enum range: 5/8. Values:  other(1), invalid(2), dynamic(3), static(4),
local(5)
 *
 ...
 * @retval MFD_ERROR           : Any other error
 */
int inetNetToMediaType_get(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
 ...
 *   settable   0
 *
 * Enum range: 6/8. Values:  reachable(1), stale(2), delay(3), probe(4),
invalid(5), unknown(6), incomplete(7)
 *
 * Its syntax is INTEGER (based on perltype INTEGER)
 * The net-snmp type is ASN_INTEGER. The C type decl is long (u_long)
 */
 ...
 * @retval MFD_ERROR           : Any other error
 */
int inetNetToMediaState_get(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                            u_long* inetNetToMediaState_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the inetNetToMediaState
     * data. copy (* inetNetToMediaState_val_ptr ) from rowreq_ctx->data
     */
 ...
 * @retval MFD_ERROR           : Any other error
 */
int inetNetToMediaRowStatus_get(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                u_long* inetNetToMediaRowStatus_val_ptr)
{
    /** we should have a non-NULL pointer */
    netsnmp_assert(NULL != inetNetToMediaRowStatus_val_ptr);

    (*inetNetToMediaRowStatus_val_ptr) = rowreq_ctx->inetNetToMediaRowStatus;
 ...
 */
int inetNetToMediaTable_undo_setup(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_undo_setup",
                "called\n"));
 ...
 * @retval MFD_ERROR   : error. set will fail.
 */
int inetNetToMediaTable_undo(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 */
int inetNetToMediaTable_undo_cleanup(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_undo_cleanup",
                "called\n"));
 ...
 * @retval MFD_ERROR   : error
 */
int inetNetToMediaTable_commit(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    int save_flags;

    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_commit", "called\n"));
    ...
    {
        save_flags &= ~COLUMN_INETNETTOMEDIAPHYSADDRESS_FLAG; /* clear
        ...
        if (-1 == rc)
        {
            snmp_log(LOG_ERR, "inetNetToMediaTable column "
                              "inetNetToMediaPhysAddress commit failed\n");
        }
        else
        {
            /*
    ...
    {
        save_flags &=
            ~COLUMN_INETNETTOMEDIATYPE_FLAG; /* clear inetNetToMediaType */
        /*
        ...
        if (-1 == rc)
        {
            snmp_log(LOG_ERR, "inetNetToMediaTable column inetNetToMediaType "
                              "commit failed\n");
        }
        else
        {
    ...
    {
        save_flags &=
            ~COLUMN_INETNETTOMEDIAROWSTATUS_FLAG; /* clear
        ...
        {
            snmp_log(LOG_ERR, "inetNetToMediaTable column "
                              "inetNetToMediaRowStatus commit failed\n");
        }
        else
        {
            /*
 ...
 * @retval MFD_ERROR   : error
 */
int inetNetToMediaTable_undo_commit(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_undo_commit",
                "called\n"));
 ...
 *
 */
int inetNetToMediaPhysAddress_check_value(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
    char* inetNetToMediaPhysAddress_val_ptr,
    size_t inetNetToMediaPhysAddress_val_ptr_len)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaPhysAddress_check_value",
         "called\n"));
 ...
 */
int inetNetToMediaPhysAddress_undo_setup(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaPhysAddress_undo_setup",
         "called\n"));
     ...
     * set rowreq_ctx->undo->inetNetToMediaPhysAddress from
     * rowreq_ctx->data->inetNetToMediaPhysAddress
     */
 ...
 * inetNetToMediaPhysAddress_val_ptr
 */
int inetNetToMediaPhysAddress_set(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                  char* inetNetToMediaPhysAddress_val_ptr,
                                  size_t inetNetToMediaPhysAddress_val_ptr_len)
{

    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaPhysAddress_set",
                "called\n"));
 ...
 *        Pointer to the users context.
 */
int inetNetToMediaPhysAddress_undo(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{

    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaPhysAddress_undo",
                "called\n"));
    ...
    /*
     * copy inetNetToMediaPhysAddress and inetNetToMediaPhysAddress_len data
     * set rowreq_ctx->data->inetNetToMediaPhysAddress from
     * rowreq_ctx->undo->inetNetToMediaPhysAddress
     */
 ...
 *
 */
int inetNetToMediaType_check_value(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                   u_long inetNetToMediaType_val)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaType_check_value",
                "called\n"));
 ...
 * won't be done unless it is necessary.
 */
int inetNetToMediaType_undo_setup(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaType_undo_setup",
                "called\n"));
     ...
     * set rowreq_ctx->undo->inetNetToMediaType from
     * rowreq_ctx->data->inetNetToMediaType
     */
 ...
 *        A long containing the new value.
 */
int inetNetToMediaType_set(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                           u_long inetNetToMediaType_val)
{

    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaType_set", "called\n"));
 ...
 *        Pointer to the users context.
 */
int inetNetToMediaType_undo(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{

    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaType_undo", "called\n"));
    ...
    /*
     * copy inetNetToMediaType data
     * set rowreq_ctx->data->inetNetToMediaType from
     * rowreq_ctx->undo->inetNetToMediaType
     */
 ...
 *
 */
int inetNetToMediaRowStatus_check_value(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
    u_long inetNetToMediaRowStatus_val)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaRowStatus_check_value",
         "called\n"));
 ...
 * won't be done unless it is necessary.
 */
int inetNetToMediaRowStatus_undo_setup(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaRowStatus_undo_setup",
         "called\n"));
     ...
     * set rowreq_ctx->undo->inetNetToMediaRowStatus from
     * rowreq_ctx->data->inetNetToMediaRowStatus
     */
 ...
 *        A long containing the new value.
 */
int inetNetToMediaRowStatus_set(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                u_long inetNetToMediaRowStatus_val)
{
 ...
 *        Pointer to the users context.
 */
int inetNetToMediaRowStatus_undo(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    ...
    /*
     * copy inetNetToMediaRowStatus data
     * set rowreq_ctx->data->inetNetToMediaRowStatus from
     * rowreq_ctx->undo->inetNetToMediaRowStatus
     */
    rowreq_ctx->inetNetToMediaRowStatus =
        rowreq_ctx->inetNetToMediaRowStatus_undo;
 ...
 */
int inetNetToMediaTable_check_dependencies(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:inetNetToMediaTable_check_dependencies",
         "called\n"));
    ...
    if (rowreq_ctx->column_set_flags & COLUMN_INETNETTOMEDIAROWSTATUS_FLAG)
    {
         ...
         */
        rc =
            check_rowstatus_transition(rowreq_ctx->inetNetToMediaRowStatus_undo,
                                       rowreq_ctx->inetNetToMediaRowStatus);
        if (MFD_SUCCESS != rc)
            return rc;
    ...
    else
    {
        ...
        {
            DEBUGMSGTL(
                ("inetNetToMediaTable", "must use RowStatus to create rows\n"));
            return MFD_CANNOT_CREATE_NOW;
        }
    } /* row status not set */
