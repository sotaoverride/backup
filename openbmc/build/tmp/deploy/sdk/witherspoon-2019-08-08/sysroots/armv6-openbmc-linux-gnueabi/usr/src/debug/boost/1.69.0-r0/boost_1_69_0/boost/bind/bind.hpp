...
template <class T>
bool ref_compare(reference_wrapper<T> const& a, reference_wrapper<T> const& b,
                 int)
{
...
class list0
{
  public:
    ...
    typename result_traits<R, F>::type
        operator[](bind_t<R, F, L> const& b) const
    {
        return b.eval(*this);
    }
...
class list3 : private storage3<A1, A2, A3>
{
  ...
  public:
    ...
    {
        return unwrapper<F const>::unwrap(f, 0)(
            a[base_type::a1_], a[base_type::a2_], a[base_type::a3_]);
    }
...
class rrlist1
{
  ...
  public:
    ...
    A1&& operator[](boost::arg<1>) const
    {
        return std::forward<A1>(a1_);
    } // not static_cast because of g++ 4.9
...
class rrlist7
{
  ...
  public:
    ...
    typename result_traits<R, F>::type operator[](bind_t<R, F, L>& b) const
    {
        rrlist7<A1&, A2&, A3&, A4&, A5&, A6&, A7&> a(a1_, a2_, a3_, a4_, a5_,
                                                     a6_, a7_);
        return b.eval(a);
    }
...
class rrlist8
{
  ...
  public:
    ...
    typename result_traits<R, F>::type operator[](bind_t<R, F, L>& b) const
    {
        rrlist8<A1&, A2&, A3&, A4&, A5&, A6&, A7&, A8&> a(a1_, a2_, a3_, a4_,
                                                          a5_, a6_, a7_, a8_);
        return b.eval(a);
    }
...
class rrlist9
{
  ...
  public:
    rrlist9(A1& a1, A2& a2, A3& a3, A4& a4, A5& a5, A6& a6, A7& a7, A8& a8,
            A9& a9) :
        a1_(a1),
        a2_(a2), a3_(a3), a4_(a4), a5_(a5), a6_(a6), a7_(a7), a8_(a8), a9_(a9)
    {
    }
    ...
    typename result_traits<R, F>::type operator[](bind_t<R, F, L>& b) const
    {
        rrlist9<A1&, A2&, A3&, A4&, A5&, A6&, A7&, A8&, A9&> a(
...
class bind_t
{
  ...
  public:
    ...
    result_type operator()(A1&& a1, A2&& a2, A3&& a3, A4&& a4, A5&& a5, A6&& a6,
                           A7&& a7, A8&& a8)
    {
        rrlist8<A1, A2, A3, A4, A5, A6, A7, A8> a(a1, a2, a3, a4, a5, a6, a7,
                                                  a8);
        return l_(type<result_type>(), f_, a, 0);
    }
    ...
    result_type operator()(A1&& a1, A2&& a2, A3&& a3, A4&& a4, A5&& a5, A6&& a6,
                           A7&& a7, A8&& a8, A9&& a9)
    {
        rrlist9<A1, A2, A3, A4, A5, A6, A7, A8, A9> a(a1, a2, a3, a4, a5, a6,
                                                      a7, a8, a9);
        return l_(type<result_type>(), f_, a, 0);
    }
...
class bind_t
    : public bind_t_generator<R2>::BOOST_NESTED_TEMPLATE implementation<F, L>
{
  public:
    bind_t(F f, L const& l) :
        bind_t_generator<R2>::BOOST_NESTED_TEMPLATE implementation<F, L>(f, l)
    {
    }
};
...
template <class R, class F, class L>
bool function_equal_impl(bind_t<R, F, L> const& a, bind_t<R, F, L> const& b,
                         int)
{
    return a.compare(b);
}
...
template <class R, class F, class L>
bool function_equal(_bi::bind_t<R, F, L> const& a,
                    _bi::bind_t<R, F, L> const& b)
{
    return a.compare(b);
}
...
template <class R, class F, class L>
bool function_equal_impl(_bi::bind_t<R, F, L> const& a,
                         _bi::bind_t<R, F, L> const& b, int)
{
    return a.compare(b);
}
...
template <class T>
_avt_r1 _avt_f(value<T>);
template <class T>
_avt_r1 _avt_f(reference_wrapper<T>);
template <int I>
_avt_r1 _avt_f(arg<I>);
template <int I>
_avt_r1 _avt_f(arg<I> (*)());
template <class R, class F, class L>
_avt_r1 _avt_f(bind_t<R, F, L>);
...
template <class R, class F, class L>
bind_t<bool, logical_not, list1<bind_t<R, F, L>>> operator!(
    bind_t<R, F, L> const& f)
{
...
#define BOOST_BIND_OPERATOR(op, name)                                          \
                                                                               \
    template <class R, class F, class L>                                       \
    bind_t<bool, name, list2<bind_t<R, F, L>, bind_t<R, F, L>>> operator op(   \
        bind_t<R, F, L> const& f, bind_t<R, F, L> const& g)                    \
    {                                                                          \
...
_bi::bind_t<R, F, typename _bi::list_av_2<A1, A2>::type> BOOST_BIND(F f, A1 a1,
                                                                    A2 a2)
{
    ...
    BOOST_BIND(F f, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7)
{
    ...
    return _bi::bind_t<R, F, list_type>(f,
...
template <class R, class F, class A1>
_bi::bind_t<R, F, typename _bi::list_av_1<A1>::type> BOOST_BIND(boost::type<R>,
                                                                F f, A1 a1)
{
    typedef typename _bi::list_av_1<A1>::type list_type;
    return _bi::bind_t<R, F, list_type>(f, list_type(a1));
...
{
    typedef typename _bi::list_av_3<A1, A2, A3>::type list_type;
    return _bi::bind_t<_bi::unspecified, F, list_type>(f,
                                                       list_type(a1, a2, a3));
}
...
{
    typedef typename _bi::list_av_4<A1, A2, A3, A4>::type list_type;
    return _bi::bind_t<_bi::unspecified, F, list_type>(
        f, list_type(a1, a2, a3, a4));
}

template <class F, class A1, class A2, class A3, class A4, class A5>
_bi::bind_t<_bi::unspecified, F,
...
// data member pointers
    ...
    (defined(__BORLANDC__) &&                                                  \
     BOOST_WORKAROUND(__BORLANDC__, BOOST_TESTED_AT(0x620)))
...
template <class R, class T>
struct add_cref<R (T::*)() const noexcept, 1>
{
    typedef void type;
};
...
_bi::bind_t<typename _bi::dm_result<M T::*, A1>::type, _mfi::dm<M, T>,
