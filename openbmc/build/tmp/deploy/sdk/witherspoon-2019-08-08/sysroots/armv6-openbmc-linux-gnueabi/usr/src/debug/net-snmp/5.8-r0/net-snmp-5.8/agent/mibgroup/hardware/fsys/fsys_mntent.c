...
static int _fsys_remote(char* device, int type)
{
...
static int _fsys_type(char* typename)
{
...
#include "mnttypes.h"
        ...
        return _NETSNMP_FS_TYPE_UFS; /* either N_FS_TYPE_BERKELEY or
                                        N_FS_TYPE_SYSV */
    else if (!strcmp(typename, MNTTYPE_SYSV))
        return NETSNMP_FS_TYPE_SYSV;
    else if (!strcmp(typename, MNTTYPE_PC) || !strcmp(typename, MNTTYPE_MSDOS))
        ...
        return _NETSNMP_FS_TYPE_CDFS; /* either N_FS_TYPE_ISO9660 or
                                         N_FS_TYPE_ROCKRIDGE */
     ...
     */
             ...
             !strcmp(typename, MNTTYPE_XFS) || !strcmp(typename, MNTTYPE_JFS) ||
             ...
             !strcmp(typename, MNTTYPE_ACFS) || !strcmp(typename, MNTTYPE_LOFS))
