...
{
    DEBUGMSGTL(("ifXTable:ifXTable_dirty_set", "called. was %d, now %d\n",
...
NETSNMP_STATIC_INLINE int _ifXTable_undo_column(ifXTable_rowreq_ctx* rowreq_ctx,
 ...
 */
int ifXTable_index_from_oid(netsnmp_index* oid_idx, ifXTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
                                               ...
                                               int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IFNAME:
            ...
            rc =
                ifName_get(rowreq_ctx, (char**)&var->val.string, &var->val_len);
            break;
        ...
        case COLUMN_IFHCINOCTETS:
            ...
            rc = ifHCInOctets_get(rowreq_ctx,
        ...
        case COLUMN_IFCONNECTORPRESENT:
            var->val_len = sizeof(u_long);
            var->type = ASN_INTEGER;
            rc = ifConnectorPresent_get(rowreq_ctx, (u_long*)var->val.string);
            break;
                           ...
                           netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(("internal:ifXTable:_ifXTable_check_column", "called for %d\n",
                column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IFLINKUPDOWNTRAPENABLE:
            ...
            {
                DEBUGMSGTL(
                    ("ifXTable:_ifXTable_check_column:ifLinkUpDownTrapEnable",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ifLinkUpDownTrapEnable_check_value(
        ...
        case COLUMN_IFPROMISCUOUSMODE:
            rc = netsnmp_check_vb_type_and_size(
                var, ASN_INTEGER, sizeof(rowreq_ctx->data.ifPromiscuousMode));
            /*
             * check that the value is one of defined enums
             */
            if ((SNMPERR_SUCCESS == rc) &&
            ...
            {
                DEBUGMSGTL(
                    ("ifXTable:_ifXTable_check_column:ifPromiscuousMode",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
        ...
        case COLUMN_IFALIAS:
            rc = netsnmp_check_vb_type_and_max_size(
                var, ASN_OCTET_STR, sizeof(rowreq_ctx->data.ifAlias));
            /*
            ...
            {
                DEBUGMSGTL(
                    ("ifXTable:_ifXTable_check_column:ifAlias",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
...
int _mfd_ifXTable_check_objects(netsnmp_mib_handler* handler,
                                netsnmp_handler_registration* reginfo,
                                netsnmp_agent_request_info* agtreq_info,
                                netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ifXTable:_mfd_ifXTable_check_objects", "called\n"));
 ...
 */
static int _mfd_ifXTable_check_dependencies(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    ifXTable_rowreq_ctx* rowreq_ctx =
        (ifXTable_rowreq_ctx*)netsnmp_container_table_row_extract(requests);
    DEBUGMSGTL(
        ("internal:ifXTable:_mfd_ifXTable_check_dependencies", "called\n"));
 ...
 * undo setup
 */
int _mfd_ifXTable_undo_setup(netsnmp_mib_handler* handler,
                             netsnmp_handler_registration* reginfo,
                             netsnmp_agent_request_info* agtreq_info,
                             netsnmp_request_info* requests)
{
 ...
 * undo setup
 */
int _mfd_ifXTable_undo_cleanup(netsnmp_mib_handler* handler,
                               netsnmp_handler_registration* reginfo,
                               netsnmp_agent_request_info* agtreq_info,
                               netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ifXTable:_mfd_ifXTable_undo_cleanup", "called\n"));
 ...
 * Set the value for a particular column
 */
NETSNMP_STATIC_INLINE int _ifXTable_set_column(ifXTable_rowreq_ctx* rowreq_ctx,
                                               netsnmp_variable_list* var,
                                               int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    DEBUGMSGTL(
        ("internal:ifXTable:_ifXTable_set_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IFPROMISCUOUSMODE:
            rowreq_ctx->column_set_flags |= COLUMN_IFPROMISCUOUSMODE_FLAG;
            rc = ifPromiscuousMode_set(rowreq_ctx, *((u_long*)var->val.string));
            break;
        ...
        case COLUMN_IFALIAS:
            rowreq_ctx->column_set_flags |= COLUMN_IFALIAS_FLAG;
            rc = ifAlias_set(rowreq_ctx, (char*)var->val.string, var->val_len);
            break;
...
int _mfd_ifXTable_set_values(netsnmp_mib_handler* handler,
                             netsnmp_handler_registration* reginfo,
                             netsnmp_agent_request_info* agtreq_info,
                             netsnmp_request_info* requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ifXTable_set_column(rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL(("ifXTable:mfd",
                        "error %d from "
 ...
 * commit the values
 */
int _mfd_ifXTable_commit(netsnmp_mib_handler* handler,
                         netsnmp_handler_registration* reginfo,
                         netsnmp_agent_request_info* agtreq_info,
                         netsnmp_request_info* requests)
{
...
int _mfd_ifXTable_undo_commit(netsnmp_mib_handler* handler,
                              netsnmp_handler_registration* reginfo,
                              netsnmp_agent_request_info* agtreq_info,
                              netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ifXTable:_mfd_ifXTable_undo_commit", "called\n"));
                                                ...
                                                int column)
{
    ...
    DEBUGMSGTL(
        ("internal:ifXTable:_ifXTable_undo_column", "called for %d\n", column));
...
int _mfd_ifXTable_undo_values(netsnmp_mib_handler* handler,
                              netsnmp_handler_registration* reginfo,
                              netsnmp_agent_request_info* agtreq_info,
                              netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ifXTable:_mfd_ifXTable_undo_values", "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc =
            _ifXTable_undo_column(rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
 ...
 */
int _mfd_ifXTable_irreversible_commit(netsnmp_mib_handler* handler,
                                      netsnmp_handler_registration* reginfo,
                                      netsnmp_agent_request_info* agtreq_info,
                                      netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ifXTable:_mfd_ifXTable_irreversible:commit", "called\n"));
 ...
 */
netsnmp_container* _ifXTable_container_get(void)
{
    return ifXTable_if_ctx.container;
}
...
static void _ifXTable_container_row_restore(const char* token, char* buf);
static int _ifXTable_container_row_save(ifXTable_rowreq_ctx* rowreq_ctx,
                                        void* type);
static char* _ifXTable_container_col_restore(ifXTable_rowreq_ctx* rowreq_ctx,
                                             u_int col, char* buf);
static char* _ifXTable_container_col_save(ifXTable_rowreq_ctx* rowreq_ctx,
                                          u_int col, char* buf);
 ...
 */
void ifXTable_container_init_persistence(netsnmp_container* container)
{
    netsnmp_container** container_p;
    int rc;

    register_config_handler(NULL, row_token, _ifXTable_container_row_restore,
                            NULL, NULL);
                                         ...
                                         void* serverarg, void* clientarg)
{
     ...
     */
    CONTAINER_FOR_EACH(
        *(netsnmp_container**)clientarg,
        (netsnmp_container_obj_func*)_ifXTable_container_row_save, type);
...
#define MAX_ROW_SIZE                                                           \
    (sizeof(row_token) + 1 + (12) + /* ASN_INTEGER ifLinkUpDownTrapEnable */   \
...
static void _ifXTable_container_row_restore(const char* token, char* buf)
{
    ...
    {
        snmp_log(LOG_ERR, "unknown token in _ifXTable_container_row_restore\n");
        return;
    }
    ...
    while ((NULL != buf) && isdigit(*buf & 0xFF))
    {
         ...
         */
        DEBUGMSGTL(
            ("_ifXTable_container_row_restore", "parsing column %d\n", col));
    ...
    switch (col)
    {
        ...
        case COLUMN_IFALIAS: /** DisplayString = ASN_OCTET_STR */
            buf = read_config_save_octet_string(
                buf, (u_char*)rowreq_ctx->data.ifAlias,
                                             ...
                                             u_int col, char* buf)
{
    ...
    switch (col)
    {
        ...
        case COLUMN_IFALIAS: /** DisplayString = ASN_OCTET_STR */
            ...
            buf = read_config_read_memory(
                ASN_OCTET_STR, buf, (char*)&rowreq_ctx->data.ifAlias,
...
ifXTable_rowreq_ctx* ifXTable_row_find_by_mib_index(ifXTable_mib_index* mib_idx)
{
    ifXTable_rowreq_ctx* rowreq_ctx;
    ...
    rowreq_ctx = (ifXTable_rowreq_ctx*)CONTAINER_FIND(ifXTable_if_ctx.container,
                                                      &oid_idx);
