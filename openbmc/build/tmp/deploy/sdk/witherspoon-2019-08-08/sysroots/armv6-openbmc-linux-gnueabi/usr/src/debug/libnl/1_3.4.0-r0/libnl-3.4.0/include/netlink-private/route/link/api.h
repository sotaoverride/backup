...
struct rtnl_link_af_ops
{
    ...
    void (*ao_dump[NL_DUMP_MAX + 1])(struct rtnl_link*, struct nl_dump_params*,
                                     void*);
...
extern int rtnl_link_af_data_compare(struct rtnl_link* a, struct rtnl_link* b,
                                     int family);
extern int rtnl_link_info_data_compare(struct rtnl_link* a, struct rtnl_link* b,
                                       int flags);
