...
G_DEFINE_TYPE_WITH_PRIVATE(GUnixFDMessage, g_unix_fd_message,
...
static GSocketControlMessage* g_unix_fd_message_deserialize(int level, int type,
                                                            gsize size,
                                                            gpointer data)
{
...
static void g_unix_fd_message_serialize(GSocketControlMessage* message,
                                        gpointer data)
{
    GUnixFDMessage* fd_message = G_UNIX_FD_MESSAGE(message);
    const gint* fds;
...
static void g_unix_fd_message_set_property(GObject* object, guint prop_id,
                                           const GValue* value,
                                           GParamSpec* pspec)
{
...
static void g_unix_fd_message_get_property(GObject* object, guint prop_id,
 ...
 * Since: 2.22
 **/
gboolean g_unix_fd_message_append_fd(GUnixFDMessage* message, gint fd,
                                     GError** error)
{
