...
static const struct option longopts[] = {
    {"config", 0, 0, 'c'},  {"default", 0, 0, 'd'}, {"format", 1, 0, 'f'},
...
static void usage(char* program, int error)
{
    ...
    fprintf(
        file,
        _("usage: %s [-cdVh] [-f FORMAT] [--config] [--default] [--verbose] "
    ...
    fprintf(
        file,
        _("  -c, --config         perform config substitution on pattern\n"));
    fprintf(
        file,
        _("  -d, --default        perform default substitution on pattern\n"));
