...
class PowerSupplyAttributes
{
    ...
    private:
        ...
        static int _callback_get_DeratingFactor(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);
        /** @brief sd-bus callback for set-property 'DeratingFactor' */
        static int _callback_set_DeratingFactor(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);


        static constexpr auto _interface = "xyz.openbmc_project.Control.PowerSupplyAttributes";
