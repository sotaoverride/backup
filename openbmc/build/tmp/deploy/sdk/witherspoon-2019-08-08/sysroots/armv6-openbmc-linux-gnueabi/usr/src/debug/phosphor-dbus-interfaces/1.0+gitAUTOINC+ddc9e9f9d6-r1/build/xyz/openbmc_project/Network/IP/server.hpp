...
class IP
{
  public:
    ...
    using PropertiesVariant =
        std::variant<AddressOrigin, Protocol, uint8_t, std::string>;
    ...
    virtual uint8_t prefixLength(uint8_t value, bool skipSignal);
    ...
    virtual AddressOrigin origin(AddressOrigin value, bool skipSignal);
    /** Set value of Origin */
    ...
    virtual std::string gateway(std::string value, bool skipSignal);
    ...
    virtual Protocol type(Protocol value, bool skipSignal);
    /** Set value of Type */
  ...
  private:
    ...
    static int _callback_get_PrefixLength(sd_bus*, const char*, const char*,
                                          const char*, sd_bus_message*, void*,
                                          sd_bus_error*);
    /** @brief sd-bus callback for set-property 'PrefixLength' */
    static int _callback_set_PrefixLength(sd_bus*, const char*, const char*,
                                          const char*, sd_bus_message*, void*,
                                          sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Origin' */
    static int _callback_get_Origin(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Origin' */
    static int _callback_set_Origin(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Gateway' */
    static int _callback_get_Gateway(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Gateway' */
    static int _callback_set_Gateway(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Network_IP_interface;
