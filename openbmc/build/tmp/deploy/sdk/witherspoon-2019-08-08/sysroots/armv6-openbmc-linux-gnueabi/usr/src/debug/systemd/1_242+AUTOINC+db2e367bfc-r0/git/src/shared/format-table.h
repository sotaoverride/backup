...
static inline int table_add_cell(Table* t, TableCell** ret_cell,
                                 TableDataType type, const void* data)
{
    return table_add_cell_full(t, ret_cell, type, data, (size_t)-1, (size_t)-1,
...
#define table_add_many(t, ...)                                                 \
    table_add_many_internal(t, __VA_ARGS__, _TABLE_DATA_TYPE_MAX)
