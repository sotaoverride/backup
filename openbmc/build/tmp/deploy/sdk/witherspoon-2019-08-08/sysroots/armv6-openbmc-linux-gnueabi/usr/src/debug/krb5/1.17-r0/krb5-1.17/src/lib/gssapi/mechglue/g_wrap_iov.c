...
static OM_uint32 val_wrap_iov_args(OM_uint32* minor_status,
...
OM_uint32 KRB5_CALLCONV gss_wrap_iov(minor_status, context_handle,
                                     conf_req_flag, qop_req, conf_state, iov,
                                     iov_count) OM_uint32* minor_status;
gss_ctx_id_t context_handle;
int conf_req_flag;
gss_qop_t qop_req;
int* conf_state;
...
int iov_count;
{
    ...
    status = val_wrap_iov_args(minor_status, context_handle, conf_req_flag,
    ...
    if (mech)
    {
        ...
        {
            status = mech->gss_wrap_iov(minor_status, ctx->internal_ctx_id,
                                        conf_req_flag, qop_req, conf_state, iov,
                                        iov_count);
            if (status != GSS_S_COMPLETE)
...
OM_uint32 KRB5_CALLCONV gss_wrap_iov_length(minor_status, context_handle,
...
OM_uint32 KRB5_CALLCONV gss_get_mic_iov_length(OM_uint32* minor_status,
                                               gss_ctx_id_t context_handle,
                                               gss_qop_t qop_req,
                                               gss_iov_buffer_desc* iov,
                                               int iov_count)
...
OM_uint32
    KRB5_CALLCONV gss_release_iov_buffer(minor_status, iov,
                                         iov_count) OM_uint32* minor_status;
gss_iov_buffer_desc* iov;
int iov_count;
{
