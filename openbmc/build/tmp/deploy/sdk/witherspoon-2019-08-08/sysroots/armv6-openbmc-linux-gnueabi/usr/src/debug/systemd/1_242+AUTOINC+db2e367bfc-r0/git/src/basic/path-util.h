...
#define DEFAULT_PATH_NORMAL                                                    \
    PATH_SBIN_BIN("/usr/local/") ":" PATH_SBIN_BIN("/usr/")
#define DEFAULT_PATH_NORMAL_NULSTR                                             \
    PATH_SBIN_BIN_NULSTR("/usr/local/") PATH_SBIN_BIN_NULSTR("/usr/")
#define DEFAULT_PATH_SPLIT_USR DEFAULT_PATH_NORMAL ":" PATH_SBIN_BIN("/")
#define DEFAULT_PATH_SPLIT_USR_NULSTR                                          \
    DEFAULT_PATH_NORMAL_NULSTR PATH_SBIN_BIN_NULSTR("/")
#define DEFAULT_PATH_COMPAT                                                    \
    PATH_SPLIT_SBIN_BIN("/usr/local/")                                         \
    ":" PATH_SPLIT_SBIN_BIN("/usr/") ":" PATH_SPLIT_SBIN_BIN("/")
...
#define PATH_FOREACH_PREFIX(prefix, path)                                      \
    for (char* _slash = ({                                                     \
         ...
         _slash && ((*_slash = 0), true); _slash = strrchr((prefix), '/'))
...
int systemd_installation_has_version(const char* root,
...
enum
{
    PATH_CHECK_FATAL =
        1
        << 0, /* If not set, then error message is appended with 'ignoring'. */
