...
object getattr(Target const& target,
               Key const& key BOOST_PYTHON_NO_ARRAY_ARG(Key))
{
...
object getattr(Target const& target, Key const& key,
               Default const& default_ BOOST_PYTHON_NO_ARRAY_ARG(Key))
{
    return getattr(object(target), object(key), object(default_));
}

template <class Key, class Value>
void setattr(object const& target, Key const& key,
             Value const& value BOOST_PYTHON_NO_ARRAY_ARG(Key))
{
    setattr(target, object(key), object(value));
}

template <class Key>
void delattr(object const& target,
             Key const& key BOOST_PYTHON_NO_ARRAY_ARG(Key))
{
...
template <class Target, class Key>
object getitem(Target const& target,
               Key const& key BOOST_PYTHON_NO_ARRAY_ARG(Key))
{
...
template <class Key, class Value>
void setitem(object const& target, Key const& key,
             Value const& value BOOST_PYTHON_NO_ARRAY_ARG(Key))
{
...
template <class Key>
void delitem(object const& target,
             Key const& key BOOST_PYTHON_NO_ARRAY_ARG(Key))
{
...
void setslice(object const& target, Begin const& begin, End const& end,
              Value const& value)
{
