...
typedef struct request_list
{
    ...
    struct timeval
        expireM; /* Time this request is due to expire [monotonic clock]. */
...
#define SNMP_MAX_MSG_V3_HDRS                                                   \
    (4 + 3 + 4 + 7 + 7 + 3 + 7 + 16) /* fudge factor=16 */
 ...
 */
#define REPORT_STATS_LEN                                                       \
    9 /* Length of prefix for MPD/USM report statistic objects */
#define REPORT_STATS_LEN2                                                      \
    8 /* Length of prefix for Target report statistic objects */
/* From SNMP-MPD-MIB */
...
NETSNMP_IMPORT void
    snmp_free_var_internals(netsnmp_variable_list*); /* frees contents only */
...
NETSNMP_IMPORT
int snmp_oidsubtree_compare(const oid*, size_t, const oid*, size_t);
NETSNMP_IMPORT
...
NETSNMP_IMPORT
int netsnmp_oid_tree_equals(const oid*, size_t, const oid*, size_t);
NETSNMP_IMPORT
int netsnmp_oid_is_subtree(const oid*, size_t, const oid*, size_t);
NETSNMP_IMPORT
...
#endif
NETSNMP_IMPORT
int snmpv3_parse(netsnmp_pdu*, u_char*, size_t*, u_char**, netsnmp_session*);
NETSNMP_IMPORT
int snmpv3_packet_build(netsnmp_session*, netsnmp_pdu* pdu, u_char* packet,
                        size_t* out_length, u_char* pdu_data,
                        size_t pdu_data_len);
NETSNMP_IMPORT
int snmpv3_packet_rbuild(netsnmp_session*, netsnmp_pdu* pdu, u_char* packet,
                         size_t* out_length, u_char* pdu_data,
                         size_t pdu_data_len);
NETSNMP_IMPORT
...
netsnmp_session* snmp_open_ex(
    netsnmp_session*,
    int (*fpre_parse)(netsnmp_session*, struct netsnmp_transport_s*, void*,
                      int),
...
NETSNMP_IMPORT
void snmp_sess_transport_set(void*, struct netsnmp_transport_s*);

NETSNMP_IMPORT int netsnmp_sess_config_transport(
    struct netsnmp_container_s* transport_configuration,
    struct netsnmp_transport_s* transport);

NETSNMP_IMPORT int netsnmp_sess_config_and_open_transport(
    netsnmp_session* in_session, struct netsnmp_transport_s* transport);
...
void* snmp_sess_add_ex(
    ...
    int (*fpre_parse)(netsnmp_session*, struct netsnmp_transport_s*, void*,
                      int),
    int (*fparse)(netsnmp_session*, struct snmp_pdu*, u_char*, size_t),
    int (*fpost_parse)(netsnmp_session*, struct snmp_pdu*, int),
    int (*fbuild)(netsnmp_session*, struct snmp_pdu*, u_char*, size_t*),
    int (*frbuild)(netsnmp_session*, struct snmp_pdu*, u_char**, size_t*,
                   size_t*),
    int (*fcheck)(u_char*, size_t),
    netsnmp_pdu* (*fcreate_pdu)(struct netsnmp_transport_s*, void*, size_t));

NETSNMP_IMPORT
void* snmp_sess_add(netsnmp_session*, struct netsnmp_transport_s*,
...
NETSNMP_IMPORT
netsnmp_session*
    snmp_add(netsnmp_session*, struct netsnmp_transport_s*,
             int (*fpre_parse)(netsnmp_session*, struct netsnmp_transport_s*,
                               void*, int),
             int (*fpost_parse)(netsnmp_session*, netsnmp_pdu*, int));
NETSNMP_IMPORT
