...
/*! \file
    ...
    This header contains generator functions for the Formatters provided in this
   library.
*/
...
{
    return detail::const_formatF<iterator_range<
...
inline detail::identity_formatF<
    ...
    identity_formatter()
{
    return detail::identity_formatF<iterator_range<
        BOOST_STRING_TYPENAME range_const_iterator<RangeT>::type>>();
}
...
/*!
    ...
    to extract a portion of the formatted sequence. The first finder's match is
