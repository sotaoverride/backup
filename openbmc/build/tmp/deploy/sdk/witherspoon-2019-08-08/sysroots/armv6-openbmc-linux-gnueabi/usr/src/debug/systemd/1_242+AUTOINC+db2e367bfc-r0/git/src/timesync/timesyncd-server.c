...
int server_address_new(ServerName* n, ServerAddress** ret,
                       const union sockaddr_union* sockaddr, socklen_t socklen)
{
...
int server_name_new(Manager* m, ServerName** ret, ServerType type,
                    const char* string)
{
