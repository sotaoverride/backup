...
class int_adapter
{
  public:
    ...
    inline int_adapter operator+(const int_adapter<rhs_type>& rhs) const
    {
        ...
        return int_adapter<int_type>(value_ +
                                     static_cast<int_type>(rhs.as_number()));
    }
  ...
  private:
    ...
    int_adapter mult_div_specials(const int_adapter& rhs) const
    {
        ...
        BOOST_CONSTEXPR_OR_CONST int min_value =
            std::numeric_limits<int_type>::is_signed ? 0 : 1;
...
// template<class charT = char, class traits = std::traits<charT>, typename
// int_type>
