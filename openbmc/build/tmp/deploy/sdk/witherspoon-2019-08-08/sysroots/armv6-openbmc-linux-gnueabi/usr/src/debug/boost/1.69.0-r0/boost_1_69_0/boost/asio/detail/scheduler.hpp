                  ...
                  public thread_context
{
  public:
    ...
    BOOST_ASIO_DECL std::size_t wait_one(long usec,
  ...
  private:
    ...
    BOOST_ASIO_DECL std::size_t
        do_wait_one(mutex::scoped_lock& lock, thread_info& this_thread,
                    long usec, const boost::system::error_code& ec);

    // Poll for at most one operation.
    BOOST_ASIO_DECL std::size_t
        do_poll_one(mutex::scoped_lock& lock, thread_info& this_thread,
                    const boost::system::error_code& ec);
    ...
    BOOST_ASIO_DECL void wake_one_thread_and_unlock(mutex::scoped_lock& lock);
