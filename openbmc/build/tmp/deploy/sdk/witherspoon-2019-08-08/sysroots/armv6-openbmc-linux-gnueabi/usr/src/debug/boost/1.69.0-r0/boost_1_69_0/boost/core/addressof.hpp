...
template <class T>
BOOST_CONSTEXPR inline T* addressof(T& o) BOOST_NOEXCEPT
{
...
{
  public:
    BOOST_FORCEINLINE addrof_ref(T& o) BOOST_NOEXCEPT : o_(o)
    {
    }
...
struct addrof<const volatile addrof_null_t>
{
    ...
    defined(BOOST_NO_CXX11_CONSTEXPR) || defined(BOOST_NO_CXX11_DECLTYPE)
#define BOOST_CORE_NO_CONSTEXPR_ADDRESSOF

template <class T>
BOOST_FORCEINLINE T* addressof(T& o) BOOST_NOEXCEPT
{
...
template <class T, std::size_t N>
BOOST_FORCEINLINE T (*addressof(T (&o)[N]) BOOST_NOEXCEPT)[N]
{
...
template <class T>
struct addrof_member_operator<
    T, typename addrof_void<decltype(addrof_declval<T&>().operator&())>::type>
{
...
addrof_addressable* operator&(addrof_addressable&)BOOST_NOEXCEPT;
#endif
...
template <class T>
struct addrof_non_member_operator<
    T, typename addrof_void<decltype(operator&(addrof_declval<T&>()))>::type>
{
    static constexpr bool value = true;
};
...
template <class T>
struct addrof_expression<
    T, typename addrof_void<decltype(&addrof_declval<T&>())>::type>
{
    static constexpr bool value = true;
};
...
template <class T>
BOOST_FORCEINLINE typename addrof_if<!addrof_is_constexpr<T>::value, T>::type
