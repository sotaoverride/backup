...
#define POPT_ARG_CALLBACK                                                      \
    5U /*!< table-wide callback... must be                                     \
set first in table; arg points                                                 \
to callback, descrip points to                                                 \
callback data to pass */
#define POPT_ARG_INTL_DOMAIN                                                   \
    6U                        /*!< set the translation domain                  \
...
#define POPT_ARG_MAINCALL                                                      \
    16U + 11U              /*!< EXPERIMENTAL: return (*arg) (argc, argv) */
...
#define POPT_ARGFLAG_STRIP                                                     \
    0x20000000U /*!< strip this arg from argv(only applies to long args) */
...
#define POPT_ARGFLAG_SHOW_DEFAULT                                              \
    0x00800000U                         /*!< show default value in --help */
...
#define POPT_CBFLAG_INC_DATA                                                   \
    0x20000000U /*!< use data from the include line,                           \
not the subtable */
...
#define POPT_ERROR_BADOPERATION                                                \
    -19 /*!< mutually exclusive logical operations requested */
...
#define POPT_CONTEXT_ARG_OPTS                                                  \
    (1U << 4) /*!< return args as options with value 0 */
/*@}*/
...
poptContext poptGetContext(
    /*@dependent@*/ /*@keep@*/ const char* name, int argc,
...
/*@only@*/ /*@null@*/ /*@unused@*/
poptContext
    poptInit(int argc, /*@dependent@*/ /*@keep@*/ const char** argv,
             /*@dependent@*/ /*@keep@*/ const struct poptOption* options,
...
* The result is:
\verbatim
--aaa --bbb --ccc --bla="bla" --this_is="fdsafdas" --5555="55555" --test="with
lots of spaces" \endverbatim
*
