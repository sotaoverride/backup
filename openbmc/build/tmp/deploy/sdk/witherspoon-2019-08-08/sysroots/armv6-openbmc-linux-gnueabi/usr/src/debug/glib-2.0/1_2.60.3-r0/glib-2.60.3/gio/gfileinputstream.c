...
static gboolean g_file_input_stream_seekable_truncate(GSeekable* seekable,
                                                      ...
                                                      GCancellable* cancellable,
                                                      GError** error);
static void g_file_input_stream_real_query_info_async(
    GFileInputStream* stream, const char* attributes, int io_priority,
    GCancellable* cancellable, GAsyncReadyCallback callback,
    gpointer user_data);
static GFileInfo* g_file_input_stream_real_query_info_finish(
...
G_DEFINE_TYPE_WITH_CODE(
    GFileInputStream, g_file_input_stream, G_TYPE_INPUT_STREAM,
    ...
    GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (!g_input_stream_set_pending(input_stream, &error))
    {
        g_task_report_error(stream, callback, user_data,
                            g_file_input_stream_query_info_async, error);
        return;
    }
...
static gboolean g_file_input_stream_seek(GFileInputStream* stream,
...
static gboolean g_file_input_stream_seekable_seek(GSeekable* seekable,
                                                  ...
                                                  GError** error)
{
    return g_file_input_stream_seek(G_FILE_INPUT_STREAM(seekable), offset, type,
                                    cancellable, error);
}
...
static GFileInfo* g_file_input_stream_real_query_info_finish(
    GFileInputStream* stream, GAsyncResult* res, GError** error)
{
