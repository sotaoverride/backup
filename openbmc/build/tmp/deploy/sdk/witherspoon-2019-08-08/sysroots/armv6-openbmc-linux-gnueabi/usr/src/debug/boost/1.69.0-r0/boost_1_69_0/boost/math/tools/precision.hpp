...
// when code tries to use these functions, unless you explicitly specialise
// them.
...
inline BOOST_MATH_CONSTEXPR int
    digits(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(T)) BOOST_NOEXCEPT
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T max_value(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
...
template <class T>
inline BOOST_MATH_CONSTEXPR T min_value(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
    BOOST_STATIC_ASSERT(::std::numeric_limits<T>::is_specialized);
...
//
template <class T>
inline BOOST_MATH_CONSTEXPR T log_max_value(
    const mpl::int_<128>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
    return 88.0f;
}
...
template <class T>
inline BOOST_MATH_CONSTEXPR T log_min_value(
    const mpl::int_<128>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
    return -87.0f;
...
template <class T>
inline BOOST_MATH_CONSTEXPR T log_max_value(
    const mpl::int_<1024>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
    return 709.0;
}
...
template <class T>
inline BOOST_MATH_CONSTEXPR T log_max_value(
    const mpl::int_<16384>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
    BOOST_MATH_NOEXCEPT(T)
{
    return 11356.0L;
}
...
inline T log_max_value(
    const mpl::int_<0>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
...
inline BOOST_MATH_CONSTEXPR T
    epsilon(const mpl::true_& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
        BOOST_MATH_NOEXCEPT(T)
{
...
template <>
inline BOOST_MATH_CONSTEXPR long double epsilon<long double>(
    const mpl::true_& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(long double))
    BOOST_MATH_NOEXCEPT(long double)
{
...
inline T epsilon(const mpl::false_& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
    ...
    BOOST_MATH_STD_USING // for ADL of std names
        return ldexp(static_cast<T>(1),
                     1 - policies::digits<T, policies::policy<>>());
}
...
struct log_limit_traits
{
    typedef typename mpl::if_c<
        ...
        mpl::int_<(
            std::numeric_limits<T>::max_exponent > INT_MAX
                ? INT_MAX
                : static_cast<int>(std::numeric_limits<T>::max_exponent))>,
...
struct log_limit_noexcept_traits_imp : public log_limit_traits<T>
{
};
template <class T>
struct log_limit_noexcept_traits_imp<T, false>
    : public boost::integral_constant<bool, false>
{
};

template <class T>
struct log_limit_noexcept_traits
    : public log_limit_noexcept_traits_imp<T, BOOST_MATH_IS_FLOAT(T)>
{
};
...
inline BOOST_MATH_CONSTEXPR
    T log_max_value(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
        BOOST_NOEXCEPT_IF(detail::log_limit_noexcept_traits<T>::value)
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
    return detail::log_max_value<T>(
        typename detail::log_limit_traits<T>::tag_type());
#else
    BOOST_ASSERT(::std::numeric_limits<T>::is_specialized);
    BOOST_MATH_STD_USING
...
template <class T>
inline BOOST_MATH_CONSTEXPR T epsilon(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(T))
    BOOST_MATH_NOEXCEPT(T)
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
    return detail::epsilon<T>(
...
template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon_imp(const mpl::int_<24>&)
    BOOST_MATH_NOEXCEPT(T)
{
    return static_cast<T>(
        0.00034526698300124390839884978618400831996329879769945L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon_imp(const T*, const mpl::int_<53>&)
    BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon_imp(const T*, const mpl::int_<64>&)
    BOOST_MATH_NOEXCEPT(T)
{
    return static_cast<T>(
        0.32927225399135962333569506281281311031656150598474e-9L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon_imp(const T*, const mpl::int_<113>&)
    BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon_imp(const mpl::int_<24>&)
    BOOST_MATH_NOEXCEPT(T)
{
    return static_cast<T>(
        0.0049215666011518482998719164346805794944150447839903L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon_imp(const T*, const mpl::int_<53>&)
    BOOST_MATH_NOEXCEPT(T)
{
    return static_cast<T>(
        6.05545445239333906078989272793696693569753008995e-6L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon_imp(const T*, const mpl::int_<64>&)
    BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon_imp(const T*, const mpl::int_<113>&)
    BOOST_MATH_NOEXCEPT(T)
{
    return static_cast<T>(
        5.7749313854154005630396773604745549542403508090496e-12L);
}
...
template <class T>
inline BOOST_MATH_CONSTEXPR T forth_root_epsilon_imp(const T*,
                                                     const mpl::int_<24>&)
    BOOST_MATH_NOEXCEPT(T)
{
    return static_cast<T>(
        0.018581361171917516667460937040007436176452688944747L);
}
...
{
    return static_cast<T>(
        0.18145860519450699870567321328132261891067079047605e-4L);
}
...
{
    typedef mpl::int_<(::std::numeric_limits<T>::radix == 2) &&
                              (::std::numeric_limits<T>::digits != INT_MAX)
                          ? std::numeric_limits<T>::digits
                          : 0>
        tag_type;
    BOOST_STATIC_CONSTANT(bool, has_noexcept = (tag_type::value == 113) ||
                                               (tag_type::value == 64) ||
                                               (tag_type::value == 53) ||
                                               (tag_type::value == 24));
};
...
template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon()
    BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) &&
                      detail::root_epsilon_traits<T>::has_noexcept)
{
    return detail::root_epsilon_imp(
        static_cast<T const*>(0),
        typename detail::root_epsilon_traits<T>::tag_type());
}
...
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon()
    BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) &&
                      detail::root_epsilon_traits<T>::has_noexcept)
{
    return detail::cbrt_epsilon_imp(
        static_cast<T const*>(0),
        typename detail::root_epsilon_traits<T>::tag_type());
}

template <class T>
inline BOOST_MATH_CONSTEXPR T forth_root_epsilon()
    BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) &&
                      detail::root_epsilon_traits<T>::has_noexcept)
{
    return detail::forth_root_epsilon_imp(
        static_cast<T const*>(0),
        typename detail::root_epsilon_traits<T>::tag_type());
}
