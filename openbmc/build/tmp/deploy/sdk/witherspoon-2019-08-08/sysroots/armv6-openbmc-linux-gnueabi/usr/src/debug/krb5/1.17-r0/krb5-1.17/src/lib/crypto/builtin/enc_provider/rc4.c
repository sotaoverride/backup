...
static krb5_error_code k5_arcfour_init(ArcfourContext* ctx,
...
static krb5_error_code k5_arcfour_docrypt(krb5_key key, const krb5_data* state,
    ...
    for (i = 0; i < num_data; i++)
    {
        ...
        if (ENCRYPT_IOV(iov))
            k5_arcfour_crypt(arcfour_ctx, (unsigned char*)iov->data.data,
                             (const unsigned char*)iov->data.data,
                             iov->data.length);
    }
...
static krb5_error_code k5_arcfour_init_state(const krb5_keyblock* key,
...
const struct krb5_enc_provider krb5int_enc_arcfour = {
    ...
    16, 16, k5_arcfour_docrypt, k5_arcfour_docrypt, NULL,
