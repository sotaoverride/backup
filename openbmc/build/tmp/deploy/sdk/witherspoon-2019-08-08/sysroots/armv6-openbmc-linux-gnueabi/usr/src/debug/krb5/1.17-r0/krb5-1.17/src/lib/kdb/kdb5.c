...
static void free_mkey_list(krb5_context context, krb5_keylist_node* mkey_list)
{
...
void krb5_dbe_free_key_data_contents(krb5_context context, krb5_key_data* key)
{
    int i, idx;
...
void krb5_dbe_free_key_list(krb5_context context, krb5_keylist_node* val)
{
...
void krb5_dbe_free_actkvno_list(krb5_context context, krb5_actkvno_node* val)
{
...
void krb5_dbe_free_mkey_aux_list(krb5_context context, krb5_mkey_aux_node* val)
{
...
void krb5_dbe_free_tl_data(krb5_context context, krb5_tl_data* tl_data)
{
    if (tl_data)
    {
...
void krb5_dbe_free_strings(krb5_context context, krb5_string_attr* strings,
                           int count)
{
    int i;
...
void krb5_dbe_free_string(krb5_context context, char* string)
{
    free(string);
}
...
static krb5_error_code get_conf_section(krb5_context context, char** section)
{
...
static krb5_error_code kdb_get_library_name(krb5_context kcontext,
                                            char** libname_out)
{
...
static void copy_vtable(const kdb_vftabl* in, kdb_vftabl* out)
{
...
static krb5_error_code kdb_load_library(krb5_context kcontext, char* lib_name,
                                        db_library* libptr)
{
    krb5_error_code status;
    db_library lib;
                                        ...
                                        db_library* lib)
{
    ...
    *lib = calloc((size_t)1, sizeof(**lib));
    ...
    if ((status =
             krb5int_open_plugin_dirs((const char**)path, filebases,
    ...
    if ((status = krb5int_get_plugin_dir_data(&(*lib)->dl_dir_handle,
                                              "kdb_function_table",
    ...
    if (vftabl_addrs[0] == NULL)
    {
        ...
        k5_setmsg(kcontext, status,
                  _("Unable to load requested database module '%s': plugin "
                    "symbol 'kdb_function_table' not found"),
                  lib_name);
        goto clean_n_exit;
    }

    if (((kdb_vftabl*)vftabl_addrs[0])->maj_ver != KRB5_KDB_DAL_MAJOR_VERSION)
    {
...
static krb5_error_code kdb_find_library(krb5_context kcontext, char* lib_name,
                                        db_library* lib)
{
...
static krb5_error_code get_vftabl(krb5_context kcontext,
                                  kdb_vftabl** vftabl_ptr)
{
    krb5_error_code status;
...
static void free_tl_data(krb5_tl_data* list)
{
    krb5_tl_data* next;
...
static krb5_error_code extract_db_args_from_tl_data(krb5_context kcontext,
                                                    krb5_tl_data** start,
                                                    krb5_int16* count,
                                                    char*** db_argsp)
{
    ...
    while (curr)
    {
        if (curr->tl_data_type == KRB5_TL_DB_ARGS)
        {
            ...
            db_args_size++;
            t = realloc(db_args,
                        sizeof(char*) * (db_args_size + 1)); /* 1 for NULL */
            if (t == NULL)
            {
                status = ENOMEM;
                goto clean_n_exit;
...
krb5_error_code krb5int_put_principal_no_log(krb5_context kcontext,
                                             krb5_db_entry* entry)
{
    kdb_vftabl* v;
    krb5_error_code status;
...
krb5_error_code krb5int_delete_principal_no_log(krb5_context kcontext,
                                         ...
                                         krb5_principal target)
{
    ...
    status =
        krb5_db_get_principal(kcontext, target, KRB5_KDB_FLAG_ALIAS_OK, &entry);
    if (status == 0)
    {
...
static int sort_entry_callback_proxy(krb5_pointer func_arg,
                                     krb5_db_entry* entry)
{
...
krb5_error_code krb5_db_iterate(krb5_context kcontext, char* match_entry,
                                int (*func)(krb5_pointer, krb5_db_entry*),
...
krb5_keylist_node* krb5_db_mkey_list_alias(krb5_context kcontext)
{
    return kcontext->dal_handle->master_keylist;
}

krb5_error_code krb5_db_fetch_mkey_list(krb5_context context,
...
krb5_error_code krb5_db_store_master_key(krb5_context kcontext, char* keyfile,
                                         ...
                                         krb5_keyblock* key, char* master_pwd)
{
    ...
    return v->store_master_key_list(kcontext, keyfile, mname, &list,
                                    master_pwd);
}
...
krb5_error_code krb5_db_fetch_mkey(krb5_context context, krb5_principal mname,
                                   krb5_enctype etype,
                                   krb5_boolean fromkeyboard,
                                   krb5_boolean twice, char* db_args,
                                   krb5_kvno* kvno, krb5_data* salt,
                                   krb5_keyblock* key)
{
    ...
    if (fromkeyboard)
    {
        ...
        retval = krb5_c_string_to_key(context, etype, &pwd,
                                      salt ? salt : &scratch, key);
        /*
...
krb5_error_code krb5_dbe_fetch_act_key_list(krb5_context context,
...
static krb5_kvno find_actkvno(krb5_actkvno_node* list, krb5_timestamp now)
{
    /*
...
static krb5_keyblock* find_master_key(krb5_context context, krb5_kvno kvno)
{
    krb5_keylist_node* n;
...
krb5_error_code krb5_dbe_find_act_mkey(krb5_context context,
 ...
 * free the output key.
 */
krb5_error_code krb5_dbe_find_mkey(krb5_context context, krb5_db_entry* entry,
                                   krb5_keyblock** mkey)
{
    krb5_kvno mkvno;
    krb5_error_code retval;
...
void* krb5_db_alloc(krb5_context kcontext, void* ptr, size_t size)
{
    return realloc(ptr, size);
}

void krb5_db_free(krb5_context kcontext, void* ptr)
{
    free(ptr);
}
...
krb5_error_code krb5_dbe_find_enctype(krb5_context kcontext,
                                      krb5_db_entry* dbentp, krb5_int32 ktype,
                                      krb5_int32 stype, krb5_int32 kvno,
                                      krb5_key_data** kdatap)
{
    krb5_int32 start = 0;
    return krb5_dbe_search_enctype(kcontext, dbentp, &start, ktype, stype, kvno,
                                   kdatap);
}
...
krb5_error_code krb5_db_setup_mkey_name(krb5_context context,
                                        const char* keyname, const char* realm,
                                        char** fullname,
...
krb5_error_code krb5_dbe_lookup_last_pwd_change(krb5_context context,
                                                krb5_db_entry* entry,
...
krb5_error_code krb5_dbe_lookup_last_admin_unlock(krb5_context context,
                                                  krb5_db_entry* entry,
                                                  krb5_timestamp* stamp)
{
    krb5_tl_data tl_data;
...
krb5_error_code krb5_dbe_lookup_tl_data(krb5_context context,
                                        krb5_db_entry* entry,
...
krb5_error_code krb5_dbe_create_key_data(krb5_context context,
                                         krb5_db_entry* entry)
{
...
krb5_error_code krb5_dbe_update_mod_princ_data(krb5_context context,
                                               krb5_db_entry* entry,
                                               ...
                                               krb5_const_principal mod_princ)
{
    ...
    if ((nextloc = (krb5_octet*)malloc(unparse_mod_princ_size + 4)) == NULL)
    {
...
krb5_error_code krb5_dbe_lookup_mod_princ_data(krb5_context context,
                                               krb5_db_entry* entry,
                                               ...
                                               krb5_principal* mod_princ)
{
    ...
    *mod_time = 0;
    ...
    /* Mod Princ */
    if ((code = krb5_parse_name(
             context, (const char*)(tl_data.tl_data_contents + 4), mod_princ)))
        return (code);

    return (0);
}

krb5_error_code krb5_dbe_lookup_mkvno(krb5_context context,
                                      krb5_db_entry* entry, krb5_kvno* mkvno)
{
    krb5_tl_data tl_data;
    krb5_error_code code;
    krb5_int16 tmp;
...
krb5_error_code krb5_dbe_get_mkvno(krb5_context context, krb5_db_entry* entry,
                                   krb5_kvno* mkvno)
{
    krb5_error_code code;
    krb5_kvno kvno;
...
krb5_error_code krb5_dbe_update_mkvno(krb5_context context,
                                      krb5_db_entry* entry, krb5_kvno mkvno)
{
    krb5_tl_data tl_data;
                             ...
                             krb5_mkey_aux_node** mkey_aux_data_list)
{
    ...
    krb5_mkey_aux_node *head_data = NULL, *new_data = NULL, *prev_data = NULL;
    ...
    else
    {
        ...
        if (version == 1)
        {
            ...
            while (curloc < (tl_data.tl_data_contents + tl_data.tl_data_length))
            {
                ...
                new_data =
                    (krb5_mkey_aux_node*)malloc(sizeof(krb5_mkey_aux_node));
                if (new_data == NULL)
                {
                ...
                krb5_kdb_decode_int16(curloc,
                                      new_data->latest_mkey.key_data_kvno);
                curloc += sizeof(krb5_ui_2);
                krb5_kdb_decode_int16(curloc,
                                      new_data->latest_mkey.key_data_type[0]);
                curloc += sizeof(krb5_ui_2);
                krb5_kdb_decode_int16(curloc,
                                      new_data->latest_mkey.key_data_length[0]);
                curloc += sizeof(krb5_ui_2);

                new_data->latest_mkey.key_data_contents[0] =
                    (krb5_octet*)malloc(
                        new_data->latest_mkey.key_data_length[0]);
...
krb5_error_code krb5_dbe_update_mkey_aux(krb5_context context,
                                         krb5_db_entry* entry,
                                         krb5_mkey_aux_node* mkey_aux_data_list)
{
    krb5_error_code status;
...
/*
 * If version of the KRB5_TL_ACTKVNO data is KRB5_TL_ACTKVNO_VER == 1 then size
 * of a actkvno tuple {act_kvno, act_time} entry is:
 */
...
#define act_time(cp)                                                           \
    ((cp) + sizeof(krb5_int16)) /* return pointer to start of act_time data */
#endif

krb5_error_code krb5_dbe_lookup_actkvno(krb5_context context,
                                        krb5_db_entry* entry,
                                        krb5_actkvno_node** actkvno_list)
{
    ...
    else
    {
        ...
        if (version == 1)
        {
             ...
             */
            num_actkvno =
                (tl_data.tl_data_length - sizeof(version)) / ACTKVNO_TUPLE_SIZE;
            prev_data = NULL;
            ...
            {
                new_data =
                    (krb5_actkvno_node*)malloc(sizeof(krb5_actkvno_node));
                if (new_data == NULL)
                {
 ...
 */
#if KRB5_TL_ACTKVNO_VER == 1
krb5_error_code krb5_dbe_update_actkvno(krb5_context context,
                                        krb5_db_entry* entry,
                                        const krb5_actkvno_node* actkvno_list)
{
    ...
    new_tl_data.tl_data_contents =
        (krb5_octet*)malloc(new_tl_data.tl_data_length);
         ...
         cur_actkvno = cur_actkvno->next)
    {
        ...
        tmpptr =
            realloc(new_tl_data.tl_data_contents, new_tl_data.tl_data_length);
        if (tmpptr == NULL)
        {
         ...
         */
        nextloc = new_tl_data.tl_data_contents + new_tl_data.tl_data_length -
                  ACTKVNO_TUPLE_SIZE;
...
krb5_error_code krb5_dbe_update_last_pwd_change(krb5_context context,
                                                krb5_db_entry* entry,
                                                krb5_timestamp stamp)
{
    krb5_tl_data tl_data;
...
krb5_error_code krb5_dbe_update_last_admin_unlock(krb5_context context,
                                                  krb5_db_entry* entry,
                                                  krb5_timestamp stamp)
{
    krb5_tl_data tl_data;
 ...
 */
static krb5_error_code begin_attrs(krb5_context context, krb5_db_entry* entry,
                                   const char** pos_out, const char** end_out)
{
    krb5_error_code code;
    krb5_tl_data tl_data;
...
static krb5_boolean next_attr(const char** pos, const char* end,
...
krb5_error_code krb5_dbe_get_strings(krb5_context context, krb5_db_entry* entry,
...
krb5_error_code krb5_dbe_get_string(krb5_context context, krb5_db_entry* entry,
...
krb5_error_code krb5_dbe_set_string(krb5_context context, krb5_db_entry* entry,
...
krb5_error_code krb5_dbe_delete_tl_data(krb5_context context,
                                        krb5_db_entry* entry,
...
krb5_error_code krb5_db_update_tl_data(krb5_context context,
                                       ...
                                       krb5_tl_data* new_tl_data)
{
    ...
    { /* db_args can be multiple */
        for (tl_data = *tl_datap; tl_data; tl_data = tl_data->tl_data_next)
...
krb5_error_code krb5_dbe_update_tl_data(krb5_context context,
                                        krb5_db_entry* entry,
                                        krb5_tl_data* new_tl_data)
{
...
krb5_error_code krb5_dbe_compute_salt(krb5_context context,
                                      const krb5_key_data* key,
                                      krb5_const_principal princ,
                                      krb5_int16* salttype_out,
                                      krb5_data** salt_out)
{
    krb5_error_code retval;
    krb5_int16 stype;
    ...
    *salt_out = NULL;
    ...
    switch (stype)
    {
        ...
        case KRB5_KDB_SALTTYPE_SPECIAL:
            sdata =
                make_data(key->key_data_contents[1], key->key_data_length[1]);
...
krb5_error_code krb5_dbe_specialize_salt(krb5_context context,
                                         krb5_db_entry* entry)
{
    krb5_int16 stype, i;
    krb5_data* salt;
...
krb5_error_code krb5_dbe_cpw(krb5_context kcontext, krb5_keyblock* master_key,
                             krb5_key_salt_tuple* ks_tuple, int ks_tuple_count,
                             char* passwd, int new_kvno, krb5_boolean keepold,
                             krb5_db_entry* db_entry)
{
    ...
    if (status)
        return status;
    return v->change_pwd(kcontext, master_key, ks_tuple, ks_tuple_count, passwd,
                         new_kvno, keepold, db_entry);
}

/* policy management functions */
krb5_error_code krb5_db_create_policy(krb5_context kcontext,
...
krb5_error_code krb5_db_get_policy(krb5_context kcontext, char* name,
                                   osa_policy_ent_t* policy)
{
    krb5_error_code status = 0;
    kdb_vftabl* v;
...
krb5_error_code krb5_db_put_policy(krb5_context kcontext,
                                   osa_policy_ent_t policy)
{
    krb5_error_code status = 0;
    kdb_vftabl* v;
...
krb5_error_code krb5_db_iter_policy(krb5_context kcontext, char* match_entry,
...
static krb5_error_code decrypt_iterator(krb5_context kcontext,
...
krb5_error_code krb5_dbe_decrypt_key_data(krb5_context kcontext,
                                          const krb5_keyblock* mkey,
                                          const krb5_key_data* key_data,
                                          krb5_keyblock* dbkey,
                                          krb5_keysalt* keysalt)
{
    ...
    if (kcontext->dal_handle->master_keylist)
    {
        ...
        if (krb5_db_fetch_mkey_list(
                kcontext, kcontext->dal_handle->master_princ, cur_mkey) == 0)
            return decrypt_iterator(kcontext, key_data, dbkey, keysalt);
    }
    return status;
}

krb5_error_code krb5_dbe_encrypt_key_data(krb5_context kcontext,
                                          const krb5_keyblock* mkey,
...
krb5_error_code krb5_db_get_context(krb5_context context, void** db_context)
{
...
krb5_error_code krb5_db_set_context(krb5_context context, void* db_context)
{
...
krb5_error_code krb5_db_sign_authdata(
    krb5_context kcontext, unsigned int flags,
    krb5_const_principal client_princ, krb5_db_entry* client,
    krb5_db_entry* server, krb5_db_entry* krbtgt, krb5_keyblock* client_key,
    krb5_keyblock* server_key, krb5_keyblock* krbtgt_key,
    krb5_keyblock* session_key, krb5_timestamp authtime,
    krb5_authdata** tgt_auth_data, krb5_authdata*** signed_auth_data)
{
    krb5_error_code status = 0;
    kdb_vftabl* v;
                          ...
                          krb5_timestamp authtime, krb5_error_code error_code)
{
    ...
    if (status || v->audit_as_req == NULL)
        return;
    v->audit_as_req(kcontext, request, local_addr, remote_addr, client, server,
                    authtime, error_code);
}
...
void krb5_dbe_sort_key_data(krb5_key_data* key_data, size_t key_data_length)
{
    size_t i, j;
    krb5_key_data tmp;
