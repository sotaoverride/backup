...
*/
void krb5int_MD5Init(krb5_MD5_CTX* mdContext)
{
...
*/
void krb5int_MD5Update(krb5_MD5_CTX* mdContext, const unsigned char* inBuf,
                       unsigned int inLen)
{
    krb5_ui_4 in[16];
    int mdi;
...
*/
void krb5int_MD5Final(krb5_MD5_CTX* mdContext)
{
    krb5_ui_4 in[16];
    int mdi;
    unsigned int i, ii;
