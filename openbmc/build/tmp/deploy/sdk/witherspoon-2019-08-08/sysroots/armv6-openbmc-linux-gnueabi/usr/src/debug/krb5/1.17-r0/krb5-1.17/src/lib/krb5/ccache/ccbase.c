...
static krb5_error_code krb5int_cc_getops(krb5_context, const char*,
                                         const krb5_cc_ops**);
...
krb5_error_code KRB5_CALLCONV krb5_cc_register(krb5_context context,
                                               const krb5_cc_ops* ops,
 ...
 * prefix string.
 */
static krb5_error_code krb5int_cc_getops(krb5_context context, const char* pfx,
                                         const krb5_cc_ops** ops)
{
