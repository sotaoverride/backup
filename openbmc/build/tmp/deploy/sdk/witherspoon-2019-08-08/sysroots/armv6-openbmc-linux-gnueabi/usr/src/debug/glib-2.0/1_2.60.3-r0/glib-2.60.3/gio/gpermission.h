...
#define G_PERMISSION(inst)                                                     \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_PERMISSION, GPermission))
#define G_PERMISSION_CLASS(class)                                              \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_PERMISSION, GPermissionClass))
#define G_IS_PERMISSION(inst)                                                  \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_PERMISSION))
#define G_IS_PERMISSION_CLASS(class)                                           \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_PERMISSION))
#define G_PERMISSION_GET_CLASS(inst)                                           \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_PERMISSION, GPermissionClass))
