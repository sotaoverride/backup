...
{
    return ext2fs_u32_copy((ext2_u32_list)src, (ext2_u32_list*)dest);
}
...
errcode_t ext2fs_u32_list_add(ext2_u32_list bb, __u32 blk)
{
    ...
    if (bb->num >= bb->size)
    {
        ...
        bb->size += 100;
        retval =
            ext2fs_resize_mem(old_size, bb->size * sizeof(__u32), &bb->list);
        if (retval)
        {
            bb->size -= 100;
            return retval;
...
errcode_t ext2fs_u32_list_iterate_begin(ext2_u32_list bb, ext2_u32_iterate* ret)
{
...
{
    return ext2fs_u32_list_iterate((ext2_u32_iterate)iter, (__u32*)blk);
}
...
{
    return ext2fs_u32_list_equal((ext2_u32_list)bb1, (ext2_u32_list)bb2);
}
