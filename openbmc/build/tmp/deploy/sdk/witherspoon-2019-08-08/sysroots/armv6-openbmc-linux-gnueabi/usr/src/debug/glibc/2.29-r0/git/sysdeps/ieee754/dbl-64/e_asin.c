...
/***************************************************************************/
double SECTION __ieee754_asin(double x)
{
    ...
    else if (k < 0x3fc00000)
    {
        ...
        else
        {
            ...
            p = x1 * x1 * x1;
            s1 = a1.x * p;
            s2 = ((((((c7 * xx + c6) * xx + c5) * xx + c4) * xx + c3) * xx +
                   c2) *
                      xx * xx * x +
                  ((a1.x + a2.x) * x2 * x2 + 0.5 * x1 * x) * x2) +
                 a2.x * p;
            res1 = x + s1;
            s2 = ((x - res1) + s1) + s2;
            res = res1 + s2;
    ...
    else if (k < 0x3fe00000)
    {
        ...
        else
        {
            ...
            t = ((asncs.x[n + 8] - r) + xx * asncs.x[n + 9]) +
                (p + xx * asncs.x[n + 10]);
            res = r + t;
            cor = (r - res) + t;
    ...
    else if (k < 0x3fe80000)
    {
        ...
        else
        {
            ...
            t = ((asncs.x[n + 9] - r) + xx * asncs.x[n + 10]) +
                (p + xx * asncs.x[n + 11]);
            res = r + t;
            cor = (r - res) + t;
            if (res == res + 1.0005 * cor)
    ...
    else if (k < 0x3fed8000)
    {
        ...
        else
        {
            ...
            t = ((asncs.x[n + 10] - r) + xx * asncs.x[n + 11]) +
                (p + xx * asncs.x[n + 12]);
            res = r + t;
            cor = (r - res) + t;
    ...
    else if (k < 0x3fee8000)
    {
        ...
        else
        {
            ...
            t = ((asncs.x[n + 11] - r) + xx * asncs.x[n + 12]) +
                (p + xx * asncs.x[n + 13]);
            res = r + t;
            cor = (r - res) + t;
    ...
    else if (k < 0x3fef0000)
    {
        ...
        else
        {
            ...
            t = ((asncs.x[n + 12] - r) + xx * asncs.x[n + 13]) +
                (p + xx * asncs.x[n + 14]);
            res = r + t;
            cor = (r - res) + t;
            if (res == res + 1.0007 * cor)
