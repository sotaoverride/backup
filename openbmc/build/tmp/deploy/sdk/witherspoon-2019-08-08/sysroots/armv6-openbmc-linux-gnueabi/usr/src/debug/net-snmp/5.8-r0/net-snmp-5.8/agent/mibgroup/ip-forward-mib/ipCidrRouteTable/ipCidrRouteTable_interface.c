...
netsnmp_feature_child_of(ipCidrRouteTable_external_access, libnetsnmpmibs)
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_require(check_all_requests_error)
            ...
            netsnmp_feature_child_of(ipCidrRouteTable_container_size,
                                     ipCidrRouteTable_external_access)
                netsnmp_feature_child_of(ipCidrRouteTable_registration_set,
                                         ipCidrRouteTable_external_access)
                    netsnmp_feature_child_of(ipCidrRouteTable_registration_get,
                                             ipCidrRouteTable_external_access)
...
static void _ipCidrRouteTable_container_shutdown(
...
void ipCidrRouteTable_dirty_set(u_int status)
{
    DEBUGMSGTL(("ipCidrRouteTable:ipCidrRouteTable_dirty_set",
                "called. was %d, now %d\n", ipCidrRouteTable_if_ctx.table_dirty,
                status));
 ...
 */
void _ipCidrRouteTable_initialize_interface(
    ipCidrRouteTable_registration* reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods* access_multiplexer =
    ...
    DEBUGMSGTL(
        ("internal:ipCidrRouteTable:_ipCidrRouteTable_initialize_interface",
         "called\n"));
    ...
    reginfo = netsnmp_handler_registration_create(
        "ipCidrRouteTable", handler, ipCidrRouteTable_oid,
        ipCidrRouteTable_oid_size, HANDLER_CAN_BABY_STEP | HANDLER_CAN_RONLY);
    if (NULL == reginfo)
    {
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, ipCidrRouteTable_if_ctx.container,
 ...
 */
void _ipCidrRouteTable_shutdown_interface(
    ipCidrRouteTable_registration* reg_ptr)
{
    /*
...
void ipCidrRouteTable_valid_columns_set(netsnmp_column_info* vc)
{
                                  ...
                                  ipCidrRouteTable_mib_index* mib_idx)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipCidrRouteTable:ipCidrRouteTable_index_to_oid", "called\n"));

    /*
     * ipCidrRouteDest(1)/IPADDR/ASN_IPADDRESS/u_long(u_long)//l/A/w/e/r/d/h
     */
    snmp_set_var_value(&var_ipCidrRouteDest, (u_char*)&mib_idx->ipCidrRouteDest,
                       sizeof(mib_idx->ipCidrRouteDest));

    /*
     * ipCidrRouteMask(2)/IPADDR/ASN_IPADDRESS/u_long(u_long)//l/A/w/e/r/d/h
     */
    snmp_set_var_value(&var_ipCidrRouteMask, (u_char*)&mib_idx->ipCidrRouteMask,
                       sizeof(mib_idx->ipCidrRouteMask));

    /*
     * ipCidrRouteTos(3)/INTEGER32/ASN_INTEGER/long(long)//l/A/w/e/R/d/h
     */
    snmp_set_var_value(&var_ipCidrRouteTos, (u_char*)&mib_idx->ipCidrRouteTos,
 ...
 */
int ipCidrRouteTable_index_from_oid(netsnmp_index* oid_idx,
                                    ipCidrRouteTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
     ...
     */
    err = parse_oid_indexes(oid_idx->oids, oid_idx->len, &var_ipCidrRouteDest);
                                         ...
                                         void* user_init_ctx)
{
    ...
    DEBUGMSGTL(
        ("internal:ipCidrRouteTable:ipCidrRouteTable_allocate_rowreq_ctx",
         "called\n"));
 ...
 */
void ipCidrRouteTable_release_rowreq_ctx(
    ipCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("internal:ipCidrRouteTable:ipCidrRouteTable_release_rowreq_ctx",
                "called\n"));
 ...
 * wrapper
 */
static int _mfd_ipCidrRouteTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_pre_request",
                "called\n"));

    if (1 != netsnmp_row_merge_status_first(reginfo, agtreq_info))
    {
        DEBUGMSGTL(
            ("internal:ipCidrRouteTable", "skipping additional pre_request\n"));
 ...
 * wrapper
 */
static int _mfd_ipCidrRouteTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipCidrRouteTable_rowreq_ctx* rowreq_ctx =
        (ipCidrRouteTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    int rc, packet_rc;

    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_post_request",
                "called\n"));
    ...
    {
        DEBUGMSGTL(
            ("internal:ipCidrRouteTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && ipCidrRouteTable_dirty_get())
    {
         ...
         * the dirty flags.
         */
        snmp_log(LOG_WARNING, "ipCidrRouteTable dirty flag set in post_request "
                              "but status != SUCCESS.\n");
    }
...
static ipCidrRouteTable_rowreq_ctx*
    _mfd_ipCidrRouteTable_rowreq_from_index(netsnmp_index* oid_idx, int* rc_ptr)
{
    ipCidrRouteTable_rowreq_ctx* rowreq_ctx;
    ipCidrRouteTable_mib_index mib_idx;
    int rc;
    ...
    DEBUGMSGTL(
        ("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_rowreq_from_index",
         "called\n"));
 ...
 * wrapper
 */
static int _mfd_ipCidrRouteTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_object_lookup",
                "called\n"));
                                 ...
                                 netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_get_column",
                "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IPCIDRROUTEDEST:
            ...
            memcpy(var->val.integer, &rowreq_ctx->tbl_idx.ipCidrRouteDest,
                   sizeof(in_addr_t));
            break;
        ...
        case COLUMN_IPCIDRROUTEMASK:
            var->type = ASN_IPADDRESS;
            var->val_len = sizeof(in_addr_t);
            memcpy(var->val.integer, &rowreq_ctx->tbl_idx.ipCidrRouteMask,
                   sizeof(in_addr_t));
            break;
        ...
        case COLUMN_IPCIDRROUTENEXTHOP:
            var->type = ASN_IPADDRESS;
            var->val_len = sizeof(in_addr_t);
            memcpy(var->val.integer, &rowreq_ctx->tbl_idx.ipCidrRouteNextHop,
                   sizeof(in_addr_t));
            break;
        ...
        case COLUMN_IPCIDRROUTENEXTHOPAS:
            var->val_len = sizeof(long);
            var->type = ASN_INTEGER;
            rc = ipCidrRouteNextHopAS_get(rowreq_ctx, (long*)var->val.string);
            break;
...
int _mfd_ipCidrRouteTable_get_values(netsnmp_mib_handler* handler,
                                     netsnmp_handler_registration* reginfo,
                                     ...
                                     netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_get_values",
                "called\n"));
    ...
    _ipCidrRouteTable_check_indexes(ipCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_ipCidrRouteTable_check_indexes",
                "called\n"));
     ...
     */
    return ipCidrRouteTable_validate_index(ipCidrRouteTable_if_ctx.user_ctx,
                                           rowreq_ctx);
                                   ...
                                   netsnmp_variable_list* var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPCIDRROUTEIFINDEX:
            ...
            {
                DEBUGMSGTL(
                    ("ipCidrRouteTable:_ipCidrRouteTable_check_column:"
                     "ipCidrRouteIfIndex",
        ...
        case COLUMN_IPCIDRROUTEINFO:
            ...
            {
                rc = ipCidrRouteInfo_check_value(
                    rowreq_ctx, (oid*)var->val.string, var->val_len);
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log(LOG_ERR,
        ...
        case COLUMN_IPCIDRROUTENEXTHOPAS:
            ...
            {
                rc = ipCidrRouteNextHopAS_check_value(
...
int _mfd_ipCidrRouteTable_check_objects(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        netsnmp_agent_request_info* agtreq_info,
                                        netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_check_objects",
                "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipCidrRouteTable_check_column(rowreq_ctx, requests->requestvb,
                                            tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error(requests, SNMP_VALIDATE_ERR(rc));
 ...
 */
NETSNMP_STATIC_INLINE int
    _ipCidrRouteTable_undo_setup_column(ipCidrRouteTable_rowreq_ctx* rowreq_ctx,
                                        int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(("internal:ipCidrRouteTable:_ipCidrRouteTable_undo_setup_column",
                "called for %d\n", column));
 ...
 * undo setup
 */
int _mfd_ipCidrRouteTable_undo_setup(netsnmp_mib_handler* handler,
                                     netsnmp_handler_registration* reginfo,
                                     netsnmp_agent_request_info* agtreq_info,
                                     netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_undo_setup",
                "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL(("ipCidrRouteTable:mfd",
                    "error %d from "
    ...
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _ipCidrRouteTable_undo_setup_column(rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL(("ipCidrRouteTable:mfd",
                            "error %d from "
 ...
 * undo setup
 */
int _mfd_ipCidrRouteTable_undo_cleanup(netsnmp_mib_handler* handler,
                                       netsnmp_handler_registration* reginfo,
                                       netsnmp_agent_request_info* agtreq_info,
                                       netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_undo_cleanup",
                "called\n"));
                                 ...
                                 netsnmp_variable_list* var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPCIDRROUTEIFINDEX:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTEIFINDEX_FLAG;
            rc = ipCidrRouteIfIndex_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_IPCIDRROUTETYPE:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTETYPE_FLAG;
            rc = ipCidrRouteType_set(rowreq_ctx, *((u_long*)var->val.string));
            break;
        ...
        case COLUMN_IPCIDRROUTENEXTHOPAS:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTENEXTHOPAS_FLAG;
            rc =
                ipCidrRouteNextHopAS_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC1:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTEMETRIC1_FLAG;
            rc = ipCidrRouteMetric1_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC2:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTEMETRIC2_FLAG;
            rc = ipCidrRouteMetric2_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC3:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTEMETRIC3_FLAG;
            rc = ipCidrRouteMetric3_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC4:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTEMETRIC4_FLAG;
            rc = ipCidrRouteMetric4_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC5:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTEMETRIC5_FLAG;
            rc = ipCidrRouteMetric5_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_IPCIDRROUTESTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTESTATUS_FLAG;
            rc = ipCidrRouteStatus_set(rowreq_ctx, *((u_long*)var->val.string));
            break;
...
int _mfd_ipCidrRouteTable_set_values(netsnmp_mib_handler* handler,
                                     netsnmp_handler_registration* reginfo,
                                     netsnmp_agent_request_info* agtreq_info,
                                     netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_set_values",
                "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipCidrRouteTable_set_column(rowreq_ctx, requests->requestvb,
                                          tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL(("ipCidrRouteTable:mfd",
 ...
 * commit the values
 */
int _mfd_ipCidrRouteTable_commit(netsnmp_mib_handler* handler,
                                 netsnmp_handler_registration* reginfo,
                                 netsnmp_agent_request_info* agtreq_info,
                                 netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_commit", "called\n"));
    ...
    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
         ...
         */
        ipCidrRouteTable_dirty_set(ipCidrRouteTable_dirty_get() +
...
int _mfd_ipCidrRouteTable_undo_commit(netsnmp_mib_handler* handler,
                                      netsnmp_handler_registration* reginfo,
                                      netsnmp_agent_request_info* agtreq_info,
                                      netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_undo_commit",
                "called\n"));
...
int _mfd_ipCidrRouteTable_undo_values(netsnmp_mib_handler* handler,
                                      netsnmp_handler_registration* reginfo,
                                      netsnmp_agent_request_info* agtreq_info,
                                      netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_undo_values",
                "called\n"));
 ...
 */
int _mfd_ipCidrRouteTable_irreversible_commit(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipCidrRouteTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_irreversible:commit",
         "called\n"));
    ...
    else
    {
        ...
        {
            rowreq_ctx->rowreq_flags &= ~MFD_ROW_CREATED;
            CONTAINER_INSERT(ipCidrRouteTable_if_ctx.container, rowreq_ctx);
        }
    }
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
    ...
    {
        snmp_log(LOG_ERR, "invalid cache for ipCidrRouteTable_cache_load\n");
        return -1;
    }
     ...
     * call user code
     */
    return ipCidrRouteTable_container_load((netsnmp_container*)cache->magic);
} /* _cache_load */
...
static void _cache_free(netsnmp_cache* cache, void* magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log(LOG_ERR, "invalid cache in ipCidrRouteTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free(ipCidrRouteTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(("internal:ipCidrRouteTable:_container_item_free", "called\n"));
...
{
    DEBUGMSGTL(("internal:ipCidrRouteTable:_ipCidrRouteTable_container_init",
                "called\n"));
    ...
    if_ctx->cache = netsnmp_cache_create(
        IPCIDRROUTETABLE_CACHE_TIMEOUT, _cache_load, _cache_free,
        ipCidrRouteTable_oid, ipCidrRouteTable_oid_size);
 ...
 */
void _ipCidrRouteTable_container_shutdown(
    ipCidrRouteTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:ipCidrRouteTable:_ipCidrRouteTable_container_shutdown",
         "called\n"));
...
ipCidrRouteTable_rowreq_ctx*
    ipCidrRouteTable_row_find_by_mib_index(ipCidrRouteTable_mib_index* mib_idx)
{
    ipCidrRouteTable_rowreq_ctx* rowreq_ctx;
    ...
    rowreq_ctx = (ipCidrRouteTable_rowreq_ctx*)CONTAINER_FIND(
        ipCidrRouteTable_if_ctx.container, &oid_idx);
