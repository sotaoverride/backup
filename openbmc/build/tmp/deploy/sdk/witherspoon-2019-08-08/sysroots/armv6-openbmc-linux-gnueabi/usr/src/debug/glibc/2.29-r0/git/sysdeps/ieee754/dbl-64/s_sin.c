...
/* Given a number partitioned into X and DX, this function computes the cosine
   ...
   get the result.  */
static inline double __always_inline do_cos(double x, double dx)
{
    mynumber u;
...
/* Given a number partitioned into X and DX, this function computes the sine of
   ...
   the result.  */
static inline double __always_inline do_sin(double x, double dx)
{
    double xold = x;
...
/* Reduce range of x to within PI/2 with abs (x) < 105414350.  The high part
   ...
   are correct.  */
static inline int4 __always_inline reduce_sincos(double x, double* a,
                                                 double* da)
{
    mynumber v;
...
static double __always_inline do_sincos(double a, double da, int4 n)
{
    double retval;
