...
static int _warn_if_all_disabled(int maj, int min, void* serverarg,
                                 void* clientarg);
...
static void _init_agent_callback_transport(void)
{
    /*
     * always register a callback transport for internal use
     */
    callback_master_sess =
        netsnmp_callback_open(0, handle_snmp_packet, netsnmp_agent_check_packet,
