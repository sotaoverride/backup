...
class aligned_storage
{
    ...
    // BOOST_MAY_ALIAS works around GCC warnings about breaking strict aliasing
    // rules when casting storage address to T*
...
#if defined(BOOST_OPTIONAL_DETAIL_USE_ATTRIBUTE_MAY_ALIAS)
    // This workaround is supposed to silence GCC warnings about broken strict
    // aliasing rules
