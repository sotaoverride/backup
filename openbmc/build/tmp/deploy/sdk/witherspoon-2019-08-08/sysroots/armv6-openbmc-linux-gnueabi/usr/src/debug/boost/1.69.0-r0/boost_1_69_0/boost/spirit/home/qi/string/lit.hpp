...
struct use_terminal<qi::domain, T,
                    typename enable_if<traits::is_string<T>>::type> // enables
                                                                    // strings
    : mpl::true_
{
};
...
struct use_terminal<
    qi::domain,
    terminal_ex<tag::char_code<tag::string, CharEncoding> // enables string(str)
                ,
...
struct use_lazy_terminal<qi::domain, tag::char_code<tag::string, CharEncoding>,
                         1 /*arity*/
                         > : mpl::true_
{
};
...
{
    typedef
        typename remove_const<typename traits::char_type_of<String>::type>::type
            char_type;
    typedef std::basic_string<char_type> string_type;

    literal_string(typename add_reference<String>::type str_) : str(str_)
    {
    }
    ...
    struct attribute
    {
        typedef typename mpl::if_c<no_attribute, unused_type, string_type>::type
            type;
    };
    ...
    : primitive_parser<no_case_literal_string<String, no_attribute>>
{
        ...
        str_lo(in), str_hi(in)
    {
        ...
        encoding; // suppresses warning: C4100: 'encoding' : unreferenced formal
                  // parameter
#endif
                      ...
                      typename enable_if<traits::is_string<T>>::type>
{
    ...
    typedef
        typename mpl::if_<no_case, no_case_literal_string<const_string, true>,
                          literal_string<const_string, true>>::type result_type;

    result_type operator()(typename add_reference<const_string>::type str,
                           unused_type) const
    {
    ...
    result_type op(String const& str, mpl::true_) const
    {
        typename spirit::detail::get_encoding<
            Modifiers, spirit::char_encoding::standard>::type encoding;
                      ...
                      typename enable_if<traits::is_string<A0>>::type>
{
    ...
    result_type op(String const& str, mpl::true_) const
    {
        ...
        typename spirit::detail::get_encoding<Modifiers, encoding_type>::type
            encoding;
        return result_type(traits::get_c_string(str), encoding);
    }
};
    ...
    Modifiers>
{
    ...
    typedef typename add_const<A0>::type const_string;
    typedef
        typename mpl::if_<no_case, no_case_literal_string<const_string, false>,
...
struct handles_container<qi::literal_string<String, no_attribute>, Attribute,
                         Context, Iterator> : mpl::true_
{
};
