 ...
 */
static inline _Atomic unsigned long* c_ref_add(_Atomic unsigned long* ref,
                                               unsigned long n)
{
 ...
 */
static inline _Atomic unsigned long*
    c_ref_add_unless_zero(_Atomic unsigned long* ref, unsigned long n)
{
    unsigned long n_refs;
    ...
    if (ref)
    {
        ...
        do
        {
            ...
            ref, &n_refs, n_refs + n, memory_order_relaxed,
 ...
 */
static inline _Atomic unsigned long*
    c_ref_inc_unless_zero(_Atomic unsigned long* ref)
{
 ...
 * actually called.
 */
noreturn static inline void c_ref_unreachable(_Atomic unsigned long* ref,
                                              void* userdata)
{
    assert(0);
    abort();
 ...
 */
static inline _Atomic unsigned long* c_ref_sub(_Atomic unsigned long* ref,
                                               unsigned long n, CRefFn func,
                                               void* userdata)
{
    unsigned long n_refs;
 ...
 * Return: NULL is returned.
 */
static inline _Atomic unsigned long* c_ref_dec(_Atomic unsigned long* ref,
                                               CRefFn func, void* userdata)
{
