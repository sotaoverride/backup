...
netsnmp_subtree* netsnmp_subtree_find(const oid*, size_t, netsnmp_subtree*,
                                      const char* context_name);

netsnmp_subtree* netsnmp_subtree_find_next(const oid*, size_t, netsnmp_subtree*,
                                           const char* context_name);

netsnmp_subtree* netsnmp_subtree_find_prev(const oid*, size_t, netsnmp_subtree*,
                                           const char* context_name);
...
int register_mib(const char*, const struct variable*, size_t, size_t,
                 const oid*, size_t);

int register_mib_priority(const char*, const struct variable*, size_t, size_t,
                          const oid*, size_t, int);

int register_mib_range(const char*, const struct variable*, size_t, size_t,
                       const oid*, size_t, int, int, oid, netsnmp_session*);

int register_mib_context(const char*, const struct variable*, size_t, size_t,
                         const oid*, size_t, int, int, oid, netsnmp_session*,
                         const char*, int, int);

int netsnmp_register_mib_table_row(const char*, const struct variable*, size_t,
                                   size_t, oid*, size_t, int, int,
                                   netsnmp_session*, const char*, int, int);
...
#define REGISTER_MIB(descr, var, vartype, theoid)                              \
    if (register_mib(descr, (const struct variable*)var,                       \
                     ...
                     sizeof(theoid) / sizeof(oid)) != MIB_REGISTERED_OK)       \
...
int netsnmp_register_mib(const char*, struct variable*, size_t, size_t, oid*,
                         size_t, int, int, oid, netsnmp_session*, const char*,
                         int, int, struct netsnmp_handler_registration_s*, int);
