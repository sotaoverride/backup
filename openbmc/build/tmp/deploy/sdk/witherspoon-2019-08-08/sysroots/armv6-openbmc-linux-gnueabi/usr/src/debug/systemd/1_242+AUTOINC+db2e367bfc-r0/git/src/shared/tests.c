...
{
    log_notice("%s: %s, skipping tests.", program_invocation_short_name,
               message);
...
bool have_namespaces(void)
{
    ...
    /* Checks whether namespaces are available. In some cases they aren't. We do
     * this by calling unshare(), and we do so in a child process in order not
     * to affect our own process. */
