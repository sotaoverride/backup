...
extern ssize_t __REDIRECT(__read_alias,
                          (int __fd, void* __buf, size_t __nbytes), read) __wur;
...
__fortify_function __wur ssize_t pread(int __fd, void* __buf, size_t __nbytes,
                                       __off_t __offset)
{
    if (__bos0(__buf) != (size_t)-1)
    {
...
__fortify_function __wur ssize_t pread64(int __fd, void* __buf, size_t __nbytes,
                                         __off64_t __offset)
{
    if (__bos0(__buf) != (size_t)-1)
    {
...
extern ssize_t __readlink_chk(const char* __restrict __path,
                              ...
                              size_t __buflen) __THROW __nonnull((1, 2)) __wur;
...
__fortify_function __wur char* __NTH(getcwd(char* __buf, size_t __size))
{
    if (__bos(__buf) != (size_t)-1)
    {
...
__fortify_function __nonnull((1)) __attribute_deprecated__ __wur
    char* __NTH(getwd(char* __buf))
{
    if (__bos(__buf) != (size_t)-1)
...
__fortify_function size_t __NTH(confstr(int __name, char* __buf, size_t __len))
{
    if (__bos(__buf) != (size_t)-1)
    {
        if (!__builtin_constant_p(__len))
...
__fortify_function int __NTH(ttyname_r(int __fd, char* __buf, size_t __buflen))
{
    if (__bos(__buf) != (size_t)-1)
    {
...
__fortify_function int getlogin_r(char* __buf, size_t __buflen)
{
    if (__bos(__buf) != (size_t)-1)
    {
        if (!__builtin_constant_p(__buflen))
...
__fortify_function int __NTH(gethostname(char* __buf, size_t __buflen))
{
    if (__bos(__buf) != (size_t)-1)
    {
        if (!__builtin_constant_p(__buflen))
...
extern int __REDIRECT_NTH(__getdomainname_alias, (char* __buf, size_t __buflen),
...
__fortify_function int __NTH(getdomainname(char* __buf, size_t __buflen))
{
    if (__bos(__buf) != (size_t)-1)
    {
        if (!__builtin_constant_p(__buflen))
