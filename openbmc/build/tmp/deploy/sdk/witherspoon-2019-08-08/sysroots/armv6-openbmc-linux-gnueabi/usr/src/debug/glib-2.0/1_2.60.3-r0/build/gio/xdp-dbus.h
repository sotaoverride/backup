...
#define GXDP_DOCUMENTS_GET_IFACE(o)                                            \
    (G_TYPE_INSTANCE_GET_INTERFACE((o), GXDP_TYPE_DOCUMENTS,                   \
                                   GXdpDocumentsIface))
...
struct _GXdpDocumentsIface
{
    ...
    gboolean (*handle_add)(GXdpDocuments* object,
                           ...
                           GUnixFDList* fd_list, GVariant* arg_o_path_fd,
                           gboolean arg_reuse_existing,
                           gboolean arg_persistent);

    gboolean (*handle_add_full)(GXdpDocuments* object,
                                GDBusMethodInvocation* invocation,
                                GUnixFDList* fd_list, GVariant* arg_o_path_fds,
                                guint arg_flags, const gchar* arg_app_id,
...
struct _GXdpOpenURIIface
{
    ...
    gboolean (*handle_open_file)(GXdpOpenURI* object,
                                 ...
                                 GVariant* arg_fd, GVariant* arg_options);
...
#define GXDP_OPEN_URI_PROXY(o)                                                 \
    (G_TYPE_CHECK_INSTANCE_CAST((o), GXDP_TYPE_OPEN_URI_PROXY,                 \
                                GXdpOpenURIProxy))
...
#define GXDP_PROXY_RESOLVER(o)                                                 \
    (G_TYPE_CHECK_INSTANCE_CAST((o), GXDP_TYPE_PROXY_RESOLVER,                 \
                                GXdpProxyResolver))
...
struct _GXdpTrashIface
{
    ...
    gboolean (*handle_trash_file)(GXdpTrash* object,
                                  GDBusMethodInvocation* invocation,
                                  GUnixFDList* fd_list, GVariant* arg_fd);
...
#define GXDP_TRASH_SKELETON(o)                                                 \
    (G_TYPE_CHECK_INSTANCE_CAST((o), GXDP_TYPE_TRASH_SKELETON,                 \
                                GXdpTrashSkeleton))
