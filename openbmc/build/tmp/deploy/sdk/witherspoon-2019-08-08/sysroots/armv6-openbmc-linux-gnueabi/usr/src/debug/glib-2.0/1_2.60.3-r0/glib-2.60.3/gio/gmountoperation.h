...
#define G_MOUNT_OPERATION(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_MOUNT_OPERATION, GMountOperation))
#define G_MOUNT_OPERATION_CLASS(k)                                             \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_MOUNT_OPERATION, GMountOperationClass))
#define G_IS_MOUNT_OPERATION(o)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_MOUNT_OPERATION))
#define G_IS_MOUNT_OPERATION_CLASS(k)                                          \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_MOUNT_OPERATION))
#define G_MOUNT_OPERATION_GET_CLASS(o)                                         \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_MOUNT_OPERATION,                    \
...
struct _GMountOperationClass
{
    ...
    void (*ask_password)(GMountOperation* op, const char* message,
     ...
     */
    void (*ask_question)(GMountOperation* op, const char* message,
                         const char* choices[]);
     ...
     * Since: 2.22
     */
    void (*show_processes)(GMountOperation* op, const gchar* message,
