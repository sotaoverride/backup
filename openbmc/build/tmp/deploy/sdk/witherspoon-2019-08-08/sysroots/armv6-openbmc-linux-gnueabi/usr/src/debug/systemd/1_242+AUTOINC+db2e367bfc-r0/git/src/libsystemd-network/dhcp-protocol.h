...
#define DHCP_DEFAULT_MIN_SIZE                                                  \
    576 /* the minimum internet hosts must be able to receive */
#define DHCP_MIN_OPTIONS_SIZE                                                  \
    (DHCP_DEFAULT_MIN_SIZE - DHCP_IP_UDP_SIZE - DHCP_MESSAGE_SIZE)
