...
G_DEFINE_ABSTRACT_TYPE(GSocketAddressEnumerator, g_socket_address_enumerator,
                       G_TYPE_OBJECT)

static void g_socket_address_enumerator_real_next_async(
    GSocketAddressEnumerator* enumerator, GCancellable* cancellable,
    GAsyncReadyCallback callback, gpointer user_data);
static GSocketAddress* g_socket_address_enumerator_real_next_finish(
...
static void g_socket_address_enumerator_class_init(
 ...
 * ignored.
 *
 * Returns: (transfer full): a #GSocketAddress (owned by the caller), or %NULL
 * on error (in which case *@error will be set) or if there are no more
 * addresses.
 */
GSocketAddress*
