      ...
      public /*protected*/ ArchiveImplementation
{
  private:
    ...
    virtual void load_object(void* t, const basic_iserializer& bis)
    {
    ...
    virtual helper_collection& get_helper_collection()
    {
  ...
  public:
    ...
    polymorphic_iarchive_route(std::basic_istream<_Elem, _Tr>& is,
