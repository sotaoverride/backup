...
#define G_DBUS_AUTH_MECHANISM_SHA1(o)                                          \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_AUTH_MECHANISM_SHA1,          \
                                GDBusAuthMechanismSha1))
#define G_DBUS_AUTH_MECHANISM_SHA1_CLASS(k)                                    \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_DBUS_AUTH_MECHANISM_SHA1,             \
                             GDBusAuthMechanismSha1Class))
#define G_DBUS_AUTH_MECHANISM_SHA1_GET_CLASS(o)                                \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DBUS_AUTH_MECHANISM_SHA1,           \
                               GDBusAuthMechanismSha1Class))
#define G_IS_DBUS_AUTH_MECHANISM_SHA1(o)                                       \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_AUTH_MECHANISM_SHA1))
#define G_IS_DBUS_AUTH_MECHANISM_SHA1_CLASS(k)                                 \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_DBUS_AUTH_MECHANISM_SHA1))
