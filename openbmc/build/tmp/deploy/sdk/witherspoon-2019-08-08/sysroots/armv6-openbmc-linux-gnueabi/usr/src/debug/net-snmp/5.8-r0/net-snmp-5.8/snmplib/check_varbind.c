...
netsnmp_feature_child_of(check_varbind_all, libnetsnmp)
    ...
    netsnmp_feature_child_of(check_vb_range, check_varbind_all)
        netsnmp_feature_child_of(
            check_vb_size_range,
            check_varbind_all) netsnmp_feature_child_of(check_vb_uint,
                                                        check_varbind_all)
            netsnmp_feature_child_of(
                check_vb_storagetype,
                check_varbind_all) netsnmp_feature_child_of(check_vb_oid,
                                                            check_varbind_all)
                netsnmp_feature_child_of(check_vb_type_and_max_size,
                                         check_varbind_all)
                    netsnmp_feature_child_of(check_vb_type_and_max_size,
                                             check_varbind_all)
                        netsnmp_feature_child_of(
                            ...
                            check_varbind_all)
                            netsnmp_feature_child_of(check_vb_truthvalue,
                                                     check_varbind_all)
...
NETSNMP_INLINE int netsnmp_check_vb_size(const netsnmp_variable_list* var,
                                         size_t size)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_max_size(const netsnmp_variable_list* var,
                                             size_t size)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_range(const netsnmp_variable_list* var,
...
NETSNMP_INLINE int netsnmp_check_vb_size_range(const netsnmp_variable_list* var,
                                               size_t low, size_t high)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int
    netsnmp_check_vb_type_and_size(const netsnmp_variable_list* var, int type,
                                   size_t size)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_oid(const netsnmp_variable_list* var)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_int(const netsnmp_variable_list* var)
{
    if (NULL == var)
        return SNMP_ERR_GENERR;
...
NETSNMP_INLINE int netsnmp_check_vb_uint(const netsnmp_variable_list* var)
{
    if (NULL == var)
        return SNMP_ERR_GENERR;
...
NETSNMP_INLINE int netsnmp_check_vb_int_range(const netsnmp_variable_list* var,
                                              int low, int high)
{
    register int rc = SNMP_ERR_NOERROR;
...
int netsnmp_check_vb_rowstatus(const netsnmp_variable_list* var, int old_value)
{
    register int rc = SNMP_ERR_NOERROR;
...
int netsnmp_check_vb_rowstatus_with_storagetype(
    const netsnmp_variable_list* var, int old_value, int old_storage)
{
    register int rc = SNMP_ERR_NOERROR;
    ...
    return check_rowstatus_with_storagetype_transition(
...
int netsnmp_check_vb_storagetype(const netsnmp_variable_list* var,
                                 int old_value)
{
