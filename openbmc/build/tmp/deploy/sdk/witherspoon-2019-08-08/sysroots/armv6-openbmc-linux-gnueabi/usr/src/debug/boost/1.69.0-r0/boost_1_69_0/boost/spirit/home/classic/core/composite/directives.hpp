...
struct contiguous : public unary<ParserT, parser<contiguous<ParserT>>>
{
        ...
        parse(ScannerT const& scan) const
    {
        ...
        return impl::contiguous_parser_parse<result_t>(this->subject(), scan,
                                                       scan);
    }
};
...
struct lexeme_scanner
{
    typedef scanner_policies<
        ...
        typename ScannerT::match_policy_t, typename ScannerT::action_policy_t>
        policies_t;
...
struct inhibit_case : public unary<ParserT, parser<inhibit_case<ParserT>>>
{
    ...
    {
        typedef typename parser_result<self_t, ScannerT>::type result_t;
        return impl::inhibit_case_parser_parse<result_t>(this->subject(), scan,
                                                         scan);
    }
};
...
struct bounded : public unary<ParserT, parser<bounded<ParserT, BoundsT>>>
{
    ...
    bounded(ParserT const& p, BoundsT const& min__, BoundsT const& max__) :
        base_t(p), min_(min__), max_(max__)
    {
    }
