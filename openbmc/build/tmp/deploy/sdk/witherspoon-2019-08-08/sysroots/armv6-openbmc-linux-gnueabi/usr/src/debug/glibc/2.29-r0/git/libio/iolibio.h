...
libc_hidden_proto(_IO_fdopen) extern FILE* _IO_old_fdopen(int,
                                                          const char*) __THROW;
extern FILE* _IO_new_fdopen(int, const char*) __THROW;
extern int _IO_fflush(FILE*);
libc_hidden_proto(_IO_fflush) extern int _IO_fgetpos(FILE*, __fpos_t*);
...
extern FILE* __fopen_internal(const char*, const char*, int) attribute_hidden;
...
libc_hidden_proto(_IO_fputs) extern int _IO_fsetpos(FILE*, const __fpos_t*);
extern int _IO_fsetpos64(FILE*, const __fpos64_t*);
extern long int _IO_ftell(FILE*);
libc_hidden_proto(_IO_ftell) extern size_t
    _IO_fread(void*, size_t, size_t, FILE*);
libc_hidden_proto(_IO_fread) extern size_t
    _IO_fwrite(const void*, size_t, size_t, FILE*);
libc_hidden_proto(_IO_fwrite) extern char* _IO_gets(char*);
extern void _IO_perror(const char*) __THROW;
extern int _IO_printf(const char*, ...);
extern int _IO_puts(const char*);
libc_hidden_proto(_IO_puts) extern int _IO_scanf(const char*, ...);
extern void _IO_setbuffer(FILE*, char*, size_t) __THROW;
libc_hidden_proto(_IO_setbuffer) extern int _IO_setvbuf(FILE*, char*, int,
                                                        size_t) __THROW;
libc_hidden_proto(_IO_setvbuf) extern int _IO_sscanf(const char*, const char*,
                                                     ...) __THROW;
...
#define _IO_fseek(__fp, __offset, __whence)                                    \
    (_IO_seekoff_unlocked(__fp, __offset, __whence,                            \
                          _IOS_INPUT | _IOS_OUTPUT) == _IO_pos_BAD             \
         ? EOF                                                                 \
         : 0)
