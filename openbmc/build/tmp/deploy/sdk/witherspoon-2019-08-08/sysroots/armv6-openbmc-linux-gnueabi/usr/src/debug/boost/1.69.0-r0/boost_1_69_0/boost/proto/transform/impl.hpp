...
#define BOOST_PROTO_TRANSFORM_(PrimitiveTransform, X)                          \
    ...
    {                                                                          \
        typedef                                                                \
            typename boost::proto::detail::apply_transform<Sig>::result_type   \
                type;                                                          \
    };                                                                         \
                                                                               \
    template <typename Expr>                                                   \
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr&)>::result_type                                               \
        operator()(Expr& e) const                                              \
    {                                                                          \
        boost::proto::empty_state s = 0;                                       \
        boost::proto::empty_env d;                                             \
        return boost::proto::detail::apply_transform<transform_type(Expr&)>()( \
            e, s, d);                                                          \
    }                                                                          \
                                                                               \
    template <typename Expr>                                                   \
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr const&)>::result_type                                         \
        operator()(Expr const& e) const                                        \
    {                                                                          \
        boost::proto::empty_state s = 0;                                       \
        boost::proto::empty_env d;                                             \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr const&)>()(e, s, d);                                          \
    }                                                                          \
                                                                               \
    ...
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr const&, State&)>::result_type                                 \
        operator()(Expr const& e, State& s) const                              \
    {                                                                          \
        boost::proto::empty_env d;                                             \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr const&, State&)>()(e, s, d);                                  \
    }                                                                          \
                                                                               \
    template <typename Expr, typename State>                                   \
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr&, State const&)>::result_type                                 \
        operator()(Expr& e, State const& s) const                              \
    {                                                                          \
        boost::proto::empty_env d;                                             \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr&, State const&)>()(e, s, d);                                  \
    }                                                                          \
                                                                               \
    template <typename Expr, typename State>                                   \
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr const&, State const&)>::result_type                           \
        operator()(Expr const& e, State const& s) const                        \
    {                                                                          \
        boost::proto::empty_env d;                                             \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr const&, State const&)>()(e, s, d);                            \
    }                                                                          \
                                                                               \
    template <typename Expr, typename State, typename Data>                    \
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr&, State&, Data&)>::result_type                                \
        operator()(Expr& e, State& s, Data& d) const                           \
    {                                                                          \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr&, State&, Data&)>()(e, s, d);                                 \
    }                                                                          \
                                                                               \
    template <typename Expr, typename State, typename Data>                    \
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr const&, State&, Data&)>::result_type                          \
        operator()(Expr const& e, State& s, Data& d) const                     \
    {                                                                          \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr const&, State&, Data&)>()(e, s, d);                           \
    }                                                                          \
                                                                               \
    template <typename Expr, typename State, typename Data>                    \
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr&, State const&, Data&)>::result_type                          \
        operator()(Expr& e, State const& s, Data& d) const                     \
    {                                                                          \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr&, State const&, Data&)>()(e, s, d);                           \
    }                                                                          \
                                                                               \
    template <typename Expr, typename State, typename Data>                    \
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr const&, State const&, Data&)>::result_type                    \
        operator()(Expr const& e, State const& s, Data& d) const               \
    {                                                                          \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr const&, State const&, Data&)>()(e, s, d);                     \
    }                                                                          \
    /**/
...
#define BOOST_PROTO_TRANSFORM_(PrimitiveTransform, X)                          \
    ...
    BOOST_FORCEINLINE                                                          \
        typename boost::proto::detail::apply_transform<transform_type(         \
            Expr const&, State const&, Data const&)>::result_type              \
        operator()(Expr&& e, State&& s, Data&& d) const                        \
    {                                                                          \
        return boost::proto::detail::apply_transform<transform_type(           \
            Expr const&, State const&, Data const&)>()(e, s, d);               \
    }                                                                          \
    /**/
