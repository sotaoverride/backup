    ...
    g_dtls_client_connection_default_init(GDtlsClientConnectionInterface* iface)
{
    ...
    /**
     * GDtlsClientConnection:accepted-cas: (type GLib.List) (element-type
     * GLib.ByteArray)
     *
                                 ...
                                 GError** error)
{
    ...
    conn = g_initable_new(
        g_tls_backend_get_dtls_client_connection_type(backend), NULL, error,
        "base-socket", base_socket, "server-identity", server_identity, NULL);
