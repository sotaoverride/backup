...
OM_uint32 KRB5_CALLCONV gss_release_any_name_mapping(OM_uint32* minor_status,
                                                     gss_name_t name,
                                                     ...
                                                     gss_any_t* input)
{
    ...
    *minor_status = 0;
    ...
    status = (*mech->gss_release_any_name_mapping)(
        minor_status, union_name->mech_name, type_id, input);
