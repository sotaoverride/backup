...
#define G_DBUS_OBJECT(o)                                                       \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_OBJECT, GDBusObject))
#define G_IS_DBUS_OBJECT(o)                                                    \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_OBJECT))
#define G_DBUS_OBJECT_GET_IFACE(o)                                             \
    (G_TYPE_INSTANCE_GET_INTERFACE((o), G_TYPE_DBUS_OBJECT, GDBusObjectIface))
 ...
 * @get_object_path: Returns the object path. See
 * g_dbus_object_get_object_path().
 * @get_interfaces: Returns all interfaces. See g_dbus_object_get_interfaces().
 * @get_interface: Returns an interface by name. See
 * g_dbus_object_get_interface().
 * @interface_added: Signal handler for the #GDBusObject::interface-added
 * signal.
 * @interface_removed: Signal handler for the #GDBusObject::interface-removed
 * signal.
 *
