...
static const struct id_part arm_part[] = {
    {0x810, "ARM810"},     {0x920, "ARM920"},       {0x922, "ARM922"},
    {0x926, "ARM926"},     {0x940, "ARM940"},       {0x946, "ARM946"},
    {0x966, "ARM966"},     {0xa20, "ARM1020"},      {0xa22, "ARM1022"},
    {0xa26, "ARM1026"},    {0xb02, "ARM11 MPCore"}, {0xb36, "ARM1136"},
    {0xb56, "ARM1156"},    {0xb76, "ARM1176"},      {0xc05, "Cortex-A5"},
    {0xc07, "Cortex-A7"},  {0xc08, "Cortex-A8"},    {0xc09, "Cortex-A9"},
    {0xc0d, "Cortex-A17"}, /* Originally A12 */
    {0xc0f, "Cortex-A15"}, {0xc0e, "Cortex-A17"},   {0xc14, "Cortex-R4"},
    {0xc15, "Cortex-R5"},  {0xc17, "Cortex-R7"},    {0xc18, "Cortex-R8"},
    ...
    {0xd09, "Cortex-A73"}, {0xd0a, "Cortex-A75"},   {0xd13, "Cortex-R52"},
    {0xd20, "Cortex-M23"}, {0xd21, "Cortex-M33"},   {-1, "unknown"},
};
...
static const struct id_part cavium_part[] = {
    ...
    {0x0af, "ThunderX2 99xx"}, {-1, "unknown"},
};
...
static const struct id_part qcom_part[] = {
    ...
    {0xc00, "Falkor"},   {0xc01, "Saphira"},        {-1, "unknown"},
};
...
static const struct hw_impl hw_implementer[] = {
    ...
    {0x56, marvell_part, "Marvell"}, {0x66, faraday_part, "Faraday"},
    {0x69, intel_part, "Intel"},     {-1, unknown_part, "unknown"},
};
