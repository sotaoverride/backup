...
OM_uint32 KRB5_CALLCONV gss_verify_mic(minor_status, context_handle,
...

{
    ...
    *minor_status = 0;
    ...
    if (mech)
    {
        ...
        {
            status =
                mech->gss_verify_mic(minor_status, ctx->internal_ctx_id,
                                     message_buffer, token_buffer, qop_state);
...
OM_uint32 KRB5_CALLCONV gss_verify(minor_status, context_handle, message_buffer,
