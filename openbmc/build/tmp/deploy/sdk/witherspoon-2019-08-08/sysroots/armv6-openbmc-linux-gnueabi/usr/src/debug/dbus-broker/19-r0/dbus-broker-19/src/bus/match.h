...
#define MATCH_FILTER_INIT                                                      \
    {                                                                          \
        .type = DBUS_MESSAGE_TYPE_INVALID, .sender = ADDRESS_ID_INVALID,       \
    }
...
#define MATCH_REGISTRY_BY_KEYS_INIT(_x)                                        \
    {                                                                          \
        .n_refs = 1, .rule_list = C_LIST_INIT((_x).rule_list),                 \
...
#define MATCH_REGISTRY_BY_MEMBER_INIT(_x)                                      \
    {                                                                          \
        .n_refs = 1, .keys_tree = C_RBTREE_INIT,                               \
        .registry_node = C_RBNODE_INIT((_x).registry_node),                    \
    }
...
#define MATCH_REGISTRY_BY_INTERFACE_INIT(_x)                                   \
    {                                                                          \
        .n_refs = 1, .member_tree = C_RBTREE_INIT,                             \
        .registry_node = C_RBNODE_INIT((_x).registry_node),                    \
    }
...
#define MATCH_REGISTRY_BY_PATH_INIT(_x)                                        \
    {                                                                          \
        .n_refs = 1, .interface_tree = C_RBTREE_INIT,                          \
        .registry_node = C_RBNODE_INIT((_x).registry_node),                    \
    }
...
#define MATCH_REGISTRY_INIT(_x)                                                \
    {                                                                          \
        .subscription_tree = C_RBTREE_INIT, .monitor_tree = C_RBTREE_INIT,     \
    }
...
void match_registry_get_subscribers(MatchRegistry* matches, CList* destinations,
                                    MessageMetadata* metadata);
void match_registry_get_monitors(MatchRegistry* matches, CList* destinations,
                                 MessageMetadata* metadata);
