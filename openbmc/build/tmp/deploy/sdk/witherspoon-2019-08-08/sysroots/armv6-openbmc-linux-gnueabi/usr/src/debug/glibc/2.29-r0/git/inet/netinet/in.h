...
extern uint8_t*
    inet6_option_alloc(struct cmsghdr* __cmsg, int __datalen, int __multx,
                       int __plusy) __THROW __attribute_deprecated__;
extern int
    inet6_option_next(const struct cmsghdr* __cmsg,
                      uint8_t** __tptrp) __THROW __attribute_deprecated__;
...
extern int inet6_opt_finish(void* __extbuf, socklen_t __extlen,
                            int __offset) __THROW;
...
extern struct in6_addr* inet6_rth_getaddr(const void* __bp,
                                          int __index) __THROW;
...
extern int getipv4sourcefilter(int __s, struct in_addr __interface_addr,
                               ...
                               uint32_t* __numsrc,
                               struct in_addr* __slist) __THROW;

/* Set IPv4 source filter.  */
extern int setipv4sourcefilter(int __s, struct in_addr __interface_addr,
                               struct in_addr __group, uint32_t __fmode,
                               uint32_t __numsrc,
                               const struct in_addr* __slist) __THROW;
