...
#define G_ASYNC_RESULT(obj)                                                    \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_ASYNC_RESULT, GAsyncResult))
#define G_IS_ASYNC_RESULT(obj)                                                 \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_ASYNC_RESULT))
#define G_ASYNC_RESULT_GET_IFACE(obj)                                          \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_ASYNC_RESULT,                 \
                                   GAsyncResultIface))
 ...
 * @get_source_object: Gets the source object that issued the asynchronous
 *operation.
