...
#define G_LOADABLE_ICON(obj)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_LOADABLE_ICON, GLoadableIcon))
#define G_IS_LOADABLE_ICON(obj)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_LOADABLE_ICON))
#define G_LOADABLE_ICON_GET_IFACE(obj)                                         \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_LOADABLE_ICON,                \
                                   GLoadableIconIface))
...
struct _GLoadableIconIface
{
    ...
    void (*load_async)(GLoadableIcon* icon, int size, GCancellable* cancellable,
...
GLIB_AVAILABLE_IN_ALL
GInputStream* g_loadable_icon_load(GLoadableIcon* icon, int size, char** type,
                                   GCancellable* cancellable, GError** error);
GLIB_AVAILABLE_IN_ALL
void g_loadable_icon_load_async(GLoadableIcon* icon, int size,
