...
/**
 * g_base64_encode:
 * @data: (array length=len) (element-type guint8) (nullable): the binary data
 * to encode
 ...
 * Since: 2.12
 **/
gsize g_base64_decode_step(const gchar* in, gsize len, guchar* out, gint* state,
                           guint* save)
{
    const guchar* inptr;
    guchar* outptr;
...
guchar* g_base64_decode_inplace(gchar* text, gsize* out_len)
{
    ...
    *out_len =
        g_base64_decode_step(text, input_length, (guchar*)text, &state, &save);
