...
//  (C) Copyright Dave Abrahams and Daryle Walker 2001. Distributed under the
...
#elif !defined(BOOST_NO_INTEGRAL_INT64_T) && !defined(BOOST_NO_INT64_T) &&     \
...
template <static_min_max_unsigned_type Value1,
          static_min_max_unsigned_type Value2>
