...
static void salsa20_core(u32* dst, const u32* src, unsigned int rounds)
{
...
static void scrypt_block_mix(u32 r, unsigned char* B, unsigned char* tmp2)
{
    u64 i;
...
static void scrypt_ro_mix(u32 r, unsigned char* B, u64 N, unsigned char* tmp1,
                          unsigned char* tmp2)
{
 ...
 *
 */
gcry_err_code_t _gcry_kdf_scrypt(const unsigned char* passwd, size_t passwdlen,
                                 int algo, int subalgo,
                                 const unsigned char* salt, size_t saltlen,
                                 unsigned long iterations, size_t dkLen,
                                 unsigned char* DK)
{
