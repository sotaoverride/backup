 ...
 */
typedef krb5_error_code (*krb5_ccselect_init_fn)(
    krb5_context context, krb5_ccselect_moddata* data_out, int* priority_out);
 ...
 * as appropriate.
 */
typedef krb5_error_code (*krb5_ccselect_choose_fn)(krb5_context context,
...
typedef void (*krb5_ccselect_fini_fn)(krb5_context context,
                                      krb5_ccselect_moddata data);
