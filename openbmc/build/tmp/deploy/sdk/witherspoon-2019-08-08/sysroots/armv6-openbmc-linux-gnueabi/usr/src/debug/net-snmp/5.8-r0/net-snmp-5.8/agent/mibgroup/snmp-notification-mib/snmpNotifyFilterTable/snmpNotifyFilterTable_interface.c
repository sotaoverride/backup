...
netsnmp_feature_child_of(snmpNotifyFilterTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_require(check_all_requests_error)
            ...
            netsnmp_feature_require(check_vb_type_and_max_size)
                ...
                netsnmp_feature_child_of(snmpNotifyFilterTable_container_size,
                                         snmpNotifyFilterTable_external_access)
     ...
     **********************************************************************/
    /*
     * SNMP-NOTIFICATION-MIB::snmpNotifyFilterTable is subid 3 of
     * snmpNotifyObjects. Its status is Current. OID: .1.3.6.1.6.3.13.1.3,
     * length: 9
     */
...
static void _snmpNotifyFilterTable_container_init(
...
snmpNotifyFilterTable_registration* snmpNotifyFilterTable_registration_get(void)
{
...
snmpNotifyFilterTable_registration* snmpNotifyFilterTable_registration_set(
...
NETSNMP_STATIC_INLINE int _snmpNotifyFilterTable_undo_column(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, netsnmp_variable_list* var,
    int column);
#endif

NETSNMP_STATIC_INLINE int _snmpNotifyFilterTable_check_indexes(
 ...
 */
void _snmpNotifyFilterTable_initialize_interface(
    snmpNotifyFilterTable_registration* reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:snmpNotifyFilterTable:_snmpNotifyFilterTable_"
    ...
    if (NULL == reginfo)
    {
        snmp_log(LOG_ERR, "error registering table snmpNotifyFilterTable\n");
        return;
    }
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, snmpNotifyFilterTable_if_ctx.container,
 ...
 */
void _snmpNotifyFilterTable_shutdown_interface(
...
void snmpNotifyFilterTable_valid_columns_set(netsnmp_column_info* vc)
{
 ...
 */
int snmpNotifyFilterTable_index_to_oid(netsnmp_index* oid_idx,
                                       snmpNotifyFilterTable_mib_index* mib_idx)
{
    ...
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_index_to_oid",
         "called\n"));
 ...
 */
int snmpNotifyFilterTable_index_from_oid(
    netsnmp_index* oid_idx, snmpNotifyFilterTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_index_from_oid",
         "called\n"));
    ...
    if (err == SNMP_ERR_NOERROR)
    {
         ...
         */
        /*
         * NOTE: val_len is in bytes, snmpNotifyFilterProfileName_len might not
         * be
         */
...
snmpNotifyFilterTable_data* snmpNotifyFilterTable_allocate_data(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_allocate_data",
         "called\n"));
...
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_release_data",
         "called\n"));
    ...
    snmpNotifyFilterTable_allocate_rowreq_ctx(void* user_init_ctx)
{
    ...
    DEBUGMSGTL(("internal:snmpNotifyFilterTable:snmpNotifyFilterTable_allocate_"
                "rowreq_ctx",
                "called\n"));
    ...
    {
        if (SNMPERR_SUCCESS !=
            snmpNotifyFilterTable_rowreq_ctx_init(rowreq_ctx, user_init_ctx))
        {
 ...
 */
void snmpNotifyFilterTable_release_rowreq_ctx(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("internal:snmpNotifyFilterTable:snmpNotifyFilterTable_release_"
                "rowreq_ctx",
                "called\n"));
 ...
 * wrapper
 */
static int _mfd_snmpNotifyFilterTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL((
        "internal:snmpNotifyFilterTable:_mfd_snmpNotifyFilterTable_pre_request",
        "called\n"));
    ...
    rc = snmpNotifyFilterTable_pre_request(
        snmpNotifyFilterTable_if_ctx.user_ctx);
    if (MFD_SUCCESS != rc)
    {
        /*
 ...
 * wrapper
 */
static int _mfd_snmpNotifyFilterTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx =
        (snmpNotifyFilterTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    int rc, packet_rc;

    DEBUGMSGTL(("internal:snmpNotifyFilterTable:_mfd_snmpNotifyFilterTable_"
                "post_request",
                "called\n"));
    ...
    rc = snmpNotifyFilterTable_post_request(
        snmpNotifyFilterTable_if_ctx.user_ctx, packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
 ...
 * wrapper
 */
static int _mfd_snmpNotifyFilterTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
 ...
 */
NETSNMP_STATIC_INLINE int _snmpNotifyFilterTable_get_column(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, netsnmp_variable_list* var,
    int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERMASK:
            ...
            rc = snmpNotifyFilterMask_get(rowreq_ctx, (char**)&var->val.string,
                                          &var->val_len);
            break;
        ...
        case COLUMN_SNMPNOTIFYFILTERTYPE:
            ...
            rc = snmpNotifyFilterType_get(rowreq_ctx, (u_long*)var->val.string);
            break;
...
int _mfd_snmpNotifyFilterTable_get_values(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx =
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _snmpNotifyFilterTable_get_column(rowreq_ctx, requests->requestvb,
                                               tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
    ...
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    ...
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_snmpNotifyFilterTable_check_indexes",
         "called\n"));
     ...
     */
    return snmpNotifyFilterTable_validate_index(
        snmpNotifyFilterTable_if_ctx.user_ctx, rowreq_ctx);
 ...
 */
NETSNMP_STATIC_INLINE int _snmpNotifyFilterTable_check_column(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, netsnmp_variable_list* var,
    int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_snmpNotifyFilterTable_check_column",
         "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERMASK:
            ...
            {
                DEBUGMSGTL(
                    ("snmpNotifyFilterTable:_snmpNotifyFilterTable_check_"
                     "column:snmpNotifyFilterMask",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = snmpNotifyFilterMask_check_value(
        ...
        case COLUMN_SNMPNOTIFYFILTERTYPE:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL(
                    ("snmpNotifyFilterTable:_snmpNotifyFilterTable_check_"
                     "column:snmpNotifyFilterType",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = snmpNotifyFilterType_check_value(
        ...
        case COLUMN_SNMPNOTIFYFILTERSTORAGETYPE:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL(
                    ("snmpNotifyFilterTable:_snmpNotifyFilterTable_check_"
                     "column:snmpNotifyFilterStorageType",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = snmpNotifyFilterStorageType_check_value(
                    rowreq_ctx, *((u_long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
        ...
        case COLUMN_SNMPNOTIFYFILTERROWSTATUS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL(
                    ("snmpNotifyFilterTable:_snmpNotifyFilterTable_check_"
                     "column:snmpNotifyFilterRowStatus",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = snmpNotifyFilterRowStatus_check_value(
                    rowreq_ctx, *((u_long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
...
int _mfd_snmpNotifyFilterTable_check_objects(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx =
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _snmpNotifyFilterTable_check_column(
 ...
 */
static int _mfd_snmpNotifyFilterTable_check_dependencies(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    ...
    if (rc)
    {
        DEBUGMSGTL(("snmpNotifyFilterTable:mfd",
                    "error %d from "
 ...
 */
NETSNMP_STATIC_INLINE int _snmpNotifyFilterTable_undo_setup_column(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(("internal:snmpNotifyFilterTable:_snmpNotifyFilterTable_undo_"
                "setup_column",
                "called for %d\n", column));
 ...
 * undo setup
 */
int _mfd_snmpNotifyFilterTable_undo_setup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    ...
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_mfd_snmpNotifyFilterTable_undo_setup",
         "called\n"));
 ...
 * undo setup
 */
int _mfd_snmpNotifyFilterTable_undo_cleanup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx =
 ...
 * Set the value for a particular column
 */
NETSNMP_STATIC_INLINE int _snmpNotifyFilterTable_set_column(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, netsnmp_variable_list* var,
    int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_snmpNotifyFilterTable_set_column",
         "called for %d\n", column));
...
int _mfd_snmpNotifyFilterTable_set_values(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_mfd_snmpNotifyFilterTable_set_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _snmpNotifyFilterTable_set_column(rowreq_ctx, requests->requestvb,
                                               tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL(("snmpNotifyFilterTable:mfd",
 ...
 * commit the values
 */
int _mfd_snmpNotifyFilterTable_commit(netsnmp_mib_handler* handler,
                                      netsnmp_handler_registration* reginfo,
                                      ...
                                      netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_mfd_snmpNotifyFilterTable_commit",
         "called\n"));
    ...
    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
         ...
         */
        snmpNotifyFilterTable_dirty_set(snmpNotifyFilterTable_dirty_get() +
...
int _mfd_snmpNotifyFilterTable_undo_commit(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    ...
    DEBUGMSGTL((
        "internal:snmpNotifyFilterTable:_mfd_snmpNotifyFilterTable_undo_commit",
        "called\n"));
    ...
    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log(LOG_WARNING, "snmpNotifyFilterTable row dirty flag still set "
                              "after undo_commit\n");
    ...
    int column)
{
    ...
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_snmpNotifyFilterTable_undo_column",
         "called for %d\n", column));
...
int _mfd_snmpNotifyFilterTable_undo_values(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    ...
    DEBUGMSGTL((
        "internal:snmpNotifyFilterTable:_mfd_snmpNotifyFilterTable_undo_values",
        "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _snmpNotifyFilterTable_undo_column(rowreq_ctx, requests->requestvb,
                                                tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
 ...
 */
int _mfd_snmpNotifyFilterTable_irreversible_commit(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx =
 ...
 * @internal
 */
static void _container_item_free(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_container_item_free", "called\n"));
...
{
    DEBUGMSGTL(("internal:snmpNotifyFilterTable:_container_free", "called\n"));
 ...
 */
void _snmpNotifyFilterTable_container_init(
    snmpNotifyFilterTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:snmpNotifyFilterTable:_snmpNotifyFilterTable_container_init",
         "called\n"));
    ...
    if (NULL == if_ctx->container)
        if_ctx->container =
            netsnmp_container_find("snmpNotifyFilterTable:table_container");
    if (NULL == if_ctx->container)
    {
...
static int _snmpNotifyFilterTable_container_save_rows(int majorID, int minorID,
                                                      void* serverarg,
                                                      void* clientarg);
static void _snmpNotifyFilterTable_container_row_restore(const char* token,
                                                         char* buf);
static int _snmpNotifyFilterTable_container_row_save(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, void* type);
static char
 ...
 */
void snmpNotifyFilterTable_container_init_persistence(
    netsnmp_container* container)
{
    ...
    register_config_handler(NULL, row_token,
                            _snmpNotifyFilterTable_container_row_restore, NULL,
                            NULL);
    ...
    if (rc != SNMP_ERR_NOERROR)
        snmp_log(LOG_ERR,
                 "error registering for STORE_DATA callback "
                                                      ...
                                                      void* clientarg)
{
    ...
    CONTAINER_FOR_EACH(
        c,
        (netsnmp_container_obj_func*)_snmpNotifyFilterTable_container_row_save,
        type);
...
#define MAX_ROW_SIZE                                                                        \
    (sizeof(row_token) + 1 +                                                                \
     (12 *                                                                                  \
      128) + /* ASN_OBJECT_ID snmpNotifyFilterSubtree and */ /* ASN_OCTET_STR               \
                                                                snmpNotifyFilterProfileName \
                                                                indices */                  \
     ((2 * sizeof(rowreq_ctx->data.snmpNotifyFilterMask)) +                                 \
      3) +  /* ASN_OCTET_STR */                                                             \
    ...
    *pos++ = ' ';
     ...
     * add each column
     */
    for (i = SNMPNOTIFYFILTERTABLE_MIN_COL; i <= SNMPNOTIFYFILTERTABLE_MAX_COL;
         ++i)
    {
                                                         ...
                                                         char* buf)
{
    ...
    while ((NULL != buf) && isdigit((unsigned char)(*buf)))
    {
        ...
        DEBUGMSGTL(("_snmpNotifyFilterTable_container_row_restore",
                    "parsing column %d\n", col));
        buf =
            _snmpNotifyFilterTable_container_col_restore(rowreq_ctx, col, buf);
        ++found;
    }
    if (0 == found)
    {
    ...
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, u_int col, char* buf)
{
    ...
    switch (col)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERMASK: /** OCTETSTR = ASN_OCTET_STR */
            buf = read_config_save_octet_string(
                buf, (u_char*)rowreq_ctx->data.snmpNotifyFilterMask,
        ...
        case COLUMN_SNMPNOTIFYFILTERROWSTATUS: /** RowStatus = ASN_INTEGER */
            buf +=
                sprintf(buf, "%ld", rowreq_ctx->data.snmpNotifyFilterRowStatus);
            break;
    ...
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, u_int col, char* buf)
{
    ...
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:_snmpNotifyFilterTable_"
                "container_col_restore",
                "processing column %d\n", col));
    ...
    switch (col)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERTYPE: /** INTEGER = ASN_INTEGER */
            ...
            buf = read_config_read_memory(
                ASN_INTEGER, buf, (char*)&rowreq_ctx->data.snmpNotifyFilterType,
                &len);
            break;
...
snmpNotifyFilterTable_rowreq_ctx* snmpNotifyFilterTable_row_find_by_mib_index(
    snmpNotifyFilterTable_mib_index* mib_idx)
{
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx;
    ...
    rowreq_ctx = (snmpNotifyFilterTable_rowreq_ctx*)CONTAINER_FIND(
        snmpNotifyFilterTable_if_ctx.container, &oid_idx);
