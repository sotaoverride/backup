...
class Source
{
  public:
    ...
    using PropertiesVariant = std::variant<Sources>;
    ...
    virtual Sources bootSource(Sources value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_BootSource(sd_bus*, const char*, const char*,
                                        const char*, sd_bus_message*, void*,
                                        sd_bus_error*);
    /** @brief sd-bus callback for set-property 'BootSource' */
    static int _callback_set_BootSource(sd_bus*, const char*, const char*,
                                        const char*, sd_bus_message*, void*,
                                        sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Control_Boot_Source_interface;
