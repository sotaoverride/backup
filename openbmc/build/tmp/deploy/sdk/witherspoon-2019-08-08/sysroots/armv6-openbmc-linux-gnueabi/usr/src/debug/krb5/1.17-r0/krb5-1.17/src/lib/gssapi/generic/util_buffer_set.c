...
OM_uint32 generic_gss_add_buffer_set_member(OM_uint32* minor_status,
                                            ...
                                            gss_buffer_set_t* buffer_set)
{
    ...
    set = *buffer_set;
    set->elements = (gss_buffer_desc*)gssalloc_realloc(
        set->elements, (set->count + 1) * sizeof(gss_buffer_desc));
