...
#define ISENGINEKNOWN(e, e_l)                                                  \
    ((get_enginetime(e, e_l, &dummy_eboot, &dummy_etime, TRUE) ==              \
      SNMPERR_SUCCESS)                                                         \
         ? TRUE                                                                \
         : FALSE)
...
int get_enginetime(const u_char* engineID, u_int engineID_len,
                   u_int* engine_boot, u_int* engine_time, u_int authenticated);

int get_enginetime_ex(u_char* engineID, u_int engineID_len, u_int* engine_boot,
