...
static const GOptionEntry entries[] = {
    {"query-writable", 'w', 0, G_OPTION_ARG_NONE, &writable,
     N_("List writable attributes"), NULL},
    {"filesystem", 'f', 0, G_OPTION_ARG_NONE, &filesystem,
...
static void show_attributes(GFileInfo* info)
{
    ...
    {
        /* list the icons in order rather than displaying
         * "GThemedIcon:0x8df7200" */
...
static gboolean get_writable_info(GFile* file)
{
