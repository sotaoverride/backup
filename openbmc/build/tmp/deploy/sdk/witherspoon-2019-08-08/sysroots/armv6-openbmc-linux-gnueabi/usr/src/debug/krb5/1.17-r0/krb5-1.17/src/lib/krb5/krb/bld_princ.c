...
static krb5_error_code build_principal_va(krb5_context context,
...
krb5_error_code KRB5_CALLCONV krb5_build_principal_va(krb5_context context,
                                                      krb5_principal princ,
                                                      unsigned int rlen,
                                                      const char* realm,
                                                      va_list ap)
...
static const krb5_data anon_realm_data = {KV5M_DATA, sizeof(anon_realm_str) - 1,
                                          (char*)anon_realm_str};
...
const krb5_principal_data anon_princ = {
    ...
    (krb5_data*)anon_princ_data,
    2,
    KRB5_NT_WELLKNOWN};

const krb5_data* KRB5_CALLCONV krb5_anonymous_realm()
{
    return &anon_realm_data;
}

krb5_const_principal KRB5_CALLCONV krb5_anonymous_principal()
{
    return &anon_princ;
}
