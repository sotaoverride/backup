...
#define G_REAL_CLOSURE(_c)                                                     \
    ((GRealClosure*)G_STRUCT_MEMBER_P(                                         \
        (_c), -G_STRUCT_OFFSET(GRealClosure, closure)))
...
#define _G_DEFINE_TYPE_EXTENDED_WITH_PRELUDE(TN, t_n, T_P, _f_, _P_, _C_)      \
    _G_DEFINE_TYPE_EXTENDED_BEGIN_PRE(TN, t_n, T_P)                            \
    {                                                                          \
        _P_;                                                                   \
    }                                                                          \
    _G_DEFINE_TYPE_EXTENDED_BEGIN_REGISTER(TN, t_n, T_P, _f_)                  \
    {                                                                          \
        _C_;                                                                   \
    }                                                                          \
