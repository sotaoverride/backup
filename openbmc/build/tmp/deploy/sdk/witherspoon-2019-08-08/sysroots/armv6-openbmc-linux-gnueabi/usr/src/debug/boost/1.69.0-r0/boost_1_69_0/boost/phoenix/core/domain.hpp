...
struct phoenix_generator : proto::switch_<phoenix_generator>
{
...
struct phoenix_generator::case_<proto::tag::assign>
    : proto::otherwise<proto::call<proto::compose_generators<
          proto::by_value_generator, proto::pod_generator<actor>>(proto::_)>>
{
};
...
struct phoenix_default_domain
    : proto::domain<proto::basic_default_generator, proto::_,
...
struct phoenix_domain : proto::domain<phoenix_generator, meta_grammar,
                                      proto::basic_default_domain>
{
    template <typename T>
    struct as_child
