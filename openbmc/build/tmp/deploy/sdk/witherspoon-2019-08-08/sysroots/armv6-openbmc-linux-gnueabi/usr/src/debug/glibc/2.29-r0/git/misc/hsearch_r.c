...
libc_hidden_def(__hcreate_r) weak_alias(__hcreate_r, hcreate_r)
...
libc_hidden_def(__hdestroy_r) weak_alias(__hdestroy_r, hdestroy_r)
...
libc_hidden_def(__hsearch_r) weak_alias(__hsearch_r, hsearch_r)
