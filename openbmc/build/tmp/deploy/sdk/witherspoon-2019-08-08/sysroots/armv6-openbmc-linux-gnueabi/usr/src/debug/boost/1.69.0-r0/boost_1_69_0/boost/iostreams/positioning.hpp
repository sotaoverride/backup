...
// to a long. The latter operation is accomplished with the macro
// BOOST_IOSTREAMS_FPOSOFF, which works correctly on platforms where std::fpos_t
// is an integral type and platforms where it is a struct
