...
static GVariant* g_settings_set_mapping_int(const GValue* value,
...
static GVariant* g_settings_set_mapping_float(const GValue* value,
                                              const GVariantType* expected_type)
{
    GVariant* variant = NULL;
    gdouble d;
...
static gboolean g_settings_get_mapping_int(GValue* value, GVariant* variant)
{
...
static gboolean g_settings_get_mapping_float(GValue* value, GVariant* variant)
{
    const GVariantType* type;
    gdouble d;
    gint64 l;
...
static gboolean g_settings_get_mapping_unsigned_int(GValue* value,
                                                    GVariant* variant)
{
    const GVariantType* type;
    guint64 u;
                                 ...
                                 gpointer user_data)
{
    ...
    else if (G_VALUE_HOLDS_CHAR(value) || G_VALUE_HOLDS_UCHAR(value))
    {
    ...
    else if (G_VALUE_HOLDS_STRING(value))
    {
        ...
        else if (g_variant_type_equal(expected_type,
    ...
    else if (G_VALUE_HOLDS(value, G_TYPE_STRV))
    {
        if (g_value_get_boxed(value) == NULL)
            return NULL;
        return g_variant_new_strv((const gchar**)g_value_get_boxed(value), -1);
    }
...
gboolean g_settings_get_mapping(GValue* value, GVariant* variant,
                                gpointer user_data)
{
                                          ...
                                          const GVariantType* variant_type)
{
    ...
    else if (gvalue_type == G_TYPE_INT || gvalue_type == G_TYPE_UINT ||
             gvalue_type == G_TYPE_INT64 || gvalue_type == G_TYPE_UINT64 ||
