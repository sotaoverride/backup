...
#define HAVE_STATIC_TLS(map, sym_map)                                          \
    (__builtin_expect(                                                         \
        (sym_map)->l_tls_offset != NO_TLS_OFFSET &&                            \
...
#define TRY_STATIC_TLS(map, sym_map)                                           \
    (__builtin_expect((sym_map)->l_tls_offset != FORCED_DYNAMIC_TLS_OFFSET,    \
                      1) &&                                                    \
    ...
    {                                                                          \
        ...
        {                                                                      \
            ...
            if (ELF_DURING_STARTUP ||                                          \
                (!(do_lazy) && (ranges[0].start + ranges[0].size) == start))   \
            {                                                                  \
        ...
        {                                                                      \
            ...
            for (ranges_index = 0; ranges_index < 2; ++ranges_index)           \
                elf_dynamic_do_##reloc((map), ranges[ranges_index].start,      \
