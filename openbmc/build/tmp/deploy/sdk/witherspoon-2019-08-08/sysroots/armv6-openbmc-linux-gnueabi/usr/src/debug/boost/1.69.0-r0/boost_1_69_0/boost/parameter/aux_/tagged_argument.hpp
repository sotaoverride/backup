...
struct tagged_argument : tagged_argument_base
{
    ...
    struct binding
    {
        ...
        struct apply
        {
            typedef typename mpl::eval_if<
                ...
                mpl::identity<Default>>::type type;
        };
    };
    ...
    template <class F>
    reference get_with_lazy_default(lazy_default<key_type, F> const&,
                                    long) const
    {
        return value;
    }
...
template <class T>
struct is_tagged_argument_aux : is_convertible<T*, tagged_argument_base const*>
{
};

template <class T>
struct is_tagged_argument
    : mpl::and_<mpl::not_<is_reference<T>>, is_tagged_argument_aux<T>>
{
};
