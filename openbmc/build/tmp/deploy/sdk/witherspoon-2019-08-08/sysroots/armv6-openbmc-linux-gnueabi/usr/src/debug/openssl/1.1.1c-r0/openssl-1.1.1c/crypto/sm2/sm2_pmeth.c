...
static int pkey_sm2_verify(EVP_PKEY_CTX* ctx, const unsigned char* sig,
...
static int pkey_sm2_encrypt(EVP_PKEY_CTX* ctx, unsigned char* out,
...
static int pkey_sm2_decrypt(EVP_PKEY_CTX* ctx, unsigned char* out,
                            size_t* outlen, const unsigned char* in,
                            size_t inlen)
{
    EC_KEY* ec = ctx->pkey->pkey.ec;
...
static int pkey_sm2_ctrl_str(EVP_PKEY_CTX* ctx, const char* type,
                             const char* value)
{
...
const EVP_PKEY_METHOD sm2_pkey_meth = {EVP_PKEY_SM2,
                                       0,
                                       pkey_sm2_init,
                                       pkey_sm2_copy,
                                       pkey_sm2_cleanup,
