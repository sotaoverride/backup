...
struct property_kind
    : graph_introspect_detail::get_kind<
          PropertyTag, graph_introspect_detail::has_kind<PropertyTag>::value>
{
};
...
#define BGL_ALL_PROP(tag)                                                      \
    ...
    {                                                                          \
        ...
        typedef T type;                                                        \
        static T& lookup(T& x, tag)                                            \
        {                                                                      \
            return x;                                                          \
        }                                                                      \
        static const T& lookup(const T& x, tag)                                \
        {                                                                      \
            return x;                                                          \
        }                                                                      \
    };                                                                         \
    ...
    { /* Avoid ambiguity */                                                    \
        ...
        static type& lookup(type& x, tag)                                      \
        {                                                                      \
            return x;                                                          \
        }                                                                      \
        static const type& lookup(const type& x, tag)                          \
        {                                                                      \
            return x;                                                          \
        }                                                                      \
    };
...
#define BGL_DO_ONE_BUNDLE_TYPE(kind)                                           \
    ...
    {                                                                          \
        BOOST_STATIC_CONSTANT(bool, found = true);                             \
        typedef T type;                                                        \
        static T& lookup(T& x, BOOST_JOIN(kind, _bundle_t))                    \
        {                                                                      \
            return x;                                                          \
        }                                                                      \
    ...
    {                                                                          \
      ...
      public:                                                                  \
        ...
        static typename lazy_enable_if_c<                                      \
            (base_type::found &&                                               \
             (is_same<BundleTag, BOOST_JOIN(kind, _bundle_t)>::value)),        \
...
struct lookup_one_property_internal<boost::property<Tag, T, Base>, Tag>
{
    ...
    typedef T type;
    template <typename U>
    static typename enable_if<is_same<prop, U>, T&>::type lookup(U& prop,
                                                                 const Tag&)
    {
        return prop.m_value;
    }
    ...
    : lookup_one_property_internal<Base, PropName>
{
  ...
  public:
    ...
    static typename lazy_enable_if<
        is_same<PL, boost::property<Tag, T, Base>>,
        add_reference<const typename base_type::type>>::type
...
struct lookup_one_property_internal<
    T, R TMaybeBase::*, typename enable_if<is_base_of<TMaybeBase, T>>::type>
{
    BOOST_STATIC_CONSTANT(bool, found = true);
    typedef R type;
...
struct lookup_one_property<const T, Tag>
{
    ...
    static typename lazy_enable_if<
        is_same<T, U>,
        add_reference<
            const typename lookup_one_property_internal<T, Tag>::type>>::type
...
template <typename PList, typename Tag>
struct lookup_one_property_f_result<
    PList, Tag, const lookup_one_property_f<PList, Tag>(PList)>
{
...
template <typename PList, typename Tag>
struct lookup_one_property_f_result<
    PList, Tag, const lookup_one_property_f<PList, Tag>(const PList&)>
{
...
class lookup_one_property_f
{
  ...
  public:
    ...
    typename lookup_one_property_f_result<
        PList, Tag, const lookup_one_property_f(PList&)>::type
...
struct remove_first_property
{
    ...
    struct result
    {
        ...
        typedef
            typename boost::mpl::if_<boost::is_const<non_ref>,
