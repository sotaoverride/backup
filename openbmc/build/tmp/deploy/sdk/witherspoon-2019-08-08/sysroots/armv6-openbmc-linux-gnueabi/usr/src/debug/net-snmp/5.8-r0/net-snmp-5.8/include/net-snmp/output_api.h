...
/* Error reporting */
NETSNMP_IMPORT
void snmp_error(netsnmp_session* sess, int* clib_errorno, int* snmp_errorno,
                char** errstring);
NETSNMP_IMPORT
void snmp_sess_error(void* sess, int* clib_errorno, int* snmp_errorno,
                     char** errstring);
...
NETSNMP_STATIC_INLINE void netsnmp_debug_no_msg(const char* token,
                                                const char* fmt, ...)
{
}

NETSNMP_STATIC_INLINE void netsnmp_debug_no_tracetok(const char* token)
{
}

NETSNMP_STATIC_INLINE void netsnmp_debug_no_oid(const char* token,
                                                const oid* oid, size_t oid_len)
{
}

struct variable_list;

NETSNMP_STATIC_INLINE void netsnmp_debug_no_var(const char* token,
                                                const struct variable_list* var)
{
}
...
#define DEBUGDUMPSETUP(token, buf, len)                                        \
    do                                                                         \
    {                                                                          \
        netsnmp_debug_no_dumpsetup(token, buf, len);                           \
    } while (0)
