...
void (*test_io_cb_read_blk)(unsigned long block, int count, errcode_t err) = 0;
void (*test_io_cb_write_blk)(unsigned long block, int count, errcode_t err) = 0;
void (*test_io_cb_read_blk64)(unsigned long long block, int count,
                              errcode_t err) = 0;
void (*test_io_cb_write_blk64)(unsigned long long block, int count,
                               errcode_t err) = 0;
void (*test_io_cb_set_blksize)(int blksize, errcode_t err) = 0;
void (*test_io_cb_write_byte)(unsigned long block, int count,
                              errcode_t err) = 0;
...
static void test_dump_block(io_channel channel, struct test_private_data* data,
...
static errcode_t test_set_blksize(io_channel channel, int blksize)
{
    ...
    if (data->flags & TEST_FLAG_SET_BLKSIZE)
        fprintf(data->outfile, "Test_io: set_blksize(%d) returned %s\n",
                               ...
                               int count, void* buf)
{
    ...
    if (data->flags & TEST_FLAG_READ)
        fprintf(data->outfile, "Test_io: read_blk(%lu, %d) returned %s\n",
                                 ...
                                 int count, void* buf)
{
    ...
    if (data->flags & TEST_FLAG_READ)
        fprintf(data->outfile, "Test_io: read_blk64(%llu, %d) returned %s\n",
                block, count, retval ? error_message(retval) : "OK");
    if (data->block && data->block == block)
    {
        if (data->flags & TEST_FLAG_DUMP)
                                  ...
                                  int count, const void* buf)
{
    ...
    if (data->flags & TEST_FLAG_WRITE)
        fprintf(data->outfile, "Test_io: write_blk64(%llu, %d) returned %s\n",
                block, count, retval ? error_message(retval) : "OK");
    if (data->block && data->block == block)
    {
        if (data->flags & TEST_FLAG_DUMP)
                                 ...
                                 const char* arg)
{
    ...
    if (data->flags & TEST_FLAG_SET_OPTION)
        fprintf(data->outfile, "Test_io: set_option(%s, %s) ", option, arg);
                              ...
                              unsigned long long count)
{
    ...
    if (data->flags & TEST_FLAG_DISCARD)
        fprintf(data->outfile, "Test_io: discard(%llu, %llu) returned %s\n",
                block, count, retval ? error_message(retval) : "OK");
    return retval;
}
                                      ...
                                      unsigned long long count)
{
    ...
    if (data->flags & TEST_FLAG_READAHEAD)
        fprintf(data->outfile, "Test_io: readahead(%llu, %llu) returned %s\n",
                block, count, retval ? error_message(retval) : "OK");
    return retval;
}
                              ...
                              unsigned long long count)
{
    ...
    if (data->flags & TEST_FLAG_ZEROOUT)
        fprintf(data->outfile, "Test_io: zeroout(%llu, %llu) returned %s\n",
                block, count, retval ? error_message(retval) : "OK");
    return retval;
}
