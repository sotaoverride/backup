...
{
  public:
    // A tag for type categorization. Can be used to detect Boost.DateTime time
    // points in generic code.
    ...
    base_time(special_values sv) : time_(time_system::get_time_rep(sv))
    {
    }
    base_time(const time_rep_type& rhs) : time_(rhs)
    {
    }
