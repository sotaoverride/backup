...
struct indexes_of : indexes_of<N - 1, N - 1, I...>
{
};
template <int... I>
struct indexes_of<0, I...>
{
...
#define BOOST_CONTRACT_DETAIL_NO_TVARIADIC_ENUM_(z, n, tokens) tokens

#define BOOST_CONTRACT_DETAIL_TVARIADIC_ARG_(z, n, name) BOOST_PP_CAT(name, n)
...
#else
#define BOOST_CONTRACT_DETAIL_TVARIADIC_COMMA(arity) BOOST_PP_COMMA_IF(arity)
#endif

#if BOOST_CONTRACT_DETAIL_TVARIADIC
#define BOOST_CONTRACT_DETAIL_NO_TVARIADIC_COMMA(arity) /* nothing */
#else
#define BOOST_CONTRACT_DETAIL_NO_TVARIADIC_COMMA(arity) BOOST_PP_COMMA_IF(arity)
#endif
...
#else
#define BOOST_CONTRACT_DETAIL_TVARIADIC_TPARAMS_Z(z, arity, name)              \
    BOOST_PP_ENUM_##z(arity, BOOST_CONTRACT_DETAIL_TVARIADIC_TPARAM_, name)
#endif

#if BOOST_CONTRACT_DETAIL_TVARIADIC
#define BOOST_CONTRACT_DETAIL_TVARIADIC_FPARAMS_Z(z, arity, type, qualifier,   \
                                                  name)                        \
    type qualifier... name
#else
#define BOOST_CONTRACT_DETAIL_TVARIADIC_FPARAMS_Z(z, arity, type, qualifier,   \
...
#if BOOST_CONTRACT_DETAIL_TVARIADIC
#define BOOST_CONTRACT_DETAIL_TVARIADIC_ARGS_Z(z, arity, name) name...
#else
...
#else
#define BOOST_CONTRACT_DETAIL_NO_TVARIADIC_ENUM_Z(z, arity, tokens)            \
    BOOST_PP_ENUM_##z(arity, BOOST_CONTRACT_DETAIL_NO_TVARIADIC_ENUM_, tokens)
#endif

// Tuple.

#if BOOST_CONTRACT_DETAIL_TVARIADIC
#define BOOST_CONTRACT_DETAIL_TVARIADIC_TUPLE_Z(z, arity, type, qualifier,     \
                                                name)                          \
...
#if BOOST_CONTRACT_DETAIL_TVARIADIC
#define BOOST_CONTRACT_DETAIL_TVARIADIC_TUPLE_INIT_Z(z, arity, tuple, values)  \
    tuple(values...)
#else
#define BOOST_CONTRACT_DETAIL_TVARIADIC_TUPLE_INIT_Z(z, arity, tuple, values)  \
...
#define BOOST_CONTRACT_DETAIL_TVARIADIC_TUPLE_INDEXES_OF(tuple_type)           \
    typename boost::contract::detail::tvariadic_::indexes_of<sizeof...(        \
        tuple_type)>::type()
#else
#define BOOST_CONTRACT_DETAIL_TVARIADIC_TUPLE_INDEXES_OF(unused) /* nothing */
#endif

#if BOOST_CONTRACT_DETAIL_TVARIADIC
#define BOOST_CONTRACT_DETAIL_TVARIADIC_TUPLE_ELEMS_Z(z, arity, indexes,       \
                                                      tuple)                   \
    std::get<indexes>(tuple)...
#else
#define BOOST_CONTRACT_DETAIL_TVARIADIC_TUPLE_ELEMS_Z(z, arity, indexes,       \
                                                      tuple)                   \
    BOOST_PP_ENUM_##z(arity, BOOST_CONTRACT_DETAIL_TVARIADIC_TUPLE_ELEM_, tuple)
#endif
