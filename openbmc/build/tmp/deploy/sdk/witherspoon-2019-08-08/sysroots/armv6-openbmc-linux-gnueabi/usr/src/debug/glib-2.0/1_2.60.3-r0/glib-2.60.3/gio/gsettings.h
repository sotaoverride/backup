...
#define G_SETTINGS(inst)                                                       \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_SETTINGS, GSettings))
#define G_SETTINGS_CLASS(class)                                                \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_SETTINGS, GSettingsClass))
#define G_IS_SETTINGS(inst)                                                    \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_SETTINGS))
#define G_IS_SETTINGS_CLASS(class)                                             \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_SETTINGS))
#define G_SETTINGS_GET_CLASS(inst)                                             \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_SETTINGS, GSettingsClass))
...
GLIB_AVAILABLE_IN_2_32
gboolean g_settings_set_uint(GSettings* settings, const gchar* key,
                             guint value);
GLIB_AVAILABLE_IN_2_50
...
/**
 * GSettingsBindFlags:
 * @G_SETTINGS_BIND_DEFAULT: Equivalent to
 ...
 * @G_SETTINGS_BIND_NO_SENSITIVITY: Do not try to bind a "sensitivity" property
 * to the writability of the setting
 * @G_SETTINGS_BIND_GET_NO_CHANGES: When set in addition to
 * #G_SETTINGS_BIND_GET, set the #GObject property value initially from the
 * setting, but do not listen for changes of the setting
 * @G_SETTINGS_BIND_INVERT_BOOLEAN: When passed to g_settings_bind(), uses a
 * pair of mapping functions that invert the boolean value when mapping between
