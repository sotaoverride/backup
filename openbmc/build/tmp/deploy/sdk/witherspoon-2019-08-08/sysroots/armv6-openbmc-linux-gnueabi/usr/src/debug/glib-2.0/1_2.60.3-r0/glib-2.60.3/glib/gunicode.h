 ...
 * @G_UNICODE_CONNECT_PUNCTUATION: General category "Punctuation, Connector"
 * (Pc)
 * @G_UNICODE_DASH_PUNCTUATION: General category "Punctuation, Dash" (Pd)
 * @G_UNICODE_CLOSE_PUNCTUATION: General category "Punctuation, Close" (Pe)
 * @G_UNICODE_FINAL_PUNCTUATION: General category "Punctuation, Final quote"
 * (Pf)
 * @G_UNICODE_INITIAL_PUNCTUATION: General category "Punctuation, Initial quote"
 * (Pi)
 ...
 * @G_UNICODE_BREAK_COMPLEX_CONTEXT: Complex Content Dependent (South East
 * Asian) (SA)
 ...
 * @G_UNICODE_BREAK_CONDITIONAL_JAPANESE_STARTER: Conditional Japanese Starter
 * (CJ). Since: 2.32
 ...
 * See [Unicode Standard Annex #24: Script
...
GLIB_AVAILABLE_IN_ALL
gsize g_unichar_fully_decompose(gunichar ch, gboolean compat, gunichar* result,
                                gsize result_len);
...
gchar* g_utf8_substring(const gchar* str, glong start_pos,
...
gunichar2* g_utf8_to_utf16(const gchar* str, glong len, glong* items_read,
                           glong* items_written, GError** error) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gunichar* g_utf8_to_ucs4(const gchar* str, glong len, glong* items_read,
                         glong* items_written, GError** error) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gunichar* g_utf8_to_ucs4_fast(const gchar* str, glong len,
                              glong* items_written) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gunichar* g_utf16_to_ucs4(const gunichar2* str, glong len, glong* items_read,
                          glong* items_written, GError** error) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar* g_utf16_to_utf8(const gunichar2* str, glong len, glong* items_read,
                       glong* items_written, GError** error) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gunichar2* g_ucs4_to_utf16(const gunichar* str, glong len, glong* items_read,
                           glong* items_written, GError** error) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar* g_ucs4_to_utf8(const gunichar* str, glong len, glong* items_read,
                      glong* items_written, GError** error) G_GNUC_MALLOC;
...
gboolean g_utf8_validate_len(const gchar* str, gsize max_len,
                             const gchar** end);
