...
class default_sink : public sink
{
  private:
#if !defined(BOOST_LOG_NO_THREADS)
    ...
    value_extractor<
        ...
        fallback_to_default<boost::log::trivial::severity_level>> const
        m_severity_extractor;
    value_visitor_invoker<expressions::tag::message::value_type>
        m_message_visitor;
