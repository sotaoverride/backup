...
#define eret()                                                                 \
    do                                                                         \
    {                                                                          \
        clnt_perror(handle->clnt, "null ret");                                 \
...
kadm5_ret_t kadm5_create_principal_3(void* server_handle,
                                     kadm5_principal_ent_t princ, long mask,
                                     int n_ks_tuple,
                                     krb5_key_salt_tuple* ks_tuple, char* pw)
{
    generic_ret r = {0, 0};
    cprinc3_arg arg;
    kadm5_server_handle_t handle = server_handle;
...
kadm5_ret_t kadm5_get_principal(void* server_handle, krb5_principal princ,
...
kadm5_ret_t kadm5_chpass_principal(void* server_handle, krb5_principal princ,
                                   char* password)
{
    chpass_arg arg;
    generic_ret r = {0, 0};
...
kadm5_ret_t kadm5_chpass_principal_3(void* server_handle, krb5_principal princ,
...
kadm5_ret_t kadm5_setv4key_principal(void* server_handle, krb5_principal princ,
...
kadm5_ret_t kadm5_setkey_principal(void* server_handle, krb5_principal princ,
...
kadm5_ret_t kadm5_setkey_principal_3(void* server_handle, krb5_principal princ,
                                     krb5_boolean keepold, int n_ks_tuple,
                                     krb5_key_salt_tuple* ks_tuple,
                                     krb5_keyblock* keyblocks, int n_keys)
{
...
kadm5_ret_t kadm5_setkey_principal_4(void* server_handle, krb5_principal princ,
...
kadm5_ret_t kadm5_randkey_principal_3(void* server_handle, krb5_principal princ,
                                      krb5_boolean keepold, int n_ks_tuple,
                                      krb5_key_salt_tuple* ks_tuple,
...
kadm5_ret_t kadm5_randkey_principal(void* server_handle, krb5_principal princ,
                                    krb5_keyblock** key, int* n_keys)
{
    chrand_arg arg;
    chrand_ret r;
...
kadm5_ret_t kadm5_purgekeys(void* server_handle, krb5_principal princ,
                            int keepkvno)
{
    purgekeys_arg arg;
    generic_ret r = {0, 0};
...
kadm5_ret_t kadm5_get_principal_keys(void* server_handle, krb5_principal princ,
