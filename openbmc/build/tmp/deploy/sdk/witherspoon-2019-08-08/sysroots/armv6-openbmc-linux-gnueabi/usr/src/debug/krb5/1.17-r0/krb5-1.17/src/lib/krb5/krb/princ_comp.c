...
static krb5_boolean realm_compare_flags(krb5_context context,
...
static krb5_error_code upn_to_principal(krb5_context context,
                                        ...
                                        krb5_principal* upn)
{
    ...
    code = krb5_unparse_name_flags(
        context, princ, KRB5_PRINCIPAL_UNPARSE_NO_REALM, &unparsed_name);
    if (code)
    {
        *upn = NULL;
        return code;
