...
static unsigned int hash(krb5_donot_replay* rep, unsigned int hsize)
{
...
/*ARGSUSED*/
static int cmp(krb5_donot_replay* old, krb5_donot_replay* new1, krb5_deltat t)
{
    if ((old->cusec == new1->cusec) && /* most likely to distinguish */
        (old->ctime == new1->ctime) &&
        (strcmp(old->client, new1->client) == 0) &&
        (strcmp(old->server, new1->server) == 0))
    { /* always true */
...
static int alive(krb5_timestamp mytime, krb5_donot_replay* new1, krb5_deltat t)
{
    if (mytime == 0)
...
static int rc_store(krb5_context context, krb5_rcache id,
                    krb5_donot_replay* rep, krb5_timestamp now,
                    krb5_boolean fromfile)
{
...
char* KRB5_CALLCONV krb5_rc_dfl_get_name(krb5_context context, krb5_rcache id)
{
    return ((struct dfl_data*)(id->data))->name;
}

krb5_error_code KRB5_CALLCONV krb5_rc_dfl_get_span(krb5_context context,
                                                   krb5_rcache id,
                                                   krb5_deltat* lifespan)
{
    struct dfl_data* t;
...
static krb5_error_code KRB5_CALLCONV krb5_rc_dfl_init_locked(
    krb5_context context, krb5_rcache id, krb5_deltat lifespan)
{
    struct dfl_data* t = (struct dfl_data*)id->data;
    ...
    if ((krb5_rc_io_write(context, &t->d, (krb5_pointer)&t->lifespan,
                          sizeof(t->lifespan)) ||
...
krb5_error_code KRB5_CALLCONV krb5_rc_dfl_init(krb5_context context,
                                               krb5_rcache id,
                                               krb5_deltat lifespan)
{
    krb5_error_code retval;
...
krb5_error_code krb5_rc_dfl_close_no_free(krb5_context context, krb5_rcache id)
{
    struct dfl_data* t = (struct dfl_data*)id->data;
    struct authlist* q;
...
krb5_error_code KRB5_CALLCONV krb5_rc_dfl_close(krb5_context context,
                                                krb5_rcache id)
{
    k5_mutex_lock(&id->lock);
...
krb5_error_code KRB5_CALLCONV krb5_rc_dfl_destroy(krb5_context context,
                                                  krb5_rcache id)
{
#ifndef NOIOSTUFF
...
krb5_error_code KRB5_CALLCONV krb5_rc_dfl_resolve(krb5_context context,
                                                  krb5_rcache id, char* name)
{
    struct dfl_data* t = 0;
    krb5_error_code retval;
...
void krb5_rc_free_entry(krb5_context context, krb5_donot_replay** rep)
{
 ...
 * *result to NULL.
 */
static krb5_error_code parse_counted_string(char** strptr, char** result)
{
    char *str = *strptr, *end;
    unsigned long len;
 ...
 */
static krb5_error_code check_hash_extension(krb5_donot_replay* rep)
{
...
static krb5_error_code krb5_rc_io_fetch(krb5_context context,
                                        struct dfl_data* t,
                                        krb5_donot_replay* rep, int maxlen)
{
    ...
    retval = krb5_rc_io_read(context, &t->d, (krb5_pointer)&len2, sizeof(len2));
    if (retval)
        return retval;
...
static krb5_error_code krb5_rc_dfl_expunge_locked(krb5_context context,
                                                  krb5_rcache id);

static krb5_error_code krb5_rc_dfl_recover_locked(krb5_context context,
                                                  krb5_rcache id)
{
#ifdef NOIOSTUFF
    return KRB5_RC_NOIO;
...
krb5_error_code KRB5_CALLCONV krb5_rc_dfl_recover(krb5_context context,
                                                  krb5_rcache id)
{
    krb5_error_code ret;
...
krb5_error_code KRB5_CALLCONV krb5_rc_dfl_recover_or_init(krb5_context context,
                                                          krb5_rcache id,
                                                          krb5_deltat lifespan)
{
    krb5_error_code retval;
...
static krb5_error_code krb5_rc_io_store(krb5_context context,
                                        struct dfl_data* t,
                                        krb5_donot_replay* rep)
{
...
krb5_error_code KRB5_CALLCONV krb5_rc_dfl_store(krb5_context context,
                                                krb5_rcache id,
                                                krb5_donot_replay* rep)
{
    krb5_error_code ret;
...
krb5_error_code KRB5_CALLCONV krb5_rc_dfl_expunge(krb5_context context,
                                                  krb5_rcache id)
{
    krb5_error_code ret;
