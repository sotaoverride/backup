...
static int __THROW _IO_str_chk_overflow(FILE* fp, int c)
{
...
int __vsprintf_internal(char* string, size_t maxlen, const char* format,
                        va_list args, unsigned int mode_flags)
{
    ...
    _IO_str_init_static_internal(&sf, string, (maxlen == -1) ? -1 : maxlen - 1,
                                 string);
