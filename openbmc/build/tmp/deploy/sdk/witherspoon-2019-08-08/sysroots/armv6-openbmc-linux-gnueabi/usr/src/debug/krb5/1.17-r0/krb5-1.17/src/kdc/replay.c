...
static size_t entry_size(const krb5_data* req, const krb5_data* rep)
{
...
static struct entry* insert_entry(krb5_context context, krb5_data* req,
                                  krb5_data* rep, krb5_timestamp time)
{
    krb5_error_code ret;
    struct entry* entry;
...
static void discard_entry(krb5_context context, struct entry* entry)
{
...
void kdc_remove_lookaside(krb5_context kcontext, krb5_data* req_packet)
{
    struct entry* e;
 ...
 * to NULL.
 */
krb5_boolean kdc_check_lookaside(krb5_context kcontext, krb5_data* req_packet,
                                 krb5_data** reply_packet_out)
{
    ...
    *reply_packet_out = NULL;
    ...
    return (krb5_copy_data(kcontext, &e->reply_packet, reply_packet_out) == 0);
}
 ...
 */
void kdc_insert_lookaside(krb5_context kcontext, krb5_data* req_packet,
                          krb5_data* reply_packet)
{
    struct entry *e, *next;
...
void kdc_free_lookaside(krb5_context kcontext)
{
    struct entry *e, *next;
