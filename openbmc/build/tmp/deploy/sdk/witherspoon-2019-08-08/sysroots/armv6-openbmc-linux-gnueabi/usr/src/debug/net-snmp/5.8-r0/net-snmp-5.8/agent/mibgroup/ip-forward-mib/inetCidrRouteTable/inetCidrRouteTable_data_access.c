 ...
 */
int inetCidrRouteTable_init_data(
    inetCidrRouteTable_registration* inetCidrRouteTable_reg)
{
 ...
 */
void inetCidrRouteTable_container_init(netsnmp_container** container_ptr_ptr,
                                       netsnmp_cache* cache)
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRouteTable_container_init",
                "called\n"));
                               ...
                               netsnmp_container* container)
{
     ...
     */
    if (route_entry->rt_type == 0)
    { /* set when route not up */
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS ==
         inetCidrRouteTable_indexes_set(
             rowreq_ctx, route_entry->rt_dest_type, (char*)route_entry->rt_dest,
             route_entry->rt_dest_len, route_entry->rt_pfx_len,
             route_entry->rt_policy, route_entry->rt_policy_len,
             route_entry->rt_nexthop_type, (char*)route_entry->rt_nexthop,
             route_entry->rt_nexthop_len)))
    {
 ...
 */
void inetCidrRouteTable_container_shutdown(netsnmp_container* container_ptr)
{
    DEBUGMSGTL(
        ("verbose:inetCidrRouteTable:inetCidrRouteTable_container_shutdown",
         "called\n"));
 ...
 *
 */
int inetCidrRouteTable_container_load(netsnmp_container* container)
{
    netsnmp_container* route_container;

    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRouteTable_container_load",
                "called\n"));
     ...
     */
    route_container = netsnmp_access_route_container_load(
        NULL, NETSNMP_ACCESS_ROUTE_LOAD_NOFLAGS);
    DEBUGMSGT(("verbose:inetCidrRouteTable:inetCidrRouteTable_cache_load",
 ...
 *
 */
void inetCidrRouteTable_container_free(netsnmp_container* container)
{
 ...
 * @retval MFD_ERROR       : other error.
 */
int inetCidrRouteTable_row_prep(inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:inetCidrRouteTable:inetCidrRouteTable_row_prep", "called\n"));
    ...
    {
        memcpy(rowreq_ctx->data->rt_dest, rowreq_ctx->tbl_idx.inetCidrRouteDest,
        ...
        rowreq_ctx->data->rt_pfx_len = rowreq_ctx->tbl_idx.inetCidrRoutePfxLen;

        rowreq_ctx->data->rt_policy_len =
            rowreq_ctx->tbl_idx.inetCidrRoutePolicy_len;
        rowreq_ctx->data->rt_policy = rowreq_ctx->tbl_idx.inetCidrRoutePolicy;
        /*
 ...
 *    The value is one of  unknown(0), ipv4(1), ipv6(2), ipv4z(3), ipv6z(4),
 * dns(16)
 *
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRouteDestType_check_index(inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRouteDestType_check_index",
                "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRouteDest_check_index(inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRoutePfxLen_check_index(inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRoutePfxLen_check_index",
                "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRoutePolicy_check_index(inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRoutePolicy_check_index",
                "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRouteNextHopType_check_index(
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:inetCidrRouteTable:inetCidrRouteNextHopType_check_index",
         "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRouteNextHop_check_index(inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRouteNextHop_check_index",
                "called\n"));
 ...
 */
int inetCidrRouteTable_validate_index(
    inetCidrRouteTable_registration* inetCidrRouteTable_reg,
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRouteTable_validate_index",
                "called\n"));
