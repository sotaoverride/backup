...
netsnmp_feature_child_of(ipSystemStatsTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_child_of(ipSystemStatsTable_container_size,
                                 ipSystemStatsTable_external_access)
            netsnmp_feature_child_of(ipSystemStatsTable_registration_set,
                                     ipSystemStatsTable_external_access)
                netsnmp_feature_child_of(ipSystemStatsTable_registration_get,
                                         ipSystemStatsTable_external_access)
                    netsnmp_feature_child_of(ipSystemStatsTable_container_get,
                                             ipSystemStatsTable_external_access)
...
static void _ipSystemStatsTable_container_init(
    ...
    else
    {
        if (NULL != data)
        {
            ...
            rowreq_ctx->data = data;
                 ...
                 (rowreq_ctx->data = ipSystemStatsTable_allocate_data()))
        {
                                   ...
                                   netsnmp_variable_list* var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPSYSTEMSTATSINOCTETS:
            ...
            var->type = ASN_COUNTER;
            rc =
                ipSystemStatsInOctets_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCINOCTETS:
            var->val_len = sizeof(struct counter64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCInOctets_get(
                rowreq_ctx, (struct counter64*)var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSREASMOKS:
            ...
            var->type = ASN_COUNTER;
            rc =
                ipSystemStatsReasmOKs_get(rowreq_ctx, (u_long*)var->val.string);
            break;
    ...
    ipSystemStatsTable_interface_ctx* if_ctx)
{
    ...
    if_ctx->cache =
        netsnmp_cache_create(30, /* timeout in seconds */
                             _cache_load, _cache_free, ipSystemStatsTable_oid,
