...
netsnmp_feature_child_of(inetCidrRouteTable_external_access, libnetsnmpmibs)
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        baby_steps) netsnmp_feature_require(table_container_row_insert)
        netsnmp_feature_require(check_all_requests_error)

            netsnmp_feature_child_of(inetCidrRouteTable_container_size,
                                     inetCidrRouteTable_external_access)
                netsnmp_feature_child_of(inetCidrRouteTable_registration_set,
                                         inetCidrRouteTable_external_access)
...
static void _inetCidrRouteTable_container_init(
    inetCidrRouteTable_interface_ctx* if_ctx);
static void _inetCidrRouteTable_container_shutdown(
    inetCidrRouteTable_interface_ctx* if_ctx);
...
inetCidrRouteTable_registration* inetCidrRouteTable_registration_get(void)
{
...
inetCidrRouteTable_registration*
    inetCidrRouteTable_registration_set(inetCidrRouteTable_registration* newreg)
{
...
NETSNMP_STATIC_INLINE int _inetCidrRouteTable_check_indexes(
 ...
 */
void _inetCidrRouteTable_initialize_interface(
    inetCidrRouteTable_registration* reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods* access_multiplexer =
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_inetCidrRouteTable_initialize_interface",
         "called\n"));
     ...
     */
    DEBUGMSGTL(
        ("inetCidrRouteTable:init_inetCidrRouteTable",
         "Registering inetCidrRouteTable as a mibs-for-dummies table.\n"));
    handler = netsnmp_baby_steps_access_multiplexer_get(access_multiplexer);
    reginfo = netsnmp_handler_registration_create("inetCidrRouteTable", handler,
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, inetCidrRouteTable_if_ctx.container,
    ...
    {
        handler = netsnmp_cache_handler_get(inetCidrRouteTable_if_ctx.cache);
        netsnmp_inject_handler(reginfo, handler);
    }
 ...
 */
void _inetCidrRouteTable_shutdown_interface(
    inetCidrRouteTable_registration* reg_ptr)
{
    /*
...
void inetCidrRouteTable_valid_columns_set(netsnmp_column_info* vc)
{
 ...
 */
int inetCidrRouteTable_index_to_oid(netsnmp_index* oid_idx,
                                    inetCidrRouteTable_mib_index* mib_idx)
{
     ...
     * set up varbinds
     */
    memset(&var_inetCidrRouteDestType, 0x00, sizeof(var_inetCidrRouteDestType));
    ...
    memset(&var_inetCidrRoutePfxLen, 0x00, sizeof(var_inetCidrRoutePfxLen));
    var_inetCidrRoutePfxLen.type = ASN_UNSIGNED;
    memset(&var_inetCidrRoutePolicy, 0x00, sizeof(var_inetCidrRoutePolicy));
    ...
    memset(&var_inetCidrRouteNextHop, 0x00, sizeof(var_inetCidrRouteNextHop));
    ...
    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRouteTable_index_to_oid",
                "called\n"));
     ...
     */
    snmp_set_var_value(
        &var_inetCidrRouteDest, (u_char*)&mib_idx->inetCidrRouteDest,
 ...
 */
int inetCidrRouteTable_index_from_oid(netsnmp_index* oid_idx,
                                      inetCidrRouteTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL(("verbose:inetCidrRouteTable:inetCidrRouteTable_index_from_oid",
                "called\n"));
    ...
    if (err == SNMP_ERR_NOERROR)
    {
         ...
         */
        if (var_inetCidrRouteDest.val_len > sizeof(mib_idx->inetCidrRouteDest))
            err = SNMP_ERR_GENERR;
        else
        {
            memcpy(mib_idx->inetCidrRouteDest, var_inetCidrRouteDest.val.string,
                                           ...
                                           void* user_init_ctx)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:inetCidrRouteTable_allocate_rowreq_ctx",
         "called\n"));
    ...
    {
        if (SNMPERR_SUCCESS !=
            inetCidrRouteTable_rowreq_ctx_init(rowreq_ctx, user_init_ctx))
        {
 ...
 */
void inetCidrRouteTable_release_rowreq_ctx(
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:inetCidrRouteTable_release_rowreq_ctx",
         "called\n"));
 ...
 * wrapper
 */
static int _mfd_inetCidrRouteTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_pre_request",
         "called\n"));
 ...
 * wrapper
 */
static int _mfd_inetCidrRouteTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx =
        (inetCidrRouteTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    int rc, packet_rc;
    ...
    {
        DEBUGMSGTL(
            ("internal:inetCidrRouteTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    rc = inetCidrRouteTable_post_request(inetCidrRouteTable_if_ctx.user_ctx,
                                         packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
                                              ...
                                              int* rc_ptr)
{
    ...
    DEBUGMSGTL((
        "internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_rowreq_from_index",
        "called\n"));
 ...
 * wrapper
 */
static int _mfd_inetCidrRouteTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_object_lookup",
         "called\n"));
                                   ...
                                   netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_get_column",
         "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_INETCIDRROUTEIFINDEX:
            ...
            rc = inetCidrRouteIfIndex_get(rowreq_ctx, (long*)var->val.string);
            break;
        ...
        case COLUMN_INETCIDRROUTEPROTO:
            var->val_len = sizeof(u_long);
            var->type = ASN_INTEGER;
            rc = inetCidrRouteProto_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC1:
            var->val_len = sizeof(long);
            var->type = ASN_INTEGER;
            rc = inetCidrRouteMetric1_get(rowreq_ctx, (long*)var->val.string);
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC2:
            var->val_len = sizeof(long);
            var->type = ASN_INTEGER;
            rc = inetCidrRouteMetric2_get(rowreq_ctx, (long*)var->val.string);
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC3:
            var->val_len = sizeof(long);
            var->type = ASN_INTEGER;
            rc = inetCidrRouteMetric3_get(rowreq_ctx, (long*)var->val.string);
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC4:
            var->val_len = sizeof(long);
            var->type = ASN_INTEGER;
            rc = inetCidrRouteMetric4_get(rowreq_ctx, (long*)var->val.string);
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC5:
            var->val_len = sizeof(long);
            var->type = ASN_INTEGER;
            rc = inetCidrRouteMetric5_get(rowreq_ctx, (long*)var->val.string);
            break;
        ...
        case COLUMN_INETCIDRROUTESTATUS:
            var->val_len = sizeof(u_long);
            var->type = ASN_INTEGER;
            rc = inetCidrRouteStatus_get(rowreq_ctx, (u_long*)var->val.string);
            break;
...
int _mfd_inetCidrRouteTable_get_values(netsnmp_mib_handler* handler,
                                       netsnmp_handler_registration* reginfo,
                                       ...
                                       netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_get_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetCidrRouteTable_get_column(rowreq_ctx, requests->requestvb,
                                            tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
    ...
    _inetCidrRouteTable_check_indexes(inetCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    ...
    DEBUGMSGTL(("internal:inetCidrRouteTable:_inetCidrRouteTable_check_indexes",
                "called\n"));
     ...
     */
    return inetCidrRouteTable_validate_index(inetCidrRouteTable_if_ctx.user_ctx,
                                             rowreq_ctx);
 ...
 */
NETSNMP_STATIC_INLINE int
    _inetCidrRouteTable_check_column(inetCidrRouteTable_rowreq_ctx* rowreq_ctx,
                                     netsnmp_variable_list* var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(("internal:inetCidrRouteTable:_inetCidrRouteTable_check_column",
                "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_INETCIDRROUTEIFINDEX:
            ...
            {
                DEBUGMSGTL(
                    ("inetCidrRouteTable:_inetCidrRouteTable_check_column:"
                     "inetCidrRouteIfIndex",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteIfIndex_check_value(
        ...
        case COLUMN_INETCIDRROUTENEXTHOPAS:
            ...
            {
                rc = inetCidrRouteNextHopAS_check_value(
        ...
        case COLUMN_INETCIDRROUTEMETRIC1:
            ...
            {
                rc = inetCidrRouteMetric1_check_value(
                    rowreq_ctx, *((long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
        ...
        case COLUMN_INETCIDRROUTEMETRIC2:
            ...
            {
                rc = inetCidrRouteMetric2_check_value(
                    rowreq_ctx, *((long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
        ...
        case COLUMN_INETCIDRROUTEMETRIC3:
            ...
            {
                rc = inetCidrRouteMetric3_check_value(
                    rowreq_ctx, *((long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
        ...
        case COLUMN_INETCIDRROUTEMETRIC4:
            ...
            {
                rc = inetCidrRouteMetric4_check_value(
                    rowreq_ctx, *((long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
        ...
        case COLUMN_INETCIDRROUTEMETRIC5:
            ...
            {
                rc = inetCidrRouteMetric5_check_value(
                    rowreq_ctx, *((long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
        ...
        case COLUMN_INETCIDRROUTESTATUS:
            ...
            {
                rc = inetCidrRouteStatus_check_value(
                    rowreq_ctx, *((u_long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
...
int _mfd_inetCidrRouteTable_check_objects(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_check_objects",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetCidrRouteTable_check_column(rowreq_ctx, requests->requestvb,
                                              tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error(requests, SNMP_VALIDATE_ERR(rc));
 ...
 */
static int _mfd_inetCidrRouteTable_check_dependencies(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx =
        (inetCidrRouteTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    DEBUGMSGTL(("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_check_"
                "dependencies",
                "called\n"));
    ...
    if (rc)
    {
        DEBUGMSGTL(("inetCidrRouteTable:mfd",
                    "error %d from "
 ...
 */
NETSNMP_STATIC_INLINE int _inetCidrRouteTable_undo_setup_column(
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_inetCidrRouteTable_undo_setup_column",
         "called for %d\n", column));
 ...
 * undo setup
 */
int _mfd_inetCidrRouteTable_undo_setup(netsnmp_mib_handler* handler,
                                       netsnmp_handler_registration* reginfo,
                                       netsnmp_agent_request_info* agtreq_info,
                                       netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_undo_setup",
         "called\n"));
    ...
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _inetCidrRouteTable_undo_setup_column(rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL(("inetCidrRouteTable:mfd",
                            "error %d from "
 ...
 * undo setup
 */
int _mfd_inetCidrRouteTable_undo_cleanup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_undo_cleanup",
         "called\n"));
                                   ...
                                   netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(("internal:inetCidrRouteTable:_inetCidrRouteTable_set_column",
                "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_INETCIDRROUTEIFINDEX:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEIFINDEX_FLAG;
            rc =
                inetCidrRouteIfIndex_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTETYPE:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTETYPE_FLAG;
            rc = inetCidrRouteType_set(rowreq_ctx, *((u_long*)var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC1:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC1_FLAG;
            rc =
                inetCidrRouteMetric1_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC2:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC2_FLAG;
            rc =
                inetCidrRouteMetric2_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC3:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC3_FLAG;
            rc =
                inetCidrRouteMetric3_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC4:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC4_FLAG;
            rc =
                inetCidrRouteMetric4_set(rowreq_ctx, *((long*)var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC5:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC5_FLAG;
            rc =
                inetCidrRouteMetric5_set(rowreq_ctx, *((long*)var->val.string));
            break;
...
int _mfd_inetCidrRouteTable_set_values(netsnmp_mib_handler* handler,
                                       netsnmp_handler_registration* reginfo,
                                       netsnmp_agent_request_info* agtreq_info,
                                       netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_set_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetCidrRouteTable_set_column(rowreq_ctx, requests->requestvb,
                                            tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL(("inetCidrRouteTable:mfd",
 ...
 * commit the values
 */
int _mfd_inetCidrRouteTable_commit(netsnmp_mib_handler* handler,
                                   netsnmp_handler_registration* reginfo,
                                   netsnmp_agent_request_info* agtreq_info,
                                   netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_commit",
                "called\n"));
    ...
    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
         ...
         */
        inetCidrRouteTable_dirty_set(inetCidrRouteTable_dirty_get() +
...
int _mfd_inetCidrRouteTable_undo_commit(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        netsnmp_agent_request_info* agtreq_info,
                                        netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_undo_commit",
         "called\n"));
 ...
 *
 *---------------------------------------------------------------------*/
int _mfd_inetCidrRouteTable_undo_values(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        netsnmp_agent_request_info* agtreq_info,
                                        netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_undo_values",
         "called\n"));
 ...
 */
int _mfd_inetCidrRouteTable_irreversible_commit(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(("internal:inetCidrRouteTable:_mfd_inetCidrRouteTable_"
                "irreversible:commit",
                "called\n"));
    ...
    else
    {
        ...
        {
            rowreq_ctx->rowreq_flags &= ~MFD_ROW_CREATED;
            CONTAINER_INSERT(inetCidrRouteTable_if_ctx.container, rowreq_ctx);
        }
    }
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
    ...
    {
        snmp_log(LOG_ERR, "invalid cache for inetCidrRouteTable_cache_load\n");
        return -1;
    }
     ...
     * call user code
     */
    return inetCidrRouteTable_container_load((netsnmp_container*)cache->magic);
} /* _cache_load */
...
static void _cache_free(netsnmp_cache* cache, void* magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log(LOG_ERR, "invalid cache in inetCidrRouteTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free(inetCidrRouteTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_container_item_free", "called\n"));
...
static void _container_free(netsnmp_container* container)
{
    DEBUGMSGTL(("internal:inetCidrRouteTable:_container_free", "called\n"));
 ...
 */
void _inetCidrRouteTable_container_init(
    inetCidrRouteTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_inetCidrRouteTable_container_init",
         "called\n"));
    ...
    if_ctx->cache = netsnmp_cache_create(
        INETCIDRROUTETABLE_CACHE_TIMEOUT, _cache_load, _cache_free,
        inetCidrRouteTable_oid, inetCidrRouteTable_oid_size);
 ...
 */
void _inetCidrRouteTable_container_shutdown(
    inetCidrRouteTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:inetCidrRouteTable:_inetCidrRouteTable_container_shutdown",
         "called\n"));
...
inetCidrRouteTable_rowreq_ctx* inetCidrRouteTable_row_find_by_mib_index(
    inetCidrRouteTable_mib_index* mib_idx)
{
    inetCidrRouteTable_rowreq_ctx* rowreq_ctx;
    ...
    rowreq_ctx = (inetCidrRouteTable_rowreq_ctx*)CONTAINER_FIND(
        inetCidrRouteTable_if_ctx.container, &oid_idx);
