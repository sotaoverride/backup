...
//!   - boost::intrusive::slist / boost::intrusive::slist_base_hook /
//!   boost::intrusive::slist_member_hook
//!   - boost::intrusive::list / boost::intrusive::list_base_hook /
//!   boost::intrusive::list_member_hook
//!   - boost::intrusive::bstree / boost::intrusive::bs_set /
//!   boost::intrusive::bs_multiset /
//!      boost::intrusive::bs_set_base_hook /
//!      boost::intrusive::bs_set_member_hook
//!   - boost::intrusive::rbtree / boost::intrusive::set /
//!   boost::intrusive::multiset /
//!      boost::intrusive::set_base_hook / boost::intrusive::set_member_hook
//!   - boost::intrusive::avltree / boost::intrusive::avl_set /
//!   boost::intrusive::avl_multiset /
//!      boost::intrusive::avl_set_base_hook /
//!      boost::intrusive::avl_set_member_hook
//!   - boost::intrusive::splaytree / boost::intrusive::splay_set /
//!   boost::intrusive::splay_multiset
//!   - boost::intrusive::sgtree / boost::intrusive::sg_set /
//!   boost::intrusive::sg_multiset
//!   - boost::intrusive::treap / boost::intrusive::treap_set /
//!   boost::intrusive::treap_multiset
//!   - boost::intrusive::hashtable / boost::intrusive::unordered_set /
...
//!   - boost::intrusive::constant_time_size / boost::intrusive::size_type /
//!   boost::intrusive::compare / boost::intrusive::equal
//!   - boost::intrusive::floating_point / boost::intrusive::priority /
//!   boost::intrusive::hash
//!   - boost::intrusive::value_traits / boost::intrusive::member_hook /
//!   boost::intrusive::function_hook / boost::intrusive::base_hook
//!   - boost::intrusive::void_pointer / boost::intrusive::tag /
//!   boost::intrusive::link_mode
//!   - boost::intrusive::optimize_size / boost::intrusive::linear /
//!   boost::intrusive::cache_last
//!   - boost::intrusive::bucket_traits / boost::intrusive::store_hash /
//!   boost::intrusive::optimize_multikey
//!   - boost::intrusive::power_2_buckets / boost::intrusive::cache_begin /
//!   boost::intrusive::compare_hash / boost::intrusive::incremental
//!
...
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
template <class T, class O1 = void, class O2 = void, class O3 = void,
          class O4 = void, class O5 = void, class O6 = void, class O7 = void,
          class O8 = void, class O9 = void, class O10 = void>
#else
template <class T, class... Options>
#endif
class hashtable;
