...
/*
 * Copyright 1995, 2003, 2008, 2011 by the Massachusetts Institute of
...
static krb5_error_code encts_prep_questions(
                  ...
                  krb5_pa_data*** out_padata)
{
    ...
    if (ret)
        goto cleanup;
    TRACE_PREAUTH_ENC_TS(context, pa_enc.patimestamp, pa_enc.pausec, ts,
                         &enc_data.ciphertext);
...
static krb5_preauthtype encts_pa_types[] = {KRB5_PADATA_ENC_TIMESTAMP, 0};
