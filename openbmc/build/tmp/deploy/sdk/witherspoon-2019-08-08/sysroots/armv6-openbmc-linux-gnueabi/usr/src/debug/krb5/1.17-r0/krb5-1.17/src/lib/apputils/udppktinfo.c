...
static inline krb5_error_code set_ipv4_recvpktinfo(int sock)
{
    int sockopt = 1;
...
static inline krb5_error_code set_ipv4_recvdstaddr(int sock)
{
    int sockopt = 1;
...
static inline krb5_error_code set_ipv6_recvpktinfo(int sock)
{
    int sockopt = 1;
 ...
 * family.
 */
krb5_error_code set_pktinfo(int sock, int family)
{
    switch (family)
    {
        case AF_INET:
 ...
 */
static int is_socket_bound_to_wildcard(int sock)
{
...
static inline struct in_pktinfo* cmsg2pktinfo(struct cmsghdr* cmsgptr)
{
    return (struct in_pktinfo*)(void*)CMSG_DATA(cmsgptr);
}

#define check_cmsg_v4_pktinfo check_cmsg_ip_pktinfo
static int check_cmsg_ip_pktinfo(struct cmsghdr* cmsgptr, struct sockaddr* to,
...
static inline struct in_addr* cmsg2sin(struct cmsghdr* cmsgptr)
{
    return (struct in_addr*)(void*)CMSG_DATA(cmsgptr);
}

#define check_cmsg_v4_pktinfo check_cmsg_ip_recvdstaddr
static int check_cmsg_ip_recvdstaddr(struct cmsghdr* cmsgptr,
...
static inline struct in6_pktinfo* cmsg2pktinfo6(struct cmsghdr* cmsgptr)
{
    return (struct in6_pktinfo*)(void*)CMSG_DATA(cmsgptr);
}

#define check_cmsg_v6_pktinfo check_cmsg_ipv6_pktinfo
static int check_cmsg_ipv6_pktinfo(struct cmsghdr* cmsgptr, struct sockaddr* to,
                                   socklen_t* tolen,
                                   aux_addressing_info* auxaddr)
{
...
static int check_cmsg_pktinfo(struct cmsghdr* cmsgptr, struct sockaddr* to,
                              socklen_t* tolen, aux_addressing_info* auxaddr)
{
 ...
 */
krb5_error_code recv_from_to(int sock, void* buf, size_t len, int flags,
...
static krb5_error_code set_msg_from_ip_pktinfo(struct msghdr* msg,
                                               struct cmsghdr* cmsgptr,
...
static krb5_error_code set_msg_from_ip_sendsrcaddr(struct msghdr* msg,
                                                   struct cmsghdr* cmsgptr,
                                                   struct sockaddr* from,
                                                   socklen_t fromlen,
                                                   aux_addressing_info* auxaddr)
...
static krb5_error_code set_msg_from_ipv6_pktinfo(struct msghdr* msg,
                                                 struct cmsghdr* cmsgptr,
                                                 struct sockaddr* from,
                                                 socklen_t fromlen,
                                                 aux_addressing_info* auxaddr)
...
static krb5_error_code set_msg_from(int family, struct msghdr* msg,
                                    struct cmsghdr* cmsgptr,
                                    struct sockaddr* from, socklen_t fromlen,
                                    aux_addressing_info* auxaddr)
{
