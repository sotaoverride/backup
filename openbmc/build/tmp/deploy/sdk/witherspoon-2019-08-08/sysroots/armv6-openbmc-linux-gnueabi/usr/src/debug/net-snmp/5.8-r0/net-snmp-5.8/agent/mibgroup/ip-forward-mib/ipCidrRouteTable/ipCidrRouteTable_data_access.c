 ...
 */
int ipCidrRouteTable_init_data(
    ipCidrRouteTable_registration* ipCidrRouteTable_reg)
{
    DEBUGMSGTL(
        ("verbose:ipCidrRouteTable:ipCidrRouteTable_init_data", "called\n"));
 ...
 */
void ipCidrRouteTable_container_init(netsnmp_container** container_ptr_ptr,
                                     netsnmp_cache* cache)
{
 ...
 */
void ipCidrRouteTable_container_shutdown(netsnmp_container* container_ptr)
{
    DEBUGMSGTL(("verbose:ipCidrRouteTable:ipCidrRouteTable_container_shutdown",
                "called\n"));
 ...
 *
 */
int ipCidrRouteTable_container_load(netsnmp_container* container)
{
    netsnmp_container* route_container;

    DEBUGMSGTL(
        ("verbose:ipCidrRouteTable:ipCidrRouteTable_cache_load", "called\n"));
    ...
    route_container = netsnmp_access_route_container_load(
        NULL, NETSNMP_ACCESS_ROUTE_LOAD_IPV4_ONLY);
 ...
 *
 */
void ipCidrRouteTable_container_free(netsnmp_container* container)
{
 ...
 * @retval MFD_ERROR       : other error.
 */
int ipCidrRouteTable_row_prep(ipCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipCidrRouteTable:ipCidrRouteTable_row_prep", "called\n"));
 ...
 */
int ipCidrRouteDest_check_index(ipCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipCidrRouteTable:ipCidrRouteDest_check_index", "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int ipCidrRouteMask_check_index(ipCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipCidrRouteTable:ipCidrRouteMask_check_index", "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int ipCidrRouteTos_check_index(ipCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipCidrRouteTable:ipCidrRouteTos_check_index", "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int ipCidrRouteNextHop_check_index(ipCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
 ...
 */
int ipCidrRouteTable_validate_index(
    ipCidrRouteTable_registration* ipCidrRouteTable_reg,
    ipCidrRouteTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
