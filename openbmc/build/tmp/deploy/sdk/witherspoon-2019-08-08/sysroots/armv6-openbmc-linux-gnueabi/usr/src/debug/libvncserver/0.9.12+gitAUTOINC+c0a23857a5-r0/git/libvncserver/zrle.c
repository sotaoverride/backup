...
#define GET_IMAGE_INTO_BUF(tx, ty, tw, th, buf)                                \
    {                                                                          \
        ...
        (*cl->translateFn)(                                                    \
            ...
            fbptr, (char*)buf, cl->scaledScreen->paddedWidthInBytes, tw, th);  \
    }
...
rfbBool rfbSendRectEncodingZRLE(rfbClientPtr cl, int x, int y, int w, int h)
{
    ...
    {
        cl->zrleBeforeBuf =
            (char*)malloc(rfbZRLETileWidth * rfbZRLETileHeight * 4 + 4);
    }
    ...
    switch (cl->format.bitsPerPixel)
    {
        ...
        case 32:
        {
            ...
            rfbBool fitsInMS3Bytes =
                (cl->format.redShift > 7 && cl->format.greenShift > 7 &&
    ...
    rfbStatRecordEncodingSent(cl, rfbEncodingZRLE,
                              sz_rfbFramebufferUpdateRectHeader +
                                  sz_rfbZRLEHeader +
                                  ZRLE_BUFFER_LENGTH(&zos->out),
    ...
    for (i = 0; i < ZRLE_BUFFER_LENGTH(&zos->out);)
    {
        ...
        memcpy(cl->updateBuf + cl->ublen, (uint8_t*)zos->out.start + i,
               bytesToCopy);
