 ...
 * assumes some common field names and plumbing. It is intended to be used
 * together with module-template.h
 *
 ...
 * be found.
 */
static inline void std_checkRuleset_genErrMsg(modConfData_t* modConf,
                                              instanceConf_t* inst);
static inline rsRetVal std_checkRuleset(modConfData_t* modConf,
                                        instanceConf_t* inst)
{
    ruleset_t* pRuleset;
    rsRetVal localRet;
    ...
    localRet =
        ruleset.GetRuleset(modConf->pConf, &pRuleset, inst->pszBindRuleset);
