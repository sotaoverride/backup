...
class state_saver : private boost::noncopyable
{
  ...
  public:
    state_saver(T& object) : previous_value(object), previous_ref(object)
    {
    }
...
#ifndef BOOST_NO_EXCEPTIONS
        typedef
            typename mpl::eval_if<has_nothrow_copy<T>, mpl::identity<restore>,
                                  mpl::identity<restore_with_exception>>::type
                typex;
