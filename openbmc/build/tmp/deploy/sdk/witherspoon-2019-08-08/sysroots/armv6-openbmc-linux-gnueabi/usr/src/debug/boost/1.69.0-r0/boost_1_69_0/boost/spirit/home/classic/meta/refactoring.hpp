    ...
    : public parser<refactor_unary_parser<BinaryT, NestedT>>
{
  ...
  public:
    ...
    {
        return impl::refactor_unary_type<NestedT>::parse(*this, scan, binary,
                                                         nested);
    }
...
class refactor_unary_gen
{
  ...
  public:
    ...
    {
        return refactor_unary_parser<ParserT, NestedT>(subject.derived(),
                                                       nested);
    }
    ...
    : public parser<refactor_action_parser<BinaryT, NestedT>>
{
  ...
  public:
    ...
    typename parser_result<self_t, ScannerT>::type
        parse(ScannerT const& scan) const
    {
        return impl::refactor_action_type<NestedT>::parse(*this, scan, binary,
                                                          nested);
    }
...
class refactor_action_gen
{
  ...
  public:
    ...
    refactor_action_parser<ParserT, NestedT>
        operator[](parser<ParserT> const& subject) const
    {
        return refactor_action_parser<ParserT, NestedT>(subject.derived(),
                                                        nested);
    }
    ...
    : public parser<attach_action_parser<ActionT, NestedT>>
{
  ...
  public:
    ...
    typename parser_result<self_t, ScannerT>::type
        parse(ScannerT const& scan) const
    {
        return impl::attach_action_type<NestedT>::parse(*this, scan, actor,
                                                        nested);
    }
...
class attach_action_gen
{
  ...
  public:
    ...
    {
        return attach_action_parser<action<ParserT, ActionT>, NestedT>(actor,
                                                                       nested);
    }
