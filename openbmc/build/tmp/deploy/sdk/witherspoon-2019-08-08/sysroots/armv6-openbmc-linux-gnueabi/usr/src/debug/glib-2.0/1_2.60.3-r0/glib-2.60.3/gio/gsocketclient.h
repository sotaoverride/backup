...
#define G_SOCKET_CLIENT(inst)                                                  \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_SOCKET_CLIENT, GSocketClient))
#define G_SOCKET_CLIENT_CLASS(class)                                           \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_SOCKET_CLIENT, GSocketClientClass))
#define G_IS_SOCKET_CLIENT(inst)                                               \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_SOCKET_CLIENT))
#define G_IS_SOCKET_CLIENT_CLASS(class)                                        \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_SOCKET_CLIENT))
#define G_SOCKET_CLIENT_GET_CLASS(inst)                                        \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_SOCKET_CLIENT,                   \
                               GSocketClientClass))
