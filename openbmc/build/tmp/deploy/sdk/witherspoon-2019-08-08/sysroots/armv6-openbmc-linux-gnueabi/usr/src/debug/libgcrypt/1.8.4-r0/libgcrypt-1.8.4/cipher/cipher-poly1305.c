...
static inline int poly1305_bytecounter_add(u32 ctr[2], size_t add)
{
    int overflow = 0;
...
static void poly1305_fill_bytecounts(gcry_cipher_hd_t c)
{
    u32 lenbuf[4];
...
static void poly1305_do_padding(gcry_cipher_hd_t c, u32 ctr[2])
{
...
static void poly1305_aad_finish(gcry_cipher_hd_t c)
{
...
static gcry_err_code_t poly1305_set_zeroiv(gcry_cipher_hd_t c)
{
    byte zero[8] = {
        0,
    };
...
gcry_err_code_t _gcry_cipher_poly1305_authenticate(gcry_cipher_hd_t c,
                                                   const byte* aadbuf,
                                                   size_t aadbuflen)
{
...
gcry_err_code_t _gcry_cipher_poly1305_encrypt(gcry_cipher_hd_t c, byte* outbuf,
                                              size_t outbuflen,
                                              const byte* inbuf,
                                              size_t inbuflen)
{
...
gcry_err_code_t _gcry_cipher_poly1305_decrypt(gcry_cipher_hd_t c, byte* outbuf,
                                              size_t outbuflen,
                                              const byte* inbuf,
                                              size_t inbuflen)
{
...
static gcry_err_code_t _gcry_cipher_poly1305_tag(gcry_cipher_hd_t c,
...
gcry_err_code_t _gcry_cipher_poly1305_get_tag(gcry_cipher_hd_t c,
...
gcry_err_code_t _gcry_cipher_poly1305_check_tag(gcry_cipher_hd_t c,
...
void _gcry_cipher_poly1305_setkey(gcry_cipher_hd_t c)
{
...
gcry_err_code_t _gcry_cipher_poly1305_setiv(gcry_cipher_hd_t c, const byte* iv,
                                            size_t ivlen)
{
