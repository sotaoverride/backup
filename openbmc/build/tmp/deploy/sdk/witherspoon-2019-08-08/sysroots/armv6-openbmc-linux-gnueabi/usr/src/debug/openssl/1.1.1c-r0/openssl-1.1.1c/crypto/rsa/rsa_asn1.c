        ...
        ASN1_SEQUENCE_cb(RSAPrivateKey, rsa_cb) =
            {ASN1_EMBED(RSA, version, INT32),
             ...
             ASN1_SEQUENCE_OF_OPT(
                 RSA, prime_infos,
                 RSA_PRIME_INFO)} ASN1_SEQUENCE_END_cb(RSA, RSAPrivateKey)
...
ASN1_SEQUENCE_cb(RSA_PSS_PARAMS, rsa_pss_cb) =
    {ASN1_EXP_OPT(RSA_PSS_PARAMS, hashAlgorithm, X509_ALGOR, 0),
     ...
     ASN1_EXP_OPT(RSA_PSS_PARAMS, trailerField, ASN1_INTEGER,
                  3)} ASN1_SEQUENCE_END_cb(RSA_PSS_PARAMS, RSA_PSS_PARAMS)
