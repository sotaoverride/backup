...
using namespace sdbusplus::xyz::openbmc_project::Software::server;
using namespace sdbusplus::xyz::openbmc_project::Control::Power::server;
using namespace sdbusplus::xyz::openbmc_project::Network::server;
using namespace sdbusplus::xyz::openbmc_project::Control::Host::server;
...
class Impl : public Parent
{
  public:
    Impl(sdbusplus::bus::bus& bus, const char* path) :
        Parent(bus, path, true), path(path)
    {
    }
    virtual ~Impl() = default;

    decltype(std::declval<Iface0>().timeOwner())
        timeOwner(decltype(std::declval<Iface0>().timeOwner()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().powerSupplyRedundancyEnabled())
        powerSupplyRedundancyEnabled(decltype(
            std::declval<Iface0>().powerSupplyRedundancyEnabled()) value)
            override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().origin())
        origin(decltype(std::declval<Iface0>().origin()) value) override
    {
    ...
    decltype(std::declval<Iface0>().prefixLength()) prefixLength(
        decltype(std::declval<Iface0>().prefixLength()) value) override
    {
    ...
    decltype(std::declval<Iface0>().type())
        type(decltype(std::declval<Iface0>().type()) value) override
    {
    ...
    decltype(std::declval<Iface0>().gateway())
        gateway(decltype(std::declval<Iface0>().gateway()) value) override
    {
    ...
    decltype(std::declval<Iface0>().address())
        address(decltype(std::declval<Iface0>().address()) value) override
    {
  ...
  private:
    ...
    bool validatePrefixLength(
        decltype(std::declval<Iface0>().prefixLength()) value)
    {
        bool matched = false;
...
void save(Archive& a, const Impl& setting, const std::uint32_t version)
{
    a(setting.origin(), setting.prefixLength(), setting.type(),
      setting.gateway(), setting.address());
}
...
using Iface0 =
    sdbusplus::xyz::openbmc_project::Control::server::MinimumShipLevel;
using Parent = sdbusplus::server::object::object<Iface0>;
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().minimumShipLevelRequired())
        minimumShipLevelRequired(decltype(
            std::declval<Iface0>().minimumShipLevelRequired()) value) override
    {
...
using Iface0 =
    sdbusplus::xyz::openbmc_project::Control::Security::server::RestrictionMode;
using Parent = sdbusplus::server::object::object<Iface0>;
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().restrictionMode()) restrictionMode(
        decltype(std::declval<Iface0>().restrictionMode()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().bootSource())
        bootSource(decltype(std::declval<Iface0>().bootSource()) value) override
    {
    ...
    decltype(std::declval<Iface1>().bootMode())
        bootMode(decltype(std::declval<Iface1>().bootMode()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().timeSyncMethod()) timeSyncMethod(
        decltype(std::declval<Iface0>().timeSyncMethod()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().tPMEnable())
        tPMEnable(decltype(std::declval<Iface0>().tPMEnable()) value) override
    {
...
using Iface0 =
    sdbusplus::xyz::openbmc_project::Control::Power::server::RestorePolicy;
using Parent = sdbusplus::server::object::object<Iface0>;
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().powerRestorePolicy()) powerRestorePolicy(
        decltype(std::declval<Iface0>().powerRestorePolicy()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().enabled())
        enabled(decltype(std::declval<Iface0>().enabled()) value) override
    {
...
using Iface0 =
    sdbusplus::xyz::openbmc_project::Control::Host::server::TurboAllowed;
using Parent = sdbusplus::server::object::object<Iface0>;
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().turboAllowed()) turboAllowed(
        decltype(std::declval<Iface0>().turboAllowed()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().requestedApplyTime()) requestedApplyTime(
        decltype(std::declval<Iface0>().requestedApplyTime()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().mACAddress())
        mACAddress(decltype(std::declval<Iface0>().mACAddress()) value) override
    {
...
using Iface0 =
    sdbusplus::xyz::openbmc_project::Control::server::PowerSupplyAttributes;
using Parent = sdbusplus::server::object::object<Iface0>;
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().deratingFactor()) deratingFactor(
        decltype(std::declval<Iface0>().deratingFactor()) value) override
    {
...
using Iface0 =
    sdbusplus::xyz::openbmc_project::Control::Boot::server::RebootPolicy;
using Parent = sdbusplus::server::object::object<Iface0>;
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().autoReboot())
        autoReboot(decltype(std::declval<Iface0>().autoReboot()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface2>().enabled())
        enabled(decltype(std::declval<Iface2>().enabled()) value) override
    {
...
class Impl : public Parent
{
  public:
    ...
    decltype(std::declval<Iface0>().powerCap())
        powerCap(decltype(std::declval<Iface0>().powerCap()) value) override
    {
    ...
    decltype(std::declval<Iface0>().powerCapEnable()) powerCapEnable(
        decltype(std::declval<Iface0>().powerCapEnable()) value) override
    {
    ...
    bool validatePowerCap(decltype(std::declval<Iface0>().powerCap()) value)
    {
        ...
        else
        {
            std::string err = "Input parameter for PowerCap is invalid "
                              ...
                              std::to_string(value) +
                              "in uint: "
                              "Watts is not in range:556..3389";
            using namespace phosphor::logging;
            log<level::ERR>(err.c_str());
        }
        return matched;
...
class Manager
{
  public:
    ...
    {
        fs::path path{};
        settings = std::make_tuple(
            std::make_unique<xyz::openbmc_project::time::owner::Impl>(
                bus, "/xyz/openbmc_project/time/owner"),
            std::make_unique<
                xyz::openbmc_project::control::power_supply_redundancy::Impl>(
                bus, "/xyz/openbmc_project/control/power_supply_redundancy"),
            std::make_unique<
                xyz::openbmc_project::network::host0::intf::addr::Impl>(
                bus, "/xyz/openbmc_project/network/host0/intf/addr"),
            std::make_unique<xyz::openbmc_project::control::
                                 minimum_ship_level_required::Impl>(
                bus,
                "/xyz/openbmc_project/control/minimum_ship_level_required"),
            std::make_unique<
                xyz::openbmc_project::control::host0::restriction_mode::Impl>(
                bus, "/xyz/openbmc_project/control/host0/restriction_mode"),
            std::make_unique<xyz::openbmc_project::control::host0::boot::Impl>(
                bus, "/xyz/openbmc_project/control/host0/boot"),
            std::make_unique<xyz::openbmc_project::time::sync_method::Impl>(
                bus, "/xyz/openbmc_project/time/sync_method"),
            std::make_unique<
                xyz::openbmc_project::control::host0::TPMEnable::Impl>(
                bus, "/xyz/openbmc_project/control/host0/TPMEnable"),
            std::make_unique<xyz::openbmc_project::control::host0::
                                 power_restore_policy::Impl>(
                bus, "/xyz/openbmc_project/control/host0/power_restore_policy"),
            std::make_unique<
                xyz::openbmc_project::logging::rest_api_logs::Impl>(
                bus, "/xyz/openbmc_project/logging/rest_api_logs"),
            std::make_unique<
                xyz::openbmc_project::control::host0::turbo_allowed::Impl>(
                bus, "/xyz/openbmc_project/control/host0/turbo_allowed"),
            ...
            std::make_unique<xyz::openbmc_project::network::host0::intf::Impl>(
                bus, "/xyz/openbmc_project/network/host0/intf"),
            std::make_unique<
                xyz::openbmc_project::control::power_supply_attributes::Impl>(
                bus, "/xyz/openbmc_project/control/power_supply_attributes"),
            std::make_unique<
                xyz::openbmc_project::control::host0::auto_reboot::Impl>(
                bus, "/xyz/openbmc_project/control/host0/auto_reboot"),
            std::make_unique<
                xyz::openbmc_project::control::host0::boot::one_time::Impl>(
                bus, "/xyz/openbmc_project/control/host0/boot/one_time"),
            std::make_unique<
                xyz::openbmc_project::control::host0::power_cap::Impl>(
                bus, "/xyz/openbmc_project/control/host0/power_cap"));

        path =
            fs::path(SETTINGS_PERSIST_PATH) / "/xyz/openbmc_project/time/owner";
        path += persistent::fileSuffix;
        auto initSetting0 = [&]() {
            std::get<0>(settings)->sdbusplus::xyz::openbmc_project::Time::
                server::Owner::timeOwner(Owner::Owners::BMC);
        };
        ...
        path = fs::path(SETTINGS_PERSIST_PATH) /
               "/xyz/openbmc_project/control/power_supply_redundancy";
        path += persistent::fileSuffix;
        auto initSetting1 = [&]() {
            std::get<1>(settings)->sdbusplus::xyz::openbmc_project::Control::
                server::PowerSupplyRedundancy::powerSupplyRedundancyEnabled(
                    true);
        };
        ...
        auto initSetting2 = [&]() {
            std::get<2>(settings)
                ->sdbusplus::xyz::openbmc_project::Network::server::IP::origin(
                    IP::AddressOrigin::Static);
            std::get<2>(settings)->sdbusplus::xyz::openbmc_project::Network::
                server::IP::prefixLength(0);
            std::get<2>(settings)
                ->sdbusplus::xyz::openbmc_project::Network::server::IP::type(
                    IP::Protocol::IPv4);
            std::get<2>(settings)
                ->sdbusplus::xyz::openbmc_project::Network::server::IP::gateway(
                    "0.0.0.0");
            std::get<2>(settings)
                ->sdbusplus::xyz::openbmc_project::Network::server::IP::address(
                    "0.0.0.0");
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting3 = [&]() {
            std::get<3>(settings)->sdbusplus::xyz::openbmc_project::Control::
                server::MinimumShipLevel::minimumShipLevelRequired(true);
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting4 = [&]() {
            std::get<4>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Security::server::RestrictionMode::restrictionMode(
        ...
        path += persistent::fileSuffix;
        auto initSetting5 = [&]() {
            std::get<5>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Boot::server::Source::bootSource(Source::Sources::Default);
            std::get<5>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Boot::server::Mode::bootMode(Mode::Modes::Regular);
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting6 = [&]() {
            std::get<6>(settings)->sdbusplus::xyz::openbmc_project::Time::
                server::Synchronization::timeSyncMethod(
        ...
        path += persistent::fileSuffix;
        auto initSetting7 = [&]() {
            std::get<7>(settings)->sdbusplus::xyz::openbmc_project::Control::
                TPM::server::Policy::tPMEnable(true);
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting8 = [&]() {
            std::get<8>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Power::server::RestorePolicy::powerRestorePolicy(
        ...
        path += persistent::fileSuffix;
        auto initSetting9 = [&]() {
            std::get<9>(settings)->sdbusplus::xyz::openbmc_project::Object::
                server::Enable::enabled(false);
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting10 = [&]() {
            std::get<10>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Host::server::TurboAllowed::turboAllowed(true);
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting11 = [&]() {
            std::get<11>(settings)->sdbusplus::xyz::openbmc_project::Software::
                server::ApplyTime::requestedApplyTime(
        ...
        path += persistent::fileSuffix;
        auto initSetting12 = [&]() {
            std::get<12>(settings)->sdbusplus::xyz::openbmc_project::Network::
                server::MACAddress::mACAddress("00:00:00:00:00:00");
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting13 = [&]() {
            std::get<13>(settings)->sdbusplus::xyz::openbmc_project::Control::
                server::PowerSupplyAttributes::deratingFactor(90);
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting14 = [&]() {
            std::get<14>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Boot::server::RebootPolicy::autoReboot(true);
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting15 = [&]() {
            std::get<15>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Boot::server::Source::bootSource(Source::Sources::Default);
            std::get<15>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Boot::server::Mode::bootMode(Mode::Modes::Regular);
            std::get<15>(settings)->sdbusplus::xyz::openbmc_project::Object::
                server::Enable::enabled(true);
        };
        ...
        path += persistent::fileSuffix;
        auto initSetting16 = [&]() {
            std::get<16>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Power::server::Cap::powerCap(0);
            std::get<16>(settings)->sdbusplus::xyz::openbmc_project::Control::
                Power::server::Cap::powerCapEnable(false);
        };
  ...
  private:
    ...
    std::tuple<
        ...
        std::unique_ptr<
            xyz::openbmc_project::control::minimum_ship_level_required::Impl>,
        std::unique_ptr<
            xyz::openbmc_project::control::host0::restriction_mode::Impl>,
        ...
        std::unique_ptr<
            xyz::openbmc_project::control::host0::power_restore_policy::Impl>,
...
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::time::owner::Impl, CLASS_VERSION);
CEREAL_CLASS_VERSION(phosphor::settings::xyz::openbmc_project::control::
                         power_supply_redundancy::Impl,
                     CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::network::host0::intf::addr::Impl,
    CLASS_VERSION);
CEREAL_CLASS_VERSION(phosphor::settings::xyz::openbmc_project::control::
                         minimum_ship_level_required::Impl,
                     CLASS_VERSION);
CEREAL_CLASS_VERSION(phosphor::settings::xyz::openbmc_project::control::host0::
                         restriction_mode::Impl,
                     CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::control::host0::boot::Impl,
    CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::time::sync_method::Impl,
    CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::control::host0::TPMEnable::Impl,
    CLASS_VERSION);
CEREAL_CLASS_VERSION(phosphor::settings::xyz::openbmc_project::control::host0::
                         power_restore_policy::Impl,
                     CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::logging::rest_api_logs::Impl,
    CLASS_VERSION);
CEREAL_CLASS_VERSION(phosphor::settings::xyz::openbmc_project::control::host0::
                         turbo_allowed::Impl,
                     CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::software::apply_time::Impl,
    CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::network::host0::intf::Impl,
    CLASS_VERSION);
CEREAL_CLASS_VERSION(phosphor::settings::xyz::openbmc_project::control::
                         power_supply_attributes::Impl,
                     CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::control::host0::auto_reboot::Impl,
    CLASS_VERSION);
CEREAL_CLASS_VERSION(phosphor::settings::xyz::openbmc_project::control::host0::
                         boot::one_time::Impl,
                     CLASS_VERSION);
CEREAL_CLASS_VERSION(
    phosphor::settings::xyz::openbmc_project::control::host0::power_cap::Impl,
    CLASS_VERSION);
