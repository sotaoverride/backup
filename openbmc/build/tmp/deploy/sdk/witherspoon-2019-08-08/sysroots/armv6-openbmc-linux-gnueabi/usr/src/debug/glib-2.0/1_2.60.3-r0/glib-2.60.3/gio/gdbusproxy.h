...
#define G_DBUS_PROXY(o)                                                        \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_PROXY, GDBusProxy))
#define G_DBUS_PROXY_CLASS(k)                                                  \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_DBUS_PROXY, GDBusProxyClass))
#define G_DBUS_PROXY_GET_CLASS(o)                                              \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DBUS_PROXY, GDBusProxyClass))
#define G_IS_DBUS_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_PROXY))
#define G_IS_DBUS_PROXY_CLASS(k)                                               \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_DBUS_PROXY))
...
/**
 * GDBusProxyClass:
 * @g_properties_changed: Signal class handler for the
