...
AvahiHashmap* avahi_hashmap_new(AvahiHashFunc hash_func,
...
typedef void (*AvahiHashmapForeachCallback)(void* key, void* value,
                                            void* userdata);

void avahi_hashmap_foreach(AvahiHashmap* m,
                           AvahiHashmapForeachCallback callback,
                           void* userdata);
