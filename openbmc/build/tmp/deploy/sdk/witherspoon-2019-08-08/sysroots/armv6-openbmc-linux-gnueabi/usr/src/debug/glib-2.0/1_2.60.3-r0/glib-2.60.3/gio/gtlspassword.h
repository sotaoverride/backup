...
#define G_TLS_PASSWORD(o)                                                      \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_TLS_PASSWORD, GTlsPassword))
#define G_TLS_PASSWORD_CLASS(k)                                                \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_TLS_PASSWORD, GTlsPasswordClass))
#define G_IS_TLS_PASSWORD(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_TLS_PASSWORD))
#define G_IS_TLS_PASSWORD_CLASS(k)                                             \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_TLS_PASSWORD))
#define G_TLS_PASSWORD_GET_CLASS(o)                                            \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_TLS_PASSWORD, GTlsPasswordClass))
