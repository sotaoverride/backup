 ...
 *
 * If ENABLE_DEBUG_HASHMAP is defined (by configuring with
 * --enable-debug=hashmap), the implementation will:
 * - store extra data for debugging and statistics (see
...
typedef struct IteratedCache
    IteratedCache; /* Caches the iterated order of one of the above */
...
#define PLAIN_HASHMAP(h)                                                       \
    __builtin_choose_expr(PTR_COMPATIBLE_WITH_PLAIN_HASHMAP(h), (Hashmap*)(h), \
                          (void)0)
...
#define hashmap_ensure_allocated(h, ops)                                       \
    internal_hashmap_ensure_allocated(h, ops HASHMAP_DEBUG_SRC_ARGS)
#define ordered_hashmap_ensure_allocated(h, ops)                               \
    internal_ordered_hashmap_ensure_allocated(h, ops HASHMAP_DEBUG_SRC_ARGS)
...
static inline IteratedCache*
    ordered_hashmap_iterated_cache_new(OrderedHashmap* h)
{
    return (IteratedCache*)internal_hashmap_iterated_cache_new(HASHMAP_BASE(h));
}

int hashmap_put(Hashmap* h, const void* key, void* value);
static inline int ordered_hashmap_put(OrderedHashmap* h, const void* key,
                                      void* value)
{
...
static inline int ordered_hashmap_replace(OrderedHashmap* h, const void* key,
                                          void* value)
{
...
static inline void* ordered_hashmap_remove2(OrderedHashmap* h, const void* key,
                                            void** rkey)
{
...
void* internal_hashmap_remove_value(HashmapBase* h, const void* key,
                                    void* value);
static inline void* hashmap_remove_value(Hashmap* h, const void* key,
                                         void* value)
{
    return internal_hashmap_remove_value(HASHMAP_BASE(h), key, value);
}

static inline void* ordered_hashmap_remove_value(OrderedHashmap* h,
...
int hashmap_remove_and_put(Hashmap* h, const void* old_key, const void* new_key,
                           void* value);
static inline int ordered_hashmap_remove_and_put(OrderedHashmap* h,
                                                 const void* old_key,
                                                 const void* new_key,
                                                 void* value)
{
...
static inline int ordered_hashmap_remove_and_replace(OrderedHashmap* h,
                                                     const void* old_key,
                                                     const void* new_key,
                                                     void* value)
{
...
static inline int ordered_hashmap_reserve(OrderedHashmap* h,
...
static inline int ordered_hashmap_move_one(OrderedHashmap* h,
                                           OrderedHashmap* other,
                                           const void* key)
{
    return internal_hashmap_move_one(HASHMAP_BASE(h), HASHMAP_BASE(other), key);
}
...
bool internal_hashmap_iterate(HashmapBase* h, Iterator* i, void** value,
                              const void** key);
static inline bool hashmap_iterate(Hashmap* h, Iterator* i, void** value,
                                   const void** key)
{
    return internal_hashmap_iterate(HASHMAP_BASE(h), i, value, key);
}
static inline bool ordered_hashmap_iterate(OrderedHashmap* h, Iterator* i,
...
static inline void* ordered_hashmap_steal_first_key_and_value(OrderedHashmap* h,
                                                              void** ret)
{
    return internal_hashmap_first_key_and_value(HASHMAP_BASE(h), true, ret);
}
...
static inline void* ordered_hashmap_first_key_and_value(OrderedHashmap* h,
                                                        void** ret)
{
    return internal_hashmap_first_key_and_value(HASHMAP_BASE(h), false, ret);
}
...
#define ORDERED_HASHMAP_FOREACH(e, h, i)                                       \
    for ((i) = ITERATOR_FIRST;                                                 \
         ordered_hashmap_iterate((h), &(i), (void**)&(e), NULL);)
...
#define ORDERED_HASHMAP_FOREACH_KEY(e, k, h, i)                                \
    for ((i) = ITERATOR_FIRST; ordered_hashmap_iterate(                        \
             (h), &(i), (void**)&(e), (const void**)&(k));)
