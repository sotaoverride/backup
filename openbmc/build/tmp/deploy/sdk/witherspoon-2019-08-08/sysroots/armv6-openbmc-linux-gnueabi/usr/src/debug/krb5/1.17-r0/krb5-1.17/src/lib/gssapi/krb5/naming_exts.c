                             ...
                             krb5_gss_name_t* ret_name)
{
    ...
    *ret_name = NULL;
    ...
    if ((flags & KG_INIT_NAME_NO_COPY) == 0)
    {
        ...
        if (ad_context != NULL)
        {
            code = krb5_authdata_context_copy(context, ad_context,
                                              &name->ad_context);
            if (code != 0)
                goto cleanup;
        }
...
static OM_uint32 kg_map_name_error(OM_uint32* minor_status,
                                   krb5_error_code code)
{
...
static krb5_error_code data_list_to_buffer_set(krb5_context context,
                                               krb5_data* data,
                                               gss_buffer_set_t* buffer_set)
{
    ...
    if (GSS_ERROR(gss_create_empty_buffer_set(&minor_status, &set)))
    {
                                              ...
                                              gss_buffer_set_t* attrs)
{
    ...
    *minor_status = 0;
    ...
    code =
        krb5_authdata_get_attribute_types(context, kname->ad_context, &kattrs);
    if (code != 0)
        goto cleanup;
    ...
    gss_buffer_t display_value, int* more)
{
    ...
    *minor_status = 0;
    ...
    code = krb5_authdata_get_attribute(context, kname->ad_context, &kattr,
                                       &kauthenticated, &kcomplete, &kvalue,
                                       &kdisplay_value, more);
    if (code == 0)
    {
        if (value != NULL)
                                                    ...
                                                    gss_buffer_t value)
{
    ...
    *minor_status = 0;
    ...
    code = krb5_authdata_set_attribute(context, kname->ad_context, complete,
                                       &kattr, &kvalue);
                                                       ...
                                                       gss_buffer_t attr)
{
    ...
    *minor_status = 0;
    ...
    code = krb5_authdata_delete_attribute(context, kname->ad_context, &kattr);
                                                 ...
                                                 gss_any_t* output)
{
    ...
    *minor_status = 0;
    ...
    code = krb5_authdata_export_internal(
        context, kname->ad_context, authenticated, kmodule, (void**)output);
                                      ...
                                      gss_buffer_t type_id, gss_any_t* input)
{
    ...
    *minor_status = 0;
    ...
    code = krb5_authdata_free_internal(context, kname->ad_context, kmodule,
                                       *input);
    if (code == 0)
        *input = NULL;
    ...
    OM_uint32* minor_status, gss_name_t name, gss_buffer_t exp_composite_name)
{
    ...
    *minor_status = 0;
    ...
    if (kname->ad_context != NULL)
    {
        code = krb5_authdata_export_attributes(context, kname->ad_context,
                                               AD_USAGE_MASK, &attrs);
        if (code != 0)
            goto cleanup;
    }
