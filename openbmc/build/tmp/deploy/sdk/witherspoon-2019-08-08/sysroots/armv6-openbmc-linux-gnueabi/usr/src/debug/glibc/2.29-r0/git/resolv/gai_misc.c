...
struct requestlist* __gai_find_request(const struct gaicb* gaicbp)
{
...
struct requestlist* __gai_enqueue_request(struct gaicb* gaicbp)
{
...
static void* __attribute__((noreturn)) handle_requests(void* arg)
{
