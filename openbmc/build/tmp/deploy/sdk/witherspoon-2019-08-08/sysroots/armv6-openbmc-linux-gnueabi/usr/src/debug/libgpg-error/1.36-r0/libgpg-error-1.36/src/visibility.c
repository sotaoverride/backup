...
estream_t gpgrt_sysopen(es_syshd_t* syshd, const char* mode)
{
    return _gpgrt_sysopen(syshd, mode);
}

estream_t gpgrt_sysopen_nc(es_syshd_t* syshd, const char* mode)
{
    return _gpgrt_sysopen_nc(syshd, mode);
}

estream_t gpgrt_fpopen(FILE* fp, const char* mode)
{
    return _gpgrt_fpopen(fp, mode);
}

estream_t gpgrt_fpopen_nc(FILE* fp, const char* mode)
{
    return _gpgrt_fpopen_nc(fp, mode);
}

estream_t gpgrt_freopen(const char* _GPGRT__RESTRICT path,
                        const char* _GPGRT__RESTRICT mode,
...
int gpgrt_fclose(estream_t stream)
{
...
int gpgrt_fileno(estream_t stream)
{
...
int gpgrt_syshd(estream_t stream, es_syshd_t* syshd)
{
    return _gpgrt_syshd(stream, syshd);
}

int gpgrt_syshd_unlocked(estream_t stream, es_syshd_t* syshd)
{
...
void gpgrt_flockfile(estream_t stream)
{
    _gpgrt_flockfile(stream);
}

int gpgrt_ftrylockfile(estream_t stream)
{
    return _gpgrt_ftrylockfile(stream);
}

void gpgrt_funlockfile(estream_t stream)
{
    _gpgrt_funlockfile(stream);
}

int _gpgrt_pending(estream_t stream)
{
    return _gpgrt__pending(stream);
}

int _gpgrt_pending_unlocked(estream_t stream)
{
    return _gpgrt__pending_unlocked(stream);
}

int gpgrt_feof(estream_t stream)
{
...
int gpgrt_ferror(estream_t stream)
{
...
void gpgrt_clearerr(estream_t stream)
{
...
int gpgrt_fflush(estream_t stream)
{
...
long int gpgrt_ftell(estream_t stream)
{
    return _gpgrt_ftell(stream);
}

gpgrt_off_t gpgrt_ftello(estream_t stream)
{
    return _gpgrt_ftello(stream);
}

void gpgrt_rewind(estream_t stream)
{
...
int gpgrt_fgetc(estream_t stream)
{
...
int gpgrt_fputc(int c, estream_t stream)
{
...
int gpgrt_ungetc(int c, estream_t stream)
{
...
int gpgrt_write_hexstring(estream_t _GPGRT__RESTRICT stream,
                          const void* _GPGRT__RESTRICT buffer, size_t length,
...
int gpgrt_fprintf_sf(estream_t _GPGRT__RESTRICT stream,
...
int gpgrt_fprintf_sf_unlocked(estream_t _GPGRT__RESTRICT stream,
                              gpgrt_string_filter_t sf, void* sfvalue,
                              const char* _GPGRT__RESTRICT format, ...)
{
    va_list ap;
...
void gpgrt_setbuf(estream_t _GPGRT__RESTRICT stream, char* _GPGRT__RESTRICT buf)
{
    _gpgrt_setvbuf(stream, buf, buf ? _IOFBF : _IONBF, BUFSIZ);
}

void gpgrt_set_binary(estream_t stream)
{
    _gpgrt_set_binary(stream);
}

int gpgrt_set_nonblock(estream_t stream, int onoff)
{
    return _gpgrt_set_nonblock(stream, onoff);
}

int gpgrt_get_nonblock(estream_t stream)
{
    return _gpgrt_get_nonblock(stream);
}

int gpgrt_poll(gpgrt_poll_t* fds, unsigned int nfds, int timeout)
{
    return _gpgrt_poll(fds, nfds, timeout);
}

estream_t gpgrt_tmpfile(void)
{
    return _gpgrt_tmpfile();
}

void gpgrt_opaque_set(estream_t stream, void* opaque)
{
    _gpgrt_opaque_set(stream, opaque);
}

void* gpgrt_opaque_get(estream_t stream)
{
    return _gpgrt_opaque_get(stream);
}

void gpgrt_fname_set(estream_t stream, const char* fname)
{
    _gpgrt_fname_set(stream, fname);
}

const char* gpgrt_fname_get(estream_t stream)
{
...
char* gpgrt_strconcat(const char* s1, ...)
{
    va_list arg_ptr;
    char* result;
...
gpg_err_code_t gpgrt_setenv(const char* name, const char* value, int overwrite)
{
...
gpgrt_b64state_t gpgrt_b64enc_start(estream_t stream, const char* title)
{
    return _gpgrt_b64enc_start(stream, title);
}

gpg_err_code_t gpgrt_b64enc_write(gpgrt_b64state_t state, const void* buffer,
                                  size_t nbytes)
{
...
gpg_error_t gpgrt_b64dec_proc(gpgrt_b64state_t state, void* buffer,
...
void gpgrt_log(int level, const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_info(const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_error(const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_fatal(const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_bug(const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_debug(const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_debug_string(const char* string, const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_printf(const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_printhex(const void* buffer, size_t length, const char* fmt, ...)
{
    va_list arg_ptr;
...
void gpgrt_log_clock(const char* fmt, ...)
{
    va_list arg_ptr;
...
int gpgrt_argparse(estream_t fp, gpgrt_argparse_t* arg, gpgrt_opt_t* opts)
{
...
char* gpgrt_w32_reg_query_string(const char* root, const char* dir,
                                 const char* name)
{
