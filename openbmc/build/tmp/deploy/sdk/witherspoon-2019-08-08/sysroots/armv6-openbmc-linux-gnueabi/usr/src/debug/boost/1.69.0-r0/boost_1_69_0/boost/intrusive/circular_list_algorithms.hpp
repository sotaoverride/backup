...
class circular_list_algorithms
{
  public:
    ...
    BOOST_INTRUSIVE_FORCEINLINE static bool
        inited(const const_node_ptr& this_node)
    {
    ...
    //! <b>Throws</b>: Nothing.
    BOOST_INTRUSIVE_FORCEINLINE static bool
        unique(const const_node_ptr& this_node)
    {
    ...
    //!
    //! <b>Throws</b>: Nothing.
    BOOST_INTRUSIVE_FORCEINLINE static void link_before(node_ptr nxt_node,
                                                        node_ptr this_node)
    {
    ...
    //!
    //! <b>Throws</b>: Nothing.
    BOOST_INTRUSIVE_FORCEINLINE static void link_after(node_ptr prev_node,
                                                       node_ptr this_node)
    {
    ...
    //!
    //! <b>Effects</b>: Swaps the position of the nodes: this_node is inserted
    //! in
    ...
    //! <b>Effects</b>: Moves the node p n positions towards the end of the
    //! list.
    //!
    //! <b>Throws</b>: Nothing.
    //!
    ...
    //! <b>Effects</b>: Moves the node p n positions towards the beginning of
    //! the list.
    //!
    //! <b>Throws</b>: Nothing.
    //!
  ...
  private:
    BOOST_INTRUSIVE_FORCEINLINE static void swap_prev(node_ptr this_node,
                                                      node_ptr other_node)
    {
    ...
    BOOST_INTRUSIVE_FORCEINLINE static void swap_next(node_ptr this_node,
                                                      node_ptr other_node)
    {
