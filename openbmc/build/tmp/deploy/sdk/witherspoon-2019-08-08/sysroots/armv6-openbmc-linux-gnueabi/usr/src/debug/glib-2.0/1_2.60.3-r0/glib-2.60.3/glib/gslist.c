...
static GSList* _g_slist_remove_data(GSList* list, gconstpointer data,
                                    gboolean all)
{
    GSList* tmp = NULL;
...
static GSList* g_slist_insert_sorted_real(GSList* list, gpointer data,
...
static GSList* g_slist_sort_merge(GSList* l1, GSList* l2, GFunc compare_func,
                                  gpointer user_data)
{
    GSList list, *l;
    gint cmp;
...
static GSList* g_slist_sort_real(GSList* list, GFunc compare_func,
                                 gpointer user_data)
{
    GSList *l1, *l2;
