...
netsnmp_feature_require(row_merge) netsnmp_feature_require(
    ...
    netsnmp_feature_child_of(ipaddressprefixtable_row_find_by_mib_index,
                             ipaddressprefixtable_all)
        netsnmp_feature_child_of(ipaddressprefixtable_container_get,
                                 ipaddressprefixtable_all)
            netsnmp_feature_child_of(ipAddressPrefixTable_registration_get,
                                     ipaddressprefixtable_all)
                netsnmp_feature_child_of(ipAddressPrefixTable_registration_set,
                                         ipaddressprefixtable_all)
...
static void _ipAddressPrefixTable_container_init(
    ipAddressPrefixTable_interface_ctx* if_ctx);
static void _ipAddressPrefixTable_container_shutdown(
    ipAddressPrefixTable_interface_ctx* if_ctx);
...
ipAddressPrefixTable_registration* ipAddressPrefixTable_registration_get(void)
{
...
ipAddressPrefixTable_registration* ipAddressPrefixTable_registration_set(
 ...
 */
void _ipAddressPrefixTable_initialize_interface(
    ipAddressPrefixTable_registration* reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:ipAddressPrefixTable:_ipAddressPrefixTable_"
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, ipAddressPrefixTable_if_ctx.container,
    ...
    {
        handler = netsnmp_cache_handler_get(ipAddressPrefixTable_if_ctx.cache);
        netsnmp_inject_handler(reginfo, handler);
    }
 ...
 */
void _ipAddressPrefixTable_shutdown_interface(
    ipAddressPrefixTable_registration* reg_ptr)
{
    /*
...
void ipAddressPrefixTable_valid_columns_set(netsnmp_column_info* vc)
{
 ...
 */
int ipAddressPrefixTable_index_to_oid(netsnmp_index* oid_idx,
                                      ipAddressPrefixTable_mib_index* mib_idx)
{
    ...
    memset(&var_ipAddressPrefixType, 0x00, sizeof(var_ipAddressPrefixType));
    var_ipAddressPrefixType.type = ASN_INTEGER;
    memset(&var_ipAddressPrefixPrefix, 0x00, sizeof(var_ipAddressPrefixPrefix));
    var_ipAddressPrefixPrefix.type = ASN_OCTET_STR;
    memset(&var_ipAddressPrefixLength, 0x00, sizeof(var_ipAddressPrefixLength));
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_index_to_oid",
         "called\n"));
 ...
 */
int ipAddressPrefixTable_index_from_oid(netsnmp_index* oid_idx,
                                        ipAddressPrefixTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_index_from_oid",
         "called\n"));
    ...
    ipAddressPrefixTable_allocate_rowreq_ctx(void* user_init_ctx)
{
    ...
    DEBUGMSGTL(("internal:ipAddressPrefixTable:ipAddressPrefixTable_allocate_"
                "rowreq_ctx",
                "called\n"));
    ...
    {
        if (SNMPERR_SUCCESS !=
            ipAddressPrefixTable_rowreq_ctx_init(rowreq_ctx, user_init_ctx))
        {
 ...
 */
void ipAddressPrefixTable_release_rowreq_ctx(
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL((
        "internal:ipAddressPrefixTable:ipAddressPrefixTable_release_rowreq_ctx",
        "called\n"));
 ...
 * wrapper
 */
static int _mfd_ipAddressPrefixTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ipAddressPrefixTable:_mfd_ipAddressPrefixTable_pre_request",
         "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL(("ipAddressPrefixTable",
                    "error %d from "
 ...
 * wrapper
 */
static int _mfd_ipAddressPrefixTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx =
    ...
    rc = ipAddressPrefixTable_post_request(ipAddressPrefixTable_if_ctx.user_ctx,
                                           packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
 ...
 * wrapper
 */
static int _mfd_ipAddressPrefixTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL((
        "internal:ipAddressPrefixTable:_mfd_ipAddressPrefixTable_object_lookup",
        "called\n"));
 ...
 */
NETSNMP_STATIC_INLINE int _ipAddressPrefixTable_get_column(
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx, netsnmp_variable_list* var,
    int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(
        ("internal:ipAddressPrefixTable:_mfd_ipAddressPrefixTable_get_column",
         "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IPADDRESSPREFIXORIGIN:
            ...
            rc =
                ipAddressPrefixOrigin_get(rowreq_ctx, (u_long*)var->val.string);
            break;
...
int _mfd_ipAddressPrefixTable_get_values(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:ipAddressPrefixTable:_mfd_ipAddressPrefixTable_get_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipAddressPrefixTable_get_column(rowreq_ctx, requests->requestvb,
                                              tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
     ...
     * call user code
     */
    return ipAddressPrefixTable_container_load(
...
static void _cache_free(netsnmp_cache* cache, void* magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log(LOG_ERR, "invalid cache in ipAddressPrefixTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free(ipAddressPrefixTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(
        ("internal:ipAddressPrefixTable:_container_item_free", "called\n"));
...
static void _container_free(netsnmp_container* container)
{
    DEBUGMSGTL(("internal:ipAddressPrefixTable:_container_free", "called\n"));
 ...
 */
void _ipAddressPrefixTable_container_init(
    ipAddressPrefixTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:ipAddressPrefixTable:_ipAddressPrefixTable_container_init",
         "called\n"));
    ...
    if_ctx->cache =
        netsnmp_cache_create(30, /* timeout in seconds */
                             _cache_load, _cache_free, ipAddressPrefixTable_oid,
                             ipAddressPrefixTable_oid_size);

    if (NULL == if_ctx->cache)
    {
        snmp_log(LOG_ERR, "error creating cache for ipAddressPrefixTable\n");
        return;
    }
 ...
 */
void _ipAddressPrefixTable_container_shutdown(
    ipAddressPrefixTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(("internal:ipAddressPrefixTable:_ipAddressPrefixTable_container_"
                "shutdown",
                "called\n"));
