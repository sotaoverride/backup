...
BOOST_SERIALIZATION_DECL void const*
    void_upcast(extended_type_info const& derived,
                extended_type_info const& base, void const* const t);

inline void* void_upcast(extended_type_info const& derived,
                         extended_type_info const& base, void* const t)
{
    return const_cast<void*>(
        void_upcast(derived, base, const_cast<void const*>(t)));
}

BOOST_SERIALIZATION_DECL void const*
    void_downcast(extended_type_info const& derived,
                  extended_type_info const& base, void const* const t);

inline void* void_downcast(extended_type_info const& derived,
                           extended_type_info const& base, void* const t)
{
    return const_cast<void*>(
        void_downcast(derived, base, const_cast<void const*>(t)));
}
...
{
    friend BOOST_SERIALIZATION_DECL void const*
  ...
  protected:
    BOOST_SERIALIZATION_DECL void
        recursive_register(bool includes_virtual_base = false) const;
  ...
  public:
    ...
    // Constructor
    void_caster(extended_type_info const* derived,
                extended_type_info const* base, std::ptrdiff_t difference = 0,
                void_caster const* const parent = 0) :
        m_derived(derived),
        m_base(base), m_difference(difference), m_parent(parent)
    {
    }
    virtual ~void_caster()
    {
...
void_caster_primitive<Derived, Base>::void_caster_primitive() :
    void_caster(
        ...
        reinterpret_cast<std::ptrdiff_t>(
            static_cast<Derived*>(reinterpret_cast<Base*>(1 << 20))) -
            (1 << 20))
{
    recursive_register();
}
...
class BOOST_SYMBOL_VISIBLE void_caster_virtual_base : public void_caster
{
  ...
  public:
    ...
    {
        const Derived* d =
            dynamic_cast<const Derived*>(static_cast<const Base*>(t));
        return d;
    }
    virtual void const* upcast(void const* const t) const
    {
        const Base* b =
            dynamic_cast<const Base*>(static_cast<const Derived*>(t));
        return b;
    }
...
struct BOOST_SYMBOL_VISIBLE void_caster_base : public void_caster
{
    typedef typename mpl::eval_if<
        ...
        mpl::identity<
            void_cast_detail::void_caster_virtual_base<Derived, Base>>, // else
        mpl::identity<void_cast_detail::void_caster_primitive<Derived, Base>>>::
        type type;
};
...
BOOST_DLLEXPORT inline const void_cast_detail::void_caster&
    void_cast_register(Derived const* /* dnull = NULL */,
