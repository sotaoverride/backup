...
G_DEFINE_TYPE_WITH_CODE(
    GInotifyFileMonitor, g_inotify_file_monitor, G_TYPE_LOCAL_FILE_MONITOR,
...
static void g_inotify_file_monitor_start(GLocalFileMonitor* local_monitor,
                                         const gchar* dirname,
                                         ...
                                         GFileMonitorSource* source)
{
    GInotifyFileMonitor* inotify_monitor =
        G_INOTIFY_FILE_MONITOR(local_monitor);
    gboolean success;
