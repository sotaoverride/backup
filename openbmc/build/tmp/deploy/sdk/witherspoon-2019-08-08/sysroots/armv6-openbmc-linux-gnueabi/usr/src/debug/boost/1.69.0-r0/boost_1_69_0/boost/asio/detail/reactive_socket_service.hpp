      ...
      public reactive_socket_service_base
{
  public:
    ...
    size_t
        send_to(implementation_type& impl, const ConstBufferSequence& buffers,
                ...
                socket_base::message_flags flags, boost::system::error_code& ec)
    {
        ...
        return socket_ops::sync_sendto(
            impl.socket_, impl.state_, bufs.buffers(), bufs.count(), flags,
                       ...
                       socket_base::message_flags flags, Handler& handler)
    {
        ...
        typedef reactive_socket_sendto_op<ConstBufferSequence, endpoint_type,
                                          Handler>
            op;
                            ...
                            socket_base::message_flags flags, Handler& handler)
    {
        ...
        p.p = new (p.v) op(impl.socket_, protocol, buffers, sender_endpoint,
                           flags, handler);
                                     ...
                                     boost::system::error_code& ec)
    {
        ...
        socket_holder new_socket(
            socket_ops::sync_accept(impl.socket_, impl.state_,
                      ...
                      endpoint_type* peer_endpoint, Handler& handler)
    {
        ...
        typename op::ptr p = {boost::asio::detail::addressof(handler),
                              op::ptr::allocate(handler), 0};
        p.p = new (p.v)
            op(peer_io_context ? *peer_io_context : io_context_, impl.socket_,
               impl.state_, impl.protocol_, peer_endpoint, handler);
    ...
    boost::system::error_code connect(implementation_type& impl,
                                      ...
                                      boost::system::error_code& ec)
    {
        socket_ops::sync_connect(impl.socket_, peer_endpoint.data(),
                                 peer_endpoint.size(), ec);
        return ec;
    }
                       ...
                       const endpoint_type& peer_endpoint, Handler& handler)
    {
        ...
        BOOST_ASIO_HANDLER_CREATION((reactor_.context(), *p.p, "socket", &impl,
                                     impl.socket_, "async_connect"));

        start_connect_op(impl, p.p, is_continuation, peer_endpoint.data(),
                         peer_endpoint.size());
        p.v = p.p = 0;
    }
};
