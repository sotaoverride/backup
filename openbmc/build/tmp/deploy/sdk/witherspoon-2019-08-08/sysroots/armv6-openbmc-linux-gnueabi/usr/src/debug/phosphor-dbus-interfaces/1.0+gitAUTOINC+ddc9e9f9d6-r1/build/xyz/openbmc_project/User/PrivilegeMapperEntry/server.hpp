...
class PrivilegeMapperEntry
{
  public:
    ...
    virtual std::string groupName(std::string value, bool skipSignal);
    ...
    virtual std::string privilege(std::string value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_GroupName(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    /** @brief sd-bus callback for set-property 'GroupName' */
    static int _callback_set_GroupName(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_User_PrivilegeMapperEntry_interface;
