...
extern char* __dngettext(const char* __domainname, const char* __msgid1,
                         const char* __msgid2, unsigned long int n);
extern char* __dcngettext(const char* __domainname, const char* __msgid1,
                          const char* __msgid2, unsigned long int __n,
                          int __category) attribute_hidden;
extern char* __dcigettext(const char* __domainname, const char* __msgid1,
...
extern void _nl_unload_domain(struct loaded_domain* __domain) attribute_hidden;
#else
...
#ifdef IN_LIBGLOCALE
extern char* gl_dcigettext(const char* __domainname, const char* __msgid1,
                           const char* __msgid2, int __plural,
                           unsigned long int __n, int __category,
                           const char* __localename, const char* __encoding);
#else
extern char* libintl_dcigettext(const char* __domainname, const char* __msgid1,
                                const char* __msgid2, int __plural,
                                unsigned long int __n, int __category);
#endif
#endif
...
struct loaded_l10nfile*
    _nl_find_domain(const char* __dirname, char* __locale,
                    ...
                    struct binding* __domainbinding) attribute_hidden;
...
char* _nl_find_msg(struct loaded_l10nfile* domain_file,
                   ...
                   const char* msgid, size_t* lengthp) attribute_hidden;
#else
char* _nl_find_msg(struct loaded_l10nfile* domain_file,
                   struct binding* domainbinding, const char* msgid,
                   int convert, size_t* lengthp) attribute_hidden;
#endif
