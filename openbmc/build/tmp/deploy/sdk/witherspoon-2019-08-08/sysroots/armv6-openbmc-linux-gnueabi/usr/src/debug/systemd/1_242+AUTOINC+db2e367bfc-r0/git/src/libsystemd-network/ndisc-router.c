...
_public_ int sd_ndisc_router_from_raw(sd_ndisc_router** ret, const void* raw,
                                      size_t raw_size)
{
...
_public_ int sd_ndisc_router_get_address(sd_ndisc_router* rt,
...
_public_ int sd_ndisc_router_get_timestamp(sd_ndisc_router* rt, clockid_t clock,
                                           uint64_t* ret)
{
    assert_return(rt, -EINVAL);
...
_public_ int sd_ndisc_router_get_raw(sd_ndisc_router* rt, const void** ret,
                                     size_t* size)
{
    assert_return(rt, -EINVAL);
    assert_return(ret, -EINVAL);
...
int ndisc_router_parse(sd_ndisc_router* rt)
{
    ...
    /* Router advertisement packets are neatly aligned to 64bit boundaries,
     * hence we can access them directly */
    ...
    if (!IN_SET(rt->preference, SD_NDISC_PREFERENCE_LOW,
    ...
    for (;;)
    {
        ...
        switch (type)
        {
            ...
            case SD_NDISC_OPTION_ROUTE_INFORMATION:
                ...
                {
                    log_ndisc("Route information option of invalid size, "
                              "ignoring datagram.");
                    return -EBADMSG;
                }
...
_public_ int sd_ndisc_router_get_lifetime(sd_ndisc_router* rt,
...
_public_ int sd_ndisc_router_option_get_raw(sd_ndisc_router* rt,
...
static int get_prefix_info(sd_ndisc_router* rt, struct nd_opt_prefix_info** ret)
{
    ...
    ri = (struct nd_opt_prefix_info*)((uint8_t*)NDISC_ROUTER_RAW(rt) +
                                      rt->rindex);
...
_public_ int sd_ndisc_router_prefix_get_valid_lifetime(sd_ndisc_router* rt,
                                                       uint32_t* ret)
{
    struct nd_opt_prefix_info* ri;
    int r;
...
_public_ int sd_ndisc_router_prefix_get_preferred_lifetime(sd_ndisc_router* rt,
                                                           uint32_t* ret)
{
...
_public_ int sd_ndisc_router_prefix_get_flags(sd_ndisc_router* rt, uint8_t* ret)
{
    ...
    {
        log_ndisc("Invalid prefix length, ignoring prefix for stateless "
                  "autoconfiguration.");
...
_public_ int sd_ndisc_router_prefix_get_address(sd_ndisc_router* rt,
                                                struct in6_addr* ret_addr)
{
    struct nd_opt_prefix_info* pi;
    int r;
...
_public_ int sd_ndisc_router_prefix_get_prefixlen(sd_ndisc_router* rt,
                                                  unsigned* ret)
{
    struct nd_opt_prefix_info* pi;
    int r;
...
_public_ int sd_ndisc_router_route_get_lifetime(sd_ndisc_router* rt,
                                                uint32_t* ret)
{
    uint8_t* ri;
    int r;
...
_public_ int sd_ndisc_router_route_get_address(sd_ndisc_router* rt,
                                               struct in6_addr* ret_addr)
{
    uint8_t* ri;
    int r;
...
_public_ int sd_ndisc_router_route_get_prefixlen(sd_ndisc_router* rt,
                                                 unsigned* ret)
{
    uint8_t* ri;
    int r;
...
_public_ int sd_ndisc_router_route_get_preference(sd_ndisc_router* rt,
                                                  unsigned* ret)
{
    uint8_t* ri;
    int r;
...
_public_ int sd_ndisc_router_rdnss_get_addresses(sd_ndisc_router* rt,
                                                 const struct in6_addr** ret)
{
    uint8_t* ri;
    int r;
...
_public_ int sd_ndisc_router_rdnss_get_lifetime(sd_ndisc_router* rt,
                                                uint32_t* ret)
{
    uint8_t* ri;
    int r;
...
_public_ int sd_ndisc_router_dnssl_get_domains(sd_ndisc_router* rt, char*** ret)
{
    ...
    for (;;)
    {
        ...
        if (!GREEDY_REALLOC(e, allocated,
                            n + !first + DNS_LABEL_ESCAPED_MAX + 1U))
            return -ENOMEM;
...
_public_ int sd_ndisc_router_dnssl_get_lifetime(sd_ndisc_router* rt,
                                                uint32_t* ret_sec)
{
    uint8_t* ri;
    int r;
