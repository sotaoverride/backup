...
#define G_INOTIFY_FILE_MONITOR(o)                                              \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_INOTIFY_FILE_MONITOR,              \
                                GInotifyFileMonitor))
#define G_INOTIFY_FILE_MONITOR_CLASS(k)                                        \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_INOTIFY_FILE_MONITOR,                 \
                             GInotifyFileMonitorClass))
#define G_IS_INOTIFY_FILE_MONITOR(o)                                           \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_INOTIFY_FILE_MONITOR))
#define G_IS_INOTIFY_FILE_MONITOR_CLASS(k)                                     \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_INOTIFY_FILE_MONITOR))
