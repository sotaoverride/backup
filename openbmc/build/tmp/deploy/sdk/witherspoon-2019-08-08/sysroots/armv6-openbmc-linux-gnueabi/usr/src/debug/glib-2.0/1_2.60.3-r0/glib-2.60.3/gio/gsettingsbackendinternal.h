...
typedef struct
{
    void (*changed)(GObject* target, GSettingsBackend* backend,
                    const gchar* key, gpointer origin_tag);
    void (*path_changed)(GObject* target, GSettingsBackend* backend,
                         const gchar* path, gpointer origin_tag);
    void (*keys_changed)(GObject* target, GSettingsBackend* backend,
                         const gchar* prefix, gpointer origin_tag,
                         const gchar* const* names);
    void (*writable_changed)(GObject* target, GSettingsBackend* backend,
                             const gchar* key);
    void (*path_writable_changed)(GObject* target, GSettingsBackend* backend,
                                  const gchar* path);
...
void g_settings_backend_unsubscribe(GSettingsBackend* backend,
                                    const char* name);
void g_settings_backend_subscribe(GSettingsBackend* backend, const char* name);
