...
krb5_error_code krb5_dbe_def_encrypt_key_data(
    krb5_context context, const krb5_keyblock* mkey, const krb5_keyblock* dbkey,
    const krb5_keysalt* keysalt, int keyver, krb5_key_data* key_data)
{
    ...
    if ((retval =
             krb5_c_encrypt(context, mkey, /* XXX */ 0, 0, &plain, &cipher)))
    {
