...
class ExtendedVersion
{
  public:
    ...
    virtual std::string extendedVersion(std::string value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_ExtendedVersion(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'ExtendedVersion' */
    static int _callback_set_ExtendedVersion(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Software_ExtendedVersion_interface;
