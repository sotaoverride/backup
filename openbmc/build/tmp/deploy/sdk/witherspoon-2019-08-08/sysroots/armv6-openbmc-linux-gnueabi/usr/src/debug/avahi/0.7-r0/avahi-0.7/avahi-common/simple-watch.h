...
/** Replace the internally used poll() function. By default the system's poll()
 * will be used */
void avahi_simple_poll_set_func(AvahiSimplePoll* s, AvahiPollFunc func,
                                void* userdata);

/** The first stage of avahi_simple_poll_iterate(), use this function only if
 * you know what you do */
int avahi_simple_poll_prepare(AvahiSimplePoll* s, int timeout);

/** The second stage of avahi_simple_poll_iterate(), use this function only if
 * you know what you do */
int avahi_simple_poll_run(AvahiSimplePoll* s);

/** The third and final stage of avahi_simple_poll_iterate(), use this function
