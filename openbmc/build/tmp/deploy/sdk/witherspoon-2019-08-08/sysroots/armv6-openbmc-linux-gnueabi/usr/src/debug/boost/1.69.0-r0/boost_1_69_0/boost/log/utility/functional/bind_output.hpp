 ...
 * \date   30.03.2008
 *
 * This header contains a function object that puts the received value to the
 * bound stream. This is a lightweight alternative to what Boost.Phoenix and
 * Boost.Lambda provides.
 */
