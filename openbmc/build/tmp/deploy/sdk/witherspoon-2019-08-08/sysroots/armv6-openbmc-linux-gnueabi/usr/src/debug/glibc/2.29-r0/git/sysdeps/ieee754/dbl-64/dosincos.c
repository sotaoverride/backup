...
void SECTION __dubsin(double x, double dx, double v[])
{
    double r, s, c, cc, d, dd, d2, dd2, e, ee, sn, ssn, cs, ccs, ds, dss, dc,
        dcc;
#ifndef DLA_FMS
...
void SECTION __dubcos(double x, double dx, double v[])
{
    double r, s, c, cc, d, dd, d2, dd2, e, ee, sn, ssn, cs, ccs, ds, dss, dc,
        dcc;
#ifndef DLA_FMS
...
/**********************************************************************/
void SECTION __docos(double x, double dx, double v[])
{
    double y, yy, p, w[2];
    if (x > 0)
    {
