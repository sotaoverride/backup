...
class AccountPolicy
{
  public:
    ...
    using PropertiesVariant = std::variant<uint16_t, uint8_t, uint32_t>;
    ...
    /** Set value of MaxLoginAttemptBeforeLockout with option to skip sending
     * signal */
    ...
    virtual uint32_t accountUnlockTimeout(uint32_t value, bool skipSignal);
    ...
    virtual uint8_t minPasswordLength(uint8_t value, bool skipSignal);
     ...
     */
    virtual uint8_t rememberOldPasswordTimes(uint8_t value, bool skipSignal);
  ...
  private:
     ...
     */
    static int _callback_get_MaxLoginAttemptBeforeLockout(sd_bus*, const char*,
                                                          const char*,
                                                          const char*,
                                                          sd_bus_message*,
                                                          void*, sd_bus_error*);
     ...
     */
    static int _callback_set_MaxLoginAttemptBeforeLockout(sd_bus*, const char*,
                                                          const char*,
                                                          const char*,
                                                          sd_bus_message*,
                                                          void*, sd_bus_error*);
    ...
    static int _callback_get_AccountUnlockTimeout(sd_bus*, const char*,
                                                  const char*, const char*,
                                                  sd_bus_message*, void*,
                                                  sd_bus_error*);
    /** @brief sd-bus callback for set-property 'AccountUnlockTimeout' */
    static int _callback_set_AccountUnlockTimeout(sd_bus*, const char*,
                                                  const char*, const char*,
                                                  sd_bus_message*, void*,
                                                  sd_bus_error*);

    /** @brief sd-bus callback for get-property 'MinPasswordLength' */
    static int _callback_get_MinPasswordLength(sd_bus*, const char*,
                                               const char*, const char*,
                                               sd_bus_message*, void*,
                                               sd_bus_error*);
    /** @brief sd-bus callback for set-property 'MinPasswordLength' */
    static int _callback_set_MinPasswordLength(sd_bus*, const char*,
                                               const char*, const char*,
                                               sd_bus_message*, void*,
                                               sd_bus_error*);

    /** @brief sd-bus callback for get-property 'RememberOldPasswordTimes' */
    static int _callback_get_RememberOldPasswordTimes(sd_bus*, const char*,
                                                      const char*, const char*,
                                                      sd_bus_message*, void*,
                                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'RememberOldPasswordTimes' */
    static int _callback_set_RememberOldPasswordTimes(sd_bus*, const char*,
                                                      const char*, const char*,
                                                      sd_bus_message*, void*,
                                                      sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_User_AccountPolicy_interface;
