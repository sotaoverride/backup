...
#define G_NETWORK_MONITOR(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_NETWORK_MONITOR, GNetworkMonitor))
#define G_IS_NETWORK_MONITOR(o)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_NETWORK_MONITOR))
#define G_NETWORK_MONITOR_GET_INTERFACE(o)                                     \
    (G_TYPE_INSTANCE_GET_INTERFACE((o), G_TYPE_NETWORK_MONITOR,                \
...
struct _GNetworkMonitorInterface
{
    ...
    gboolean (*can_reach_finish)(GNetworkMonitor* monitor, GAsyncResult* result,
                                 GError** error);
};
