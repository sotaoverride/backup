...
netsnmp_feature_child_of(ipIfStatsTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(baby_steps)
        netsnmp_feature_require(check_all_requests_error)
            ...
            netsnmp_feature_child_of(ipIfStatsTable_container_size,
                                     ipIfStatsTable_external_access)
                netsnmp_feature_child_of(ipIfStatsTable_registration_set,
                                         ipIfStatsTable_external_access)
                    netsnmp_feature_child_of(ipIfStatsTable_registration_get,
                                             ipIfStatsTable_external_access)
                        netsnmp_feature_child_of(ipIfStatsTable_container_get,
                                                 ipIfStatsTable_external_access)
...
{
    DEBUGMSGTL(("ipIfStatsTable:lastChanged_set", "called. was %ld, now %ld\n",
     ...
     */
    {
        ...
        netsnmp_register_watched_scalar2(
            netsnmp_create_handler_registration(
                "ipIfStatsTableLastChanged", NULL, lc_oid, OID_LENGTH(lc_oid),
                HANDLER_CAN_RONLY),
            netsnmp_create_watcher_info(
                (void*)&ipIfStatsTable_if_ctx.last_changed, sizeof(u_long),
                               ...
                               netsnmp_variable_list* var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPIFSTATSINADDRERRORS:
            ...
            var->type = ASN_COUNTER;
            rc =
                ipIfStatsInAddrErrors_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCINFORWDATAGRAMS:
            ...
            rc = ipIfStatsHCInForwDatagrams_get(
                rowreq_ctx, (struct counter64*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSOUTFRAGREQDS:
            ...
            var->type = ASN_COUNTER;
            rc =
                ipIfStatsOutFragReqds_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSOUTFRAGFAILS:
            ...
            var->type = ASN_COUNTER;
            rc =
                ipIfStatsOutFragFails_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSOUTTRANSMITS:
            ...
            var->type = ASN_COUNTER;
            rc =
                ipIfStatsOutTransmits_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTTRANSMITS:
            var->val_len = sizeof(struct counter64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutTransmits_get(
                rowreq_ctx, (struct counter64*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSOUTMCASTPKTS:
            ...
            var->type = ASN_COUNTER;
            rc =
                ipIfStatsOutMcastPkts_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTMCASTPKTS:
            var->val_len = sizeof(struct counter64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutMcastPkts_get(
                rowreq_ctx, (struct counter64*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSOUTBCASTPKTS:
            ...
            var->type = ASN_COUNTER;
            rc =
                ipIfStatsOutBcastPkts_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTBCASTPKTS:
            var->val_len = sizeof(struct counter64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutBcastPkts_get(
                rowreq_ctx, (struct counter64*)var->val.string);
            break;
...
void _ipIfStatsTable_container_init(ipIfStatsTable_interface_ctx* if_ctx)
{
    ...
    if_ctx->cache = netsnmp_cache_create(
        ...
        _cache_load, _cache_free, ipIfStatsTable_oid, ipIfStatsTable_oid_size);
