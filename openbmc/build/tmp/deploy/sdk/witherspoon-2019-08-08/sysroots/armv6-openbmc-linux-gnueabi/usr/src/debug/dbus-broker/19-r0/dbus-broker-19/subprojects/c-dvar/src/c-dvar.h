 ...
 * @size:               size in bytes required for the serialization, 0 if
 * dynamic
...
int c_dvar_type_new_from_signature(CDVarType** typep, const char* signature,
                                   size_t n_signature);
CDVarType* c_dvar_type_free(CDVarType* type);

int c_dvar_type_compare_string(const CDVarType* subject, const char* object,
                               size_t n_object);
...
void c_dvar_get_root_types(CDVar* var, const CDVarType** typesp,
                           size_t* n_typesp);
void c_dvar_get_parent_types(CDVar* var, const CDVarType** typesp,
                             size_t* n_typesp);

void c_dvar_begin_read(CDVar* var, bool big_endian, const CDVarType* types,
                       size_t n_types, const void* data, size_t n_data);
...
void c_dvar_begin_write(CDVar* var, bool big_endian, const CDVarType* types,
                        size_t n_types);
 ...
 */
static inline int c_dvar_type_new_from_string(CDVarType** typep,
                                              const char* str)
{
