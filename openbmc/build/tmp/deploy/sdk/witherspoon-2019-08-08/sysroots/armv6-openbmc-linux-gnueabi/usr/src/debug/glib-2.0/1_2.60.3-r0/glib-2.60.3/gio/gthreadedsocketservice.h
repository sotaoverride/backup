...
#define G_THREADED_SOCKET_SERVICE(inst)                                        \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_THREADED_SOCKET_SERVICE,        \
                                GThreadedSocketService))
#define G_THREADED_SOCKET_SERVICE_CLASS(class)                                 \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_THREADED_SOCKET_SERVICE,          \
                             GThreadedSocketServiceClass))
#define G_IS_THREADED_SOCKET_SERVICE(inst)                                     \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_THREADED_SOCKET_SERVICE))
#define G_IS_THREADED_SOCKET_SERVICE_CLASS(class)                              \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_THREADED_SOCKET_SERVICE))
#define G_THREADED_SOCKET_SERVICE_GET_CLASS(inst)                              \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_THREADED_SOCKET_SERVICE,         \
                               GThreadedSocketServiceClass))
