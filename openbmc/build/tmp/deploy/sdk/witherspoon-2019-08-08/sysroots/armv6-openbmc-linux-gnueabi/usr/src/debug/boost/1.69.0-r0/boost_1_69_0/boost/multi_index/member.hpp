...
#if !defined(BOOST_NO_SFINAE)
    typename disable_if<is_convertible<const ChainedPtr&, const Class&>,
                        Type&>::type
#else
    Type&
#endif
...
struct member_offset
    : mpl::if_c<is_const<Type>::value,
                ...
                detail::non_const_member_offset_base<Class, Type,
                                                     OffsetOfMember>>::type
{
};
...
#define BOOST_MULTI_INDEX_MEMBER(Class, Type, MemberName)                      \
    ::boost::multi_index::member_offset<Class, Type,                           \
                                        offsetof(Class, MemberName)>
#else
#define BOOST_MULTI_INDEX_MEMBER(Class, Type, MemberName)                      \
