...
#define G_TLS_INTERACTION(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_TLS_INTERACTION, GTlsInteraction))
#define G_TLS_INTERACTION_CLASS(k)                                             \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_TLS_INTERACTION, GTlsInteractionClass))
#define G_IS_TLS_INTERACTION(o)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_TLS_INTERACTION))
#define G_IS_TLS_INTERACTION_CLASS(k)                                          \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_TLS_INTERACTION))
#define G_TLS_INTERACTION_GET_CLASS(o)                                         \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_TLS_INTERACTION,                    \
