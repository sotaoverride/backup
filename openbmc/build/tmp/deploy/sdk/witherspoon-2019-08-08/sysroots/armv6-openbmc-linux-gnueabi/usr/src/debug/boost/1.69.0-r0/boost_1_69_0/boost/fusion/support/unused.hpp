...
struct unused_type
{
    BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED BOOST_DEFAULTED_FUNCTION(
...
struct unused_only
{
    BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED unused_only(unused_type const&)
        BOOST_NOEXCEPT
    {
    }
};
...
inline std::ostream& operator<<(std::ostream& out,
                                detail::unused_only const&) BOOST_NOEXCEPT
{
    return out;
}
