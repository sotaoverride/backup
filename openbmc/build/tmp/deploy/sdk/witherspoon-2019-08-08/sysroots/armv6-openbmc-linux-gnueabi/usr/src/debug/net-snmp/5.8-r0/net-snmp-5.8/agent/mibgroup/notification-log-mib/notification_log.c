...
static oid nlm_module_oid[] = {
    SNMP_OID_MIB2, 92}; /* NOTIFICATION-LOG-MIB::notificationLogMIB */

static void netsnmp_notif_log_remove_oldest(int count)
{
    ...
    for (; count && deleterow; deleterow = tmprow, --count)
    {
        ...
        {
            DEBUGMSGTL(("9:notification_log", " base oid:"));
        ...
        for (; deletevarrow; deletevarrow = tmprow)
        {
            ...
            if ((deleterow->index_oid_len == deletevarrow->index_oid_len - 1) &&
                snmp_oid_compare(deleterow->index_oid, deleterow->index_oid_len,
...
static void check_log_size(unsigned int clientreg, void* clientarg)
{
    ...
    DEBUGMSGTL(("notification_log", "logged notifications %lu; max %lu\n",
                count, max_logged));
    if (count > max_logged)
    {
        count = count - max_logged;
        DEBUGMSGTL(
            ("notification_log", "removing %lu extra notifications\n", count));
    ...
    if (0 == max_age)
        return;
    count = 0;
    for (row = netsnmp_table_data_set_get_first_row(nlmLogTable); row;
...
/** Initialize the nlmLogVariableTable table by defining its contents and how
 * it's structured */
static void initialize_table_nlmLogVariableTable(const char* context)
{
    static oid nlmLogVariableTable_oid[] = {1, 3, 6, 1, 2, 1, 92, 1, 3, 2};
    size_t nlmLogVariableTable_oid_len = OID_LENGTH(nlmLogVariableTable_oid);
    ...
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding index nlmLogName of type ASN_OCTET_STR to table "
                "nlmLogVariableTable\n"));
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding index nlmLogIndex of type ASN_UNSIGNED to table "
                "nlmLogVariableTable\n"));
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding index nlmLogVariableIndex of type ASN_UNSIGNED to "
                "table nlmLogVariableTable\n"));
    netsnmp_table_dataset_add_index(table_set, ASN_UNSIGNED);
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableID (#2) of type ASN_OBJECT_ID to "
                "table nlmLogVariableTable\n"));
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableValueType (#3) of type "
                "ASN_INTEGER to table nlmLogVariableTable\n"));
    netsnmp_table_set_add_default_row(table_set, COLUMN_NLMLOGVARIABLEVALUETYPE,
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableCounter32Val (#4) of type "
                "ASN_COUNTER to table nlmLogVariableTable\n"));
    netsnmp_table_set_add_default_row(
        table_set, COLUMN_NLMLOGVARIABLECOUNTER32VAL, ASN_COUNTER, 0, NULL, 0);
    /*
     * adding column nlmLogVariableUnsigned32Val of type ASN_UNSIGNED and
     * access of ReadOnly
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableUnsigned32Val (#5) of type "
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableTimeTicksVal (#6) of type "
                "ASN_TIMETICKS to table nlmLogVariableTable\n"));
    netsnmp_table_set_add_default_row(table_set,
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableInteger32Val (#7) of type "
                "ASN_INTEGER to table nlmLogVariableTable\n"));
    netsnmp_table_set_add_default_row(
        table_set, COLUMN_NLMLOGVARIABLEINTEGER32VAL, ASN_INTEGER, 0, NULL, 0);
    /*
     * adding column nlmLogVariableOctetStringVal of type ASN_OCTET_STR
     * and access of ReadOnly
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableOctetStringVal (#8) of type "
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableIpAddressVal (#9) of type "
                "ASN_IPADDRESS to table nlmLogVariableTable\n"));
    netsnmp_table_set_add_default_row(table_set,
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableOidVal (#10) of type "
                "ASN_OBJECT_ID to table nlmLogVariableTable\n"));
    netsnmp_table_set_add_default_row(table_set, COLUMN_NLMLOGVARIABLEOIDVAL,
                                      ASN_OBJECT_ID, 0, NULL, 0);
    /*
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableCounter64Val (#11) of type "
                "ASN_COUNTER64 to table nlmLogVariableTable\n"));
    netsnmp_table_set_add_default_row(table_set,
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogVariableTable",
                "adding column nlmLogVariableOpaqueVal (#12) of type "
                "ASN_OPAQUE to table nlmLogVariableTable\n"));
    netsnmp_table_set_add_default_row(table_set, COLUMN_NLMLOGVARIABLEOPAQUEVAL,
                                      ASN_OPAQUE, 0, NULL, 0);
    ...
    reginfo = netsnmp_create_handler_registration(
        "nlmLogVariableTable", NULL, nlmLogVariableTable_oid,
        nlmLogVariableTable_oid_len, HANDLER_CAN_RWRITE);
    if (NULL != context)
        reginfo->contextName = strdup(context);
    netsnmp_register_table_data_set(reginfo, table_set, NULL);
}

/** Initialize the nlmLogTable table by defining its contents and how it's
 * structured */
static void initialize_table_nlmLogTable(const char* context)
{
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogTable",
                "adding column nlmLogTime (#2) of type ASN_TIMETICKS to table "
                "nlmLogTable\n"));
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogTable",
                "adding column nlmLogDateAndTime (#3) of type ASN_OCTET_STR to "
                "table nlmLogTable\n"));
    netsnmp_table_set_add_default_row(nlmLogTable, COLUMN_NLMLOGDATEANDTIME,
                                      ASN_OCTET_STR, 0, NULL, 0);
    /*
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogTable",
                "adding column nlmLogEngineID (#4) of type ASN_OCTET_STR to "
                "table nlmLogTable\n"));
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogTable",
                "adding column nlmLogEngineTAddress (#5) of type ASN_OCTET_STR "
                "to table nlmLogTable\n"));
    netsnmp_table_set_add_default_row(nlmLogTable, COLUMN_NLMLOGENGINETADDRESS,
                                      ASN_OCTET_STR, 0, NULL, 0);
    /*
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogTable",
                "adding column nlmLogEngineTDomain (#6) of type ASN_OBJECT_ID "
                "to table nlmLogTable\n"));
    netsnmp_table_set_add_default_row(nlmLogTable, COLUMN_NLMLOGENGINETDOMAIN,
                                      ASN_OBJECT_ID, 0, NULL, 0);
    /*
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogTable",
                "adding column nlmLogContextEngineID (#7) of type "
                "ASN_OCTET_STR to table nlmLogTable\n"));
    netsnmp_table_set_add_default_row(nlmLogTable, COLUMN_NLMLOGCONTEXTENGINEID,
                                      ASN_OCTET_STR, 0, NULL, 0);
    /*
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogTable",
                "adding column nlmLogContextName (#8) of type ASN_OCTET_STR to "
                "table nlmLogTable\n"));
    netsnmp_table_set_add_default_row(nlmLogTable, COLUMN_NLMLOGCONTEXTNAME,
                                      ASN_OCTET_STR, 0, NULL, 0);
    /*
     ...
     */
    DEBUGMSGTL(("initialize_table_nlmLogTable",
                "adding column nlmLogNotificationID (#9) of type ASN_OBJECT_ID "
                "to table nlmLogTable\n"));
    netsnmp_table_set_add_default_row(nlmLogTable, COLUMN_NLMLOGNOTIFICATIONID,
                                      ASN_OBJECT_ID, 0, NULL, 0);
     ...
     */
    reginfo = netsnmp_create_handler_registration(
        "nlmLogTable", NULL, nlmLogTable_oid, nlmLogTable_oid_len,
        HANDLER_CAN_RWRITE);
    if (NULL != context)
        reginfo->contextName = strdup(context);
...
static int notification_log_config_handler(
...
{
    static oid my_nlmStatsGlobalNotificationsLogged_oid[] = {1,  3, 6, 1, 2, 1,
                                                             92, 1, 2, 1, 0};
    static oid my_nlmStatsGlobalNotificationsBumped_oid[] = {1,  3, 6, 1, 2, 1,
                                                             92, 1, 2, 2, 0};
    static oid my_nlmConfigGlobalEntryLimit_oid[] = {1,  3, 6, 1, 2, 1,
                                                     92, 1, 1, 1, 0};
    static oid my_nlmConfigGlobalAgeOut_oid[] = {1,  3, 6, 1, 2, 1,
                                                 92, 1, 1, 2, 0};
    char* context;
    char* apptype;
    ...
    netsnmp_register_read_only_counter32_instance_context(
        ...
        OID_LENGTH(my_nlmStatsGlobalNotificationsLogged_oid), &num_received,
        NULL, context);

    netsnmp_register_read_only_counter32_instance_context(
        "nlmStatsGlobalNotificationsBumped",
        my_nlmStatsGlobalNotificationsBumped_oid,
        OID_LENGTH(my_nlmStatsGlobalNotificationsBumped_oid), &num_deleted,
        NULL, context);

    netsnmp_register_ulong_instance_context(
        "nlmConfigGlobalEntryLimit", my_nlmConfigGlobalEntryLimit_oid,
        OID_LENGTH(my_nlmConfigGlobalEntryLimit_oid), &max_logged,
        notification_log_config_handler, context);

    netsnmp_register_ulong_instance_context(
        "nlmConfigGlobalAgeOut", my_nlmConfigGlobalAgeOut_oid,
        OID_LENGTH(my_nlmConfigGlobalAgeOut_oid), &max_age,
        notification_log_config_handler, context);
    ...
    netsnmp_ds_register_config(
        ASN_BOOLEAN, apptype, "doNotRetainNotificationLogs",
...
void log_notification(netsnmp_pdu* pdu, netsnmp_transport* transport)
{
    ...
    if (!nlmLogVarTable || netsnmp_ds_get_boolean(NETSNMP_DS_APPLICATION_ID,
    ...
    netsnmp_set_row_column(row, COLUMN_NLMLOGTIME, ASN_TIMETICKS, &tmpl,
                           sizeof(tmpl));
    time(&timetnow);
    ...
    if (transport && transport->domain == netsnmpUDPDomain)
    {
        ...
        if (addr)
        {
            ...
            memcpy(buf + sizeof(in_addr_t), &portnum, sizeof(addr->sin_port));
    ...
    netsnmp_set_row_column(row, COLUMN_NLMLOGCONTEXTENGINEID, ASN_OCTET_STR,
    ...
    {
        if (snmp_oid_compare(snmptrapoid, snmptrapoid_len, vptr->name,
                             vptr->name_length) == 0)
        {
        ...
        else
        {
            ...
            switch (vptr->type)
            {
                ...
                default:
                     ...
                     */
                    DEBUGMSGTL(
                        ("notification_log", "skipping type %d\n", vptr->type));
                    (void)netsnmp_table_dataset_delete_row(myrow);
                    continue;
            }
            netsnmp_set_row_column(myrow, COLUMN_NLMLOGVARIABLEVALUETYPE,
                                   ASN_INTEGER, &tmpul, sizeof(tmpul));
            netsnmp_set_row_column(myrow, col, vptr->type, vptr->val.string,
                                   vptr->val_len);
            DEBUGMSGTL(
