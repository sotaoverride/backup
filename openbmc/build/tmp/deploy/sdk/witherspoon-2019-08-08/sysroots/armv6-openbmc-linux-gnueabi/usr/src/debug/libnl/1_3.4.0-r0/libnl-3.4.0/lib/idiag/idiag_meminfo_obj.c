...
/** @cond SKIP */
static uint64_t idiagnl_meminfo_compare(struct nl_object* _a,
                                        ...
                                        int flags)
{
    ...
    return a->idiag_rmem != b->idiag_rmem || a->idiag_wmem != b->idiag_wmem ||
           a->idiag_fmem != b->idiag_fmem || a->idiag_tmem != b->idiag_tmem;
}
