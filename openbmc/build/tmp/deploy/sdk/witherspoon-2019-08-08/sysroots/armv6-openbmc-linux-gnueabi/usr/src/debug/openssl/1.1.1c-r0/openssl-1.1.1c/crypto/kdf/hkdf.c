...
static unsigned char* HKDF(const EVP_MD* evp_md, const unsigned char* salt,
                           size_t salt_len, const unsigned char* key,
                           size_t key_len, const unsigned char* info,
...
const EVP_PKEY_METHOD hkdf_pkey_meth = {EVP_PKEY_HKDF,
                                        0,
                                        pkey_hkdf_init,
                                        0,
                                        pkey_hkdf_cleanup,
                                  ...
                                  unsigned char* okm, size_t okm_len)
{
    ...
    for (i = 1; i <= n; i++)
    {
        ...
        copy_len =
            (done_len + dig_len > okm_len) ? okm_len - done_len : dig_len;
