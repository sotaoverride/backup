...
struct select_arg_to_python
{
    ...
    typedef typename mpl::if_<
        ...
        python::detail::is_string_literal<T const>, arg_to_python<char const*>

        ,
        typename mpl::if_<
            python::detail::value_is_shared_ptr<T>, shared_ptr_arg_to_python<T>

            ,
            typename mpl::if_<
                mpl::or_<boost::python::detail::is_function<T>,
                ...
                ,
                typename mpl::if_<
                    is_object_manager<T>, object_manager_arg_to_python<T>
                    ...
                    typename mpl::if_<
                        ...
                        typename mpl::if_<
                            ...
                            typename mpl::if_<
                                ...
                                value_arg_to_python<T>>::type>::type>::type>::
                    type>::type>::type>::type
...
template <class Ptr>
inline pointer_shallow_arg_to_python<Ptr>::pointer_shallow_arg_to_python(
    Ptr x) :
...
template <class T>
inline arg_to_python<T>::arg_to_python(T const& x) : base(x)
{
}
