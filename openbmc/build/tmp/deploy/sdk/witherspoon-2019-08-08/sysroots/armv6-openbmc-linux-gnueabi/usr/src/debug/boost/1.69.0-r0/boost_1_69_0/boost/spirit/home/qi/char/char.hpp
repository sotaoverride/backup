...
struct use_terminal<qi::domain,
                    terminal<tag::char_code<tag::char_, CharEncoding> // enables
                                                                      // char_
                             >> : mpl::true_
{
};
...
struct use_terminal<
    qi::domain,
    terminal_ex<tag::char_code<tag::char_, CharEncoding> // enables char_('x'),
                                                         // char_("x")
                ,
...
struct use_terminal<
    qi::domain,
    terminal_ex<tag::char_code<tag::char_, CharEncoding> // enables
                                                         // char_('a','z')
                ,
...
struct use_lazy_terminal<        // and char_("a-z0-9")
    qi::domain, tag::char_code<tag::char_, CharEncoding>, 1 // arity
    > : mpl::true_
{
};

template <typename CharEncoding> // enables *lazy* char_('a','z')
struct use_lazy_terminal<qi::domain, tag::char_code<tag::char_, CharEncoding>,
                         2 // arity
                         > : mpl::true_
{
};
...
struct use_terminal<qi::domain, terminal_ex<tag::lit, fusion::vector1<A0>>,
...
struct literal_char
    : char_parser<literal_char<CharEncoding, no_attribute, false>,
                                     ...
                                     typename CharEncoding::char_type>::type>
{
    ...
    literal_char(Char ch_) : ch(static_cast<char_type>(ch_))
    {
    }
    ...
    {
        typedef
            typename mpl::if_c<no_attribute, unused_type, char_type>::type type;
    };
...
struct literal_char<CharEncoding, no_attribute, true> // case insensitive
    : char_parser<literal_char<CharEncoding, no_attribute, true>,
                  typename mpl::if_c<no_attribute, unused_type,
                                     typename CharEncoding::char_type>::type>
{
    typedef typename CharEncoding::char_type char_type;
...
struct char_range : char_parser<char_range<CharEncoding, false>,
                                typename CharEncoding::char_type>
{
    typedef typename CharEncoding::char_type char_type;
    typedef CharEncoding char_encoding;
...
struct char_range<CharEncoding, true> // case insensitive
    : char_parser<char_range<CharEncoding, true>,
                  typename CharEncoding::char_type>
{
    typedef typename CharEncoding::char_type char_type;
    typedef CharEncoding char_encoding;
                                     ...
                                     typename CharEncoding::char_type>::type>
{
    ...
    char_set(String const& str)
    {
        ...
        typedef typename remove_const<
            typename traits::char_type_of<String>::type>::type in_type;

        BOOST_SPIRIT_ASSERT_MSG(((sizeof(char_type) >= sizeof(in_type))),
...
struct basic_literal
{
    ...
    typedef literal_char<typename spirit::detail::get_encoding_with_case<
...
struct make_primitive<terminal<tag::char_code<tag::char_, CharEncoding>>,
                      Modifiers>
{
    typedef typename spirit::detail::get_encoding<Modifiers, CharEncoding>::type
        char_encoding;
    ...
    Modifiers>
{
    ...
    typedef typename mpl::if_<
        traits::is_string<A0>, char_set<char_encoding, false, no_case>,
...
struct make_primitive<terminal_ex<tag::lit, fusion::vector1<A0>>, Modifiers,
...
struct make_primitive<terminal_ex<tag::char_code<tag::char_, CharEncoding>,
                                  fusion::vector1<Char (&)[2]> // For single
                                                               // char strings
                                  >,
                      Modifiers>
{
...
template <typename CharEncoding, typename Modifiers, typename Char>
struct make_primitive<
    terminal_ex<tag::char_code<tag::char_, CharEncoding>,
                fusion::vector2<Char (&)[2], Char (&)[2]> // For single char
                                                          // strings
                >,
    Modifiers>
{
