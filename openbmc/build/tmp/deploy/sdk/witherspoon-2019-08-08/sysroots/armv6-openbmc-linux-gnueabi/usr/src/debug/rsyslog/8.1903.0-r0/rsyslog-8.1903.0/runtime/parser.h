...
struct parser_s
{
    ...
    sbool bDoSanitazion; /* do standard message sanitazion before calling
                            parser? */
...
ENDinterface(parser)
#define parserCURR_IF_VERSION                                                  \
    2 /* increment whenever you change the interface above! */
    /* version changes
...
/* prototypes */
PROTOTYPEObj(parser);
rsRetVal parserConstructViaModAndName(modInfo_t* pMod, uchar* const pName,
                                      void* parserInst);
