...
#define G_DELAYED_SETTINGS_BACKEND(inst)                                       \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_DELAYED_SETTINGS_BACKEND,       \
                                GDelayedSettingsBackend))
#define G_DELAYED_SETTINGS_BACKEND_CLASS(class)                                \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_DELAYED_SETTINGS_BACKEND,         \
                             GDelayedSettingsBackendClass))
#define G_IS_DELAYED_SETTINGS_BACKEND(inst)                                    \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_DELAYED_SETTINGS_BACKEND))
#define G_IS_DELAYED_SETTINGS_BACKEND_CLASS(class)                             \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_DELAYED_SETTINGS_BACKEND))
#define G_DELAYED_SETTINGS_BACKEND_GET_CLASS(inst)                             \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_DELAYED_SETTINGS_BACKEND,        \
                               GDelayedSettingsBackendClass))
