 ...
 * "Reasonable values of reps are between 15 and 50." c.f. gmp doc of
 * mpz_probab_prime_p() As of https://security.stackexchange.com/a/4546 we
 * should use 40 rounds */
...
typedef struct
{
    ...
    */
    ...
    /** ECC GF(p) point multiplication (from the NIST curves)
        ...
        @return CRYPT_OK on success
    */
    int (*ecc_ptmul)(void* k, ecc_point* G, ecc_point* R, void* modulus,
                     int map);
