...
#define BOOST_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(Self, Generator, gen)        \
    ...
    explicit Self(Generator& gen,                                              \
                  typename ::boost::random::detail::disable_constructor<       \
                      Self, Generator>::type* = 0)

#define BOOST_RANDOM_DETAIL_GENERATOR_SEED(Self, Generator, gen)               \
    template <class Generator>                                                 \
    void seed(                                                                 \
        Generator& gen,                                                        \
        typename ::boost::random::detail::disable_seed<Generator>::type* = 0)
...
#define BOOST_RANDOM_DETAIL_SEED_SEQ_SEED(Self, SeedSeq, seq)                  \
    ...
    void seed(SeedSeq& seq,                                                    \
              typename ::boost::random::detail::disable_seed<SeedSeq>::type* = \
                  0)
...
#define BOOST_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(Self, Generator, gen)        \
    ...
    explicit Self(Generator& gen)                                              \
    {                                                                          \
        boost_random_constructor_impl(gen,                                     \
                                      ::boost::is_arithmetic<Generator>());    \
    }                                                                          \
    template <class Generator>                                                 \
...
#define BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(Self, T, x)                 \
    explicit Self(const T& x)                                                  \
    {                                                                          \
        boost_random_constructor_impl(x, ::boost::mpl::true_());               \
    }                                                                          \
...
#define BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(Self, T, x)                        \
    void seed(const T& x)                                                      \
    {                                                                          \
        boost_random_seed_impl(x, ::boost::mpl::true_());                      \
    }                                                                          \
