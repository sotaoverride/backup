...
static inline BOOST_FUSION_GPU_ENABLED mpl::identity<U>
    value_at_impl(store<N, U> const volatile*);
} // namespace vector_detail
...
struct value_at_impl<vector_tag>
{
    ...
    struct apply
        : BOOST_FUSION_DECLTYPE_N3031((vector_detail::value_at_impl<N::value>(
