...
static FT_Error ft_lzw_file_init(FT_LZWFile zip, FT_Stream stream,
                                 FT_Stream source)
{
...
static FT_Error ft_lzw_file_skip_output(FT_LZWFile zip, FT_ULong count)
{
    FT_Error error = FT_Err_Ok;
...
static unsigned long ft_lzw_stream_io(FT_Stream stream, unsigned long offset,
