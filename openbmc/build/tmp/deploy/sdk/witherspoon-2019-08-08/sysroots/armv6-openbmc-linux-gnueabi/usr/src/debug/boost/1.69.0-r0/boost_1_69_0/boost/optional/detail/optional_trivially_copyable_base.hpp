...
class tc_optional_base : public optional_tag
{
  ...
  protected:
    ...
    tc_optional_base(none_t) : m_initialized(false)
    {
    }
  ...
  public:
    ...
    void reset(argument_type val) BOOST_NOEXCEPT
    {
        assign(val);
    }
  ...
  protected:
    ...
    template <class Arg>
    explicit tc_optional_base(in_place_init_t, Arg&& arg) : m_initialized(false)
    {
        construct(in_place_init, boost::forward<Arg>(arg));
    }
    ...
    explicit tc_optional_base(in_place_init_t) : m_initialized(false)
    {
        construct(in_place_init);
    }
    ...
    {
        boost_optional_detail::construct<value_type>(
            factory, boost::addressof(m_storage));
        m_initialized = true;
    }
