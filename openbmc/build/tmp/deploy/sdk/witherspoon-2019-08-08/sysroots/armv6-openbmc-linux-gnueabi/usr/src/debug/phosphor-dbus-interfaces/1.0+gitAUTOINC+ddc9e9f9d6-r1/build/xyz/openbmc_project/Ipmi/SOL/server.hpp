...
class SOL
{
  public:
    ...
    using PropertiesVariant = std::variant<bool, uint8_t>;
    ...
    virtual bool enable(bool value, bool skipSignal);
    /** Set value of Enable */
    ...
    virtual bool forceEncryption(bool value, bool skipSignal);
    ...
    virtual bool forceAuthentication(bool value, bool skipSignal);
    ...
    virtual uint8_t privilege(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t accumulateIntervalMS(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t threshold(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t retryCount(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t retryIntervalMS(uint8_t value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_Enable(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Enable' */
    static int _callback_set_Enable(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);

    /** @brief sd-bus callback for get-property 'ForceEncryption' */
    static int _callback_get_ForceEncryption(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'ForceEncryption' */
    static int _callback_set_ForceEncryption(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'ForceAuthentication' */
    static int _callback_get_ForceAuthentication(sd_bus*, const char*,
                                                 const char*, const char*,
                                                 sd_bus_message*, void*,
                                                 sd_bus_error*);
    /** @brief sd-bus callback for set-property 'ForceAuthentication' */
    static int _callback_set_ForceAuthentication(sd_bus*, const char*,
                                                 const char*, const char*,
                                                 sd_bus_message*, void*,
                                                 sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Privilege' */
    static int _callback_get_Privilege(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Privilege' */
    static int _callback_set_Privilege(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);

    /** @brief sd-bus callback for get-property 'AccumulateIntervalMS' */
    static int _callback_get_AccumulateIntervalMS(sd_bus*, const char*,
                                                  const char*, const char*,
                                                  sd_bus_message*, void*,
                                                  sd_bus_error*);
    /** @brief sd-bus callback for set-property 'AccumulateIntervalMS' */
    static int _callback_set_AccumulateIntervalMS(sd_bus*, const char*,
                                                  const char*, const char*,
                                                  sd_bus_message*, void*,
                                                  sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Threshold' */
    static int _callback_get_Threshold(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Threshold' */
    static int _callback_set_Threshold(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);

    /** @brief sd-bus callback for get-property 'RetryCount' */
    static int _callback_get_RetryCount(sd_bus*, const char*, const char*,
                                        const char*, sd_bus_message*, void*,
                                        sd_bus_error*);
    /** @brief sd-bus callback for set-property 'RetryCount' */
    static int _callback_set_RetryCount(sd_bus*, const char*, const char*,
                                        const char*, sd_bus_message*, void*,
                                        sd_bus_error*);

    /** @brief sd-bus callback for get-property 'RetryIntervalMS' */
    static int _callback_get_RetryIntervalMS(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'RetryIntervalMS' */
    static int _callback_set_RetryIntervalMS(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Ipmi_SOL_interface;
