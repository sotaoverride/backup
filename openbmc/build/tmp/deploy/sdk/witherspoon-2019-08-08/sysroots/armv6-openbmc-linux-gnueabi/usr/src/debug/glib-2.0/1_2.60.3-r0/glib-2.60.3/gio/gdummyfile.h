...
#define G_DUMMY_FILE(o)                                                        \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DUMMY_FILE, GDummyFile))
#define G_DUMMY_FILE_CLASS(k)                                                  \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_DUMMY_FILE, GDummyFileClass))
#define G_IS_DUMMY_FILE(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DUMMY_FILE))
#define G_IS_DUMMY_FILE_CLASS(k)                                               \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_DUMMY_FILE))
#define G_DUMMY_FILE_GET_CLASS(o)                                              \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DUMMY_FILE, GDummyFileClass))
