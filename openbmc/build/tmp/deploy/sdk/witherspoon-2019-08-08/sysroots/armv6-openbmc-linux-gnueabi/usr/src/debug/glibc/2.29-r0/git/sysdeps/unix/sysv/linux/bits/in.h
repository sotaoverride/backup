...
/* If the application has already included linux/in6.h from a linux-based
   ...
   coordination. In upstream kernel 56c176c9 the _UAPI prefix was stripped so we
   need to check for _LINUX_IN6_H and _IPV6_H now, and keep checking the old
   versions for maximum backwards compatibility.  */
#if defined _UAPI_LINUX_IN6_H || defined _UAPI_IPV6_H ||                       \
    defined _LINUX_IN6_H || defined _IPV6_H
...
#define MCAST_UNBLOCK_SOURCE 44 /* group_source_req: unblock from given        \
                                   group*/
