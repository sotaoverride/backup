...
extern struct mntent* __getmntent_r(FILE* __stream, struct mntent* __result,
...
libc_hidden_proto(__setmntent) libc_hidden_proto(__getmntent_r)
    libc_hidden_proto(__endmntent) libc_hidden_proto(__hasmntopt)
