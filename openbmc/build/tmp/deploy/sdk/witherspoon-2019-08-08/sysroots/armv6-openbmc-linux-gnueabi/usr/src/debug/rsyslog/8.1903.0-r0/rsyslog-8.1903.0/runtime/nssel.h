...
struct nssel_s
{
    ...
    uchar* pBaseDrvrName; /**< nsd base driver name to use, or NULL if system
                             default */
...
rsRetVal (*IsReady)(nssel_t* pThis, netstrm_t* pStrm, nsdsel_waitOp_t waitOp,
                    int* pbIsReady, int* piNumReady);
/* v2 - 2013-09-17 by rgerhards */
rsRetVal (*SetDrvrName)(nssel_t* pThis, uchar* name);
ENDinterface(nssel)
#define nsselCURR_IF_VERSION                                                   \
