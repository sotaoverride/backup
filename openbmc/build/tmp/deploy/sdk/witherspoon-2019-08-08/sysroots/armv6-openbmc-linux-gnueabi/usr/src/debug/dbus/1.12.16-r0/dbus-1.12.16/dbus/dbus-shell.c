...
static dbus_bool_t delimit_token(DBusString* token, DBusList** retval,
                                 DBusError* error)
{
    char* str;
...
static DBusList* tokenize_command_line(const char* command_line,
                                       DBusError* error)
{
    char current_quote;
    const char* p;
 ...
 **/
dbus_bool_t _dbus_shell_parse_argv(const char* command_line, int* argcp,
                                   char*** argvp, DBusError* error)
{
