...
static enum __codecvt_result do_in(struct _IO_codecvt* codecvt,
                                   __mbstate_t* statep, const char* from_start,
                                   const char* from_end, const char** from_stop,
                                    ...
                                    char* to_end, char** to_stop)
{
    ...
    status =
        DL_CALL_FCT(fct, (gs, codecvt->__cd_out.__cd.__data, &from_start_copy,
                          (const unsigned char*)from_end, NULL, &dummy, 0, 0));
                                        ...
                                        char* to_end, char** to_stop)
{
    ...
    status = DL_CALL_FCT(fct, (gs, codecvt->__cd_out.__cd.__data, NULL, NULL,
                               NULL, &dummy, 1, 0));
                                   ...
                                   wchar_t** to_stop)
{
    ...
    status =
        DL_CALL_FCT(fct, (gs, codecvt->__cd_in.__cd.__data, &from_start_copy,
                          (const unsigned char*)from_end, NULL, &dummy, 0, 0));
                     ...
                     const char* from_start, const char* from_end, size_t max)
{
    ...
    DL_CALL_FCT(fct, (gs, codecvt->__cd_in.__cd.__data, &cp,
                      (const unsigned char*)from_end, NULL, &dummy, 0, 0));
