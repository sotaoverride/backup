...
#if __STDC_VERSION__ >=                                                        \
        199901L /* ...as does GCC, since version 2.something.  */              \
...
krb5_error_code KRB5_CALLCONV krb5int_accessor(krb5int_access* internals,
                                               krb5_int32 version)
{
...
#define SC(FIELD, VAL) S(FIELD, 0)
#endif
                SC(asn1_ldap_encode_sequence_of_keys,
                   krb5int_ldap_encode_sequence_of_keys),
                SC(asn1_ldap_decode_sequence_of_keys,
...
#define SC(FIELD, VAL) S(FIELD, 0)
                ...
                SC(encode_krb5_pa_pk_as_req_draft9,
                ...
                SC(encode_krb5_reply_key_pack_draft9,
                ...
                SC(decode_krb5_pa_pk_as_req_draft9,
                ...
                SC(decode_krb5_reply_key_pack_draft9,
                   decode_krb5_reply_key_pack_draft9),
                SC(decode_krb5_td_trusted_certifiers,
