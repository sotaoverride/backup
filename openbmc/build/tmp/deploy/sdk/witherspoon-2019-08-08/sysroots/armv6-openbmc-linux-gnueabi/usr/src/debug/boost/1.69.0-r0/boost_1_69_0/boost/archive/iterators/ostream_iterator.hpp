...
class ostream_iterator
    : public boost::iterator_facade<ostream_iterator<Elem>, Elem,
                                    ...
                                    ostream_iterator<Elem>&>
{
  ...
  public:
    ...
    ostream_iterator(ostream_type& os) : m_ostream(&os)
    {
    }
    ostream_iterator() : m_ostream(NULL)
    {
    }
    ostream_iterator(const ostream_iterator& rhs) : m_ostream(rhs.m_ostream)
    {
    }
};
