...
#define RECORD_LAYER_reset_empty_record_count(rl) ((rl)->empty_record_count = 0)
...
#define SSL3_RECORD_is_sslv2_record(r) ((r)->rec_version == SSL2_VERSION)
...
int ssl3_cbc_copy_mac(unsigned char* out, const SSL3_RECORD* rec,
                      size_t md_size);
__owur int ssl3_cbc_remove_padding(SSL3_RECORD* rec, size_t block_size,
                                   size_t mac_size);
__owur int tls1_cbc_remove_padding(const SSL* s, SSL3_RECORD* rec,
