...
libc_hidden_proto(gnu_dev_major) libc_hidden_proto(gnu_dev_minor)
    libc_hidden_proto(gnu_dev_makedev)

#undef __SYSMACROS_DECL_TEMPL
#define __SYSMACROS_DECL_TEMPL(rtype, name, proto)                             \
    extern rtype __gnu_dev_##name proto __THROW __attribute_const__            \
        attribute_hidden;

#undef __SYSMACROS_IMPL_TEMPL
#define __SYSMACROS_IMPL_TEMPL(rtype, name, proto)                             \
    __extension__ __extern_inline __attribute_const__ rtype __NTH(             \
        __gnu_dev_##name proto)
