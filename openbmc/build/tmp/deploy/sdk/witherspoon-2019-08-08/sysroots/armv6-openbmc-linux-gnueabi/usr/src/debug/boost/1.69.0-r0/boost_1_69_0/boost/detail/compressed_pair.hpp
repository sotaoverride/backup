...
//
//  See http://www.boost.org/libs/utility for most recent version including
//  documentation.
...
// added partial specialisations for case T1 == T2 to avoid duplicate
// constructor defs.
...
struct compressed_pair_empty : ::boost::false_type
{
};

template <class T>
struct compressed_pair_empty<T, false> : ::boost::is_empty<T>
{
};
...
class compressed_pair_imp<T1, T2, 0>
{
  public:
    ...
    typedef
        typename call_traits<first_type>::const_reference first_const_reference;
...
template <class T1, class T2>
class compressed_pair_imp<T1, T2, 3> : protected ::boost::remove_cv<T1>::type,
...
//      instance of T2 just in case the user is relying on first() and second()
//      returning different objects (albeit both empty).
template <class T1, class T2>
...
template <class T1, class T2>
class compressed_pair
    : private ::boost::details::compressed_pair_imp<
          T1, T2,
...
{
  private:
    typedef details::compressed_pair_imp<
        T1, T2,
        ::boost::details::compressed_pair_switch<
            T1, T2,
            ::boost::is_same<typename remove_cv<T1>::type,
...
class compressed_pair<T, T>
    : private details::compressed_pair_imp<
          T, T,
          ::boost::details::compressed_pair_switch<
              T, T,
              ::boost::is_same<typename remove_cv<T>::type,
