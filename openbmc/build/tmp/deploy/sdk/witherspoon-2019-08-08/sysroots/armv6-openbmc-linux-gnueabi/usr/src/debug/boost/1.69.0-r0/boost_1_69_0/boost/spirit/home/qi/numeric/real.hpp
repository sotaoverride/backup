    ...
    : spirit::terminal<tag::stateful_tag<Policies, tag::double_, T>>
{
    ...
    real_parser(Policies const& p) : spirit::terminal<tag_type>(p)
    {
    }
};
} // namespace qi
...
struct use_lazy_terminal<
    qi::domain, tag::stateful_tag<Policies, tag::double_, T>, 1 // arity
    > : mpl::true_
{
};
} // namespace spirit
...
struct any_real_parser : primitive_parser<any_real_parser<T, RealPolicies>>
{
    ...
    bool parse(Iterator& first, Iterator const& last, Context& /*context*/,
               Skipper const& skipper, T& attr_) const
    {
...
struct make_primitive<terminal_ex<tag::stateful_tag<Policies, tag::double_, T>,
                                  fusion::vector1<A0>>,
...
template <typename Modifiers, typename A0>
struct make_primitive<terminal_ex<tag::long_double, fusion::vector1<A0>>,
                      Modifiers> : make_direct_real<long double>
{
};
} // namespace qi
} // namespace spirit
