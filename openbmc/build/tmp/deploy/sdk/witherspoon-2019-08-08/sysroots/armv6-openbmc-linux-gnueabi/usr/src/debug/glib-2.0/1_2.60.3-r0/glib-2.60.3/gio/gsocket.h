...
#define G_SOCKET(inst)                                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_SOCKET, GSocket))
#define G_SOCKET_CLASS(class)                                                  \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_SOCKET, GSocketClass))
#define G_IS_SOCKET(inst) (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_SOCKET))
#define G_IS_SOCKET_CLASS(class)                                               \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_SOCKET))
#define G_SOCKET_GET_CLASS(inst)                                               \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_SOCKET, GSocketClass))
