...
#define G_UNIX_VOLUME(o)                                                       \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_UNIX_VOLUME, GUnixVolume))
#define G_UNIX_VOLUME_CLASS(k)                                                 \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_UNIX_VOLUME, GUnixVolumeClass))
#define G_IS_UNIX_VOLUME(o)                                                    \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_UNIX_VOLUME))
#define G_IS_UNIX_VOLUME_CLASS(k)                                              \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_UNIX_VOLUME))
