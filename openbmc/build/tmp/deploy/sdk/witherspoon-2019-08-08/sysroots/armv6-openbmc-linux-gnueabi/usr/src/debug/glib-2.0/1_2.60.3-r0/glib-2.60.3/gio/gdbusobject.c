...
static void g_dbus_object_default_init(GDBusObjectIface* iface)
{
    /**
    ...
    g_signal_new(
        ...
        G_STRUCT_OFFSET(GDBusObjectIface, interface_added), NULL, NULL,
        g_cclosure_marshal_VOID__OBJECT, G_TYPE_NONE, 1, G_TYPE_DBUS_INTERFACE);
    ...
    g_signal_new(I_("interface-removed"), G_TYPE_FROM_INTERFACE(iface),
                 G_SIGNAL_RUN_LAST,
                 G_STRUCT_OFFSET(GDBusObjectIface, interface_removed), NULL,
 ...
 *
 * Returns: (element-type GDBusInterface) (transfer full): A list of
 * #GDBusInterface instances. The returned list must be freed by g_list_free()
