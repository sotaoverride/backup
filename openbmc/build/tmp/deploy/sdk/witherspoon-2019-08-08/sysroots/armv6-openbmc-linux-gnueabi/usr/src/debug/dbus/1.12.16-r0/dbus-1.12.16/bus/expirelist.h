...
typedef dbus_bool_t (*BusExpireFunc)(BusExpireList* list, DBusList* link,
                                     void* data);
...
/* this macro and function are semi-related utility functions, not really part
 * of the BusExpireList API
 */

#define ELAPSED_MILLISECONDS_SINCE(orig_tv_sec, orig_tv_usec, now_tv_sec,      \
                                   now_tv_usec)                                \
