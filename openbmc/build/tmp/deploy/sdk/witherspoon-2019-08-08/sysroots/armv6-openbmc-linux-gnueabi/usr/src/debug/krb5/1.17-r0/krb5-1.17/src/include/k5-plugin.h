...
{
    /* This points to a NULL-terminated list of pointers to plugin_file_handle
     * structs */
...
long KRB5_CALLCONV krb5int_open_plugin(const char*, struct plugin_file_handle**,
                                       struct errinfo*);
void KRB5_CALLCONV krb5int_close_plugin(struct plugin_file_handle*);

long KRB5_CALLCONV krb5int_get_plugin_data(struct plugin_file_handle*,
                                           const char*, void**,
                                           struct errinfo*);

long KRB5_CALLCONV krb5int_get_plugin_func(struct plugin_file_handle*,
                                           const char*, void (**)(),
                                           struct errinfo*);

long KRB5_CALLCONV krb5int_open_plugin_dirs(const char* const*,
                                            const char* const*,
                                            struct plugin_dir_handle*,
                                            struct errinfo*);
void KRB5_CALLCONV krb5int_close_plugin_dirs(struct plugin_dir_handle*);
