 ...
 */
#ifndef _WIN32
OM_uint32 KRB5_CALLCONV gss_pname_to_uid(OM_uint32* minor,
 ...
 */
OM_uint32 KRB5_CALLCONV gss_localname(OM_uint32* minor, const gss_name_t name,
 ...
 */
int KRB5_CALLCONV gss_userok(const gss_name_t name, const char* username);
 ...
 * @sa gss_userok
 */
OM_uint32 KRB5_CALLCONV gss_authorize_localname(OM_uint32* minor,
                                                const gss_name_t name,
...
OM_uint32 KRB5_CALLCONV gss_set_sec_context_option(
    OM_uint32* /*minor_status*/, gss_ctx_id_t* /*cred_handle*/,
 ...
 */
OM_uint32 KRB5_CALLCONV gss_export_cred(OM_uint32* /* minor_status */,
                                        gss_cred_id_t /* cred_handle */,
                                        gss_buffer_t /* token */);

OM_uint32 KRB5_CALLCONV gss_import_cred(OM_uint32* /* minor_status */,
                                        gss_buffer_t /* token */,
                                        gss_cred_id_t* /* cred_handle */);
 ...
 * Heimdal extension
 */
OM_uint32 KRB5_CALLCONV gss_set_cred_option(OM_uint32* /*minor_status*/,
                                            gss_cred_id_t* /*cred*/,
 ...
 */
OM_uint32 KRB5_CALLCONV gssspi_mech_invoke(OM_uint32* /*minor_status*/,
                                           const gss_OID /*desired_mech*/,
                                           const gss_OID /*desired_object*/,
                                           gss_buffer_t /*value*/);
...
OM_uint32 KRB5_CALLCONV gss_wrap_aead(
    ...
    gss_buffer_t /*input_assoc_buffer*/, gss_buffer_t /*input_payload_buffer*/,
    int* /*conf_state*/, gss_buffer_t /*output_message_buffer*/);

OM_uint32 KRB5_CALLCONV gss_unwrap_aead(OM_uint32* /*minor_status*/,
...
#define GSS_IOV_BUFFER_FLAG_ALLOCATE                                           \
    0x00010000 /* indicates GSS should allocate */
#define GSS_IOV_BUFFER_FLAG_ALLOCATED                                          \
    0x00020000 /* indicates caller should free */
 ...
 */
OM_uint32 KRB5_CALLCONV gss_wrap_iov(OM_uint32*,           /* minor_status */
                                     gss_ctx_id_t,         /* context_handle */
                                     int,                  /* conf_req_flag */
                                     gss_qop_t,            /* qop_req */
                                     int*,                 /* conf_state */
 ...
 * untouched.
 */
OM_uint32 KRB5_CALLCONV gss_unwrap_iov(OM_uint32*,   /* minor_status */
                                       gss_ctx_id_t, /* context_handle */
                                       int*,         /* conf_state */
                                       gss_qop_t*,   /* qop_state */
                                       gss_iov_buffer_desc*, /* iov */
 ...
 */
OM_uint32 KRB5_CALLCONV gss_wrap_iov_length(OM_uint32*,   /* minor_status */
                                            gss_ctx_id_t, /* context_handle */
                                            int,          /* conf_req_flag */
                                            gss_qop_t,    /* qop_req */
                                            int*,         /* conf_state */
 ...
 */
OM_uint32 KRB5_CALLCONV gss_get_mic_iov(OM_uint32*,   /* minor_status */
                                        gss_ctx_id_t, /* context_handle */
                                        gss_qop_t,    /* qop_req */
                                        gss_iov_buffer_desc*, /* iov */
                                        int);                 /* iov_count */
 ...
 */
OM_uint32 KRB5_CALLCONV
    gss_get_mic_iov_length(OM_uint32*,           /* minor_status */
                           gss_ctx_id_t,         /* context_handle */
                           gss_qop_t,            /* qop_req */
                           gss_iov_buffer_desc*, /* iov */
                           int);                 /* iov_count */
 ...
 * gss_verify_mic.
 */
OM_uint32 KRB5_CALLCONV gss_verify_mic_iov(OM_uint32*,   /* minor_status */
                                           gss_ctx_id_t, /* context_handle */
                                           gss_qop_t*,   /* qop_state */
                                           gss_iov_buffer_desc*, /* iov */
                                           int);                 /* iov_count */
 ...
 */
OM_uint32 KRB5_CALLCONV gss_release_iov_buffer(OM_uint32*, /* minor_status */
                                               gss_iov_buffer_desc*, /* iov */
                                               int); /* iov_count */
...
OM_uint32 KRB5_CALLCONV gss_display_name_ext(OM_uint32*, /* minor_status */
                                             gss_name_t, /* name */
                                             gss_OID, /* display_as_name_type */
                                             gss_buffer_t /* display_name */
);

OM_uint32 KRB5_CALLCONV gss_inquire_name(OM_uint32*,       /* minor_status */
                                         gss_name_t,       /* name */
                                         int*,             /* name_is_MN */
                                         gss_OID*,         /* MN_mech */
...
OM_uint32 KRB5_CALLCONV gss_get_name_attribute(OM_uint32*,   /* minor_status */
                                               gss_name_t,   /* name */
                                               gss_buffer_t, /* attr */
                                               int*,         /* authenticated */
                                               int*,         /* complete */
...
OM_uint32 KRB5_CALLCONV gss_set_name_attribute(OM_uint32*,   /* minor_status */
                                               gss_name_t,   /* name */
                                               int,          /* complete */
                                               gss_buffer_t, /* attr */
                                               gss_buffer_t  /* value */
...
OM_uint32 KRB5_CALLCONV gss_delete_name_attribute(OM_uint32*, /* minor_status */
                                                  gss_name_t, /* name */
                                                  gss_buffer_t /* attr */
);
...
OM_uint32 KRB5_CALLCONV gss_map_name_to_any(OM_uint32*,   /* minor_status */
                                            gss_name_t,   /* name */
                                            int,          /* authenticated */
...
OM_uint32
    KRB5_CALLCONV gss_encapsulate_token(gss_const_buffer_t, /* input_token */
                                        gss_const_OID,      /* token_oid */
                                        gss_buffer_t        /* output_token */
    );

OM_uint32
    KRB5_CALLCONV gss_decapsulate_token(gss_const_buffer_t, /* input_token */
                                        gss_const_OID,      /* token_oid */
                                        gss_buffer_t        /* output_token */
    );

int KRB5_CALLCONV gss_oid_equal(gss_const_OID, /* first_oid */
