...
class Create
{
  public:
     ...
     *  @param[in] fullPaths - A list of paths (file paths or d-bus object
     * paths) that must be processed to derive the dump content.
     */
    virtual void create(Type type, std::vector<std::string> fullPaths) = 0;
  ...
  private:
     ...
     */
    static int _callback_Create(sd_bus_message*, void*, sd_bus_error*);

    static constexpr auto _interface =
        "xyz.openbmc_project.Dump.Internal.Create";
    static const vtable::vtable_t _vtable[];
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Dump_Internal_Create_interface;
