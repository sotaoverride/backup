...
static void io_job_thread(GTask* task, gpointer source_object,
 ...
 **/
void g_io_scheduler_push_job(GIOSchedulerJobFunc job_func, gpointer user_data,
                             GDestroyNotify notify, gint io_priority,
                             GCancellable* cancellable)
{
    GIOSchedulerJob* job;
    GTask* task;
