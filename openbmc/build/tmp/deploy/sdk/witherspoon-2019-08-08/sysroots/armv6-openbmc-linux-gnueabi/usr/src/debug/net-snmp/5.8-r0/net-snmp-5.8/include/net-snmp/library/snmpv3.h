...
NETSNMP_IMPORT int snmpv3_parse_args(char* optarg, netsnmp_session* session,
...
NETSNMP_IMPORT int snmpv3_parse_arg(int arg, char* optarg,
                                    netsnmp_session* session, char** Apsz,
                                    char** Xpsz, int argc, char* const* argv,
                                    int flags);
NETSNMP_IMPORT int snmpv3_options(char* optarg, netsnmp_session* session,
                                  char** Apsz, char** Xpsz, int argc,
                                  char* const* argv);
