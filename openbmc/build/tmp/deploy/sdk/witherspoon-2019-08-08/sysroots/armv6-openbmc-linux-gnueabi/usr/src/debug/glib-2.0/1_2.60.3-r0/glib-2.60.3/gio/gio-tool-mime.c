...
static GAppInfo* get_app_info_for_id(const char* id)
{
    GList *list, *l;
    GAppInfo* ret_info;
...
int handle_mime(int argc, char* argv[], gboolean do_help)
{
    ...
    g_option_context_set_description(
        context,
        _("If no handler is given, lists registered and recommended "
          "applications\n"
    ...
    else
    {
        ...
        {
            print_error(
                _("Failed to set “%s” as the default handler for “%s”: %s\n"),
