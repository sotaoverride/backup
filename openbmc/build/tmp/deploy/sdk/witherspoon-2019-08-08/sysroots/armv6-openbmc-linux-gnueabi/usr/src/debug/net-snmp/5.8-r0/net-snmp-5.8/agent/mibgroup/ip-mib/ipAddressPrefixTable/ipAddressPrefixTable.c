...
const int ipAddressPrefixTable_oid_size = OID_LENGTH(ipAddressPrefixTable_oid);
...
{
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:init_ipAddressPrefixTable", "called\n"));
...
void initialize_table_ipAddressPrefixTable(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:initialize_table_ipAddressPrefixTable",
         "called\n"));
 ...
 */
int ipAddressPrefixTable_rowreq_ctx_init(
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx, void* user_init_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_rowreq_ctx_init",
         "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:210:o: |-> Perform extra ipAddressPrefixTable rowreq initialization.
     * (eg DEFVALS)
     */
 ...
 *
 */
void ipAddressPrefixTable_rowreq_ctx_cleanup(
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_rowreq_ctx_cleanup",
         "called\n"));
 ...
 */
int ipAddressPrefixTable_pre_request(
    ipAddressPrefixTable_registration* user_context)
{
    DEBUGMSGTL(("verbose:ipAddressPrefixTable:ipAddressPrefixTable_pre_request",
                "called\n"));
 ...
 */
int ipAddressPrefixTable_post_request(
    ipAddressPrefixTable_registration* user_context, int rc)
{
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_post_request",
         "called\n"));
 ...
 */
int ipAddressPrefixTable_indexes_set_tbl_idx(
    ipAddressPrefixTable_mib_index* tbl_idx, long ipAddressPrefixIfIndex_val,
    u_long ipAddressPrefixType_val, u_char* ipAddressPrefixPrefix_val_ptr,
    size_t ipAddressPrefixPrefix_val_ptr_len, u_long ipAddressPrefixLength_val)
{
    DEBUGMSGTL((
        "verbose:ipAddressPrefixTable:ipAddressPrefixTable_indexes_set_tbl_idx",
        "called\n"));
    ...
    tbl_idx->ipAddressPrefixPrefix_len =
        sizeof(tbl_idx->ipAddressPrefixPrefix) /
        sizeof(tbl_idx->ipAddressPrefixPrefix[0]); /* max length */
    /*
 ...
 *  from the mib index.
 */
int ipAddressPrefixTable_indexes_set(
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx,
    long ipAddressPrefixIfIndex_val, u_long ipAddressPrefixType_val,
    u_char* ipAddressPrefixPrefix_val_ptr,
    size_t ipAddressPrefixPrefix_val_ptr_len, u_long ipAddressPrefixLength_val)
{
    DEBUGMSGTL(("verbose:ipAddressPrefixTable:ipAddressPrefixTable_indexes_set",
                "called\n"));

    if (MFD_SUCCESS !=
        ipAddressPrefixTable_indexes_set_tbl_idx(
            &rowreq_ctx->tbl_idx, ipAddressPrefixIfIndex_val,
            ipAddressPrefixType_val, ipAddressPrefixPrefix_val_ptr,
 ...
 *   settable   0
 *
 * Enum range: 4/8. Values:  other(1), manual(2), wellknown(3), dhcp(4),
routeradv(5)
 *
                              ...
                              u_long* ipAddressPrefixOrigin_val_ptr)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixOrigin_get", "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:231:o: |-> Extract the current value of the ipAddressPrefixOrigin
     * data. copy (* ipAddressPrefixOrigin_val_ptr ) from rowreq_ctx->data
     */
                                  ...
                                  u_long* ipAddressPrefixOnLinkFlag_val_ptr)
{
    ...
    DEBUGMSGTL(("verbose:ipAddressPrefixTable:ipAddressPrefixOnLinkFlag_get",
                "called\n"));
     ...
     * ipAddressPrefixOnLinkFlag data. copy (* ipAddressPrefixOnLinkFlag_val_ptr
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressPrefixAutonomousFlag_get(
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx,
    u_long* ipAddressPrefixAutonomousFlag_val_ptr)
{
    /** we should have a non-NULL pointer */
    netsnmp_assert(NULL != ipAddressPrefixAutonomousFlag_val_ptr);

    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixAutonomousFlag_get",
         "called\n"));
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipAddressPrefixAutonomousFlag data. copy (*
     * ipAddressPrefixAutonomousFlag_val_ptr ) from rowreq_ctx->data
     */
    if (INETADDRESSTYPE_IPV4 == rowreq_ctx->tbl_idx.ipAddressPrefixType)
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressPrefixAdvPreferredLifetime_get(
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx,
    u_long* ipAddressPrefixAdvPreferredLifetime_val_ptr)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixAdvPreferredLifetime_get",
         "called\n"));
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipAddressPrefixAdvPreferredLifetime data. copy (*
     * ipAddressPrefixAdvPreferredLifetime_val_ptr ) from rowreq_ctx->data
     */
    if (INETADDRESSTYPE_IPV4 == rowreq_ctx->tbl_idx.ipAddressPrefixType)
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressPrefixAdvValidLifetime_get(
    ipAddressPrefixTable_rowreq_ctx* rowreq_ctx,
    u_long* ipAddressPrefixAdvValidLifetime_val_ptr)
{
    /** we should have a non-NULL pointer */
    netsnmp_assert(NULL != ipAddressPrefixAdvValidLifetime_val_ptr);

    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixAdvValidLifetime_get",
         "called\n"));
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipAddressPrefixAdvValidLifetime data. copy (*
     * ipAddressPrefixAdvValidLifetime_val_ptr ) from rowreq_ctx->data
     */
    if (INETADDRESSTYPE_IPV4 == rowreq_ctx->tbl_idx.ipAddressPrefixType)
