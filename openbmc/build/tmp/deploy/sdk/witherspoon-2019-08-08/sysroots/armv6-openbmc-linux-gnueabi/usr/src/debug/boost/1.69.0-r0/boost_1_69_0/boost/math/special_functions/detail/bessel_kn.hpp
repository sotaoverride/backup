...
// K_n(z) is the dominant solution, forward recurrence always OK (though
// unstable)
...
T bessel_kn(int n, T x, const Policy& pol)
{
    ...
    if (x < 0)
    {
        return policies::raise_domain_error<T>(
            function,
            "Got x = %1%, but argument x must be non-negative, complex number "
