...
#define NETSNMP_FD_SET_BYTES(setsize)                                          \
    (sizeof(fd_set) +                                                          \
     ((setsize) > FD_SETSIZE ? ((setsize)-FD_SETSIZE) * sizeof(SOCKET) : 0))
 ...
 * <a
 * href="http://www.opengroup.org/onlinepubs/007908775/xsh/systime.h.html">The
 * Single UNIX Specification, Version 2, &lt;sys/time.h&gt;</a>.
 */
