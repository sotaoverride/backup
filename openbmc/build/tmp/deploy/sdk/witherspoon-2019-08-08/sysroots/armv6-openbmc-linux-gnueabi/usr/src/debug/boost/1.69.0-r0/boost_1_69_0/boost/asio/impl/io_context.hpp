...
inline io_context::executor_type io_context::get_executor() BOOST_ASIO_NOEXCEPT
{
...
io_context::dispatch(BOOST_ASIO_MOVE_ARG(LegacyCompletionHandler) handler)
{
    ...
    BOOST_ASIO_LEGACY_COMPLETION_HANDLER_CHECK(LegacyCompletionHandler, handler)
    type_check;
    ...
    if (impl_.can_dispatch())
    {
        ...
        boost_asio_handler_invoke_helpers::invoke(init.completion_handler,
    ...
    else
    {
        ...
        BOOST_ASIO_HANDLER_CREATION(
            (*this, *p.p, "io_context", this, 0, "dispatch"));
...
io_context::post(BOOST_ASIO_MOVE_ARG(LegacyCompletionHandler) handler)
{
    ...
    bool is_continuation = boost_asio_handler_cont_helpers::is_continuation(
        init.completion_handler);
    ...
    BOOST_ASIO_HANDLER_CREATION((*this, *p.p, "io_context", this, 0, "post"));
...
void io_context::executor_type::dispatch(BOOST_ASIO_MOVE_ARG(Function) f,
                                         const Allocator& a) const
{
    ...
    BOOST_ASIO_HANDLER_CREATION(
        (this->context(), *p.p, "io_context", &this->context(), 0, "dispatch"));
...
template <typename Function, typename Allocator>
void io_context::executor_type::post(BOOST_ASIO_MOVE_ARG(Function) f,
                                     const Allocator& a) const
{
    typedef typename decay<Function>::type function_type;
...
template <typename Function, typename Allocator>
void io_context::executor_type::defer(BOOST_ASIO_MOVE_ARG(Function) f,
                                      const Allocator& a) const
{
    typedef typename decay<Function>::type function_type;
...
inline bool io_context::executor_type::running_in_this_thread() const
    BOOST_ASIO_NOEXCEPT
{
