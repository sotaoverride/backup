 ...
 */
static krb5_error_code krb5_checksum_esize(krb5_context, krb5_pointer, size_t*);
static krb5_error_code krb5_checksum_externalize(krb5_context, krb5_pointer,
                                                 krb5_octet**, size_t*);
static krb5_error_code krb5_checksum_internalize(krb5_context, krb5_pointer*,
                                                 krb5_octet**, size_t*);
 ...
 *                                the krb5_checksum.
 */
static krb5_error_code krb5_checksum_esize(krb5_context kcontext,
    ...
    if ((checksum = (krb5_checksum*)arg))
    {
        *sizep +=
            (sizeof(krb5_int32) + sizeof(krb5_int32) + sizeof(krb5_int32) +
             sizeof(krb5_int32) + (size_t)checksum->length);
        kret = 0;
    }
    return (kret);
}
 ...
 */
static krb5_error_code krb5_checksum_externalize(krb5_context kcontext,
                                                 krb5_pointer arg,
                                                 krb5_octet** buffer,
                                                 size_t* lenremain)
{
    ...
    if ((checksum = (krb5_checksum*)arg))
    {
            ...
            (required <= remain))
        {
            ...
            /* Our checksum_type */
            (void)krb5_ser_pack_int32((krb5_int32)checksum->checksum_type, &bp,
                                      &remain);

            /* Our length */
            (void)krb5_ser_pack_int32((krb5_int32)checksum->length, &bp,
                                      &remain);

            /* Our contents */
            (void)krb5_ser_pack_bytes(checksum->contents,
                                      (size_t)checksum->length, &bp, &remain);
 ...
 */
static krb5_error_code krb5_checksum_internalize(krb5_context kcontext,
                                                 krb5_pointer* argp,
                                                 krb5_octet** buffer,
                                                 size_t* lenremain)
{
    ...
    if (ibuf == KV5M_CHECKSUM)
    {
            ...
            (checksum = (krb5_checksum*)calloc(1, sizeof(krb5_checksum))))
        {
            ...
            /* Get the string */
            if (!ibuf ||
                ((checksum->contents = (krb5_octet*)malloc((size_t)(ibuf))) &&
 ...
 */
krb5_error_code krb5_ser_checksum_init(krb5_context kcontext)
{
