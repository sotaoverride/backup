...
extern int nfnlmsg_log_msg_parse(struct nlmsghdr*, struct nfnl_log_msg**);
...
extern void nfnl_log_msg_set_timestamp(struct nfnl_log_msg*, struct timeval*);
extern const struct timeval*
    nfnl_log_msg_get_timestamp(const struct nfnl_log_msg*);
