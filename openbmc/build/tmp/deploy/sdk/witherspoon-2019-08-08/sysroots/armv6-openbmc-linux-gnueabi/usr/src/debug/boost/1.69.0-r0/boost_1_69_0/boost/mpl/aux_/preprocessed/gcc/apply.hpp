...
{
    BOOST_MPL_AUX_LAMBDA_SUPPORT(2, apply1, (F, T1))
};
...
{
    BOOST_MPL_AUX_LAMBDA_SUPPORT(3, apply2, (F, T1, T2))
};
...
{
    BOOST_MPL_AUX_LAMBDA_SUPPORT(4, apply3, (F, T1, T2, T3))
};
...
{
    BOOST_MPL_AUX_LAMBDA_SUPPORT(5, apply4, (F, T1, T2, T3, T4))
};
...
{
    BOOST_MPL_AUX_LAMBDA_SUPPORT(6, apply5, (F, T1, T2, T3, T4, T5))
};
