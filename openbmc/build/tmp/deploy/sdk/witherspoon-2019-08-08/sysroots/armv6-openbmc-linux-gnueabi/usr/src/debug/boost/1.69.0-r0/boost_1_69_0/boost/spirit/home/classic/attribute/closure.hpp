...
///////////////////////////////////////////////////////////////////////////////
//
// ensure BOOST_SPIRIT_CLOSURE_LIMIT <= PHOENIX_LIMIT and SPIRIT_CLOSURE_LIMIT
// <= 15
//
///////////////////////////////////////////////////////////////////////////////
...
class closure_context : public parser_context_base
{
  public:
    typedef
        typename ::phoenix::tuple_element<0, typename ClosureT::tuple_t>::type
            attr_t;
    typedef ClosureT base_t;
    typedef closure_context_linker<closure_context<ClosureT>> context_linker_t;

    closure_context(ClosureT const& clos) : frame(clos)
    {
    }
...
#endif
          >
struct closure : public ::phoenix::closure<T0, T1, T2
#if BOOST_SPIRIT_CLOSURE_LIMIT > 3
                                           ,
                                           T3, T4, T5
#if BOOST_SPIRIT_CLOSURE_LIMIT > 6
                                           ...
                                           >
{
    typedef ::phoenix::closure<T0, T1, T2
#if BOOST_SPIRIT_CLOSURE_LIMIT > 3
                               ,
                               T3, T4, T5
#if BOOST_SPIRIT_CLOSURE_LIMIT > 6
    ...
    struct aux
    {
        ...
        template <typename A>
        init_closure_parser<
            DerivedT2, ::phoenix::tuple<typename ::phoenix::as_actor<A>::type>>
                       ...
                       E const& e, F const& f) const
        {
            ...
            typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t>
                actor_tuple_t;
        ...
        init_closure_parser<
            ...
            operator()(A const& a, B const& b, C const& c, D const& d,
                       E const& e, F const& f, G const& g) const
        {
            typedef typename ::phoenix::as_actor<A>::type a_t;
            typedef typename ::phoenix::as_actor<B>::type b_t;
            typedef typename ::phoenix::as_actor<C>::type c_t;
            ...
            typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t>
                actor_tuple_t;
        ...
        init_closure_parser<
            ...
            operator()(A const& a, B const& b, C const& c, D const& d,
                       E const& e, F const& f, G const& g, H const& h) const
        {
            typedef typename ::phoenix::as_actor<A>::type a_t;
            typedef typename ::phoenix::as_actor<B>::type b_t;
            typedef typename ::phoenix::as_actor<C>::type c_t;
            ...
            typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t>
                actor_tuple_t;
        ...
        init_closure_parser<
            ...
            operator()(A const& a, B const& b, C const& c, D const& d,
                       E const& e, F const& f, G const& g, H const& h,
                       I const& i, J const& j, K const& k) const
        {
            typedef typename ::phoenix::as_actor<A>::type a_t;
            typedef typename ::phoenix::as_actor<B>::type b_t;
            typedef typename ::phoenix::as_actor<C>::type c_t;
        ...
        init_closure_parser<
            ...
            operator()(A const& a, B const& b, C const& c, D const& d,
                       E const& e, F const& f, G const& g, H const& h,
                       I const& i, J const& j, K const& k, L const& l) const
        {
            typedef typename ::phoenix::as_actor<A>::type a_t;
            typedef typename ::phoenix::as_actor<B>::type b_t;
            typedef typename ::phoenix::as_actor<C>::type c_t;
...
struct container_begin
{
    ...
    {
        typedef
            typename ::phoenix::actor_result<ActorT,
                                             TupleT>::plain_type::iterator type;
    };

    container_begin(ActorT actor_) : actor(actor_)
    {
    }
...
struct container_end
{
    ...
    container_end(ActorT actor_) : actor(actor_)
    {
    }
...
inline f_chseq<::phoenix::actor<container_begin<::phoenix::actor<BaseT>>>,
...
template <typename BaseT>
inline f_strlit<::phoenix::actor<container_begin<::phoenix::actor<BaseT>>>,
                ::phoenix::actor<container_end<::phoenix::actor<BaseT>>>>
