...
ASN1_SEQUENCE_enc(X509_CINF, enc, 0) =
    {ASN1_EXP_OPT(X509_CINF, version, ASN1_INTEGER, 0),
     ...
     ASN1_EXP_SEQUENCE_OF_OPT(X509_CINF, extensions, X509_EXTENSION,
                              3)} ASN1_SEQUENCE_END_enc(X509_CINF, X509_CINF)
...
ASN1_SEQUENCE_ref(X509, x509_cb) =
    {ASN1_EMBED(X509, cert_info, X509_CINF),
     ...
     ASN1_EMBED(X509, signature, ASN1_BIT_STRING)} ASN1_SEQUENCE_END_ref(X509,
                                                                         X509)
