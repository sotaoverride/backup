...
#define G_SOCKET_LISTENER(inst)                                                \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_SOCKET_LISTENER,                \
                                GSocketListener))
#define G_SOCKET_LISTENER_CLASS(class)                                         \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_SOCKET_LISTENER,                  \
                             GSocketListenerClass))
#define G_IS_SOCKET_LISTENER(inst)                                             \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_SOCKET_LISTENER))
#define G_IS_SOCKET_LISTENER_CLASS(class)                                      \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_SOCKET_LISTENER))
#define G_SOCKET_LISTENER_GET_CLASS(inst)                                      \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_SOCKET_LISTENER,                 \
                               GSocketListenerClass))
