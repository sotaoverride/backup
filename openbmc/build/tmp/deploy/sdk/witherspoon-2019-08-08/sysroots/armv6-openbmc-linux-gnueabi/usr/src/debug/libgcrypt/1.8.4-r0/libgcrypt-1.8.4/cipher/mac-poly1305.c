...
static gcry_err_code_t poly1305mac_open(gcry_mac_hd_t h)
{
...
static gcry_err_code_t poly1305mac_prepare_key(gcry_mac_hd_t h,
...
static gcry_err_code_t poly1305mac_setiv(gcry_mac_hd_t h,
...
static gcry_err_code_t poly1305mac_reset(gcry_mac_hd_t h)
{
    struct poly1305mac_context_s* mac_ctx = h->u.poly1305mac.ctx;
...
static gcry_err_code_t poly1305mac_read(gcry_mac_hd_t h, unsigned char* outbuf,
                                        size_t* outlen)
{
    struct poly1305mac_context_s* mac_ctx = h->u.poly1305mac.ctx;
