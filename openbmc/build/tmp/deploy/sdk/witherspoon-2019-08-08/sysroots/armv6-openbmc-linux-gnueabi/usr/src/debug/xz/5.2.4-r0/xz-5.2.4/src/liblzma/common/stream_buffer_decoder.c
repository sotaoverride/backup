                              ...
                              uint8_t* out, size_t* out_pos, size_t out_size)
{
    ...
    if (in_pos == NULL || (in == NULL && *in_pos != in_size) ||
        *in_pos > in_size || out_pos == NULL ||
        (out == NULL && *out_pos != out_size) || *out_pos > out_size)
    ...
    lzma_ret ret =
        lzma_stream_decoder_init(&stream_decoder, allocator, *memlimit, flags);
    ...
    if (ret == LZMA_OK)
    {
        ...
        ret = stream_decoder.code(stream_decoder.coder, allocator, in, in_pos,
        ...
        else
        {
            ...
            *out_pos = out_start;
            ...
            else if (ret == LZMA_MEMLIMIT_ERROR)
            {
                ...
                // have been needed.
                uint64_t memusage;
                (void)stream_decoder.memconfig(stream_decoder.coder, memlimit,
                                               &memusage, 0);
            }
        }
    }
