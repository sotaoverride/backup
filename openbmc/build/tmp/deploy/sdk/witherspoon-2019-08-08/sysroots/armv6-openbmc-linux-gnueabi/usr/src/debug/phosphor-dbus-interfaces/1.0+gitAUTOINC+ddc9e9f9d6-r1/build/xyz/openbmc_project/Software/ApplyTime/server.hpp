...
class ApplyTime
{
  public:
    ...
    using PropertiesVariant = std::variant<RequestedApplyTimes>;
     ...
     */
    static RequestedApplyTimes
        convertRequestedApplyTimesFromString(const std::string& s);

  private:
    /** @brief sd-bus callback for get-property 'RequestedApplyTime' */
    static int _callback_get_RequestedApplyTime(sd_bus*, const char*,
                                                const char*, const char*,
                                                sd_bus_message*, void*,
                                                sd_bus_error*);
    /** @brief sd-bus callback for set-property 'RequestedApplyTime' */
    static int _callback_set_RequestedApplyTime(sd_bus*, const char*,
                                                const char*, const char*,
                                                sd_bus_message*, void*,
                                                sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Software_ApplyTime_interface;
