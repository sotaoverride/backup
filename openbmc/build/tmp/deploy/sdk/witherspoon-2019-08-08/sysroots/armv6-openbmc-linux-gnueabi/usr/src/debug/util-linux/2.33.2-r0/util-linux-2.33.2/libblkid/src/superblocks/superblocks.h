...
extern int blkid_probe_set_label(blkid_probe pr, const unsigned char* label,
                                 size_t len);
...
extern int blkid_probe_strncpy_uuid(blkid_probe pr, const unsigned char* str,
                                    size_t len);

extern int blkid_probe_set_uuid(blkid_probe pr, const unsigned char* uuid);
extern int blkid_probe_set_uuid_as(blkid_probe pr, const unsigned char* uuid,
                                   const char* name);
