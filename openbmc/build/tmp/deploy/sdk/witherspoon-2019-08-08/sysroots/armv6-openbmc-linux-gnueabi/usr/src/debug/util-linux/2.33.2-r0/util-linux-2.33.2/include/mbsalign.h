...
extern size_t mbsalign(const char* src, char* dest, size_t dest_size,
                       size_t* width, mbs_align_t align, int flags);

extern size_t mbsalign_with_padding(const char* src, char* dest,
                                    size_t dest_size, size_t* width,
                                    mbs_align_t align, int flags, int padchar);
...
extern char* mbs_invalid_encode_to_buffer(const char* s, size_t* width,
                                          char* buf);
