...
#define G_BYTES_ICON(inst)                                                     \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_BYTES_ICON, GBytesIcon))
#define G_IS_BYTES_ICON(inst)                                                  \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_BYTES_ICON))
