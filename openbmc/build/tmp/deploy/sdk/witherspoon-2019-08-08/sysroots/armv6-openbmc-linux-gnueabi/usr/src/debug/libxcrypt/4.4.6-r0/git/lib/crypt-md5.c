...
#define MD5_HASH_LENGTH (sizeof(md5_salt_prefix) + SALT_LEN_MAX + 1 + 22)
...
/* This entry point is equivalent to the `crypt' function in Unix
   libcs.  */
void crypt_md5crypt_rn(const char* phrase, size_t phr_size, const char* setting,
...
void gensalt_md5crypt_rn(unsigned long count, const uint8_t* rbytes,
                         size_t nrbytes, uint8_t* output, size_t output_size)
{
    ...
    gensalt_sha_rn('1', 8, 1000, 1000, 1000, 1000, rbytes, nrbytes, output,
                   output_size);
}
