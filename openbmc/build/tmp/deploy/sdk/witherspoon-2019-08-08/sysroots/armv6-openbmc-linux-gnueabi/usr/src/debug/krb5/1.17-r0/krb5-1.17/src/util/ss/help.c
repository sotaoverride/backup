...
void ss_help(argc, argv, sci_idx, info_ptr) int argc;
...
void ss_add_info_dir(sci_idx, info_dir, code_ptr) int sci_idx;
char* info_dir;
int* code_ptr;
{
    ss_data* info;
    ...
    dirs = (char**)realloc((char*)dirs, (unsigned)(n_dirs + 2) * sizeof(char*));
    if (dirs == (char**)NULL)
    {
...
void ss_delete_info_dir(sci_idx, info_dir, code_ptr) int sci_idx;
char* info_dir;
int* code_ptr;
{
    char** i_d;
