...
#define GUINT64_SWAP_LE_BE_CONSTANT(val)                                       \
    ((guint64)(                                                                \
        (((guint64)(val) & (guint64)G_GINT64_CONSTANT(0x00000000000000ffU))    \
         << 56) |                                                              \
        (((guint64)(val) & (guint64)G_GINT64_CONSTANT(0x000000000000ff00U))    \
         << 40) |                                                              \
        (((guint64)(val) & (guint64)G_GINT64_CONSTANT(0x0000000000ff0000U))    \
         << 24) |                                                              \
        (((guint64)(val) & (guint64)G_GINT64_CONSTANT(0x00000000ff000000U))    \
         << 8) |                                                               \
        (((guint64)(val) & (guint64)G_GINT64_CONSTANT(0x000000ff00000000U)) >> \
         8) |                                                                  \
        (((guint64)(val) & (guint64)G_GINT64_CONSTANT(0x0000ff0000000000U)) >> \
         24) |                                                                 \
        (((guint64)(val) & (guint64)G_GINT64_CONSTANT(0x00ff000000000000U)) >> \
         40) |                                                                 \
...
static inline gboolean _GLIB_CHECKED_ADD_U32(guint32* dest, guint32 a,
                                             guint32 b)
{
    return !__builtin_uadd_overflow(a, b, dest);
}
static inline gboolean _GLIB_CHECKED_MUL_U32(guint32* dest, guint32 a,
                                             guint32 b)
{
    return !__builtin_umul_overflow(a, b, dest);
}
static inline gboolean _GLIB_CHECKED_ADD_U64(guint64* dest, guint64 a,
                                             guint64 b)
{
    G_STATIC_ASSERT(sizeof(unsigned long long) == sizeof(guint64));
    return !__builtin_uaddll_overflow(a, b, (unsigned long long*)dest);
}
static inline gboolean _GLIB_CHECKED_MUL_U64(guint64* dest, guint64 a,
                                             guint64 b)
{
