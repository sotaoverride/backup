    ...
    void init_mteTriggerDeltaTable(void)
{
    ...
    reg = netsnmp_create_handler_registration(
        "mteTriggerDeltaTable", mteTriggerDeltaTable_handler,
        mteTDeltaTable_oid, mteTDeltaTable_oid_len, HANDLER_CAN_RWRITE);
#else  /* !NETSNMP_NO_WRITE_SUPPORT */
    reg = netsnmp_create_handler_registration(
        "mteTriggerDeltaTable", mteTriggerDeltaTable_handler,
        mteTDeltaTable_oid, mteTDeltaTable_oid_len, HANDLER_CAN_RONLY);
#endif /* !NETSNMP_NO_WRITE_SUPPORT */
...
int mteTriggerDeltaTable_handler(netsnmp_mib_handler* handler,
                                 ...
                                 netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("disman:event:mib", "Delta Table handler (%d)\n", reqinfo->mode));
