...
#define PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP                                 \
    {                                                                          \
        {                                                                      \
            0, 0, 0, 0, PTHREAD_MUTEX_RECURSIVE_NP, __PTHREAD_SPINS,           \
            {                                                                  \
                0, 0                                                           \
            }                                                                  \
        }                                                                      \
...
#define PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP                                \
    {                                                                          \
        {                                                                      \
            0, 0, 0, 0, PTHREAD_MUTEX_ERRORCHECK_NP, __PTHREAD_SPINS,          \
            {                                                                  \
                0, 0                                                           \
            }                                                                  \
        }                                                                      \
...
#define PTHREAD_ADAPTIVE_MUTEX_INITIALIZER_NP                                  \
    {                                                                          \
        {                                                                      \
            0, 0, 0, 0, PTHREAD_MUTEX_ADAPTIVE_NP, __PTHREAD_SPINS,            \
            {                                                                  \
                0, 0                                                           \
            }                                                                  \
        }                                                                      \
...
#define PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP                                \
    {                                                                          \
        {                                                                      \
            0, 0, 0, PTHREAD_MUTEX_ERRORCHECK_NP, 0,                           \
            {                                                                  \
                __PTHREAD_SPINS                                                \
            }                                                                  \
        }                                                                      \
...
#define PTHREAD_ADAPTIVE_MUTEX_INITIALIZER_NP                                  \
    {                                                                          \
        {                                                                      \
            0, 0, 0, PTHREAD_MUTEX_ADAPTIVE_NP, 0,                             \
            {                                                                  \
                __PTHREAD_SPINS                                                \
            }                                                                  \
        }                                                                      \
...
struct _pthread_cleanup_buffer
{
    ...
    struct _pthread_cleanup_buffer*
        __prev; /* Chaining of cleanup functions.  */
};
...
extern int pthread_attr_setguardsize(pthread_attr_t* __attr,
                                     size_t __guardsize) __THROW __nonnull((1));
...
/* Optimizations.  */
__extern_inline int __NTH(pthread_equal(pthread_t __thread1,
                                        pthread_t __thread2))
{
