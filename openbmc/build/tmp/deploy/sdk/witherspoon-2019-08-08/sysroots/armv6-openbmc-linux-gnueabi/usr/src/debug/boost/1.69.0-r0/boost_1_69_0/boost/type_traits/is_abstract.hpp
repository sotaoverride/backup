...
//              and John Maddock.
//  - Dec 2004: Added new config macro BOOST_NO_IS_ABSTRACT which causes the
//  template
//              to degrade gracefully, rather than trash the compiler (John
//              Maddock).
//
...
struct is_abstract_imp2
{
    ...
    BOOST_STATIC_CONSTANT(
        std::size_t,
        s1 = sizeof(is_abstract_imp2<T>::template check_sig<T>(0)));
#else
...
template <class T>
struct is_abstract
    : public integral_constant<bool, ::boost::detail::is_abstract_imp<T>::value>
{
};
#else
template <class T>
struct is_abstract
    : public integral_constant<bool,
                               ::boost::detail::is_polymorphic_imp<T>::value>
{
};
#endif
