...
//! Fake mutex that doesn't do anything. Note: we're not using \c null_mutex
//! from Boost.Thread in order not to introduce false dependencies on
//! Boost.Thread and Boost.Chrono.
class fake_mutex
{
  public:
