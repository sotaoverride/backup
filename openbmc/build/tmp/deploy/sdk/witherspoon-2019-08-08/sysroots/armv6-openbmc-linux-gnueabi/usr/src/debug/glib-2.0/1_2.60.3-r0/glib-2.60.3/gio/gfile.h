...
#define G_FILE_GET_IFACE(obj)                                                  \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_FILE, GFileIface))
 ...
 * @resolve_relative_path: Resolves a relative path for a #GFile to an absolute
 *path.
 ...
 * @enumerate_children_async: Asynchronously gets a #GFileEnumerator with the
 *children of a #GFile.
 ...
 * @query_filesystem_info_async: Asynchronously gets a #GFileInfo for the file
 *system #GFile is on.
 * @query_filesystem_info_finish: Finishes asynchronously getting the file
 *system info.
 ...
 * @set_display_name_finish: Finishes asynchronously setting a #GFile's display
 *name.
 * @query_settable_attributes: Returns a list of #GFileAttributes that can be
 *set.
 * @_query_settable_attributes_async: Asynchronously gets a list of
 *#GFileAttributes that can be set.
 * @_query_settable_attributes_finish: Finishes asynchronously querying settable
 *attributes.
 * @query_writable_namespaces: Returns a list of #GFileAttribute namespaces that
 *are writable.
 * @_query_writable_namespaces_async: Asynchronously gets a list of
 *#GFileAttribute namespaces that are writable.
 * @_query_writable_namespaces_finish: Finishes asynchronously querying the
 *writable namespaces.
 * @set_attribute: Sets a #GFileAttribute.
 * @set_attributes_from_info: Sets a #GFileAttribute with information from a
 *#GFileInfo.
 ...
 * @create_readwrite_finish: Finishes an asynchronous creates read/write.
 *Since 2.22.
 * @replace_readwrite: Replaces file read/write. Since 2.22.
 * @replace_readwrite_async: Asynchronously replaces file read/write.
 *Since 2.22.
 * @replace_readwrite_finish: Finishes an asynchronous replace read/write.
 *Since 2.22.
 ...
 * @supports_thread_contexts: a boolean that indicates whether the #GFile
 *implementation supports thread-default contexts. Since 2.22.
 * @unmount_mountable_with_operation: Unmounts a mountable object using a
 *#GMountOperation. Since 2.22.
 * @unmount_mountable_with_operation_finish: Finishes an unmount operation using
 *a #GMountOperation. Since 2.22.
 * @eject_mountable_with_operation: Ejects a mountable object using a
 *#GMountOperation. Since 2.22.
 * @eject_mountable_with_operation_finish: Finishes an eject operation using a
 *#GMountOperation. Since 2.22.
 * @poll_mountable: Polls a mountable object for media changes. Since 2.22.
 * @poll_mountable_finish: Finishes an poll operation for media changes.
 *Since 2.22.
 * @measure_disk_usage: Recursively measures the disk usage of @file. Since 2.38
 * @measure_disk_usage_async: Asynchronously recursively measures the disk usage
 *of @file. Since 2.38
 * @measure_disk_usage_finish: Finishes an asynchronous recursive measurement of
 *the disk usage of @file. Since 2.38
 *
...
struct _GFileIface
{
    ...
    GFile* (*set_display_name)(GFile* file, const char* display_name,
                               GCancellable* cancellable, GError** error);
    void (*set_display_name_async)(GFile* file, const char* display_name,
    ...
    gboolean (*delete_file)(GFile* file, GCancellable* cancellable,
                            GError** error);
    void (*delete_file_async)(GFile* file, int io_priority,
                              GCancellable* cancellable,
                              GAsyncReadyCallback callback, gpointer user_data);
    gboolean (*delete_file_finish)(GFile* file, GAsyncResult* result,
                                   GError** error);

    gboolean (*trash)(GFile* file, GCancellable* cancellable, GError** error);
    void (*trash_async)(GFile* file, int io_priority, GCancellable* cancellable,
                        GAsyncReadyCallback callback, gpointer user_data);
    ...
    gboolean (*make_directory)(GFile* file, GCancellable* cancellable,
                               GError** error);
    void (*make_directory_async)(GFile* file, int io_priority,
                                 GCancellable* cancellable,
                                 GAsyncReadyCallback callback,
                                 gpointer user_data);
    ...
    gboolean (*measure_disk_usage)(
        ...
        guint64* disk_usage, guint64* num_dirs, guint64* num_files,
        GError** error);
...
GFileEnumerator* g_file_enumerate_children_finish(GFile* file,
                                                  ...
                                                  GError** error);
GLIB_AVAILABLE_IN_ALL
GFile* g_file_set_display_name(GFile* file, const char* display_name,
                               GCancellable* cancellable, GError** error);
GLIB_AVAILABLE_IN_ALL
void g_file_set_display_name_async(GFile* file, const char* display_name,
                                   int io_priority, GCancellable* cancellable,
                                   GAsyncReadyCallback callback,
                                   gpointer user_data);
GLIB_AVAILABLE_IN_ALL
...
GLIB_AVAILABLE_IN_2_34
gboolean g_file_delete_finish(GFile* file, GAsyncResult* result,
                              GError** error);
...
GFileAttributeInfoList*
    g_file_query_writable_namespaces(GFile* file, GCancellable* cancellable,
                                     GError** error);
GLIB_AVAILABLE_IN_ALL
gboolean g_file_set_attribute(GFile* file, const char* attribute,
                              GFileAttributeType type, gpointer value_p,
                              GFileQueryInfoFlags flags,
                              GCancellable* cancellable, GError** error);
GLIB_AVAILABLE_IN_ALL
...
gboolean g_file_set_attribute_string(GFile* file, const char* attribute,
                                     ...
                                     GCancellable* cancellable, GError** error);
GLIB_AVAILABLE_IN_ALL
gboolean g_file_set_attribute_byte_string(GFile* file, const char* attribute,
                                          const char* value,
                                          GFileQueryInfoFlags flags,
                                          GCancellable* cancellable,
                                          GError** error);
GLIB_AVAILABLE_IN_ALL
gboolean g_file_set_attribute_uint32(GFile* file, const char* attribute,
                                     guint32 value, GFileQueryInfoFlags flags,
                                     GCancellable* cancellable, GError** error);
GLIB_AVAILABLE_IN_ALL
gboolean g_file_set_attribute_int32(GFile* file, const char* attribute,
                                    gint32 value, GFileQueryInfoFlags flags,
                                    GCancellable* cancellable, GError** error);
GLIB_AVAILABLE_IN_ALL
gboolean g_file_set_attribute_uint64(GFile* file, const char* attribute,
                                     guint64 value, GFileQueryInfoFlags flags,
                                     GCancellable* cancellable, GError** error);
GLIB_AVAILABLE_IN_ALL
gboolean g_file_set_attribute_int64(GFile* file, const char* attribute,
