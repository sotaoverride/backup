    ...
    : public ebo_functor_holder<F>
{
    ...
    typedef
        typename if_c<IsConst, const_reference, reference>::type reference_type;

    node_cloner(F f, const ValueTraits* traits) : base_t(f), traits_(traits)
    {
    }
    ...
    : public ebo_functor_holder<F>
{
    ...
    node_disposer(F f, const ValueTraits* cont) : base_t(f), traits_(cont)
    {
    }
