...
struct meta_grammar : proto::switch_<meta_grammar>
{
...
struct evaluator
{
    ...
    {
        typedef meta_grammar::impl<Expr, typename result_of::env<State>::type,
...
struct default_actions
{
    ...
    struct when : proto::_default<meta_grammar>
    {
    };
};

template <typename Rule, typename Dummy = void>
struct enable_rule : proto::when<Rule, proto::external_transform>
{
};
...
struct eval : boost::result_of<::boost::phoenix::evaluator(Expr, Context)>
{
};
} // namespace result_of
...
template <typename Expr, typename Context>
inline typename meta_grammar::template impl<
    Expr const&, typename result_of::env<Context const&>::type,
    typename result_of::actions<Context const&>::type>::result_type
...
template <typename Expr, typename Context>
inline typename meta_grammar::template impl<
    Expr&, typename result_of::env<Context const&>::type,
    typename result_of::actions<Context const&>::type>::result_type
