...
netsnmp_feature_child_of(ifTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_child_of(iftable_container_get, ifTable_external_access)
            netsnmp_feature_child_of(ifxtable_shutdown_interface,
                                     netsnmp_unused)
                netsnmp_feature_child_of(ifXTable_container_size,
                                         ifXTable_external_access)
                    netsnmp_feature_child_of(ifXTable_registration_set,
                                             ifXTable_external_access)
                        netsnmp_feature_child_of(ifXTable_registration_get,
                                                 ifXTable_external_access)
                            netsnmp_feature_child_of(ifXTable_container_get,
                                                     ifXTable_external_access)
                                netsnmp_feature_child_of(
                                    iftable_container_size,
                                    ifTable_external_access)
                                    netsnmp_feature_child_of(
...
{
    DEBUGMSGTL(("ifTable:ifTable_dirty_set", "called. was %d, now %d\n",
...
{
    DEBUGMSGTL(("ifTable:ifTable_lastChanged_set", "called. was %ld, now %ld\n",
...
NETSNMP_STATIC_INLINE int _ifTable_undo_column(ifTable_rowreq_ctx* rowreq_ctx,
...
void _ifTable_initialize_interface(ifTable_registration* reg_ptr, u_long flags)
{
    ...
    reginfo = netsnmp_handler_registration_create("ifTable", handler,
     ...
     */
    {
        ...
        netsnmp_register_watched_scalar2(
            netsnmp_create_handler_registration(
                "ifTableLastChanged", NULL, iftlc_oid, OID_LENGTH(iftlc_oid),
                HANDLER_CAN_RONLY),
            netsnmp_create_watcher_info((void*)&ifTable_if_ctx.last_changed,
 ...
 */
NETSNMP_STATIC_INLINE int _ifTable_check_column(ifTable_rowreq_ctx* rowreq_ctx,
                                                netsnmp_variable_list* var,
                                                int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    DEBUGMSGTL(
        ("internal:ifTable:_ifTable_check_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IFADMINSTATUS:
            ...
            {
                DEBUGMSGTL(
                    ("ifTable:_ifTable_check_column:ifAdminStatus",
...
int _mfd_ifTable_check_objects(netsnmp_mib_handler* handler,
                               netsnmp_handler_registration* reginfo,
                               netsnmp_agent_request_info* agtreq_info,
                               netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ifTable:_mfd_ifTable_check_objects", "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc =
            _ifTable_check_column(rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error(requests, SNMP_VALIDATE_ERR(rc));
            break;
 ...
 */
static int _mfd_ifTable_check_dependencies(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    ifTable_rowreq_ctx* rowreq_ctx =
        (ifTable_rowreq_ctx*)netsnmp_container_table_row_extract(requests);
    DEBUGMSGTL(
        ("internal:ifTable:_mfd_ifTable_check_dependencies", "called\n"));
...
int _mfd_ifTable_undo_setup_allocate(ifTable_rowreq_ctx* rowreq_ctx)
{
    ...
    if (NULL == rowreq_ctx->undo)
    {
        ...
        {
            rowreq_ctx->undo->ifentry = netsnmp_access_interface_entry_create(
                rowreq_ctx->data.ifentry->name,
 ...
 * undo setup
 */
int _mfd_ifTable_undo_setup(netsnmp_mib_handler* handler,
                            netsnmp_handler_registration* reginfo,
                            netsnmp_agent_request_info* agtreq_info,
                            netsnmp_request_info* requests)
{
 ...
 * undo setup
 */
int _mfd_ifTable_undo_cleanup(netsnmp_mib_handler* handler,
                              netsnmp_handler_registration* reginfo,
                              netsnmp_agent_request_info* agtreq_info,
                              netsnmp_request_info* requests)
{
 ...
 * Set the value for a particular column
 */
NETSNMP_STATIC_INLINE int _ifTable_set_column(ifTable_rowreq_ctx* rowreq_ctx,
                                              netsnmp_variable_list* var,
                                              int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    DEBUGMSGTL(
        ("internal:ifTable:_ifTable_set_column", "called for %d\n", column));
...
int _mfd_ifTable_set_values(netsnmp_mib_handler* handler,
                            netsnmp_handler_registration* reginfo,
                            netsnmp_agent_request_info* agtreq_info,
                            netsnmp_request_info* requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ifTable_set_column(rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL(("ifTable:mfd",
                        "error %d from "
 ...
 * commit the values
 */
int _mfd_ifTable_commit(netsnmp_mib_handler* handler,
                        netsnmp_handler_registration* reginfo,
                        netsnmp_agent_request_info* agtreq_info,
                        netsnmp_request_info* requests)
{
...
int _mfd_ifTable_undo_commit(netsnmp_mib_handler* handler,
                             netsnmp_handler_registration* reginfo,
                             netsnmp_agent_request_info* agtreq_info,
                             netsnmp_request_info* requests)
{
                                               ...
                                               int column)
{
    ...
    DEBUGMSGTL(
        ("internal:ifTable:_ifTable_undo_column", "called for %d\n", column));
...
int _mfd_ifTable_undo_values(netsnmp_mib_handler* handler,
                             netsnmp_handler_registration* reginfo,
                             netsnmp_agent_request_info* agtreq_info,
                             netsnmp_request_info* requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ifTable_undo_column(rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
 ...
 */
int _mfd_ifTable_irreversible_commit(netsnmp_mib_handler* handler,
                                     netsnmp_handler_registration* reginfo,
                                     netsnmp_agent_request_info* agtreq_info,
                                     netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ifTable:_mfd_ifTable_irreversible:commit", "called\n"));
 ...
 * @internal
 */
static void _container_item_free(ifTable_rowreq_ctx* rowreq_ctx, void* context)
{
...
void _ifTable_container_init(ifTable_interface_ctx* if_ctx)
{
    ...
    if_ctx->cache = netsnmp_cache_create(30, /* timeout in seconds */
                                         _cache_load, _cache_free, ifTable_oid,
                                         ifTable_oid_size);
...
ifTable_rowreq_ctx* ifTable_row_find_by_mib_index(ifTable_mib_index* mib_idx)
{
    ...
    rowreq_ctx =
        (ifTable_rowreq_ctx*)CONTAINER_FIND(ifTable_if_ctx.container, &oid_idx);
