...
static krb5_error_code principal2salt_internal(krb5_context,
 ...
 */
static krb5_error_code principal2salt_internal(krb5_context context,
...
krb5_error_code krb5_principal2salt(krb5_context context,
                                    krb5_const_principal pr, krb5_data* ret)
{
    return principal2salt_internal(context, pr, ret, 1);
}

krb5_error_code krb5_principal2salt_norealm(krb5_context context,
                                            krb5_const_principal pr,
                                            krb5_data* ret)
{
