...
struct is_related
    : public ::boost::is_same<typename ::boost::detail::remove_cv_ref<T>::type,
...
class base_from_member
{
  protected:
    ...
    template <typename... T,
              typename EnableIf = typename ::boost::detail::enable_if_unrelated<
                  base_from_member, T...>::type>
...
class base_from_member<MemberType&, UniqueID>
{
  protected:
    ...
    explicit BOOST_CONSTEXPR base_from_member(MemberType& x) BOOST_NOEXCEPT
        : member(x)
    {
    }
