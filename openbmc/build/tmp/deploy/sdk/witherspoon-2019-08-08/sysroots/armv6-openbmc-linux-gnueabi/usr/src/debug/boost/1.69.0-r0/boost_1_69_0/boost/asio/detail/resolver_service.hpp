  ...
  public:
                         ...
                         boost::system::error_code& ec)
    {
        ...
        socket_ops::getaddrinfo(query.host_name().c_str(),
                                query.service_name().c_str(), query.hints(),
                                &address_info, ec);
        auto_addrinfo auto_address_info(address_info);

        return ec ? results_type()
                  : results_type::create(address_info, query.host_name(),
                                         query.service_name());
    }
                       ...
                       Handler& handler)
    {
        ...
        BOOST_ASIO_HANDLER_CREATION((io_context_impl_.context(), *p.p,
                                     "resolver", &impl, 0, "async_resolve"));
                         ...
                         boost::system::error_code& ec)
    {
        ...
        socket_ops::sync_getnameinfo(
            endpoint.data(), endpoint.size(), host_name, NI_MAXHOST,
