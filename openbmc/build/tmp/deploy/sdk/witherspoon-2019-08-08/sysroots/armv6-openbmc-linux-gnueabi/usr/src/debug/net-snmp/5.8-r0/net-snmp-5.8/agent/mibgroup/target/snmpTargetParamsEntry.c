...
#define snmpTargetParamsOIDLen                                                 \
    11 /*This is base+column,                                                  \
        * i.e. everything but index */

oid snmpTargetParamsOID[snmpTargetParamsOIDLen] = {1,  3, 6, 1, 6, 3,
                                                   12, 1, 3, 1, 0};
 ...
 */
int snmpTargetParams_rowStatusCheck(struct targetParamTable_struct* entry)
{
...
int snmpTargetParams_addParamName(struct targetParamTable_struct* entry,
                                  char* cptr)
{
    size_t len;
    if (cptr == NULL)
    ...
    else
    {
        ...
        if (len < 1 || len > 32)
        {
            DEBUGMSGTL(("snmpTargetParamsEntry",
                        "ERROR snmpTargetParamsEntry: param name out of range "
                        "in config string\n"));
            return (0);
        }
...
int snmpTargetParams_addMPModel(struct targetParamTable_struct* entry,
                                char* cptr)
{
    if (cptr == NULL)
    {
    ...
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargeParamsEntry: mp model is "
                                      "not digit in config string\n"));
        return (0);
    }
    /*
    ...
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargeParamsEntry: mp model "
...
int snmpTargetParams_addSecModel(struct targetParamTable_struct* entry,
                                 char* cptr)
{
    if (cptr == NULL)
    {
    ...
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargeParamsEntry: security "
                                      "model is not digit in config string\n"));
        return (0);
    }
    /*
    ...
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargetParamsEntry: security "
                                      "model out of range in config string\n"));
        return (0);
    }
    return (1);
} /*  snmpTargetParams_addSecModel  */

int snmpTargetParams_addSecName(struct targetParamTable_struct* entry,
                                char* cptr)
{
    if (cptr == NULL)
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargetParamsEntry: no "
                                      "security name in config string\n"));
        return (0);
    }
    else
    {
...
int snmpTargetParams_addSecLevel(struct targetParamTable_struct* entry,
                                 char* cptr)
{
    if (cptr == NULL)
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargetParamsEntry: no "
                                      "security level in config string\n"));
        return (0);
    }
    else if (!(isdigit((unsigned char)(*cptr))))
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargeParamsEntry: security "
                                      "level is not digit in config string\n"));
        return (0);
    }
    /*
    ...
    {
        DEBUGMSGTL(("snmpTargetParamsEntry",
                    "ERROR snmpTargeParamsEntry: security level is not greater "
                    "than 0 in config string\n"));
        return (0);
    }
    return (1);
} /*  snmpTargetParams_addSecLevel  */

int snmpTargetParams_addStorageType(struct targetParamTable_struct* entry,
                                    char* cptr)
{
    if (cptr == NULL)
    {
    ...
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargeParamsEntry: storage "
                                      "type is not digit in config string\n"));
        return (0);
    }
    /*
...
int snmpTargetParams_addRowStatus(struct targetParamTable_struct* entry,
                                  char* cptr)
{
    if (cptr == NULL)
    {
    ...
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargeParamsEntry: row status "
                                      "is not digit in config string\n"));
        return (0);
    }
    /*
    ...
    {
        DEBUGMSGTL(
            ("snmpTargetParamsEntry", "ERROR snmpTargetParamsEntry: Row Status "
 ...
 */
void update_timestamp(struct targetParamTable_struct* temp_struct)
{
    temp_struct->updateTime = time(NULL);
}

void snmpd_parse_config_targetParams(const char* token, char* char_ptr)
{
...
u_char* var_snmpTargetParamsEntry(struct variable* vp, oid* name,
                                  ...
                                  WriteMethod** write_method)
{
    ...
    *var_len = sizeof(long_ret);
     ...
     */
    if ((temp_struct = search_snmpTargetParamsTable(vp->name, vp->namelen, name,
                                                    length, exact)) == NULL)
    {
        return NULL;
    }
 ...
 */
int write_snmpTargetParamsMPModel(int action, u_char* var_val,
                                  ...
                                  u_char* statP, oid* name, size_t name_len)
{
    ...
    else if (action == RESERVE2)
    {
        snmpTargetParamsOID[snmpTargetParamsOIDLen - 1] =
            SNMPTARGETPARAMSMPMODELCOLUMN;
        params = search_snmpTargetParamsTable(
            snmpTargetParamsOID, snmpTargetParamsOIDLen, name, &name_len, 1);
        if (params == NULL)
        {
            DEBUGMSGTL(("snmpTargetParamsEntry",
        ...
        else
        {
            ...
            {
                DEBUGMSGTL(("snmpTargetParamsEntry",
                            "write to snmpTargetParamsMPModel: this change not "
                            "allowed in active row.\n"));
                return SNMP_ERR_INCONSISTENTVALUE;
            }
 ...
 */
int write_snmpTargetParamsSecModel(int action, u_char* var_val,
                                   u_char var_val_type, size_t var_val_len,
                                   u_char* statP, oid* name, size_t name_len)
{
    long long_ret = *((long*)var_val);
    ...
    else if (action == RESERVE2)
    {
        ...
        else
        {
            ...
            {
                DEBUGMSGTL(("snmpTargetParamsEntry",
                            "write to snmpTargetParamsSecModel: this change "
                            "not allowed in active row.\n"));
                return SNMP_ERR_INCONSISTENTVALUE;
            }
 ...
 */
int write_snmpTargetParamsSecLevel(int action, u_char* var_val,
                                   u_char var_val_type, size_t var_val_len,
                                   u_char* statP, oid* name, size_t name_len)
{
    long long_ret = *((long*)var_val);
    ...
    if (action == RESERVE1)
    {
        ...
        {
            DEBUGMSGTL(("snmpTargetParamsEntry",
                        "write to snmpTargetParamsSecLevel: security level is "
                        "not noAuthNoPriv(1), authNopriv(2) or authPriv(3)\n"));
            return SNMP_ERR_WRONGVALUE;
        }
    }
    else if (action == RESERVE2)
    {
        ...
        else
        {
            ...
            {
                DEBUGMSGTL(("snmpTargetParamsEntry",
                            "write to snmpTargetParamsSecLevel: this change "
                            "not allowed in active row.\n"));
                return SNMP_ERR_INCONSISTENTVALUE;
            }
 ...
 */
int write_snmpTargetParamsStorageType(int action, u_char* var_val,
                                      u_char var_val_type, size_t var_val_len,
                                      u_char* statP, oid* name, size_t name_len)
{
    long long_ret = *((long*)var_val);
    ...
    if (action == RESERVE1)
    {
        ...
        {
            DEBUGMSGTL(("snmpTargetParamsEntry",
                        "write to snmpTargetParamsStorageType: attempted "
    ...
    else if (action == RESERVE2)
    {
        ...
        else
        {
            ...
            {
                DEBUGMSGTL(("snmpTargetParamsEntry",
                            "write to snmpTargetParamsStorageType: row has "
                            "unchangeable storage status: %d\n",
                            params->storageType));
                return SNMP_ERR_INCONSISTENTVALUE;
            }
 ...
 */
int write_snmpTargetParamsSecName(int action, u_char* var_val,
                                  u_char var_val_type, size_t var_val_len,
                                  u_char* statP, oid* name, size_t name_len)
{
    ...
    else if (action == RESERVE2)
    {
        ...
        else
        {
            ...
            {
                DEBUGMSGTL(("snmpTargetParamsEntry",
                            "write to snmpTargetParamsSecName: this change not "
                            "allowed in active row.\n"));
                return SNMP_ERR_INCONSISTENTVALUE;
            }
            if (old_name != NULL)
            ...
            params->secNameData =
                netsnmp_memdup_nt(var_val, var_val_len, &params->secNameLen);
 ...
 */
int snmpTargetParams_createNewRow(oid* name, size_t name_len)
{
    int pNameLen, i;
    struct targetParamTable_struct* temp_struct;
 ...
 */
int write_snmpTargetParamsRowStatus(int action, u_char* var_val,
                                    u_char var_val_type, size_t var_val_len,
                                    u_char* statP, oid* name, size_t name_len)
{
    static long value;
    ...
    if (action == RESERVE1)
    {
        ...
        if (params != NULL)
        {
            ...
            if (params->storageType == SNMP_STORAGE_READONLY)
            {
                DEBUGMSGTL(("snmpTargetParamsEntry", "row is read only\n"));
                return SNMP_ERR_NOTWRITABLE;
            }
    ...
    else if (action == UNDO || action == FREE)
    {
        ...
        params = search_snmpTargetParamsTable(
            snmpTargetParamsOID, snmpTargetParamsOIDLen, name, &name_len, 1);
        if (value == SNMP_ROW_CREATEANDGO || value == SNMP_ROW_CREATEANDWAIT)
        {
            if (params != NULL)
            {
                snmpTargetParamTable_remove(params);
