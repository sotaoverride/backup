...
static krb5_error_code des_encrypt(krb5_key key, const krb5_data* ivec,
...
static krb5_error_code des_decrypt(krb5_key key, const krb5_data* ivec,
                                   krb5_crypto_iov* data, size_t num_data)
{
    mit_des_key_schedule schedule;
    krb5_error_code err;
...
static krb5_error_code des_cbc_mac(krb5_key key, const krb5_crypto_iov* data,
...
const struct krb5_enc_provider krb5int_enc_des = {8,
                                                  7,
                                                  8,
                                                  des_encrypt,
                                                  des_decrypt,
