...
class basic_ptree
{
  ...
  public:
    ...
    typename boost::enable_if<detail::is_character<Ch>,
                              std::basic_string<Ch>>::type
     ...
     */
    template <class Type, class Translator>
    Type get(const path_type& path, const Type& default_value,
             Translator tr) const;
    ...
    typename boost::enable_if<detail::is_character<Ch>,
                              std::basic_string<Ch>>::type
        get(const path_type& path, const Ch* default_value,
            Translator tr) const;
