...
{
    return std::lexicographical_compare(boost::begin(l), boost::end(l),
...
{
    typedef BOOST_DEDUCED_TYPENAME iterator_traversal<IteratorT>::type
        traversal_t;
    ...
    typedef BOOST_DEDUCED_TYPENAME
        pure_iterator_traversal_impl<traversal_i>::type type;
};
...
class iterator_range_base : public iterator_range_tag
{
  ...
  public:
    typedef BOOST_DEDUCED_TYPENAME safe_bool_t::unspecified_bool_type
        unspecified_bool_type;

    typedef BOOST_DEDUCED_TYPENAME iterator_value<IteratorT>::type value_type;

    typedef BOOST_DEDUCED_TYPENAME iterator_difference<IteratorT>::type
        difference_type;
    ...
    typedef BOOST_DEDUCED_TYPENAME iterator_reference<IteratorT>::type
        reference;
  ...
  protected:
    iterator_range_base() : m_Begin(), m_End()
    {
    }
  ...
  public:
    ...
    {
        return safe_bool_t::to_unspecified_bool(m_Begin != m_End,
                                                &iterator_range_base::m_Begin);
    }
...
{
    typedef iterator_range_base<IteratorT, incrementable_traversal_tag>
        base_type;
  ...
  protected:
    ...
    template <class Iterator>
    iterator_range_base(Iterator first, Iterator last) : base_type(first, last)
    {
    }
...
/*!
    An \c iterator_range delimits a range in a sequence by beginning and ending
   iterators. An iterator_range can be passed to an algorithm which requires a
   sequence as an input. For example, the \c toupper() function may be used most
   frequently on strings, but can also be used on iterator_ranges:
    ...
    delimiting a working range, as an arguments. The \c iterator_range class is
   an encapsulation of a range identified by a pair of iterators. It provides a
   collection interface, so it is possible to pass an instance to an algorithm
              ...
              iterator_range_detail::pure_iterator_traversal<IteratorT>::type>
{
    ...
    struct is_compatible_range_
        : is_convertible<BOOST_DEDUCED_TYPENAME mpl::eval_if<
                             has_range_iterator<Source>, range_iterator<Source>,
    ...
    struct is_compatible_range
        : mpl::and_<mpl::not_<is_convertible<
                        Source, BOOST_DEDUCED_TYPENAME base_type::iterator>>,
  ...
  public:
    ...
    template <class Iterator>
    iterator_range(Iterator first, Iterator last) : base_type(first, last)
    {
    }
    ...
    iterator_range&
        advance_begin(BOOST_DEDUCED_TYPENAME base_type::difference_type n)
    {
        std::advance(this->m_Begin, n);
        return *this;
    }
    ...
    iterator_range&
        advance_end(BOOST_DEDUCED_TYPENAME base_type::difference_type n)
    {
        std::advance(this->m_End, n);
        return *this;
    }
...
inline BOOST_DEDUCED_TYPENAME boost::enable_if<
    mpl::not_<is_base_and_derived<iterator_range_detail::iterator_range_tag,
                                  ForwardRange>>,
    bool>::type
...
template <class IteratorT, class ForwardRange>
inline BOOST_DEDUCED_TYPENAME boost::enable_if<
    mpl::not_<boost::is_base_and_derived<
        iterator_range_detail::iterator_range_tag, ForwardRange>>,
    bool>::type
    operator!=(const ForwardRange& l, const iterator_range<IteratorT>& r)
{
    return !boost::equal(l, r);
...
*/
template <typename IteratorT>
inline iterator_range<IteratorT> make_iterator_range(IteratorT Begin,
                                                     IteratorT End)
{
        ...
        BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end)
{
    ...
    BOOST_DEDUCED_TYPENAME range_iterator<Range>::type new_begin =
                                                           boost::begin(r),
                                                       new_end = boost::end(r);
...
inline iterator_range<BOOST_DEDUCED_TYPENAME range_iterator<Range>::type>
    make_iterator_range(
        ...
        BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end)
{
    return iterator_range_detail::make_range_impl(r, advance_begin,
                                                  advance_end);
}
