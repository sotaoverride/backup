...
netsnmp_feature_require(ipAddressTable_container_get)
     ...
     */
    int ipAddressPrefixTable_init_data(
        ipAddressPrefixTable_registration* ipAddressPrefixTable_reg)
{
    DEBUGMSGTL(("verbose:ipAddressPrefixTable:ipAddressPrefixTable_init_data",
                "called\n"));
 ...
 */
void ipAddressPrefixTable_container_init(netsnmp_container** container_ptr_ptr,
                                         netsnmp_cache* cache)
{
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_init",
         "called\n"));
 ...
 */
void ipAddressPrefixTable_container_shutdown(netsnmp_container* container_ptr)
{
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_shutdown",
         "called\n"));
 ...
 *
 */
int ipAddressPrefixTable_container_load(netsnmp_container* container)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_load",
         "called\n"));
     ...
     * the container.
     */
    for (addr_rowreq_ctx = ITERATOR_FIRST(addr_it); addr_rowreq_ctx;
         addr_rowreq_ctx = ITERATOR_NEXT(addr_it))
    {

        /*
         * TODO:352:M: |   |-> set indexes in new ipAddressPrefixTable rowreq
        ...
        netsnmp_ipaddress_flags_copy(
            ...
            &addr_rowreq_ctx->data->ia_prefered_lifetime,
            &addr_rowreq_ctx->data->ia_valid_lifetime,
            &addr_rowreq_ctx->data->ia_onlink_flag,
            &addr_rowreq_ctx->data->ia_autonomous_flag);

        if (MFD_SUCCESS != ipAddressPrefixTable_indexes_set(
                               rowreq_ctx, addr_rowreq_ctx->data->if_index,
        ...
        netsnmp_ipaddress_prefix_origin_copy(
            ...
            addr_rowreq_ctx->data->ia_origin, addr_rowreq_ctx->data->flags,
            addr_rowreq_ctx->tbl_idx.ipAddressAddrType);
...
{
    DEBUGMSGTL(
        ("verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_free",
         "called\n"));
 ...
 * @retval MFD_ERROR       : other error.
 */
int ipAddressPrefixTable_row_prep(ipAddressPrefixTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:ipAddressPrefixTable:ipAddressPrefixTable_row_prep",
                "called\n"));
