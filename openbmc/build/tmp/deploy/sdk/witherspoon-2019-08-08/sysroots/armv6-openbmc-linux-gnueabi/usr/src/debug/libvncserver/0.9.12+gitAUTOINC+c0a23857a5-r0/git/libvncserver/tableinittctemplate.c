                                            ...
                                            rfbPixelFormat* out)
{
    ...
    *table = (char*)malloc(nEntries * sizeof(OUT_T));
    ...
    for (i = 0; i < nEntries; i++)
    {
        ...
        t[i] = ((outRed << out->redShift) | (outGreen << out->greenShift) |
                                          ...
                                          rfbPixelFormat* out)
{
    ...
    *table = (char*)malloc((in->redMax + in->greenMax + in->blueMax + 3) *
    ...
    rfbInitOneRGBTableOUT(redTable, in->redMax, out->redMax, out->redShift,
    ...
    rfbInitOneRGBTableOUT(blueTable, in->blueMax, out->blueMax, out->blueShift,
                          (out->bigEndian != in->bigEndian));
}
