...
typedef struct PS_Parser_FuncsRec_
{
    ...
    void (*to_token_array)(PS_Parser parser, T1_Token tokens,
                           FT_UInt max_tokens, FT_Int* pnum_tokens);

    FT_Error (*load_field)(PS_Parser parser, const T1_Field field,
...
typedef struct CFF_Decoder_FuncsRec_
{
    ...
    FT_Error (*prepare)(CFF_Decoder* decoder, CFF_Size size,
                        FT_UInt glyph_index);
...
typedef struct PSAux_ServiceRec_
{
    ...
    void (*ps_decoder_init)(PS_Decoder* ps_decoder, void* decoder,
                            FT_Bool is_t1);
