...
{
    return IN_SET(m, OUTPUT_JSON, OUTPUT_JSON_PRETTY, OUTPUT_JSON_SSE,
                  OUTPUT_JSON_SEQ);
}

/* The output flags definitions are shared by the logs and process tree output.
 * Some apply to both, some only to the
