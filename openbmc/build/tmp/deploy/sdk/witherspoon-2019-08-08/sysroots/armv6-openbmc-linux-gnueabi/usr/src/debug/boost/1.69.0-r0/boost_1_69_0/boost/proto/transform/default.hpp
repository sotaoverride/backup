...
#define BOOST_PROTO_UNARY_DEFAULT_EVAL(OP, TAG, MAKE)                          \
    ...
    {                                                                          \
        ...
        {                                                                      \
          private:                                                             \
            ...
            typedef                                                            \
                typename Grammar::template impl<e0, State, Data>::result_type  \
                    r0;                                                        \
                                                                               \
          public:                                                              \
    ...
    template <typename Grammar>                                                \
        ...
        : when<unary_expr<tag::TAG, Grammar>,                                  \
               BOOST_PP_CAT(default_, TAG) < Grammar>>                         \
    {                                                                          \
    };                                                                         \
    /**/
...
#define BOOST_PROTO_BINARY_DEFAULT_EVAL(OP, TAG, LMAKE, RMAKE)                 \
          ...
          private:                                                             \
            ...
            typedef                                                            \
                typename Grammar::template impl<e0, State, Data>::result_type  \
                    r0;                                                        \
            typedef                                                            \
                typename Grammar::template impl<e1, State, Data>::result_type  \
                    r1;                                                        \
                                                                               \
          public:                                                              \
            BOOST_PROTO_DECLTYPE_(proto::detail::LMAKE<r0>()                   \
                                      OP proto::detail::RMAKE<r1>(),           \
                                  result_type)                                 \
            result_type operator()(typename impl::expr_param e,                \
                                   typename impl::state_param s,               \
                                   typename impl::data_param d) const          \
    ...
    template <typename Grammar>                                                \
        struct default_case<Grammar, tag::TAG>                                 \
        : when<binary_expr<tag::TAG, Grammar, Grammar>,                        \
               BOOST_PP_CAT(default_, TAG) < Grammar>>                         \
    {                                                                          \
    };                                                                         \
    /**/
...
struct is_member_function_invocation
    : is_member_function_pointer<
          typename uncvref<typename Grammar::template impl<
              typename result_of::child_c<Expr, 1>::type, State,
...
struct default_mem_ptr_impl : transform_impl<Expr, State, Data>
{
  ...
  public:
    ...
    result_type operator()(typename default_mem_ptr_impl::expr_param e,
                           typename default_mem_ptr_impl::state_param s,
                           typename default_mem_ptr_impl::data_param d) const
    {
        typename Grammar::template impl<e0, State, Data> t0;
        typename Grammar::template impl<e1, State, Data> t1;
        return detail::mem_ptr_fun<r0, r1>()(t0(proto::child_c<0>(e), s, d),
    ...
    : transform_impl<Expr, State, Data>
{
  ...
  public:
    ...
    result_type const
        operator()(typename default_mem_ptr_impl::expr_param e,
                   typename default_mem_ptr_impl::state_param s,
                   typename default_mem_ptr_impl::data_param d) const
    {
        typename Grammar::template impl<e0, State, Data> t0;
        typename Grammar::template impl<e1, State, Data> t1;
        return detail::memfun<r0, r1>(t0(proto::child_c<0>(e), s, d),
                                      t1(proto::child_c<1>(e), s, d));
    }
};
...
struct default_post_inc : transform<default_post_inc<Grammar>>
{
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
      private:
        typedef typename result_of::child_c<Expr, 0>::type e0;
        typedef
            typename Grammar::template impl<e0, State, Data>::result_type r0;
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
      private:
        ...
        typedef
            typename Grammar::template impl<e0, State, Data>::result_type r0;
        typedef
            typename Grammar::template impl<e1, State, Data>::result_type r1;
      ...
      public:
                               ...
                               typename impl::data_param d) const
        {
            typename Grammar::template impl<e0, State, Data> t0;
            typename Grammar::template impl<e1, State, Data> t1;
            return t0(proto::child_c<0>(e), s,
                      d)[t1(proto::child_c<1>(e), s, d)];
        }
    };
};
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
      private:
        ...
        typedef
            typename Grammar::template impl<e1, State, Data>::result_type r1;
        typedef
            typename Grammar::template impl<e2, State, Data>::result_type r2;

      public:
        BOOST_PROTO_DECLTYPE_(proto::detail::make<r0>()
...
{
    template <typename Expr, typename State, typename Data>
    struct impl : default_function_impl<
                      Grammar, Expr, State, Data,
...
#define BOOST_PROTO_DEFAULT_EVAL_TYPE(Z, N, DATA)                              \
    typedef typename result_of::child_c<DATA, N>::type BOOST_PP_CAT(e, N);     \
                                                                               \
    typedef                                                                    \
        typename Grammar::template impl<BOOST_PP_CAT(e, N), State,             \
                                        Data>::result_type BOOST_PP_CAT(r, N); \
    /**/
    ...
    : transform_impl<Expr, State, Data>
{
    ...
    result_type operator()(typename default_function_impl::expr_param e,
    ...
    : transform_impl<Expr, State, Data>
{
    ...
    result_type operator()(typename default_function_impl::expr_param e,
                           ...
                           typename default_function_impl::data_param d) const
    {
        return this->invoke(e, s, d,
                            is_member_function_pointer<function_type>(),
                            is_member_object_pointer<function_type>());
    }

  private:
    result_type invoke(typename default_function_impl::expr_param e,
                       typename default_function_impl::state_param s,
                       typename default_function_impl::data_param d,
                       mpl::false_, mpl::false_) const
    {
        return BOOST_PROTO_DEFAULT_EVAL(~, 0,
                                        e)(BOOST_PROTO_DEFAULT_EVAL(~, 1, e));
    }

    result_type invoke(typename default_function_impl::expr_param e,
                       typename default_function_impl::state_param s,
                       typename default_function_impl::data_param d, mpl::true_,
                       mpl::false_) const
    {
        BOOST_PROTO_USE_GET_POINTER();
        typedef typename detail::class_member_traits<function_type>::class_type
            class_type;
        return (BOOST_PROTO_GET_POINTER(class_type,
                                        (BOOST_PROTO_DEFAULT_EVAL(~, 1, e)))
