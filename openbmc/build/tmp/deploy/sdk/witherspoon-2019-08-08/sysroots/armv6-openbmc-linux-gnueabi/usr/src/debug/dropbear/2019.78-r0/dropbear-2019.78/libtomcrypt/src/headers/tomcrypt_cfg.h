...
/* ulong32: "32-bit at least" data type */
    ...
    defined(_M_IA64) || defined(__LP64__) || defined(_LP64) ||                 \
    defined(__64BIT__)
...
/* No LTC_FAST if: explicitly disabled OR non-gcc/non-clang compiler OR old gcc
 * OR using -ansi -std=c99 */
...
typedef ulong32 __attribute__((__may_alias__)) LTC_FAST_TYPE;
    ...
    (defined(ENDIAN_BIG) || defined(ENDIAN_LITTLE)) &&                         \
