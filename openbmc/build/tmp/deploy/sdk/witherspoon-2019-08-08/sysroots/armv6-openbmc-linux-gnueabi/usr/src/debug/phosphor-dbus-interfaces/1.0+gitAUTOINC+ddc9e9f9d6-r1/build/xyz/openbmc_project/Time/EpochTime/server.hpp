...
class EpochTime
{
  public:
    ...
    virtual uint64_t elapsed(uint64_t value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_Elapsed(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Elapsed' */
    static int _callback_set_Elapsed(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Time_EpochTime_interface;
