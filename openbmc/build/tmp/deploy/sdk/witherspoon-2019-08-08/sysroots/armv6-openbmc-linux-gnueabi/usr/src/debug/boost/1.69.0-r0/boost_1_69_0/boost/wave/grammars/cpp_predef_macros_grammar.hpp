...
#if !defined(                                                                  \
    CPP_PREDEF_MACROS_GRAMMAR_HPP_53858C9A_C202_4D60_AD92_DC9CAE4DBB43_INCLUDED)
...
#define TRACE_PREDEF_MACROS_GRAMMAR                                            \
    bool(BOOST_SPIRIT_DEBUG_FLAGS_CPP &                                        \
         BOOST_SPIRIT_DEBUG_FLAGS_PREDEF_MACROS_GRAMMAR) /**/
    ...
    : public boost::spirit::classic::grammar<predefined_macros_grammar>
{
    ...
    struct definition
    {
        ...
        definition(predefined_macros_grammar const& /*self*/)
        {
            ...
            // This grammar resembles the overall structure of the cpp_grammar
            // to make it possible to reuse the parse tree traversal code
            plain_define =
                (ch_p(T_IDENTIFIER) |
            ...
            macro_parameters = confix_p(
                ...
                !list_p(
                    ...
                    no_node_d[*ch_p(T_SPACE) >> ch_p(T_COMMA) >>
                              *ch_p(T_SPACE)]),
            ...
            BOOST_SPIRIT_DEBUG_TRACE_RULE(plain_define,
                                          TRACE_PREDEF_MACROS_GRAMMAR);
            BOOST_SPIRIT_DEBUG_TRACE_RULE(macro_definition,
                                          TRACE_PREDEF_MACROS_GRAMMAR);
            BOOST_SPIRIT_DEBUG_TRACE_RULE(macro_parameters,
                                          TRACE_PREDEF_MACROS_GRAMMAR);
        }
    ...
    predefined_macros_grammar()
    {
        BOOST_SPIRIT_DEBUG_TRACE_GRAMMAR_NAME(
            *this, "predefined_macros_grammar", TRACE_PREDEF_MACROS_GRAMMAR);
    }
};
