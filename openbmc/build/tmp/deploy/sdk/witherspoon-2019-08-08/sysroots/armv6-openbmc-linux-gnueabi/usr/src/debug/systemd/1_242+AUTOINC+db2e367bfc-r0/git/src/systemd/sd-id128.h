...
char* sd_id128_to_string(sd_id128_t id,
                         char s[_SD_ARRAY_STATIC SD_ID128_STRING_MAX]);
...
#define SD_ID128_ARRAY(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12,  \
                       v13, v14, v15)                                          \
    {                                                                          \
        .bytes = {                                                             \
            0x##v0,                                                            \
...
#define SD_ID128_MAKE(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12,   \
                      v13, v14, v15)                                           \
    ((const sd_id128_t)SD_ID128_ARRAY(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9,  \
...
#define SD_ID128_FORMAT_VAL(x)                                                 \
    (x).bytes[0], (x).bytes[1], (x).bytes[2], (x).bytes[3], (x).bytes[4],      \
...
#define SD_ID128_CONST_STR(x)                                                  \
    ((const char[SD_ID128_STRING_MAX]){                                        \
        ...
        ((x).bytes[9] & 15) >= 10 ? 'a' + ((x).bytes[9] & 15) - 10             \
                                  : '0' + ((x).bytes[9] & 15),                 \
        ((x).bytes[10] >> 4) >= 10 ? 'a' + ((x).bytes[10] >> 4) - 10           \
                                   : '0' + ((x).bytes[10] >> 4),               \
        ((x).bytes[10] & 15) >= 10 ? 'a' + ((x).bytes[10] & 15) - 10           \
                                   : '0' + ((x).bytes[10] & 15),               \
        ((x).bytes[11] >> 4) >= 10 ? 'a' + ((x).bytes[11] >> 4) - 10           \
                                   : '0' + ((x).bytes[11] >> 4),               \
        ((x).bytes[11] & 15) >= 10 ? 'a' + ((x).bytes[11] & 15) - 10           \
                                   : '0' + ((x).bytes[11] & 15),               \
        ((x).bytes[12] >> 4) >= 10 ? 'a' + ((x).bytes[12] >> 4) - 10           \
                                   : '0' + ((x).bytes[12] >> 4),               \
        ((x).bytes[12] & 15) >= 10 ? 'a' + ((x).bytes[12] & 15) - 10           \
                                   : '0' + ((x).bytes[12] & 15),               \
        ((x).bytes[13] >> 4) >= 10 ? 'a' + ((x).bytes[13] >> 4) - 10           \
                                   : '0' + ((x).bytes[13] >> 4),               \
        ((x).bytes[13] & 15) >= 10 ? 'a' + ((x).bytes[13] & 15) - 10           \
                                   : '0' + ((x).bytes[13] & 15),               \
        ((x).bytes[14] >> 4) >= 10 ? 'a' + ((x).bytes[14] >> 4) - 10           \
                                   : '0' + ((x).bytes[14] >> 4),               \
        ((x).bytes[14] & 15) >= 10 ? 'a' + ((x).bytes[14] & 15) - 10           \
                                   : '0' + ((x).bytes[14] & 15),               \
        ((x).bytes[15] >> 4) >= 10 ? 'a' + ((x).bytes[15] >> 4) - 10           \
                                   : '0' + ((x).bytes[15] >> 4),               \
        ((x).bytes[15] & 15) >= 10 ? 'a' + ((x).bytes[15] & 15) - 10           \
                                   : '0' + ((x).bytes[15] & 15),               \
        0})
...
{
    return a.qwords[0] == UINT64_C(0xFFFFFFFFFFFFFFFF) &&
           a.qwords[1] == UINT64_C(0xFFFFFFFFFFFFFFFF);
}

#define SD_ID128_NULL ((const sd_id128_t){.qwords = {0, 0}})
#define SD_ID128_ALLF                                                          \
    ((const sd_id128_t){.qwords = {UINT64_C(0xFFFFFFFFFFFFFFFF),               \
