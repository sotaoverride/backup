...
class basic_cstring
{
  ...
  public:
...
#else
    // VA C++/XL C++ v6 and v8 has in this case a problem with the default
    // arguments.
    ...
    self_type& trim_left()
    {
        return trim_left(self_type());
    }
    self_type& trim_right()
    {
        return trim_right(self_type());
    }
    self_type& trim()
    {
        return trim(self_type());
    }
#endif
...
template <typename CharT>
inline typename basic_cstring<CharT>::pointer basic_cstring<CharT>::null_str()
{
    static CharT null = 0;
    return &null;
}
...
template <typename CharT>
inline basic_cstring<CharT>::basic_cstring() :
...
template <typename CharT>
inline basic_cstring<CharT>::basic_cstring(basic_cstring const& s) :
    m_begin(s.m_begin), m_end(s.m_end)
{
}
...
template <typename CharT>
inline basic_cstring<CharT>::basic_cstring(std_string const& s) :
    m_begin(s.c_str()), m_end(m_begin + s.size())
{
}
...
template <typename CharT>
inline basic_cstring<CharT>::basic_cstring(pointer s) :
...
template <typename CharT>
inline basic_cstring<CharT>::basic_cstring(pointer first, pointer last) :
...
template <typename CharT>
inline typename basic_cstring<CharT>::value_ret_type basic_cstring<CharT>::
...
template <typename CharT>
inline bool basic_cstring<CharT>::is_empty() const
{
...
template <typename CharT>
inline bool basic_cstring<CharT>::empty() const
{
    return is_empty();
}
...
template <typename CharT>
inline void basic_cstring<CharT>::clear()
{
    m_begin = m_end;
}
...
template <typename CharT>
inline void basic_cstring<CharT>::resize(size_type new_len)
{
...
template <typename CharT>
inline basic_cstring<CharT>& basic_cstring<CharT>::trim_left(iterator it)
{
    m_begin = it;
    if (m_end <= m_begin)
        clear();
    ...
    basic_cstring<CharT>::trim_left(basic_cstring exclusions)
{
    ...
    {
        if (traits_type::find(exclusions.begin(), exclusions.size(), *it) ==
...
template <typename CharT>
inline basic_cstring<CharT>& basic_cstring<CharT>::trim_right(iterator it)
{
    m_end = it;
    if (m_end <= m_begin)
        clear();
    ...
    basic_cstring<CharT>::trim_right(basic_cstring exclusions)
{
    ...
    {
        if (self_type::traits_type::find(exclusions.begin(), exclusions.size(),
                                         *it) == reinterpret_cast<pointer>(0))
            break;
    }
...
template <typename CharT>
inline basic_cstring<CharT>& basic_cstring<CharT>::
    operator=(basic_cstring<CharT> const& s)
{
    m_begin = s.m_begin;
    m_end = s.m_end;
...
template <typename CharT>
inline basic_cstring<CharT>& basic_cstring<CharT>::operator=(pointer s)
{
    return *this = self_type(s);
}
...
template <typename CharT>
inline basic_cstring<CharT>& basic_cstring<CharT>::assign(std_string const& s)
{
    return *this = self_type(s);
}
...
template <typename CharT>
inline basic_cstring<CharT>& basic_cstring<CharT>::assign(pointer s)
{
    return *this = self_type(s);
}
...
template <typename CharT>
inline basic_cstring<CharT>& basic_cstring<CharT>::assign(pointer f, pointer l)
{
...
template <typename CharT>
inline void basic_cstring<CharT>::swap(basic_cstring<CharT>& s)
{
...
template <typename CharT>
inline typename basic_cstring<CharT>::iterator basic_cstring<CharT>::begin()
{
    return m_begin;
}
...
template <typename CharT>
inline typename basic_cstring<CharT>::iterator basic_cstring<CharT>::end()
{
    return m_end;
}
    ...
    basic_cstring<CharT>::rfind(basic_cstring<CharT> str) const
{
    ...
    return it == last ? static_cast<size_type>(npos)
...
template <typename CharT>
inline basic_cstring<CharT> basic_cstring<CharT>::default_trim_ex()
{
...
inline bool operator==(basic_cstring<CharT1> const& s1,
...
template <typename CharT1, typename CharT2>
inline bool operator==(basic_cstring<CharT1> const& s1, CharT2* s2)
{
#if !defined(__DMC__)
...
template <typename CharT>
inline bool operator==(basic_cstring<CharT> const& s1,
...
template <typename CharT1, typename CharT2>
inline bool operator==(CharT1* s2, basic_cstring<CharT2> const& s1)
{
    return s1 == s2;
}
...
template <typename CharT>
inline bool operator==(typename basic_cstring<CharT>::std_string const& s2,
...
template <typename CharT>
inline bool operator!=(basic_cstring<CharT> const& s1, CharT* s2)
{
    return !(s1 == s2);
}
...
template <typename CharT>
inline bool operator!=(CharT* s2, basic_cstring<CharT> const& s1)
{
    return !(s1 == s2);
}
...
template <typename CharT1, typename CharT2>
inline void assign_op(std::basic_string<CharT1>& target,
                      basic_cstring<CharT2> src, int)
{
...
template <typename CharT1, typename CharT2>
inline std::basic_string<CharT1>& operator+=(std::basic_string<CharT1>& target,
...
template <typename CharT1, typename CharT2>
inline std::basic_string<CharT1> operator+(std::basic_string<CharT1> const& lhs,
                                           basic_cstring<CharT2> const& rhs)
{
