...
#define G_DTLS_CLIENT_CONNECTION(inst)                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_DTLS_CLIENT_CONNECTION,         \
                                GDtlsClientConnection))
#define G_IS_DTLS_CLIENT_CONNECTION(inst)                                      \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_DTLS_CLIENT_CONNECTION))
#define G_DTLS_CLIENT_CONNECTION_GET_INTERFACE(inst)                           \
    (G_TYPE_INSTANCE_GET_INTERFACE((inst), G_TYPE_DTLS_CLIENT_CONNECTION,      \
