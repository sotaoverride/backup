 ...
 * Flags for mkjournal
 */
#define EXT2_MKJOURNAL_V1_SUPER                                                \
    0x0000001 /* create V1 superblock (deprecated) */
#define EXT2_MKJOURNAL_LAZYINIT                                                \
    0x0000002 /* don't zero journal inode before use*/
...
struct struct_ext2_filsys
{
    ...
    errcode_t (*get_alloc_block2)(ext2_filsys fs, blk64_t goal, blk64_t* ret,
    ...
    errcode_t (*new_range)(ext2_filsys fs, int flags, blk64_t goal, blk64_t len,
                           blk64_t* pblk, blk64_t* plen);
...
#define EXT2_EXTENT_DELETE_KEEP_EMPTY                                          \
    0x001 /* keep node if last extent gone                                     \
           */
 ...
 */
#define EXT2_LIB_FEATURE_COMPAT_SUPP                                           \
...
#define EXT2_LIB_FEATURE_INCOMPAT_SUPP                                         \
    (EXT2_FEATURE_INCOMPAT_FILETYPE | EXT3_FEATURE_INCOMPAT_JOURNAL_DEV |      \
     EXT2_FEATURE_INCOMPAT_META_BG | EXT3_FEATURE_INCOMPAT_RECOVER |           \
     EXT3_FEATURE_INCOMPAT_EXTENTS | EXT4_FEATURE_INCOMPAT_FLEX_BG |           \
     EXT4_FEATURE_INCOMPAT_EA_INODE | EXT4_LIB_INCOMPAT_MMP |                  \
     EXT4_FEATURE_INCOMPAT_64BIT | EXT4_FEATURE_INCOMPAT_INLINE_DATA |         \
...
#define EXT2_LIB_FEATURE_RO_COMPAT_SUPP                                        \
    (EXT2_FEATURE_RO_COMPAT_SPARSE_SUPER | EXT4_FEATURE_RO_COMPAT_HUGE_FILE |  \
     EXT2_FEATURE_RO_COMPAT_LARGE_FILE | EXT4_FEATURE_RO_COMPAT_DIR_NLINK |    \
     EXT4_FEATURE_RO_COMPAT_EXTRA_ISIZE | EXT4_FEATURE_RO_COMPAT_GDT_CSUM |    \
     EXT4_FEATURE_RO_COMPAT_BIGALLOC | EXT4_FEATURE_RO_COMPAT_QUOTA |          \
     EXT4_FEATURE_RO_COMPAT_METADATA_CSUM | EXT4_FEATURE_RO_COMPAT_READONLY |  \
...
#define EXT2FS_NUM_B2C(fs, blks)                                               \
    (((blks) + EXT2FS_CLUSTER_MASK(fs)) >> (fs)->cluster_ratio_bits)
...
extern errcode_t ext2fs_get_free_blocks2(ext2_filsys fs, blk64_t start,
                                         ...
                                         ext2fs_block_bitmap map, blk64_t* ret);
extern errcode_t ext2fs_alloc_block(ext2_filsys fs, blk_t goal, char* block_buf,
                                    blk_t* ret);
...
extern void ext2fs_set_alloc_block_callback(
    ext2_filsys fs,
    errcode_t (*func)(ext2_filsys fs, blk64_t goal, blk64_t* ret),
    errcode_t (**old)(ext2_filsys fs, blk64_t goal, blk64_t* ret));
blk64_t ext2fs_find_inode_goal(ext2_filsys fs, ext2_ino_t ino,
                               struct ext2_inode* inode, blk64_t lblk);
extern void ext2fs_set_new_range_callback(
    ext2_filsys fs,
    errcode_t (*func)(ext2_filsys fs, int flags, blk64_t goal, blk64_t len,
                      blk64_t* pblk, blk64_t* plen),
    errcode_t (**old)(ext2_filsys fs, int flags, blk64_t goal, blk64_t len,
                      blk64_t* pblk, blk64_t* plen));
extern void ext2fs_set_block_alloc_stats_range_callback(
    ext2_filsys fs,
    void (*func)(ext2_filsys fs, blk64_t blk, blk_t num, int inuse),
    void (**old)(ext2_filsys fs, blk64_t blk, blk_t num, int inuse));
#define EXT2_NEWRANGE_FIXED_GOAL (0x1)
#define EXT2_NEWRANGE_MIN_LENGTH (0x2)
#define EXT2_NEWRANGE_ALL_FLAGS (0x3)
errcode_t ext2fs_new_range(ext2_filsys fs, int flags, blk64_t goal, blk64_t len,
                           ext2fs_block_bitmap map, blk64_t* pblk,
                           blk64_t* plen);
#define EXT2_ALLOCRANGE_FIXED_GOAL (0x1)
#define EXT2_ALLOCRANGE_ZERO_BLOCKS (0x2)
#define EXT2_ALLOCRANGE_ALL_FLAGS (0x3)
errcode_t ext2fs_alloc_range(ext2_filsys fs, int flags, blk64_t goal, blk_t len,
                             blk64_t* ret);

/* alloc_sb.c */
extern int ext2fs_reserve_super_and_bgd(ext2_filsys fs, dgrp_t group,
                                        ext2fs_block_bitmap bmap);
extern void ext2fs_set_block_alloc_stats_callback(
    ext2_filsys fs, void (*func)(ext2_filsys fs, blk64_t blk, int inuse),
    void (**old)(ext2_filsys fs, blk64_t blk, int inuse));

/* alloc_stats.c */
void ext2fs_inode_alloc_stats(ext2_filsys fs, ext2_ino_t ino, int inuse);
void ext2fs_inode_alloc_stats2(ext2_filsys fs, ext2_ino_t ino, int inuse,
                               int isdir);
void ext2fs_block_alloc_stats(ext2_filsys fs, blk_t blk, int inuse);
void ext2fs_block_alloc_stats2(ext2_filsys fs, blk64_t blk, int inuse);
void ext2fs_block_alloc_stats_range(ext2_filsys fs, blk64_t blk, blk_t num,
                                    int inuse);
...
extern int ext2fs_badblocks_list_test(ext2_badblocks_list bb, blk_t blk);
...
extern errcode_t ext2fs_allocate_block_bitmap(ext2_filsys fs, const char* descr,
...
extern errcode_t ext2fs_allocate_inode_bitmap(ext2_filsys fs, const char* descr,
...
extern errcode_t ext2fs_resize_inode_bitmap2(__u64 new_end, __u64 new_real_end,
                                             ext2fs_inode_bitmap bmap);
extern errcode_t ext2fs_resize_block_bitmap(__u32 new_end, __u32 new_real_end,
                                            ext2fs_block_bitmap bmap);
extern errcode_t ext2fs_resize_block_bitmap2(__u64 new_end, __u64 new_real_end,
                                             ext2fs_block_bitmap bmap);
...
extern blk64_t ext2fs_inode_data_blocks2(ext2_filsys fs,
                                         struct ext2_inode* inode);
extern blk64_t ext2fs_inode_i_blocks(ext2_filsys fs, struct ext2_inode* inode);
...
extern struct ext2_group_desc*
    ext2fs_group_desc(ext2_filsys fs, struct opaque_ext2_group_desc* gdp,
                      dgrp_t group);
...
extern void ext2fs_bg_itable_unused_set(ext2_filsys fs, dgrp_t group, __u32 n);
...
extern void ext2fs_file_acl_block_set(ext2_filsys fs, struct ext2_inode* inode,
                                      blk64_t blk);
extern errcode_t ext2fs_inode_size_set(ext2_filsys fs, struct ext2_inode* inode,
                                       ext2_off64_t size);

/* block.c */
extern errcode_t ext2fs_block_iterate(
    ext2_filsys fs, ext2_ino_t ino, int flags, char* block_buf,
    int (*func)(ext2_filsys fs, blk_t* blocknr, int blockcnt, void* priv_data),
    void* priv_data);
errcode_t ext2fs_block_iterate2(ext2_filsys fs, ext2_ino_t ino, int flags,
                                char* block_buf,
                                int (*func)(ext2_filsys fs, blk_t* blocknr,
                                            e2_blkcnt_t blockcnt, blk_t ref_blk,
                                            int ref_offset, void* priv_data),
                                void* priv_data);
errcode_t ext2fs_block_iterate3(
    ext2_filsys fs, ext2_ino_t ino, int flags, char* block_buf,
...
extern errcode_t ext2fs_bmap(ext2_filsys fs, ext2_ino_t ino,
                             ...
                             int bmap_flags, blk_t block, blk_t* phys_blk);
...
extern errcode_t ext2fs_super_and_bgd_loc2(ext2_filsys fs, dgrp_t group,
                                           blk64_t* ret_super_blk,
                                           blk64_t* ret_old_desc_blk,
                                           blk64_t* ret_new_desc_blk,
                                           blk_t* ret_used_blks);
extern int ext2fs_super_and_bgd_loc(ext2_filsys fs, dgrp_t group,
                                    blk_t* ret_super_blk,
                                    blk_t* ret_old_desc_blk,
                                    blk_t* ret_new_desc_blk, int* ret_meta_bg);
...
extern int ext2fs_superblock_csum_verify(ext2_filsys fs,
                                         struct ext2_super_block* sb);
extern errcode_t
    ext2fs_ext_attr_block_csum_set(ext2_filsys fs, ext2_ino_t inum,
                                   blk64_t block,
...
#define EXT2_DIRENT_TAIL(block, blocksize)                                     \
    ((struct ext2_dir_entry_tail*)(((char*)(block)) + (blocksize) -            \
...
extern errcode_t ext2fs_get_dx_countlimit(ext2_filsys fs,
                                          ...
                                          int* offset);
extern errcode_t ext2fs_extent_block_csum_set(ext2_filsys fs, ext2_ino_t inum,
                                              struct ext3_extent_header* eh);
extern int ext2fs_extent_block_csum_verify(ext2_filsys fs, ext2_ino_t inum,
                                           struct ext3_extent_header* eh);
...
extern void ext2fs_dblist_sort2(ext2_dblist dblist,
                                EXT2_QSORT_TYPE (*sortfunc)(const void*,
                                                            const void*));
extern errcode_t ext2fs_dblist_iterate(
    ext2_dblist dblist,
    int (*func)(ext2_filsys fs, struct ext2_db_entry* db_info, void* priv_data),
    void* priv_data);
extern errcode_t ext2fs_dblist_iterate2(
    ext2_dblist dblist,
    int (*func)(ext2_filsys fs, struct ext2_db_entry2* db_info,
                void* priv_data),
    void* priv_data);
extern errcode_t ext2fs_dblist_iterate3(
    ext2_dblist dblist,
    int (*func)(ext2_filsys fs, struct ext2_db_entry2* db_info,
                void* priv_data),
    unsigned long long start, unsigned long long count, void* priv_data);
extern errcode_t ext2fs_set_dir_block(ext2_dblist dblist, ext2_ino_t ino,
                                      blk_t blk, int blockcnt);
extern errcode_t ext2fs_set_dir_block2(ext2_dblist dblist, ext2_ino_t ino,
                                       blk64_t blk, e2_blkcnt_t blockcnt);
extern errcode_t ext2fs_copy_dblist(ext2_dblist src, ext2_dblist* dest);
...
extern errcode_t ext2fs_dblist_dir_iterate(
    ext2_dblist dblist, int flags, char* block_buf,
    int (*func)(ext2_ino_t dir, int entry, struct ext2_dir_entry* dirent,
...
extern errcode_t ext2fs_read_dir_block2(ext2_filsys fs, blk_t block, void* buf,
                                        int flags);
...
extern errcode_t ext2fs_write_dir_block2(ext2_filsys fs, blk_t block, void* buf,
                                         int flags);
...
extern errcode_t ext2fs_dirhash(int version, const char* name, int len,
                                const __u32* seed, ext2_dirhash_t* ret_hash,
...
extern errcode_t ext2fs_set_rec_len(ext2_filsys fs, unsigned int len,
                                    struct ext2_dir_entry* dirent);
extern errcode_t ext2fs_dir_iterate(ext2_filsys fs, ext2_ino_t dir, int flags,
                                    char* block_buf,
...
extern errcode_t ext2fs_dir_iterate2(
    ext2_filsys fs, ext2_ino_t dir, int flags, char* block_buf,
    int (*func)(ext2_ino_t dir, int entry, struct ext2_dir_entry* dirent,
                int offset, int blocksize, char* buf, void* priv_data),
    void* priv_data);
...
extern errcode_t ext2fs_read_ext_attr2(ext2_filsys fs, blk64_t block,
                                       void* buf);
extern errcode_t ext2fs_read_ext_attr3(ext2_filsys fs, blk64_t block, void* buf,
                                       ext2_ino_t inum);
...
errcode_t ext2fs_xattr_set(struct ext2_xattr_handle* handle, const char* key,
...
extern errcode_t ext2fs_extent_get(ext2_extent_handle_t handle, int flags,
...
extern errcode_t ext2fs_extent_goto(ext2_extent_handle_t handle, blk64_t blk);
...
extern errcode_t ext2fs_file_open2(ext2_filsys fs, ext2_ino_t ino,
                                   ...
                                   ext2_file_t* ret);
extern errcode_t ext2fs_file_open(ext2_filsys fs, ext2_ino_t ino, int flags,
                                  ext2_file_t* ret);
...
extern errcode_t ext2fs_file_llseek(ext2_file_t file, __u64 offset, int whence,
                                    __u64* ret_pos);
...
extern errcode_t ext2fs_make_generic_bitmap(errcode_t magic, ext2_filsys fs,
                                            ...
                                            __u32 real_end, const char* descr,
                                            char* init_map,
                                            ext2fs_generic_bitmap* ret);
extern errcode_t ext2fs_allocate_generic_bitmap(__u32 start, __u32 end,
                                                __u32 real_end,
                                                const char* descr,
                                                ext2fs_generic_bitmap* ret);
...
extern errcode_t ext2fs_resize_generic_bitmap(errcode_t magic, __u32 new_end,
                                              __u32 new_real_end,
...
extern errcode_t
    ext2fs_find_first_zero_generic_bitmap(ext2fs_generic_bitmap bitmap,
                                          __u32 start, __u32 end, __u32* out);
extern errcode_t
...
errcode_t ext2fs_alloc_generic_bmap(ext2_filsys fs, errcode_t magic, int type,
                                    __u64 start, __u64 end, __u64 real_end,
                                    const char* descr,
                                    ext2fs_generic_bitmap* ret);
...
errcode_t ext2fs_fudge_generic_bmap_end(ext2fs_generic_bitmap bitmap,
                                        errcode_t neq, __u64 end, __u64* oend);
void ext2fs_set_generic_bmap_padding(ext2fs_generic_bitmap bmap);
errcode_t ext2fs_resize_generic_bmap(ext2fs_generic_bitmap bmap, __u64 new_end,
                                     __u64 new_real_end);
errcode_t ext2fs_compare_generic_bmap(errcode_t neq, ext2fs_generic_bitmap bm1,
                                      ext2fs_generic_bitmap bm2);
errcode_t ext2fs_get_generic_bmap_range(ext2fs_generic_bitmap bmap, __u64 start,
                                        unsigned int num, void* out);
errcode_t ext2fs_set_generic_bmap_range(ext2fs_generic_bitmap bmap, __u64 start,
                                        unsigned int num, void* in);
...
extern errcode_t ext2fs_create_icount2(ext2_filsys fs, int flags,
                                       unsigned int size, ext2_icount_t hint,
                                       ext2_icount_t* ret);
extern errcode_t ext2fs_create_icount(ext2_filsys fs, int flags,
                                      unsigned int size, ext2_icount_t* ret);
...
extern errcode_t ext2fs_get_memalign(unsigned long size, unsigned long align,
                                     void* ptr);
...
extern errcode_t ext2fs_inline_data_get(ext2_filsys fs, ext2_ino_t ino,
                                        struct ext2_inode* inode, void* buf,
                                        size_t* size);
...
extern void ext2fs_set_inode_callback(
    ...
    errcode_t (*done_group)(ext2_filsys fs, ext2_inode_scan scan, dgrp_t group,
                            void* priv_data),
...
extern errcode_t ext2fs_write_new_inode(ext2_filsys fs, ext2_ino_t ino,
                                        struct ext2_inode* inode);
extern errcode_t ext2fs_get_blocks(ext2_filsys fs, ext2_ino_t ino,
                                   blk_t* blocks);
...
extern errcode_t ext2fs_inode_io_intern2(ext2_filsys fs, ext2_ino_t ino,
                                         struct ext2_inode* inode, char** name);
...
errcode_t ext2fs_namei_follow(ext2_filsys fs, ext2_ino_t root, ext2_ino_t cwd,
                              const char* name, ext2_ino_t* inode);
extern errcode_t ext2fs_follow_link(ext2_filsys fs, ext2_ino_t root,
                                    ext2_ino_t cwd, ext2_ino_t inode,
...
/* mkdir.c */
extern errcode_t ext2fs_mkdir(ext2_filsys fs, ext2_ino_t parent,
 ...
 */
extern blk64_t ext2fs_descriptor_block_loc2(ext2_filsys fs, blk64_t group_block,
                                            dgrp_t i);
...
/* get_pathname.c */
extern errcode_t ext2fs_get_pathname(ext2_filsys fs, ext2_ino_t dir,
...
/* read_bb_file.c */
extern errcode_t ext2fs_read_bb_FILE2(
    ext2_filsys fs, FILE* f, ext2_badblocks_list* bb_list, void* priv_data,
    void (*invalid)(ext2_filsys fs, blk_t blk, char* badstr, void* priv_data));
extern errcode_t
    ext2fs_read_bb_FILE(ext2_filsys fs, FILE* f, ext2_badblocks_list* bb_list,
...
extern errcode_t ext2fs_get_array(unsigned long count, unsigned long size,
                                  void* ptr);
extern errcode_t ext2fs_get_arrayzero(unsigned long count, unsigned long size,
                                      void* ptr);
extern errcode_t ext2fs_free_mem(void* ptr);
extern errcode_t ext2fs_resize_mem(unsigned long old_size, unsigned long size,
                                   void* ptr);
...
extern blk_t ext2fs_inode_data_blocks(ext2_filsys fs, struct ext2_inode* inode);
...
extern const struct ext2_inode*
...
_INLINE_ errcode_t ext2fs_get_arrayzero(unsigned long count, unsigned long size,
                                        void* ptr)
{
    void* pp;
...
_INLINE_ void ext2fs_dirent_set_file_type(struct ext2_dir_entry* entry,
                                          int type)
{
