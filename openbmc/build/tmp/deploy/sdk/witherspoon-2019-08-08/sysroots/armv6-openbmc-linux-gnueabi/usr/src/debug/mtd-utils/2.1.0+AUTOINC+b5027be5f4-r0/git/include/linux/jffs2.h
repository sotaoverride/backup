...
#define JFFS2_COMPAT_MASK                                                      \
    0xc000 /* What do to if an unknown nodetype is found */
...
//JFFS2_NODE_ACCURATE | 3) #define JFFS2_NODETYPE_OPTIONS
//(JFFS2_FEATURE_RWCOMPAT_COPY | JFFS2_NODE_ACCURATE | 4)
...
struct jffs2_raw_inode
{
    ...
    jint32_t
        isize; /* Total resultant size of this inode (used for truncations)  */
