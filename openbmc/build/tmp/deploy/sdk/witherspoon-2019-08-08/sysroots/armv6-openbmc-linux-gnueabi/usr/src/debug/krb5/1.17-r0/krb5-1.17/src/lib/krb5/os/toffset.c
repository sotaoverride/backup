                                                 ...
                                                 krb5_int32 microseconds)
{
    ...
    os_ctx->os_flags =
        ((os_ctx->os_flags & ~KRB5_OS_TOFFSET_TIME) | KRB5_OS_TOFFSET_VALID);
    return 0;
}
 ...
 */
krb5_error_code krb5_set_debugging_time(krb5_context context,
                                        krb5_timestamp seconds,
                                        krb5_int32 microseconds)
{
    krb5_os_context os_ctx = &context->os_context;
 ...
 */
krb5_error_code krb5_use_natural_time(krb5_context context)
{
    krb5_os_context os_ctx = &context->os_context;
 ...
 */
krb5_error_code krb5_set_time_offsets(krb5_context context,
                                      krb5_timestamp seconds,
                                      krb5_int32 microseconds)
{
    krb5_os_context os_ctx = &context->os_context;
