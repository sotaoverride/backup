...
#define G_CONVERTER(obj)                                                       \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_CONVERTER, GConverter))
#define G_IS_CONVERTER(obj)                                                    \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_CONVERTER))
#define G_CONVERTER_GET_IFACE(obj)                                             \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_CONVERTER, GConverterIface))
