...
=============================================================================*/
#if !defined(                                                                  \
    UNPUT_QUEUE_ITERATOR_HPP_76DA23D0_4893_4AD5_ABCC_6CED7CFB89BC_INCLUDED)
...
class unput_queue_iterator
    : public boost::iterator_adaptor<
          unput_queue_iterator<IteratorT, TokenT, ContainerT>, IteratorT,
          TokenT const, std::forward_iterator_tag>
{
  ...
  public:
    ...
    bool equal(boost::iterator_adaptor<OtherDerivedT, OtherIteratorT, V, C, R,
                                       D> const& x) const
    {
...
typename gen_unput_queue_iterator<IteratorT, TokenT, ContainerT>::container_type
    gen_unput_queue_iterator<IteratorT, TokenT, ContainerT>::last =
        typename gen_unput_queue_iterator<IteratorT, TokenT,
                                          ContainerT>::container_type();

///////////////////////////////////////////////////////////////////////////
template <typename IteratorT, typename TokenT, typename ContainerT>
struct gen_unput_queue_iterator<
    unput_queue_iterator<IteratorT, TokenT, ContainerT>, TokenT, ContainerT>
{
    typedef ContainerT container_type;
...
struct next_token
{
    static boost::wave::token_id peek(IteratorT it, IteratorT end,
...
struct next_token<unput_queue_iterator<IteratorT, TokenT, ContainerT>>
{
    ...
    static boost::wave::token_id peek(iterator_type it, iterator_type end,
                                      bool skip_whitespace = true)
    {
        using namespace boost::wave;
        ...
        if (0 != queue.size())
        {
            typename iterator_type::container_type::iterator cit =
                queue.begin();
        ...
        typename iterator_type::iterator_type base_end =
            end.get_base_iterator();
