...
int c_shquote_append_str(char** outp, size_t* n_outp, const char* in,
                         size_t n_in)
{
    if (n_in > *n_outp)
...
int c_shquote_append_char(char** outp, size_t* n_outp, char in)
{
    return c_shquote_append_str(outp, n_outp, &in, 1);
}

void c_shquote_skip_str(const char** strp, size_t* n_strp, size_t len)
{
    assert(len <= *n_strp);
...
void c_shquote_skip_char(const char** strp, size_t* n_strp)
{
    c_shquote_skip_str(strp, n_strp, 1);
}

int c_shquote_consume_str(char** outp, size_t* n_outp, const char** inp,
                          size_t* n_inp, size_t len)
{
    int r;
...
int c_shquote_consume_char(char** outp, size_t* n_outp, const char** inp,
                           size_t* n_inp)
{
    return c_shquote_consume_str(outp, n_outp, inp, n_inp, 1);
}

size_t c_shquote_strnspn(const char* string, size_t n_string,
                         const char* accept)
{
...
size_t c_shquote_strncspn(const char* string, size_t n_string,
                          const char* reject)
{
    bool buffer[UCHAR_MAX] = {};
...
void c_shquote_discard_comment(const char** inp, size_t* n_inp)
{
    size_t len;
...
void c_shquote_discard_whitespace(const char** inp, size_t* n_inp)
{
    size_t len;
...
int c_shquote_unescape_char_quoted(char** outp, size_t* n_outp,
                                   const char** inp, size_t* n_inp)
{
    const char* in = *inp;
    size_t n_in = *n_inp;
    int r;
...
int c_shquote_unescape_char_unquoted(char** outp, size_t* n_outp,
                                     const char** inp, size_t* n_inp)
{
    const char* in = *inp;
    size_t n_in = *n_inp;
...
int c_shquote_unquote_single(char** outp, size_t* n_outp, const char** inp,
                             size_t* n_inp)
{
    const char* in = *inp;
    size_t n_in = *n_inp;
...
int c_shquote_unquote_double(char** outp, size_t* n_outp, const char** inp,
                             size_t* n_inp)
{
    char* out = *outp;
    size_t n_out = *n_outp;
 ...
 */
_public_ int c_shquote_quote(char** outp, size_t* n_outp, const char* in,
                             size_t n_in)
{
    size_t n_out = *n_outp;
    char* out = *outp;
 ...
 *         buffer.
 */
_public_ int c_shquote_unquote(char** outp, size_t* n_outp, const char* in,
                               size_t n_in)
{
    size_t n_out = *n_outp;
    char* out = *outp;
 ...
 */
_public_ int c_shquote_parse_next(char** outp, size_t* n_outp, const char** inp,
                                  size_t* n_inp)
{
    const char* in = *inp;
    size_t n_in = *n_inp;
 ...
 *         NULL character.
 */
_public_ int c_shquote_parse_argv(char*** argvp, size_t* argcp,
                                  const char* input, size_t n_input)
{
