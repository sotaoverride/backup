...
class RebootPolicy
{
  public:
    ...
    virtual bool autoReboot(bool value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_AutoReboot(sd_bus*, const char*, const char*,
                                        const char*, sd_bus_message*, void*,
                                        sd_bus_error*);
    /** @brief sd-bus callback for set-property 'AutoReboot' */
    static int _callback_set_AutoReboot(sd_bus*, const char*, const char*,
                                        const char*, sd_bus_message*, void*,
                                        sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Control_Boot_RebootPolicy_interface;
