...
static gboolean g_environ_matches(const gchar* env, const gchar* variable,
                                  gsize len)
{
#ifdef G_OS_WIN32
...
/**
 * g_environ_getenv:
 * @envp: (nullable) (array zero-terminated=1) (transfer none) (element-type
 * filename): an environment list (eg, as returned from g_get_environ()), or
...
/**
 * g_environ_setenv:
 * @envp: (nullable) (array zero-terminated=1) (element-type filename) (transfer
 * full): an environment list that can be freed using g_strfreev() (e.g., as
...
static gchar** g_environ_unsetenv_internal(gchar** envp, const gchar* variable,
                                           gboolean free_value)
{
    gsize len;
    gchar **e, **f;
...
_GLIB_EXTERN gboolean g_setenv_utf8(const gchar* variable, const gchar* value,
                                    gboolean overwrite);
...
gboolean g_setenv_utf8(const gchar* variable, const gchar* value,
                       gboolean overwrite)
{
