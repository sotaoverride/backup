...
#include <net-snmp/agent/stash_to_next.h>
     ...
     *  to a series of GETNEXT requests.  It can be inserted into a handler
     * chain where the lower-level handlers don't process such requests
     * themselves.
     *  @ingroup utilities
     *  @{
     */
    ...
    netsnmp_mib_handler* netsnmp_get_stash_to_next_handler(void)
{
    netsnmp_mib_handler* handler =
        netsnmp_create_handler("stash_to_next", netsnmp_stash_to_next_helper);
...
int netsnmp_stash_to_next_helper(netsnmp_mib_handler* handler,
