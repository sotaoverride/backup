 ...
 */
int tcpConnectionTable_init_data(
    tcpConnectionTable_registration* tcpConnectionTable_reg)
{
 ...
 */
void tcpConnectionTable_container_init(netsnmp_container** container_ptr_ptr,
                                       netsnmp_cache* cache)
{
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_container_init",
                "called\n"));
 ...
 */
void tcpConnectionTable_container_shutdown(netsnmp_container* container_ptr)
{
    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionTable_container_shutdown",
         "called\n"));
 ...
 * add new entry
 */
static void _add_connection(netsnmp_tcpconn_entry* entry,
                            netsnmp_container* container)
{
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS == tcpConnectionTable_indexes_set(
                            rowreq_ctx, entry->loc_addr_len, entry->loc_addr,
                            entry->loc_addr_len, entry->loc_port,
                            entry->rmt_addr_len, entry->rmt_addr,
                            entry->rmt_addr_len, entry->rmt_port)))
    {
 ...
 *
 */
int tcpConnectionTable_container_load(netsnmp_container* container)
{
    netsnmp_container* raw_data = netsnmp_access_tcpconn_container_load(
        NULL, NETSNMP_ACCESS_TCPCONN_LOAD_NOLISTEN);

    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_container_load",
                "called\n"));
     ...
     */
    CONTAINER_FOR_EACH(raw_data, (netsnmp_container_obj_func*)_add_connection,
                       container);
    ...
    netsnmp_access_tcpconn_container_free(
        raw_data, NETSNMP_ACCESS_TCPCONN_FREE_DONT_CLEAR);
 ...
 *
 */
void tcpConnectionTable_container_free(netsnmp_container* container)
{
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_container_free",
                "called\n"));
 ...
 * @retval MFD_ERROR       : other error.
 */
int tcpConnectionTable_row_prep(tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:tcpConnectionTable:tcpConnectionTable_row_prep", "called\n"));
