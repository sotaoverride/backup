...
#define G_PARAM_SPEC_VARIANT(pspec)                                            \
    (G_TYPE_CHECK_INSTANCE_CAST((pspec), G_TYPE_PARAM_VARIANT,                 \
                                GParamSpecVariant))
 ...
 * @substitutor: the replacement byte for bytes which don't match @cset_first or
 * @cset_nth.
 ...
 * @fixed_n_elements: if greater than 0, arrays of this property will always
