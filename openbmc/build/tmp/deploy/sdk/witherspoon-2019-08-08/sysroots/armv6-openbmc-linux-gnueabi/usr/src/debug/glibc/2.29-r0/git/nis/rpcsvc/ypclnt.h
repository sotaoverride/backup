...
{
    int (*foreach)(int __status, char* __key, int __keylen, char* __val,
                   int __vallen, char* __data);
    char* data;
};
...
extern int yp_match(const char*, const char*, const char*, const int, char**,
                    int*) __THROW;
extern int yp_first(const char*, const char*, char**, int*, char**,
                    int*) __THROW;
extern int yp_next(const char*, const char*, const char*, const int, char**,
...
extern int yp_update(char*, char*, unsigned int, char*, int, char*,
                     int) __THROW;
