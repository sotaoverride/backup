...
static const ecc_domain_parms_t domain_parms[] = {
    {/* (-x^2 + y^2 = 1 + dx^2y^2) */
     "Ed25519", 256, 0, MPI_EC_EDWARDS, ECC_DIALECT_ED25519,
    ...
    {/* (y^2 = x^3 + 486662*x^2 + x) */
     "Curve25519", 256, 0, MPI_EC_MONTGOMERY, ECC_DIALECT_STANDARD,
     "0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFED",
     "0x01DB41", "0x01",
     "0x1000000000000000000000000000000014DEF9DEA2F79CD65812631A5CF5D3ED",
...
#endif /*0*/
    {"NIST P-192", 192, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x07192b95ffc8da78631011ed6b24cdd573f977a11e794811", "0x01"},
    {"NIST P-224", 224, 1, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0xbd376388b5f723fb4c22dfe6cd4375a05a07476444d5819985007e34", "0x01"},
    {"NIST P-256", 256, 1, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"NIST P-384", 384, 1, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"NIST P-521", 521, 1, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
    ...
    {"brainpoolP160r1", 160, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     "0xe95e4a5f737059dc60dfc7ad95b3d8139515620f",
     "0x340e7be2a280eb74e2be61bada745d97e8f7c300",
     "0x1e589a8595423412134faa2dbdec95c8d8675e58",
     "0xe95e4a5f737059dc60df5991d45029409e60fc09",
     "0xbed5af16ea3f6a4f62938c4631eb5af7bdbcdbc3",
     "0x1667cb477a1a8ec338f94741669c976316da6321", "0x01"},

    {"brainpoolP192r1", 192, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     "0xc302f41d932a36cda7a3463093d18db78fce476de1a86297",
     "0x6a91174076b1e0e19c39c031fe8685c1cae040e5c69a28ef",
     "0x469a28ef7c28cca3dc721d044f4496bcca7ef4146fbf25c9",
     "0xc302f41d932a36cda7a3462f9e9e916b5be8f1029ac4acc1",
     "0xc0a0647eaab6a48753b033c56cb0f0900a2f5c4853375fd6",
     "0x14b690866abd5bb88b5f4828c1490002e6773fa2fa299b8f", "0x01"},

    {"brainpoolP224r1", 224, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     "0xd7c134aa264366862a18302575d1d787b09f075797da89f57ec8c0ff",
     "0x68a5e62ca9ce6c1c299803a6c1530b514e182ad8b0042a59cad29f43",
     "0x2580f63ccfe44138870713b1a92369e33e2135d266dbb372386c400b",
     "0xd7c134aa264366862a18302575d0fb98d116bc4b6ddebca3a5a7939f",
     "0x0d9029ad2c7e5cf4340823b2a87dc68c9e4ce3174c1e6efdee12c07d",
     "0x58aa56f772c0726f24c6b89e4ecdac24354b9e99caa3f6d3761402cd", "0x01"},

    {"brainpoolP256r1", 256, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
    ...
    {"brainpoolP320r1", 320, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
    ...
    {"brainpoolP384r1", 384, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
    ...
    {"brainpoolP512r1", 512, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"GOST2001-test", 256, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"GOST2001-CryptoPro-A", 256, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"GOST2001-CryptoPro-B", 256, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"GOST2001-CryptoPro-C", 256, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"GOST2012-test", 511, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"GOST2012-tc26-A", 512, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
     ...
     "0x01"},
    {"GOST2012-tc26-B", 512, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
    ...
    {"secp256k1", 256, 0, MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
...
static gcry_mpi_point_t point_copy(gcry_mpi_point_t point)
{
...
static int find_domain_parms_idx(const char* name)
{
    int idx, aliasno;
...
gpg_err_code_t _gcry_ecc_fill_in_curve(unsigned int nbits, const char* name,
...
const char* _gcry_ecc_get_curve(gcry_sexp_t keyparms, int iterator,
                                unsigned int* r_nbits)
{
    gpg_err_code_t rc;
     ...
     */
    rc = gpg_err_code(sexp_extract_param(keyparms, NULL, "-pabgnh", &E.p, &E.a,
                                         &E.b, &mpi_g, &E.n, &E.h, NULL));
...
static gpg_err_code_t mpi_from_keyparam(gcry_mpi_t* r_a, gcry_sexp_t keyparam,
                                        const char* name)
{
...
static gpg_err_code_t point_from_keyparam(gcry_mpi_point_t* r_a,
                                          gcry_sexp_t keyparam,
                                          const char* name, mpi_ec_t ec)
{
    gcry_err_code_t rc;
    gcry_sexp_t l1;
...
/* This function creates a new context for elliptic curve operations.
   ...
   gcry_ctx_release.  */
gpg_err_code_t _gcry_mpi_ec_new(gcry_ctx_t* r_ctx, gcry_sexp_t keyparam,
...
gcry_sexp_t _gcry_ecc_get_param_sexp(const char* name)
{
    ...
    g_x = mpi_new(0);
    g_y = mpi_new(0);
    ctx = _gcry_mpi_ec_p_internal_new(MPI_EC_WEIERSTRASS, ECC_DIALECT_STANDARD,
                                      0, E.p, E.a, NULL);
    ...
    if (sexp_build(&result, NULL,
                   "(public-key(ecc(p%m)(a%m)(b%m)(g%m)(n%m)(h%m)))", pkey[0],
                   pkey[1], pkey[2], pkey[3], pkey[4], pkey[5]))
        result = NULL;
...
gcry_mpi_t _gcry_ecc_get_mpi(const char* name, mpi_ec_t ec, int copy)
{
    ...
    if (*name == 'q' && (!name[1] || name[1] == '@'))
    {
        ...
        if (!strcmp(name + 2, "eddsa") && ec->model == MPI_EC_EDWARDS)
        {
            ...
            if (!_gcry_ecc_eddsa_encodepoint(ec->Q, ec, NULL, NULL, 0, &encpk,
                                             &encpklen))
...
gpg_err_code_t _gcry_ecc_set_mpi(const char* name, gcry_mpi_t newvalue,
                                 mpi_ec_t ec)
{
    gpg_err_code_t rc = 0;
    ...
    else if (*name == 'q' && (!name[1] || name[1] == '@'))
    {
        if (newvalue)
        {
            ...
            if (ec->dialect == ECC_DIALECT_ED25519)
                rc = _gcry_ecc_eddsa_decodepoint(newvalue, ec, ec->Q, NULL,
                                                 NULL);
            else
...
gpg_err_code_t _gcry_ecc_set_point(const char* name, gcry_mpi_point_t newvalue,
                                   mpi_ec_t ec)
{
    if (!strcmp(name, "g"))
    {
