...
#define G_NETWORK_MONITOR_NETLINK(o)                                           \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_NETWORK_MONITOR_NETLINK,           \
                                GNetworkMonitorNetlink))
#define G_NETWORK_MONITOR_NETLINK_CLASS(k)                                     \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_NETWORK_MONITOR_NETLINK,              \
                             GNetworkMonitorNetlinkClass))
#define G_IS_NETWORK_MONITOR_NETLINK(o)                                        \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_NETWORK_MONITOR_NETLINK))
#define G_IS_NETWORK_MONITOR_NETLINK_CLASS(k)                                  \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_NETWORK_MONITOR_NETLINK))
#define G_NETWORK_MONITOR_NETLINK_GET_CLASS(o)                                 \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_NETWORK_MONITOR_NETLINK,            \
                               GNetworkMonitorNetlinkClass))
