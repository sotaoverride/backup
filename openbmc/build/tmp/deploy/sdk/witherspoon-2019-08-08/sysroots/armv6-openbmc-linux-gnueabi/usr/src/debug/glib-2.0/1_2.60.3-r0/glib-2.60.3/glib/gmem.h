 ...
 * handler.
 * @try_realloc: function to use for reallocating memory without a default error
 * handler.
 *
...
gpointer g_try_malloc_n(gsize n_blocks, gsize n_block_bytes) G_GNUC_MALLOC
    G_GNUC_ALLOC_SIZE2(1, 2);
GLIB_AVAILABLE_IN_ALL
gpointer g_try_malloc0_n(gsize n_blocks, gsize n_block_bytes) G_GNUC_MALLOC
    G_GNUC_ALLOC_SIZE2(1, 2);
GLIB_AVAILABLE_IN_ALL
gpointer g_try_realloc_n(gpointer mem, gsize n_blocks,
                         gsize n_block_bytes) G_GNUC_WARN_UNUSED_RESULT;
...
/* type safety */
    ...
    !defined(__cplusplus) && GLIB_VERSION_MAX_ALLOWED >= GLIB_VERSION_2_58
...
#define g_try_new0(struct_type, n_structs)                                     \
    _G_NEW(struct_type, n_structs, try_malloc0)
/**
 * g_try_renew:
 * @struct_type: the type of the elements to allocate
 * @mem: the currently allocated memory
...
#define g_try_renew(struct_type, mem, n_structs)                               \
    _G_RENEW(struct_type, mem, n_structs, try_realloc)
