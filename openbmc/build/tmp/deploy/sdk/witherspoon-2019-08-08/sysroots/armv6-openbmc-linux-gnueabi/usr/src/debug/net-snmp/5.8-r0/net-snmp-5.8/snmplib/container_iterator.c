 ...
 *
 **********************************************************************/
static void* _iterator_get(iterator_info* ii, const void* key)
{
    ...
    {
        for (; (NULL != tmp.val) && (SNMP_ERR_NOERROR == rc);
 ...
 */
static void* _iterator_get_next(iterator_info* ii, const void* key)
{
    int cmp, rc = SNMP_ERR_NOERROR;
    ...
    if (SNMP_ERR_NOERROR == rc)
    {
         ...
         */
        for (; (NULL != tmp.val) && (rc == SNMP_ERR_NOERROR);
             rc = ii->get_next(ii->user_ctx, &loop_ctx, &tmp))
        {
 ...
 *
 **********************************************************************/
static void _iterator_free(iterator_info* ii)
{
    DEBUGMSGT(("container_iterator", ">%s\n", "_iterator_free"));
...
static void* _iterator_find(iterator_info* ii, const void* data)
{
    DEBUGMSGT(("container_iterator", ">%s\n", "_iterator_find"));
...
static void* _iterator_find_next(iterator_info* ii, const void* data)
{
    DEBUGMSGT(("container_iterator", ">%s\n", "_iterator_find_next"));
...
static int _iterator_insert(iterator_info* ii, const void* data)
{
    DEBUGMSGT(("container_iterator", ">%s\n", "_iterator_insert"));
...
static int _iterator_remove(iterator_info* ii, const void* data)
{
    DEBUGMSGT(("container_iterator", ">%s\n", "_iterator_remove"));
...
static int _iterator_release(iterator_info* ii, const void* data)
{
    DEBUGMSGT(("container_iterator", ">%s\n", "_iterator_release"));
...
static size_t _iterator_size(iterator_info* ii)
{
    size_t count = 0;
    netsnmp_ref_void loop_ctx = {NULL};
    netsnmp_ref_void tmp = {NULL};
    ...
    for (ii->get_first(ii->user_ctx, &loop_ctx, &tmp); NULL != tmp.val;
...
static void _iterator_for_each(iterator_info* ii, netsnmp_container_obj_func* f,
                               void* ctx)
{
    netsnmp_ref_void loop_ctx = {NULL};
    netsnmp_ref_void tmp = {NULL};
...
static void _iterator_clear(netsnmp_container* container,
...
netsnmp_container* netsnmp_container_iterator_get(
    void* iterator_user_ctx, netsnmp_container_compare* compare,
    Netsnmp_Iterator_Loop_Key* get_first, Netsnmp_Iterator_Loop_Key* get_next,
    Netsnmp_Iterator_Loop_Data* get_data, Netsnmp_Iterator_Ctx_Dup* save_pos,
    Netsnmp_Iterator_Ctx* init_loop_ctx, Netsnmp_Iterator_Ctx* cleanup_loop_ctx,
...
void netsnmp_container_iterator_set_data_cb(netsnmp_container* c,
                                            Netsnmp_Iterator_Data* insert_data,
                                            Netsnmp_Iterator_Data* remove_data,
                                            Netsnmp_Iterator_Op* get_size)
{
