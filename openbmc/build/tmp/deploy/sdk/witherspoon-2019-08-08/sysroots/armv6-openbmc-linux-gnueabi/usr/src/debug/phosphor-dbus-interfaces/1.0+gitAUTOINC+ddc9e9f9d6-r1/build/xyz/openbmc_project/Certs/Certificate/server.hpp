...
class Certificate
{
  public:
    ...
    virtual std::string certificateString(std::string value, bool skipSignal);
    ...
    virtual std::string issuer(std::string value, bool skipSignal);
    /** Set value of Issuer */
    ...
    virtual std::string subject(std::string value, bool skipSignal);
    ...
    virtual uint64_t validNotAfter(uint64_t value, bool skipSignal);
    ...
    virtual uint64_t validNotBefore(uint64_t value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_CertificateString(sd_bus*, const char*,
                                               const char*, const char*,
                                               sd_bus_message*, void*,
                                               sd_bus_error*);
    /** @brief sd-bus callback for set-property 'CertificateString' */
    static int _callback_set_CertificateString(sd_bus*, const char*,
                                               const char*, const char*,
                                               sd_bus_message*, void*,
                                               sd_bus_error*);

    /** @brief sd-bus callback for get-property 'KeyUsage' */
    static int _callback_get_KeyUsage(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'KeyUsage' */
    static int _callback_set_KeyUsage(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Issuer' */
    static int _callback_get_Issuer(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Issuer' */
    static int _callback_set_Issuer(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Subject' */
    static int _callback_get_Subject(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Subject' */
    static int _callback_set_Subject(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);

    /** @brief sd-bus callback for get-property 'ValidNotAfter' */
    static int _callback_get_ValidNotAfter(sd_bus*, const char*, const char*,
                                           const char*, sd_bus_message*, void*,
                                           sd_bus_error*);
    /** @brief sd-bus callback for set-property 'ValidNotAfter' */
    static int _callback_set_ValidNotAfter(sd_bus*, const char*, const char*,
                                           const char*, sd_bus_message*, void*,
                                           sd_bus_error*);

    /** @brief sd-bus callback for get-property 'ValidNotBefore' */
    static int _callback_get_ValidNotBefore(sd_bus*, const char*, const char*,
                                            const char*, sd_bus_message*, void*,
                                            sd_bus_error*);
    /** @brief sd-bus callback for set-property 'ValidNotBefore' */
    static int _callback_set_ValidNotBefore(sd_bus*, const char*, const char*,
                                            const char*, sd_bus_message*, void*,
                                            sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Certs_Certificate_interface;
