 ...
 * #GDBusInterfaceVTable for more information.
 *
 * Returns: A #GDBusMethodInfo or %NULL. Do not free, it is owned by
 * @invocation.
 *
 * Since: 2.26
 */
 ...
 *
 * Returns: (transfer none):A #GDBusConnection. Do not free, it is owned by
 * @invocation.
 *
 * Since: 2.26
 */
 ...
 *
 * Returns: (transfer none): #GDBusMessage. Do not free, it is owned by
 * @invocation.
 *
 * Since: 2.26
 */
 ...
 *
 * Returns: (transfer none): A #GVariant tuple. Do not unref this because it is
 * owned by @invocation.
 *
 * Since: 2.26
 */
 ...
 * @sender: (nullable): The bus name that invoked the method or %NULL if
 ...
 * @user_data: The @user_data #gpointer passed to
 ...
 * Since: 2.26
 */
GDBusMethodInvocation* _g_dbus_method_invocation_new(
    const gchar* sender, const gchar* object_path, const gchar* interface_name,
    const gchar* method_name, const GDBusMethodInfo* method_info,
    const GDBusPropertyInfo* property_info, GDBusConnection* connection,
    GDBusMessage* message, GVariant* parameters, gpointer user_data)
{
    GDBusMethodInvocation* invocation;
    ...
    g_return_val_if_fail(g_variant_is_of_type(parameters, G_VARIANT_TYPE_TUPLE),
                         NULL);

    invocation = G_DBUS_METHOD_INVOCATION(
        g_object_new(G_TYPE_DBUS_METHOD_INVOCATION, NULL));
    ...
    if (method_info)
        invocation->method_info =
            g_dbus_method_info_ref((GDBusMethodInfo*)method_info);
    if (property_info)
        invocation->property_info =
            g_dbus_property_info_ref((GDBusPropertyInfo*)property_info);
...
static void g_dbus_method_invocation_return_value_internal(
    ...
    GUnixFDList* fd_list)
{
    ...
    if (g_dbus_message_get_flags(invocation->message) &
    ...
    /* if we have introspection data, check that the signature of @parameters is
     * correct */
    if (invocation->method_info != NULL)
    {
        GVariantType* type;

        type = _g_dbus_compute_complete_signature(
            invocation->method_info->out_args);
        ...
        if (!g_variant_is_of_type(parameters, type))
        {
            ...
            g_warning(
                "Type of return value is incorrect: expected '%s', got '%s''",
    ...
    if (invocation->property_info != NULL)
    {
        if (g_str_equal(invocation->method_name, "Get"))
        {
            ...
            {
                g_warning("Type of return value for property 'Get' call should "
                          "be '(v)' but got '%s'",
            ...
            if (!g_str_equal(g_variant_get_type_string(nested),
                             invocation->property_info->signature))
            {
                g_warning("Value returned from property 'Get' call for '%s' "
        ...
        else if (g_str_equal(invocation->method_name, "GetAll"))
        {
            ...
            {
                g_warning("Type of return value for property 'GetAll' call "
                          "should be '(a{sv})' but got '%s'",
                          g_variant_get_type_string(parameters));
                goto out;
            }
        ...
        else if (g_str_equal(invocation->method_name, "Set"))
        {
            ...
            {
                g_warning("Type of return value for property 'Set' call should "
                          "be '()' but got '%s'",
                          g_variant_get_type_string(parameters));
                goto out;
            }
    ...
    if (G_UNLIKELY(_g_dbus_debug_return()))
    {
        ...
        g_print("=============================================================="
                ...
                invocation->object_path, invocation->sender,
 ...
 * @parameters: (nullable): A #GVariant tuple with out parameters for the method
 * or %NULL if not passing any parameters.
 *
...
void g_dbus_method_invocation_return_value(GDBusMethodInvocation* invocation,
                                           GVariant* parameters)
{
    g_dbus_method_invocation_return_value_internal(invocation, parameters,
                                                   NULL);
}
                                           ...
                                           const gchar* format, ...)
{
    ...
    g_dbus_method_invocation_return_error_valist(invocation, domain, code,
                                                 format, var_args);
    va_end(var_args);
}
...
void g_dbus_method_invocation_return_error_valist(
    GDBusMethodInvocation* invocation, GQuark domain, gint code,
    const gchar* format, va_list var_args)
{
    ...
    g_dbus_method_invocation_return_error_literal(invocation, domain, code,
                                                  literal_message);
                                            ...
                                            const GError* error)
{
    ...
    g_dbus_method_invocation_return_dbus_error(invocation, dbus_error_name,
                                               error->message);
...
void g_dbus_method_invocation_return_dbus_error(
    GDBusMethodInvocation* invocation, const gchar* error_name,
