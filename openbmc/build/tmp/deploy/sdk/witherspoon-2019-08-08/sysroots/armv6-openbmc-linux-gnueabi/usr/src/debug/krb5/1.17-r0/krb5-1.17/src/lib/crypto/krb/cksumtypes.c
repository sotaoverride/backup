...
const struct krb5_cksumtypes krb5int_cksumtypes_list[] = {
    {CKSUMTYPE_CRC32,
     ...
     4,
     4,
     CKSUM_UNKEYED | CKSUM_NOT_COLL_PROOF},
    ...
    {CKSUMTYPE_RSA_MD4_DES,
     "md4-des",
     {0},
     "RSA-MD4 with DES cbc mode",
     &krb5int_enc_des,
     &krb5int_hash_md4,
     krb5int_confounder_checksum,
    ...
    {CKSUMTYPE_HMAC_MD5_ARCFOUR,
     "hmac-md5-rc4",
     {"hmac-md5-enc", "hmac-md5-earcfour"},
     "Microsoft HMAC MD5",
     NULL,
     &krb5int_hash_md5,
