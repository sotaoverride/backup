...
#define BOOST_THREAD_HAS_PTHREAD_MUTEXATTR_SETTYPE
    ...
    defined BOOST_THREAD_USES_PTHREAD_TIMEDLOCK
    ...
    recursive_mutex()
    {
        ...
        if (init_attr_res)
        {
            boost::throw_exception(thread_resource_error(
                init_attr_res, "boost:: recursive_mutex constructor failed in "
                               "pthread_mutexattr_init"));
        }
        int const set_attr_res =
            pthread_mutexattr_settype(&attr, PTHREAD_MUTEX_RECURSIVE);
        if (set_attr_res)
        {
            BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
            boost::throw_exception(thread_resource_error(
                set_attr_res, "boost:: recursive_mutex constructor failed in "
        ...
        if (res)
        {
            BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
            boost::throw_exception(thread_resource_error(
                res, "boost:: recursive_mutex constructor failed in "
                     "pthread_mutex_init"));
        }
        BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
#else
        ...
        if (res2)
        {
            ...
            boost::throw_exception(thread_resource_error(
                res2, "boost:: recursive_mutex constructor failed in "
                      "pthread::cond_init"));
        }
        is_locked = false;
        count = 0;
...
class recursive_timed_mutex
{
  ...
  public:
    ...
    recursive_timed_mutex()
    {
        ...
        {
            boost::throw_exception(thread_resource_error(
                init_attr_res, "boost:: recursive_timed_mutex constructor "
                               "failed in pthread_mutexattr_init"));
        }
        int const set_attr_res =
            pthread_mutexattr_settype(&attr, PTHREAD_MUTEX_RECURSIVE);
        if (set_attr_res)
        {
            boost::throw_exception(thread_resource_error(
                set_attr_res, "boost:: recursive_timed_mutex constructor "
                              "failed in pthread_mutexattr_settype"));
        }
        ...
        if (res)
        {
            BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
            boost::throw_exception(thread_resource_error(
                res, "boost:: recursive_timed_mutex constructor failed in "
                     "pthread_mutex_init"));
        }
        BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
#else
        ...
        if (res2)
        {
            BOOST_VERIFY(!pthread_mutex_destroy(&m));
            boost::throw_exception(thread_resource_error(
                res2, "boost:: recursive_timed_mutex constructor failed in "
                      "pthread::cond_init"));
        }
        is_locked = false;
        count = 0;
  ...
  private:
    bool do_try_lock_until(detail::internal_platform_timepoint const& timeout)
    {
        ...
        {
            int const cond_res =
                pthread_cond_timedwait(&cond, &m, &timeout.getTs());
