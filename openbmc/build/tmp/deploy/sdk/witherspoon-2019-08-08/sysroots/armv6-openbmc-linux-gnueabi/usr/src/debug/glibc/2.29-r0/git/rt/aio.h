...
extern int lio_listio(int __mode, struct aiocb* const __list[__restrict_arr],
...
extern int aio_error64(const struct aiocb64* __aiocbp) __THROW __nonnull((1));
extern __ssize_t aio_return64(struct aiocb64* __aiocbp) __THROW __nonnull((1));
