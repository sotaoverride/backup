...
template <>
bool BOOST_MATH_TR1_DECL signbit<double>
...
template <>
int BOOST_MATH_TR1_DECL fpclassify<double>
    BOOST_PREVENT_MACRO_SUBSTITUTION(double x)
{
...
template <>
bool BOOST_MATH_TR1_DECL isfinite<double>
    BOOST_PREVENT_MACRO_SUBSTITUTION(double x)
{
...
template <>
bool BOOST_MATH_TR1_DECL isinf<double>
    BOOST_PREVENT_MACRO_SUBSTITUTION(double x)
{
...
template <>
bool BOOST_MATH_TR1_DECL isnan<double>
    BOOST_PREVENT_MACRO_SUBSTITUTION(double x)
{
...
template <>
bool BOOST_MATH_TR1_DECL isnormal<double>
    BOOST_PREVENT_MACRO_SUBSTITUTION(double x)
{
