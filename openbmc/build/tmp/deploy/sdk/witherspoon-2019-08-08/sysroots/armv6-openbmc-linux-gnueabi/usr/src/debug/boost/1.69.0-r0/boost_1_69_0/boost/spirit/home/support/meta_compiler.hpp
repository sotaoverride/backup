...
struct meta_compiler
{
    ...
    struct cases
    {
        ...
        struct case_<proto::tag::terminal, Enable>
            : proto::when<proto::if_<use_terminal<Domain, proto::_value>()>,
    ...
    struct cases
    {
        ...
        struct case_<Tag>
            : proto::or_<
                  ...
                  ///////////////////////////////////////////////////////////////////
                  proto::when<proto::binary_expr<
                                  typename enable_if<use_operator<Domain, Tag>,
                                                     Tag>::type,
...
{
// Default case
template <typename Domain, typename Expr, typename Modifiers = unused_type,
          typename Enable = void>
struct compile
{
    typedef typename meta_compiler<Domain>::meta_grammar meta_grammar;
    typedef typename meta_grammar::template result<meta_grammar(
        Expr, mpl::void_, Modifiers)>::type type;
};
...
struct matches
    : proto::matches<typename proto::result_of::as_expr<
...
{
    typedef
        typename fusion::result_of::value_at_c<Elements, 0>::type element_type;
...
template <typename Elements,
          template <typename Left, typename Right> class generator>
struct make_binary_composite
{
    typedef typename fusion::result_of::value_at_c<Elements, 0>::type left_type;
    typedef
        typename fusion::result_of::value_at_c<Elements, 1>::type right_type;
