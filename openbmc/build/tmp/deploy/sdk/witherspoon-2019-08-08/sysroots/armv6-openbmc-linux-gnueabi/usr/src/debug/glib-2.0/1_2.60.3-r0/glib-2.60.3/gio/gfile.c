...
static void g_file_real_query_info_async(GFile* file, const char* attributes,
                                         GFileQueryInfoFlags flags,
                                         int io_priority,
                                         GCancellable* cancellable,
                                         GAsyncReadyCallback callback,
                                         gpointer user_data);
static GFileInfo* g_file_real_query_info_finish(GFile* file, GAsyncResult* res,
                                                GError** error);
static void g_file_real_query_filesystem_info_async(
    GFile* file, const char* attributes, int io_priority,
    GCancellable* cancellable, GAsyncReadyCallback callback,
    gpointer user_data);
static GFileInfo* g_file_real_query_filesystem_info_finish(GFile* file,
                                                           GAsyncResult* res,
                                                           GError** error);
static void g_file_real_enumerate_children_async(
    GFile* file, const char* attributes, GFileQueryInfoFlags flags,
...
static GFileEnumerator* g_file_real_enumerate_children_finish(GFile* file,
                                                              GAsyncResult* res,
                                                              GError** error);
static void g_file_real_read_async(GFile* file, int io_priority,
                                   GCancellable* cancellable,
                                   GAsyncReadyCallback callback,
                                   gpointer user_data);
static GFileInputStream* g_file_real_read_finish(GFile* file, GAsyncResult* res,
                                                 GError** error);
static void g_file_real_append_to_async(GFile* file, GFileCreateFlags flags,
                                        int io_priority,
                                        GCancellable* cancellable,
                                        GAsyncReadyCallback callback,
                                        gpointer user_data);
static GFileOutputStream* g_file_real_append_to_finish(GFile* file,
                                                       GAsyncResult* res,
                                                       GError** error);
static void g_file_real_create_async(GFile* file, GFileCreateFlags flags,
                                     int io_priority, GCancellable* cancellable,
                                     GAsyncReadyCallback callback,
                                     gpointer user_data);
static GFileOutputStream*
    g_file_real_create_finish(GFile* file, GAsyncResult* res, GError** error);
static void g_file_real_replace_async(GFile* file, const char* etag,
                                      ...
                                      gpointer user_data);
static GFileOutputStream*
    g_file_real_replace_finish(GFile* file, GAsyncResult* res, GError** error);
static void g_file_real_delete_async(GFile* file, int io_priority,
                                     GCancellable* cancellable,
                                     GAsyncReadyCallback callback,
                                     gpointer user_data);
static gboolean g_file_real_delete_finish(GFile* file, GAsyncResult* res,
                                          GError** error);
static void g_file_real_trash_async(GFile* file, int io_priority,
                                    GCancellable* cancellable,
                                    GAsyncReadyCallback callback,
                                    gpointer user_data);
static gboolean g_file_real_trash_finish(GFile* file, GAsyncResult* res,
                                         GError** error);
static void g_file_real_make_directory_async(GFile* file, int io_priority,
                                             GCancellable* cancellable,
                                             GAsyncReadyCallback callback,
                                             gpointer user_data);
static gboolean g_file_real_make_directory_finish(GFile* file,
                                                  GAsyncResult* res,
                                                  GError** error);
static void g_file_real_open_readwrite_async(GFile* file, int io_priority,
                                             GCancellable* cancellable,
                                             GAsyncReadyCallback callback,
                                             gpointer user_data);
...
static GFileIOStream* g_file_real_create_readwrite_finish(GFile* file,
                                                          GAsyncResult* res,
                                                          GError** error);
static void g_file_real_replace_readwrite_async(
    GFile* file, const char* etag, gboolean make_backup, GFileCreateFlags flags,
    int io_priority, GCancellable* cancellable, GAsyncReadyCallback callback,
    gpointer user_data);
...
static GFile* g_file_real_set_display_name_finish(GFile* file,
                                                  GAsyncResult* res,
                                                  GError** error);
static void g_file_real_set_attributes_async(GFile* file, GFileInfo* info,
                                             GFileQueryInfoFlags flags,
                                             int io_priority,
                                             GCancellable* cancellable,
                                             GAsyncReadyCallback callback,
...
static gboolean g_file_real_set_attributes_finish(GFile* file,
                                                  ...
                                                  GFileInfo** info,
                                                  GError** error);
static void g_file_real_find_enclosing_mount_async(GFile* file, int io_priority,
                                                   GCancellable* cancellable,
                                                   GAsyncReadyCallback callback,
                                                   gpointer user_data);
static GMount* g_file_real_find_enclosing_mount_finish(GFile* file,
                                                       GAsyncResult* res,
                                                       GError** error);
static void g_file_real_copy_async(GFile* source, GFile* destination,
                                   ...
                                   GAsyncReadyCallback callback,
                                   gpointer user_data);
static gboolean g_file_real_copy_finish(GFile* file, GAsyncResult* res,
                                        GError** error);

static gboolean g_file_real_measure_disk_usage(
    GFile* file, GFileMeasureFlags flags, GCancellable* cancellable,
...
static void g_file_real_measure_disk_usage_async(
    GFile* file, GFileMeasureFlags flags, gint io_priority,
    GCancellable* cancellable, GFileMeasureProgressCallback progress_callback,
    gpointer progress_data, GAsyncReadyCallback callback, gpointer user_data);
static gboolean g_file_real_measure_disk_usage_finish(
    GFile* file, GAsyncResult* result, guint64* disk_usage, guint64* num_dirs,
...
static void g_file_default_init(GFileIface* iface)
{
    ...
    iface->query_filesystem_info_async =
        g_file_real_query_filesystem_info_async;
    iface->query_filesystem_info_finish =
    ...
    iface->find_enclosing_mount_finish =
 ...
 */
static char* file_get_target_path(GFile* file)
{
    GFileInfo* info;
    const char* target;
    char* path;
    ...
    if (info == NULL)
        return NULL;
    target = g_file_info_get_attribute_string(
...
static const char* file_peek_path_generic(GFile* file)
{
    const char* path;
     ...
     * (g_object_get_qdata(…) == NULL) to begin with, both would generate and
     * add the path, but the second thread to add it would end up freeing the
     * path set by the first thread. The first thread would still return the
     * pointer to that freed path, though, resulting an a read-after-free.
     * Handle that with a compare-and-swap loop. The g_object_*_qdata()
    ...
    while (TRUE)
    {
        ...
        if (g_object_replace_qdata((GObject*)file, _file_path_quark, NULL,
                                   (gpointer)new_path, (GDestroyNotify)g_free,
                                   NULL))
            break;
        else
            g_free(new_path);
 ...
 *     Free the returned object with g_object_unref().
 */
GFile* g_file_get_child_for_display_name(GFile* file, const char* display_name,
                                         GError** error)
{
    GFileIface* iface;
 ...
 */
GFileEnumerator* g_file_enumerate_children(GFile* file, const char* attributes,
                                           GFileQueryInfoFlags flags,
                                           GCancellable* cancellable,
                                           GError** error)
{
    ...
    return (*iface->enumerate_children)(file, attributes, flags, cancellable,
                                        error);
}
 ...
 * the operation.
 */
void g_file_enumerate_children_async(GFile* file, const char* attributes,
                                     ...
                                     gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->enumerate_children_async)(file, attributes, flags, io_priority,
 ...
 * Since: 2.18
 */
GFileType g_file_query_file_type(GFile* file, GFileQueryInfoFlags flags,
                                 GCancellable* cancellable)
{
    GFileInfo* info;
    GFileType file_type;
 ...
 */
void g_file_query_info_async(GFile* file, const char* attributes,
                             GFileQueryInfoFlags flags, int io_priority,
                             GCancellable* cancellable,
                             GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->query_info_async)(file, attributes, flags, io_priority,
                               cancellable, callback, user_data);
}
 ...
 *     g_object_unref().
 */
GFileInfo* g_file_query_info_finish(GFile* file, GAsyncResult* res,
                                    GError** error)
{
    GFileIface* iface;
                                        ...
                                        GError** error)
{
    ...
    return (*iface->query_filesystem_info)(file, attributes, cancellable,
                                           error);
}
 ...
 * operation.
 */
void g_file_query_filesystem_info_async(GFile* file, const char* attributes,
                                        int io_priority,
                                        GCancellable* cancellable,
                                        GAsyncReadyCallback callback,
                                        gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->query_filesystem_info_async)(file, attributes, io_priority,
                                          cancellable, callback, user_data);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GFileInfo* g_file_query_filesystem_info_finish(GFile* file, GAsyncResult* res,
                                               GError** error)
{
    GFileIface* iface;
 ...
 *     Free the returned object with g_object_unref().
 */
GMount* g_file_find_enclosing_mount(GFile* file, GCancellable* cancellable,
                                    GError** error)
{
    GFileIface* iface;
 ...
 */
void g_file_find_enclosing_mount_async(GFile* file, int io_priority,
                                       GCancellable* cancellable,
                                       GAsyncReadyCallback callback,
                                       gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->find_enclosing_mount_async)(file, io_priority, cancellable,
                                         callback, user_data);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GMount* g_file_find_enclosing_mount_finish(GFile* file, GAsyncResult* res,
                                           GError** error)
{
    GFileIface* iface;
 ...
 *     Free the returned object with g_object_unref().
 */
GFileInputStream* g_file_read(GFile* file, GCancellable* cancellable,
                              GError** error)
{
    GFileIface* iface;
 ...
 *     Free the returned object with g_object_unref().
 */
GFileOutputStream* g_file_replace(GFile* file, const char* etag,
                                  ...
                                  GCancellable* cancellable, GError** error)
{
    ...
    return (*iface->replace)(file, etag, make_backup, flags, cancellable,
                             error);
}
 ...
 * Since: 2.22
 */
GFileIOStream* g_file_open_readwrite(GFile* file, GCancellable* cancellable,
                                     GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.22
 */
GFileIOStream* g_file_create_readwrite(GFile* file, GFileCreateFlags flags,
                                       GCancellable* cancellable,
                                       GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.22
 */
GFileIOStream* g_file_replace_readwrite(GFile* file, const char* etag,
                                        gboolean make_backup,
                                        GFileCreateFlags flags,
                                        GCancellable* cancellable,
                                        GError** error)
{
    ...
    return (*iface->replace_readwrite)(file, etag, make_backup, flags,
                                       cancellable, error);
}
 ...
 * of the operation.
 */
void g_file_read_async(GFile* file, int io_priority, GCancellable* cancellable,
                       GAsyncReadyCallback callback, gpointer user_data)
{
    GFileIface* iface;
 ...
 *     Free the returned object with g_object_unref().
 */
GFileInputStream* g_file_read_finish(GFile* file, GAsyncResult* res,
                                     GError** error)
{
    GFileIface* iface;
 ...
 * of the operation.
 */
void g_file_append_to_async(GFile* file, GFileCreateFlags flags,
                            int io_priority, GCancellable* cancellable,
                            GAsyncReadyCallback callback, gpointer user_data)
{
    GFileIface* iface;
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->append_to_async)(file, flags, io_priority, cancellable, callback,
                              user_data);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GFileOutputStream* g_file_append_to_finish(GFile* file, GAsyncResult* res,
                                           GError** error)
{
    GFileIface* iface;
 ...
 * of the operation.
 */
void g_file_create_async(GFile* file, GFileCreateFlags flags, int io_priority,
                         GCancellable* cancellable,
                         GAsyncReadyCallback callback, gpointer user_data)
{
    GFileIface* iface;
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->create_async)(file, flags, io_priority, cancellable, callback,
                           user_data);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GFileOutputStream* g_file_create_finish(GFile* file, GAsyncResult* res,
                                        GError** error)
{
    GFileIface* iface;
 ...
 * of the operation.
 */
void g_file_replace_async(GFile* file, const char* etag, gboolean make_backup,
                          GFileCreateFlags flags, int io_priority,
                          GCancellable* cancellable,
                          GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->replace_async)(file, etag, make_backup, flags, io_priority,
                            cancellable, callback, user_data);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GFileOutputStream* g_file_replace_finish(GFile* file, GAsyncResult* res,
                                         GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.22
 */
void g_file_open_readwrite_async(GFile* file, int io_priority,
                                 GCancellable* cancellable,
                                 GAsyncReadyCallback callback,
                                 gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->open_readwrite_async)(file, io_priority, cancellable, callback,
                                   user_data);
}
 ...
 * Since: 2.22
 */
GFileIOStream* g_file_open_readwrite_finish(GFile* file, GAsyncResult* res,
                                            GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.22
 */
void g_file_create_readwrite_async(GFile* file, GFileCreateFlags flags,
                                   int io_priority, GCancellable* cancellable,
                                   GAsyncReadyCallback callback,
                                   gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->create_readwrite_async)(file, flags, io_priority, cancellable,
                                     callback, user_data);
}
 ...
 * Since: 2.22
 */
GFileIOStream* g_file_create_readwrite_finish(GFile* file, GAsyncResult* res,
                                              GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.22
 */
void g_file_replace_readwrite_async(GFile* file, const char* etag,
                                    gboolean make_backup,
                                    GFileCreateFlags flags, int io_priority,
                                    GCancellable* cancellable,
                                    GAsyncReadyCallback callback,
                                    gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->replace_readwrite_async)(file, etag, make_backup, flags,
 ...
 * Since: 2.22
 */
GFileIOStream* g_file_replace_readwrite_finish(GFile* file, GAsyncResult* res,
                                               GError** error)
{
    GFileIface* iface;
...
static gboolean copy_symlink(GFile* destination, GFileCopyFlags flags,
                             GCancellable* cancellable, const char* target,
                             GError** error)
{
    GError* my_error;
...
retry:
    ...
    if (!g_file_make_symbolic_link(destination, target, cancellable, &my_error))
    {
        ...
        if (!tried_delete && (flags & G_FILE_COPY_OVERWRITE) &&
            ...
            my_error->code == G_IO_ERROR_EXISTS)
        {
            ...
            info = g_file_query_info(
                ...
                G_FILE_QUERY_INFO_NOFOLLOW_SYMLINKS, cancellable, &my_error);
            if (info != NULL)
            {
                file_type = g_file_info_get_file_type(info);
                g_object_unref(info);
...
static GFileInputStream* open_source_for_copy(GFile* source, GFile* destination,
                                              ...
                                              GError** error)
{
    ...
    if (my_error->domain == G_IO_ERROR &&
        my_error->code == G_IO_ERROR_IS_DIRECTORY)
    {
            ...
            g_file_info_has_attribute(info, G_FILE_ATTRIBUTE_STANDARD_TYPE))
        {
            ...
            if (flags & G_FILE_COPY_OVERWRITE)
            {
                ...
                {
                    g_set_error_literal(
                        error, G_IO_ERROR, G_IO_ERROR_WOULD_MERGE,
...
static gboolean should_copy(GFileAttributeInfo* info,
                            gboolean copy_all_attributes, gboolean skip_perms)
{
...
static gboolean build_attribute_list_for_copy(GFile* file, GFileCopyFlags flags,
                                              char** out_attributes,
                                              GCancellable* cancellable,
                                              GError** error)
{
    ...
    if (attributes)
    {
        ...
        {
            if (should_copy(&attributes->infos[i], copy_all_attributes,
                            skip_perms))
            {
                if (first)
                    first = FALSE;
 ...
 *     %FALSE otherwise.
 */
gboolean g_file_copy_attributes(GFile* source, GFile* destination,
                                ...
                                GError** error)
{
    ...
    if (info)
    {
        res = g_file_set_attributes_from_info(
            destination, info, G_FILE_QUERY_INFO_NOFOLLOW_SYMLINKS, cancellable,
            error);
        g_object_unref(info);
    }
...
static gboolean
    copy_stream_with_progress(GInputStream* in, GOutputStream* out,
                              GFile* source, GCancellable* cancellable,
                              GFileProgressCallback progress_callback,
                              gpointer progress_callback_data, GError** error)
{
    ...
    if (progress_callback)
    {
        ...
        if (total_size == -1)
        {
            info = g_file_query_info(source, G_FILE_ATTRIBUTE_STANDARD_SIZE,
                                     G_FILE_QUERY_INFO_NONE, cancellable, NULL);
            if (info)
            {
    ...
    while (TRUE)
    {
        n_read = g_input_stream_read(in, buffer, STREAM_BUFFER_SIZE,
                                     cancellable, error);
        if (n_read == -1)
        {
            res = FALSE;
        ...
        res = g_output_stream_write_all(out, buffer, n_read, &n_written,
                                        cancellable, error);
        if (!res)
            break;
...
static gboolean do_splice(int fd_in, loff_t* off_in, int fd_out,
                          loff_t* off_out, size_t len, long* bytes_transferd,
                          GError** error)
{
    long result;
...
static gboolean
    splice_stream_with_progress(GInputStream* in, GOutputStream* out,
                                GCancellable* cancellable,
                                GFileProgressCallback progress_callback,
                                gpointer progress_callback_data, GError** error)
{
     ...
     * but ≥ 2.6.11, meaning the pipe capacity is 64KiB. Ignore the possibility
     * of running on Linux < 2.6.11 (where the capacity was the system page
     * size, typically 4KiB) because it’s ancient. See pipe(7). */
    buffer_size = 1024 * 64;
#endif
    ...
    while (TRUE)
    {
        ...
        if (!do_splice(fd_in, &offset_in, buffer[1], NULL, buffer_size, &n_read,
                       error))
            break;
        ...
        while (n_read > 0)
        {
            ...
            if (!do_splice(buffer[0], NULL, fd_out, &offset_out, n_read,
                           &n_written, error))
                goto out;
...
#ifdef __linux__
static gboolean
    btrfs_reflink_with_progress(GInputStream* in, GOutputStream* out,
                                GFileInfo* info, GCancellable* cancellable,
                                GFileProgressCallback progress_callback,
                                gpointer progress_callback_data, GError** error)
{
    goffset source_size;
...
static gboolean file_copy_fallback(GFile* source, GFile* destination,
                                   GFileCopyFlags flags,
                                   GCancellable* cancellable,
                                   GFileProgressCallback progress_callback,
                                   gpointer progress_callback_data,
                                   GError** error)
{
    ...
    file_in =
        open_source_for_copy(source, destination, flags, cancellable, error);
    if (!file_in)
        goto out;
    ...
    if (attrs_to_read != NULL)
    {
        ...
        if (!info)
        {
             ...
             */
            if (g_error_matches(tmp_error, G_IO_ERROR,
    ...
    if (G_IS_LOCAL_FILE(destination))
    {
        if (flags & G_FILE_COPY_OVERWRITE)
            out = (GOutputStream*)_g_local_file_output_stream_replace(
                _g_local_file_get_filename(G_LOCAL_FILE(destination)), FALSE,
                NULL, flags & G_FILE_COPY_BACKUP,
                G_FILE_CREATE_REPLACE_DESTINATION | G_FILE_CREATE_PRIVATE, info,
                cancellable, error);
        else
            out = (GOutputStream*)_g_local_file_output_stream_create(
                _g_local_file_get_filename(G_LOCAL_FILE(destination)), FALSE,
                G_FILE_CREATE_PRIVATE, info, cancellable, error);
    }
    else if (flags & G_FILE_COPY_OVERWRITE)
    {
        out = (GOutputStream*)g_file_replace(
            destination, NULL, flags & G_FILE_COPY_BACKUP,
            G_FILE_CREATE_REPLACE_DESTINATION | G_FILE_CREATE_PRIVATE,
            cancellable, error);
    }
    else
    {
        out = (GOutputStream*)g_file_create(destination, G_FILE_CREATE_PRIVATE,
                                            cancellable, error);
    }
    ...
    if (G_IS_FILE_DESCRIPTOR_BASED(in) && G_IS_FILE_DESCRIPTOR_BASED(out))
    {
        ...
        if (!btrfs_reflink_with_progress(in, out, info, cancellable,
                                         progress_callback,
                                         progress_callback_data, &reflink_err))
        {
            if (g_error_matches(reflink_err, G_IO_ERROR,
                                G_IO_ERROR_NOT_SUPPORTED))
            {
    ...
    if (G_IS_FILE_DESCRIPTOR_BASED(in) && G_IS_FILE_DESCRIPTOR_BASED(out))
    {
        ...
        if (!splice_stream_with_progress(in, out, cancellable,
                                         progress_callback,
                                         progress_callback_data, &splice_err))
        {
            if (g_error_matches(splice_err, G_IO_ERROR,
                                G_IO_ERROR_NOT_SUPPORTED))
            {
...
out:
    ...
    {
        g_file_set_attributes_from_info(destination, info,
                                        G_FILE_QUERY_INFO_NOFOLLOW_SYMLINKS,
                                        cancellable, NULL);
    }
                     ...
                     gpointer progress_callback_data, GError** error)
{
    ...
    {
        my_error = NULL;
        res = (*iface->copy)(source, destination, flags, cancellable,
                             progress_callback, progress_callback_data,
                             &my_error);
        ...
        if (my_error->domain != G_IO_ERROR ||
            my_error->code != G_IO_ERROR_NOT_SUPPORTED)
        {
            g_propagate_error(error, my_error);
            return FALSE;
        }
 ...
 * @cancellable: (nullable): optional #GCancellable object,
 *     %NULL to ignore
 * @progress_callback: (nullable) (scope notified): function to callback with
 * progress information, or %NULL if progress information is not needed
 * @progress_callback_data: (closure progress_callback) (nullable): user data to
 ...
 */
void g_file_copy_async(GFile* source, GFile* destination, GFileCopyFlags flags,
                       int io_priority, GCancellable* cancellable,
                       GFileProgressCallback progress_callback,
                       gpointer progress_callback_data,
                       GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(source);
    (*iface->copy_async)(source, destination, flags, io_priority, cancellable,
                         progress_callback, progress_callback_data, callback,
                         user_data);
}
                     ...
                     gpointer progress_callback_data, GError** error)
{
    ...
    {
        my_error = NULL;
        res = (*iface->move)(source, destination, flags, cancellable,
                             progress_callback, progress_callback_data,
                             &my_error);
    ...
    if (!g_file_copy(source, destination, flags, cancellable, progress_callback,
                     progress_callback_data, error))
        return FALSE;
 ...
 */
gboolean g_file_make_directory(GFile* file, GCancellable* cancellable,
                               GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.38
 */
void g_file_make_directory_async(GFile* file, int io_priority,
                                 GCancellable* cancellable,
                                 GAsyncReadyCallback callback,
                                 gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->make_directory_async)(file, io_priority, cancellable, callback,
                                   user_data);
}
 ...
 * Since: 2.38
 */
gboolean g_file_make_directory_finish(GFile* file, GAsyncResult* result,
                                      GError** error)
{
    GFileIface* iface;
    ...
    while (g_error_matches(my_error, G_IO_ERROR, G_IO_ERROR_NOT_FOUND))
    {
        ...
        if (g_error_matches(my_error, G_IO_ERROR, G_IO_ERROR_NOT_FOUND))
            list = g_list_prepend(list,
                                  parent_file); /* Transfer ownership of ref */
        else
 ...
 */
gboolean g_file_make_symbolic_link(GFile* file, const char* symlink_value,
                                   GCancellable* cancellable, GError** error)
{
    GFileIface* iface;
    ...
    return (*iface->make_symbolic_link)(file, symlink_value, cancellable,
                                        error);
}
 ...
 * Since: 2.34
 */
void g_file_delete_async(GFile* file, int io_priority,
                         GCancellable* cancellable,
                         GAsyncReadyCallback callback, gpointer user_data)
{
    GFileIface* iface;
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->delete_file_async)(file, io_priority, cancellable, callback,
                                user_data);
}
 ...
 * Since: 2.38
 */
void g_file_trash_async(GFile* file, int io_priority, GCancellable* cancellable,
                        GAsyncReadyCallback callback, gpointer user_data)
{
    GFileIface* iface;
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->trash_async)(file, io_priority, cancellable, callback, user_data);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GFile* g_file_set_display_name(GFile* file, const gchar* display_name,
                               GCancellable* cancellable, GError** error)
{
    GFileIface* iface;
 ...
 * the result of the operation.
 */
void g_file_set_display_name_async(GFile* file, const gchar* display_name,
                                   ...
                                   gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->set_display_name_async)(file, display_name, io_priority,
                                     cancellable, callback, user_data);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GFile* g_file_set_display_name_finish(GFile* file, GAsyncResult* res,
                                      GError** error)
{
    GFileIface* iface;
...
GFileAttributeInfoList*
    g_file_query_settable_attributes(GFile* file, GCancellable* cancellable,
                                     GError** error)
{
    GFileIface* iface;
    GError* my_error;
 ...
 */
GFileAttributeInfoList*
    g_file_query_writable_namespaces(GFile* file, GCancellable* cancellable,
                                     GError** error)
{
    GFileIface* iface;
    GError* my_error;
 ...
 */
gboolean g_file_set_attribute(GFile* file, const gchar* attribute,
                              ...
                              GCancellable* cancellable, GError** error)
{
    ...
    return (*iface->set_attribute)(file, attribute, type, value_p, flags,
                                   cancellable, error);
}
 ...
 */
gboolean g_file_set_attributes_from_info(GFile* file, GFileInfo* info,
                                         GFileQueryInfoFlags flags,
                                         GCancellable* cancellable,
                                         GError** error)
{
    ...
    return (*iface->set_attributes_from_info)(file, info, flags, cancellable,
                                              error);
}
                                                     ...
                                                     GError** error)
{
    ...
    for (i = 0; attributes[i] != NULL; i++)
    {
        ...
        if (!g_file_set_attribute(
                file, attributes[i], value->type,
                _g_file_attribute_value_peek_as_pointer(value), flags,
                cancellable, error))
        {
 ...
 * the result of the operation.
 */
void g_file_set_attributes_async(GFile* file, GFileInfo* info,
                                 GFileQueryInfoFlags flags, int io_priority,
                                 GCancellable* cancellable,
                                 GAsyncReadyCallback callback,
                                 gpointer user_data)
{
    ...
    iface = G_FILE_GET_IFACE(file);
    (*iface->set_attributes_async)(file, info, flags, io_priority, cancellable,
                                   callback, user_data);
}
 ...
 */
gboolean g_file_set_attributes_finish(GFile* file, GAsyncResult* result,
 ...
 */
gboolean g_file_set_attribute_string(GFile* file, const char* attribute,
                                     const char* value,
                                     GFileQueryInfoFlags flags,
                                     GCancellable* cancellable, GError** error)
{
    return g_file_set_attribute(file, attribute, G_FILE_ATTRIBUTE_TYPE_STRING,
                                (gpointer)value, flags, cancellable, error);
}
 ...
 */
gboolean g_file_set_attribute_byte_string(GFile* file, const gchar* attribute,
                                          const gchar* value,
                                          GFileQueryInfoFlags flags,
                                          GCancellable* cancellable,
                                          GError** error)
 ...
 *     in the @file, %FALSE otherwise.
 */
gboolean g_file_set_attribute_uint32(GFile* file, const gchar* attribute,
                                     guint32 value, GFileQueryInfoFlags flags,
                                     GCancellable* cancellable, GError** error)
{
    return g_file_set_attribute(file, attribute, G_FILE_ATTRIBUTE_TYPE_UINT32,
 ...
 *     in the @file, %FALSE otherwise.
 */
gboolean g_file_set_attribute_int32(GFile* file, const gchar* attribute,
                                    gint32 value, GFileQueryInfoFlags flags,
                                    GCancellable* cancellable, GError** error)
{
    return g_file_set_attribute(file, attribute, G_FILE_ATTRIBUTE_TYPE_INT32,
                                &value, flags, cancellable, error);
}
 ...
 *     in the @file, %FALSE otherwise.
 */
gboolean g_file_set_attribute_uint64(GFile* file, const gchar* attribute,
                                     guint64 value, GFileQueryInfoFlags flags,
                                     GCancellable* cancellable, GError** error)
{
    return g_file_set_attribute(file, attribute, G_FILE_ATTRIBUTE_TYPE_UINT64,
                                &value, flags, cancellable, error);
}
 ...
 * Returns: %TRUE if the @attribute was successfully set, %FALSE otherwise.
 */
gboolean g_file_set_attribute_int64(GFile* file, const gchar* attribute,
                                    gint64 value, GFileQueryInfoFlags flags,
                                    GCancellable* cancellable, GError** error)
{
    return g_file_set_attribute(file, attribute, G_FILE_ATTRIBUTE_TYPE_INT64,
                                &value, flags, cancellable, error);
}
 ...
 * the result of the operation.
 */
void g_file_mount_mountable(GFile* file, GMountMountFlags flags,
                            ...
                            GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->mount_mountable == NULL)
    {
        g_task_report_new_error(
            file, callback, user_data, g_file_mount_mountable, G_IO_ERROR,
            G_IO_ERROR_NOT_SUPPORTED, _("Operation not supported"));
        return;
    }

    (*iface->mount_mountable)(file, flags, mount_operation, cancellable,
                              callback, user_data);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GFile* g_file_mount_mountable_finish(GFile* file, GAsyncResult* result,
                                     GError** error)
{
    GFileIface* iface;
 ...
 */
void g_file_unmount_mountable(GFile* file, GMountUnmountFlags flags,
                              GCancellable* cancellable,
                              GAsyncReadyCallback callback, gpointer user_data)
{
    GFileIface* iface;
    ...
    {
        g_task_report_new_error(
            file, callback, user_data, g_file_unmount_mountable_with_operation,
            G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("Operation not supported"));
        return;
    }
 ...
 *     instead.
 */
gboolean g_file_unmount_mountable_finish(GFile* file, GAsyncResult* result,
                                         GError** error)
{
    GFileIface* iface;
    ...
    if (g_async_result_legacy_propagate_error(result, error))
        return FALSE;
    else if (g_async_result_is_tagged(result,
    ...
    GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->unmount_mountable == NULL &&
        iface->unmount_mountable_with_operation == NULL)
    {
        g_task_report_new_error(
            file, callback, user_data, g_file_unmount_mountable_with_operation,
            G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("Operation not supported"));
    ...
    if (iface->unmount_mountable_with_operation != NULL)
        (*iface->unmount_mountable_with_operation)(
            file, flags, mount_operation, cancellable, callback, user_data);
    else
        (*iface->unmount_mountable)(file, flags, cancellable, callback,
                                    user_data);
}
                                                        ...
                                                        GError** error)
{
    ...
    if (iface->unmount_mountable_with_operation_finish != NULL)
        return (*iface->unmount_mountable_with_operation_finish)(file, result,
                                                                 error);
    else
        return (*iface->unmount_mountable_finish)(file, result, error);
}
 ...
 */
void g_file_eject_mountable(GFile* file, GMountUnmountFlags flags,
                            GCancellable* cancellable,
                            GAsyncReadyCallback callback, gpointer user_data)
{
    GFileIface* iface;
    ...
    {
        g_task_report_new_error(
            file, callback, user_data, g_file_eject_mountable_with_operation,
            G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("Operation not supported"));
        return;
    }
 ...
 *     instead.
 */
gboolean g_file_eject_mountable_finish(GFile* file, GAsyncResult* result,
                                       GError** error)
{
    GFileIface* iface;
    ...
    GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->eject_mountable == NULL &&
        iface->eject_mountable_with_operation == NULL)
    {
        g_task_report_new_error(
            file, callback, user_data, g_file_eject_mountable_with_operation,
            G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("Operation not supported"));
    ...
    if (iface->eject_mountable_with_operation != NULL)
        ...
        (*iface->eject_mountable)(file, flags, cancellable, callback,
                                  user_data);
}
                                                      ...
                                                      GError** error)
{
    ...
    if (iface->eject_mountable_with_operation_finish != NULL)
        return (*iface->eject_mountable_with_operation_finish)(file, result,
                                                               error);
    else
        return (*iface->eject_mountable_finish)(file, result, error);
}
 ...
 *     Free the returned object with g_object_unref().
 */
GFileMonitor* g_file_monitor_directory(GFile* file, GFileMonitorFlags flags,
                                       GCancellable* cancellable,
                                       GError** error)
{
    GFileIface* iface;
 ...
 *     Free the returned object with g_object_unref().
 */
GFileMonitor* g_file_monitor_file(GFile* file, GFileMonitorFlags flags,
                                  GCancellable* cancellable, GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.18
 */
GFileMonitor* g_file_monitor(GFile* file, GFileMonitorFlags flags,
                             GCancellable* cancellable, GError** error)
{
    if (g_file_query_file_type(file, 0, cancellable) == G_FILE_TYPE_DIRECTORY)
        return g_file_monitor_directory(
            file, flags & ~G_FILE_MONITOR_WATCH_HARD_LINKS, cancellable, error);
    else
...
static void query_info_async_thread(GTask* task, gpointer object,
                                    gpointer task_data,
                                    GCancellable* cancellable)
{
    ...
    info = g_file_query_info(G_FILE(object), data->attributes, data->flags,
                             cancellable, &error);
    if (info)
...
static void query_filesystem_info_async_thread(GTask* task, gpointer object,
                                               gpointer task_data,
                                               GCancellable* cancellable)
{
    ...
    info = g_file_query_filesystem_info(G_FILE(object), attributes, cancellable,
                                        &error);
    if (info)
        g_task_return_pointer(task, info, g_object_unref);
    else
...
static void enumerate_children_async_thread(GTask* task, gpointer object,
                                            gpointer task_data,
                                            GCancellable* cancellable)
{
    QueryInfoAsyncData* data = task_data;
    ...
    enumerator = g_file_enumerate_children(G_FILE(object), data->attributes,
                                           data->flags, cancellable, &error);
    if (error)
        g_task_return_error(task, error);
    else
...
static void open_read_async_thread(GTask* task, gpointer object,
                                   gpointer task_data,
                                   GCancellable* cancellable)
{
...
static void append_to_async_thread(GTask* task, gpointer source_object,
                                   gpointer task_data,
                                   GCancellable* cancellable)
{
    ...
    stream =
        g_file_append_to(G_FILE(source_object), *data, cancellable, &error);
    if (stream)
        g_task_return_pointer(task, stream, g_object_unref);
    else
        g_task_return_error(task, error);
...
static GFileOutputStream*
    g_file_real_append_to_finish(GFile* file, GAsyncResult* res, GError** error)
{
    g_return_val_if_fail(g_task_is_valid(res, file), NULL);
...
static void create_async_thread(GTask* task, gpointer source_object,
...
static void replace_async_thread(GTask* task, gpointer source_object,
                                 gpointer task_data, GCancellable* cancellable)
{
    GFileOutputStream* stream;
    ...
    stream =
        g_file_replace(G_FILE(source_object), data->etag, data->make_backup,
                       data->flags, cancellable, &error);
...
static void delete_async_thread(GTask* task, gpointer object,
                                gpointer task_data, GCancellable* cancellable)
{
    GError* error = NULL;
...
static void trash_async_thread(GTask* task, gpointer object, gpointer task_data,
                               GCancellable* cancellable)
{
    GError* error = NULL;
...
static void make_directory_async_thread(GTask* task, gpointer object,
                                        gpointer task_data,
                                        GCancellable* cancellable)
{
    GError* error = NULL;
...
static void open_readwrite_async_thread(GTask* task, gpointer object,
                                        gpointer task_data,
                                        GCancellable* cancellable)
{
...
static void create_readwrite_async_thread(GTask* task, gpointer object,
                                          gpointer task_data,
                                          GCancellable* cancellable)
{
    GFileCreateFlags* data = task_data;
    ...
    stream =
        g_file_create_readwrite(G_FILE(object), *data, cancellable, &error);
...
static void g_file_real_create_readwrite_async(
    GFile* file, GFileCreateFlags flags, int io_priority,
    GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    GFileCreateFlags* data;
    GTask* task;
...
static void replace_readwrite_async_thread(GTask* task, gpointer object,
                                           gpointer task_data,
                                           GCancellable* cancellable)
{
    GFileIOStream* stream;
    ...
    stream =
        g_file_replace_readwrite(G_FILE(object), data->etag, data->make_backup,
                                 data->flags, cancellable, &error);
    ...
    gpointer user_data)
{
    ...
    g_task_set_task_data(task, data,
                         (GDestroyNotify)replace_rw_async_data_free);
    g_task_set_priority(task, io_priority);
...
static void set_display_name_async_thread(GTask* task, gpointer object,
                                          gpointer task_data,
                                          GCancellable* cancellable)
{
    GError* error = NULL;
...
static void g_file_real_set_display_name_async(
    GFile* file, const char* display_name, int io_priority,
    GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    GTask* task;
...
static void set_info_async_thread(GTask* task, gpointer object,
                                  gpointer task_data, GCancellable* cancellable)
{
    SetInfoAsyncData* data = task_data;

    data->error = NULL;
    data->res = g_file_set_attributes_from_info(
        G_FILE(object), data->info, data->flags, cancellable, &data->error);
}

static void g_file_real_set_attributes_async(
    GFile* file, GFileInfo* info, GFileQueryInfoFlags flags, int io_priority,
    GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    GTask* task;
...
static void find_enclosing_mount_async_thread(GTask* task, gpointer object,
                                              gpointer task_data,
                                              GCancellable* cancellable)
{
    GError* error = NULL;
...
static gboolean copy_async_progress_in_main(gpointer user_data)
{
    ...
    data->progress_cb(progress->current_num_bytes, progress->total_num_bytes,
                      data->progress_cb_data);

    return FALSE;
}

static void copy_async_progress_callback(goffset current_num_bytes,
                                         goffset total_num_bytes,
                                         gpointer user_data)
{
    ...
    g_main_context_invoke_full(g_task_get_context(task),
                               ...
                               copy_async_progress_in_main, progress, g_free);
}

static void copy_async_thread(GTask* task, gpointer source, gpointer task_data,
                              GCancellable* cancellable)
{
    ...
    result = g_file_copy(
        data->source, data->destination, data->flags, cancellable,
        (data->progress_cb != NULL) ? copy_async_progress_callback : NULL, task,
        &error);
    if (result)
        g_task_return_boolean(task, TRUE);
    else
 ...
 * Since: 2.32
 */
GFile* g_file_new_tmp(const char* tmpl, GFileIOStream** iostream,
                      GError** error)
{
    gint fd;
    gchar* path;
...
static GFile* new_for_cmdline_arg(const gchar* arg, const gchar* cwd)
{
    GFile* file;
    char* filename;
 ...
 * was cancelled, the error %G_IO_ERROR_CANCELLED will be returned.
 */
void g_file_mount_enclosing_volume(GFile* location, GMountMountFlags flags,
                                   GMountOperation* mount_operation,
                                   GCancellable* cancellable,
                                   GAsyncReadyCallback callback,
                                   gpointer user_data)
{
    ...
    if (iface->mount_enclosing_volume == NULL)
    {
        g_task_report_new_error(location, callback, user_data,
                                g_file_mount_enclosing_volume, G_IO_ERROR,
                                G_IO_ERROR_NOT_SUPPORTED,
                                _("volume doesn’t implement mount"));
        return;
    }

    (*iface->mount_enclosing_volume)(location, flags, mount_operation,
                                     cancellable, callback, user_data);
}
 ...
 */
GAppInfo* g_file_query_default_handler(GFile* file, GCancellable* cancellable,
                                       GError** error)
{
    char* uri_scheme;
    ...
    info = g_file_query_info(file, G_FILE_ATTRIBUTE_STANDARD_CONTENT_TYPE, 0,
                             cancellable, error);
    if (info == NULL)
        return NULL;
...
static void query_default_handler_query_info_cb(GObject* object,
                                                GAsyncResult* result,
                                                gpointer user_data)
{
 ...
 * Since: 2.60
 */
void g_file_query_default_handler_async(GFile* file, int io_priority,
                                        GCancellable* cancellable,
                                        GAsyncReadyCallback callback,
                                        gpointer user_data)
{
    ...
    if (uri_scheme && uri_scheme[0] != '\0')
    {
        ...
        if (appinfo != NULL)
        {
            g_task_return_pointer(task, g_steal_pointer(&appinfo),
                                  g_object_unref);
            g_object_unref(task);
            return;
        }
    ...
    g_file_query_info_async(file, G_FILE_ATTRIBUTE_STANDARD_CONTENT_TYPE, 0,
 ...
 * Since: 2.60
 */
GAppInfo* g_file_query_default_handler_finish(GFile* file, GAsyncResult* result,
                                              GError** error)
{
    g_return_val_if_fail(G_IS_FILE(file), NULL);
 ...
 * the file, or %NULL if the length is not needed
 * @etag_out: (out) (optional): a location to place the current entity tag for
 * the file, or %NULL if the entity tag is not needed
 * @error: a #GError, or %NULL
 *
...
gboolean g_file_load_contents(GFile* file, GCancellable* cancellable,
                              char** contents, gsize* length, char** etag_out,
                              GError** error)
{
    GFileInputStream* in;
    GByteArray* content;
    ...
    while ((res = g_input_stream_read(G_INPUT_STREAM(in), content->data + pos,
                                      GET_CONTENT_BLOCK_SIZE, cancellable,
                                      error)) > 0)
    {
        pos += res;
        g_byte_array_set_size(content, pos + GET_CONTENT_BLOCK_SIZE + 1);
    ...
    if (etag_out)
    {
        *etag_out = NULL;
        ...
        info = g_file_input_stream_query_info(in, G_FILE_ATTRIBUTE_ETAG_VALUE,
                                              cancellable, NULL);
        if (info)
        {
...
static void load_contents_close_callback(GObject* obj, GAsyncResult* close_res,
                                         gpointer user_data)
{
...
static void load_contents_fstat_callback(GObject* obj, GAsyncResult* stat_res,
                                         gpointer user_data)
{
    GInputStream* stream = G_INPUT_STREAM(obj);
    LoadContentsData* data = user_data;
    ...
    g_input_stream_close_async(stream, 0, g_task_get_cancellable(data->task),
                               load_contents_close_callback, data);
}

static void load_contents_read_callback(GObject* obj, GAsyncResult* read_res,
                                        gpointer user_data)
{
    GInputStream* stream = G_INPUT_STREAM(obj);
    LoadContentsData* data = user_data;
    ...
    else if (read_size == 0)
    {
        g_file_input_stream_query_info_async(
            G_FILE_INPUT_STREAM(stream), G_FILE_ATTRIBUTE_ETAG_VALUE, 0,
            g_task_get_cancellable(data->task), load_contents_fstat_callback,
            data);
    }
    else if (read_size > 0)
    {
        ...
        if (data->read_more_callback &&
            !data->read_more_callback(
                (char*)data->content->data, data->pos,
                g_async_result_get_user_data(G_ASYNC_RESULT(data->task))))
            g_file_input_stream_query_info_async(
                G_FILE_INPUT_STREAM(stream), G_FILE_ATTRIBUTE_ETAG_VALUE, 0,
                g_task_get_cancellable(data->task),
                load_contents_fstat_callback, data);
        else
            g_input_stream_read_async(stream, data->content->data + data->pos,
                                      GET_CONTENT_BLOCK_SIZE, 0,
                                      g_task_get_cancellable(data->task),
                                      load_contents_read_callback, data);
    }
}

static void load_contents_open_callback(GObject* obj, GAsyncResult* open_res,
                                        gpointer user_data)
{
    ...
    if (stream)
    {
        ...
        g_input_stream_read_async(
            G_INPUT_STREAM(stream), data->content->data + data->pos,
            GET_CONTENT_BLOCK_SIZE, 0, g_task_get_cancellable(data->task),
            load_contents_read_callback, data);
    }
    else
    {
...
void g_file_load_partial_contents_async(
    ...
    GFileReadMoreCallback read_more_callback, GAsyncReadyCallback callback,
    gpointer user_data)
{
    ...
    g_task_set_task_data(data->task, data,
                         (GDestroyNotify)load_contents_data_free);

    g_file_read_async(file, 0, g_task_get_cancellable(data->task),
                      load_contents_open_callback, data);
}
 ...
 */
gboolean g_file_load_partial_contents_finish(GFile* file, GAsyncResult* res,
 ...
 * was cancelled, the error %G_IO_ERROR_CANCELLED will be returned.
 */
void g_file_load_contents_async(GFile* file, GCancellable* cancellable,
                                GAsyncReadyCallback callback,
                                gpointer user_data)
{
    g_file_load_partial_contents_async(file, cancellable, NULL, callback,
                                       user_data);
}
 ...
 *     present, it will be set appropriately.
 */
gboolean g_file_load_contents_finish(GFile* file, GAsyncResult* res,
                                     char** contents, gsize* length,
                                     char** etag_out, GError** error)
{
    return g_file_load_partial_contents_finish(file, res, contents, length,
                                               etag_out, error);
}
 ...
 * @file: input #GFile
 * @contents: (element-type guint8) (array length=length): a string containing
 * the new contents for @file
 ...
 */
gboolean g_file_replace_contents(GFile* file, const char* contents,
                                 gsize length, const char* etag,
                                 gboolean make_backup, GFileCreateFlags flags,
                                 char** new_etag, GCancellable* cancellable,
                                 GError** error)
{
    ...
    remainder = length;
    while (remainder > 0 &&
           (res = g_output_stream_write(G_OUTPUT_STREAM(out), contents + pos,
...
static void replace_contents_close_callback(GObject* obj,
...
static void replace_contents_write_callback(GObject* obj,
                                            ...
                                            gpointer user_data)
{
    ...
    else if (write_size > 0)
    {
        ...
        if (data->pos >= length)
            ...
            g_output_stream_write_async(stream, content + data->pos,
                                        length - data->pos, 0,
                                        g_task_get_cancellable(data->task),
...
static void replace_contents_open_callback(GObject* obj, GAsyncResult* open_res,
                                           gpointer user_data)
{
    GFile* file = G_FILE(obj);
    GFileOutputStream* stream;
    ...
    if (stream)
    {
        ...
        g_output_stream_write_async(G_OUTPUT_STREAM(stream),
                                    content + data->pos, length - data->pos, 0,
                                    g_task_get_cancellable(data->task),
                                    replace_contents_write_callback, data);
    }
    else
 ...
 * @file: input #GFile
 * @contents: (element-type guint8) (array length=length): string of contents to
 ...
 */
void g_file_replace_contents_async(GFile* file, const char* contents,
                                   gsize length, const char* etag,
                                   gboolean make_backup, GFileCreateFlags flags,
                                   GCancellable* cancellable,
                                   GAsyncReadyCallback callback,
 ...
 * Since: 2.40
 */
void g_file_replace_contents_bytes_async(GFile* file, GBytes* contents,
                                         ...
                                         gpointer user_data)
{
    ...
    g_task_set_task_data(data->task, data,
                         (GDestroyNotify)replace_contents_data_free);

    g_file_replace_async(file, etag, make_backup, flags, 0,
                         g_task_get_cancellable(data->task),
                         replace_contents_open_callback, data);
}
 ...
 */
gboolean g_file_replace_contents_finish(GFile* file, GAsyncResult* res,
                                        char** new_etag, GError** error)
{
    GTask* task;
    ReplaceContentsData* data;
...
gboolean g_file_real_measure_disk_usage(
    GFile* file, GFileMeasureFlags flags, GCancellable* cancellable,
    GFileMeasureProgressCallback progress_callback, gpointer progress_data,
    guint64* disk_usage, guint64* num_dirs, guint64* num_files, GError** error)
{
...
static gboolean measure_disk_usage_invoke_progress(gpointer user_data)
{
    MeasureProgress* progress = user_data;

    (*progress->callback)(progress->reporting, progress->current_size,
                          progress->num_dirs, progress->num_files,
                          progress->user_data);

    return FALSE;
}

static void measure_disk_usage_progress(gboolean reporting,
                                        guint64 current_size, guint64 num_dirs,
                                        guint64 num_files, gpointer user_data)
{
    ...
    g_main_context_invoke_full(g_task_get_context(task),
                               ...
                               g_memdup(&progress, sizeof progress), g_free);
}

static void measure_disk_usage_thread(GTask* task, gpointer source_object,
                                      gpointer task_data,
                                      GCancellable* cancellable)
{
    ...
    if (g_file_measure_disk_usage(
            source_object, data->flags, cancellable,
            data->progress_callback ? measure_disk_usage_progress : NULL, task,
            &result.disk_usage, &result.num_dirs, &result.num_files, &error))
    ...
    guint64* disk_usage, guint64* num_dirs, guint64* num_files, GError** error)
{
    ...
    return G_FILE_GET_IFACE(file)->measure_disk_usage(
        file, flags, cancellable, progress_callback, progress_data, disk_usage,
        num_dirs, num_files, error);
}
    ...
    gpointer progress_data, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    G_FILE_GET_IFACE(file)->measure_disk_usage_async(
        file, flags, io_priority, cancellable, progress_callback, progress_data,
        callback, user_data);
}
 ...
 * Since: 2.38
 **/
gboolean g_file_measure_disk_usage_finish(GFile* file, GAsyncResult* result,
                                          guint64* disk_usage,
                                          ...
                                          GError** error)
{
    ...
    return G_FILE_GET_IFACE(file)->measure_disk_usage_finish(
 ...
 * @file: input #GFile
 * @flags: flags affecting the operation
 * @start_operation: (nullable): a #GMountOperation, or %NULL to avoid user
 * interaction
 ...
 * Since: 2.22
 */
void g_file_start_mountable(GFile* file, GDriveStartFlags flags,
                            ...
                            GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    {
        g_task_report_new_error(
            file, callback, user_data, g_file_start_mountable, G_IO_ERROR,
            G_IO_ERROR_NOT_SUPPORTED, _("Operation not supported"));
        return;
    }

    (*iface->start_mountable)(file, flags, start_operation, cancellable,
                              callback, user_data);
}
 ...
 * Since: 2.22
 */
gboolean g_file_start_mountable_finish(GFile* file, GAsyncResult* result,
                                       GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.22
 */
void g_file_stop_mountable(GFile* file, GMountUnmountFlags flags,
                           GMountOperation* mount_operation,
                           GCancellable* cancellable,
                           GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    {
        g_task_report_new_error(
            file, callback, user_data, g_file_stop_mountable, G_IO_ERROR,
            G_IO_ERROR_NOT_SUPPORTED, _("Operation not supported"));
        return;
    }

    (*iface->stop_mountable)(file, flags, mount_operation, cancellable,
                             callback, user_data);
}
 ...
 * Since: 2.22
 */
gboolean g_file_stop_mountable_finish(GFile* file, GAsyncResult* result,
                                      GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.22
 */
void g_file_poll_mountable(GFile* file, GCancellable* cancellable,
                           GAsyncReadyCallback callback, gpointer user_data)
{
    GFileIface* iface;
    ...
    {
        g_task_report_new_error(
            file, callback, user_data, g_file_poll_mountable, G_IO_ERROR,
            G_IO_ERROR_NOT_SUPPORTED, _("Operation not supported"));
        return;
    }
 ...
 * Since: 2.22
 */
gboolean g_file_poll_mountable_finish(GFile* file, GAsyncResult* result,
                                      GError** error)
{
    GFileIface* iface;
 ...
 * Since: 2.56
 */
GBytes* g_file_load_bytes(GFile* file, GCancellable* cancellable,
                          gchar** etag_out, GError** error)
{
    ...
    if (g_file_has_uri_scheme(file, "resource"))
    {
        ...
        bytes = g_resources_lookup_data(unescaped, G_RESOURCE_LOOKUP_FLAGS_NONE,
                                        error);
        g_free(unescaped);
...
static void g_file_load_bytes_cb(GObject* object, GAsyncResult* result,
                                 gpointer user_data)
{
    GFile* file = G_FILE(object);
    GTask* task = user_data;
 ...
 * Since: 2.56
 */
void g_file_load_bytes_async(GFile* file, GCancellable* cancellable,
                             GAsyncReadyCallback callback, gpointer user_data)
{
    GError* error = NULL;
    GBytes* bytes;
    ...
    if (!g_file_has_uri_scheme(file, "resource"))
    {
        g_file_load_contents_async(file, cancellable, g_file_load_bytes_cb,
                                   g_steal_pointer(&task));
        return;
    }
 ...
 * Since: 2.56
 */
GBytes* g_file_load_bytes_finish(GFile* file, GAsyncResult* result,
                                 gchar** etag_out, GError** error)
{
    GBytes* bytes;
