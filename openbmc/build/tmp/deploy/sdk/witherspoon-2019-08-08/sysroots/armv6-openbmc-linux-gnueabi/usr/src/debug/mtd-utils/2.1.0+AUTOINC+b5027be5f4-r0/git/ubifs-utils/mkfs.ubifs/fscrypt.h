...
#else
static inline struct fscrypt_context*
    init_fscrypt_context(const char* cipher_name, unsigned int flags,
                         const char* key_file, const char* key_descriptor)
{
    (void)cipher_name;
    (void)flags;
    (void)key_file;
...
static inline int encrypt_data_node(struct fscrypt_context* fctx,
...
static inline struct fscrypt_context*
    inherit_fscrypt_context(struct fscrypt_context* fctx)
{
    (void)fctx;
