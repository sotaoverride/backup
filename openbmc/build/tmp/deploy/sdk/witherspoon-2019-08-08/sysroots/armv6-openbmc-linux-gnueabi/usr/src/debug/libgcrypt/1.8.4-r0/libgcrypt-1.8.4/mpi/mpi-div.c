                       ...
                       gcry_mpi_t den)
{
    ...
    if (quot)
    {
        ...
        { /* Copy NP object to temporary space.  */
            ...
            np = marker[markidx++] =
                mpi_alloc_limb_space(nsize, mpi_is_secure(quot));
    ...
    if (normalization_steps)
    {
        ...
        tp = marker[markidx++] =
            mpi_alloc_limb_space(dsize, mpi_is_secure(den));
...
void _gcry_mpi_tdiv_q_2exp(gcry_mpi_t w, gcry_mpi_t u, unsigned int count)
{
...
void _gcry_mpi_div(gcry_mpi_t quot, gcry_mpi_t rem, gcry_mpi_t dividend,
