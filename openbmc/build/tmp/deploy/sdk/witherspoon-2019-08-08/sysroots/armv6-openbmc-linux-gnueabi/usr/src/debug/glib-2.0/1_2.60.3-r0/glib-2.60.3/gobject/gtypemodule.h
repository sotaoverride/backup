...
#define G_TYPE_MODULE(module)                                                  \
    (G_TYPE_CHECK_INSTANCE_CAST((module), G_TYPE_TYPE_MODULE, GTypeModule))
#define G_TYPE_MODULE_CLASS(class)                                             \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_TYPE_MODULE, GTypeModuleClass))
...
#define G_TYPE_MODULE_GET_CLASS(module)                                        \
    (G_TYPE_INSTANCE_GET_CLASS((module), G_TYPE_TYPE_MODULE, GTypeModuleClass))
...
#define G_DEFINE_DYNAMIC_TYPE(TN, t_n, T_P)                                    \
    G_DEFINE_DYNAMIC_TYPE_EXTENDED(TN, t_n, T_P, 0, {})
/**
 ...
 *     };
 *     g_type_module_add_interface (type_module, g_define_type_id, TYPE_GIZMO,
 ...
 * Since: 2.14
 */
#define G_DEFINE_DYNAMIC_TYPE_EXTENDED(TypeName, type_name, TYPE_PARENT,       \
                                       flags, CODE)                            \
    ...
    {                                                                          \
        ...
        type_name##_type_id = g_type_module_register_type(                     \
            type_module, TYPE_PARENT, #TypeName, &g_define_type_info,          \
            (GTypeFlags)flags);                                                \
