                                                 ...
                                                 krb5_flags* fields)
{
    ...
    *fields = KRB5_TC_MATCH_TIMES /*XXX |KRB5_TC_MATCH_SKEY_TYPE */
              | KRB5_TC_MATCH_AUTHDATA | KRB5_TC_SUPPORTED_KTYPES;
...
static krb5_error_code begin_get_tgt(krb5_context context,
 ...
 */
static krb5_error_code set_caller_request(krb5_context context,
                                          krb5_tkt_creds_context ctx)
{
 ...
 * container. */
static krb5_error_code cache_get(krb5_context context, krb5_ccache ccache,
                                 krb5_flags flags, krb5_creds* in_creds,
 ...
 * extra_options.
 */
static krb5_error_code make_request(krb5_context context,
                                    krb5_tkt_creds_context ctx,
                                    int extra_options)
{
    krb5_error_code code;
...
static krb5_error_code make_request_for_tgt(krb5_context context,
                                            krb5_tkt_creds_context ctx,
...
static krb5_error_code make_request_for_service(krb5_context context,
                                                krb5_tkt_creds_context ctx,
...
static krb5_error_code get_creds_from_tgs_reply(krb5_context context,
                                                krb5_tkt_creds_context ctx,
                                                krb5_data* reply)
{
    krb5_error_code code;
    ...
    code = krb5int_process_tgs_reply(
        context, ctx->fast_state, reply, ctx->cur_tgt, ctx->kdcopt,
        ctx->cur_tgt->addresses, NULL, ctx->tgs_in_creds, ctx->timestamp,
        ctx->nonce, ctx->subkey, NULL, NULL, &ctx->reply_creds);
...
static krb5_error_code remember_realm(krb5_context context,
                                      krb5_tkt_creds_context ctx,
                                      const krb5_data* realm)
{
    size_t len = 0;
...
static krb5_boolean seen_realm_before(krb5_context context,
                                      krb5_tkt_creds_context ctx,
                                      const krb5_data* realm)
{
    size_t i;
...
static krb5_error_code complete(krb5_context context,
                                krb5_tkt_creds_context ctx)
{
...
static krb5_error_code step_non_referral(krb5_context context,
                                         krb5_tkt_creds_context ctx)
{
...
static krb5_error_code begin_non_referral(krb5_context context,
                                          krb5_tkt_creds_context ctx)
{
...
static krb5_error_code try_fallback(krb5_context context,
                                    krb5_tkt_creds_context ctx)
{
    krb5_error_code code;
    char** hrealms;
    ...
    code =
        krb5_get_fallback_host_realm(context, &ctx->server->data[1], &hrealms);
    if (code != 0)
        return code;
 ...
 * one of them. */
static krb5_boolean wrong_enctype(krb5_context context, krb5_enctype enctype)
{
    size_t i;
...
static krb5_error_code step_referrals(krb5_context context,
                                      krb5_tkt_creds_context ctx)
{
    krb5_error_code code;
    ...
    if (krb5_principal_compare(context, ctx->reply_creds->server, ctx->server))
    {
 ...
 * ctx->realm->server.
 */
static krb5_error_code begin_referrals(krb5_context context,
                                       krb5_tkt_creds_context ctx)
{
 ...
 */
static krb5_error_code end_get_tgt(krb5_context context,
                                   krb5_tkt_creds_context ctx)
{
...
static krb5_error_code step_get_tgt_offpath(krb5_context context,
                                            krb5_tkt_creds_context ctx)
{
    krb5_error_code code;
...
static krb5_error_code begin_get_tgt_offpath(krb5_context context,
                                             krb5_tkt_creds_context ctx)
{
 ...
 */
static krb5_error_code get_cached_tgt(krb5_context context,
                                      krb5_tkt_creds_context ctx,
                                      const krb5_data* realm,
                                      krb5_creds** tgt_out)
{
...
static krb5_error_code get_cached_local_tgt(krb5_context context,
                                            krb5_tkt_creds_context ctx,
                                            krb5_creds** tgt_out)
{
    krb5_creds mcreds;
 ...
 * ctx->server->realm. */
static krb5_error_code init_realm_path(krb5_context context,
                                       krb5_tkt_creds_context ctx)
{
    krb5_error_code code;
...
static const krb5_data* find_realm_in_path(krb5_context context,
                                           krb5_tkt_creds_context ctx,
                                           const krb5_data* realm)
{
    const krb5_data* r;
 ...
 */
static krb5_error_code get_tgt_request(krb5_context context,
                                       krb5_tkt_creds_context ctx)
{
    krb5_error_code code;
...
static krb5_error_code step_get_tgt(krb5_context context,
                                    krb5_tkt_creds_context ctx)
{
    krb5_error_code code;
 ...
 * wanted cached creds.
 */
static krb5_error_code check_cache(krb5_context context,
                                   krb5_tkt_creds_context ctx)
{
    krb5_error_code code;
    krb5_creds mcreds;
...
static krb5_error_code begin(krb5_context context, krb5_tkt_creds_context ctx)
{
    krb5_error_code code;
                                                 ...
                                                 krb5_tkt_creds_context ctx)
{
    ...
    for (;;)
    {
        ...
        code =
            krb5_tkt_creds_step(context, ctx, &reply, &request, &realm, &flags);
                                                  ...
                                                  unsigned int* flags)
{
    ...
    *flags = 0;
    ...
    if (no_input != (ctx->state == STATE_BEGIN) || ctx->state == STATE_COMPLETE)
        return EINVAL;
