                            ...
                            void* userdata)
{
    ...
    if (record)
    {
        ...
        b->callback(b, interface, protocol, event, type, domain, flags,
                    b->userdata);
    }
    else
        b->callback(b, interface, protocol, event, NULL, b->domain_name, flags,
                    b->userdata);
}
    ...
    AvahiSServiceTypeBrowserCallback callback, void* userdata)
{
    ...
    if ((r = avahi_service_name_join(n, sizeof(n), NULL,
    ...
    AVAHI_LLIST_PREPEND(AvahiSServiceTypeBrowser, browser,
                        server->service_type_browsers, b);
...
void avahi_s_service_type_browser_free(AvahiSServiceTypeBrowser* b)
{
    ...
    AVAHI_LLIST_REMOVE(AvahiSServiceTypeBrowser, browser,
                       b->server->service_type_browsers, b);
