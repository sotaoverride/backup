...
class Item
{
  public:
    ...
    virtual std::string prettyName(std::string value, bool skipSignal);
    ...
    virtual bool present(bool value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_PrettyName(sd_bus*, const char*, const char*,
                                        const char*, sd_bus_message*, void*,
                                        sd_bus_error*);
    /** @brief sd-bus callback for set-property 'PrettyName' */
    static int _callback_set_PrettyName(sd_bus*, const char*, const char*,
                                        const char*, sd_bus_message*, void*,
                                        sd_bus_error*);

    /** @brief sd-bus callback for get-property 'Present' */
    static int _callback_get_Present(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Present' */
    static int _callback_set_Present(sd_bus*, const char*, const char*,
                                     const char*, sd_bus_message*, void*,
                                     sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Inventory_Item_interface;
