 ...
 */
void _ipAddressTable_initialize_interface(ipAddressTable_registration* user_ctx,
                                          u_long flags);
void _ipAddressTable_shutdown_interface(ipAddressTable_registration* user_ctx);
...
ipAddressTable_rowreq_ctx*
    ipAddressTable_allocate_rowreq_ctx(ipAddressTable_data*, void*);
