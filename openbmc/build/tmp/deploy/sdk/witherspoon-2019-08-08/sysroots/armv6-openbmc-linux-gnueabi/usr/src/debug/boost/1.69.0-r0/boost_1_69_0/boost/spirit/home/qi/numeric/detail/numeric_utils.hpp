...
#define BOOST_SPIRIT_LOG2                                                      \
    (#error)(#error)(1000000)(1584960)(2000000)(2321920)(2584960)(2807350)(    \
        3000000)(3169920)(3321920)(3459430)(3584960)(3700430)(3807350)(        \
        3906890)(4000000)(4087460)(4169920)(4247920)(4321920)(4392310)(        \
        4459430)(4523560)(4584960)(4643850)(4700430)(4754880)(4807350)(        \
        4857980)(4906890)(4954190)(5000000)(5044390)(5087460)(5129280)(        \
        5169925) /***/

#define BOOST_PP_LOCAL_MACRO(Radix)                                            \
    template <typename T>                                                      \
    struct digits_traits<T, Radix>                                             \
    {                                                                          \
        typedef std::numeric_limits<T> numeric_limits_type;                    \
        BOOST_STATIC_CONSTANT(                                                 \
            int,                                                               \
            value = static_cast<int>((numeric_limits_type::digits * 1000000) / \
                                     BOOST_PP_SEQ_ELEM(Radix,                  \
                                                       BOOST_SPIRIT_LOG2)));   \
    };                                                                         \
    /***/
...
struct radix_traits
{
    ...
    inline static bool is_valid(Char ch)
    {
        return (ch >= '0' &&
                ch <=
                    (Radix > 10 ? '9' : static_cast<Char>('0' + Radix - 1))) ||
               (Radix > 10 && ch >= 'a' &&
                ch <= static_cast<Char>('a' + Radix - 10 - 1)) ||
               (Radix > 10 && ch >= 'A' &&
                ch <= static_cast<Char>('A' + Radix - 10 - 1));
    }
...
struct int_extractor
{
    ...
    template <typename Char>
    inline static bool call(Char /*ch*/, std::size_t /*count*/, unused_type,
                            mpl::false_)
    {
        return true;
    }
...
#pragma warning(disable : 4127) // conditional expression is constant
    ...
    inline static bool parse_main(Iterator& first, Iterator const& last,
                                  Attribute& attr)
    {
        typedef radix_traits<Radix> radix_check;
        typedef int_extractor<Radix, Accumulator, MaxDigits, Accumulate>
            extractor;
        ...
        if (!Accumulate)
        {
            ...
            while (it != last && *it == '0' &&
                   (MaxDigits < 0 ||
                    leading_zeros < static_cast<std::size_t>(MaxDigits)))
            {
                ++it;
                ++leading_zeros;
            }
        ...
        while (true)
        {
            BOOST_PP_REPEAT(SPIRIT_NUMERICS_LOOP_UNROLL,
...
#pragma warning(pop)
    ...
    template <typename Iterator, typename Attribute>
    inline static bool parse(Iterator& first, Iterator const& last,
                             Attribute& attr)
    {
