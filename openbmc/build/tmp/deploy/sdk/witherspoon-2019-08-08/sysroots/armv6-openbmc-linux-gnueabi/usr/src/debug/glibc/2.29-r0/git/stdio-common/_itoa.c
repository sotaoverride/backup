...
const struct base_table_t _itoa_base_table[] attribute_hidden = {
    ...
    /* 36 */
    {SEL1(0xe38e38e38e38e38full) 0, 5}
#endif
#if BITS_PER_MP_LIMB == 32
    /*  2 */ {SEL1(0ul) 1, 1, {0, 31, 0x80000000ul SEL2(0xfffffffful)}},
    /*  3 */
    {SEL1(0xaaaaaaabul) 0, 1, {0, 20, 0xcfd41b91ul SEL2(0x3b563c24ul)}},
    /*  4 */ {SEL1(0ul) 1, 2, {1, 15, 0x40000000ul SEL2(0xfffffffful)}},
    /*  5 */
    {SEL1(0xcccccccdul) 0, 2, {1, 13, 0x48c27395ul SEL2(0xc25c2684ul)}},
    /*  6 */
    {SEL1(0xaaaaaaabul) 0, 2, {0, 12, 0x81bf1000ul SEL2(0xf91bd1b6ul)}},
    /*  7 */
    {SEL1(0x24924925ul) 1, 3, {1, 11, 0x75db9c97ul SEL2(0x1607a2cbul)}},
    /*  8 */ {SEL1(0ul) 1, 3, {1, 10, 0x40000000ul SEL2(0xfffffffful)}},
    /*  9 */
    {SEL1(0x38e38e39ul) 0, 1, {0, 10, 0xcfd41b91ul SEL2(0x3b563c24ul)}},
...
char* _itoa_word(_ITOA_WORD_TYPE value, char* buflim, unsigned int base,
                 int upper_case)
{
    ...
    {                                                                          \
        ...
        {                                                                      \
            ...
            {                                                                  \
                ...
                {                                                              \
                    work_lo |=                                                 \
                        ((work_hi &                                            \
                          ((1 << (BITS - BITS_PER_MP_LIMB % BITS)) - 1))       \
        ...
        default:
        {
            ...
            if ((mp_limb_t)(value >> 32) >= 1)
            {
                ...
                mp_limb_t big_base_norm = brec->big.base
...
#if _ITOA_NEEDED
char* _fitoa(unsigned long long value, char* buf, unsigned int base,
             int upper_case)
{
    char tmpbuf[sizeof(value) * 4]; /* Worst case length: base 2.  */
