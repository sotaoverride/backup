...
class Entry
{
  public:
    ...
    virtual uint64_t size(uint64_t value, bool skipSignal);
    /** Set value of Size */
  ...
  private:
    ...
    static int _callback_get_Size(sd_bus*, const char*, const char*,
                                  const char*, sd_bus_message*, void*,
                                  sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Size' */
    static int _callback_set_Size(sd_bus*, const char*, const char*,
                                  const char*, sd_bus_message*, void*,
                                  sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Dump_Entry_interface;
