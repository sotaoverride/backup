...
extern int nla_parse(struct nlattr**, int, struct nlattr*, int,
                     struct nla_policy*);
...
extern int nla_put_data(struct nl_msg*, int, const struct nl_data*);
...
/* Attribute nesting */
extern int nla_put_nested(struct nl_msg*, int, const struct nl_msg*);
