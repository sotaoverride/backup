...
#define G_TLS_DATABASE(inst)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_TLS_DATABASE, GTlsDatabase))
#define G_TLS_DATABASE_CLASS(class)                                            \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_TLS_DATABASE, GTlsDatabaseClass))
#define G_IS_TLS_DATABASE(inst)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_TLS_DATABASE))
#define G_IS_TLS_DATABASE_CLASS(class)                                         \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_TLS_DATABASE))
#define G_TLS_DATABASE_GET_CLASS(inst)                                         \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_TLS_DATABASE, GTlsDatabaseClass))
