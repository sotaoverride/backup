...
OM_uint32 KRB5_CALLCONV spnego_gss_inquire_cred(OM_uint32*, /* minor_status */
                                                gss_cred_id_t, /* cred_handle */
                                                gss_name_t*,   /* name */
                                                OM_uint32*,    /* lifetime */
                                                int*,          /* cred_usage */
...
OM_uint32 KRB5_CALLCONV spnego_gss_wrap_iov(OM_uint32* minor_status,
                                            gss_ctx_id_t context_handle,
                                            int conf_req_flag,
...
OM_uint32 KRB5_CALLCONV spnego_gss_pseudo_random(OM_uint32* minor_status,
