...
#define FT_DEFINE_TT_CMAP(class_, size_, init_, done_, char_index_,            \
                          char_next_, char_var_index_, char_var_default_,      \
                          variant_list_, charvariant_list_, variantchar_list_, \
                          format_, validate_, get_cmap_info_)                  \
    FT_CALLBACK_TABLE_DEF                                                      \
    const TT_CMap_ClassRec class_ = {{size_, init_, done_, char_index_,        \
                                      char_next_, char_var_index_,             \
                                      char_var_default_, variant_list_,        \
