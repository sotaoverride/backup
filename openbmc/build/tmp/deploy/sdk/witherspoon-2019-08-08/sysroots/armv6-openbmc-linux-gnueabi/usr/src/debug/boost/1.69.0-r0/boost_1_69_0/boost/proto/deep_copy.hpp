...
struct deep_copy_impl<Expr, 0>
{
    typedef typename base_expr<
        typename Expr::proto_domain, tag::terminal,
...
{
    typedef
        typename detail::deep_copy_impl<BOOST_PROTO_UNCVREF(Expr)>::result_type
            type;
};
} // namespace result_of
...
struct deep_copy
{
    ...
    {
        typedef typename detail::deep_copy_impl<BOOST_PROTO_UNCVREF(
