 ...
 */
int DynAppend(obj, els, num) DynObjectP obj;
DynPtr els;
int num;
{
...
DynObjectP DynCreate(el_size, inc) int el_size, inc;
{
    DynObjectP obj;
...
DynObjectP DynCopy(obj) DynObjectP obj;
{
    DynObjectP obj1;
    ...
    memcpy(obj1->array, obj->array, (size_t)(obj1->el_size * obj1->size));
...
int DynRelease(obj) DynObjectP obj;
{
    if (obj->debug)
...
int DynDebug(obj, state) DynObjectP obj;
int state;
{
    obj->debug = state;
 ...
 */
int DynDelete(obj, idx) DynObjectP obj;
int idx;
{
    if (idx < 0)
    {
    ...
    else
    {
        ...
        {
            if (obj->debug)
                fprintf(stderr, "dyn: delete: zeroing %d bytes from %p + %d\n",
...
int DynInitzero(obj, state) DynObjectP obj;
int state;
{
    obj->initzero = state;
...
int DynInsert(obj, idx, els_in, num) DynObjectP obj;
void* els_in;
int idx, num;
{
...
int DynParanoid(obj, state) DynObjectP obj;
int state;
{
    obj->paranoid = state;
...
DynPtr DynArray(obj) DynObjectP obj;
{
    if (obj->debug)
...
DynPtr DynGet(obj, num) DynObjectP obj;
int num;
{
    if (num < 0)
    {
...
int DynAdd(obj, el) DynObjectP obj;
void* el;
{
    int ret;
 ...
 */
int DynPut(obj, el_in, idx) DynObjectP obj;
void* el_in;
int idx;
{
 ...
 */
int _DynResize(obj, req) DynObjectP obj;
int req;
{
    int size;
 ...
 */
int _DynRealloc(obj, num_incs) DynObjectP obj;
int num_incs;
{
    DynPtr temp;
...
int DynSize(obj) DynObjectP obj;
{
    if (obj->debug)
...
int DynCapacity(obj) DynObjectP obj;
{
    if (obj->debug)
