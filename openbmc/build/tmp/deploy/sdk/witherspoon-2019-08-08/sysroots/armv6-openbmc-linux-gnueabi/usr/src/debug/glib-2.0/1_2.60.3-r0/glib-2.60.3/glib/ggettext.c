 ...
 * Since: 2.16
 */
const gchar* g_dpgettext(const gchar* domain, const gchar* msgctxtid,
                         gsize msgidoffset)
{
 ...
 * Since: 2.18
 */
const gchar* g_dpgettext2(const gchar* domain, const gchar* msgctxt,
                          const gchar* msgid)
{
...
static gboolean _g_dgettext_should_translate(void)
{
    ...
    if (G_UNLIKELY(g_once_init_enter(&translate)))
    {
        ...
        g_once_init_leave(&translate, should_translate ? SHOULD_TRANSLATE
 ...
 * Since: 2.18
 */
const gchar* g_dngettext(const gchar* domain, const gchar* msgid,
