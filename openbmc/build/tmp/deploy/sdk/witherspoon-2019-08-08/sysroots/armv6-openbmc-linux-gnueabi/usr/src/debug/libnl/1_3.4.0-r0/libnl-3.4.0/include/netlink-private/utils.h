...
/* internal macro to calculate the size of a struct @type up to (and including)
 * @field. this will be used for .minlen policy fields, so that we require only
 * a field of up to the given size. */
