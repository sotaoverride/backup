...
static gpg_err_code_t octet_string_from_mpi(unsigned char** r_frame,
                                            void* space, gcry_mpi_t value,
                                            size_t nbytes)
{
...
static gcry_err_code_t mgf1(unsigned char* output, size_t outlen,
                            unsigned char* seed, size_t seedlen, int algo)
{
                                     ...
                                     size_t labellen)
{
    ...
    *r_resultlen = db_len - n;
    ...
    if (DBG_CIPHER)
        log_printhex("value extracted from OAEP encoded data", *r_result,
                     *r_resultlen);
