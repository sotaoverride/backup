...
*/
netsnmp_variable_list* nsTransactionTable_get_first_data_point(
    void** my_loop_context, void** my_data_context,
    netsnmp_variable_list* put_index_data, netsnmp_iterator_info* iinfo)
{
...
netsnmp_variable_list* nsTransactionTable_get_next_data_point(
    void** my_loop_context, void** my_data_context,
    netsnmp_variable_list* put_index_data, netsnmp_iterator_info* iinfo)
{

    netsnmp_variable_list* vptr;
    netsnmp_agent_session* alist = (netsnmp_agent_session*)*my_loop_context;
...
int nsTransactionTable_handler(netsnmp_mib_handler* handler,
                               ...
                               netsnmp_request_info* requests)
{
    ...
    for (; requests; requests = requests->next)
    {
         ...
         */
        asp =
            (netsnmp_agent_session*)netsnmp_extract_iterator_context(requests);
        if (asp == NULL)
        {
                ...
                switch (table_info->colnum)
                {
                    ...
                    default:
                        ...
                        snmp_log(
                            ...
                            "nsTransactionTable_handler: unknown column\n");
                }
                break;

            default:
                snmp_log(LOG_ERR,
                         "problem encountered in nsTransactionTable_handler: "
                         "unsupported mode\n");
        }
    }
