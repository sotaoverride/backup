...
krb5_error_code ktutil_add(krb5_context, krb5_kt_list*, char*, int, krb5_kvno,
                           char*, int, char*);

krb5_error_code ktutil_read_keytab(krb5_context, char*, krb5_kt_list*);

krb5_error_code ktutil_write_keytab(krb5_context, krb5_kt_list, char*);

krb5_error_code ktutil_read_srvtab(krb5_context, char*, krb5_kt_list*);
