...
#define G_DBUS_OBJECT_MANAGER(o)                                               \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_OBJECT_MANAGER,               \
                                GDBusObjectManager))
#define G_IS_DBUS_OBJECT_MANAGER(o)                                            \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_OBJECT_MANAGER))
#define G_DBUS_OBJECT_MANAGER_GET_IFACE(o)                                     \
    (G_TYPE_INSTANCE_GET_INTERFACE((o), G_TYPE_DBUS_OBJECT_MANAGER,            \
 ...
 * @get_object_path: Virtual function for
 ...
 * @object_added: Signal handler for the #GDBusObjectManager::object-added
 * signal.
 * @object_removed: Signal handler for the #GDBusObjectManager::object-removed
 * signal.
 * @interface_added: Signal handler for the #GDBusObjectManager::interface-added
 * signal.
 * @interface_removed: Signal handler for the
 * #GDBusObjectManager::interface-removed signal.
 *
