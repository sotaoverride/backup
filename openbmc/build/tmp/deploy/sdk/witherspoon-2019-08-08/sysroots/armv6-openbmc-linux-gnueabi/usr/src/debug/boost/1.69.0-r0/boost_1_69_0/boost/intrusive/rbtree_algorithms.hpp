...
/////////////////////////////////////////////////////////////////////////////
//
// The tree destruction algorithm is based on Julienne Walker and The EC Team
// code:
//
// This code is in the public domain. Anyone may use it or change it in any way
// that they see fit. The author assumes no responsibility for damages incurred
// through use of the original code or any variations thereof.
//
// It is requested, but not required, that due credit is given to the original
// author and anyone who has modified the code through a header comment, such as
// this one.
    ...
    : public bstree_node_checker<ValueTraits, NodePtrCompare, ExtraChecker>
{
    ...
    rbtree_node_checker(const NodePtrCompare& comp,
                    ...
                    return_type& check_return)
    {
        ...
        if (node_traits::get_color(p) == node_traits::red())
        {
            ...
            (void)p_right;
            BOOST_INTRUSIVE_INVARIANT_ASSERT(!p_left ||
                                             node_traits::get_color(p_left) ==
                                                 node_traits::black());
            BOOST_INTRUSIVE_INVARIANT_ASSERT(!p_right ||
                                             node_traits::get_color(p_right) ==
                                                 node_traits::black());
        ...
        BOOST_INTRUSIVE_INVARIANT_ASSERT(l_black_count ==
                                         check_return_right.black_count_);
        check_return.black_count_ =
            l_black_count +
            static_cast<std::size_t>(node_traits::get_color(p) ==
                                     node_traits::black());
...
//!
//! rbtree_algorithms is configured with a NodeTraits class, which encapsulates
...
#endif
{
  ...
  public:
    ...
    //! @copydoc ::boost::intrusive::bstree_algorithms::get_header(const
    //! const_node_ptr&)
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::swap_nodes(node_ptr,node_ptr)
    static void swap_nodes(node_ptr node1, node_ptr node2)
    {
        if (node1 == node2)
            return;

        node_ptr header1(bstree_algo::get_header(node1)),
            header2(bstree_algo::get_header(node2));
        swap_nodes(node1, header1, node2, header2);
    }

    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::swap_nodes(node_ptr,node_ptr,node_ptr,node_ptr)
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::replace_node(node_ptr,node_ptr)
    static void replace_node(node_ptr node_to_be_replaced, node_ptr new_node)
    {
        if (node_to_be_replaced == new_node)
            return;
        replace_node(node_to_be_replaced,
                     bstree_algo::get_header(node_to_be_replaced), new_node);
    }

    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::replace_node(node_ptr,node_ptr,node_ptr)
...
#ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::unlink_leftmost_without_rebalance
    static node_ptr unlink_leftmost_without_rebalance(const node_ptr& header);

    //! @copydoc ::boost::intrusive::bstree_algorithms::unique(const
    //! const_node_ptr&)
    static bool unique(const const_node_ptr& node);

    //! @copydoc ::boost::intrusive::bstree_algorithms::size(const
    //! const_node_ptr&)
    static std::size_t size(const const_node_ptr& header);

    //! @copydoc ::boost::intrusive::bstree_algorithms::next_node(const
    //! node_ptr&)
    static node_ptr next_node(const node_ptr& node);

    //! @copydoc ::boost::intrusive::bstree_algorithms::prev_node(const
    //! node_ptr&)
                                ...
                                node_ptr header2, node_ptr z)
    {
        ...
        bool const transferred =
            bstree_algo::transfer_unique(header1, comp, header2, z, info);
        if (transferred)
        {
    ...
    //! @copydoc ::boost::intrusive::bstree_algorithms::clone(const
    //! const_node_ptr&,node_ptr,Cloner,Disposer)
...
#ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
    //! @copydoc ::boost::intrusive::bstree_algorithms::clear_and_dispose(const
    //! node_ptr&,Disposer)
    template <class Disposer>
    static void clear_and_dispose(const node_ptr& header, Disposer disposer);

    //! @copydoc ::boost::intrusive::bstree_algorithms::lower_bound(const
    //! const_node_ptr&,const KeyType&,KeyNodePtrCompare)
    template <class KeyType, class KeyNodePtrCompare>
    static node_ptr lower_bound(const const_node_ptr& header,
                                const KeyType& key, KeyNodePtrCompare comp);

    //! @copydoc ::boost::intrusive::bstree_algorithms::upper_bound(const
    //! const_node_ptr&,const KeyType&,KeyNodePtrCompare)
    template <class KeyType, class KeyNodePtrCompare>
    static node_ptr upper_bound(const const_node_ptr& header,
                                const KeyType& key, KeyNodePtrCompare comp);

    //! @copydoc ::boost::intrusive::bstree_algorithms::find(const
    //! const_node_ptr&, const KeyType&,KeyNodePtrCompare)
    template <class KeyType, class KeyNodePtrCompare>
    ...
    //! @copydoc ::boost::intrusive::bstree_algorithms::bounded_range(const
    //! const_node_ptr&,const KeyType&,const
    //! KeyType&,KeyNodePtrCompare,bool,bool)
    template <class KeyType, class KeyNodePtrCompare>
    static std::pair<node_ptr, node_ptr>
    ...
    //! @copydoc ::boost::intrusive::bstree_algorithms::count(const
    //! const_node_ptr&,const KeyType&,KeyNodePtrCompare)
    template <class KeyType, class KeyNodePtrCompare>
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::insert_equal_upper_bound(node_ptr,node_ptr,NodePtrCompare)
    template <class NodePtrCompare>
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::insert_equal_lower_bound(node_ptr,node_ptr,NodePtrCompare)
    template <class NodePtrCompare>
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::insert_equal(node_ptr,node_ptr,node_ptr,NodePtrCompare)
    template <class NodePtrCompare>
    static node_ptr insert_equal(node_ptr header, node_ptr hint,
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::insert_before(node_ptr,node_ptr,node_ptr)
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::push_back(node_ptr,node_ptr)
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::push_front(node_ptr,node_ptr)
...
#ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::insert_unique_check(const
    //! const_node_ptr&,const KeyType&,KeyNodePtrCompare,insert_commit_data&)
    template <class KeyType, class KeyNodePtrCompare>
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::insert_unique_check(const
    //! const_node_ptr&,const node_ptr&,const
    //! KeyType&,KeyNodePtrCompare,insert_commit_data&)
    template <class KeyType, class KeyNodePtrCompare>
    static std::pair<node_ptr, bool>
    ...
    //! @copydoc
    //! ::boost::intrusive::bstree_algorithms::insert_unique_commit(node_ptr,node_ptr,const
    //! insert_commit_data&)
  ...
  private:
    static void rebalance_after_erasure(
        node_ptr header, node_ptr z,
        const typename bstree_algo::data_for_rebalance& info)
    {
        color new_z_color;
        if (info.y != z)
        {
        ...
        {
            rebalance_after_erasure_restore_invariants(header, info.x,
                                                       info.x_parent);
        }
    }

    static void rebalance_after_erasure_restore_invariants(node_ptr header,
                                                           node_ptr x,
                                                           node_ptr x_parent)
    {
        while (1)
        {
            if (x_parent == header ||
                (x && NodeTraits::get_color(x) != NodeTraits::black()))
            {
                break;
            }
            ...
            { // x is left child
                ...
                if (NodeTraits::get_color(w) == NodeTraits::red())
                {
                    ...
                    bstree_algo::rotate_left(
                        x_parent, w, NodeTraits::get_parent(x_parent), header);
                ...
                if ((!w_left ||
                     NodeTraits::get_color(w_left) == NodeTraits::black()) &&
                    (!w_right ||
                     NodeTraits::get_color(w_right) == NodeTraits::black()))
                {
                ...
                else
                {
                        ...
                        NodeTraits::get_color(w_right) == NodeTraits::black())
                    {
                        ...
                        bstree_algo::rotate_right(
                            w, w_left, NodeTraits::get_parent(w), header);
                        w = NodeTraits::get_right(x_parent);
                        BOOST_INTRUSIVE_INVARIANT_ASSERT(w);
                    }
                    ...
                    bstree_algo::rotate_left(
                        x_parent, NodeTraits::get_right(x_parent),
                        NodeTraits::get_parent(x_parent), header);
                    break;
                }
            }
            else
            {
                ...
                else
                {
                        ...
                        NodeTraits::get_color(w_left) == NodeTraits::black())
                    {
                        ...
                        NodeTraits::set_color(w, NodeTraits::red());
                        bstree_algo::rotate_left(
                            w, w_right, NodeTraits::get_parent(w), header);
                        w = NodeTraits::get_left(x_parent);
                        BOOST_INTRUSIVE_INVARIANT_ASSERT(w);
                    }
                    NodeTraits::set_color(w, NodeTraits::get_color(x_parent));
                    ...
                    bstree_algo::rotate_right(
                        x_parent, NodeTraits::get_left(x_parent),
                        NodeTraits::get_parent(x_parent), header);
                    break;
                }
            }
    ...
    static void rebalance_after_insertion(node_ptr header, node_ptr p)
    {
        ...
        while (1)
        {
            ...
            if (p_parent == header ||
                NodeTraits::get_color(p_parent) == NodeTraits::black() ||
                p_grandparent == header)
            {
                break;
            }

            NodeTraits::set_color(p_grandparent, NodeTraits::red());
            node_ptr const p_grandparent_left(
                NodeTraits::get_left(p_grandparent));
            bool const p_parent_is_left_child = p_parent == p_grandparent_left;
            node_ptr const x(p_parent_is_left_child
                                 ? NodeTraits::get_right(p_grandparent)
                                 : p_grandparent_left);
            ...
            { // Final step
                ...
                { // p_parent is left child
                    if (!p_is_left_child)
                    { // p is right child
                        bstree_algo::rotate_left_no_parent_fix(p_parent, p);
                        // No need to link p and p_grandparent:
                        //    [NodeTraits::set_parent(p, p_grandparent) +
                        //    NodeTraits::set_left(p_grandparent, p)]
                        // as p_grandparent is not the header, another rotation
                        // is coming and p_parent will be the left child of
                        // p_grandparent
                        p_parent = p;
                    }
                    bstree_algo::rotate_right(
                ...
                { // p_parent is right child
                    if (p_is_left_child)
                    { // p is left child
                        bstree_algo::rotate_right_no_parent_fix(p_parent, p);
                        // No need to link p and p_grandparent:
                        //    [NodeTraits::set_parent(p, p_grandparent) +
                        //    NodeTraits::set_right(p_grandparent, p)]
                        // as p_grandparent is not the header, another rotation
                        // is coming and p_parent will be the right child of
                        // p_grandparent
                        p_parent = p;
                    }
                    bstree_algo::rotate_left(
        ...
        NodeTraits::set_color(NodeTraits::get_parent(header),
                              NodeTraits::black());
    }
    /// @endcond
};
...
template <class ValueTraits, class NodePtrCompare, class ExtraChecker>
struct get_node_checker<RbTreeAlgorithms, ValueTraits, NodePtrCompare,
                        ExtraChecker>
{
    typedef detail::rbtree_node_checker<ValueTraits, NodePtrCompare,
                                        ExtraChecker>
        type;
};
