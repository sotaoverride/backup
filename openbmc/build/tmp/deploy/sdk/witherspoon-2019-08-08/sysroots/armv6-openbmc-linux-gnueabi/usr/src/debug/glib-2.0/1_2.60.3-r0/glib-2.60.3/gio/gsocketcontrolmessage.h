...
#define G_SOCKET_CONTROL_MESSAGE(inst)                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_SOCKET_CONTROL_MESSAGE,         \
                                GSocketControlMessage))
#define G_SOCKET_CONTROL_MESSAGE_CLASS(class)                                  \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_SOCKET_CONTROL_MESSAGE,           \
                             GSocketControlMessageClass))
#define G_IS_SOCKET_CONTROL_MESSAGE(inst)                                      \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_SOCKET_CONTROL_MESSAGE))
#define G_IS_SOCKET_CONTROL_MESSAGE_CLASS(class)                               \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_SOCKET_CONTROL_MESSAGE))
#define G_SOCKET_CONTROL_MESSAGE_GET_CLASS(inst)                               \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_SOCKET_CONTROL_MESSAGE,          \
                               GSocketControlMessageClass))
...
void g_socket_control_message_serialize(GSocketControlMessage* message,
                                        gpointer data);
GLIB_AVAILABLE_IN_ALL
GSocketControlMessage* g_socket_control_message_deserialize(int level, int type,
                                                            gsize size,
                                                            gpointer data);
