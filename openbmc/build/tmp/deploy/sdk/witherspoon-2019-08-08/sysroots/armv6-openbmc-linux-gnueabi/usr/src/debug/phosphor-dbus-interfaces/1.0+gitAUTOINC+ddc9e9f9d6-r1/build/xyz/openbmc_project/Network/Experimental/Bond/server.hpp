...
class Bond
{
  public:
    ...
    using PropertiesVariant =
        std::variant<HashPolicy, BondingMode, std::vector<std::string>,
                     std::string>;
    ...
    virtual std::vector<std::string>
        bondedInterfaces(std::vector<std::string> value, bool skipSignal);
    /** Set value of BondedInterfaces */
    virtual std::vector<std::string>
        bondedInterfaces(std::vector<std::string> value);
    /** Get value of Mode */
    virtual BondingMode mode() const;
    /** Set value of Mode with option to skip sending signal */
    virtual BondingMode mode(BondingMode value, bool skipSignal);
    /** Set value of Mode */
    ...
    virtual HashPolicy transmitHashPolicy(HashPolicy value, bool skipSignal);
     ...
     *                 "xyz.openbmc_project.Network.Experimental.Bond.<value
     * name>"
  ...
  private:
    ...
    static int _callback_get_BondedInterfaces(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'BondedInterfaces' */
    static int _callback_set_BondedInterfaces(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    ...
    static int _callback_get_TransmitHashPolicy(sd_bus*, const char*,
                                                const char*, const char*,
                                                sd_bus_message*, void*,
                                                sd_bus_error*);
    /** @brief sd-bus callback for set-property 'TransmitHashPolicy' */
    static int _callback_set_TransmitHashPolicy(sd_bus*, const char*,
                                                const char*, const char*,
                                                sd_bus_message*, void*,
                                                sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Network_Experimental_Bond_interface;
