...
class Host
{
  public:
    ...
    using PropertiesVariant = std::variant<Transition, HostState>;
    ...
    virtual HostState currentHostState(HostState value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_RequestedHostTransition(sd_bus*, const char*,
                                                     const char*, const char*,
                                                     sd_bus_message*, void*,
                                                     sd_bus_error*);
    /** @brief sd-bus callback for set-property 'RequestedHostTransition' */
    static int _callback_set_RequestedHostTransition(sd_bus*, const char*,
                                                     const char*, const char*,
                                                     sd_bus_message*, void*,
                                                     sd_bus_error*);

    /** @brief sd-bus callback for get-property 'CurrentHostState' */
    static int _callback_get_CurrentHostState(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'CurrentHostState' */
    static int _callback_set_CurrentHostState(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_State_Host_interface;
