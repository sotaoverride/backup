...
void netsnmp_table_dataset_remove_row(netsnmp_table_data_set* table,
                                      netsnmp_table_row* row);
void netsnmp_table_dataset_remove_and_delete_row(netsnmp_table_data_set* table,
                                                 netsnmp_table_row* row);
 ...
 * calling argument).
 */
int netsnmp_table_set_add_default_row(netsnmp_table_data_set*, unsigned int,
                                      int, int, void* default_value,
...
netsnmp_table_data_set_storage*
    netsnmp_extract_table_data_set_column(netsnmp_request_info*, unsigned int);
...
int netsnmp_mark_row_column_writable(netsnmp_table_row* row, int column,
                                     int writable);
int netsnmp_set_row_column(netsnmp_table_row*, unsigned int, int, const void*,
                           size_t);
...
#define netsnmp_table_row_add_column(row, type, value, value_len)              \
    snmp_varlist_add_variable(&row->indexes, NULL, 0, type, (u_char*)value,    \
                              value_len)
