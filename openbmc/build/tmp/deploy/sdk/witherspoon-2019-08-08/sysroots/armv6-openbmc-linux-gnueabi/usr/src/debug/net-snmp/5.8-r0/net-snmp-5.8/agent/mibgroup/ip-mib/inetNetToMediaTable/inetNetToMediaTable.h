...
config_require(ip - mib / data_access / arp)
    config_require(ip -
                   mib / inetNetToMediaTable / inetNetToMediaTable_interface)
        config_require(ip - mib / inetNetToMediaTable /
                                inetNetToMediaTable_data_access)
/* *INDENT-ON*  */
...
typedef struct inetNetToMediaTable_rowreq_ctx_s
{
    ...
    /*
     * TODO:131:o: |   |-> Add useful data to inetNetToMediaTable rowreq
     * context.
     */
...
int inetNetToMediaTable_indexes_set(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx, long inetNetToMediaIfIndex_val,
    u_long inetNetToMediaNetAddressType_val,
    char* inetNetToMediaNetAddress_val_ptr,
    size_t inetNetToMediaNetAddress_val_ptr_len);
...
int inetNetToMediaTable_undo_cleanup(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx);
...
int inetNetToMediaLastUpdated_check_value(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
    u_long inetNetToMediaLastUpdated_val);
int inetNetToMediaLastUpdated_undo_setup(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx);
int inetNetToMediaLastUpdated_set(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                  u_long inetNetToMediaLastUpdated_val);
int inetNetToMediaLastUpdated_undo(inetNetToMediaTable_rowreq_ctx* rowreq_ctx);
...
int inetNetToMediaState_check_value(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                    u_long inetNetToMediaState_val);
int inetNetToMediaState_undo_setup(inetNetToMediaTable_rowreq_ctx* rowreq_ctx);
int inetNetToMediaState_set(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                            u_long inetNetToMediaState_val);
int inetNetToMediaState_undo(inetNetToMediaTable_rowreq_ctx* rowreq_ctx);
...
int inetNetToMediaTable_check_dependencies(inetNetToMediaTable_rowreq_ctx* ctx);
