...
rsRetVal (*SetOrigin)(statsobj_t* pThis,
                      uchar* name); /* added v12, 2014-09-08 */
rsRetVal (*SetReadNotifier)(statsobj_t* pThis,
...
rsRetVal (*GetAllStatsLines)(rsRetVal (*cb)(void*, const char*), void* usrptr,
                             statsFmtType_t fmt, int8_t bResetCtr);
rsRetVal (*AddCounter)(statsobj_t* pThis, const uchar* ctrName,
                       statsCtrType_t ctrType, int8_t flags, void* pCtr);
rsRetVal (*AddManagedCounter)(statsobj_t* pThis, const uchar* ctrName,
                              statsCtrType_t ctrType, int8_t flags, void* pCtr,
                              ctr_t** ref, int8_t linked);
...
#define statsobjCURR_IF_VERSION                                                \
     ...
     *                  - GetAllStatsLines got parameter telling if ctrs shall
     * be reset v13, 2016-05-19: GetAllStatsLines cb data type changed (char*
     * instead of cstr)
     */
...
rsRetVal statsRecordSender(const uchar* sender, unsigned nMsgs,
                           time_t lastSeen);
