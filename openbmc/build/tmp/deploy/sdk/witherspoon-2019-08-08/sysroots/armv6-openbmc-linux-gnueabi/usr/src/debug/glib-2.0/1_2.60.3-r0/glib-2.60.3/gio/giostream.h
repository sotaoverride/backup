...
#define G_IO_STREAM(o)                                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_IO_STREAM, GIOStream))
#define G_IO_STREAM_CLASS(k)                                                   \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_IO_STREAM, GIOStreamClass))
...
#define G_IO_STREAM_GET_CLASS(o)                                               \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_IO_STREAM, GIOStreamClass))
...
void g_io_stream_splice_async(GIOStream* stream1, GIOStream* stream2,
                              GIOStreamSpliceFlags flags, int io_priority,
