 ...
 * hold the TLS-format signature. It is the responsibility of the caller to free
 * it. If |out| points to an allocated string, the signature will be written to
 * it. The length of the signature in TLS format will be returned.
 */
