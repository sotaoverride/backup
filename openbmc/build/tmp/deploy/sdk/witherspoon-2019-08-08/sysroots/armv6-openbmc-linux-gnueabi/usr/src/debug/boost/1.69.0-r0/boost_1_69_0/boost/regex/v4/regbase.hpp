...
class BOOST_REGEX_DECL regbase
{
  public:
    enum flag_type_
    {
        ...
        main_option_type = literal | basic_syntax_group |
                           perl_syntax_group, // everything!
                                              //
        ...
        mod_s =
            1 << 12, // force s modifier on (overrides match_not_dot_newline)
        no_mod_s =
            1 << 13, // force s modifier off (overrides match_not_dot_newline)
