...
static bool_t _xdr_kadm5_principal_ent_rec(XDR* xdrs,
                                           kadm5_principal_ent_rec* objp,
                                           int v);
static bool_t _xdr_kadm5_policy_ent_rec(XDR* xdrs, kadm5_policy_ent_rec* objp,
                                        int vers);
...
bool_t xdr_krb5_key_data_nocontents(XDR* xdrs, krb5_key_data* objp)
{
    ...
    if (xdrs->x_op == XDR_FREE)
    {
        ...
        if (!xdr_bytes(xdrs, (char**)&objp->key_data_contents[0], &tmp, ~0))
            return FALSE;

        tmp = (unsigned int)objp->key_data_length[1];
        if (!xdr_bytes(xdrs, (char**)&objp->key_data_contents[1], &tmp, ~0))
            return FALSE;
    }
...
static bool_t _xdr_kadm5_principal_ent_rec(XDR* xdrs,
                                           kadm5_principal_ent_rec* objp, int v)
{
    unsigned int n;
    ...
    n = objp->n_key_data;
    if (!xdr_array(xdrs, (caddr_t*)&objp->key_data, &n, ~0,
...
bool_t xdr_cprinc_arg(XDR* xdrs, cprinc_arg* objp)
{
    ...
    if (!_xdr_kadm5_principal_ent_rec(xdrs, &objp->rec, objp->api_version))
    {
        return (FALSE);
    }
...
bool_t xdr_gprincs_ret(XDR* xdrs, gprincs_ret* objp)
{
    ...
    if (objp->code == KADM5_OK)
    {
        ...
        if (!xdr_array(xdrs, (caddr_t*)&objp->princs,
                       (unsigned int*)&objp->count, ~0, sizeof(char*),
                       xdr_nullstring))
        {
            return (FALSE);
        }
...
bool_t xdr_setv4key_arg(XDR* xdrs, setv4key_arg* objp)
{
    ...
    if (!xdr_array(xdrs, (caddr_t*)&objp->keyblock, &n_keys, ~0,
...
bool_t xdr_setkey_arg(XDR* xdrs, setkey_arg* objp)
{
    ...
    if (!xdr_array(xdrs, (caddr_t*)&objp->keyblocks,
                   (unsigned int*)&objp->n_keys, ~0, sizeof(krb5_keyblock),
                   xdr_krb5_keyblock))
    {
        return (FALSE);
    }
...
bool_t xdr_setkey4_arg(XDR* xdrs, setkey4_arg* objp)
{
    ...
    if (!xdr_array(xdrs, (caddr_t*)&objp->key_data,
                   (unsigned int*)&objp->n_key_data, ~0, sizeof(kadm5_key_data),
                   xdr_kadm5_key_data))
    {
        return FALSE;
    }
...
bool_t xdr_chrand_ret(XDR* xdrs, chrand_ret* objp)
{
    ...
    if (objp->code == KADM5_OK)
    {
        if (!xdr_array(xdrs, (char**)&objp->keys, (unsigned int*)&objp->n_keys,
                       ~0, sizeof(krb5_keyblock), xdr_krb5_keyblock))
            return FALSE;
    }
...
bool_t xdr_cpol_arg(XDR* xdrs, cpol_arg* objp)
{
    ...
    if (!_xdr_kadm5_policy_ent_rec(xdrs, &objp->rec, objp->api_version))
    {
        return (FALSE);
    }
    if (!xdr_long(xdrs, &objp->mask))
...
bool_t xdr_gpols_ret(XDR* xdrs, gpols_ret* objp)
{
    ...
    if (objp->code == KADM5_OK)
    {
        ...
        if (!xdr_array(xdrs, (caddr_t*)&objp->pols, (unsigned int*)&objp->count,
                       ~0, sizeof(char*), xdr_nullstring))
        {
            return (FALSE);
        }
    }
...
bool_t xdr_getprivs_ret(XDR* xdrs, getprivs_ret* objp)
{
    ...
    if (!xdr_kadm5_ret_t(xdrs, &objp->code) || !xdr_long(xdrs, &objp->privs))
        return FALSE;
...
bool_t xdr_gstrings_ret(XDR* xdrs, gstrings_ret* objp)
{
    ...
    if (objp->code == KADM5_OK)
    {
        ...
        if (!xdr_array(xdrs, (caddr_t*)&objp->strings,
                       ...
                       sizeof(krb5_string_attr), xdr_krb5_string_attr))
        {
            return (FALSE);
        }
    }
...
bool_t xdr_krb5_keyblock(XDR* xdrs, krb5_keyblock* objp)
{
    ...
    if (!xdr_krb5_enctype(xdrs, &objp->enctype))
        return FALSE;
    if (!xdr_bytes(xdrs, (char**)&objp->contents, (unsigned int*)&objp->length,
                   ~0))
        return FALSE;
    return TRUE;
}
...
bool_t xdr_krb5_string_attr(XDR* xdrs, krb5_string_attr* objp)
{
    ...
    if (!xdr_nullstring(xdrs, &objp->value))
        return FALSE;
    if (xdrs->x_op == XDR_DECODE && (objp->key == NULL || objp->value == NULL))
        return FALSE;
    return TRUE;
}
...
bool_t xdr_kadm5_key_data(XDR* xdrs, kadm5_key_data* objp)
{
    ...
    if (!xdr_krb5_int16(xdrs, &objp->salt.type))
        return FALSE;
    if (!xdr_bytes(xdrs, &objp->salt.data.data, &objp->salt.data.length, ~0))
        return FALSE;
    return TRUE;
}
