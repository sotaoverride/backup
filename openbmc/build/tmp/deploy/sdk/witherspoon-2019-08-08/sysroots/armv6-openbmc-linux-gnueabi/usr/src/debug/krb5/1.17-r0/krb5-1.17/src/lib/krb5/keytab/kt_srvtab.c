...
/*
 * Copyright 1990,1991,2002,2007,2008 by the Massachusetts Institute of
...
static krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_resolve(krb5_context,
                                                           const char*,
                                                           krb5_keytab*);

static krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_get_name(krb5_context,
                                                            krb5_keytab, char*,
                                                            unsigned int);

static krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_close(krb5_context,
                                                         krb5_keytab);
...
static krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_get_next(krb5_context,
                                                            krb5_keytab,
                                                            krb5_keytab_entry*,
                                                            krb5_kt_cursor*);

static krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_end_get(krb5_context,
                                                           krb5_keytab,
                                                           krb5_kt_cursor*);

static krb5_error_code krb5_ktsrvint_open(krb5_context, krb5_keytab);

static krb5_error_code krb5_ktsrvint_close(krb5_context, krb5_keytab);

static krb5_error_code krb5_ktsrvint_read_entry(krb5_context, krb5_keytab,
                                                krb5_keytab_entry*);
...
static krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_resolve(krb5_context context,
                                                           const char* name,
                                                           krb5_keytab* id)
{
...
krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_close(krb5_context context,
                                                  krb5_keytab id)
/*
...
krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_get_name(krb5_context context,
...
krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_get_next(krb5_context context,
                                                     krb5_keytab id,
...
krb5_error_code KRB5_CALLCONV krb5_ktsrvtab_end_get(krb5_context context,
                                                    krb5_keytab id,
                                                    krb5_kt_cursor* cursor)
{
    free(*cursor);
...
static krb5_error_code read_field(FILE* fp, char* s, int len)
{
    int c;
...
krb5_error_code krb5_ktsrvint_open(krb5_context context, krb5_keytab id)
{
...
krb5_error_code krb5_ktsrvint_close(krb5_context context, krb5_keytab id)
{
    if (!KTFILEP(id))
        return 0;
...
krb5_error_code krb5_ktsrvint_read_entry(krb5_context context, krb5_keytab id,
