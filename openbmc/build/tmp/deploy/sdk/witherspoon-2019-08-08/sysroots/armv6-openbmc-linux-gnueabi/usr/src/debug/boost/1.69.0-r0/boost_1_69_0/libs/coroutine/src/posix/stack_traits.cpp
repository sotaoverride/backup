...
bool stack_traits::is_unbounded() BOOST_NOEXCEPT
{
    return RLIM_INFINITY == stacksize_limit().rlim_max;
}

std::size_t stack_traits::page_size() BOOST_NOEXCEPT
{
    return pagesize();
}

std::size_t stack_traits::default_size() BOOST_NOEXCEPT
{
...
std::size_t stack_traits::minimum_size() BOOST_NOEXCEPT
{
    return SIGSTKSZ;
}

std::size_t stack_traits::maximum_size() BOOST_NOEXCEPT
{
