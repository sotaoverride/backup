...
inline typename tools::promote_args<T>::type expint(unsigned n, T z,
                                                    const Policy& /*pol*/);
...
T expint_1_rational(const T& z, const mpl::int_<53>&)
{
    ...
    if (z <= 1)
    {
        ...
        result =
            tools::evaluate_polynomial(P, z) / tools::evaluate_polynomial(Q, z);
        result += z - log(z) - Y;
    }
...
T expint_1_rational(const T& z, const mpl::int_<113>&)
{
    ...
    if (z <= 1)
    {
        ...
        static const T Y = 0.66373538970947265625F;
        static const T P[10] = {
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0865197248079397956434879099175975937),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0369066175910795772830865304506087759),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.24272036838415474665971599314725545),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0502166331248948515282379137550178307),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.00768384138547489410285101483730424919),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.000612574337702109683505224915484717162),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.380207107950635046971492617061708534e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.136528159460768830763009294683628406e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.346839106212658259681029388908658618e-7),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.340500302777838063940402160594523429e-9)};
        static const T Q[10] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.426568827778942588160423015589537302),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0841384046470893490592450881447510148),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0100557215850668029618957359471132995),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.000799334870474627021737357294799839363),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.434452090903862735242423068552687688e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.15829674748799079874182885081231252e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.354406206738023762100882270033082198e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.369373328141051577845488477377890236e-9),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.274149801370933606409282434677600112e-12)};
        result =
            tools::evaluate_polynomial(P, z) / tools::evaluate_polynomial(Q, z);
        result += z - log(z) - Y;
    }
    else if (z <= 4)
    {
        ...
        static const T P[16] = {
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.298096656795020369955077350585959794),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    12.9314045995266142913135497455971247),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    226.144334921582637462526628217345501),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    2070.83670924261732722117682067381405),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    10715.1115684330959908244769731347186),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    30728.7876355542048019664777316053311),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    38520.6078609349855436936232610875297),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -27606.0780981527583168728339620565165),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -169026.485055785605958655247592604835),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -254361.919204983608659069868035092282),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -195765.706874132267953259272028679935),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -83352.6826013533205474990119962408675),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -19251.6828496869586415162597993050194),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -2226.64251774578542836725386936102339),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -109.009437301400845902228611986479816),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -1.51492042209561411434644938098833499)};
        static const T Q[16] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    46.734521442032505570517810766704587),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    908.694714348462269000247450058595655),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    9701.76053033673927362784882748513195),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    63254.2815292641314236625196594947774),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    265115.641285880437335106541757711092),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    732707.841188071900498536533086567735),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1348514.02492635723327306628712057794),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1649986.81455283047769673308781585991),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1326000.828522976970116271208812099),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    683643.09490612171772350481773951341),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    217640.505137263607952365685653352229),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    40288.3467237411710881822569476155485),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    3932.89353979531632559232883283175754),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    169.845369689596739824177412096477219),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    2.17607292280092201170768401876895354)};
        T recip = 1 / z;
    ...
    else if (z < -boost::math::tools::log_min_value<T>())
    {
        ...
        static const T P[19] = {
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.559148411832951463689610809550083986e-40),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.999999999999999999999999999999999997),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -166.542326331163836642960118190147367),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -12204.639128796330005065904675153652),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -520807.069767086071806275022036146855),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -14435981.5242137970691490903863125326),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -274574945.737064301247496460758654196),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -3691611582.99810039356254671781473079),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -35622515944.8255047299363690814678763),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -248040014774.502043161750715548451142),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -1243190389769.53458416330946622607913),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -4441730126135.54739052731990368425339),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -11117043181899.7388524310281751971366),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -18976497615396.9717776601813519498961),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -21237496819711.1011661104761906067131),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -14695899122092.5161620333466757812848),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -5737221535080.30569711574295785864903),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -1077042281708.42654526404581272546244),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -68028222642.1941480871395695677675137)};
        static const T Q[20] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    168.542326331163836642960118190147311),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    12535.7237814586576783518249115343619),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    544891.263372016404143120911148640627),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    15454474.7241010258634446523045237762),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    302495899.896629522673410325891717381),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    4215565948.38886507646911672693270307),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    42552409471.7951815668506556705733344),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    313592377066.753173979584098301610186),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1688763640223.4541980740597514904542),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    6610992294901.59589748057620192145704),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    18601637235659.6059890851321772682606),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    36944278231087.2571020964163402941583),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    50425858518481.7497071917028793820058),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    45508060902865.0899967797848815980644),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    25649955002765.3817331501988304758142),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    8259575619094.6518520988612711292331),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1299981487496.12607474362723586264515),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    70242279152.8241187845178443118302693),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -37633302.9409263839042721539363416685)};
        T recip = 1 / z;
        result = 1 + tools::evaluate_polynomial(P, recip) /
                         tools::evaluate_polynomial(Q, recip);
        result *= exp(-z) * recip;
...
struct expint_fraction
{
    ...
    {
        std::pair<T, T> result =
            std::make_pair(-static_cast<T>((i + 1) * (n + i)), b);
        b += 2;
        ++i;
        return result;
    }
...
inline T expint_as_fraction(unsigned n, T z, const Policy& pol)
{
    ...
    policies::check_series_iterations<T>(
        "boost::math::expint_continued_fraction<%1%>(unsigned,%1%)", max_iter,
        pol);
...
inline T expint_as_series(unsigned n, T z, const Policy& pol)
{
    ...
    result = tools::sum_series(s, policies::get_epsilon<T, Policy>(), max_iter,
                               result);
    policies::check_series_iterations<T>(
        "boost::math::expint_series<%1%>(unsigned,%1%)", max_iter, pol);
    BOOST_MATH_INSTRUMENT_VARIABLE(result)
    BOOST_MATH_INSTRUMENT_VARIABLE(max_iter)
    return result;
}
...
T expint_imp(unsigned n, T z, const Policy& pol, const Tag& tag)
{
    ...
    if (z < 0)
        return policies::raise_domain_error<T>(
            function, "Function requires z >= 0 but got %1%.", z, pol);
    if (z == 0)
        return n == 1 ? policies::raise_overflow_error<T>(function, 0, pol)
                      : T(1 / (static_cast<T>(n - 1)));
...
T expint_i_as_series(T z, const Policy& pol)
{
    ...
    result = tools::sum_series(s, policies::get_epsilon<T, Policy>(), max_iter,
                               result);
    policies::check_series_iterations<T>(
        "boost::math::expint_i_series<%1%>(%1%)", max_iter, pol);
    return result;
}
...
T expint_i_imp(T z, const Policy& pol, const mpl::int_<53>& tag)
{
    ...
    if (z <= 6)
    {
        ...
        // Max Error found at double precision =        Poly: 2.636335e-16
        // Cheb: 4.187027e-16
        static const T P[10] = {
        ...
        static const T r2 = BOOST_MATH_BIG_CONSTANT(
            T, 53,
            0.131401834143860282009280387409357165515556574352422001206362e-16);
        static const T r = static_cast<T>(BOOST_MATH_BIG_CONSTANT(
            T, 53,
            0.372507410781366634461991866580119133535689497771654051555657435242200120636201854384926049951548942392));
        T t = (z / 3) - 1;
        result =
            tools::evaluate_polynomial(P, t) / tools::evaluate_polynomial(Q, t);
        t = (z - r1) - r2;
        result *= t;
        if (fabs(t) < 0.1)
        {
    ...
    else if (z <= 10)
    {
        ...
        // Max Error found at double precision =        Poly: 6.890169e-17
        // Cheb: 6.772128e-17
    ...
    else if (z <= 20)
    {
        ...
        // Max Error found at double precision =        Poly: 4.375868e-17
        // Cheb: 5.860967e-17
    ...
    else if (z <= 40)
    {
        ...
        // Max Error found at double precision =        Poly: 1.441088e-16
        // Cheb: 1.864792e-16
    ...
    else
    {
        ...
        static const T exp40 = static_cast<T>(BOOST_MATH_BIG_CONSTANT(
            T, 53,
            2.35385266837019985407899910749034804508871617254555467236651e17));
...
T expint_i_imp(T z, const Policy& pol, const mpl::int_<64>& tag)
{
    ...
    if (z <= 6)
    {
        ...
        // Max Error found at long double precision =   Poly: 3.344801e-19
        // Cheb: 4.989937e-19
    ...
    else if (z <= 10)
    {
        ...
        // Max Error found at long double precision =   Poly: 1.208328e-20
        // Cheb: 1.073723e-20
    ...
    else if (z <= 20)
    {
        ...
        // Max Error found at long double precision =   Poly: 7.696841e-20
        // Cheb: 6.205163e-20
    ...
    else if (z <= 40)
    {
        ...
        // Max Error found at long double precision =   Poly: 3.419893e-19
        // Cheb: 3.359874e-19
    ...
    else
    {
        ...
        // Max Error found at long double precision =   Poly: 1.310671e-19
        // Cheb: 8.630943e-11
...
void expint_i_imp_113a(T& result, const T& z, const Policy& pol)
{
    ...
    // Max Error found at long double precision =   Poly: 4.355299e-34
    // Cheb: 7.512581e-34

    static const T P[15] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 2.98677224343598593765287235997328555),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.333256034674702967028780537349334037),
        BOOST_MATH_BIG_CONSTANT(T, 113, 0.851831522798101228384971644036708463),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0657854833494646206186773614110374948),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0630065662557284456000060708977935073),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00311759191425309373327784154659649232),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.00176213568201493949664478471656026771),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.491548660404172089488535218163952295e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.207764227621061706075562107748176592e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.225445398156913584846374273379402765e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.996939977231410319761273881672601592e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.212546902052178643330520878928100847e-9),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.154646053060262871360159325115980023e-9),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.143971277122049197323415503594302307e-11),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.306243138978114692252817805327426657e-13)};
    static const T Q[15] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.405026631534345064600850391026113165),
        BOOST_MATH_BIG_CONSTANT(T, 113, 0.123924153524614086482627660399122762),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0286364505373369439591132549624317707),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.00516148845910606985396596845494015963),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000738330799456364820380739850924783649),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.843737760991856114061953265870882637e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.767957673431982543213661388914587589e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.549136847313854595809952100614840031e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.299801381513743676764008325949325404e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.118419479055346106118129130945423483e-8),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.30372295663095470359211949045344607e-10),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.382742953753485333207877784720070523e-12)};
    ...
    static const T r3 = static_cast<T>(BOOST_MATH_BIG_CONSTANT(
        T, 113,
        0.283806480836357377069325311780969887585024578164571984232357e-31));
    static const T r = static_cast<T>(BOOST_MATH_BIG_CONSTANT(
        T, 113,
        0.372507410781366634461991866580119133535689497771654051555657435242200120636201854384926049951548942392));
    T t = (z / 3) - 1;
...
void expint_i_113b(T& result, const T& z)
{
    ...
    // Max Error found at long double precision =   Poly: 2.576723e-35
    // Cheb: 1.236001e-34

    static const T Y = 1.158985137939453125F;
    static const T P[15] = {
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.00139324086199409049282472239613554817),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0338173111691991289178779840307998955),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0555972290794371306259684845277620556),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0378677976003456171563136909186202177),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0152221583517528358782902783914356667),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00428283334203873035104248217403126905),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000922782631491644846511553601323435286),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000155513428088853161562660696055496696),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.205756580255359882813545261519317096e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.220327406578552089820753181821115181e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.189483157545587592043421445645377439e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.122426571518570587750898968123803867e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.635187358949437991465353268374523944e-9),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.203015132965870311935118337194860863e-10),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.384276705503357655108096065452950822e-12)};
    static const T Q[15] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0459658051803613282360464632326866113),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0089505064268613225167835599456014705),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.00139042673882987693424772855926289077),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.000174210708041584097450805790176479012),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.176324034009707558089086875136647376e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.142935845999505649273084545313710581e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.907502324487057260675816233312747784e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.431044337808893270797934621235918418e-8),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.139007266881450521776529705677086902e-9),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.234715286125516430792452741830364672e-11)};
    T t = z / 2 - 4;
    result =
        Y + tools::evaluate_polynomial(P, t) / tools::evaluate_polynomial(Q, t);
    result *= exp(z) / z;
    result += z;
}
...
void expint_i_113c(T& result, const T& z)
{
    ...
    // Max Error found at long double precision =   Poly: 1.958294e-34
    // Cheb: 2.472261e-34

    static const T Y = 1.091579437255859375F;
    static const T P[17] = {
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00685089599550151282724924894258520532),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0443313550253580053324487059748497467),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.071538561252424027443296958795814874),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0622923153354102682285444067843300583),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0361631270264607478205393775461208794),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0153192826839624850298106509601033261),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00496967904961260031539602977748408242),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00126989079663425780800919171538920589),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000258933143097125199914724875206326698),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.422110326689204794443002330541441956e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.546004547590412661451073996127115221e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.546775260262202177131068692199272241e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.404157632825805803833379568956559215e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.200612596196561323832327013027419284e-8),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.502538501472133913417609379765434153e-10),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.326283053716799774936661568391296584e-13),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.869226483473172853557775877908693647e-15)};
    static const T Q[15] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0902400121654409267774593230720600752),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0212708882169429206498765100993228086),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.00404442626252467471957713495828165491),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0006195601618842253612635241404054589),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.755930932686543009521454653994321843e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.716004532773778954193609582677482803e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.500881663076471627699290821742924233e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.233593219218823384508105943657387644e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.554900353169148897444104962034267682e-9)};
    T t = z / 4 - 3.5;
    result =
        Y + tools::evaluate_polynomial(P, t) / tools::evaluate_polynomial(Q, t);
    result *= exp(z) / z;
...
void expint_i_113d(T& result, const T& z)
{
    ...
    // Max Error found at long double precision =   Poly: 4.158110e-35
    // Cheb: 5.385532e-35

    static const T Y = 1.051731109619140625F;
    static const T P[14] = {
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00144552494420652573815404828020593565),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0126747451594545338365684731262912741),
        BOOST_MATH_BIG_CONSTANT(T, 113, -0.01757394877502366717526779263438073),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0126838952395506921945756139424722588),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0060045057928894974954756789352443522),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00205349237147226126653803455793107903),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000532606040579654887676082220195624207),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000107344687098019891474772069139014662),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.169536802705805811859089949943435152e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.20863311729206543881826553010120078e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.195670358542116256713560296776654385e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.133291168587253145439184028259772437e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.595500337089495614285777067722823397e-9),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.133141358866324100955927979606981328e-10)};
    static const T Q[14] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0879346899691339661394537806057953957),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0200802415843802892793583043470125006),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.00362842049172586254520256100538273214),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.000519731362862955132062751246769469957),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.584092147914050999895178697392282665e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.501851497707855358002773398333542337e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.313085677467921096644895738538865537e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.127552010539733113371132321521204458e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.25737310826983451144405899970774587e-9)};
    T t = z / 4 - 5.5;
    result =
        Y + tools::evaluate_polynomial(P, t) / tools::evaluate_polynomial(Q, t);
    BOOST_MATH_INSTRUMENT_VARIABLE(result)
...
void expint_i_113e(T& result, const T& z)
{
    ...
    // Max Error found at long double precision =   Poly: 1.711721e-34
    // Cheb: 3.100018e-34

    static const T Y = 1.032726287841796875F;
    static const T P[15] = {
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00141056919297307534690895009969373233),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0123384175302540291339020257071411437),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0298127270706864057791526083667396115),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0390686759471630584626293670260768098),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0338226792912607409822059922949035589),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0211659736179834946452561197559654582),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0100428887460879377373158821400070313),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00370717396015165148484022792801682932),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0010768667551001624764329000496561659),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000246127328761027039347584096573123531),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.437318110527818613580613051861991198e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.587532682329299591501065482317771497e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.565697065670893984610852937110819467e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.350233957364028523971768887437839573e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.105428907085424234504608142258423505e-8)};
    static const T Q[16] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0607470145906491602476833515412605389),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0125048143774226921434854172947548724),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.00201034366420433762935768458656609163),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.000244823338417452367656368849303165721),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.213511655166983177960471085462540807e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.119323998465870686327170541547982932e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.322153582559488797803027773591727565e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.161635525318683508633792845159942312e-16)};
    T t = z / 8 - 4.25;
    result =
        Y + tools::evaluate_polynomial(P, t) / tools::evaluate_polynomial(Q, t);
    BOOST_MATH_INSTRUMENT_VARIABLE(result)
...
void expint_i_113f(T& result, const T& z)
{
    ...
    // Max Error found at long double precision =   Poly: 1.288958e-35
    // Cheb: 2.304586e-35

    static const T Y = 1.0216197967529296875F;
    static const T P[12] = {
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000322999116096627043476023926572650045),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00385606067447365187909164609294113346),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00686514524727568176735949971985244415),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00606260649593050194602676772589601799),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00334382362017147544335054575436194357),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00126108534260253075708625583630318043),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000337881489347846058951220431209276776),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.648480902304640018785370650254018022e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.87652644082970492211455290209092766e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.794712243338068631557849449519994144e-6),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.434084023639508143975983454830954835e-7),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.107839681938752337160494412638656696e-8)};
    static const T Q[12] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0351720877642000691155202082629857131),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.00565313621289648752407123620997063122),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.000646920278540515480093843570291218295),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.499904084850091676776993523323213591e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.233740058688179614344680531486267142e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.498800627828842754845418576305379469e-7)};
    T t = z / 7 - 7;
    result =
        Y + tools::evaluate_polynomial(P, t) / tools::evaluate_polynomial(Q, t);
    BOOST_MATH_INSTRUMENT_VARIABLE(result)
...
void expint_i_113g(T& result, const T& z)
{
    ...
    // Max Error found at long double precision =   Poly: 9.976345e-35
    // Cheb: 8.358865e-35

    static const T Y = 1.015148162841796875F;
    static const T P[11] = {
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000435714784725086961464589957142615216),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00432114324353830636009453048419094314),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0100740363285526177522819204820582424),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0116744115827059174392383504427640362),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00816145387784261141360062395898644652),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00371380272673500791322744465394211508),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.00112958263488611536502153195005736563),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.000228316462389404645183269923754256664),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.29462181955852860250359064291292577e-4),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.21972450610957417963227028788460299e-5),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.720558173805289167524715527536874694e-7)};
    static const T Q[11] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.0026257132337460784266874572001650153),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.000167479843750859222348869769094711093),
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                0.475673638665358075556452220192497036e-5)};
    T t = z / 14 - 5;
    result =
        Y + tools::evaluate_polynomial(P, t) / tools::evaluate_polynomial(Q, t);
    BOOST_MATH_INSTRUMENT_VARIABLE(result)
...
void expint_i_113h(T& result, const T& z)
{
    ...
    // Max Error found at long double precision =   Poly: 2.058532e-35
    // Cheb: 2.165465e-27

    static const T Y = 1.00849151611328125F;
    static const T P[9] = {
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -0.0084915161132812500000001440233607358),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113,
                                -6758379.93672362080947905580906028645)};
    static const T Q[10] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
...
T expint_i_imp(T z, const Policy& pol, const mpl::int_<113>& tag)
{
    ...
    else // z > 210
    {
        ...
        // Max Error found at long double precision =   Poly: 1.248049e-36
        // Cheb: 2.843486e-29
        ...
        static const T P[8] = {
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.00252532958984375000000000000000000085),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1.16591386866059087390621952073890359),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -67.8483431314018462417456828499277579),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1567.68688154683822956359536287575892),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -17335.4683325819116482498725687644986),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    93632.6567462673524739954389166550069),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -225025.189335919133214440347510936787),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    175864.614717440010942804684741336853)};
        static const T Q[9] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -65.6998869881600212224652719706425129),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1642.73850032324014781607859416890077),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -19937.2610222467322481947237312818575),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    124136.267326632742667972126625064538),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -384614.251466704550678760562965502293),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    523355.035910385688578278384032026998),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -217809.552260834025885677791936351294),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -8555.81719551123640677261226549550872)};
        T t = 1 / z;
        result = Y + tools::evaluate_polynomial(P, t) /
                         tools::evaluate_polynomial(Q, t);
        if (z < 41)
...
template <class T, class Policy, class tag>
const typename expint_i_initializer<T, Policy, tag>::init
    expint_i_initializer<T, Policy, tag>::initializer;
...
template <class T, class Policy, class tag>
const typename expint_1_initializer<T, Policy, tag>::init
    expint_1_initializer<T, Policy, tag>::initializer;
    ...
    expint_forwarder(T z, const Policy& /*pol*/, mpl::true_ const&)
{
    ...
    typedef typename mpl::if_<
        mpl::less_equal<precision_type, mpl::int_<0>>, mpl::int_<0>,
        typename mpl::if_<
            ...
            typename mpl::if_<
                ...
                typename mpl::if_<
                    ...
                    >::type>::type>::type>::type tag_type;

    expint_i_initializer<value_type, forwarding_policy,
                         tag_type>::force_instantiate();

    return policies::checked_narrowing_cast<result_type, forwarding_policy>(
        detail::expint_i_imp(static_cast<value_type>(z), forwarding_policy(),
                             tag_type()),
        "boost::math::expint<%1%>(%1%)");
}
                                                    ...
                                                    const Policy& /*pol*/)
{
    ...
    detail::expint_1_initializer<value_type, forwarding_policy,
                                 tag_type>::force_instantiate();

    return policies::checked_narrowing_cast<result_type, forwarding_policy>(
        detail::expint_imp(n, static_cast<value_type>(z), forwarding_policy(),
                           tag_type()),
        "boost::math::expint<%1%>(unsigned, %1%)");
}

template <class T, class U>
inline typename detail::expint_result<T, U>::type expint(T const z, U const u)
{
...
template <class T>
inline typename tools::promote_args<T>::type expint(T z)
{
