...
class linear_feedback_shift_engine
{
  public:
    ...
    BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(linear_feedback_shift_engine, UIntType,
                                        s0)
    {
        value = s0 & wordmask();
        if (value < (1 << (w - k)))
     ...
     */
    BOOST_RANDOM_DETAIL_SEED_SEQ_SEED(linear_feedback_shift_engine, SeedSeq,
                                      seq)
    {
    ...
    {
        seed(detail::get_one_int<UIntType, (UIntType(2) << (w - 1))>(first,
                                                                     last));
    }
    ...
    : public linear_feedback_shift_engine<UIntType, w, k, q, s>
{
  ...
  public:
    ...
    BOOST_RANDOM_DETAIL_SEED_SEQ_CONSTRUCTOR(linear_feedback_shift, SeedSeq,
                                             seq)
    {
        seed(seq);
    }
    BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(linear_feedback_shift, UIntType,
                                               val)
    {
        seed(val);
    }
