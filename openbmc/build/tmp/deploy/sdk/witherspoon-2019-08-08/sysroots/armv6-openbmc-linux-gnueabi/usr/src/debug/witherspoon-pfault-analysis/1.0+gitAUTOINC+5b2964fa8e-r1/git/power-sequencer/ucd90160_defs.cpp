     ...
     DeviceDefinition{
         ...
         GPIOAnalysis{
             {extraAnalysisType::gpuPGOOD,
              GPIOGroup{"/sys/devices/platform/ahb/ahb:apb/"
                        "ahb:apb:bus@1e78a000/1e78a400.i2c-bus/i2c-11/11-0060",
                        gpio::Value::low,
                        ...
                        GPIODefinitions{
                            GPIODefinition{
                                8, "/system/chassis/motherboard/gv100card0"s},
                            GPIODefinition{
                                9, "/system/chassis/motherboard/gv100card1"s},
                            GPIODefinition{
                                10, "/system/chassis/motherboard/gv100card2"s},
                            GPIODefinition{
                                11, "/system/chassis/motherboard/gv100card3"s},
                            GPIODefinition{
                                12, "/system/chassis/motherboard/gv100card4"s},
                            GPIODefinition{
             ...
             {extraAnalysisType::gpuOverTemp,
              GPIOGroup{"/sys/devices/platform/ahb/ahb:apb/"
                        ...
                        GPIODefinitions{
                            GPIODefinition{
                                2, "/system/chassis/motherboard/gv100card0"s},
                            GPIODefinition{
                                3, "/system/chassis/motherboard/gv100card1"s},
                            GPIODefinition{
                                4, "/system/chassis/motherboard/gv100card2"s},
                            GPIODefinition{
                                5, "/system/chassis/motherboard/gv100card3"s},
                            GPIODefinition{
                                6, "/system/chassis/motherboard/gv100card4"s},
                            GPIODefinition{
