...
#define G_SOCKET_INPUT_STREAM(inst)                                            \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_SOCKET_INPUT_STREAM,            \
                                GSocketInputStream))
#define G_SOCKET_INPUT_STREAM_CLASS(class)                                     \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_SOCKET_INPUT_STREAM,              \
                             GSocketInputStreamClass))
#define G_IS_SOCKET_INPUT_STREAM(inst)                                         \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_SOCKET_INPUT_STREAM))
#define G_IS_SOCKET_INPUT_STREAM_CLASS(class)                                  \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_SOCKET_INPUT_STREAM))
#define G_SOCKET_INPUT_STREAM_GET_CLASS(inst)                                  \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_SOCKET_INPUT_STREAM,             \
                               GSocketInputStreamClass))
