...
#define G_APPLICATION_COMMAND_LINE(inst)                                       \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_APPLICATION_COMMAND_LINE,       \
                                GApplicationCommandLine))
#define G_APPLICATION_COMMAND_LINE_CLASS(class)                                \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_APPLICATION_COMMAND_LINE,         \
                             GApplicationCommandLineClass))
#define G_IS_APPLICATION_COMMAND_LINE(inst)                                    \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_APPLICATION_COMMAND_LINE))
#define G_IS_APPLICATION_COMMAND_LINE_CLASS(class)                             \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_APPLICATION_COMMAND_LINE))
#define G_APPLICATION_COMMAND_LINE_GET_CLASS(inst)                             \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_APPLICATION_COMMAND_LINE,        \
                               GApplicationCommandLineClass))
