...
static nss_status_t read_spwd(TFILE* fp, struct spwd* result, char* buffer,
...
{
    NSS_GETONE(NSLCD_ACTION_SHADOW_BYNAME, WRITE_STRING(fp, name),
...
static nss_backend_op_t shadow_ops[] = {nss_ldap_destructor, shadow_endspent,
                                        shadow_setspent, shadow_getspent,
                                        shadow_getspnam};
