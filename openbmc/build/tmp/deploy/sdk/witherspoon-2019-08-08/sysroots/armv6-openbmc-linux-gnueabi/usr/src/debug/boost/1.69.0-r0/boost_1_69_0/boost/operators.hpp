...
#define BOOST_BINARY_OPERATOR_COMMUTATIVE(NAME, OP)                            \
    template <class T, class U, class B = operators_detail::empty_base<T>>     \
    struct NAME##2                                                             \
        : B{friend T operator OP(const T& lhs, const U& rhs){T nrv(lhs);       \
    nrv OP## = rhs;                                                            \
    return nrv;                                                                \
    }                                                                          \
    ...
    template <class T, class B = operators_detail::empty_base<T>>              \
    struct NAME##1                                                             \
        : B{friend T operator OP(const T& lhs, const T& rhs){T nrv(lhs);       \
    nrv OP## = rhs;                                                            \
    return nrv;                                                                \
    }                                                                          \
    }                                                                          \
...
struct euclidian_ring_operators2
    : ring_operators2<
          ...
          dividable2<
              T, U,
              dividable2_left<T, U, modable2<T, U, modable2_left<T, U, B>>>>>
{
};
...
template <class T, class P, class D, class R,
...
//
// Here's where we put it all together, defining the xxxx forms of the
// templates. We also define specializations of is_chained_base<> for the xxxx,
// xxxx1, and xxxx2 templates.
//
...
#define BOOST_OPERATOR_TEMPLATE(template_name)                                 \
    ...
    template <class T, class U>                                                \
        struct template_name<T, U, operators_detail::empty_base<T>,            \
                             operators_detail::true_t> : template_name##1 < T, \
        U >                                                                    \
    {                                                                          \
    };                                                                         \
                                                                               \
...
template <class T, class V, class D = std::ptrdiff_t, class P = V const*,
          class R = V const&>
...
struct output_iterator_helper
    : output_iteratable<
          T, iterator_helper<std::output_iterator_tag, void, void, void, void>>
{
    T& operator*()
    {
...
template <class T, class V, class D = std::ptrdiff_t, class P = V*,
          class R = V&>
...
struct bidirectional_iterator_helper
    : bidirectional_iteratable<
          T, P, iterator_helper<std::bidirectional_iterator_tag, V, D, P, R>>
{
};
