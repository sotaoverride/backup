...
static int has_unexpired_creds(krb5_gss_cred_id_t kcred,
                               const gss_OID desired_mech, int default_cred,
                               gss_const_key_value_set_t cred_store)
{
    ...
    major_status = krb5_gss_acquire_cred_from(
        &minor, cred_name, 0, &desired_mechs, GSS_C_INITIATE, cred_store,
...
static OM_uint32 copy_initiator_creds(OM_uint32* minor_status,
                                      ...
                                      gss_const_key_value_set_t cred_store)
{
    ...
    *minor_status = 0;
    ...
    major_status =
        krb5_gss_validate_cred_1(minor_status, input_cred_handle, context);
    ...
    major_status =
        kg_value_from_cred_store(cred_store, KRB5_CS_CCACHE_URN, &ccache_name);
    if (GSS_ERROR(major_status))
        goto cleanup;
...
{
    return krb5_gss_store_cred_into(minor_status, input_cred_handle, cred_usage,
                                    desired_mech, overwrite_cred, default_cred,
                                    GSS_C_NO_CRED_STORE, elements_stored,
                                    cred_usage_stored);
}

OM_uint32 KRB5_CALLCONV krb5_gss_store_cred_into(
    OM_uint32* minor_status, gss_cred_id_t input_cred_handle,
    gss_cred_usage_t cred_usage, const gss_OID desired_mech,
    OM_uint32 overwrite_cred, OM_uint32 default_cred,
    ...
    gss_cred_usage_t* cred_usage_stored)
{
    ...
    major_status =
        krb5_gss_inquire_cred(minor_status, input_cred_handle, NULL, &lifetime,
    ...
    major_status =
        copy_initiator_creds(minor_status, input_cred_handle, desired_mech,
