 ...
 */
netsnmp_variable_list* get_first_context(void** my_loop_context,
 ...
 * subtree_context_cache list.
 */
netsnmp_variable_list* get_next_context(void** my_loop_context,
                                        void** my_data_context,
                                        netsnmp_variable_list* put_data,
                                        netsnmp_iterator_info* iinfo)
{
...
void init_vacm_context(void)
{
    ...
    my_handler = netsnmp_create_handler_registration(
        "vacm_context", vacm_context_handler, vacm_context_oid,
        sizeof(vacm_context_oid) / sizeof(oid), HANDLER_CAN_RONLY);
...
int vacm_context_handler(netsnmp_mib_handler* handler,
                         ...
                         netsnmp_request_info* requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        context_ptr =
            (subtree_context_cache*)netsnmp_extract_iterator_context(requests);
        ...
        switch (reqinfo->mode)
        {
            ...
            default:
                 ...
                 */
                snmp_log(LOG_ERR,
                         "vacm_context table accessed as mode=%d.  We're "
