...
static void g_variant_type_info_check(const GVariantTypeInfo* info,
 ...
 */
void g_variant_type_info_query(GVariantTypeInfo* info, guint* alignment,
                               gsize* fixed_size)
{
    g_variant_type_info_check(info, 0);
 ...
 * Since: 2.60
 */
gsize g_variant_type_info_query_depth(GVariantTypeInfo* info)
{
    g_variant_type_info_check(info, 0);
...
static ArrayInfo* GV_ARRAY_INFO(GVariantTypeInfo* info)
{
 ...
 */
void g_variant_type_info_query_element(GVariantTypeInfo* info, guint* alignment,
                                       gsize* fixed_size)
{
    g_variant_type_info_query(GV_ARRAY_INFO(info)->element, alignment,
                              fixed_size);
}

/* == tuple == */
#define GV_TUPLE_INFO_CLASS 'r'
static TupleInfo* GV_TUPLE_INFO(GVariantTypeInfo* info)
{
...
static void tuple_allocate_members(const GVariantType* type,
                                   GVariantMemberInfo** members,
                                   gsize* n_members)
{
 ...
 */
static gboolean tuple_get_item(TupleInfo* info, GVariantMemberInfo* item,
                               gsize* d, gsize* e)
{
 ...
 */
static void tuple_table_append(GVariantMemberInfo** items, gsize i, gsize a,
                               gsize b, gsize c)
{
