 ...
 */
int ipv6ScopeZoneIndexTable_init_data(
    ipv6ScopeZoneIndexTable_registration* ipv6ScopeZoneIndexTable_reg)
{
    DEBUGMSGTL(
        ("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_init_data",
         "called\n"));
    return MFD_SUCCESS;
 ...
 */
void ipv6ScopeZoneIndexTable_container_init(
 ...
 */
void ipv6ScopeZoneIndexTable_container_shutdown(
 ...
 *
 */
static void _snarf_zoneindex_entry(netsnmp_v6scopezone_entry* scopezone_entry,
                                   netsnmp_container* container)
{
    ...
    rowreq_ctx =
        ipv6ScopeZoneIndexTable_allocate_rowreq_ctx(scopezone_entry, NULL);
    if ((NULL != rowreq_ctx) &&
 ...
 *
 */
int ipv6ScopeZoneIndexTable_container_load(netsnmp_container* container)
{
     ...
     */
    netsnmp_container* zoneindex =
        netsnmp_access_scopezone_container_load(NULL, 0);
    ...
    /*
     * TODO:351:M: |-> Load/update data in the ipv6ScopeZoneIndexTable
     * container. loop over your ipv6ScopeZoneIndexTable data, allocate a rowreq
     * context, set the index(es) [and data, optionally] and insert into the
     * container.
     */
     ...
     */
    netsnmp_access_scopezone_container_free(zoneindex, 0x0001);

    DEBUGMSGT(("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_"
               "container_load",
               "inserted %lu records\n",
 ...
 *
 */
void ipv6ScopeZoneIndexTable_container_free(netsnmp_container* container)
{
    DEBUGMSGTL(("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_"
                "container_free",
                "called\n"));
 ...
 * @retval MFD_ERROR       : other error.
 */
int ipv6ScopeZoneIndexTable_row_prep(
    ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_row_prep",
         "called\n"));
