    ...
    BEGINdbgPrintInstInfo CODESTARTdbgPrintInstInfo
        ...
        ENDdbgPrintInstInfo
            ...
            BEGINisCompatibleWithFeature CODESTARTisCompatibleWithFeature
                /* we are not compatible with repeated msg reduction feature, so
                   do not allow it */
        ...
        ENDfreeInstance
            ...
            BEGINfreeWrkrInstance CODESTARTfreeWrkrInstance ENDfreeWrkrInstance
                ...
                BEGINparseSelectorAct CODESTARTparseSelectorAct
                    CODE_STD_STRING_REQUESTparseSelectorAct(0) pData =
                        NULL; /* this action does not have any instance data */
p = *pp;
    ...
    BEGINmodExit CODESTARTmodExit ENDmodExit
        ...
        BEGINqueryEtryPt CODESTARTqueryEtryPt CODEqueryEtryPt_STD_OMOD_QUERIES
            CODEqueryEtryPt_STD_OMOD8_QUERIES ENDqueryEtryPt
                ...
                BEGINmodInit(Discard) CODESTARTmodInit* ipIFVersProvided =
