...
static unsigned char const_Rb[BLOCK_SIZE] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static krb5_error_code generate_subkey(const struct krb5_enc_provider* enc,
                                       krb5_key key, unsigned char* K1,
                                       unsigned char* K2)
{
