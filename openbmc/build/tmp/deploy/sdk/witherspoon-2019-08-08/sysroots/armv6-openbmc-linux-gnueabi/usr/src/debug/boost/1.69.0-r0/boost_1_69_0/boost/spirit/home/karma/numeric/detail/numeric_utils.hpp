...
#error                                                                         \
    "Please set the BOOST_KARMA_NUMERICS_LOOP_UNROLL to a non-negative value!"
#endif
...
template <unsigned Radix, typename CharEncoding = unused_type,
...
{
    template <typename OutputIterator>
    static bool call_noforce(OutputIterator& sink, bool is_zero,
                             bool is_negative, bool sign_if_zero)
    {
    ...
    template <typename OutputIterator>
    static bool call_force(OutputIterator& sink, bool is_zero, bool is_negative,
                           bool sign_if_zero)
    {
    ...
    template <typename OutputIterator>
    static bool call(OutputIterator& sink, bool is_zero, bool is_negative,
