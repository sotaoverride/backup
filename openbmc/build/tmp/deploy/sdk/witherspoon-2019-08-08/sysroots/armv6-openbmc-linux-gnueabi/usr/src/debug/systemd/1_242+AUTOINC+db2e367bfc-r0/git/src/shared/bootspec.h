...
typedef enum BootEntryType
{
    ...
    BOOT_ENTRY_LOADER,  /* Additional entries augmented from LoaderEntries EFI
                           var */
    _BOOT_ENTRY_MAX,
...
typedef struct BootEntry
{
    ...
    char* root; /* The root path in which the drop-in was found, i.e. to which
                   'kernel', 'efi' and 'initrd' are relative */
    char* title;
    char* show_title;
    char* version;
    char* machine_id;
