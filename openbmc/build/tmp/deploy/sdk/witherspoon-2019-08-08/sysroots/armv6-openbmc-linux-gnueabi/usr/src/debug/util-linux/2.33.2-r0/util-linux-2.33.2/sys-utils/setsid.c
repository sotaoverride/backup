...
static void __attribute__((__noreturn__)) usage(void)
{
    ...
    fputs(
        _(" -c, --ctty     set the controlling terminal to the current one\n"),
        out);
...
int main(int argc, char** argv)
{
    ...
    static const struct option longopts[] = {
        {"ctty", no_argument, NULL, 'c'}, {"fork", no_argument, NULL, 'f'},
        {"wait", no_argument, NULL, 'w'}, {"version", no_argument, NULL, 'V'},
