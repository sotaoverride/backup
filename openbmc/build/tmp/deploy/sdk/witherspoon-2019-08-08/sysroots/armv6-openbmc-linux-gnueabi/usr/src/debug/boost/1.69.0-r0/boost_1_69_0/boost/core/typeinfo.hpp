...
class typeinfo
{
  ...
  public:
    ...
    !defined(BOOST_DISABLE_CURRENT_FUNCTION)

        return lib_id_ == rhs.lib_id_ ? this == &rhs
                                      : std::strcmp(name_, rhs.name_) == 0;
    ...
    !defined(BOOST_DISABLE_CURRENT_FUNCTION)
        ...
        return lib_id_ == rhs.lib_id_ ? std::less<typeinfo const*>()(this, &rhs)
                                      : std::strcmp(name_, rhs.name_) < 0;
...
template <class T>
boost::core::typeinfo core_typeid_<T>::ti_(core_typeid_<T>::name(),
                                           &core_typeid_lib_id);
