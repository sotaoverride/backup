...
#define G_DESKTOP_APP_INFO(o)                                                  \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DESKTOP_APP_INFO, GDesktopAppInfo))
#define G_DESKTOP_APP_INFO_CLASS(k)                                            \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_DESKTOP_APP_INFO,                     \
                             GDesktopAppInfoClass))
#define G_IS_DESKTOP_APP_INFO(o)                                               \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DESKTOP_APP_INFO))
#define G_IS_DESKTOP_APP_INFO_CLASS(k)                                         \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_DESKTOP_APP_INFO))
#define G_DESKTOP_APP_INFO_GET_CLASS(o)                                        \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DESKTOP_APP_INFO,                   \
                               GDesktopAppInfoClass))
...
#define G_DESKTOP_APP_INFO_LOOKUP(obj)                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_DESKTOP_APP_INFO_LOOKUP,         \
                                GDesktopAppInfoLookup))
#define G_IS_DESKTOP_APP_INFO_LOOKUP(obj)                                      \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_DESKTOP_APP_INFO_LOOKUP))
#define G_DESKTOP_APP_INFO_LOOKUP_GET_IFACE(obj)                               \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_DESKTOP_APP_INFO_LOOKUP,      \
 ...
 */
#define G_DESKTOP_APP_INFO_LOOKUP_EXTENSION_POINT_NAME                         \
 ...
 */
typedef void (*GDesktopAppLaunchCallback)(GDesktopAppInfo* appinfo, GPid pid,
                                          gpointer user_data);
