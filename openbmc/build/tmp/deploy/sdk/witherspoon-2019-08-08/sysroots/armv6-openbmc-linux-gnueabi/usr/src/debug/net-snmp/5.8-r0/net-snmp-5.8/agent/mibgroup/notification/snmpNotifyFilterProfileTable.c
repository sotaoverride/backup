...
netsnmp_feature_require(header_complex_find_entry)
    ...
    oid snmpNotifyFilterProfileTable_variables_oid[] = {1, 3,  6, 1, 6,
                                                        3, 13, 1, 2};
 ...
 * var_snmpNotifyFilterProfileTable above.
 */
unsigned char* var_snmpNotifyFilterProfileTable(struct variable* vp, oid* name,
...
int write_snmpNotifyFilterProfileName(int action, u_char* var_val,
                                      ...
                                      u_char* statP, oid* name, size_t name_len)
{
    ...
    switch (action)
    {
        ...
        case ACTION:
             ...
             * it.  Note that anything done here must be reversable in the UNDO
             * case
             */
            memcpy(StorageTmp->snmpNotifyFilterProfileName, var_val,
                   var_val_len);
...
int write_snmpNotifyFilterProfileStorType(int action, u_char* var_val,
                                          u_char var_val_type,
...
int write_snmpNotifyFilterProfileRowStatus(int action, u_char* var_val,
                                           u_char var_val_type,
                                           size_t var_val_len, u_char* statP,
                                           oid* name, size_t name_len)
{
    ...
    switch (action)
    {
        ...
        case UNDO:
                ...
                (set_value == RS_CREATEANDGO || set_value == RS_CREATEANDWAIT))
            {
                 ...
                 */
                StorageDel = snmpNotifyFilterProfileTable_extract(StorageNew);
                /*
                 * XXX: free it
                 */
            }
