...
extern int rtnl_ematch_add_child(struct rtnl_ematch*, struct rtnl_ematch*);
...
extern int rtnl_ematch_set_ops(struct rtnl_ematch*, struct rtnl_ematch_ops*);
extern int rtnl_ematch_set_kind(struct rtnl_ematch*, uint16_t);
extern int rtnl_ematch_set_name(struct rtnl_ematch*, const char*);

extern struct rtnl_ematch_tree* rtnl_ematch_tree_alloc(uint16_t);
extern void rtnl_ematch_tree_free(struct rtnl_ematch_tree*);
extern void rtnl_ematch_tree_add(struct rtnl_ematch_tree*, struct rtnl_ematch*);

extern int rtnl_ematch_parse_attr(struct nlattr*, struct rtnl_ematch_tree**);
extern int rtnl_ematch_fill_attr(struct nl_msg*, int, struct rtnl_ematch_tree*);
...
extern char* rtnl_ematch_offset2txt(uint8_t, uint16_t, char*, size_t);
