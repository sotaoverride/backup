...
OM_uint32 KRB5_CALLCONV krb5_gss_export_sec_context(
    minor_status, context_handle, interprocess_token) OM_uint32* minor_status;
...
gss_buffer_t interprocess_token;
{
    ...
    *minor_status = 0;
    ...
    bufsize = 0;
    if ((kret = kg_ctx_size(context, (krb5_pointer)ctx, &bufsize)))
        goto error_out;
    ...
    if ((kret = kg_ctx_externalize(context, (krb5_pointer)ctx, &obp, &blen)))
        goto error_out;
