...
struct make_terminal_impl : proto::transform_impl<Expr, State, Data>
{
    ...
    typedef typename make_component_::template result<make_component_(
        elements, Data)>::type result_type;

    result_type operator()(typename make_terminal_impl::expr_param expr,
                           ...
                           typename make_terminal_impl::data_param data) const
    {
        return typename make_terminal_impl::make_component_()(
            detail::make_cons(proto::value(expr)), data);
    }
};
...
struct make_unary : proto::transform<make_unary<Domain, Tag, Grammar>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef
            typename Grammar::template result<Grammar(child, State, Data)>::type
                child_component;
...
struct make_binary
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        typedef typename Grammar::template result<Grammar(
            typename proto::result_of::child_c<Expr, 0>::type, State,
            Data)>::type lhs_component;

        typedef typename Grammar::template result<Grammar(
            typename proto::result_of::child_c<Expr, 1>::type, State,
            Data)>::type rhs_component;

        typedef typename result_of::make_cons<
            lhs_component,
            typename result_of::make_cons<rhs_component>::type>::type
            elements_type;

        typedef make_component<Domain, Tag> make_component_;

        typedef typename make_component_::template result<make_component_(
            elements_type, Data)>::type result_type;
...
struct make_binary_helper : proto::transform<make_binary_helper<Grammar>>
{
    ...
    {
        typedef
            typename Grammar::template result<Grammar(Expr, State, Data)>::type
                lhs;
    ...
    : proto::transform<make_binary<Domain, Tag, Grammar>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        typedef typename proto::reverse_fold_tree<
            proto::_, proto::make<fusion::nil_>,
        ...
        result_type operator()(typename impl::expr_param expr,
                               ...
                               typename impl::data_param data) const
        {
            return make_component_()(reverse_fold_tree()(expr, state, data),
                                     data);
        }
    };
};
...
struct make_directive : proto::transform<make_directive<Domain, Grammar>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef typename modify<Domain>::template result<modify<Domain>(
            tag_type, Data)>::type modifier_type;

        typedef typename Grammar::template result<Grammar(
            typename proto::result_of::child_c<Expr, 1>::type, State,
            modifier_type)>::type rhs_component;

        typedef typename result_of::make_cons<
            tag_type, typename result_of::make_cons<rhs_component>::type>::type
            elements_type;
                               ...
                               typename impl::data_param data) const
        {
            ...
            typename remove_reference<modifier_type>::type modifier =
                modify<Domain>()(tag, data);

            elements_type elements = detail::make_cons(
                tag // LHS
                ,
                detail::make_cons(Grammar()(proto::child_c<1>(expr) // RHS
                                            ,
                                            state, modifier)));
...
struct make_action : proto::transform<make_action<Domain, Grammar>>
{
    ...
    struct impl : proto::transform_impl<Expr, State, Data>
    {
        ...
        typedef typename mpl::eval_if_c<
            phoenix::is_actor<
                typename proto::result_of::child_c<Expr, 1>::type>::type::value,
        ...
        result_type operator()(typename impl::expr_param expr,
                               typename impl::state_param state,
                               typename impl::data_param data, mpl::true_) const
        {
            elements_type elements = detail::make_cons(
                Grammar()(proto::child_c<0>(expr), state, data) // LHS
                ,
