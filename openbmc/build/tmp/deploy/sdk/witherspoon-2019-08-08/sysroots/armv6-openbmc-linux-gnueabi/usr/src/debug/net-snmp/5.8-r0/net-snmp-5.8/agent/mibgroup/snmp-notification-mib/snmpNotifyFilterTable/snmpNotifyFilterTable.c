...
void initialize_table_snmpNotifyFilterTable(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:initialize_table_snmpNotifyFilterTable",
         "called\n"));
 ...
 */
int snmpNotifyFilterTable_rowreq_ctx_init(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx, void* user_init_ctx)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_rowreq_ctx_init",
         "called\n"));
 ...
 * @param  rowreq_ctx
 */
void snmpNotifyFilterTable_rowreq_ctx_cleanup(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_rowreq_"
                "ctx_cleanup",
                "called\n"));
...
int
    ...
    (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    if (SNMP_STORAGE_VOLATILE == rowreq_ctx->data.snmpNotifyFilterStorageType)
        return 0;
 ...
 */
int snmpNotifyFilterTable_pre_request(
    snmpNotifyFilterTable_registration* user_context)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_pre_request",
         "called\n"));
 ...
 */
int snmpNotifyFilterTable_post_request(
    snmpNotifyFilterTable_registration* user_context, int rc)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_post_request",
         "called\n"));
 ...
 */
int snmpNotifyFilterTable_indexes_set_tbl_idx(
...
{
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_indexes_"
                "set_tbl_idx",
                "called\n"));
    ...
    tbl_idx->snmpNotifyFilterProfileName_len =
        sizeof(tbl_idx->snmpNotifyFilterProfileName) /
        sizeof(tbl_idx->snmpNotifyFilterProfileName[0]); /* max length */
    /*
    ...
    tbl_idx->snmpNotifyFilterSubtree_len =
        sizeof(tbl_idx->snmpNotifyFilterSubtree) /
        sizeof(tbl_idx->snmpNotifyFilterSubtree[0]); /* max length */
    /*
    ...
    tbl_idx->snmpNotifyFilterSubtree_len = snmpNotifyFilterSubtree_val_ptr_len;
    memcpy(tbl_idx->snmpNotifyFilterSubtree, snmpNotifyFilterSubtree_val_ptr,
           snmpNotifyFilterSubtree_val_ptr_len *
 ...
 *  from the mib index.
 */
int snmpNotifyFilterTable_indexes_set(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
    char* snmpNotifyFilterProfileName_val_ptr,
    size_t snmpNotifyFilterProfileName_val_ptr_len,
    oid* snmpNotifyFilterSubtree_val_ptr,
...
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_indexes_set",
         "called\n"));

    if (MFD_SUCCESS != snmpNotifyFilterTable_indexes_set_tbl_idx(
                           &rowreq_ctx->tbl_idx,
                           snmpNotifyFilterProfileName_val_ptr,
                           snmpNotifyFilterProfileName_val_ptr_len,
 ...
 *
 * @note If you need more than (*snmpNotifyFilterMask_val_ptr_len_ptr) bytes of
 * memory, allocate it using malloc() and update
 * snmpNotifyFilterMask_val_ptr_ptr. <b>DO NOT</b> free the previous pointer.
 ...
 */
int snmpNotifyFilterMask_get(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
                             ...
                             size_t* snmpNotifyFilterMask_val_ptr_len_ptr)
{
    ...
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterMask_get", "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:231:o: |-> Extract the current value of the snmpNotifyFilterMask
     * data. copy (* snmpNotifyFilterMask_val_ptr_ptr ) data and (*
     * snmpNotifyFilterMask_val_ptr_len_ptr ) from rowreq_ctx->data
     */
    /*
          ...
          sizeof(rowreq_ctx->data.snmpNotifyFilterMask[0]))))
    {
        ...
        (*snmpNotifyFilterMask_val_ptr_ptr) =
            (char*)malloc(rowreq_ctx->data.snmpNotifyFilterMask_len *
                          sizeof(rowreq_ctx->data.snmpNotifyFilterMask[0]));
        if (NULL == (*snmpNotifyFilterMask_val_ptr_ptr))
        {
 ...
 * @retval MFD_ERROR           : Any other error
 */
int snmpNotifyFilterType_get(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
                             u_long* snmpNotifyFilterType_val_ptr)
{
    ...
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterType_get", "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:231:o: |-> Extract the current value of the snmpNotifyFilterType
     * data. copy (* snmpNotifyFilterType_val_ptr ) from rowreq_ctx->data
     */
    (*snmpNotifyFilterType_val_ptr) = rowreq_ctx->data.snmpNotifyFilterType;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int snmpNotifyFilterStorageType_get(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
    u_long* snmpNotifyFilterStorageType_val_ptr)
{
    /** we should have a non-NULL pointer */
     ...
     * snmpNotifyFilterStorageType data. copy (*
     * snmpNotifyFilterStorageType_val_ptr ) from rowreq_ctx->data
     */
 ...
 * @retval MFD_ERROR           : Any other error
 */
int snmpNotifyFilterRowStatus_get(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
 ...
 */
int snmpNotifyFilterTable_undo_setup(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_undo_setup",
         "called\n"));
 ...
 * @retval MFD_ERROR   : error. set will fail.
 */
int snmpNotifyFilterTable_undo(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 */
int snmpNotifyFilterTable_undo_cleanup(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_undo_cleanup",
         "called\n"));
 ...
 * @retval MFD_ERROR   : error
 */
int snmpNotifyFilterTable_commit(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_commit",
                "called\n"));
 ...
 * @retval MFD_ERROR   : error
 */
int snmpNotifyFilterTable_undo_commit(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_undo_commit",
         "called\n"));
 ...
 *
 */
int snmpNotifyFilterMask_check_value(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
    char* snmpNotifyFilterMask_val_ptr, size_t snmpNotifyFilterMask_val_ptr_len)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterMask_check_value",
         "called\n"));
 ...
 */
int snmpNotifyFilterMask_undo_setup(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterMask_undo_setup",
                "called\n"));
     ...
     * set rowreq_ctx->undo->snmpNotifyFilterMask from
     * rowreq_ctx->data.snmpNotifyFilterMask
     */
 ...
 * snmpNotifyFilterMask_val_ptr
 */
int snmpNotifyFilterMask_set(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
                             char* snmpNotifyFilterMask_val_ptr,
                             size_t snmpNotifyFilterMask_val_ptr_len)
{

    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterMask_set", "called\n"));
     ...
     */
    memcpy(rowreq_ctx->data.snmpNotifyFilterMask, snmpNotifyFilterMask_val_ptr,
 ...
 *        Pointer to the users context.
 */
int snmpNotifyFilterMask_undo(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    ...
    /*
     * copy snmpNotifyFilterMask and snmpNotifyFilterMask_len data
     * set rowreq_ctx->data.snmpNotifyFilterMask from
 ...
 *
 */
int snmpNotifyFilterType_check_value(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
    u_long snmpNotifyFilterType_val)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterType_check_value",
         "called\n"));
 ...
 * won't be done unless it is necessary.
 */
int snmpNotifyFilterType_undo_setup(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterType_undo_setup",
                "called\n"));
     ...
     * set rowreq_ctx->undo->snmpNotifyFilterType from
 ...
 *        A long containing the new value.
 */
int snmpNotifyFilterType_set(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
                             u_long snmpNotifyFilterType_val)
{

    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterType_set", "called\n"));
 ...
 *        Pointer to the users context.
 */
int snmpNotifyFilterType_undo(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    ...
    /*
     * copy snmpNotifyFilterType data
     * set rowreq_ctx->data.snmpNotifyFilterType from
     * rowreq_ctx->undo->snmpNotifyFilterType
     */
    rowreq_ctx->data.snmpNotifyFilterType =
        rowreq_ctx->undo->snmpNotifyFilterType;
 ...
 *
 */
int snmpNotifyFilterStorageType_check_value(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
    u_long snmpNotifyFilterStorageType_val)
{
    DEBUGMSGTL((
        "verbose:snmpNotifyFilterTable:snmpNotifyFilterStorageType_check_value",
        "called\n"));
 ...
 * won't be done unless it is necessary.
 */
int snmpNotifyFilterStorageType_undo_setup(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterStorageType_undo_setup",
         "called\n"));
     ...
     * set rowreq_ctx->undo->snmpNotifyFilterStorageType from
     * rowreq_ctx->data.snmpNotifyFilterStorageType
     */
 ...
 *        A long containing the new value.
 */
int snmpNotifyFilterStorageType_set(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
    u_long snmpNotifyFilterStorageType_val)
{

    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterStorageType_set",
                "called\n"));
 ...
 *        Pointer to the users context.
 */
int snmpNotifyFilterStorageType_undo(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{

    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterStorageType_undo",
         "called\n"));
    ...
    /*
     * copy snmpNotifyFilterStorageType data
     * set rowreq_ctx->data.snmpNotifyFilterStorageType from
     * rowreq_ctx->undo->snmpNotifyFilterStorageType
     */
    rowreq_ctx->data.snmpNotifyFilterStorageType =
        rowreq_ctx->undo->snmpNotifyFilterStorageType;
 ...
 *
 */
int snmpNotifyFilterRowStatus_check_value(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
    u_long snmpNotifyFilterRowStatus_val)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterRowStatus_check_value",
         "called\n"));
 ...
 * won't be done unless it is necessary.
 */
int snmpNotifyFilterRowStatus_undo_setup(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterRowStatus_undo_setup",
         "called\n"));
     ...
     * set rowreq_ctx->undo->snmpNotifyFilterRowStatus from
     * rowreq_ctx->data.snmpNotifyFilterRowStatus
     */
 ...
 *        A long containing the new value.
 */
int snmpNotifyFilterRowStatus_set(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx,
                                  u_long snmpNotifyFilterRowStatus_val)
{

    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterRowStatus_set",
                "called\n"));
     ...
     */
    rowreq_ctx->data.snmpNotifyFilterRowStatus = snmpNotifyFilterRowStatus_val;
 ...
 *        Pointer to the users context.
 */
int snmpNotifyFilterRowStatus_undo(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{

    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterRowStatus_undo",
                "called\n"));
    ...
    /*
     * copy snmpNotifyFilterRowStatus data
     * set rowreq_ctx->data.snmpNotifyFilterRowStatus from
     * rowreq_ctx->undo->snmpNotifyFilterRowStatus
     */
    rowreq_ctx->data.snmpNotifyFilterRowStatus =
        rowreq_ctx->undo->snmpNotifyFilterRowStatus;
 ...
 */
int snmpNotifyFilterTable_check_dependencies(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("internal:snmpNotifyFilterTable:snmpNotifyFilterTable_check_"
                "dependencies",
                "called\n"));
     ...
     */
    rc = check_storage_transition(rowreq_ctx->undo->snmpNotifyFilterStorageType,
                                  rowreq_ctx->data.snmpNotifyFilterStorageType);
    if (MFD_SUCCESS != rc)
        return rc;
     ...
     */
    if (rowreq_ctx->column_set_flags & COLUMN_SNMPNOTIFYFILTERROWSTATUS_FLAG)
    {
        /*
        ...
        {
            if (ROWSTATUS_DESTROY == rowreq_ctx->data.snmpNotifyFilterRowStatus)
            {
                     ...
                     rowreq_ctx->data.snmpNotifyFilterRowStatus)
            {
                ...
                rowreq_ctx->data.snmpNotifyFilterRowStatus = ROWSTATUS_ACTIVE;
            }
        } /* row creation */
        else
        {
