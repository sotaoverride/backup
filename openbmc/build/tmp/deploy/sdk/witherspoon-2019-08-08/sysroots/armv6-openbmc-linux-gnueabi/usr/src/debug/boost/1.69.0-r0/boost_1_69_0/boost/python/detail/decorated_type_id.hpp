...
struct decorated_type_info : totally_ordered<decorated_type_info>
{
    ...
    friend BOOST_PYTHON_DECL std::ostream&
        operator<<(std::ostream&, decorated_type_info const&);
...
inline decorated_type_info::decorated_type_info(type_info base_t,
...
inline bool decorated_type_info::
    operator==(decorated_type_info const& rhs) const
{
...
BOOST_PYTHON_DECL std::ostream& operator<<(std::ostream&,
                                           decorated_type_info const&);
