...
class execution_context : private noncopyable
{
  ...
  public:
     ...
     *
     * @throws boost::system::system_error Thrown on failure. If the
     * notification fails the execution_context object should no longer be used
