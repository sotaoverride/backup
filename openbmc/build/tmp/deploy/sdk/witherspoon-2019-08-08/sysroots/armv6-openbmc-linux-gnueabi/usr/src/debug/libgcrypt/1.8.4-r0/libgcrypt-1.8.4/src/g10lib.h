...
void _gcry_bug(const char* file, int line, const char* func) GCC_ATTR_NORETURN;
...
gcry_mpi_t _gcry_generate_public_prime(unsigned int nbits,
                                       ...
                                       int (*extra_check)(void*, gcry_mpi_t),
                                       void* extra_check_arg);
gcry_err_code_t _gcry_generate_elg_prime(int mode, unsigned int pbits,
...
#else
#define fast_wipememory2_unaligned_head(_vptr, _vset, _vlen)                   \
    do                                                                         \
    {                                                                          \
...
#define fast_wipememory2(_vptr, _vset, _vlen)                                  \
    ...
    {                                                                          \
        ...
        do                                                                     \
        {                                                                      \
            volatile fast_wipememory_t* _vptr_long = (volatile void*)_vptr;    \
...
#define alphap(a) ((*(a) >= 'A' && *(a) <= 'Z') || (*(a) >= 'a' && *(a) <= 'z'))
#define hexdigitp(a)                                                           \
