 ...
 */
static gcry_err_code_t spec_from_sexp(gcry_sexp_t sexp, int want_private,
                                      ...
                                      gcry_sexp_t* r_parms)
{
    ...
    *r_spec = NULL;
    ...
    list =
        sexp_find_token(sexp, want_private ? "private-key" : "public-key", 0);
 ...
 */
static gcry_err_code_t check_pubkey_algo(int algo, unsigned use)
{
...
*/
gcry_err_code_t _gcry_pk_encrypt(gcry_sexp_t* r_ciph, gcry_sexp_t s_data,
                                 gcry_sexp_t s_pkey)
{
    gcry_err_code_t rc;
    gcry_pk_spec_t* spec;
 ...
 */
gcry_err_code_t _gcry_pk_decrypt(gcry_sexp_t* r_plain, gcry_sexp_t s_data,
                                 gcry_sexp_t s_skey)
{
    gcry_err_code_t rc;
    gcry_pk_spec_t* spec;
...
*/
gcry_err_code_t _gcry_pk_sign(gcry_sexp_t* r_sig, gcry_sexp_t s_hash,
                              gcry_sexp_t s_skey)
{
    gcry_err_code_t rc;
    gcry_pk_spec_t* spec;
...
gcry_err_code_t _gcry_pk_verify(gcry_sexp_t s_sig, gcry_sexp_t s_hash,
                                gcry_sexp_t s_pkey)
{
    gcry_err_code_t rc;
    gcry_pk_spec_t* spec;
 ...
 */
gcry_err_code_t _gcry_pk_genkey(gcry_sexp_t* r_key, gcry_sexp_t s_parms)
{
...
gcry_err_code_t _gcry_pk_ctl(int cmd, void* buffer, size_t buflen)
{
...
gcry_err_code_t _gcry_pk_algo_info(int algorithm, int what, void* buffer,
                                   size_t* nbytes)
{
    gcry_err_code_t rc = 0;
...
gcry_err_code_t _gcry_pubkey_get_sexp(gcry_sexp_t* r_sexp, int mode,
                                      gcry_ctx_t ctx)
{
    mpi_ec_t ec;
