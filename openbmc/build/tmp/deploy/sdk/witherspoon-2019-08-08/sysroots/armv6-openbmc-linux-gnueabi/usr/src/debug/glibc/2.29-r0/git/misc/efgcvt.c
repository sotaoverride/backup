...
char* __APPEND(FUNC_PREFIX, fcvt)(FLOAT_TYPE value, int ndigit, int* decpt,
                                  int* sign)
{
    if (FCVT_BUFPTR == NULL)
    {
    ...
    (void)__APPEND(FUNC_PREFIX, fcvt_r)(value, ndigit, decpt, sign, FCVT_BUFPTR,
                                        FCVT_MAXDIG);

    return FCVT_BUFPTR;
}

char* __APPEND(FUNC_PREFIX, ecvt)(FLOAT_TYPE value, int ndigit, int* decpt,
                                  int* sign)
{
    (void)__APPEND(FUNC_PREFIX, ecvt_r)(value, ndigit, decpt, sign, ECVT_BUFFER,
                                        MAXDIG);

    return ECVT_BUFFER;
}

char* __APPEND(FUNC_PREFIX, gcvt)(FLOAT_TYPE value, int ndigit, char* buf)
{
