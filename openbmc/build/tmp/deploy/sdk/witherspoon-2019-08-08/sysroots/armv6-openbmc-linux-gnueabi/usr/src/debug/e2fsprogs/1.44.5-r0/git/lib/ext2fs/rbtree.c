...
static void ext2fs_rb_augment_path(struct rb_node* node, rb_augment_f func,
                                   void* data)
{
 ...
 */
void ext2fs_rb_augment_insert(struct rb_node* node, rb_augment_f func,
                              void* data)
{
    if (node->rb_left)
        node = node->rb_left;
 ...
 */
void ext2fs_rb_augment_erase_end(struct rb_node* node, rb_augment_f func,
                                 void* data)
{
    if (node)
        ext2fs_rb_augment_path(node, func, data);
