 ...
 *
 * The header provides forward declarations of Boost.ASIO that are required for
 * the user's code to compile with Boost.Log. The forward declarations allow to
 * avoid including the major part of Boost.ASIO and system headers into user's
 * code.
 */
