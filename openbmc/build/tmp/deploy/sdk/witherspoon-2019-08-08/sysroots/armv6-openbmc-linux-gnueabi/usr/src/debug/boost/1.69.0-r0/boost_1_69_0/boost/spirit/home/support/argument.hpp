...
#define SPIRIT_DECLARE_ARG(z, n, data)                                         \
    typedef phoenix::actor<argument<n>> BOOST_PP_CAT(                          \
        BOOST_PP_CAT(_, BOOST_PP_INC(n)), _type);                              \
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>, boost::spirit::argument<N>, mpl::false_ // is not nullary
    ,
    v2_eval(proto::make<boost::spirit::argument<N>()>,
            proto::call<functional::env(proto::_state)>))

BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <typename Dummy>, boost::spirit::attribute_context<Dummy>,
...
struct attribute_context
{
    ...
    struct result
    {
        ...
        typedef typename remove_const<
            typename mpl::at_c<typename Env::args_type, 0>::type>::type type;
    };
