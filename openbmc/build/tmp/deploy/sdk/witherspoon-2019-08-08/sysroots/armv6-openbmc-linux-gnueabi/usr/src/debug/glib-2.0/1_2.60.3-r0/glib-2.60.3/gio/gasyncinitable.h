...
#define G_ASYNC_INITABLE(obj)                                                  \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), G_TYPE_ASYNC_INITABLE, GAsyncInitable))
#define G_IS_ASYNC_INITABLE(obj)                                               \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), G_TYPE_ASYNC_INITABLE))
#define G_ASYNC_INITABLE_GET_IFACE(obj)                                        \
    (G_TYPE_INSTANCE_GET_INTERFACE((obj), G_TYPE_ASYNC_INITABLE,               \
                                   GAsyncInitableIface))
#define G_TYPE_IS_ASYNC_INITABLE(type)                                         \
    (g_type_is_a((type), G_TYPE_ASYNC_INITABLE))
