 ...
 *
 */
static void array_qsort(void** data, int first, int last,
                        netsnmp_container_compare* f)
{
    int i, j;
    void *mid, *tmp;
...
static int Sort_Array(netsnmp_container* c)
{
...
static int linear_search(const void* val, netsnmp_container* c)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
    size_t pos = 0;
...
static int binary_search(const void* val, netsnmp_container* c, int exact,
                         size_t* next)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
    size_t len = t->count;
...
NETSNMP_STATIC_INLINE binary_array_table* netsnmp_binary_array_initialize(void)
{
...
NETSNMP_STATIC_INLINE size_t netsnmp_binary_array_count(netsnmp_container* c)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
    /*
     * return count
...
NETSNMP_STATIC_INLINE void* netsnmp_binary_array_get(netsnmp_container* c,
                                                     const void* key, int exact)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
    int index = 0;
...
static int netsnmp_binary_array_get_at(netsnmp_container* c, size_t pos,
                                       void** entry)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
...
int netsnmp_binary_array_remove_at(netsnmp_container* c, size_t index,
                                   void** save)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
...
NETSNMP_STATIC_INLINE void
    netsnmp_binary_array_for_each(netsnmp_container* c,
                                  netsnmp_container_obj_func* fe, void* context,
                                  int sort)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
    size_t i;
...
static int _ba_resize_check(binary_array_table* t)
{
    size_t new_max;
    void** new_data;
...
static int netsnmp_binary_array_insert_before(netsnmp_container* c,
                                              size_t index, const void* entry,
                                              int dirty)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
...
NETSNMP_STATIC_INLINE int netsnmp_binary_array_insert(netsnmp_container* c,
                                                      const void* const_entry)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
    int dirty = 0, i = -2;
    size_t next, pos;
 ...
 *
 */
static int binary_search_for_start(netsnmp_index* val, netsnmp_container* c)
{
    binary_array_table* t = (binary_array_table*)c->container_data;
    size_t len = t->count;
    size_t half;
    ...
    if ((first >= t->count) || c->ncompare(t->data[first], val) != 0)
        return -1;

    return first;
}

void** netsnmp_binary_array_get_subset(netsnmp_container* c, void* key,
                                       int* len)
{
    binary_array_table* t;
    void** subset;
 ...
 *
 */
static void* _ba_find(netsnmp_container* container, const void* data)
{
    return netsnmp_binary_array_get(container, data, 1);
}

static void* _ba_find_next(netsnmp_container* container, const void* data)
{
    return netsnmp_binary_array_get(container, data, 0);
}

static int _ba_insert(netsnmp_container* container, const void* data)
{
    return netsnmp_binary_array_insert(container, data);
}

static int _ba_insert_before(netsnmp_container* container, size_t index,
                             void* data)
{
...
static int _ba_remove(netsnmp_container* container, const void* data)
{
    return netsnmp_binary_array_remove(container, data, NULL);
}

static int _ba_free(netsnmp_container* container)
{
    netsnmp_binary_array_release(container);
    return 0;
}

static size_t _ba_size(netsnmp_container* container)
{
    return netsnmp_binary_array_count(container);
}

static void _ba_for_each(netsnmp_container* container,
                         netsnmp_container_obj_func* f, void* context)
{
    netsnmp_binary_array_for_each(container, f, context, 1);
}

static void _ba_clear(netsnmp_container* container,
                      netsnmp_container_obj_func* f, void* context)
{
    netsnmp_binary_array_clear(container, f, context);
}

static netsnmp_void_array* _ba_get_subset(netsnmp_container* container,
                                          void* data)
{
...
static netsnmp_container* _ba_duplicate(netsnmp_container* c, void* ctx,
                                        u_int flags)
{
...
{
    static netsnmp_factory f = {
        "binary_array",
        (netsnmp_factory_produce_f*)netsnmp_container_get_binary_array};
 ...
 *
 */
NETSNMP_STATIC_INLINE binary_array_table* _ba_it2cont(binary_array_iterator* it)
{
    if (NULL == it)
    {
...
NETSNMP_STATIC_INLINE void* _ba_iterator_position(binary_array_iterator* it,
                                                  size_t pos)
{
...
static void* _ba_iterator_curr(binary_array_iterator* it)
{
    if (NULL == it)
    {
        netsnmp_assert(NULL != it);
...
static void* _ba_iterator_first(binary_array_iterator* it)
{
    return _ba_iterator_position(it, 0);
}

static void* _ba_iterator_next(binary_array_iterator* it)
{
    if (NULL == it)
    {
        netsnmp_assert(NULL != it);
...
static void* _ba_iterator_last(binary_array_iterator* it)
{
    binary_array_table* t = _ba_it2cont(it);
    if (NULL == t)
    {
...
static int _ba_iterator_remove(binary_array_iterator* it)
{
    binary_array_table* t = _ba_it2cont(it);
    if (NULL == t)
    {
...
static int _ba_iterator_reset(binary_array_iterator* it)
{
    binary_array_table* t = _ba_it2cont(it);
    if (NULL == t)
    {
...
static int _ba_iterator_release(netsnmp_iterator* it)
{
    free(it);
