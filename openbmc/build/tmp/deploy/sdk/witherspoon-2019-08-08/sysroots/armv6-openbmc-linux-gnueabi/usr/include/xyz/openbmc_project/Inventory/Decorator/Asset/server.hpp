...
class Asset
{
    ...
    private:
        ...
        static int _callback_get_PartNumber(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);
        /** @brief sd-bus callback for set-property 'PartNumber' */
        static int _callback_set_PartNumber(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);
        ...
        static int _callback_get_BuildDate(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);
        /** @brief sd-bus callback for set-property 'BuildDate' */
        static int _callback_set_BuildDate(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);
        ...
        static constexpr auto _interface = "xyz.openbmc_project.Inventory.Decorator.Asset";
