...
void krb5int_MD4Init(krb5_MD4_CTX* mdContext)
{
...
void krb5int_MD4Update(krb5_MD4_CTX* mdContext, const unsigned char* inBuf,
                       unsigned int inLen)
{
    krb5_ui_4 in[16];
    int mdi;
...
void krb5int_MD4Final(krb5_MD4_CTX* mdContext)
{
    krb5_ui_4 in[16];
    int mdi;
    unsigned int i, ii;
...
#define ROTATE                                                                 \
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        FF(a, b, c, d, in[i], round1consts[i % 4]);
        ROTATE;
    }
    for (i = 0; i < 16; i++)
    {
        ...
        GG(a, b, c, d, in[round2indices[i]], round2consts[i % 4]);
        ROTATE;
    }
    for (i = 0; i < 16; i++)
    {
        ...
        HH(a, b, c, d, in[round3indices[i]], round3consts[i % 4]);
        ROTATE;
    }
#else
    /* Round 1 */
