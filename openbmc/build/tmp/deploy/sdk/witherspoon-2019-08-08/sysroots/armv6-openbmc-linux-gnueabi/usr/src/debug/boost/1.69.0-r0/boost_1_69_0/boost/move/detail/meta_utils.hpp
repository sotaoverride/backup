...
struct addr_impl_ref
{
    ...
    BOOST_MOVE_FORCEINLINE operator T&() const
    {
        return v_;
    }
...
struct and_impl : and_impl<B::value, C, D>
{
};
...
struct and_ : and_impl<A::value, B, C, D>
{
};
...
struct or_impl : or_impl<B::value, C, D>
{
};
...
struct or_ : or_impl<A::value, B, C, D>
{
};
...
struct enable_if_and : enable_if_c<and_<A, B, C, D>::value, R>
{
};

template <class R, class A, class B, class C = true_, class D = true_>
struct disable_if_and : disable_if_c<and_<A, B, C, D>::value, R>
{
};

template <class R, class A, class B, class C = false_, class D = false_>
struct enable_if_or : enable_if_c<or_<A, B, C, D>::value, R>
{
};

template <class R, class A, class B, class C = false_, class D = false_>
struct disable_if_or : disable_if_c<or_<A, B, C, D>::value, R>
{
};
...
//////////////////////////////////////////////////////////////////////////////
template <class T>
struct has_move_emulation_enabled_impl : is_convertible<T, ::boost::rv<T>&>
{
};
...
{
template <class T, bool emulation = has_move_emulation_enabled_impl<T>::value,
...
//
//- TypeTraits metafunctions is_lvalue_reference, add_lvalue_reference, and
//remove_lvalue_reference ?
//  Perhaps add_reference and remove_reference can be modified so that they
//  behave wrt emulated rvalue references the same as wrt real rvalue
//  references, i.e., add_reference< rv<T>& > -> T& rather than rv<T>& (since
//  T&& & -> T&).
//
//- Add'l TypeTraits has_[trivial_]move_{constructor,assign}...?
//
//- An as_lvalue(T& x) function, which amounts to an identity operation in
//C++0x, but strips emulated
//  rvalue references in C++03.  This may be necessary to prevent "accidental
//  moves".
