...
static gcry_mac_spec_t* spec_from_algo(int algo)
{
    gcry_mac_spec_t* spec;
    int idx;
...
static gcry_mac_spec_t* spec_from_name(const char* name)
{
    gcry_mac_spec_t* spec;
    int idx;
 ...
 */
int _gcry_mac_map_name(const char* string)
{
    gcry_mac_spec_t* spec;
 ...
 * is valid.
 */
const char* _gcry_mac_algo_name(int algorithm)
{
    gcry_mac_spec_t* spec;
...
static gcry_err_code_t check_mac_algo(int algorithm)
{
    gcry_mac_spec_t* spec;
 ...
 */
static gcry_err_code_t mac_open(gcry_mac_hd_t* hd, int algo, int secure,
                                gcry_ctx_t ctx)
{
    gcry_mac_spec_t* spec;
    gcry_err_code_t err;
...
static gcry_err_code_t mac_reset(gcry_mac_hd_t hd)
{
...
static void mac_close(gcry_mac_hd_t hd)
{
...
static gcry_err_code_t mac_setkey(gcry_mac_hd_t hd, const void* key,
                                  size_t keylen)
{
...
static gcry_err_code_t mac_setiv(gcry_mac_hd_t hd, const void* iv, size_t ivlen)
{
...
static gcry_err_code_t mac_write(gcry_mac_hd_t hd, const void* inbuf,
                                 size_t inlen)
{
...
static gcry_err_code_t mac_read(gcry_mac_hd_t hd, void* outbuf, size_t* outlen)
{
...
static gcry_err_code_t mac_verify(gcry_mac_hd_t hd, const void* buf,
                                  size_t buflen)
{
...
gpg_err_code_t _gcry_mac_open(gcry_mac_hd_t* h, int algo, unsigned int flags,
                              gcry_ctx_t ctx)
{
    gcry_err_code_t rc;
...
void _gcry_mac_close(gcry_mac_hd_t hd)
{
    if (hd)
        mac_close(hd);
}

gcry_err_code_t _gcry_mac_setkey(gcry_mac_hd_t hd, const void* key,
                                 size_t keylen)
{
    return mac_setkey(hd, key, keylen);
}

gcry_err_code_t _gcry_mac_setiv(gcry_mac_hd_t hd, const void* iv, size_t ivlen)
{
    return mac_setiv(hd, iv, ivlen);
}

gcry_err_code_t _gcry_mac_write(gcry_mac_hd_t hd, const void* inbuf,
                                size_t inlen)
{
    return mac_write(hd, inbuf, inlen);
}

gcry_err_code_t _gcry_mac_read(gcry_mac_hd_t hd, void* outbuf, size_t* outlen)
{
    return mac_read(hd, outbuf, outlen);
}

gcry_err_code_t _gcry_mac_verify(gcry_mac_hd_t hd, const void* buf,
                                 size_t buflen)
{
...
gcry_err_code_t _gcry_mac_ctl(gcry_mac_hd_t hd, int cmd, void* buffer,
                              size_t buflen)
{
    gcry_err_code_t rc;
 ...
 */
gcry_err_code_t _gcry_mac_algo_info(int algo, int what, void* buffer,
                                    size_t* nbytes)
{
