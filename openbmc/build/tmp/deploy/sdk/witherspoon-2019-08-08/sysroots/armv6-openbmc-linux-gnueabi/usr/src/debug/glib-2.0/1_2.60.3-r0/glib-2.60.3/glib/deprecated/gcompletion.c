 ...
 * In contrast to g_completion_complete(), this function returns the largest
 ...
 *
 * Returns: (element-type utf8) (transfer none): the list of items whose strings
 ...
 * Deprecated: 2.26: Rarely used API
 **/
GList* g_completion_complete_utf8(GCompletion* cmp, const gchar* prefix,
                                  gchar** new_prefix)
{
    GList* list;
    gchar *p, *q;
 ...
 * Deprecated: 2.26: Rarely used API
 **/
GList* g_completion_complete(GCompletion* cmp, const gchar* prefix,
                             gchar** new_prefix)
{
    gsize plen, len;
    gboolean done = FALSE;
