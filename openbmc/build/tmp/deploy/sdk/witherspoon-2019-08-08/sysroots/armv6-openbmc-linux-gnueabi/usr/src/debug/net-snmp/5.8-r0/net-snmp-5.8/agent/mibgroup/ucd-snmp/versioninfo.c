    ...
    void init_versioninfo(void)
{
     ...
     * information at
     */
    struct variable2 extensible_version_variables[] = {{MIBINDEX,
                                                        ASN_INTEGER,
...
u_char* var_extensible_version(struct variable* vp, oid* name, size_t* length,
...
int update_hook(int action, u_char* var_val, u_char var_val_type,
...
int debugging_hook(int action, u_char* var_val, u_char var_val_type,
...
int save_persistent(int action, u_char* var_val, u_char var_val_type,
                    size_t var_val_len, u_char* statP, oid* name,
                    size_t name_len)
{
    if (var_val_type != ASN_INTEGER)
