...
//! the set/multiset and provides an appropriate value_traits class for
//! set/multiset.
//!
...
#endif
class set_base_hook : public make_set_base_hook<
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                          O1, O2, O3, O4
#else
                          Options...
                          ...
                          >::type
{
  ...
  public:
    ...
    //!   the object is stored in a set an assertion is raised. If link_mode is
    ...
    //!   set::iterator_to will return a valid iterator.
    //!
    //! <b>Complexity</b>: Constant
...
struct make_set_member_hook
{
    ...
    typedef generic_hook<
        ...
        rbtree_node_traits<typename packed_options::void_pointer,
                           packed_options::optimize_size>,
        member_tag, packed_options::link_mode, NoBaseHookId>
        implementation_defined;
    /// @endcond
    typedef implementation_defined type;
};

//! Put a public data member set_member_hook in order to store objects of this
//! class in a set/multiset. set_member_hook holds the data necessary for
//! maintaining the set/multiset and provides an appropriate value_traits class
//! for set/multiset.
//!
...
template <class O1, class O2, class O3, class O4>
#endif
class set_member_hook : public make_set_member_hook<
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                            O1, O2, O3, O4
#else
                            Options...
