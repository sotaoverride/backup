...
/** Compare two timeval structures and return a negative value when a < b, 0
 * when a == b and a positive value otherwise */
...
/** Return the difference between the current time and *a. Positive if *a was
 * earlier */
