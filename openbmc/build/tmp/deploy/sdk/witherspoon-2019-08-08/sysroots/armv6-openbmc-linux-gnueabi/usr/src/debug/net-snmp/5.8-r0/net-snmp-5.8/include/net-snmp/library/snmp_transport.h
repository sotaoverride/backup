...
#define NETSNMP_TRANSPORT_FLAG_TMSTATE                                         \
    0x08 /* indicates opaque is a                                              \
...
typedef struct netsnmp_transport_s
{
    ...
    int (*f_send)(struct netsnmp_transport_s*, const void*, int, void**, int*);
    ...
    char* (*f_fmtaddr)(struct netsnmp_transport_s*, const void*, int);
    ...
    void (*f_get_taddr)(struct netsnmp_transport_s* t, void** addr,
                        size_t* addr_len);
