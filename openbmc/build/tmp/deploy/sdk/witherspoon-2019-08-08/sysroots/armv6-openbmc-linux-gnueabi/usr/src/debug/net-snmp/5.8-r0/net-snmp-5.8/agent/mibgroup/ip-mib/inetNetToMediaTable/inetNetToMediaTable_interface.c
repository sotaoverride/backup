...
netsnmp_feature_child_of(inetNetToMediaTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_require(check_all_requests_error)
            ...
            netsnmp_feature_child_of(inetNetToMediaTable_container_size,
                                     inetNetToMediaTable_external_access)
                netsnmp_feature_child_of(inetNetToMediaTable_registration_set,
                                         inetNetToMediaTable_external_access)
...
static void _inetNetToMediaTable_container_init(
    inetNetToMediaTable_interface_ctx* if_ctx);
static void _inetNetToMediaTable_container_shutdown(
    inetNetToMediaTable_interface_ctx* if_ctx);
...
inetNetToMediaTable_registration* inetNetToMediaTable_registration_get(void)
{
...
inetNetToMediaTable_registration* inetNetToMediaTable_registration_set(
...
NETSNMP_STATIC_INLINE int
    _inetNetToMediaTable_undo_column(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                     netsnmp_variable_list* var, int column);
#endif /* NETSNMP_NO_WRITE_SUPPORT || NETSNMP_DISABLE_SET_SUPPORT */

NETSNMP_STATIC_INLINE int _inetNetToMediaTable_check_indexes(
 ...
 */
void _inetNetToMediaTable_initialize_interface(
    inetNetToMediaTable_registration* reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods* access_multiplexer =
    ...
    DEBUGMSGTL(("internal:inetNetToMediaTable:_inetNetToMediaTable_initialize_"
                "interface",
                "called\n"));
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, inetNetToMediaTable_if_ctx.container,
    ...
    {
        handler = netsnmp_cache_handler_get(inetNetToMediaTable_if_ctx.cache);
        netsnmp_inject_handler(reginfo, handler);
    }
 ...
 */
void _inetNetToMediaTable_shutdown_interface(
    inetNetToMediaTable_registration* reg_ptr)
{
    /*
...
void inetNetToMediaTable_valid_columns_set(netsnmp_column_info* vc)
{
 ...
 */
int inetNetToMediaTable_index_to_oid(netsnmp_index* oid_idx,
                                     inetNetToMediaTable_mib_index* mib_idx)
{
     ...
     * set up varbinds
     */
    memset(&var_inetNetToMediaIfIndex, 0x00, sizeof(var_inetNetToMediaIfIndex));
     ...
     */
    var_inetNetToMediaIfIndex.next_variable = &var_inetNetToMediaNetAddressType;
    ...
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_index_to_oid",
                "called\n"));
 ...
 */
int inetNetToMediaTable_index_from_oid(netsnmp_index* oid_idx,
                                       inetNetToMediaTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_index_from_oid",
         "called\n"));
                                            ...
                                            void* user_init_ctx)
{
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:inetNetToMediaTable_allocate_rowreq_ctx",
         "called\n"));
    ...
    else
    {
        if (NULL != data)
        {
            ...
            rowreq_ctx->data = data;
                 ...
                 (rowreq_ctx->data = inetNetToMediaTable_allocate_data()))
        {
    ...
    {
        if (SNMPERR_SUCCESS !=
            inetNetToMediaTable_rowreq_ctx_init(rowreq_ctx, user_init_ctx))
        {
 ...
 */
void inetNetToMediaTable_release_rowreq_ctx(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:inetNetToMediaTable_release_rowreq_ctx",
         "called\n"));
 ...
 * wrapper
 */
static int _mfd_inetNetToMediaTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_pre_request",
         "called\n"));
 ...
 * wrapper
 */
static int _mfd_inetNetToMediaTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx =
        (inetNetToMediaTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    int rc, packet_rc;

    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_post_request",
         "called\n"));
    ...
    rc = inetNetToMediaTable_post_request(inetNetToMediaTable_if_ctx.user_ctx,
                                          packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
                                               ...
                                               int* rc_ptr)
{
    ...
    DEBUGMSGTL(("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_rowreq_"
                "from_index",
                "called\n"));
 ...
 * wrapper
 */
static int _mfd_inetNetToMediaTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_object_lookup",
         "called\n"));
 ...
 */
NETSNMP_STATIC_INLINE int
    _inetNetToMediaTable_get_column(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                    netsnmp_variable_list* var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_get_column",
         "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_INETNETTOMEDIAPHYSADDRESS:
            ...
            rc = inetNetToMediaPhysAddress_get(
        ...
        case COLUMN_INETNETTOMEDIATYPE:
            ...
            rc = inetNetToMediaType_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_INETNETTOMEDIASTATE:
            var->val_len = sizeof(u_long);
            var->type = ASN_INTEGER;
            rc = inetNetToMediaState_get(rowreq_ctx, (u_long*)var->val.string);
            break;
...
int _mfd_inetNetToMediaTable_get_values(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        ...
                                        netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_get_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetNetToMediaTable_get_column(rowreq_ctx, requests->requestvb,
                                             tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
    ...
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_inetNetToMediaTable_check_indexes",
         "called\n"));
     ...
     */
    return inetNetToMediaTable_validate_index(
        inetNetToMediaTable_if_ctx.user_ctx, rowreq_ctx);
 ...
 */
NETSNMP_STATIC_INLINE int _inetNetToMediaTable_check_column(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx, netsnmp_variable_list* var,
    int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_inetNetToMediaTable_check_column",
         "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_INETNETTOMEDIAPHYSADDRESS:
            ...
            {
                DEBUGMSGTL(
                    ("inetNetToMediaTable:_inetNetToMediaTable_check_column:"
                     "inetNetToMediaPhysAddress",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetNetToMediaPhysAddress_check_value(
                    rowreq_ctx, (char*)var->val.string, var->val_len);
        ...
        case COLUMN_INETNETTOMEDIATYPE:
            ...
            {
                rc = inetNetToMediaType_check_value(
        ...
        case COLUMN_INETNETTOMEDIAROWSTATUS:
            ...
            {
                rc = inetNetToMediaRowStatus_check_value(
                    rowreq_ctx, *((u_long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
...
int _mfd_inetNetToMediaTable_check_objects(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_check_objects",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetNetToMediaTable_check_column(rowreq_ctx, requests->requestvb,
                                               tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error(requests, SNMP_VALIDATE_ERR(rc));
 ...
 */
static int _mfd_inetNetToMediaTable_check_dependencies(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx =
        (inetNetToMediaTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    DEBUGMSGTL(("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_check_"
                "dependencies",
                "called\n"));
    ...
    if (rc)
    {
        DEBUGMSGTL(("inetNetToMediaTable:mfd",
                    "error %d from "
 ...
 */
NETSNMP_STATIC_INLINE int _inetNetToMediaTable_undo_setup_column(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_inetNetToMediaTable_undo_setup_column",
         "called for %d\n", column));
 ...
 * undo setup
 */
int _mfd_inetNetToMediaTable_undo_setup(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        netsnmp_agent_request_info* agtreq_info,
                                        netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_undo_setup",
         "called\n"));
    ...
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc =
                _inetNetToMediaTable_undo_setup_column(rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL(("inetNetToMediaTable:mfd",
                            "error %d from "
 ...
 * undo setup
 */
int _mfd_inetNetToMediaTable_undo_cleanup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_undo_cleanup",
         "called\n"));
 ...
 */
NETSNMP_STATIC_INLINE int
    _inetNetToMediaTable_set_column(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                    netsnmp_variable_list* var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(("internal:inetNetToMediaTable:_inetNetToMediaTable_set_column",
                "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_INETNETTOMEDIAPHYSADDRESS:
            rowreq_ctx->column_set_flags |=
                COLUMN_INETNETTOMEDIAPHYSADDRESS_FLAG;
            rc = inetNetToMediaPhysAddress_set(
                rowreq_ctx, (char*)var->val.string, var->val_len);
            break;
        ...
        case COLUMN_INETNETTOMEDIATYPE:
            rowreq_ctx->column_set_flags |= COLUMN_INETNETTOMEDIATYPE_FLAG;
            rc =
                inetNetToMediaType_set(rowreq_ctx, *((u_long*)var->val.string));
            break;
...
int _mfd_inetNetToMediaTable_set_values(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        netsnmp_agent_request_info* agtreq_info,
                                        netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_set_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetNetToMediaTable_set_column(rowreq_ctx, requests->requestvb,
                                             tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL(("inetNetToMediaTable:mfd",
 ...
 * commit the values
 */
int _mfd_inetNetToMediaTable_commit(netsnmp_mib_handler* handler,
                                    netsnmp_handler_registration* reginfo,
                                    netsnmp_agent_request_info* agtreq_info,
                                    netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_commit",
                "called\n"));
    ...
    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
         ...
         */
        inetNetToMediaTable_dirty_set(inetNetToMediaTable_dirty_get() +
...
int _mfd_inetNetToMediaTable_undo_commit(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_undo_commit",
         "called\n"));
                                     ...
                                     netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(("internal:inetNetToMediaTable:_inetNetToMediaTable_undo_column",
                "called for %d\n", column));
...
int _mfd_inetNetToMediaTable_undo_values(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    ...
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_undo_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetNetToMediaTable_undo_column(rowreq_ctx, requests->requestvb,
                                              tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
 ...
 */
int _mfd_inetNetToMediaTable_irreversible_commit(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(("internal:inetNetToMediaTable:_mfd_inetNetToMediaTable_"
                "irreversible:commit",
                "called\n"));
    ...
    else
    {
        ...
        {
            rowreq_ctx->rowreq_flags &= ~MFD_ROW_CREATED;
            CONTAINER_INSERT(inetNetToMediaTable_if_ctx.container, rowreq_ctx);
        }
    }
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
    ...
    {
        snmp_log(LOG_ERR, "invalid cache for inetNetToMediaTable_cache_load\n");
        return -1;
    }
     ...
     * call user code
     */
    return inetNetToMediaTable_container_load((netsnmp_container*)cache->magic);
} /* _cache_load */
...
static void _cache_free(netsnmp_cache* cache, void* magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log(LOG_ERR, "invalid cache in inetNetToMediaTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free(inetNetToMediaTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_container_item_free", "called\n"));
...
static void _container_free(netsnmp_container* container)
{
    DEBUGMSGTL(("internal:inetNetToMediaTable:_container_free", "called\n"));
 ...
 */
void _inetNetToMediaTable_container_init(
    inetNetToMediaTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_inetNetToMediaTable_container_init",
         "called\n"));
     ...
     */
    if_ctx->cache =
        netsnmp_cache_create(30, /* timeout in seconds */
                             _cache_load, _cache_free, inetNetToMediaTable_oid,
                             inetNetToMediaTable_oid_size);

    if (NULL == if_ctx->cache)
    {
        snmp_log(LOG_ERR, "error creating cache for inetNetToMediaTable\n");
        return;
    }
 ...
 */
void _inetNetToMediaTable_container_shutdown(
    inetNetToMediaTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:inetNetToMediaTable:_inetNetToMediaTable_container_shutdown",
         "called\n"));
...
inetNetToMediaTable_rowreq_ctx* inetNetToMediaTable_row_find_by_mib_index(
    inetNetToMediaTable_mib_index* mib_idx)
{
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx;
    ...
    rowreq_ctx = (inetNetToMediaTable_rowreq_ctx*)CONTAINER_FIND(
        inetNetToMediaTable_if_ctx.container, &oid_idx);
