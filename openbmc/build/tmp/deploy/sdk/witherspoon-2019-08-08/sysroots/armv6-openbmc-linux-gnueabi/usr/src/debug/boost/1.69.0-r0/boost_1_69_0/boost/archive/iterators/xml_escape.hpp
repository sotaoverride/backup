...
template <class Base>
class xml_escape : public escape<xml_escape<Base>, Base>
{
  ...
  public:
    ...
    template <class T>
    xml_escape(T start) : super_t(Base(static_cast<T>(start)))
    {
    }
...
template <class Base>
char xml_escape<Base>::fill(const char*& bstart, const char*& bend)
{
...
template <class Base>
wchar_t xml_escape<Base>::fill(const wchar_t*& bstart, const wchar_t*& bend)
{
