...
#define G_FILE_ICON(o)                                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_FILE_ICON, GFileIcon))
#define G_FILE_ICON_CLASS(k)                                                   \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_FILE_ICON, GFileIconClass))
...
#define G_FILE_ICON_GET_CLASS(o)                                               \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_FILE_ICON, GFileIconClass))
