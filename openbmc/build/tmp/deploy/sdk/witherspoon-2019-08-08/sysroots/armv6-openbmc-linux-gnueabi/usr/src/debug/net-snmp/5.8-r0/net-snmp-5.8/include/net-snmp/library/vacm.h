...
NETSNMP_IMPORT
struct vacm_viewEntry* vacm_getViewEntry(const char*, oid*, size_t, int);
/*
...
NETSNMP_IMPORT
struct vacm_viewEntry* vacm_createViewEntry(const char*, oid*, size_t);
/*
...
NETSNMP_IMPORT
struct vacm_accessEntry* vacm_createAccessEntry(const char*, const char*, int,
                                                int);
NETSNMP_IMPORT
struct vacm_accessEntry* vacm_getAccessEntry(const char*, const char*, int,
                                             int);
NETSNMP_IMPORT
