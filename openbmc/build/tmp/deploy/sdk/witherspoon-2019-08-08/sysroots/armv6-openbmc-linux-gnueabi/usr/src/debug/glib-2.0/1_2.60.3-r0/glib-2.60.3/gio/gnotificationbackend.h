...
#define G_NOTIFICATION_BACKEND(o)                                              \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_NOTIFICATION_BACKEND,              \
                                GNotificationBackend))
#define G_IS_NOTIFICATION_BACKEND(o)                                           \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_NOTIFICATION_BACKEND))
#define G_NOTIFICATION_BACKEND_CLASS(k)                                        \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_NOTIFICATION_BACKEND,                 \
                             GNotificationBackendClass))
#define G_NOTIFICATION_BACKEND_GET_CLASS(o)                                    \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_NOTIFICATION_BACKEND,               \
                               GNotificationBackendClass))
...
struct _GNotificationBackendClass
{
    ...
    void (*send_notification)(GNotificationBackend* backend, const gchar* id,
