...
#define G_TLS_CONNECTION(inst)                                                 \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_TLS_CONNECTION, GTlsConnection))
#define G_TLS_CONNECTION_CLASS(class)                                          \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_TLS_CONNECTION,                   \
                             GTlsConnectionClass))
#define G_IS_TLS_CONNECTION(inst)                                              \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_TLS_CONNECTION))
#define G_IS_TLS_CONNECTION_CLASS(class)                                       \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_TLS_CONNECTION))
#define G_TLS_CONNECTION_GET_CLASS(inst)                                       \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_TLS_CONNECTION,                  \
                               GTlsConnectionClass))
