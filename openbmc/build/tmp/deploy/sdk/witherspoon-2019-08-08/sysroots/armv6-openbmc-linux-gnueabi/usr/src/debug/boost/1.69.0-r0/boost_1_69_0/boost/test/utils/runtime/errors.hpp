...
class BOOST_SYMBOL_VISIBLE specific_param_error : public Base
{
  ...
  public:
    ...
    {
        const_cast<specific_param_error<Derived, Base>&>(*this).msg.append(
            unit_test::utils::string_cast(val));
...
class BOOST_SYMBOL_VISIBLE ambiguous_param
    : public specific_param_error<ambiguous_param, input_error>
{
  public:
...
class unrecognized_param
    : public specific_param_error<unrecognized_param, input_error>
{
  public:
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
