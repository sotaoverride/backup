    ...
    difference_type distance_to(const integer_iterator& other) const
    {
        return is_signed<value_type>::value
                   ...
                   : (other.m_value >= m_value)
                         ...
                         : -static_cast<difference_type>(m_value -
                                                         other.m_value);
    }
                                    ...
                                    Integer, std::ptrdiff_t>
{
  ...
  public:
    ...
    integer_iterator_with_step(value_type first, difference_type step,
        ...
        m_first(first),
        m_step(step), m_step_size(step_size)
    {
    }
    ...
    : public iterator_range<range_detail::integer_iterator_with_step<Integer>>
{
  ...
  public:
    ...
    strided_integer_range(Iterator first, Iterator last) : base_t(first, last)
    {
    }
};
                                      ...
                                      StepSize step_size)
{
    ...
    typedef typename range_detail::integer_iterator_with_step<Integer>
        iterator_t;
