...
#define TOUPPER(Ch) __towupper_l((Ch), _nl_C_locobj_ptr)
    ...
    (!defined isascii && !defined HAVE_ISASCII)
...
/* External user entry point.  */
    ...
    /* Prototype.  */
    extern INT
    __strtol_l(const STRING_TYPE* nptr, STRING_TYPE** endptr, int base);
#endif
...
libc_hidden_def(__strtol_l) weak_alias(__strtol_l, strtol_l)
