...
const int udpEndpointTable_oid_size = OID_LENGTH(udpEndpointTable_oid);
...
{
    DEBUGMSGTL(("verbose:udpEndpointTable:init_udpEndpointTable", "called\n"));
...
void initialize_table_udpEndpointTable(void)
{
    ...
    DEBUGMSGTL(("verbose:udpEndpointTable:initialize_table_udpEndpointTable",
                "called\n"));
     ...
     */
    _udpEndpointTable_initialize_interface(udpEndpointTable_user_context_p,
                                           flags);
} /* initialize_table_udpEndpointTable */
 ...
 */
int udpEndpointTable_pre_request(udpEndpointTable_registration* user_context)
{
    DEBUGMSGTL(
        ("verbose:udpEndpointTable:udpEndpointTable_pre_request", "called\n"));
 ...
 */
int udpEndpointTable_post_request(udpEndpointTable_registration* user_context,
                                  int rc)
{
    DEBUGMSGTL(
        ("verbose:udpEndpointTable:udpEndpointTable_post_request", "called\n"));
    ...
    u_long udpEndpointProcess_val)
{
    ...
    tbl_idx->udpEndpointLocalAddress_len =
        sizeof(tbl_idx->udpEndpointLocalAddress) /
        sizeof(tbl_idx->udpEndpointLocalAddress[0]); /* max length */
    /*
    ...
    tbl_idx->udpEndpointLocalAddress_len = udpEndpointLocalAddress_val_ptr_len;
    memcpy(tbl_idx->udpEndpointLocalAddress, udpEndpointLocalAddress_val_ptr,
           udpEndpointLocalAddress_val_ptr_len *
     ...
     */
    tbl_idx->udpEndpointRemoteAddressType = udpEndpointRemoteAddressType_val;
    ...
    tbl_idx->udpEndpointRemoteAddress_len =
        ...
        sizeof(tbl_idx->udpEndpointRemoteAddress[0]); /* max length */
    /*
    ...
    tbl_idx->udpEndpointRemoteAddress_len =
        udpEndpointRemoteAddress_val_ptr_len;
    memcpy(tbl_idx->udpEndpointRemoteAddress, udpEndpointRemoteAddress_val_ptr,
           udpEndpointRemoteAddress_val_ptr_len *
 ...
 *  from the mib index.
 */
int udpEndpointTable_indexes_set(udpEndpointTable_rowreq_ctx* rowreq_ctx,
...
{
    DEBUGMSGTL(
        ("verbose:udpEndpointTable:udpEndpointTable_indexes_set", "called\n"));

    if (MFD_SUCCESS !=
        udpEndpointTable_indexes_set_tbl_idx(
            &rowreq_ctx->tbl_idx, udpEndpointLocalAddressType_val,
            udpEndpointLocalAddress_val_ptr,
            udpEndpointLocalAddress_val_ptr_len, udpEndpointLocalPort_val,
            udpEndpointRemoteAddressType_val, udpEndpointRemoteAddress_val_ptr,
            udpEndpointRemoteAddress_val_ptr_len, udpEndpointRemotePort_val,
            udpEndpointInstance_val, udpEndpointProcess_val))
        return MFD_ERROR;
 ...
 */
int udpEndpointProcess_get(udpEndpointTable_rowreq_ctx* rowreq_ctx,
                           u_long* udpEndpointProcess_val_ptr)
{
    /** we should have a non-NULL pointer */
    netsnmp_assert(NULL != udpEndpointProcess_val_ptr);

    DEBUGMSGTL(("verbose:udpEndpointTable:udpEndpointProcess_get", "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:231:o: |-> Extract the current value of the udpEndpointProcess data.
     * copy (* udpEndpointProcess_val_ptr ) from
     * rowreq_ctx->tbl_idx.udpEndpointProcess
     */
