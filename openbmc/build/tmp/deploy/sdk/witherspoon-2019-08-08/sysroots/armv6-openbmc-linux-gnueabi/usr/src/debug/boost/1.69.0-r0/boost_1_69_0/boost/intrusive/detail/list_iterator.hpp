...
class list_iterator
{
  ...
  public:
    ...
    BOOST_INTRUSIVE_FORCEINLINE explicit list_iterator(
  ...
  public:
    ...
    BOOST_INTRUSIVE_FORCEINLINE friend bool operator==(const list_iterator& l,
                                                       const list_iterator& r)
    {
    ...
    {
        return list_iterator<ValueTraits, false>(this->pointed_node(),
