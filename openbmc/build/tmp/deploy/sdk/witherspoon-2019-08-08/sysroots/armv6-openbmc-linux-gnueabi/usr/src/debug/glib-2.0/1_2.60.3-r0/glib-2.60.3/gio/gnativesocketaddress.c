...
G_DEFINE_TYPE_WITH_PRIVATE(GNativeSocketAddress, g_native_socket_address,
                           G_TYPE_SOCKET_ADDRESS)

static void g_native_socket_address_dispose(GObject* object)
{
...
static GSocketFamily g_native_socket_address_get_family(GSocketAddress* address)
{
...
static gssize g_native_socket_address_get_native_size(GSocketAddress* address)
{
    GNativeSocketAddress* addr;
...
static gboolean g_native_socket_address_to_native(GSocketAddress* address,
...
static void g_native_socket_address_class_init(GNativeSocketAddressClass* klass)
{
...
static void g_native_socket_address_init(GNativeSocketAddress* address)
{
