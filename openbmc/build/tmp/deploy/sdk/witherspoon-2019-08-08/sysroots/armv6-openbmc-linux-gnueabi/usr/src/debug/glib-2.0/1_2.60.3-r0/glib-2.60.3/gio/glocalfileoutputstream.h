...
#define G_LOCAL_FILE_OUTPUT_STREAM(o)                                          \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_LOCAL_FILE_OUTPUT_STREAM,          \
                                GLocalFileOutputStream))
#define G_LOCAL_FILE_OUTPUT_STREAM_CLASS(k)                                    \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_LOCAL_FILE_OUTPUT_STREAM,             \
                             GLocalFileOutputStreamClass))
#define G_IS_LOCAL_FILE_OUTPUT_STREAM(o)                                       \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_LOCAL_FILE_OUTPUT_STREAM))
#define G_IS_LOCAL_FILE_OUTPUT_STREAM_CLASS(k)                                 \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_LOCAL_FILE_OUTPUT_STREAM))
#define G_LOCAL_FILE_OUTPUT_STREAM_GET_CLASS(o)                                \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_LOCAL_FILE_OUTPUT_STREAM,           \
                               GLocalFileOutputStreamClass))
