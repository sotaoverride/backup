...
extern int __internal_setnetgrent(const char* group, struct __netgrent* datap);
libc_hidden_proto(__internal_setnetgrent) extern void __internal_endnetgrent(
    struct __netgrent* datap);
libc_hidden_proto(__internal_endnetgrent) extern int __internal_getnetgrent_r(
    char** hostp, char** userp, char** domainp, struct __netgrent* datap,
