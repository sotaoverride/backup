...
static inline int missing_name_to_handle_at(int fd, const char* name,
...
static inline int missing_renameat2(int oldfd, const char* oldname, int newfd,
...
#if !HAVE_KCMP
static inline int missing_kcmp(pid_t pid1, pid_t pid2, int type,
...
#if !HAVE_KEYCTL
static inline long missing_keyctl(int cmd, unsigned long arg2,
...
static inline key_serial_t missing_add_key(const char* type,
...
#if !HAVE_STATX
static inline ssize_t missing_statx(int dfd, const char* filename,
