...
#define SKM_DEFINE_STACK_OF(t1, t2, t3)                                        \
    ...
    static ossl_unused ossl_inline int sk_##t1##_reserve(STACK_OF(t1) * sk,    \
                                                         int n)                \
    {                                                                          \
    ...
    static ossl_unused ossl_inline t2* sk_##t1##_delete_ptr(STACK_OF(t1) * sk, \
                                                            t2 * ptr)          \
    {                                                                          \
    ...
    static ossl_unused ossl_inline int sk_##t1##_unshift(STACK_OF(t1) * sk,    \
                                                         t2 * ptr)             \
    {                                                                          \
    ...
    static ossl_unused ossl_inline int sk_##t1##_find_ex(STACK_OF(t1) * sk,    \
                                                         t2 * ptr)             \
    {                                                                          \
    ...
    {                                                                          \
        return (STACK_OF(t1)*)OPENSSL_sk_deep_copy(                            \
            (const OPENSSL_STACK*)sk, (OPENSSL_sk_copyfunc)copyfunc,           \
            (OPENSSL_sk_freefunc)freefunc);                                    \
    }                                                                          \
