...
#define G_LOCK(name)                                                           \
    ...
    {                                                                          \
        g_log(G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG,                                 \
              "file %s: line %d (%s): locking: %s ", __FILE__, __LINE__,       \
              G_STRFUNC, #name);                                               \
...
#define G_UNLOCK(name)                                                         \
    ...
    {                                                                          \
        g_log(G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG,                                 \
              "file %s: line %d (%s): unlocking: %s ", __FILE__, __LINE__,     \
              G_STRFUNC, #name);                                               \
...
#define G_TRYLOCK(name)                                                        \
    (g_log(G_LOG_DOMAIN, G_LOG_LEVEL_DEBUG,                                    \
           "file %s: line %d (%s): try locking: %s ", __FILE__, __LINE__,      \
           G_STRFUNC, #name),                                                  \
 ...
 * my_object_do_stuff (MyObject *self)
 * {
 *   g_autoptr(GRecMutexLocker) locker = g_rec_mutex_locker_new
 * (&self->rec_mutex);
 *
