...
struct extract_uint
{
    ...
    inline static bool call(Iterator& first, Iterator const& last, T& attr_)
    {
        ...
        typedef detail::extract_int<T, Radix, MinDigits, MaxDigits,
                                    detail::positive_accumulator<Radix>,
                                    Accumulate, IgnoreOverflowDigits>
            extract_type;
    ...
    inline static bool call(Iterator& first, Iterator const& last,
                            Attribute& attr_)
    {
...
struct extract_int
{
    ...
    inline static bool call(Iterator& first, Iterator const& last, T& attr_)
    {
        ...
        typedef detail::extract_int<T, Radix, MinDigits, MaxDigits,
                                    detail::negative_accumulator<Radix>>
            extract_neg_type;
