...
class xor_combine_engine
{
  public:
     ...
     * @endxmlwarning
     */
    BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(xor_combine_engine, result_type,
                                               v)
    {
        seed(v);
    }
    ...
    {
        return (std::min)((URNG1::min)(), (URNG2::min)());
    }
    /** Returns the largest value that the generator can produce. */
    static result_type max BOOST_PREVENT_MACRO_SUBSTITUTION()
    {
        return (std::max)((URNG1::min)(), (URNG2::max)());
    }
...
class xor_combine : public xor_combine_engine<URNG1, s1, URNG2, s2>
{
  ...
  public:
    ...
    xor_combine(const URNG1& rng1, const URNG2& rng2) : base_type(rng1, rng2)
    {
    }
