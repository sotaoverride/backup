...
struct iterator_facade : iterator_base<Derived>
{
    ...
    struct equal_to // default implementation
        : is_same<typename I1::derived_type, typename I2::derived_type>
    {
    };
    ...
    struct advance
        : mpl::if_c<(N::value > 0), advance_detail::forward<Iterator, N::value>,
                    advance_detail::backward<Iterator, N::value>>::type
    {
    ...
    struct distance : distance_detail::linear_distance<First, Last>
    {
    };
};
} // namespace fusion
