...
#define EVP_PKEY_CTX_get_signature_md(ctx, pmd)                                \
    EVP_PKEY_CTX_ctrl(ctx, -1, EVP_PKEY_OP_TYPE_SIG, EVP_PKEY_CTRL_GET_MD, 0,  \
                      (void*)(pmd))

#define EVP_PKEY_CTX_set_mac_key(ctx, key, len)                                \
    EVP_PKEY_CTX_ctrl(ctx, -1, EVP_PKEY_OP_KEYGEN, EVP_PKEY_CTRL_SET_MAC_KEY,  \
                      len, (void*)(key))
...
void EVP_PKEY_meth_get_verifyctx(
    ...
    int (**pverifyctx)(EVP_PKEY_CTX* ctx, const unsigned char* sig, int siglen,
                       EVP_MD_CTX* mctx));
