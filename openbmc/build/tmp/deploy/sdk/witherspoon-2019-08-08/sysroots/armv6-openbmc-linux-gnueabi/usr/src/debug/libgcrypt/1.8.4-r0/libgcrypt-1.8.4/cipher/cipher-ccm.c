...
gcry_err_code_t _gcry_cipher_ccm_set_nonce(gcry_cipher_hd_t c,
...
gcry_err_code_t _gcry_cipher_ccm_set_lengths(gcry_cipher_hd_t c, u64 encryptlen,
...
gcry_err_code_t _gcry_cipher_ccm_authenticate(gcry_cipher_hd_t c,
...
gcry_err_code_t _gcry_cipher_ccm_tag(gcry_cipher_hd_t c, unsigned char* outbuf,
...
gcry_err_code_t _gcry_cipher_ccm_get_tag(gcry_cipher_hd_t c,
                                         unsigned char* outtag, size_t taglen)
{
    return _gcry_cipher_ccm_tag(c, outtag, taglen, 0);
}

gcry_err_code_t _gcry_cipher_ccm_check_tag(gcry_cipher_hd_t c,
...
gcry_err_code_t _gcry_cipher_ccm_encrypt(gcry_cipher_hd_t c,
...
gcry_err_code_t _gcry_cipher_ccm_decrypt(gcry_cipher_hd_t c,
                                         unsigned char* outbuf,
                                         size_t outbuflen,
                                         const unsigned char* inbuf,
                                         size_t inbuflen)
