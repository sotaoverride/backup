                                                 ...
                                                 u_int load_flags)
{
    ...
    {
        snmp_log(LOG_ERR,
                 "no container specified/found for access_scopezone_\n");
        return -1;
    }
...
#define PROCFILE "/proc/net/if_inet6"
    ...
    {
        DEBUGMSGTL(
            ("access:scopezone:container", "could not open " PROCFILE "\n"));
        return -2;
    }
