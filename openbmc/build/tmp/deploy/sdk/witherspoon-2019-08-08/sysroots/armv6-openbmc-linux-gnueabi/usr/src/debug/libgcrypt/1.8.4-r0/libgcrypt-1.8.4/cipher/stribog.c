...
static unsigned int transform(void* context, const unsigned char* inbuf_arg,
                              size_t datalen);

static void stribog_init_512(void* context, unsigned int flags)
{
...
static void stribog_init_256(void* context, unsigned int flags)
{
    STRIBOG_CONTEXT* hd = context;
...
static void transform_bits(STRIBOG_CONTEXT* hd, const unsigned char* data,
                           unsigned count)
{
    u64 M[8];
    u64 l;
...
static unsigned int transform_blk(void* context, const unsigned char* inbuf_arg)
{
    STRIBOG_CONTEXT* hd = context;
...
static void stribog_final(void* context)
{
    STRIBOG_CONTEXT* hd = context;
    u64 Z[8] = {};
    int i;
...
static byte* stribog_read_512(void* context)
{
    STRIBOG_CONTEXT* hd = context;
...
static byte* stribog_read_256(void* context)
{
    STRIBOG_CONTEXT* hd = context;
...
gcry_md_spec_t _gcry_digest_spec_stribog_256 = {GCRY_MD_STRIBOG256,
                                                {0, 0},
                                                "STRIBOG256",
                                                NULL,
                                                0,
...
gcry_md_spec_t _gcry_digest_spec_stribog_512 = {GCRY_MD_STRIBOG512,
                                                {0, 0},
                                                "STRIBOG512",
                                                NULL,
                                                0,
