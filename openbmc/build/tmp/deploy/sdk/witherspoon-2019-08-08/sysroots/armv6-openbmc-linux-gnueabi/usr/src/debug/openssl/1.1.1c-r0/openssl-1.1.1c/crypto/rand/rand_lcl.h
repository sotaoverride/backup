...
typedef int (*RAND_DRBG_instantiate_fn)(RAND_DRBG* ctx,
                                        ...
                                        size_t perslen);
/* reseed */
typedef int (*RAND_DRBG_reseed_fn)(RAND_DRBG* ctx, const unsigned char* ent,
                                   size_t entlen, const unsigned char* adin,
                                   size_t adinlen);
/* generate output */
typedef int (*RAND_DRBG_generate_fn)(RAND_DRBG* ctx, unsigned char* out,
...
struct rand_drbg_st
{
     ...
     *
     * Currently the only type is CTR_DRBG, its init function is
     * drbg_ctr_init().
     *
