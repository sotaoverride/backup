...
netsnmp_feature_require(container_lifo) static netsnmp_arp_access* arp_access =
    NULL;
 ...
 */
int inetNetToMediaTable_init_data(
    inetNetToMediaTable_registration* inetNetToMediaTable_reg)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_init_data",
                "called\n"));
 ...
 */
static void _add_or_update_arp_entry(netsnmp_arp_entry* arp_entry,
                                     netsnmp_container* container)
{
    ...
    switch (arp_entry->arp_ipaddress_len)
    {
        ...
        default:
            snmp_log(LOG_ERR,
                     "inetNetToMediaTable:_add_or_update_arpentry: unsupported "
                     "address type, len = %d\n",
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS ==
         inetNetToMediaTable_indexes_set(rowreq_ctx, rowreq_ctx->data->if_index,
                                         inetAddressType,
                                         ...
                                         rowreq_ctx->data->arp_ipaddress_len)))
    {
        ...
        old = (inetNetToMediaTable_rowreq_ctx*)CONTAINER_FIND(container,
                                                              rowreq_ctx);
...
static void _arp_hook_update(netsnmp_arp_access* access,
 ...
 */
static void _collect_invalid_arp_ctx(inetNetToMediaTable_rowreq_ctx* ctx,
                                     _collect_ctx* cctx)
{
...
static void _arp_hook_gc(netsnmp_arp_access* access)
{
    ...
    while (CONTAINER_SIZE(cctx.to_delete))
    {
        inetNetToMediaTable_rowreq_ctx* ctx =
            (inetNetToMediaTable_rowreq_ctx*)CONTAINER_FIRST(cctx.to_delete);
 ...
 */
void inetNetToMediaTable_container_init(netsnmp_container** container_ptr_ptr,
                                        netsnmp_cache* cache)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_container_init",
         "called\n"));
    ...
    *container_ptr_ptr = NULL;
    ...
    arp_access = netsnmp_access_arp_create(
        NETSNMP_ACCESS_ARP_CREATE_NOFLAGS, _arp_hook_update, _arp_hook_gc,
        &cache->timeout, &cache->flags, &cache->expired);
    if (arp_access == NULL)
    {
        snmp_log(LOG_ERR, "unable to create arp access in "
 ...
 */
void inetNetToMediaTable_container_shutdown(netsnmp_container* container_ptr)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_container_shutdown",
         "called\n"));
 ...
 *
 */
int inetNetToMediaTable_container_load(netsnmp_container* container)
{
...
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_container_free",
         "called\n"));
 ...
 * @retval MFD_ERROR       : other error.
 */
int inetNetToMediaTable_row_prep(inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
 ...
 */
int inetNetToMediaIfIndex_check_index(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaIfIndex_check_index",
                "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetNetToMediaNetAddressType_check_index(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaNetAddressType_check_index",
         "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:426:M: |-> Check inetNetToMediaTable index
     * inetNetToMediaNetAddressType. check that index value in the table context
     * is legal. (rowreq_ctx->tbl_index.inetNetToMediaNetAddressType)
     */
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetNetToMediaNetAddress_check_index(
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaNetAddress_check_index",
         "called\n"));
 ...
 */
int inetNetToMediaTable_validate_index(
    inetNetToMediaTable_registration* inetNetToMediaTable_reg,
    inetNetToMediaTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    ...
    DEBUGMSGTL(
        ("verbose:inetNetToMediaTable:inetNetToMediaTable_validate_index",
         "called\n"));
