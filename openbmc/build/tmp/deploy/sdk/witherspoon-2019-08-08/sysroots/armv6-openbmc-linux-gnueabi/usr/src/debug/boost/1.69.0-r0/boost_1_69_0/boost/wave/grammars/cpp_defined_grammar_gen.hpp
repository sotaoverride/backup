...
#if !defined(                                                                  \
    CPP_DEFINED_GRAMMAR_GEN_HPP_825BE9F5_98A3_400D_A97C_AD76B3B08632_INCLUDED)
...
struct BOOST_WAVE_DECL defined_grammar_gen
{
    ...
    //  This results in no code overhead, because otherwise the function would
    //  be generated by the compiler twice anyway.

    typedef boost::wave::util::unput_queue_iterator<
        typename token_sequence_type::iterator, token_type, token_sequence_type>
        iterator1_type;

    typedef boost::wave::util::unput_queue_iterator<LexIteratorT, token_type,
                                                    token_sequence_type>
        iterator2_type;
