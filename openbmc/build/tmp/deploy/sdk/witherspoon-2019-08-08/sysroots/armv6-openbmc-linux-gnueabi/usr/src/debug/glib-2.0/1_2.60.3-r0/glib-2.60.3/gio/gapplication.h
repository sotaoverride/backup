...
#define G_APPLICATION(inst)                                                    \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_APPLICATION, GApplication))
#define G_APPLICATION_CLASS(class)                                             \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_APPLICATION, GApplicationClass))
#define G_IS_APPLICATION(inst)                                                 \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_APPLICATION))
#define G_IS_APPLICATION_CLASS(class)                                          \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_APPLICATION))
#define G_APPLICATION_GET_CLASS(inst)                                          \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_APPLICATION, GApplicationClass))
...
struct _GApplicationClass
{
     ...
     * @arguments: (inout) (array zero-terminated=1): array of command line
     * arguments
     * @exit_status: (out): exit status to fill after processing the command
     * line.
     *
