...
static void __condvar_cancel_waiting(pthread_cond_t* cond, uint64_t seq,
...
static void __condvar_dec_grefs(pthread_cond_t* cond, unsigned int g,
                                int private)
{
    ...
    do
    {
        while (1)
        {
            ...
            if (abstime == NULL)
            {
                ...
                err = futex_wait_cancelable(cond->__data.__g_signals + g, 0,
                                            private);
            }
            else
            {
