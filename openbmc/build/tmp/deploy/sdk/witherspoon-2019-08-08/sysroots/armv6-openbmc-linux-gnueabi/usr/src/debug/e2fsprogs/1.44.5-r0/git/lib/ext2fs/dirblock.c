...
errcode_t ext2fs_read_dir_block4(ext2_filsys fs, blk64_t block, void* buf,
                                 ...
                                 ext2_ino_t ino)
{
    ...
    if (!(fs->flags & EXT2_FLAG_IGNORE_CSUM_ERRORS) &&
        !ext2fs_dir_block_csum_verify(fs, ino, (struct ext2_dir_entry*)buf))
        corrupt = 1;
...
errcode_t ext2fs_read_dir_block3(ext2_filsys fs, blk64_t block, void* buf,
                                 int flags EXT2FS_ATTR((unused)))
{
    return ext2fs_read_dir_block4(fs, block, buf, flags, 0);
}

errcode_t ext2fs_read_dir_block2(ext2_filsys fs, blk_t block, void* buf,
                                 int flags EXT2FS_ATTR((unused)))
{
...
errcode_t ext2fs_write_dir_block4(ext2_filsys fs, blk64_t block, void* inbuf,
                                  int flags EXT2FS_ATTR((unused)),
                                  ext2_ino_t ino)
{
    errcode_t retval;
    ...
    if (retval)
        return retval;
#endif
    retval = ext2fs_dir_block_csum_set(fs, ino, (struct ext2_dir_entry*)buf);
    if (retval)
        goto out;
...
errcode_t ext2fs_write_dir_block3(ext2_filsys fs, blk64_t block, void* inbuf,
                                  int flags EXT2FS_ATTR((unused)))
{
    return ext2fs_write_dir_block4(fs, block, inbuf, flags, 0);
}

errcode_t ext2fs_write_dir_block2(ext2_filsys fs, blk_t block, void* inbuf,
                                  int flags EXT2FS_ATTR((unused)))
{
