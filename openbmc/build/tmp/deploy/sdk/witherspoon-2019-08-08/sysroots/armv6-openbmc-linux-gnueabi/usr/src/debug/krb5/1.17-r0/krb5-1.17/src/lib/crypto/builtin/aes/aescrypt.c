...
#define fwd_rnd(y, x, k, c)                                                    \
    s(y, c) = (k)[c] ^ four_tables(x, ft_tab, fwd_var, rf1, c)
#elif defined(FT1_SET)
#undef dec_fmvars
#define dec_fmvars
#define fwd_rnd(y, x, k, c)                                                    \
    s(y, c) = (k)[c] ^ one_table(x, upr, ft_tab, fwd_var, rf1, c)
#else
#define fwd_rnd(y, x, k, c)                                                    \
    s(y, c) = fwd_mcol(no_table(x, s_box, fwd_var, rf1, c)) ^ (k)[c]
#endif

#if defined(FL4_SET)
#define fwd_lrnd(y, x, k, c)                                                   \
    s(y, c) = (k)[c] ^ four_tables(x, fl_tab, fwd_var, rf1, c)
#elif defined(FL1_SET)
#define fwd_lrnd(y, x, k, c)                                                   \
    s(y, c) = (k)[c] ^ one_table(x, ups, fl_tab, fwd_var, rf1, c)
#else
#define fwd_lrnd(y, x, k, c)                                                   \
    s(y, c) = no_table(x, s_box, fwd_var, rf1, c) ^ (k)[c]
#endif
...
#define inv_rnd(y, x, k, c)                                                    \
    s(y, c) = (k)[c] ^ four_tables(x, it_tab, inv_var, rf1, c)
#elif defined(IT1_SET)
#undef dec_imvars
#define dec_imvars
#define inv_rnd(y, x, k, c)                                                    \
    s(y, c) = (k)[c] ^ one_table(x, upr, it_tab, inv_var, rf1, c)
#else
#define inv_rnd(y, x, k, c)                                                    \
    s(y, c) = inv_mcol(no_table(x, inv_s_box, inv_var, rf1, c) ^ (k)[c])
#endif

#if defined(IL4_SET)
#define inv_lrnd(y, x, k, c)                                                   \
    s(y, c) = (k)[c] ^ four_tables(x, il_tab, inv_var, rf1, c)
#elif defined(IL1_SET)
#define inv_lrnd(y, x, k, c)                                                   \
    s(y, c) = (k)[c] ^ one_table(x, ups, il_tab, inv_var, rf1, c)
#else
#define inv_lrnd(y, x, k, c)                                                   \
    s(y, c) = no_table(x, inv_s_box, inv_var, rf1, c) ^ (k)[c]
#endif
