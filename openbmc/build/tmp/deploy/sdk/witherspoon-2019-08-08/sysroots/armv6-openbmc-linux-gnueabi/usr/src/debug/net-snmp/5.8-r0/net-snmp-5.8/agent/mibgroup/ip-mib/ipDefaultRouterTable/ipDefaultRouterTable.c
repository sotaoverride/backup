...
const int ipDefaultRouterTable_oid_size = OID_LENGTH(ipDefaultRouterTable_oid);
...
{
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:init_ipDefaultRouterTable", "called\n"));
...
void initialize_table_ipDefaultRouterTable(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:initialize_table_ipDefaultRouterTable",
         "called\n"));
 ...
 */
int ipDefaultRouterTable_rowreq_ctx_init(
    ipDefaultRouterTable_rowreq_ctx* rowreq_ctx, void* user_init_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_rowreq_ctx_init",
         "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:210:o: |-> Perform extra ipDefaultRouterTable rowreq initialization.
     * (eg DEFVALS)
     */
 ...
 *
 */
void ipDefaultRouterTable_rowreq_ctx_cleanup(
    ipDefaultRouterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_rowreq_ctx_cleanup",
         "called\n"));
 ...
 */
int ipDefaultRouterTable_pre_request(
    ipDefaultRouterTable_registration* user_context)
{
    DEBUGMSGTL(("verbose:ipDefaultRouterTable:ipDefaultRouterTable_pre_request",
                "called\n"));
 ...
 */
int ipDefaultRouterTable_post_request(
    ipDefaultRouterTable_registration* user_context, int rc)
{
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_post_request",
         "called\n"));
