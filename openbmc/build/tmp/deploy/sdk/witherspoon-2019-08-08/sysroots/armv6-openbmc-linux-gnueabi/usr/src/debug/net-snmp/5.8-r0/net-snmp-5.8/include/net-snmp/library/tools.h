 ...
 * @param[in] e An expression of a type that can be assigned to the type (const
 * t).
 */
#if defined(__GNUC__)
...
u_long uatime_diff(const_marker_t first,
                   const_marker_t second); /* 1/1000th sec */
NETSNMP_IMPORT
u_long uatime_hdiff(const_marker_t first,
                    const_marker_t second); /* 1/100th sec */
NETSNMP_IMPORT
