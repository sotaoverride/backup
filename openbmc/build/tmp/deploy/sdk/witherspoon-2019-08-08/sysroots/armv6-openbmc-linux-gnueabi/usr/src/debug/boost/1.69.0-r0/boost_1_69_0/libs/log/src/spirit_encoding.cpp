...
#define BOOST_LOG_DEFINE_CHARSET_PARSER(r, charset, parser)                    \
    BOOST_LOG_API encoding_specific<                                           \
        spirit::char_encoding::charset>::BOOST_PP_TUPLE_ELEM(2, 0, parser)     \
        const& encoding_specific<                                              \
            spirit::char_encoding::charset>::BOOST_PP_TUPLE_ELEM(2, 1,         \
                                                                 parser) =     \
            spirit::charset::BOOST_PP_TUPLE_ELEM(2, 1, parser);

#define BOOST_LOG_DEFINE_CHARSET_PARSERS(charset)                              \
    BOOST_PP_SEQ_FOR_EACH(BOOST_LOG_DEFINE_CHARSET_PARSER, charset,            \
