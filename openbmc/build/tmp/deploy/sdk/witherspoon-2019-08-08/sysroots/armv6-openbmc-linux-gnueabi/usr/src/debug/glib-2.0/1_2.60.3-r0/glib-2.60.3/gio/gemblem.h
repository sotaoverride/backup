...
#define G_EMBLEM_CLASS(k)                                                      \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_EMBLEM, GEmblemClass))
...
#define G_EMBLEM_GET_CLASS(o)                                                  \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_EMBLEM, GEmblemClass))
