...
static int handle_ipForwarding(netsnmp_mib_handler* handler,
                               netsnmp_handler_registration* reginfo,
                               netsnmp_agent_request_info* reqinfo,
                               netsnmp_request_info* requests);

static int handle_ipDefaultTTL(netsnmp_mib_handler* handler,
                               netsnmp_handler_registration* reginfo,
                               netsnmp_agent_request_info* reqinfo,
                               netsnmp_request_info* requests);

static int handle_ipv6IpForwarding(netsnmp_mib_handler* handler,
                                   netsnmp_handler_registration* reginfo,
                                   netsnmp_agent_request_info* reqinfo,
                                   netsnmp_request_info* requests);

static int handle_ipv6IpDefaultHopLimit(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        netsnmp_agent_request_info* reqinfo,
                                        netsnmp_request_info* requests);
...
static int handle_ipAddressSpinLock(netsnmp_mib_handler* handler,
                                    netsnmp_handler_registration* reginfo,
                                    netsnmp_agent_request_info* reqinfo,
                                    netsnmp_request_info* requests);
...
void init_ip_scalars(void)
{
    ...
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "ipForwarding", handle_ipForwarding, ipForwarding_oid,
        OID_LENGTH(ipForwarding_oid), HANDLER_CAN_RWRITE));

    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "ipDefaultTTL", handle_ipDefaultTTL, ipDefaultTTL_oid,
        OID_LENGTH(ipDefaultTTL_oid), HANDLER_CAN_RWRITE));

    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "ipv6IpForwarding", handle_ipv6IpForwarding, ipv6IpForwarding_oid,
        OID_LENGTH(ipv6IpForwarding_oid), HANDLER_CAN_RWRITE));
    ...
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "ipAddressSpinLock", handle_ipAddressSpinLock, ipAddressSpinLock_oid,
        OID_LENGTH(ipAddressSpinLock_oid), HANDLER_CAN_RWRITE));
                               ...
                               netsnmp_request_info* requests)
{
    ...
    switch (reqinfo->mode)
    {
            ...
            else
            {
                ...
                if (NULL == value_save)
                    ...
                    netsnmp_request_add_list_data(
                        requests,
                        netsnmp_create_data_list("ipfw", value_save, free));
            }
            break;
        ...
        case MODE_SET_UNDO:
            value = *((u_long*)netsnmp_request_get_list_data(requests, "ipfw"));
            rc = netsnmp_arch_ip_scalars_ipForwarding_set(value);
            if (0 != rc)
            {
                netsnmp_set_request_error(reqinfo, requests,
                               ...
                               netsnmp_request_info* requests)
{
    ...
    switch (reqinfo->mode)
    {
        ...
        case MODE_SET_RESERVE2:
            ...
            else
            {
                ...
                if (NULL == value_save)
                    ...
                    netsnmp_request_add_list_data(
                        requests,
                        netsnmp_create_data_list("ipttl", value_save, free));
            }
            break;
        ...
        case MODE_SET_UNDO:
            value =
                *((u_long*)netsnmp_request_get_list_data(requests, "ipttl"));
            rc = netsnmp_arch_ip_scalars_ipDefaultTTL_set(value);
            if (0 != rc)
            {
                netsnmp_set_request_error(reqinfo, requests,
                                   ...
                                   netsnmp_request_info* requests)
{
    ...
    switch (reqinfo->mode)
    {
        ...
        case MODE_SET_RESERVE2:
            ...
            else
            {
                ...
                else
                {
                    netsnmp_request_add_list_data(
                        requests,
                        netsnmp_create_data_list("ip6fw", value_save, free));
                }
            }
            break;
        ...
        case MODE_SET_UNDO:
            value =
                *((u_long*)netsnmp_request_get_list_data(requests, "ip6fw"));
            rc = netsnmp_arch_ip_scalars_ipv6IpForwarding_set(value);
            if (0 != rc)
            {
                netsnmp_set_request_error(reqinfo, requests,
    ...
    switch (reqinfo->mode)
    {
        ...
        case MODE_SET_ACTION:
            ...
            else
            {
                ...
                if (ipAddressSpinLockValue > 2147483647 ||
