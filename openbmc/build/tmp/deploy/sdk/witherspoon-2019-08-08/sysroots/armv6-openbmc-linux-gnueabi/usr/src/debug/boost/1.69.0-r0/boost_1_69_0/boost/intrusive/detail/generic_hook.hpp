...
struct hooktags_impl
{
    ...
    static const bool safemode_or_autounlink =
        is_safe_autounlink<link_mode>::value;
...
class generic_hook
    ...
    // will define an special internal typedef. Containers will be able to
    // detect this special typedef and obtain generic_hook's internal types in
    // order to deduce value_traits for this hook.
    ,
...
/// @endcond
{
  ...
  public:
    ...
    ~generic_hook()
    {
        destructor_impl(*this, detail::link_dispatch<hooktags::link_mode>());
    }

    void swap_nodes(generic_hook& other)
    {
        node_algorithms::swap_nodes(this->this_ptr(), other.this_ptr());
    }
