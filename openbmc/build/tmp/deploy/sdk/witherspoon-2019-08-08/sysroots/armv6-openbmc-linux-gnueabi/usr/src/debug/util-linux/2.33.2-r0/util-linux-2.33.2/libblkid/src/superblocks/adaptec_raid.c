                        ...
                        __attribute__((__unused__)))
{
    ...
    ad = (struct adaptec_metadata*)blkid_probe_get_buffer(
        pr, off, sizeof(struct adaptec_metadata));
    if (!ad)
...
const struct blkid_idinfo adraid_idinfo = {.name = "adaptec_raid_member",
