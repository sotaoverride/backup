...
#define G_DBUS_AUTH_MECHANISM(o)                                               \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_AUTH_MECHANISM,               \
                                GDBusAuthMechanism))
#define G_DBUS_AUTH_MECHANISM_CLASS(k)                                         \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_DBUS_AUTH_MECHANISM,                  \
                             GDBusAuthMechanismClass))
#define G_DBUS_AUTH_MECHANISM_GET_CLASS(o)                                     \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DBUS_AUTH_MECHANISM,                \
                               GDBusAuthMechanismClass))
#define G_IS_DBUS_AUTH_MECHANISM(o)                                            \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_AUTH_MECHANISM))
#define G_IS_DBUS_AUTH_MECHANISM_CLASS(k)                                      \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_DBUS_AUTH_MECHANISM))
...
struct _GDBusAuthMechanismClass
{
    ...
    gchar* (*encode_data)(GDBusAuthMechanism* mechanism, const gchar* data,
                          gsize data_len, gsize* out_data_len);
    gchar* (*decode_data)(GDBusAuthMechanism* mechanism, const gchar* data,
                          gsize data_len, gsize* out_data_len);
