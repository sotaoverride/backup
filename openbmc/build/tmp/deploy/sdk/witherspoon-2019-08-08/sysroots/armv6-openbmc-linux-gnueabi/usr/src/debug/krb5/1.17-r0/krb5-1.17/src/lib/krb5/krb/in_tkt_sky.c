    ...
    krb5_kdc_rep** ret_as_reply)
{
    ...
    if (key == NULL)
    {
        retval = krb5_get_init_creds_keytab(
            context, creds, creds->client, NULL /* keytab */,
            creds->times.starttime, NULL /* in_tkt_service */, opts);
        goto cleanup;
    }
#endif /* LEAN_CLIENT */
    ...
    retval = k5_get_init_creds(
        ...
        opts, get_as_key_skey, (void*)key, &use_master, ret_as_reply);
