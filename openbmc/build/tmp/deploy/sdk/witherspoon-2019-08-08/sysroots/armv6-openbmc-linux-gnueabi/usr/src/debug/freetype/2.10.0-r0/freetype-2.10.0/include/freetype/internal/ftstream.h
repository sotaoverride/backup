...
#define FT_PEEK_OFF3(p)                                                        \
    FT_INT32(FT_BYTE_U32(p, 0, 16) | FT_BYTE_U32(p, 1, 8) |                    \
             FT_BYTE_U32(p, 2, 0))

#define FT_PEEK_UOFF3(p)                                                       \
    FT_UINT32(FT_BYTE_U32(p, 0, 16) | FT_BYTE_U32(p, 1, 8) |                   \
              FT_BYTE_U32(p, 2, 0))
...
#define FT_PEEK_OFF3_LE(p)                                                     \
    FT_INT32(FT_BYTE_U32(p, 2, 16) | FT_BYTE_U32(p, 1, 8) |                    \
             FT_BYTE_U32(p, 0, 0))

#define FT_PEEK_UOFF3_LE(p)                                                    \
    FT_UINT32(FT_BYTE_U32(p, 2, 16) | FT_BYTE_U32(p, 1, 8) |                   \
              FT_BYTE_U32(p, 0, 0))
...
#define FT_READ_SHORT_LE(var)                                                  \
    FT_READ_MACRO(FT_Stream_ReadUShortLE, FT_Short, var)
#define FT_READ_USHORT_LE(var)                                                 \
    FT_READ_MACRO(FT_Stream_ReadUShortLE, FT_UShort, var)
#define FT_READ_LONG_LE(var) FT_READ_MACRO(FT_Stream_ReadULongLE, FT_Long, var)
#define FT_READ_ULONG_LE(var)                                                  \
    FT_READ_MACRO(FT_Stream_ReadULongLE, FT_ULong, var)
...
#define FT_FRAME_EXTRACT(size, bytes)                                          \
    FT_SET_ERROR(FT_DEBUG_INNER(FT_Stream_ExtractFrame(                        \
        stream, (FT_ULong)(size), (FT_Byte**)&(bytes))))
