...
extern int posix_spawnattr_getflags(const posix_spawnattr_t* __restrict __attr,
...
extern int posix_spawnattr_getpgroup(const posix_spawnattr_t* __restrict __attr,
...
extern int posix_spawnattr_getschedparam(
    ...
    struct sched_param* __restrict __schedparam) __THROW;
...
extern int posix_spawn_file_actions_init(
    posix_spawn_file_actions_t* __file_actions) __THROW;
...
extern int posix_spawn_file_actions_addclose(
    posix_spawn_file_actions_t* __file_actions, int __fd) __THROW;
