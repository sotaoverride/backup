 ...
 */
krb5_ser_handle krb5_find_serializer(krb5_context kcontext, krb5_magic odtype)
{
    krb5_ser_handle res;
 ...
 */
krb5_error_code krb5_register_serializer(krb5_context kcontext,
                                         const krb5_ser_entry* entry)
{
    ...
    if (!(stable =
              (krb5_ser_entry*)krb5_find_serializer(kcontext, entry->odtype)))
    {
        /*
 ...
 */
krb5_error_code KRB5_CALLCONV krb5_size_opaque(krb5_context kcontext,
                                               krb5_magic odtype,
 ...
 */
krb5_error_code KRB5_CALLCONV krb5_externalize_opaque(krb5_context kcontext,
                                                      krb5_magic odtype,
                                                      krb5_pointer arg,
                                                      krb5_octet** bufpp,
                                                      size_t* sizep)
{
    ...
    if ((shandle = krb5_find_serializer(kcontext, odtype)))
        kret = (shandle->externalizer)
                   ? (*shandle->externalizer)(kcontext, arg, bufpp, sizep)
                   : 0;
    return (kret);
}
 ...
 */
krb5_error_code krb5_externalize_data(krb5_context kcontext, krb5_pointer arg,
                                      krb5_octet** bufpp, size_t* sizep)
{
    ...
    if (!(kret = krb5_size_opaque(kcontext, *mp, arg, &bufsize)))
    {
        if ((buffer = (krb5_octet*)malloc(bufsize)))
        {
            ...
            bsize = bufsize;
            if (!(kret =
                      krb5_externalize_opaque(kcontext, *mp, arg, &bp, &bsize)))
            {
                if (bsize != 0)
                    bufsize -= bsize;
                *bufpp = buffer;
 ...
 *                                structure.
 */
krb5_error_code KRB5_CALLCONV krb5_internalize_opaque(krb5_context kcontext,
                                                      krb5_magic odtype,
                                                      krb5_pointer* argp,
                                                      krb5_octet** bufpp,
                                                      size_t* sizep)
{
    ...
    if ((shandle = krb5_find_serializer(kcontext, odtype)))
        kret = (shandle->internalizer)
                   ? (*shandle->internalizer)(kcontext, argp, bufpp, sizep)
                   : 0;
    return (kret);
}
 ...
 */
krb5_error_code KRB5_CALLCONV krb5_ser_pack_int32(krb5_int32 iarg,
                                                  krb5_octet** bufp,
                                                  size_t* remainp)
{
 ...
 *                                Update buffer pointer and remaining space.
 */
krb5_error_code KRB5_CALLCONV krb5_ser_pack_int64(int64_t iarg,
                                                  krb5_octet** bufp,
                                                  size_t* remainp)
{
 ...
 */
krb5_error_code KRB5_CALLCONV krb5_ser_pack_bytes(krb5_octet* ostring,
                                                  size_t osize,
                                                  krb5_octet** bufp,
                                                  size_t* remainp)
{
 ...
 */
krb5_error_code KRB5_CALLCONV krb5_ser_unpack_int32(krb5_int32* intp,
                                                    krb5_octet** bufp,
                                                    size_t* remainp)
{
    if (*remainp >= sizeof(krb5_int32))
 ...
 */
krb5_error_code KRB5_CALLCONV krb5_ser_unpack_int64(int64_t* intp,
                                                    krb5_octet** bufp,
                                                    size_t* remainp)
{
    if (*remainp >= sizeof(int64_t))
 ...
 */
krb5_error_code KRB5_CALLCONV krb5_ser_unpack_bytes(krb5_octet* istring,
                                                    size_t isize,
                                                    krb5_octet** bufp,
                                                    size_t* remainp)
{
