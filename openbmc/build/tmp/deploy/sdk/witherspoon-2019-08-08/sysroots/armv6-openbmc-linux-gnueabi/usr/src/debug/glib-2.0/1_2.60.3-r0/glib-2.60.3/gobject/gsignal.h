...
/**
 * GSignalFlags:
 * @G_SIGNAL_RUN_FIRST: Invoke the object method handler in the first emission
 * stage.
 * @G_SIGNAL_RUN_LAST: Invoke the object method handler in the third emission
 * stage.
 * @G_SIGNAL_RUN_CLEANUP: Invoke the object method handler in the last emission
 * stage.
 ...
 * @G_SIGNAL_DETAILED: This signal supports "::detail" appendices to the signal
 * name upon handler connections and emissions.
 * @G_SIGNAL_ACTION: Action signals are signals that may freely be emitted on
 * alive objects from user code via g_signal_emit() and friends, without the
 * need of being embedded into extra code that performs pre or post emission
 ...
 *
 * Returns: the handler ID, of type #gulong (always greater than 0 for
...
#define g_signal_handlers_disconnect_by_func(instance, func, data)             \
    g_signal_handlers_disconnect_matched(                                      \
        (instance),                                                            \
        (GSignalMatchType)(G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0,   \
        NULL, (func), (data))
