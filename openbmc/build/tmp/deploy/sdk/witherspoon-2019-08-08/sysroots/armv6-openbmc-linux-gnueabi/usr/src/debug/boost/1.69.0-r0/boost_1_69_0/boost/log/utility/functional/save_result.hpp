 ...
 * \date   19.01.2013
 *
 * This header contains function object adapter that saves the result of the
 * adopted function to an external variable.
 */
...
template <typename FunT, typename AssigneeT>
BOOST_FORCEINLINE save_result_wrapper<FunT, AssigneeT>
