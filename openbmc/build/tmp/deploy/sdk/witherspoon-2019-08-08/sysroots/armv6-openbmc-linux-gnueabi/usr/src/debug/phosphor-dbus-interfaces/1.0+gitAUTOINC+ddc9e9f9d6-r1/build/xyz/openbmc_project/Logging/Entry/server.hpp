...
class Entry
{
  public:
    ...
    using PropertiesVariant = std::variant<std::string, Level, bool, uint32_t,
    ...
    virtual Level severity(Level value, bool skipSignal);
    ...
    virtual bool resolved(bool value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_Severity(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Severity' */
    static int _callback_set_Severity(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    ...
    static int _callback_get_Resolved(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Resolved' */
    static int _callback_set_Resolved(sd_bus*, const char*, const char*,
                                      const char*, sd_bus_message*, void*,
                                      sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Logging_Entry_interface;
