...
BOOST_THREAD_DECL void
    set_tss_data(void const* key, boost::shared_ptr<tss_cleanup_function> func,
...
class thread_specific_ptr
{
  ...
  public:
    ...
    explicit thread_specific_ptr(void (*func_)(T*))
    {
        ...
        {
            cleanup.reset(
                detail::heap_new<run_custom_cleanup_function>(func_),
    ...
    {
        detail::set_tss_data(
            this, boost::shared_ptr<detail::tss_cleanup_function>(), 0, true);
    }
    ...
    T* release()
    {
        T* const temp = get();
        detail::set_tss_data(
            this, boost::shared_ptr<detail::tss_cleanup_function>(), 0, false);
        return temp;
    }
