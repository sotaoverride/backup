...
/* We use this nasty thing, because NULL is a valid attribute matcher (matches
 * nothing) */
...
static guint32 _lookup_attribute(const char* attribute)
{
    ...
    attributes[ns_info->id] =
        g_realloc(attributes[ns_info->id], (id + 1) * sizeof(char*));
    attributes[ns_info->id][id] = g_strdup(attribute);

    attr_id = MAKE_ATTR_ID(ns_info->id, id);

    g_hash_table_insert(attribute_hash, attributes[ns_info->id][id],
                        GUINT_TO_POINTER(attr_id));
...
#define REGISTER_ATTRIBUTE(name)                                               \
    ...
    {                                                                          \
        ...
        /* use for generating the ID: g_print ("#define G_FILE_ATTRIBUTE_ID_%s \
...
static GFileAttributeValue* g_file_info_find_value(GFileInfo* info,
                                                   guint32 attr_id)
{
    GFileAttribute* attrs;
    int i;
...
static GFileAttributeValue*
    g_file_info_find_value_by_name(GFileInfo* info, const char* attribute)
{
    guint32 attr_id;
                                                  ...
                                                  const char* attribute)
{
    ...
    g_return_val_if_fail(attribute != NULL && *attribute != '\0',
 ...
 *      %FALSE otherwise.
 */
gboolean g_file_info_get_attribute_data(GFileInfo* info, const char* attribute,
 ...
 *
 * Returns: (transfer none): the contents of the @attribute value as a stringv,
...
static GFileAttributeValue* g_file_info_create_value(GFileInfo* info,
                                                     guint32 attr_id)
{
    GFileAttribute* attrs;
    int i;
...
void _g_file_info_set_attribute_by_id(GFileInfo* info, guint32 attribute,
 ...
 **/
void g_file_info_set_attribute(GFileInfo* info, const char* attribute,
                               GFileAttributeType type, gpointer value_p)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');

    _g_file_info_set_attribute_by_id(info, lookup_attribute(attribute), type,
                                     value_p);
}

void _g_file_info_set_attribute_object_by_id(GFileInfo* info, guint32 attribute,
                                             GObject* attr_value)
{
    GFileAttributeValue* value;
 ...
 * if possible.
 **/
void g_file_info_set_attribute_object(GFileInfo* info, const char* attribute,
                                      GObject* attr_value)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');
    ...
    _g_file_info_set_attribute_object_by_id(info, lookup_attribute(attribute),
                                            attr_value);
}
 ...
 * Sinze: 2.22
 **/
void g_file_info_set_attribute_stringv(GFileInfo* info, const char* attribute,
                                       char** attr_value)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');
    ...
    _g_file_info_set_attribute_stringv_by_id(info, lookup_attribute(attribute),
                                             attr_value);
}

void _g_file_info_set_attribute_string_by_id(GFileInfo* info, guint32 attribute,
 ...
 * if possible.
 **/
void g_file_info_set_attribute_string(GFileInfo* info, const char* attribute,
                                      const char* attr_value)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');
    ...
    _g_file_info_set_attribute_string_by_id(info, lookup_attribute(attribute),
                                            attr_value);
}
                                           ...
                                           const char* attr_value)
{
    ...
    _g_file_info_set_attribute_byte_string_by_id(
        info, lookup_attribute(attribute), attr_value);
}
 ...
 * if possible.
 **/
void g_file_info_set_attribute_boolean(GFileInfo* info, const char* attribute,
                                       gboolean attr_value)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');

    _g_file_info_set_attribute_boolean_by_id(info, lookup_attribute(attribute),
                                             attr_value);
}

void _g_file_info_set_attribute_uint32_by_id(GFileInfo* info, guint32 attribute,
                                             guint32 attr_value)
{
    GFileAttributeValue* value;
 ...
 * if possible.
 **/
void g_file_info_set_attribute_uint32(GFileInfo* info, const char* attribute,
                                      guint32 attr_value)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');

    _g_file_info_set_attribute_uint32_by_id(info, lookup_attribute(attribute),
                                            attr_value);
}

void _g_file_info_set_attribute_int32_by_id(GFileInfo* info, guint32 attribute,
                                            gint32 attr_value)
{
    GFileAttributeValue* value;
 ...
 * if possible.
 **/
void g_file_info_set_attribute_int32(GFileInfo* info, const char* attribute,
                                     gint32 attr_value)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');

    _g_file_info_set_attribute_int32_by_id(info, lookup_attribute(attribute),
                                           attr_value);
}

void _g_file_info_set_attribute_uint64_by_id(GFileInfo* info, guint32 attribute,
                                             guint64 attr_value)
{
    GFileAttributeValue* value;
 ...
 * if possible.
 **/
void g_file_info_set_attribute_uint64(GFileInfo* info, const char* attribute,
                                      guint64 attr_value)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');

    _g_file_info_set_attribute_uint64_by_id(info, lookup_attribute(attribute),
                                            attr_value);
}

void _g_file_info_set_attribute_int64_by_id(GFileInfo* info, guint32 attribute,
                                            gint64 attr_value)
{
    GFileAttributeValue* value;
 ...
 *
 **/
void g_file_info_set_attribute_int64(GFileInfo* info, const char* attribute,
                                     gint64 attr_value)
{
    g_return_if_fail(G_IS_FILE_INFO(info));
    g_return_if_fail(attribute != NULL && *attribute != '\0');

    _g_file_info_set_attribute_int64_by_id(info, lookup_attribute(attribute),
                                           attr_value);
}
 ...
 *
 * Returns: a #gint32 containing the value of the "standard::sort_order"
 *attribute.
 **/
...
static gint compare_sub_matchers(gconstpointer a, gconstpointer b)
{
...
static gboolean sub_matcher_matches(SubMatcher* matcher, SubMatcher* submatcher)
{
 ...
 */
static GFileAttributeMatcher* matcher_optimize(GFileAttributeMatcher* matcher)
{
                                               ...
                                               const char* attribute)
{
    ...
    return sub_matcher->id == id && sub_matcher->mask == 0xffffffff;
}
 ...
 * matcher was created with "standard::*" and @ns is "standard", or if matcher
 *was created using "*" and namespace is anything.)
 *
...
char* g_file_attribute_matcher_to_string(GFileAttributeMatcher* matcher)
{
    ...
    for (i = 0; i < matcher->sub_matchers->len; i++)
    {
        SubMatcher* submatcher =
            &g_array_index(matcher->sub_matchers, SubMatcher, i);
