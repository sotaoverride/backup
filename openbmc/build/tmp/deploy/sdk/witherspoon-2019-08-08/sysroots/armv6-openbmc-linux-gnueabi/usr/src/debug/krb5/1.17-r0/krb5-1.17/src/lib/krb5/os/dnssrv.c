...
/*
 * Copyright 1990,2000,2001,2002,2003 by the Massachusetts Institute of
 ...
 * be NULL. */
static char* make_lookup_name(const krb5_data* realm, const char* service,
                              const char* protocol)
{
    struct k5buf buf;
 ...
 * currently used. */
static void place_srv_entry(struct srv_dns_entry** head,
                            struct srv_dns_entry* new)
{
