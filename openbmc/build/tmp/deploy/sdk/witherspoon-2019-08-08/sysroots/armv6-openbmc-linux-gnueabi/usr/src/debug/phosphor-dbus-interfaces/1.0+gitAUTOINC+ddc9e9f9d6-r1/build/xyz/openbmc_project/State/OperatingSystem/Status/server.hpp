...
class Status
{
  public:
    ...
    using PropertiesVariant = std::variant<OSStatus>;
    ...
    virtual OSStatus operatingSystemState(OSStatus value, bool skipSignal);
     ...
     *                 "xyz.openbmc_project.State.OperatingSystem.Status.<value
     * name>"
  ...
  private:
    ...
    static int _callback_get_OperatingSystemState(sd_bus*, const char*,
                                                  const char*, const char*,
                                                  sd_bus_message*, void*,
                                                  sd_bus_error*);
    /** @brief sd-bus callback for set-property 'OperatingSystemState' */
    static int _callback_set_OperatingSystemState(sd_bus*, const char*,
                                                  const char*, const char*,
                                                  sd_bus_message*, void*,
                                                  sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_State_OperatingSystem_Status_interface;
