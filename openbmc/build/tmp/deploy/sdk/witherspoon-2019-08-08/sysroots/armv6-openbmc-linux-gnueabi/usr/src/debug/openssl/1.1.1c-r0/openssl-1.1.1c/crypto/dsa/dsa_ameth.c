...
static int dsa_priv_encode(PKCS8_PRIV_KEY_INFO* p8, const EVP_PKEY* pkey)
{
    ...
    if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(NID_dsa), 0, V_ASN1_SEQUENCE, params,
                         dp, dplen))
        goto err;
...
static int dsa_param_decode(EVP_PKEY* pkey, const unsigned char** pder,
                            int derlen)
{
    DSA* dsa;
...
static int old_dsa_priv_decode(EVP_PKEY* pkey, const unsigned char** pder,
                               int derlen)
{
    DSA* dsa;
...
const EVP_PKEY_ASN1_METHOD dsa_asn1_meths[5] = {
    ...
    {EVP_PKEY_DSA2, EVP_PKEY_DSA, ASN1_PKEY_ALIAS},

    {EVP_PKEY_DSA1, EVP_PKEY_DSA, ASN1_PKEY_ALIAS},

    {EVP_PKEY_DSA4, EVP_PKEY_DSA, ASN1_PKEY_ALIAS},

    {EVP_PKEY_DSA3, EVP_PKEY_DSA, ASN1_PKEY_ALIAS},
