 ...
 * states they might not be accessible since the local host name might not
 ...
 *   - Add your service(s)/additional RRs/subtypes (e.g.
...
typedef enum
{
    ...
    AVAHI_SERVER_COLLISION,   /**< There is a collision with a host RR. All host
                                 RRs have been withdrawn, the user should set a
                                 new host name via avahi_server_set_host_name() */
    AVAHI_SERVER_FAILURE /**< Some fatal failure happened, the server is unable
                            to proceed */
} AvahiServerState;
...
typedef enum
{
    ...
    AVAHI_ENTRY_GROUP_COLLISION, /**< A name collision for one of the entries in
                                    the group has been detected, the entries
                                    have been withdrawn */
    AVAHI_ENTRY_GROUP_FAILURE    /**< Some kind of failure happened, the entries
                                    have been withdrawn */
...
typedef enum
{
    ...
    AVAHI_PUBLISH_NO_PROBE =
        2, /**< For raw records: Though the RRset is intended to be unique no
              probes shall be sent */
    ...
    AVAHI_PUBLISH_NO_COOKIE = 32, /**< For service records: do not implicitly
                                     add the local service cookie to TXT data */
                                  /** \endcond */
...
typedef enum
{
    ...
    AVAHI_LOOKUP_RESULT_STATIC =
        32 /**< The returned data has been defined statically by some
...
typedef enum
{
    AVAHI_DOMAIN_BROWSER_BROWSE, /**< Browse for a list of available browsing
                                    domains */
    AVAHI_DOMAIN_BROWSER_BROWSE_DEFAULT,   /**< Browse for the default browsing
                                              domain */
    AVAHI_DOMAIN_BROWSER_REGISTER,         /**< Browse for a list of available
                                              registering domains */
    AVAHI_DOMAIN_BROWSER_REGISTER_DEFAULT, /**< Browse for the default
                                              registering domain */
    AVAHI_DOMAIN_BROWSER_BROWSE_LEGACY, /**< Legacy browse domain - see DNS-SD
