...
config_require(if - mib / data_access / interface)
    config_require(ip - mib / data_access / ipaddress)
        config_require(ip - mib / ipAddressTable / ipAddressTable_interface)
            config_require(ip -
                           mib / ipAddressTable / ipAddressTable_data_access)
/* *INDENT-ON*  */
...
int ipAddressPrefix_check_value(ipAddressTable_rowreq_ctx* rowreq_ctx,
                                oid* ipAddressPrefix_val_ptr,
                                size_t ipAddressPrefix_val_ptr_len);
int ipAddressPrefix_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx);
int ipAddressPrefix_set(ipAddressTable_rowreq_ctx* rowreq_ctx,
                        oid* ipAddressPrefix_val_ptr,
                        size_t ipAddressPrefix_val_ptr_len);
int ipAddressPrefix_undo(ipAddressTable_rowreq_ctx* rowreq_ctx);

int ipAddressOrigin_check_value(ipAddressTable_rowreq_ctx* rowreq_ctx,
                                u_long ipAddressOrigin_val);
int ipAddressOrigin_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx);
int ipAddressOrigin_set(ipAddressTable_rowreq_ctx* rowreq_ctx,
                        u_long ipAddressOrigin_val);
int ipAddressOrigin_undo(ipAddressTable_rowreq_ctx* rowreq_ctx);
...
int ipAddressCreated_check_value(ipAddressTable_rowreq_ctx* rowreq_ctx,
                                 u_long ipAddressCreated_val);
int ipAddressCreated_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx);
int ipAddressCreated_set(ipAddressTable_rowreq_ctx* rowreq_ctx,
                         u_long ipAddressCreated_val);
int ipAddressCreated_undo(ipAddressTable_rowreq_ctx* rowreq_ctx);

int ipAddressLastChanged_check_value(ipAddressTable_rowreq_ctx* rowreq_ctx,
                                     u_long ipAddressLastChanged_val);
int ipAddressLastChanged_undo_setup(ipAddressTable_rowreq_ctx* rowreq_ctx);
int ipAddressLastChanged_set(ipAddressTable_rowreq_ctx* rowreq_ctx,
                             u_long ipAddressLastChanged_val);
int ipAddressLastChanged_undo(ipAddressTable_rowreq_ctx* rowreq_ctx);
...
int ipAddressTable_check_dependencies(ipAddressTable_rowreq_ctx* ctx);
