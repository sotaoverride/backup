...
#define DES_SP_ENCRYPT_ROUND(left, right, temp, kp)                            \
    ...
    {                                                                          \
        ...
        (left) ^= SP[0][((temp) >> 24) & 0x3f] |                               \
                  SP[1][((temp) >> 16) & 0x3f] | SP[2][((temp) >> 8) & 0x3f] | \
                  SP[3][((temp)) & 0x3f];                                      \
        (temp) = (((right) >> 23) | ((right) << 9)) ^ *(kp)++;                 \
        (left) ^= SP[4][((temp) >> 24) & 0x3f] |                               \
                  SP[5][((temp) >> 16) & 0x3f] | SP[6][((temp) >> 8) & 0x3f] | \
                  SP[7][((temp)) & 0x3f];                                      \
    } while (0);
...
#define DES_SP_DECRYPT_ROUND(left, right, temp, kp)                            \
    ...
    {                                                                          \
        (temp) = (((right) >> 23) | ((right) << 9)) ^ *(--(kp));               \
        (left) ^= SP[7][((temp)) & 0x3f] | SP[6][((temp) >> 8) & 0x3f] |       \
                  SP[5][((temp) >> 16) & 0x3f] | SP[4][((temp) >> 24) & 0x3f]; \
        (temp) = (((right) >> 11) | ((right) << 21)) ^ *(--(kp));              \
        (left) ^= SP[3][((temp)) & 0x3f] | SP[2][((temp) >> 8) & 0x3f] |       \
                  SP[1][((temp) >> 16) & 0x3f] | SP[0][((temp) >> 24) & 0x3f]; \
    } while (0);
...
#define DES_IP_RIGHT_BITS(left, right)                                         \
    (((left)&0xaaaaaaaa) | (((unsigned DES_INT32)((right)&0xaaaaaaaa)) >> 1))
...
#define DES_INITIAL_PERM(left, right, temp)                                    \
    ...
    {                                                                          \
        ...
        (left) = IP[((right) >> 24) & 0xff] |                                  \
                 (IP[((right) >> 16) & 0xff] << 1) |                           \
                 (IP[((right) >> 8) & 0xff] << 2) | (IP[(right)&0xff] << 3);   \
        (right) = IP[((temp) >> 24) & 0xff] |                                  \
                  (IP[((temp) >> 16) & 0xff] << 1) |                           \
                  (IP[((temp) >> 8) & 0xff] << 2) | (IP[(temp)&0xff] << 3);    \
    } while (0);
...
#define DES_FP_RIGHT_BITS(left, right)                                         \
    (((left)&0xf0f0f0f0) | (((unsigned DES_INT32)((right)&0xf0f0f0f0)) >> 4))
...
#define DES_FINAL_PERM(left, right, temp)                                      \
    ...
    {                                                                          \
        ...
        (left) = (FP[((right) >> 24) & 0xff] << 6) |                           \
                 (FP[((right) >> 16) & 0xff] << 4) |                           \
                 (FP[((right) >> 8) & 0xff] << 2) | FP[(right)&0xff];          \
        (right) = (FP[((temp) >> 24) & 0xff] << 6) |                           \
                  (FP[((temp) >> 16) & 0xff] << 4) |                           \
                  (FP[((temp) >> 8) & 0xff] << 2) | FP[temp & 0xff];           \
    } while (0);
