...
{
    /*
     * TODO:201:r: |-> allocate memory for the ipDefaultRouterTable data
     * context.
     */
    ...
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_allocate_data",
         "called\n"));
...
{
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_release_data",
         "called\n"));
...
int ipDefaultRouterTable_indexes_set_tbl_idx(
    ...
    u_long ipDefaultRouterAddressType_val, char* ipDefaultRouterAddress_val_ptr,
    size_t ipDefaultRouterAddress_val_ptr_len, long ipDefaultRouterIfIndex_val)
{
    DEBUGMSGTL((
        "verbose:ipDefaultRouterTable:ipDefaultRouterTable_indexes_set_tbl_idx",
        "called\n"));
    ...
    tbl_idx->ipDefaultRouterAddress_len =
        sizeof(tbl_idx->ipDefaultRouterAddress) /
        sizeof(tbl_idx->ipDefaultRouterAddress[0]); /* max length */
    /** WARNING: this code might not work for netsnmp_defaultrouter_entry */
    /*
 ...
 *  from the mib index.
 */
int ipDefaultRouterTable_indexes_set(
    ipDefaultRouterTable_rowreq_ctx* rowreq_ctx,
    u_long ipDefaultRouterAddressType_val, char* ipDefaultRouterAddress_val_ptr,
    size_t ipDefaultRouterAddress_val_ptr_len, long ipDefaultRouterIfIndex_val)
{
    DEBUGMSGTL(("verbose:ipDefaultRouterTable:ipDefaultRouterTable_indexes_set",
                "called\n"));

    if (MFD_SUCCESS != ipDefaultRouterTable_indexes_set_tbl_idx(
                           &rowreq_ctx->tbl_idx, ipDefaultRouterAddressType_val,
                                ...
                                u_long* ipDefaultRouterLifetime_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipDefaultRouterLifetime
     * data. copy (* ipDefaultRouterLifetime_val_ptr ) from rowreq_ctx->data
     */
                                  ...
                                  u_long* ipDefaultRouterPreference_val_ptr)
{
    ...
    DEBUGMSGTL(("verbose:ipDefaultRouterTable:ipDefaultRouterPreference_get",
                "called\n"));
     ...
     * ipDefaultRouterPreference data. copy (* ipDefaultRouterPreference_val_ptr
