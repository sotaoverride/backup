...
template <class Category, class Traversal>
struct is_boost_iterator<
    boost::iterators::detail::iterator_category_with_traversal<Category,
                                                               Traversal>>
{
...
struct iterator_enable_if_boost_iterator
    : ::boost::move_detail::enable_if_c<
          is_boost_iterator<typename boost::intrusive::iterator_traits<
              I>::iterator_category>::value,
          R>
{
};
...
struct iterator_enable_if_convertible_tag
    : ::boost::move_detail::enable_if_c<
          ::boost::move_detail::is_same_or_convertible<
              ...
              Tag>::value &&
              !::boost::move_detail::is_same_or_convertible<
                  typename boost::intrusive::iterator_traits<
                      I>::iterator_category,
                  Tag2>::value,
          R>
{
...
struct iterator_enable_if_tag_difference_type
    : iterator_enable_if_tag<
          I, Tag,
          typename boost::intrusive::iterator_traits<I>::difference_type>
{
};

template <class I, class Tag>
struct iterator_disable_if_tag_difference_type
    : iterator_disable_if_tag<
          I, Tag,
          typename boost::intrusive::iterator_traits<I>::difference_type>
{
};
...
template <class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE
    typename iterator_enable_if_tag<InputIt,
...
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag<
    InputIt, const boost::iterators::incrementable_traversal_tag&,
    const boost::iterators::single_pass_traversal_tag&>::type
    iterator_advance(InputIt& it, Distance n)
{
    while (n--)
        ++it;
...
template <class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag<
    InputIt, const boost::iterators::single_pass_traversal_tag&,
    const boost::iterators::forward_traversal_tag&>::type
    iterator_advance(InputIt& it, Distance n)
{
    while (n--)
        ++it;
...
template <class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag<
    InputIt, const boost::iterators::forward_traversal_tag&,
    const boost::iterators::bidirectional_traversal_tag&>::type
    iterator_advance(InputIt& it, Distance n)
{
    while (n--)
        ++it;
...
template <class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag<
    InputIt, const boost::iterators::bidirectional_traversal_tag&,
    const boost::iterators::random_access_traversal_tag&>::type
    iterator_advance(InputIt& it, Distance n)
{
    for (; 0 < n; --n)
        ++it;
...
template <class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag<
    InputIt, const boost::iterators::random_access_traversal_tag&,
    const fake&>::type
    iterator_advance(InputIt& it, Distance n)
{
    it += n;
...
inline typename iterator_disable_if_tag_difference_type<
...
template <class I>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_traits<I>::pointer
    iterator_arrow_result(const I& i)
{
    return i.operator->();
}
