 ...
 * \date   01.12.2007
 *
 * The header contains implementation of time traits that are used in various
 * parts of the library to acquire current time.
 */
...
//! Time traits that describes UTC time acquirement via Boost.DateTime
//! facilities
...
//! Time traits that describes local time acquirement via Boost.DateTime
//! facilities
