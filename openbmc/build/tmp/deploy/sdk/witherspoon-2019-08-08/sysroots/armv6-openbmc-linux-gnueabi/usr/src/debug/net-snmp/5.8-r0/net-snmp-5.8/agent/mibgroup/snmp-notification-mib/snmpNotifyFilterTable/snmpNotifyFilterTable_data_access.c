...
netsnmp_feature_require(snmpNotifyFilterTable_container_get)
     ...
     */
    int snmpNotifyFilterTable_init_data(
        snmpNotifyFilterTable_registration* snmpNotifyFilterTable_reg)
{
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_init_data",
                "called\n"));
 ...
 */
void snmpNotifyFilterTable_container_init(netsnmp_container** container_ptr_ptr)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_container_init",
         "called\n"));
 ...
 */
void snmpNotifyFilterTable_container_shutdown(netsnmp_container* container_ptr)
{
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_container_"
                "shutdown",
                "called\n"));
 ...
 *
 */
int snmpNotifyFilterTable_container_load(netsnmp_container* container)
{
    ...
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_container_load",
         "called\n"));
    ...
    while (1)
    {
        ...
        /*
         * TODO:352:M: |   |-> set indexes in new snmpNotifyFilterTable rowreq
         * context. data context will be set from the param (unless NULL, in
         * which case a new data context will be allocated)
         */
        ...
        if (MFD_SUCCESS != snmpNotifyFilterTable_indexes_set(
                               rowreq_ctx, snmpNotifyFilterProfileName,
 ...
 *
 */
void snmpNotifyFilterTable_container_free(netsnmp_container* container)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_container_free",
         "called\n"));
 ...
 * @retval MFD_ERROR       : other error.
 */
int snmpNotifyFilterTable_row_prep(snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_row_prep",
                "called\n"));
...
int
    ...
    (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    DEBUGMSGTL(("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_"
                "snmpNotifyFilterProfileName_check_index",
                "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:424:M: |-> Check snmpNotifyFilterTable external index
     * snmpNotifyFilterProfileName. check that index value in the table context
     * (rowreq_ctx) for the external index snmpNotifyFilterProfileName is legal.
     */
 ...
 */
int snmpNotifyFilterSubtree_check_index(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterSubtree_check_index",
         "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    /*
     * TODO:426:M: |-> Check snmpNotifyFilterTable index
     * snmpNotifyFilterSubtree. check that index value in the table context is
     * legal. (rowreq_ctx->tbl_index.snmpNotifyFilterSubtree)
     */
 ...
 */
int snmpNotifyFilterTable_validate_index(
    snmpNotifyFilterTable_registration* snmpNotifyFilterTable_reg,
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    ...
    DEBUGMSGTL(
        ("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_validate_index",
         "called\n"));
