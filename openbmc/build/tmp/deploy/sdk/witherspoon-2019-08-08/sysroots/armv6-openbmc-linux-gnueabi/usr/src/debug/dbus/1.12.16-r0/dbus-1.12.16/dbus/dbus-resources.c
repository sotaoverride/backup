...
struct DBusCounter
{
    ...
    long notify_size_guard_value; /**< call notify function when crossing this
                                     size value */
    long notify_unix_fd_guard_value; /**< call notify function when crossing
                                        this unix fd value */

    DBusCounterNotifyFunction notify_function; /**< notify function */
    void* notify_data;                         /**< data for notify function */
    dbus_bool_t
        notify_pending : 1; /**< TRUE if the guard value has been crossed */
 ...
 * @param unix_fd_guard_value the value we're notified if the unix fd counter
 * crosses
 * @param function function to call in order to notify
 * @param user_data data to pass to the function
 */
void _dbus_counter_set_notify(DBusCounter* counter, long size_guard_value,
