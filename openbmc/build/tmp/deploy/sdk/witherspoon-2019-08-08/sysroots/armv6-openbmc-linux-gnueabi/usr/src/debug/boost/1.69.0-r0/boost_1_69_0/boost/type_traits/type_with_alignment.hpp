...
{
    typedef typename long_double_alignment<
        Target, boost::alignment_of<long double>::value >= Target>::type type;
};
...
{
    typedef
        typename double_alignment<Target, boost::alignment_of<double>::value >=
                                              Target>::type type;
};
#endif
...
{
    typedef typename long_long_alignment<
        Target,
        boost::alignment_of<boost::long_long_type>::value >= Target>::type type;
};
#else
template <std::size_t Target>
struct long_alignment<Target, false>
...
{
    typedef typename long_alignment<Target, boost::alignment_of<long>::value >=
                                                Target>::type type;
};
...
{
    typedef typename int_alignment<Target, boost::alignment_of<int>::value >=
                                               Target>::type type;
};
...
{
    typedef
        typename short_alignment<Target, boost::alignment_of<short>::value >=
                                             Target>::type type;
};
...
{
    typedef typename boost::detail::char_alignment<
        Align, boost::alignment_of<char>::value >= Align>::type type;
};
...
struct type_with_alignment<8>
{
    typedef boost::conditional <
        ::boost::alignment_of<boost::detail::max_align>::value<
            8, tt_align_ns::a8, boost::detail::char_alignment<8, false>>::type
            t1;
...
// 1) The version above doesn't always compile (with the new test cases for
// example) 2) Because of Borlands #pragma option we can create types with
// alignments that are
