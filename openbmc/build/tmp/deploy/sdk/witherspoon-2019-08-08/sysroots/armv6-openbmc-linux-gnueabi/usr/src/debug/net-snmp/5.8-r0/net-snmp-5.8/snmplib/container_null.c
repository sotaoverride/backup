 ...
 */
     ...
     *
     */
    static void* _null_find(netsnmp_container* container, const void* data)
{
    DEBUGMSGTL(("container:null:find", "in\n"));
    return NULL;
}

static void* _null_find_next(netsnmp_container* container, const void* data)
{
    DEBUGMSGTL(("container:null:find_next", "in\n"));
    return NULL;
}

static int _null_insert(netsnmp_container* container, const void* data)
{
    DEBUGMSGTL(("container:null:insert", "in\n"));
    return 0;
}

static int _null_remove(netsnmp_container* container, const void* data)
{
    DEBUGMSGTL(("container:null:remove", "in\n"));
    return 0;
}

static int _null_free(netsnmp_container* container)
{
...
static int _null_init(netsnmp_container* container)
{
    DEBUGMSGTL(("container:null:", "in\n"));
    return 0;
}

static size_t _null_size(netsnmp_container* container)
{
    DEBUGMSGTL(("container:null:size", "in\n"));
    return 0;
}

static void _null_for_each(netsnmp_container* container,
                           netsnmp_container_obj_func* f, void* context)
{
    DEBUGMSGTL(("container:null:for_each", "in\n"));
}

static netsnmp_void_array* _null_get_subset(netsnmp_container* container,
                                            void* data)
{
...
static void _null_clear(netsnmp_container* container,
                        netsnmp_container_obj_func* f, void* context)
{
...
netsnmp_factory* netsnmp_container_get_null_factory(void)
{
    static netsnmp_factory f = {
        "null", (netsnmp_factory_produce_f*)netsnmp_container_get_null};
...
{
    netsnmp_container_register("null", netsnmp_container_get_null_factory());
}
