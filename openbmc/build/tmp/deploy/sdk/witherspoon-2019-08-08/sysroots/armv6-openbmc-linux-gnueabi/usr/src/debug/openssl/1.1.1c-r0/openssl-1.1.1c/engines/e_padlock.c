...
static int padlock_bind_helper(ENGINE* e)
{
    ...
    if (!ENGINE_set_id(e, padlock_id) || !ENGINE_set_name(e, padlock_name) ||
    ...
    {                                                                          \
        if (_hidden_aes_##ksize##_##lmode == NULL &&                           \
            ((_hidden_aes_##ksize##_##lmode = EVP_CIPHER_meth_new(             \
                  NID_aes_##ksize##_##lmode, EVP_CIPHER_block_size_##umode,    \
             ...
             !EVP_CIPHER_meth_set_set_asn1_params(                             \
                 _hidden_aes_##ksize##_##lmode, EVP_CIPHER_set_asn1_iv) ||     \
             !EVP_CIPHER_meth_set_get_asn1_params(                             \
                 _hidden_aes_##ksize##_##lmode, EVP_CIPHER_get_asn1_iv)))      \
        {                                                                      \
                                ...
                                const unsigned char* iv, int enc)
{
    ...
    switch (key_len)
    {
        ...
        case 256:
            /*
             * Generate an extended AES key in software. Needed for
             * AES192/AES256
             */
            /*
