...
struct undirected_edge_iter
    : iterator_adaptor<
          undirected_edge_iter<EdgeIter, EdgeDescriptor, Difference>, EdgeIter,
          EdgeDescriptor, use_default, EdgeDescriptor, Difference>
{
    typedef iterator_adaptor<
        undirected_edge_iter<EdgeIter, EdgeDescriptor, Difference>, EdgeIter,
        EdgeDescriptor, use_default, EdgeDescriptor, Difference>
...
template <class Vertex>
class stored_edge : public boost::equality_comparable1<
                        stored_edge<Vertex>,
                        boost::less_than_comparable1<stored_edge<Vertex>>>
{
  public:
    ...
    inline Vertex& get_target() const
    {
        return m_target;
    }
    inline const no_property& get_property() const
    {
        return s_prop;
    }
...
class stored_edge_property : public stored_edge<Vertex>
{
  ...
  public:
    ...
    {
        // NOTE: avoid 'Base::operator=(x);' broken on SGI MIPSpro (bug 55771 of
        // Mozilla).
...
#if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
    // NOTE Don't rely on default operators, their behavior is broken on several
    // compilers (GCC 4.6).
...
inline void remove_directed_edge_dispatch(edge_descriptor, EdgeList& el,
                                          StoredProperty& p)
{
...
template <class PropT, class Graph, class incidence_iterator, class EdgeList,
          class Predicate>
inline void undirected_remove_out_edge_if_dispatch(
    Graph& g, incidence_iterator first, incidence_iterator last, EdgeList& el,
    ...
    for (incidence_iterator next = first; first != last; first = next)
    {
        ...
        if (pred(*first))
        {
            if (source(*first, g) != target(*first, g))
            {
                // Remove the edge from the target
                detail::remove_directed_edge_dispatch(
                    *first, g.out_edge_list(target(*first, g)),
...
// O(E/V)
template <class edge_descriptor, class EdgeList, class StoredProperty>
inline void remove_directed_edge_dispatch(edge_descriptor e, EdgeList& el,
                                          no_property&)
{
    for (typename EdgeList::iterator i = el.begin(); i != el.end(); ++i)
    ...
    edges(const directed_edges_helper<Config>& g_)
{
    ...
    return std::make_pair(
        edge_iterator(g.vertex_set().begin(), g.vertex_set().begin(),
                      g.vertex_set().end(), g),
                               ...
                               directed_graph_helper<Config>& g_)
{
    ...
    detail::remove_directed_edge_if_dispatch(first, last, g.out_edge_list(u),
                                             pred, edge_parallel_category());
}
...
inline void remove_edge(EdgeOrIter e_or_iter, directed_graph_helper<Config>& g_)
{
...
struct remove_undirected_edge_dispatch
{
    ...
    static void apply(edge_descriptor e, undirected_graph_helper<Config>& g_,
                      StoredProperty& p)
    {
...
inline void remove_edge_and_property(Graph& g, EdgeList& el, Vertex v,
    ...
    : public boost::detail::edge_base<boost::undirected_tag, Vertex>
{
    ...
    EdgeProperty& get_property()
    {
        return m_property;
    }
    const EdgeProperty& get_property() const
    {
        return m_property;
    }
    ...
    bool operator==(const list_edge&) const
    {
        return false;
    }
    bool operator<(const list_edge&) const
             ...
             undirected_graph_helper<Config>& g_)
{
    ...
    if (inserted)
    {
        boost::graph_detail::push(g.out_edge_list(v),
                                  StoredEdge(u, p_iter, &g.m_edges));
                      ...
                      bidirectional_graph_helper_with_property<Config>& g_)
{
    ...
    typedef typename Config::edge_parallel_category Cat;
    detail::remove_directed_edge_if_dispatch(first, last, in_edge_list(g, v),
                                             pred, Cat());
             ...
             bidirectional_graph_helper_with_property<Config>& g_)
{
    ...
    if (inserted)
    {
        boost::graph_detail::push(in_edge_list(g, v),
                                  StoredEdge(u, p_iter, &g.m_edges));
...
struct adj_list_helper : public Base
{
    ...
    typedef
        typename lookup_one_property<edge_property_type, edge_bundle_t>::type
            edge_bundled;
    typedef
        typename lookup_one_property<graph_property_type, graph_bundle_t>::type
            graph_bundled;
};
...
inline typename boost::property_map<typename Config::graph_type, Property>::type
...
{
    typedef
        typename detail::property_kind_from_graph<adj_list_helper<Config, Base>,
                                                  Property>::type Kind;
...
class adj_list_impl : public adj_list_helper<Config, Base>
{
  ...
  public:
    ...
    inline StoredVertexList& vertex_set()
    {
        return m_vertices;
    }
    inline const StoredVertexList& vertex_set() const
    {
        return m_vertices;
    }
    ...
    inline void copy_impl(const adj_list_impl& x_)
    {
        ...
        for (boost::tie(ei, ei_end) = edges(x); ei != ei_end; ++ei)
        {
            ...
            boost::tie(e, inserted) =
                add_edge(vertex_map[(stored_vertex*)s],
                          ...
                          adj_list_impl<Derived, Config, Base>& g_)
{
    ...
    Derived& g = static_cast<Derived&>(g_);
    g.removing_vertex(u,
                      boost::graph_detail::iterator_stability(g_.m_vertices));
                                   ...
                                   boost::bidirectional_tag)
{
    ...
    if (u != V)
    {
        for (v = 0; v < V; ++v)
            reindex_edge_list(g.out_edge_list(v), u, edge_parallel_category());
        for (v = 0; v < V; ++v)
            reindex_edge_list(in_edge_list(g, v), u, edge_parallel_category());
...
template <class EdgeList, class vertex_descriptor>
inline void reindex_edge_list(EdgeList& el, vertex_descriptor u,
                              boost::allow_parallel_edge_tag)
{
...
struct adj_list_gen
{
    ...
    struct config
    {
        ...
        typedef
            typename container_gen<VertexListS, vertex_ptr>::type SeqVertexList;
        ...
        typedef typename container_gen<
            EdgeListS, list_edge<vertex_descriptor, EdgeProperty>>::type
            EdgeContainer;
        ...
        typedef typename mpl::if_<on_edge_storage, std::size_t,
                                  typename EdgeContainer::size_type>::type
            edges_size_type;
        ...
        typedef typename mpl::if_<
            ...
            typename mpl::if_<is_edge_ra,
                              stored_ra_edge_iter<vertex_descriptor,
                                                  EdgeContainer, EdgeProperty>,
                              stored_edge_iter<vertex_descriptor, EdgeIter,
                                               EdgeProperty>>::type>::type
            StoredEdge;

        // Adjacency Types

        typedef
            typename container_gen<OutEdgeListS, StoredEdge>::type OutEdgeList;
        ...
        typedef out_edge_iter<OutEdgeIter, vertex_descriptor, edge_descriptor,
                              OutEdgeIterDiff>
            out_edge_iterator;

        typedef
            typename adjacency_iterator_generator<graph_type, vertex_descriptor,
        ...
        typedef in_edge_iter<InEdgeIter, vertex_descriptor, edge_descriptor,
                             InEdgeIterDiff>
            in_edge_iterator;

        typedef typename inv_adjacency_iterator_generator<
            graph_type, vertex_descriptor, in_edge_iterator>::type
        ...
        typedef undirected_edge_iter<EdgeIter, edge_descriptor, EdgeIterDiff>
    ...
    typedef typename mpl::if_<
        BidirectionalT, bidirectional_graph_helper_with_property<config>,
        typename mpl::if_<DirectedT, directed_graph_helper<config>,
                          undirected_graph_helper<config>>::type>::type
        DirectedHelper;

    typedef typename mpl::if_<
        is_rand_access, vec_adj_list_impl<Graph, config, DirectedHelper>,
...
struct adj_list_vertex_all_properties_map
    : public boost::put_get_helper<
          PropRef, adj_list_vertex_all_properties_map<Graph, Property, PropRef>>
{
    typedef typename Graph::stored_vertex StoredVertex;
    ...
    typedef typename Graph::vertex_descriptor key_type;
    typedef boost::lvalue_property_map_tag category;
    inline adj_list_vertex_all_properties_map(const Graph* = 0,
                                              vertex_all_t = vertex_all_t())
    {
    }
...
struct vec_adj_list_vertex_property_map
    : public boost::put_get_helper<
          Reference, vec_adj_list_vertex_property_map<
                         Graph, GraphPtr, ValueType, Reference, Tag>>
{
    typedef ValueType value_type;
    typedef Reference reference;
...
struct vec_adj_list_vertex_all_properties_map
    : public boost::put_get_helper<PropertyRef,
                                   vec_adj_list_vertex_all_properties_map<
                                       Graph, GraphPtr, Property, PropertyRef>>
{
    typedef Property value_type;
    typedef PropertyRef reference;
    typedef typename boost::graph_traits<Graph>::vertex_descriptor key_type;
    typedef boost::lvalue_property_map_tag category;
    vec_adj_list_vertex_all_properties_map(GraphPtr g = 0,
                                           vertex_all_t = vertex_all_t()) :
        m_g(g)
    {
    }
...
struct adj_list_any_vertex_pa
{
    ...
    struct bind_
    {
        ...
        typedef adj_list_vertex_property_map<Graph, value_type, reference, Tag>
            type;
        typedef adj_list_vertex_property_map<Graph, value_type, const_reference,
                                             Tag>
            const_type;
    };
};
...
struct vec_adj_list_all_vertex_pa
{
    ...
    struct bind_
    {
        ...
        typedef vec_adj_list_vertex_all_properties_map<
            Graph, const Graph*, Property, const Property&>
            const_type;
    };
};
namespace detail
...
struct adj_list_choose_vertex_pa
    : boost::mpl::if_<boost::is_same<Tag, vertex_all_t>, adj_list_all_vertex_pa,
                      adj_list_any_vertex_pa>::type ::template bind_<Tag, Graph,
                                                                     Property>
{
};
...
struct vec_adj_list_choose_vertex_pa
    : vec_adj_list_choose_vertex_pa_helper<Tag>::type::template bind_<
          Tag, Graph, Property>
{
};
} // namespace detail
...
struct adj_list_edge_property_map
    : public put_get_helper<Ref,
                            adj_list_edge_property_map<Directed, Value, Ref,
                                                       Vertex, Property, Tag>>
{
    Tag tag;
...
struct adj_list_edge_all_properties_map
    : public put_get_helper<
          PropRef, adj_list_edge_all_properties_map<Directed, Property, PropRef,
                                                    PropPtr, Vertex>>
{
