            ...
            case DP_S_CONV:
                switch (ch)
                {
                    ...
                    case 'f':
                         ...
                         * um, floating point?
                         */
                        fmtfp(buffer, &currlen, maxlen, fvalue, min, max,
                              flags);
                        break;
                    case 'E':
                        flags |= DP_F_UP;
...
static void fmtstr(char* buffer, size_t* currlen, size_t maxlen, char* valuein,
                   int flags, int min, int max)
{
...
static LDOUBLE ns_pow10(int exp)
{
    LDOUBLE result = 1;
...
static long ns_round(LDOUBLE value)
{
    long intpart;
...
int main(void)
{
    ...
    char* int_fmt[] = {"%-1.5d",  "%1.5d",    "%123.9d", "%5.5d", "%10.5d",
                       "% 10.5d", "%+22.33d", "%01.3d",  "%4d",   NULL};
