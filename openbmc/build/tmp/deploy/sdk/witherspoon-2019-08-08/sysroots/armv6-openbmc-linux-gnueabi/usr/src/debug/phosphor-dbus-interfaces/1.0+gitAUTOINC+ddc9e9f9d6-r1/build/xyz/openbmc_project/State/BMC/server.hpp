...
class BMC
{
  public:
    ...
    using PropertiesVariant = std::variant<uint64_t, BMCState, Transition>;
    ...
    virtual BMCState currentBMCState(BMCState value, bool skipSignal);
    ...
    virtual uint64_t lastRebootTime(uint64_t value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_RequestedBMCTransition(sd_bus*, const char*,
                                                    const char*, const char*,
                                                    sd_bus_message*, void*,
                                                    sd_bus_error*);
    /** @brief sd-bus callback for set-property 'RequestedBMCTransition' */
    static int _callback_set_RequestedBMCTransition(sd_bus*, const char*,
                                                    const char*, const char*,
                                                    sd_bus_message*, void*,
                                                    sd_bus_error*);

    /** @brief sd-bus callback for get-property 'CurrentBMCState' */
    static int _callback_get_CurrentBMCState(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'CurrentBMCState' */
    static int _callback_set_CurrentBMCState(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'LastRebootTime' */
    static int _callback_get_LastRebootTime(sd_bus*, const char*, const char*,
                                            const char*, sd_bus_message*, void*,
                                            sd_bus_error*);
    /** @brief sd-bus callback for set-property 'LastRebootTime' */
    static int _callback_set_LastRebootTime(sd_bus*, const char*, const char*,
                                            const char*, sd_bus_message*, void*,
                                            sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_State_BMC_interface;
