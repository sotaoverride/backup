...
struct use_terminal<karma::domain, terminal_ex<tag::uint_generator<T, Radix>,
                                               fusion::vector1<A0>>>
    : mpl::true_
{
};
...
template <typename T, unsigned Radix>
struct use_lazy_terminal<karma::domain, tag::uint_generator<T, Radix>,
                         1 // arity
                         > : mpl::true_
{
};
...
// enables lit(uint)
template <typename A0>
struct use_terminal<karma::domain, terminal_ex<tag::lit, fusion::vector1<A0>>,
    ...
    : primitive_generator<any_uint_generator<T, CharEncoding, Tag, Radix>>
{
                         ...
                         Delimiter const& d, Attribute const& attr)
    {
        ...
        return uint_inserter<Radix, CharEncoding, Tag>::call(
                   sink, traits::extract_from<T>(attr, context)) &&
                         ...
                         unused_type)
    {
        ...
        BOOST_SPIRIT_ASSERT_FAIL(OutputIterator,
                                 uint_not_usable_without_attribute, ());
        return false;
    }
...
struct literal_uint_generator
    : primitive_generator<
          literal_uint_generator<T, CharEncoding, Tag, Radix, no_attribute>>
{
    ...
    literal_uint_generator(typename add_const<T>::type n) : n_(n)
    {
    }
...
struct make_uint
{
    ...
    typedef any_uint_generator<
        T,
        typename spirit::detail::get_encoding_with_case<Modifiers, unused_type,
                                                        lower || upper>::type,
        typename detail::get_casetag<Modifiers, lower || upper>::type, Radix>
        result_type;
...
#ifdef BOOST_HAS_LONG_LONG
template <typename Modifiers, typename A0>
struct make_primitive<terminal_ex<tag::ulong_long, fusion::vector1<A0>>,
                      Modifiers>
...
struct make_primitive<
    terminal_ex<tag::uint_generator<T, Radix>, fusion::vector1<A0>>, Modifiers>
...
struct basic_uint_literal
{
    ...
    typedef literal_uint_generator<
        ...
        typename spirit::detail::get_encoding_with_case<Modifiers, unused_type,
                                                        lower || upper>::type,
        typename detail::get_casetag<Modifiers, lower || upper>::type, 10, true>
        result_type;
