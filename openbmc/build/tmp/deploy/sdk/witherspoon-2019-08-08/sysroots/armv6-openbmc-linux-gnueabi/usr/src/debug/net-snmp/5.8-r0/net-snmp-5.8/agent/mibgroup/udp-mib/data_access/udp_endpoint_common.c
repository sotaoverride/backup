...
netsnmp_feature_child_of(udp_endpoint_common, libnetsnmpmibs)
     ...
     */
    netsnmp_container* netsnmp_access_udp_endpoint_container_init(u_int flags)
{
...
void netsnmp_access_udp_endpoint_container_free(netsnmp_container* container,
                                                u_int free_flags)
{
    ...
    if (!(free_flags & NETSNMP_ACCESS_UDP_ENDPOINT_FREE_DONT_CLEAR))
    {
        ...
        CONTAINER_CLEAR(
            container,
            (netsnmp_container_obj_func*)netsnmp_access_udp_endpoint_entry_free,
            NULL);
    }
...
netsnmp_udp_endpoint_entry* netsnmp_access_udp_endpoint_entry_create(void)
{
