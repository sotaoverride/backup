...
netsnmp_feature_child_of(tcpConnectionTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        baby_steps) netsnmp_feature_require(check_all_requests_error)

        netsnmp_feature_child_of(tcpConnectionTable_container_size,
                                 tcpConnectionTable_external_access)
            netsnmp_feature_child_of(tcpConnectionTable_registration_set,
                                     tcpConnectionTable_external_access)
                netsnmp_feature_child_of(tcpConnectionTable_registration_get,
                                         tcpConnectionTable_external_access)
...
static void _tcpConnectionTable_container_init(
    tcpConnectionTable_interface_ctx* if_ctx);
static void _tcpConnectionTable_container_shutdown(
    tcpConnectionTable_interface_ctx* if_ctx);
...
tcpConnectionTable_registration* tcpConnectionTable_registration_get(void)
{
...
tcpConnectionTable_registration*
    tcpConnectionTable_registration_set(tcpConnectionTable_registration* newreg)
{
 ...
 */
void _tcpConnectionTable_initialize_interface(
    tcpConnectionTable_registration* reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods* access_multiplexer =
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_tcpConnectionTable_initialize_interface",
         "called\n"));
     ...
     */
    DEBUGMSGTL(
        ("tcpConnectionTable:init_tcpConnectionTable",
         "Registering tcpConnectionTable as a mibs-for-dummies table.\n"));
    handler = netsnmp_baby_steps_access_multiplexer_get(access_multiplexer);
    reginfo = netsnmp_handler_registration_create("tcpConnectionTable", handler,
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, tcpConnectionTable_if_ctx.container,
    ...
    {
        handler = netsnmp_cache_handler_get(tcpConnectionTable_if_ctx.cache);
        netsnmp_inject_handler(reginfo, handler);
    }
 ...
 */
void _tcpConnectionTable_shutdown_interface(
...
void tcpConnectionTable_valid_columns_set(netsnmp_column_info* vc)
{
 ...
 */
int tcpConnectionTable_index_to_oid(netsnmp_index* oid_idx,
                                    tcpConnectionTable_mib_index* mib_idx)
{
    ...
    memset(&var_tcpConnectionRemPort, 0x00, sizeof(var_tcpConnectionRemPort));
    ...
    var_tcpConnectionLocalAddress.next_variable = &var_tcpConnectionLocalPort;
    var_tcpConnectionLocalPort.next_variable = &var_tcpConnectionRemAddressType;
    ...
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_index_to_oid",
                "called\n"));
 ...
 */
int tcpConnectionTable_index_from_oid(netsnmp_index* oid_idx,
                                      tcpConnectionTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL(("verbose:tcpConnectionTable:tcpConnectionTable_index_from_oid",
                "called\n"));
                                           ...
                                           void* user_init_ctx)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:tcpConnectionTable_allocate_rowreq_ctx",
         "called\n"));
    ...
    else
    {
        if (NULL != data)
        {
            ...
            rowreq_ctx->data = data;
                 ...
                 (rowreq_ctx->data = tcpConnectionTable_allocate_data()))
        {
    ...
    {
        if (SNMPERR_SUCCESS !=
            tcpConnectionTable_rowreq_ctx_init(rowreq_ctx, user_init_ctx))
        {
 ...
 */
void tcpConnectionTable_release_rowreq_ctx(
    tcpConnectionTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:tcpConnectionTable_release_rowreq_ctx",
         "called\n"));
 ...
 * wrapper
 */
static int _mfd_tcpConnectionTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_pre_request",
         "called\n"));
 ...
 * wrapper
 */
static int _mfd_tcpConnectionTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    tcpConnectionTable_rowreq_ctx* rowreq_ctx =
        (tcpConnectionTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    int rc, packet_rc;
    ...
    {
        DEBUGMSGTL(
            ("internal:tcpConnectionTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    rc = tcpConnectionTable_post_request(tcpConnectionTable_if_ctx.user_ctx,
                                         packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
 ...
 * wrapper
 */
static int _mfd_tcpConnectionTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_object_lookup",
         "called\n"));
                                   ...
                                   netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_get_column",
         "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_TCPCONNECTIONSTATE:
            ...
            rc = tcpConnectionState_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_TCPCONNECTIONPROCESS:
            ...
            rc = tcpConnectionProcess_get(rowreq_ctx, (u_long*)var->val.string);
            break;
...
int _mfd_tcpConnectionTable_get_values(netsnmp_mib_handler* handler,
                                       netsnmp_handler_registration* reginfo,
                                       ...
                                       netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_get_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _tcpConnectionTable_get_column(rowreq_ctx, requests->requestvb,
                                            tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
 ...
 */
NETSNMP_STATIC_INLINE int
    _tcpConnectionTable_check_column(tcpConnectionTable_rowreq_ctx* rowreq_ctx,
                                     netsnmp_variable_list* var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(("internal:tcpConnectionTable:_tcpConnectionTable_check_column",
                "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_TCPCONNECTIONSTATE:
            ...
            {
                DEBUGMSGTL(
                    ("tcpConnectionTable:_tcpConnectionTable_check_column:"
                     "tcpConnectionState",
                     "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = tcpConnectionState_check_value(
...
int _mfd_tcpConnectionTable_check_objects(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    tcpConnectionTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_check_objects",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _tcpConnectionTable_check_column(rowreq_ctx, requests->requestvb,
                                              tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error(requests, SNMP_VALIDATE_ERR(rc));
 ...
 */
static int _mfd_tcpConnectionTable_check_dependencies(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    tcpConnectionTable_rowreq_ctx* rowreq_ctx =
        (tcpConnectionTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    DEBUGMSGTL(("internal:tcpConnectionTable:_mfd_tcpConnectionTable_check_"
                "dependencies",
                "called\n"));
    ...
    if (rc)
    {
        DEBUGMSGTL(("tcpConnectionTable:mfd",
                    "error %d from "
 ...
 */
NETSNMP_STATIC_INLINE int _tcpConnectionTable_undo_setup_column(
    tcpConnectionTable_rowreq_ctx* rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_tcpConnectionTable_undo_setup_column",
         "called for %d\n", column));
 ...
 * undo setup
 */
int _mfd_tcpConnectionTable_undo_setup(netsnmp_mib_handler* handler,
                                       netsnmp_handler_registration* reginfo,
                                       netsnmp_agent_request_info* agtreq_info,
                                       netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_undo_setup",
         "called\n"));
    ...
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _tcpConnectionTable_undo_setup_column(rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL(("tcpConnectionTable:mfd",
                            "error %d from "
 ...
 * undo setup
 */
int _mfd_tcpConnectionTable_undo_cleanup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    tcpConnectionTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_undo_cleanup",
         "called\n"));
                                   ...
                                   netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(("internal:tcpConnectionTable:_tcpConnectionTable_set_column",
                "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_TCPCONNECTIONSTATE:
            rowreq_ctx->column_set_flags |= COLUMN_TCPCONNECTIONSTATE_FLAG;
            rc =
                tcpConnectionState_set(rowreq_ctx, *((u_long*)var->val.string));
            break;
...
int _mfd_tcpConnectionTable_set_values(netsnmp_mib_handler* handler,
                                       netsnmp_handler_registration* reginfo,
                                       netsnmp_agent_request_info* agtreq_info,
                                       netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_set_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _tcpConnectionTable_set_column(rowreq_ctx, requests->requestvb,
                                            tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL(("tcpConnectionTable:mfd",
 ...
 * commit the values
 */
int _mfd_tcpConnectionTable_commit(netsnmp_mib_handler* handler,
                                   netsnmp_handler_registration* reginfo,
                                   netsnmp_agent_request_info* agtreq_info,
                                   netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:tcpConnectionTable:_mfd_tcpConnectionTable_commit",
                "called\n"));
    ...
    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
         ...
         */
        tcpConnectionTable_dirty_set(tcpConnectionTable_dirty_get() +
...
int _mfd_tcpConnectionTable_undo_commit(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        netsnmp_agent_request_info* agtreq_info,
                                        netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_undo_commit",
         "called\n"));
                                    ...
                                    netsnmp_variable_list* var, int column)
{
    ...
    DEBUGMSGTL(("internal:tcpConnectionTable:_tcpConnectionTable_undo_column",
                "called for %d\n", column));
...
int _mfd_tcpConnectionTable_undo_values(netsnmp_mib_handler* handler,
                                        netsnmp_handler_registration* reginfo,
                                        netsnmp_agent_request_info* agtreq_info,
                                        netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_mfd_tcpConnectionTable_undo_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _tcpConnectionTable_undo_column(rowreq_ctx, requests->requestvb,
                                             tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
 ...
 */
int _mfd_tcpConnectionTable_irreversible_commit(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    tcpConnectionTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(("internal:tcpConnectionTable:_mfd_tcpConnectionTable_"
                "irreversible:commit",
                "called\n"));
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
    ...
    {
        snmp_log(LOG_ERR, "invalid cache for tcpConnectionTable_cache_load\n");
        return -1;
    }
     ...
     * call user code
     */
    return tcpConnectionTable_container_load((netsnmp_container*)cache->magic);
} /* _cache_load */
...
static void _cache_free(netsnmp_cache* cache, void* magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log(LOG_ERR, "invalid cache in tcpConnectionTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free(tcpConnectionTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_container_item_free", "called\n"));
...
static void _container_free(netsnmp_container* container)
{
    DEBUGMSGTL(("internal:tcpConnectionTable:_container_free", "called\n"));
 ...
 */
void _tcpConnectionTable_container_init(
    tcpConnectionTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_tcpConnectionTable_container_init",
         "called\n"));
    ...
    if_ctx->cache =
        netsnmp_cache_create(30, /* timeout in seconds */
                             _cache_load, _cache_free, tcpConnectionTable_oid,
                             tcpConnectionTable_oid_size);
 ...
 */
void _tcpConnectionTable_container_shutdown(
    tcpConnectionTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:tcpConnectionTable:_tcpConnectionTable_container_shutdown",
         "called\n"));
...
tcpConnectionTable_rowreq_ctx* tcpConnectionTable_row_find_by_mib_index(
    tcpConnectionTable_mib_index* mib_idx)
{
    tcpConnectionTable_rowreq_ctx* rowreq_ctx;
    ...
    rowreq_ctx = (tcpConnectionTable_rowreq_ctx*)CONTAINER_FIND(
        tcpConnectionTable_if_ctx.container, &oid_idx);
