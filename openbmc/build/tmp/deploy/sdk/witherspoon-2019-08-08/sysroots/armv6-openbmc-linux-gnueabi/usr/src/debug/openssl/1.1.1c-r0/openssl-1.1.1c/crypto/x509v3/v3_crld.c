...
const X509V3_EXT_METHOD v3_crld = {NID_crl_distribution_points,
                                   0,
...
const X509V3_EXT_METHOD v3_freshest_crl = {NID_freshest_crl,
                                           0,
                                           ASN1_ITEM_ref(CRL_DIST_POINTS),
                                           0,
                                           0,
                               ...
                               CONF_VALUE* cnf)
{
    ...
    else if (strcmp(cnf->name, "relativename") == 0)
    {
        ...
        if (!dnsect)
        {
            X509V3err(X509V3_F_SET_DIST_POINT_NAME, X509V3_R_SECTION_NOT_FOUND);
            return -1;
        }
    ...
    if (*pdp)
    {
        X509V3err(X509V3_F_SET_DIST_POINT_NAME, X509V3_R_DISTPOINT_ALREADY_SET);
        goto err;
    }
...
ASN1_CHOICE_cb(
    DIST_POINT_NAME,
    dpn_cb) = {ASN1_IMP_SEQUENCE_OF(DIST_POINT_NAME, name.fullname,
                                    GENERAL_NAME, 0),
               ASN1_IMP_SET_OF(DIST_POINT_NAME, name.relativename,
                               X509_NAME_ENTRY,
                               1)} ASN1_CHOICE_END_cb(DIST_POINT_NAME,
                                                      DIST_POINT_NAME, type)
    ...
    IMPLEMENT_ASN1_FUNCTIONS(DIST_POINT_NAME)
        ...
        ASN1_SEQUENCE(DIST_POINT) =
            {ASN1_EXP_OPT(DIST_POINT, distpoint, DIST_POINT_NAME, 0),
             ...
             ASN1_IMP_SEQUENCE_OF_OPT(DIST_POINT, CRLissuer, GENERAL_NAME,
                                      2)} ASN1_SEQUENCE_END(DIST_POINT)

                IMPLEMENT_ASN1_FUNCTIONS(DIST_POINT)

                    ASN1_ITEM_TEMPLATE(CRL_DIST_POINTS) = ASN1_EX_TEMPLATE_TYPE(
                        ASN1_TFLG_SEQUENCE_OF, 0, CRLDistributionPoints,
                        DIST_POINT) ASN1_ITEM_TEMPLATE_END(CRL_DIST_POINTS)

                        IMPLEMENT_ASN1_FUNCTIONS(CRL_DIST_POINTS)

                            ASN1_SEQUENCE(ISSUING_DIST_POINT) =
                                {ASN1_EXP_OPT(ISSUING_DIST_POINT, distpoint,
                                              DIST_POINT_NAME, 0),
                                 ASN1_IMP_OPT(ISSUING_DIST_POINT, onlyuser,
                                              ASN1_FBOOLEAN, 1),
                                 ASN1_IMP_OPT(ISSUING_DIST_POINT, onlyCA,
                                              ASN1_FBOOLEAN, 2),
                                 ASN1_IMP_OPT(ISSUING_DIST_POINT,
                                              onlysomereasons, ASN1_BIT_STRING,
                                              3),
                                 ASN1_IMP_OPT(ISSUING_DIST_POINT, indirectCRL,
                                              ASN1_FBOOLEAN, 4),
                                 ASN1_IMP_OPT(
                                     ISSUING_DIST_POINT, onlyattr,
                                     ASN1_FBOOLEAN,
                                     5)} ASN1_SEQUENCE_END(ISSUING_DIST_POINT)
...
const X509V3_EXT_METHOD v3_idp = {NID_issuing_distribution_point,
