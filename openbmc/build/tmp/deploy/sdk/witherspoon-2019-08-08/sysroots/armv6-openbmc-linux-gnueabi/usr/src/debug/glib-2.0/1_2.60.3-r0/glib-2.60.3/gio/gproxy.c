 ...
 *
 * Returns: (transfer full): a #GIOStream that will replace @connection. This
 * might be the same as @connection, in which case a reference will be added.
 *
 * Since: 2.26
 */
GIOStream* g_proxy_connect(GProxy* proxy, GIOStream* connection,
                           ...
                           GCancellable* cancellable, GError** error)
{
    ...
    return (*iface->connect)(proxy, connection, proxy_address, cancellable,
                             error);
}
 ...
 * Since: 2.26
 */
void g_proxy_connect_async(GProxy* proxy, GIOStream* connection,
                           GProxyAddress* proxy_address,
                           ...
                           GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    (*iface->connect_async)(proxy, connection, proxy_address, cancellable,
                            callback, user_data);
}
 ...
 * Since: 2.26
 */
GIOStream* g_proxy_connect_finish(GProxy* proxy, GAsyncResult* result,
                                  GError** error)
{
    GProxyInterface* iface;
