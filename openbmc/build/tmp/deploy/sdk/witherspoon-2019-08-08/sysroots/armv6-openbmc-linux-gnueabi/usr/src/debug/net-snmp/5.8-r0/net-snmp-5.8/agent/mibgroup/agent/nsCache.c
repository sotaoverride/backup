...
void init_nsCache(void)
{
    ...
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "nsCacheTimeout", handle_nsCacheTimeout, nsCacheTimeout_oid,
        OID_LENGTH(nsCacheTimeout_oid), HANDLER_CAN_RWRITE));
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        "nsCacheEnabled", handle_nsCacheEnabled, nsCacheEnabled_oid,
        OID_LENGTH(nsCacheEnabled_oid), HANDLER_CAN_RWRITE));
    ...
    netsnmp_register_table_iterator2(
        netsnmp_create_handler_registration(
            "tzCacheTable", handle_nsCacheTable, nsCacheTable_oid,
            OID_LENGTH(nsCacheTable_oid), HANDLER_CAN_RWRITE),
        iinfo);
}
...
int handle_nsCacheTimeout(netsnmp_mib_handler* handler,
                          netsnmp_handler_registration* reginfo,
                          netsnmp_agent_request_info* reqinfo,
                          netsnmp_request_info* requests)
{
    long cache_default_timeout = netsnmp_ds_get_int(
        NETSNMP_DS_APPLICATION_ID, NETSNMP_DS_AGENT_CACHE_TIMEOUT);
...
int handle_nsCacheEnabled(netsnmp_mib_handler* handler,
                          netsnmp_handler_registration* reginfo,
                          netsnmp_agent_request_info* reqinfo,
                          netsnmp_request_info* requests)
{
...
netsnmp_variable_list* get_first_cache_entry(void** loop_context,
                                             void** data_context,
...
netsnmp_variable_list* get_next_cache_entry(void** loop_context,
                                            void** data_context,
                                            netsnmp_variable_list* index,
                                            netsnmp_iterator_info* data)
{
...
int handle_nsCacheTable(netsnmp_mib_handler* handler,
                        netsnmp_handler_registration* reginfo,
                        netsnmp_agent_request_info* reqinfo,
                        netsnmp_request_info* requests)
{
    ...
    switch (reqinfo->mode)
    {
        ...
        case MODE_GET:
            for (request = requests; request; request = request->next)
            {
                ...
                cache_entry =
                    (netsnmp_cache*)netsnmp_extract_iterator_context(request);
                    ...
                    case NSCACHE_STATUS:
                        switch (*request->requestvb->val.integer)
                        {
                            ...
                            case NSCACHE_STATUS_EMPTY:
                                cache_entry->free_cache(cache_entry,
                                                        cache_entry->magic);
