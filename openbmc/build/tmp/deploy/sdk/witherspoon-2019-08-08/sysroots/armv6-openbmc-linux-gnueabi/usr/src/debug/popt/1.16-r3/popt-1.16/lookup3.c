    ...
    if (HASH_BIG_ENDIAN && ((u.i & 0x3) == 0))
    {
        ...
        { /* all the case statements fall through */
            case 12:
                ...
                break;
            case 11:
                c += ((uint32_t)k8[10]) << 8; /*@fallthrough@*/
            case 10:
                c += ((uint32_t)k8[9]) << 16; /*@fallthrough@*/
            case 9:
                c += ((uint32_t)k8[8]) << 24; /*@fallthrough@*/
            case 8:
                b += k[1];
                a += k[0];
                break;
            case 7:
                b += ((uint32_t)k8[6]) << 8; /*@fallthrough@*/
            case 6:
                b += ((uint32_t)k8[5]) << 16; /*@fallthrough@*/
            case 5:
                b += ((uint32_t)k8[4]) << 24; /*@fallthrough@*/
            case 4:
                a += k[0];
                break;
            case 3:
                a += ((uint32_t)k8[2]) << 8; /*@fallthrough@*/
            case 2:
                a += ((uint32_t)k8[1]) << 16; /*@fallthrough@*/
            case 1:
                a += ((uint32_t)k8[0]) << 24;
                break;
            case 0:
    ...
    { /* need to read the key one byte at a time */
        ...
        { /* all the case statements fall through */
            case 12:
                c += k[11]; /*@fallthrough@*/
            case 11:
                c += ((uint32_t)k[10]) << 8; /*@fallthrough@*/
            case 10:
                c += ((uint32_t)k[9]) << 16; /*@fallthrough@*/
            case 9:
                c += ((uint32_t)k[8]) << 24; /*@fallthrough@*/
            case 8:
                b += k[7]; /*@fallthrough@*/
            case 7:
                b += ((uint32_t)k[6]) << 8; /*@fallthrough@*/
            case 6:
                b += ((uint32_t)k[5]) << 16; /*@fallthrough@*/
            case 5:
                b += ((uint32_t)k[4]) << 24; /*@fallthrough@*/
            case 4:
                a += k[3]; /*@fallthrough@*/
            case 3:
                a += ((uint32_t)k[2]) << 8; /*@fallthrough@*/
            case 2:
                a += ((uint32_t)k[1]) << 16; /*@fallthrough@*/
            case 1:
                a += ((uint32_t)k[0]) << 24; /*@fallthrough@*/
                break;
            case 0:
                goto exit;
        }
...
/*@*/
{
    ...
    uint8_t qq[] = "xThis is the time for all good men to come to the aid of "
                   "their country...";
    uint32_t i;
    uint8_t qqq[] = "xxThis is the time for all good men to come to the aid of "
                    "their country...";
    uint32_t j;
    uint8_t qqqq[] = "xxxThis is the time for all good men to come to the aid "
                     "of their country...";
    uint32_t ref, x, y;
    uint8_t* p;
    uint32_t m = 13;

    printf("Endianness.  These lines should all be the same (for values filled "
           "in):\n");
    printf("%.8x                            %.8x                            "
           "%.8x\n",
