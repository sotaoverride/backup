...
G_DEFINE_ABSTRACT_TYPE_WITH_PRIVATE(GDBusAuthMechanism, _g_dbus_auth_mechanism,
                                    G_TYPE_OBJECT)

/* ----------------------------------------------------------------------------------------------------
 */

static void _g_dbus_auth_mechanism_finalize(GObject* object)
{
...
static void _g_dbus_auth_mechanism_get_property(GObject* object, guint prop_id,
                                                GValue* value,
                                                GParamSpec* pspec)
{
    GDBusAuthMechanism* mechanism = G_DBUS_AUTH_MECHANISM(object);
...
static void _g_dbus_auth_mechanism_set_property(GObject* object, guint prop_id,
                                                const GValue* value,
                                                GParamSpec* pspec)
{
    GDBusAuthMechanism* mechanism = G_DBUS_AUTH_MECHANISM(object);
...
static void _g_dbus_auth_mechanism_class_init(GDBusAuthMechanismClass* klass)
{
     ...
     */
    g_object_class_install_property(
        gobject_class, PROP_CREDENTIALS,
        g_param_spec_object("credentials", P_("Credentials"),
...
static void _g_dbus_auth_mechanism_init(GDBusAuthMechanism* mechanism)
{
...
const gchar* _g_dbus_auth_mechanism_get_name(GType mechanism_type)
{
    ...
    g_return_val_if_fail(
        g_type_is_a(mechanism_type, G_TYPE_DBUS_AUTH_MECHANISM), NULL);
...
gint _g_dbus_auth_mechanism_get_priority(GType mechanism_type)
{
    ...
    g_return_val_if_fail(
        g_type_is_a(mechanism_type, G_TYPE_DBUS_AUTH_MECHANISM), 0);
...
{
    g_return_val_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism), NULL);
    return G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->encode_data(
        mechanism, data, data_len, out_data_len);
}
...
{
    g_return_val_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism), NULL);
    return G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->decode_data(
        mechanism, data, data_len, out_data_len);
}
...
{
    g_return_val_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism),
                         G_DBUS_AUTH_MECHANISM_STATE_INVALID);
    return G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->server_get_state(
        mechanism);
}
                                            ...
                                            gsize initial_response_len)
{
    ...
    G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->server_initiate(
        mechanism, initial_response, initial_response_len);
}
...
{
    g_return_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism));
    G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->server_data_receive(
...
{
    g_return_val_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism), NULL);
    return G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->server_data_send(
        mechanism, out_data_len);
}

gchar* _g_dbus_auth_mechanism_server_get_reject_reason(
    GDBusAuthMechanism* mechanism)
{
    g_return_val_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism), NULL);
    return G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->server_get_reject_reason(
        mechanism);
}
    ...
    _g_dbus_auth_mechanism_client_get_state(GDBusAuthMechanism* mechanism)
{
    g_return_val_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism),
                         G_DBUS_AUTH_MECHANISM_STATE_INVALID);
    return G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->client_get_state(
        mechanism);
}
...
{
    g_return_val_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism), NULL);
    return G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->client_initiate(
        mechanism, out_initial_response_len);
}
...
{
    g_return_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism));
    G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->client_data_receive(
        mechanism, data, data_len);
}
...
{
    g_return_val_if_fail(G_IS_DBUS_AUTH_MECHANISM(mechanism), NULL);
    return G_DBUS_AUTH_MECHANISM_GET_CLASS(mechanism)->client_data_send(
        mechanism, out_data_len);
}
