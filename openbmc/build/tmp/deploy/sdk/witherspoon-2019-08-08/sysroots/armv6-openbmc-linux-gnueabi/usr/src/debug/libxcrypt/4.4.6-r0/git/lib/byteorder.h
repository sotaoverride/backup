...
static inline uint32_t le32_to_cpu(const unsigned char* buf)
{
    return ((((uint32_t)buf[0]) << 0) | (((uint32_t)buf[1]) << 8) |
            (((uint32_t)buf[2]) << 16) | (((uint32_t)buf[3]) << 24));
}

static inline uint32_t be32_to_cpu(const unsigned char* buf)
{
    return ((((uint32_t)buf[0]) << 24) | (((uint32_t)buf[1]) << 16) |
            (((uint32_t)buf[2]) << 8) | (((uint32_t)buf[3]) << 0));
}

static inline uint64_t le64_to_cpu(const unsigned char* buf)
{
...
static inline uint64_t be64_to_cpu(const unsigned char* buf)
{
...
static inline void cpu_to_le32(unsigned char* buf, uint32_t n)
{
...
static inline void cpu_to_be32(unsigned char* buf, uint32_t n)
{
...
static inline void cpu_to_le64(unsigned char* buf, uint64_t n)
{
...
static inline void cpu_to_be64(unsigned char* buf, uint64_t n)
{
