...
// and some may have <wchar.h> but not <cwchar> ...
    ...
    (!defined(BOOST_NO_CWCHAR) || defined(sun) || defined(__sun) ||            \
     defined(__QNX__))
#include <wchar.h>
#endif
...
// of the kind:
//
// ../../../boost/integer_traits.hpp:164:66: warning: use of C99 long long
// integer constant
//
...
#elif (defined(__sgi) &&                                                       \
       (!defined(__SGI_STL_PORT) || __SGI_STL_PORT < 0x400)) ||                \
    (defined __APPLE__) || (defined(__OpenBSD__) && defined(__GNUC__)) ||      \
...
class integer_traits<::boost::long_long_type>
    : public std::numeric_limits<::boost::long_long_type>,
      public detail::integer_traits_base<::boost::long_long_type, LLONG_MIN,
                                         LLONG_MAX>
{
};
...
class integer_traits<::boost::ulong_long_type>
    : public std::numeric_limits<::boost::ulong_long_type>,
      public detail::integer_traits_base<::boost::ulong_long_type, 0,
                                         ULLONG_MAX>
{
};
...
class integer_traits<::boost::long_long_type>
    : public std::numeric_limits<::boost::long_long_type>,
      public detail::integer_traits_base<::boost::long_long_type, LONG_LONG_MIN,
                                         LONG_LONG_MAX>
{
};
template <>
...
class integer_traits<::boost::long_long_type>
    : public std::numeric_limits<::boost::long_long_type>,
      public detail::integer_traits_base<::boost::long_long_type, LONGLONG_MIN,
                                         LONGLONG_MAX>
{
};
...
class integer_traits<::boost::long_long_type>
    : public std::numeric_limits<::boost::long_long_type>,
      public detail::integer_traits_base<::boost::long_long_type,
                                         -_LLONG_MAX - _C2, _LLONG_MAX>
{
};
...
//
// we have long long but no constants, this happens for example with gcc in
// -ansi mode, we'll just have to work out the values for ourselves (assumes 2's
