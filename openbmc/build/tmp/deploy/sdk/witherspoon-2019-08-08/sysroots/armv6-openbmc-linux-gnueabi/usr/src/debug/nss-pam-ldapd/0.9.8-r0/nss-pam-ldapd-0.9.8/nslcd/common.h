...
#define ERROR_OUT_BUFERROR(fp)                                                 \
    log_log(LOG_ERR, "client supplied argument %d bytes too large", tmpint32); \
    return -1;
...
#define STR_CMP(str1, str2)                                                    \
    (nslcd_cfg->ignorecase == 1 ? strcasecmp(str1, str2) : strcmp(str1, str2))
