 ...
 */
extern nis_result* nis_lookup(const_nis_name name, unsigned int flags) __THROW;
extern nis_result* nis_add(const_nis_name name, const nis_object* obj) __THROW;
...
extern nis_error nis_stats(const nis_server* __machine, const nis_tag* __tags,
                           int __numtags, nis_tag** __result) __THROW;
...
extern bool_t nis_write_obj(const char* __file,
                            const nis_object* __obj) __THROW;
...
extern nis_error __nisbind_create(dir_binding*, const nis_server*, unsigned int,
