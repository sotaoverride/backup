...
#if !(defined(HAVE_CC_SHA256_INIT) || defined(HAVE_SHA256_INIT) ||             \
...
extern void lzma_sha256_update(const uint8_t* buf, size_t size,
...
static inline void lzma_sha256_update(const uint8_t* buf, size_t size,
                                      lzma_check_state* check)
{
