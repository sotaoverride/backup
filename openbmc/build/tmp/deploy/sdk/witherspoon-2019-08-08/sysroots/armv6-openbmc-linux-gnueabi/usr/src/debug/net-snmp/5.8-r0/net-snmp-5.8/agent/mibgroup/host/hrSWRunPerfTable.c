...
/** Initialize the hrSWRunPerfTable table by defining its contents and how it's
 * structured */
void initialize_table_hrSWRunPerfTable(void)
{
    ...
    reg = netsnmp_create_handler_registration(
        "hrSWRunPerfTable", hrSWRunPerfTable_handler, hrSWRunPerfTable_oid,
        hrSWRunPerfTable_oid_len, HANDLER_CAN_RONLY);
    if (NULL == reg)
    {
        snmp_log(LOG_ERR,
...
int hrSWRunPerfTable_handler(netsnmp_mib_handler* handler,
