...
static const CDVarType* c_dvar_type_builtins[256] = {
    ['y'] = c_dvar_type_y, ['b'] = c_dvar_type_b, ['n'] = c_dvar_type_n,
    ['q'] = c_dvar_type_q, ['i'] = c_dvar_type_i, ['u'] = c_dvar_type_u,
    ['x'] = c_dvar_type_x, ['t'] = c_dvar_type_t, ['h'] = c_dvar_type_h,
    ['d'] = c_dvar_type_d, ['s'] = c_dvar_type_s, ['o'] = c_dvar_type_o,
    ['g'] = c_dvar_type_g, ['v'] = c_dvar_type_v,
};
 ...
 */
_public_ int c_dvar_type_new_from_signature(CDVarType** typep,
                                            ...
                                            size_t n_signature)
{
    ...
    do
    {
        if (_unlikely_(n_type >= n_signature ||
                       n_type >= C_DVAR_TYPE_LENGTH_MAX))
    ...
    for (i = 0; i < n_type; ++i)
    {
        ...
        if (container)
        {
            ...
            {
                container->size =
                    ALIGN_TO(container->size, 1 << this->alignment);
 ...
 *         @object, respectively.
 */
_public_ int c_dvar_type_compare_string(const CDVarType* subject,
                                        const char* object, size_t n_object)
{
