...
static struct region default_overflow_region = {.offset = 0,
                                                .nsamples = 1,
                                                .scale = 2,
...
static unsigned long int pc_to_index(size_t pc, size_t offset,
                                     unsigned int scale, int prof_uint)
{
...
static inline size_t index_to_pc(unsigned long int n, size_t offset,
                                 unsigned int scale, int prof_uint)
{
...
static void profil_count(void* pcp, int prof_uint)
{
...
static inline void profil_count_ushort(void* pcp)
{
    profil_count(pcp, 0);
}

static inline void profil_count_uint(void* pcp)
{
    profil_count(pcp, 1);
}
...
static int insert(int i, unsigned long int start, unsigned long int end,
                  struct prof* p, int prof_uint)
{
    struct region* r;
    size_t to_copy;
