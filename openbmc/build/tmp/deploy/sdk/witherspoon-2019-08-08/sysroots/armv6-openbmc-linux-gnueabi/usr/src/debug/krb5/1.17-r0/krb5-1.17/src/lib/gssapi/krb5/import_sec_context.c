 ...
 * the OID if possible.
 */
gss_OID krb5_gss_convert_static_mech_oid(oid) gss_OID oid;
{
...
krb5_error_code krb5_gss_ser_init(krb5_context context)
{
    krb5_error_code code;
    static krb5_error_code(KRB5_CALLCONV* const fns[])(krb5_context) = {
        krb5_ser_context_init, krb5_ser_auth_context_init, krb5_ser_ccache_init,
        krb5_ser_rcache_init,  krb5_ser_keytab_init,
    };
    unsigned int i;
...
OM_uint32 KRB5_CALLCONV krb5_gss_import_sec_context(
    minor_status, interprocess_token, context_handle) OM_uint32* minor_status;
