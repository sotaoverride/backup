...
static char* netsnmp_tcp_fmtaddr(netsnmp_transport* t, const void* data,
                                 int len)
{
    return netsnmp_ipv4_fmtaddr("TCP", t, data, len);
}

static int netsnmp_tcp_accept(netsnmp_transport* t)
{
...
netsnmp_transport* netsnmp_tcp_create_tstring(const char* str, int local,
                                              const char* default_target)
{
...
netsnmp_transport* netsnmp_tcp_create_ostring(const void* o, size_t o_len,
                                              int local)
{
