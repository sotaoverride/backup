...
/* HOLDS: quark_global_lock */
static inline GQuark quark_from_string(const gchar* string, gboolean duplicate)
{
    GQuark quark = 0;
...
static inline GQuark quark_from_string_locked(const gchar* string,
                                              gboolean duplicate)
{
    GQuark quark = 0;
...
static inline const gchar* quark_intern_string_locked(const gchar* string,
                                                      gboolean duplicate)
{
    const gchar* result;
    GQuark quark;
