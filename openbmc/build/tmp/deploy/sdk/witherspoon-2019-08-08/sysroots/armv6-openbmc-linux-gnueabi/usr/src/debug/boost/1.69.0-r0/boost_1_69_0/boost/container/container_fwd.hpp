...
template <class T, class Allocator = new_allocator<T>, class Options = void>
class vector;
...
template <class T, std::size_t N, class Allocator = new_allocator<T>>
class small_vector;
...
template <class Key, class Compare = std::less<Key>,
          class Allocator = new_allocator<Key>, class Options = void>
class set;
...
typedef basic_string<wchar_t, std::char_traits<wchar_t>, new_allocator<wchar_t>>
    wstring;
...
template <class T, std::size_t NodesPerBlock = ADP_nodes_per_block,
...
template <class T, std::size_t NodesPerBlock = NodeAlloc_nodes_per_block,
