...
/* For plain hash functions. Hash functions commonly supported on today's
 * kernels are: crc32c, crct10dif, crc32,
 * sha224, sha256, sha512, sha384, sha1, md5, md4, sha3-224, sha3-256, sha3-384,
 * sha3-512, and more. */
int khash_new(khash** ret, const char* algorithm);

/* For keyed hash functions. Hash functions commonly supported on today's
 * kernels are: hmac(sha256), cmac(aes), cmac(des3_ede), hmac(sha3-512),
 * hmac(sha3-384), hmac(sha3-256), hmac(sha3-224), hmac(rmd160), hmac(rmd128),
