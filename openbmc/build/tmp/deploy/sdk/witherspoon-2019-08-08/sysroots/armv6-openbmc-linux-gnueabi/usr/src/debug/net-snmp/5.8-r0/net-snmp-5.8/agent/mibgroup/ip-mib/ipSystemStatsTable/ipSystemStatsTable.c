...
void initialize_table_ipSystemStatsTable(void)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipSystemStatsTable:initialize_table_ipSystemStatsTable",
         "called\n"));
     ...
     */
    _ipSystemStatsTable_initialize_interface(ipSystemStatsTable_user_context_p,
                                             flags);
} /* initialize_table_ipSystemStatsTable */
    ...
    ipSystemStatsTable_rowreq_ctx* rowreq_ctx, void* user_init_ctx)
{
    ...
    /*
     * TODO:210:o: |-> Perform extra ipSystemStatsTable rowreq initialization.
     * (eg DEFVALS)
     */
...
ipSystemStatsTable_data* ipSystemStatsTable_allocate_data(void)
{
     ...
     */
    ipSystemStatsTable_data* rtn = SNMP_MALLOC_TYPEDEF(ipSystemStatsTable_data);

    DEBUGMSGTL(("verbose:ipSystemStatsTable:ipSystemStatsTable_allocate_data",
                "called\n"));
 ...
 */
void ipSystemStatsTable_release_data(ipSystemStatsTable_data* data)
{
    DEBUGMSGTL(("verbose:ipSystemStatsTable:ipSystemStatsTable_release_data",
                "called\n"));
...
int ipSystemStatsTable_indexes_set_tbl_idx(
    ipSystemStatsTable_mib_index* tbl_idx, u_long ipSystemStatsIPVersion_val)
{
    DEBUGMSGTL(
                                ...
                                u_long* ipSystemStatsInReceives_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsInReceives
     * data. copy (* ipSystemStatsInReceives_val_ptr ) from rowreq_ctx->data
     */
                              ...
                              u_long* ipSystemStatsInOctets_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsInOctets
     * data. copy (* ipSystemStatsInOctets_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCINOCTETS])
        return MFD_SKIP;

    (*ipSystemStatsInOctets_val_ptr) = rowreq_ctx->data->stats.HCInOctets.low;
    ...
    struct counter64* ipSystemStatsHCInOctets_val_ptr)
{
     ...
     * get (* ipSystemStatsHCInOctets_val_ptr ).low and (*
     * ipSystemStatsHCInOctets_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCINOCTETS])
        return MFD_SKIP;
                                 ...
                                 u_long* ipSystemStatsInHdrErrors_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsInHdrErrors
     * data. copy (* ipSystemStatsInHdrErrors_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_INHDRERRORS])
        return MFD_SKIP;

    (*ipSystemStatsInHdrErrors_val_ptr) = rowreq_ctx->data->stats.InHdrErrors;
                                ...
                                u_long* ipSystemStatsInNoRoutes_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsInNoRoutes
     * data. copy (* ipSystemStatsInNoRoutes_val_ptr ) from rowreq_ctx->data
     */
                                  ...
                                  u_long* ipSystemStatsInAddrErrors_val_ptr)
{
     ...
     * ipSystemStatsInAddrErrors data. copy (* ipSystemStatsInAddrErrors_val_ptr
     * ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_INADDRERRORS])
        return MFD_SKIP;

    (*ipSystemStatsInAddrErrors_val_ptr) = rowreq_ctx->data->stats.InAddrErrors;
    ...
    u_long* ipSystemStatsInUnknownProtos_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsInUnknownProtos data. copy (*
     * ipSystemStatsInUnknownProtos_val_ptr ) from rowreq_ctx->data
     */
    ...
    u_long* ipSystemStatsInTruncatedPkts_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsInTruncatedPkts data. copy (*
     * ipSystemStatsInTruncatedPkts_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
    ...
    u_long* ipSystemStatsInForwDatagrams_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsInForwDatagrams data. copy (*
     * ipSystemStatsInForwDatagrams_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
...
int ipSystemStatsHCInForwDatagrams_get(
    ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
    struct counter64* ipSystemStatsHCInForwDatagrams_val_ptr)
{
    /** we should have a non-NULL pointer */
     ...
     * get (* ipSystemStatsHCInForwDatagrams_val_ptr ).low and (*
     * ipSystemStatsHCInForwDatagrams_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
             .columnAvail[IPSYSTEMSTATSTABLE_HCINFORWDATAGRAMS])
        return MFD_SKIP;
                                ...
                                u_long* ipSystemStatsReasmReqds_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsReasmReqds
     * data. copy (* ipSystemStatsReasmReqds_val_ptr ) from rowreq_ctx->data
     */
                              ...
                              u_long* ipSystemStatsReasmOKs_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsReasmOKs
     * data. copy (* ipSystemStatsReasmOKs_val_ptr ) from rowreq_ctx->data
     */
                                ...
                                u_long* ipSystemStatsReasmFails_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsReasmFails
     * data. copy (* ipSystemStatsReasmFails_val_ptr ) from rowreq_ctx->data
     */
                                ...
                                u_long* ipSystemStatsInDiscards_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsInDiscards
     * data. copy (* ipSystemStatsInDiscards_val_ptr ) from rowreq_ctx->data
     */
                                ...
                                u_long* ipSystemStatsInDelivers_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsInDelivers
     * data. copy (* ipSystemStatsInDelivers_val_ptr ) from rowreq_ctx->data
     */
    ...
    struct counter64* ipSystemStatsHCInDelivers_val_ptr)
{
     ...
     * get (* ipSystemStatsHCInDelivers_val_ptr ).low and (*
     * ipSystemStatsHCInDelivers_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCINDELIVERS])
        return MFD_SKIP;
                                 ...
                                 u_long* ipSystemStatsOutRequests_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsOutRequests
     * data. copy (* ipSystemStatsOutRequests_val_ptr ) from rowreq_ctx->data
     */
    ...
    struct counter64* ipSystemStatsHCOutRequests_val_ptr)
{
     ...
     * get (* ipSystemStatsHCOutRequests_val_ptr ).low and (*
     * ipSystemStatsHCOutRequests_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCOUTREQUESTS])
        return MFD_SKIP;
                                 ...
                                 u_long* ipSystemStatsOutNoRoutes_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsOutNoRoutes
     * data. copy (* ipSystemStatsOutNoRoutes_val_ptr ) from rowreq_ctx->data
     */
    ...
    u_long* ipSystemStatsOutForwDatagrams_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsOutForwDatagrams data. copy (*
     * ipSystemStatsOutForwDatagrams_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
...
int ipSystemStatsHCOutForwDatagrams_get(
    ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
    struct counter64* ipSystemStatsHCOutForwDatagrams_val_ptr)
{
    /** we should have a non-NULL pointer */
     ...
     * get (* ipSystemStatsHCOutForwDatagrams_val_ptr ).low and (*
     * ipSystemStatsHCOutForwDatagrams_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
             .columnAvail[IPSYSTEMSTATSTABLE_HCOUTFORWDATAGRAMS])
        return MFD_SKIP;
                                 ...
                                 u_long* ipSystemStatsOutDiscards_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsOutDiscards
     * data. copy (* ipSystemStatsOutDiscards_val_ptr ) from rowreq_ctx->data
     */
                                  ...
                                  u_long* ipSystemStatsOutFragReqds_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsOutFragReqds data. copy (* ipSystemStatsOutFragReqds_val_ptr
     * ) from rowreq_ctx->data
     */
                                ...
                                u_long* ipSystemStatsOutFragOKs_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsOutFragOKs
     * data. copy (* ipSystemStatsOutFragOKs_val_ptr ) from rowreq_ctx->data
     */
                                  ...
                                  u_long* ipSystemStatsOutFragFails_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsOutFragFails data. copy (* ipSystemStatsOutFragFails_val_ptr
     * ) from rowreq_ctx->data
     */
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipSystemStatsOutFragCreates_get(ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
                                    u_long* ipSystemStatsOutFragCreates_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsOutFragCreates data. copy (*
     * ipSystemStatsOutFragCreates_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
                                  ...
                                  u_long* ipSystemStatsOutTransmits_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsOutTransmits data. copy (* ipSystemStatsOutTransmits_val_ptr
     * ) from rowreq_ctx->data
     */
    ...
    struct counter64* ipSystemStatsHCOutTransmits_val_ptr)
{
     ...
     * get (* ipSystemStatsHCOutTransmits_val_ptr ).low and (*
     * ipSystemStatsHCOutTransmits_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCOUTTRANSMITS])
        return MFD_SKIP;
                               ...
                               u_long* ipSystemStatsOutOctets_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsOutOctets
     * data. copy (* ipSystemStatsOutOctets_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCOUTOCTETS])
        return MFD_SKIP;

    (*ipSystemStatsOutOctets_val_ptr) = rowreq_ctx->data->stats.HCOutOctets.low;
    ...
    struct counter64* ipSystemStatsHCOutOctets_val_ptr)
{
     ...
     * get (* ipSystemStatsHCOutOctets_val_ptr ).low and (*
     * ipSystemStatsHCOutOctets_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCOUTOCTETS])
        return MFD_SKIP;
                                 ...
                                 u_long* ipSystemStatsInMcastPkts_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsInMcastPkts
     * data. copy (* ipSystemStatsInMcastPkts_val_ptr ) from rowreq_ctx->data
     */
    ...
    struct counter64* ipSystemStatsHCInMcastPkts_val_ptr)
{
     ...
     * get (* ipSystemStatsHCInMcastPkts_val_ptr ).low and (*
     * ipSystemStatsHCInMcastPkts_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCINMCASTPKTS])
        return MFD_SKIP;
                                   ...
                                   u_long* ipSystemStatsInMcastOctets_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsInMcastOctets data. copy (*
     * ipSystemStatsInMcastOctets_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
...
int ipSystemStatsHCInMcastOctets_get(
    ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
    struct counter64* ipSystemStatsHCInMcastOctets_val_ptr)
{
    /** we should have a non-NULL pointer */
     ...
     * get (* ipSystemStatsHCInMcastOctets_val_ptr ).low and (*
     * ipSystemStatsHCInMcastOctets_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
             .columnAvail[IPSYSTEMSTATSTABLE_HCINMCASTOCTETS])
        return MFD_SKIP;
                                  ...
                                  u_long* ipSystemStatsOutMcastPkts_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsOutMcastPkts data. copy (* ipSystemStatsOutMcastPkts_val_ptr
     * ) from rowreq_ctx->data
     */
    ...
    struct counter64* ipSystemStatsHCOutMcastPkts_val_ptr)
{
     ...
     * get (* ipSystemStatsHCOutMcastPkts_val_ptr ).low and (*
     * ipSystemStatsHCOutMcastPkts_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCOUTMCASTPKTS])
        return MFD_SKIP;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipSystemStatsOutMcastOctets_get(ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
                                    u_long* ipSystemStatsOutMcastOctets_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsOutMcastOctets data. copy (*
     * ipSystemStatsOutMcastOctets_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
...
int ipSystemStatsHCOutMcastOctets_get(
    ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
    struct counter64* ipSystemStatsHCOutMcastOctets_val_ptr)
{
    /** we should have a non-NULL pointer */
     ...
     * get (* ipSystemStatsHCOutMcastOctets_val_ptr ).low and (*
     * ipSystemStatsHCOutMcastOctets_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
             .columnAvail[IPSYSTEMSTATSTABLE_HCOUTMCASTOCTETS])
        return MFD_SKIP;
                                 ...
                                 u_long* ipSystemStatsInBcastPkts_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsInBcastPkts
     * data. copy (* ipSystemStatsInBcastPkts_val_ptr ) from rowreq_ctx->data
     */
    ...
    struct counter64* ipSystemStatsHCInBcastPkts_val_ptr)
{
     ...
     * get (* ipSystemStatsHCInBcastPkts_val_ptr ).low and (*
     * ipSystemStatsHCInBcastPkts_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCINBCASTPKTS])
        return MFD_SKIP;
                                  ...
                                  u_long* ipSystemStatsOutBcastPkts_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsOutBcastPkts data. copy (* ipSystemStatsOutBcastPkts_val_ptr
     * ) from rowreq_ctx->data
     */
    ...
    struct counter64* ipSystemStatsHCOutBcastPkts_val_ptr)
{
     ...
     * get (* ipSystemStatsHCOutBcastPkts_val_ptr ).low and (*
     * ipSystemStatsHCOutBcastPkts_val_ptr ).high from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_HCOUTBCASTPKTS])
        return MFD_SKIP;
...
int ipSystemStatsDiscontinuityTime_get(
    ipSystemStatsTable_rowreq_ctx* rowreq_ctx,
    u_long* ipSystemStatsDiscontinuityTime_val_ptr)
{
    /** we should have a non-NULL pointer */
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the
     * ipSystemStatsDiscontinuityTime data. copy (*
     * ipSystemStatsDiscontinuityTime_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats
                                 ...
                                 u_long* ipSystemStatsRefreshRate_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ipSystemStatsRefreshRate
     * data. copy (* ipSystemStatsRefreshRate_val_ptr ) from rowreq_ctx->data
     */
    if (!rowreq_ctx->data->stats.columnAvail[IPSYSTEMSTATSTABLE_REFRESHRATE])
        return MFD_SKIP;

    (*ipSystemStatsRefreshRate_val_ptr) = rowreq_ctx->ipSystemStatsRefreshRate;
