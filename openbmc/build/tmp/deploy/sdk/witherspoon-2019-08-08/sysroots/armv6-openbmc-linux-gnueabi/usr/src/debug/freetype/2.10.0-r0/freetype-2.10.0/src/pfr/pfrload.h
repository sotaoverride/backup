...
typedef FT_Error (*PFR_ExtraItem_ParseFunc)(FT_Byte* p, FT_Byte* limit,
                                            FT_Pointer data);
...
FT_LOCAL(FT_Error)
pfr_log_font_count(FT_Stream stream, FT_UInt32 log_section_offset,
                   FT_Long* acount);

/* load a pfr logical font entry */
FT_LOCAL(FT_Error)
pfr_log_font_load(PFR_LogFont log_font, FT_Stream stream, FT_UInt face_index,
