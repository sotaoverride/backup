...
struct match_policy
{
    ...
    match<AttrT> create_match(std::size_t length, AttrT const& val,
    ...
    void group_match(MatchT& /*m*/, parser_id const& /*id*/,
                     IteratorT const& /*first*/,
                     IteratorT const& /*last*/) const
    {
    }
...
struct attributed_action_policy
{
    ...
    static void call(ActorT const& actor, AttrT& val, IteratorT const&,
                     IteratorT const&)
    {
        actor(val);
    }
...
{
    template <typename ActorT, typename IteratorT>
    static void call(ActorT const& actor, nil_t, IteratorT const& first,
...
struct action_policy
{
    ...
    void do_action(ActorT const& actor, AttrT& val, IteratorT const& first,
                   IteratorT const& last) const
    {
...
//
///////////////////////////////////////////////////////////////////////////
template <typename IterationPolicyT, typename MatchPolicyT,
          typename ActionPolicyT>
struct scanner_policies : public IterationPolicyT,
                          public MatchPolicyT,
...
class scanner : public PoliciesT, public scanner_base
{
  public:
    ...
    typedef
        typename boost::detail::iterator_traits<IteratorT>::value_type value_t;
    ...
    scanner(IteratorT& first_, iter_param_t last_,
