...
netsnmp_feature_child_of(ipAddressTable_external_access, libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_require(check_all_requests_error)
            ...
            netsnmp_feature_child_of(ipAddressTable_container_size,
                                     ipAddressTable_external_access)
                netsnmp_feature_child_of(ipAddressTable_registration_set,
                                         ipAddressTable_external_access)
                    netsnmp_feature_child_of(ipAddressTable_registration_get,
                                             ipAddressTable_external_access)
                        netsnmp_feature_child_of(ipAddressTable_container_get,
                                                 ipAddressTable_external_access)
...
void ipAddressTable_dirty_set(u_int status)
{
    DEBUGMSGTL(("ipAddressTable:ipAddressTable_dirty_set",
                "called. was %d, now %d\n", ipAddressTable_if_ctx.table_dirty,
                status));
                                          ...
                                          u_long flags)
{
    ...
    netsnmp_table_registration_info* tbl_info = &ipAddressTable_if_ctx.tbl_info;
    netsnmp_handler_registration* reginfo;
    netsnmp_mib_handler* handler;
    int mfd_modes = 0;

    DEBUGMSGTL(("internal:ipAddressTable:_ipAddressTable_initialize_interface",
                "called\n"));
    ...
    reginfo = netsnmp_handler_registration_create(
        "ipAddressTable", handler, ipAddressTable_oid, ipAddressTable_oid_size,
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, ipAddressTable_if_ctx.container,
...
void ipAddressTable_valid_columns_set(netsnmp_column_info* vc)
{
                                ...
                                ipAddressTable_mib_index* mib_idx)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_index_to_oid", "called\n"));
     ...
     * ipAddressAddr(2)/InetAddress/ASN_OCTET_STR/char(char)//L/a/w/e/R/d/h
     */
    snmp_set_var_value(&var_ipAddressAddr, (u_char*)&mib_idx->ipAddressAddr,
                                  ...
                                  ipAddressTable_mib_index* mib_idx)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipAddressTable:ipAddressTable_index_from_oid", "called\n"));

    /*
     * parse the oid into the individual index components
     */
    err =
        parse_oid_indexes(oid_idx->oids, oid_idx->len, &var_ipAddressAddrType);
    if (err == SNMP_ERR_NOERROR)
    {
        ...
        else
        {
            ...
            mib_idx->ipAddressAddr_len =
                var_ipAddressAddr.val_len / sizeof(mib_idx->ipAddressAddr[0]);
        }
    }
                                       ...
                                       void* user_init_ctx)
{
    ...
    DEBUGMSGTL(("internal:ipAddressTable:ipAddressTable_allocate_rowreq_ctx",
                "called\n"));
 ...
 * wrapper
 */
static int _mfd_ipAddressTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    {
        DEBUGMSGTL(
            ("internal:ipAddressTable", "skipping additional pre_request\n"));
 ...
 * wrapper
 */
static int _mfd_ipAddressTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipAddressTable_rowreq_ctx* rowreq_ctx =
    ...
    {
        DEBUGMSGTL(
            ("internal:ipAddressTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && ipAddressTable_dirty_get())
    {
         ...
         * the dirty flags.
         */
        snmp_log(LOG_WARNING, "ipAddressTable dirty flag set in post_request "
                              "but status != SUCCESS.\n");
    }

    rc = ipAddressTable_post_request(ipAddressTable_if_ctx.user_ctx, packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
    ...
    _mfd_ipAddressTable_rowreq_from_index(netsnmp_index* oid_idx, int* rc_ptr)
{
    ...
    DEBUGMSGTL(("internal:ipAddressTable:_mfd_ipAddressTable_rowreq_from_index",
                "called\n"));
 ...
 * wrapper
 */
static int _mfd_ipAddressTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipAddressTable:_mfd_ipAddressTable_object_lookup",
                "called\n"));
                               ...
                               netsnmp_variable_list* var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPADDRESSLASTCHANGED:
            var->val_len = sizeof(u_long);
            var->type = ASN_TIMETICKS;
            rc = ipAddressLastChanged_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPADDRESSROWSTATUS:
            var->val_len = sizeof(u_long);
            var->type = ASN_INTEGER;
            rc = ipAddressRowStatus_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPADDRESSSTORAGETYPE:
            var->val_len = sizeof(u_long);
            var->type = ASN_INTEGER;
            rc = ipAddressStorageType_get(rowreq_ctx, (u_long*)var->val.string);
            break;
...
int _mfd_ipAddressTable_get_values(netsnmp_mib_handler* handler,
                                   netsnmp_handler_registration* reginfo,
                                   ...
                                   netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ipAddressTable:_mfd_ipAddressTable_get_values", "called\n"));
    ...
    _ipAddressTable_check_indexes(ipAddressTable_rowreq_ctx* rowreq_ctx)
{
    ...
    DEBUGMSGTL(
        ("internal:ipAddressTable:_ipAddressTable_check_indexes", "called\n"));
                                 ...
                                 netsnmp_variable_list* var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPADDRESSIFINDEX:
             ...
             */
            if ((SNMPERR_SUCCESS == rc) &&
                ((*var->val.integer < 1) || (*var->val.integer > 2147483647)))
            {
                rc = SNMP_ERR_WRONGVALUE;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL(
                    ("ipAddressTable:_ipAddressTable_check_column:"
                     "ipAddressIfIndex",
        ...
        case COLUMN_IPADDRESSTYPE:
            ...
            {
                DEBUGMSGTL((
                    "ipAddressTable:_ipAddressTable_check_column:ipAddressType",
                    "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
        ...
        case COLUMN_IPADDRESSROWSTATUS:
            ...
            {
                rc = ipAddressRowStatus_check_value(
        ...
        case COLUMN_IPADDRESSSTORAGETYPE:
            ...
            {
                rc = ipAddressStorageType_check_value(
                    rowreq_ctx, *((u_long*)var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) &&
                    (MFD_NOT_VALID_NOW != rc))
                {
...
int _mfd_ipAddressTable_check_objects(netsnmp_mib_handler* handler,
                                      netsnmp_handler_registration* reginfo,
                                      netsnmp_agent_request_info* agtreq_info,
                                      netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipAddressTable:_mfd_ipAddressTable_check_objects",
                "called\n"));
 ...
 */
static int _mfd_ipAddressTable_check_dependencies(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    int rc;
    ipAddressTable_rowreq_ctx* rowreq_ctx =
        (ipAddressTable_rowreq_ctx*)netsnmp_container_table_row_extract(
            requests);
    DEBUGMSGTL(
        ("internal:ipAddressTable:_mfd_ipAddressTable_check_dependencies",
         "called\n"));
                                      ...
                                      int column)
{
    ...
    DEBUGMSGTL(("internal:ipAddressTable:_ipAddressTable_undo_setup_column",
                "called for %d\n", column));
 ...
 * undo setup
 */
int _mfd_ipAddressTable_undo_setup(netsnmp_mib_handler* handler,
                                   netsnmp_handler_registration* reginfo,
                                   netsnmp_agent_request_info* agtreq_info,
                                   netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ipAddressTable:_mfd_ipAddressTable_undo_setup", "called\n"));
    ...
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _ipAddressTable_undo_setup_column(rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL(("ipAddressTable:mfd",
                            "error %d from "
 ...
 * undo setup
 */
int _mfd_ipAddressTable_undo_cleanup(netsnmp_mib_handler* handler,
                                     netsnmp_handler_registration* reginfo,
                                     netsnmp_agent_request_info* agtreq_info,
                                     netsnmp_request_info* requests)
{
                               ...
                               netsnmp_variable_list* var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPADDRESSSTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_IPADDRESSSTATUS_FLAG;
            rc = ipAddressStatus_set(rowreq_ctx, *((u_long*)var->val.string));
            break;
        ...
        case COLUMN_IPADDRESSROWSTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_IPADDRESSROWSTATUS_FLAG;
            rc =
                ipAddressRowStatus_set(rowreq_ctx, *((u_long*)var->val.string));
            break;
...
int _mfd_ipAddressTable_set_values(netsnmp_mib_handler* handler,
                                   netsnmp_handler_registration* reginfo,
                                   netsnmp_agent_request_info* agtreq_info,
                                   netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ipAddressTable:_mfd_ipAddressTable_set_values", "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipAddressTable_set_column(rowreq_ctx, requests->requestvb,
                                        tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL(("ipAddressTable:mfd",
 ...
 * commit the values
 */
int _mfd_ipAddressTable_commit(netsnmp_mib_handler* handler,
                               netsnmp_handler_registration* reginfo,
                               netsnmp_agent_request_info* agtreq_info,
                               netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ipAddressTable:_mfd_ipAddressTable_commit", "called\n"));
...
int _mfd_ipAddressTable_undo_commit(netsnmp_mib_handler* handler,
                                    netsnmp_handler_registration* reginfo,
                                    netsnmp_agent_request_info* agtreq_info,
                                    netsnmp_request_info* requests)
{
...
int _mfd_ipAddressTable_undo_values(netsnmp_mib_handler* handler,
                                    netsnmp_handler_registration* reginfo,
                                    netsnmp_agent_request_info* agtreq_info,
                                    netsnmp_request_info* requests)
{
 ...
 */
int _mfd_ipAddressTable_irreversible_commit(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipAddressTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:ipAddressTable:_mfd_ipAddressTable_irreversible:commit",
         "called\n"));
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
     ...
     * call user code
     */
    return ipAddressTable_container_load((netsnmp_container*)cache->magic);
} /* _cache_load */
 ...
 * @internal
 */
static void _container_item_free(ipAddressTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(("internal:ipAddressTable:_container_item_free", "called\n"));
...
{
    DEBUGMSGTL(
        ("internal:ipAddressTable:_ipAddressTable_container_init", "called\n"));
    ...
    if_ctx->cache = netsnmp_cache_create(
        ...
        _cache_load, _cache_free, ipAddressTable_oid, ipAddressTable_oid_size);
...
{
    DEBUGMSGTL(("internal:ipAddressTable:_ipAddressTable_container_shutdown",
                "called\n"));
    ...
    ipAddressTable_row_find_by_mib_index(ipAddressTable_mib_index* mib_idx)
{
    ...
    rowreq_ctx = (ipAddressTable_rowreq_ctx*)CONTAINER_FIND(
        ipAddressTable_if_ctx.container, &oid_idx);
