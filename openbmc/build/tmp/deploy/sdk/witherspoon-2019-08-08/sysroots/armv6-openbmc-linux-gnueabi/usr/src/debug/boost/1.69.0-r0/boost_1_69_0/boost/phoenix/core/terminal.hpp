...
#define BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(Template, Terminal, IsNullary,    \
                                             EvalFun)                          \
    namespace boost                                                            \
    {                                                                          \
    namespace phoenix                                                          \
    ...
    namespace result_of                                                        \
    {                                                                          \
    Template struct is_nullary<custom_terminal<Terminal>> : IsNullary          \
    {                                                                          \
    };                                                                         \
    }                                                                          \
    Template struct is_custom_terminal<Terminal> : mpl::true_                  \
    {                                                                          \
    };                                                                         \
                                                                               \
    Template struct custom_terminal<Terminal> : proto::call<EvalFun>           \
    {                                                                          \
    };                                                                         \
    }                                                                          \
    }                                                                          \
...
struct terminal : proto::terminal<T>
{
    typedef proto::basic_expr<proto::tag::terminal
                              // tag::terminal //cannot change to use phoenix
                              // tag - breaks code.
                              ,
                              proto::term<T>, 0>
        base_type;
...
namespace rule
{
struct argument : proto::if_<boost::is_placeholder<proto::_value>()>
{
};
...
struct terminal : proto::terminal<proto::_>
{
};
} // namespace rule
...
struct meta_grammar::case_<proto::tag::terminal, Dummy>
    : proto::or_<enable_rule<rule::argument, Dummy>,
...
{
template <typename N>
struct placeholder_idx : mpl::int_<N::value>
{
};
} // namespace detail
...
struct default_actions::when<rule::argument, Grammar>
    : proto::call<proto::functional::at(
          _env, proto::make<detail::placeholder_idx<
                    proto::make<boost::is_placeholder<proto::_value>()>>()>)>
{
};
} // namespace phoenix
} // namespace boost
