...
#define G_SIMPLE_PROXY_RESOLVER(o)                                             \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_SIMPLE_PROXY_RESOLVER,             \
                                GSimpleProxyResolver))
#define G_SIMPLE_PROXY_RESOLVER_CLASS(k)                                       \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_SIMPLE_PROXY_RESOLVER,                \
                             GSimpleProxyResolverClass))
#define G_IS_SIMPLE_PROXY_RESOLVER(o)                                          \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_SIMPLE_PROXY_RESOLVER))
#define G_IS_SIMPLE_PROXY_RESOLVER_CLASS(k)                                    \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_SIMPLE_PROXY_RESOLVER))
#define G_SIMPLE_PROXY_RESOLVER_GET_CLASS(o)                                   \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_SIMPLE_PROXY_RESOLVER,              \
                               GSimpleProxyResolverClass))
