...
#define _xdg_mime_cache_get_max_buffer_extents                                 \
    XDG_RESERVED_ENTRY(cache_get_max_buffer_extents)
#define _xdg_mime_cache_get_mime_type_for_data                                 \
    XDG_RESERVED_ENTRY(cache_get_mime_type_for_data)
#define _xdg_mime_cache_get_mime_type_for_file                                 \
    XDG_RESERVED_ENTRY(cache_get_mime_type_for_file)
...
#define _xdg_mime_cache_mime_type_subclass                                     \
    XDG_RESERVED_ENTRY(cache_mime_type_subclass)
#define _xdg_mime_cache_unalias_mime_type                                      \
    XDG_RESERVED_ENTRY(cache_unalias_mime_type)
#define _xdg_mime_cache_get_icon XDG_RESERVED_ENTRY(cache_get_icon)
#define _xdg_mime_cache_get_generic_icon                                       \
    XDG_RESERVED_ENTRY(cache_get_generic_icon)
