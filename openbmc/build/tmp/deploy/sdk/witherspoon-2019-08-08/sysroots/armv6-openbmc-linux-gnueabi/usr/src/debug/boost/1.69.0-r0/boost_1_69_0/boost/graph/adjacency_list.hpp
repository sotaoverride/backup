...
struct is_distributed_selector : mpl::false_
{
};
...
struct adjacency_list_traits
{
    ...
    typedef
        typename mpl::if_<is_rand_access, vertices_size_type, vertex_ptr>::type
            vertex_descriptor;
          ...
          VertexProperty>
{
  ...
  private:
    ...
    typedef typename detail::adj_list_gen<
        self, VertexListS, OutEdgeListS, DirectedS, vertex_property_type,
        edge_property_type, GraphProperty, EdgeListS>::type Base;
...
inline typename graph_property<ADJLIST, Tag>::type& get_property(ADJLIST& g,
                                                                 Tag tag)
{
