...
///
/// \brief Geneneric utf8 codecvt facet, it allows to convert UTF-8 strings to
...
class utf8_codecvt : public generic_codecvt<CharType, utf8_codecvt<CharType>>
{
  public:
    ...
    utf8_codecvt(size_t refs = 0) :
        generic_codecvt<CharType, utf8_codecvt<CharType>>(refs)
    {
    }
    ...
    static utf::code_point to_unicode(state_type&, char const*& begin,
                                      char const* end)
    {
        char const* p = begin;
    ...
    static utf::code_point from_unicode(state_type&, utf::code_point u,
                                        char* begin, char const* end)
    {
