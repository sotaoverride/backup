                             ...
                             int prediction_resistance)
{
    ...
    {
        size_t bytes_needed =
            rand_pool_bytes_needed(pool, 1 /*entropy_factor*/);
        ...
        if (buffer != NULL)
        {
            ...
            if (RAND_DRBG_generate(drbg->parent, buffer, bytes_needed,
                                   prediction_resistance, NULL, 0) != 0)
                bytes = bytes_needed;
...
int RAND_poll(void)
{
    ...
    else
    {
        ...
        pool = rand_pool_new(RAND_DRBG_STRENGTH, (RAND_DRBG_STRENGTH + 7) / 8,
        ...
        if (meth->add == NULL ||
            meth->add(rand_pool_buffer(pool), rand_pool_length(pool),
...
RAND_POOL* rand_pool_new(int entropy_requested, size_t min_len, size_t max_len)
{
    ...
    pool->max_len =
        (max_len > RAND_POOL_MAX_LENGTH) ? RAND_POOL_MAX_LENGTH : max_len;
