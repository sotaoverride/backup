...
static inline krb5_boolean filename_is_cache(const char* filename)
{
    return (strncmp(filename, "tkt", 3) == 0);
}

/* Compose the pathname of the primary file within a cache directory. */
static inline krb5_error_code primary_pathname(const char* dirname,
                                               char** path_out)
{
 ...
 * name and filename. */
static krb5_error_code subsidiary_residual(const char* dirname,
...
static inline krb5_error_code split_path(krb5_context context, const char* path,
                                         char** dirname_out,
                                         char** filename_out)
{
    krb5_error_code ret;
...
static krb5_error_code read_primary_file(krb5_context context,
                                         ...
                                         char** residual_out)
{
    ...
    *residual_out = NULL;
    ...
    if (buf[len - 1] != '\n' || !filename_is_cache(buf) || strchr(buf, '/') ||
        strchr(buf, '\\'))
    {
...
static krb5_error_code write_primary_file(const char* primary_path,
                                          const char* contents)
{
...
static krb5_error_code verify_dir(krb5_context context, const char* dirname)
{
    struct stat st;
    ...
    if (stat(dirname, &st) < 0)
    {
        ...
        k5_setmsg(context, KRB5_FCC_NOFILE,
                  _("Credential cache directory %s does not exist"), dirname);
 ...
 * *dirname_out to NULL.
 */
static krb5_error_code get_context_default_dir(krb5_context context,
                                               char** dirname_out)
{
    const char* defname;
    char* dirname;
 ...
 */
static krb5_error_code get_context_subsidiary_file(krb5_context context,
                                                   char** subsidiary_out)
{
    const char* defname;
    char* residual;
...
static const char* KRB5_CALLCONV dcc_get_name(krb5_context context,
                                              krb5_ccache cache)
{
...
static krb5_error_code make_cache(const char* residual, krb5_ccache fcc,
...
static krb5_error_code KRB5_CALLCONV dcc_resolve(krb5_context context,
                                                 krb5_ccache* cache_out,
                                                 const char* residual)
{
    krb5_error_code ret;
...
static krb5_error_code KRB5_CALLCONV dcc_gen_new(krb5_context context,
                                                 krb5_ccache* cache_out)
{
    krb5_error_code ret;
...
static krb5_error_code KRB5_CALLCONV dcc_init(krb5_context context,
                                              krb5_ccache cache,
...
static krb5_error_code KRB5_CALLCONV dcc_destroy(krb5_context context,
                                                 krb5_ccache cache)
{
    dcc_data* data = cache->data;
    krb5_error_code ret;
...
static krb5_error_code KRB5_CALLCONV dcc_close(krb5_context context,
                                               krb5_ccache cache)
{
    dcc_data* data = cache->data;
    krb5_error_code ret;
...
static krb5_error_code KRB5_CALLCONV dcc_store(krb5_context context,
                                               krb5_ccache cache,
                                               krb5_creds* creds)
{
    dcc_data* data = cache->data;
...
static krb5_error_code KRB5_CALLCONV dcc_retrieve(krb5_context context,
                                                  krb5_ccache cache,
                                                  krb5_flags flags,
                                                  krb5_creds* mcreds,
                                                  krb5_creds* creds)
{
    ...
    return krb5_fcc_ops.retrieve(context, data->fcc, flags, mcreds, creds);
}

static krb5_error_code KRB5_CALLCONV dcc_get_princ(krb5_context context,
                                                   krb5_ccache cache,
...
static krb5_error_code KRB5_CALLCONV dcc_get_first(krb5_context context,
                                                   krb5_ccache cache,
...
static krb5_error_code KRB5_CALLCONV dcc_get_next(krb5_context context,
                                                  krb5_ccache cache,
                                                  krb5_cc_cursor* cursor,
                                                  krb5_creds* creds)
{
...
static krb5_error_code KRB5_CALLCONV dcc_end_get(krb5_context context,
                                                 krb5_ccache cache,
                                                 krb5_cc_cursor* cursor)
{
    dcc_data* data = cache->data;
...
static krb5_error_code KRB5_CALLCONV dcc_remove_cred(krb5_context context,
                                                     krb5_ccache cache,
                                                     krb5_flags flags,
                                                     krb5_creds* creds)
{
...
static krb5_error_code KRB5_CALLCONV dcc_set_flags(krb5_context context,
                                                   krb5_ccache cache,
                                                   krb5_flags flags)
{
    dcc_data* data = cache->data;
...
static krb5_error_code KRB5_CALLCONV dcc_get_flags(krb5_context context,
                                                   krb5_ccache cache,
 ...
 * success. */
static krb5_error_code make_cursor(char* dirname, char* primary, DIR* dir,
...
static krb5_error_code KRB5_CALLCONV dcc_ptcursor_next(krb5_context context,
                                                       krb5_cc_ptcursor cursor,
                                                       krb5_ccache* cache_out)
{
...
static krb5_error_code KRB5_CALLCONV dcc_ptcursor_free(krb5_context context,
                                                       krb5_cc_ptcursor* cursor)
{
    struct dcc_ptcursor_data* data = (*cursor)->data;
...
static krb5_error_code KRB5_CALLCONV dcc_lastchange(krb5_context context,
                                                    krb5_ccache cache,
...
static krb5_error_code KRB5_CALLCONV dcc_lock(krb5_context context,
                                              krb5_ccache cache)
{
    dcc_data* data = cache->data;
...
static krb5_error_code KRB5_CALLCONV dcc_unlock(krb5_context context,
                                                krb5_ccache cache)
{
    dcc_data* data = cache->data;
...
static krb5_error_code KRB5_CALLCONV dcc_switch_to(krb5_context context,
                                                   krb5_ccache cache)
{
    dcc_data* data = cache->data;
