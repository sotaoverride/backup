...
struct equal_to
{
    ...
    enum
    {
        x = (BOOST_MPL_AUX_VALUE_WKND(T1)::value ==
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_MPL_AUX_VALUE_WKND(T1)::value ==
                                         BOOST_MPL_AUX_VALUE_WKND(T2)::value));

    typedef mpl::bool_<(BOOST_MPL_AUX_VALUE_WKND(T1)::value ==
                        BOOST_MPL_AUX_VALUE_WKND(T2)::value)>
        type;
#endif
};
...
//
template <class Value, class Case0Val, class Case1Val, class Case2Val,
          class Case0Type, class Case1Type, class Case2Type, class DefaultType>
struct ct_switch4
{
    ...
    typedef
        typename mpl::eval_if<is_case0, Case0TypeQ, choose_1_2_3Q>::type type;
};
...
//
// According to the combined boolean value of 'expr0 && expr1', selects the
// corresponding type.
//
