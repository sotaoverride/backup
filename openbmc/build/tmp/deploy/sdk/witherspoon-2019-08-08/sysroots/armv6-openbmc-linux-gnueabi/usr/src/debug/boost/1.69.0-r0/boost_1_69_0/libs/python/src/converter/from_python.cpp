...
BOOST_PYTHON_DECL void*
    rvalue_result_from_python(PyObject* src,
                              rvalue_from_python_stage1_data& data)
{
...
BOOST_PYTHON_DECL void*
    rvalue_from_python_stage2(PyObject* source,
                              rvalue_from_python_stage1_data& data,
                              registration const& converters)
{
    if (!data.convertible)
    {
        handle<> msg(
            ...
            ("No registered converter was able to produce a C++ rvalue of type "
             "%s from this Python object of type %s",
...
BOOST_PYTHON_DECL bool
    implicit_rvalue_convertible_from_python(PyObject* source,
                                            registration const& converters)
{
...
BOOST_PYTHON_DECL void
    throw_no_pointer_from_python(PyObject* source,
                                 registration const& converters)
{
...
BOOST_PYTHON_DECL void
    throw_no_reference_from_python(PyObject* source,
                                   registration const& converters)
{
...
BOOST_PYTHON_DECL void*
    reference_result_from_python(PyObject* source,
                                 registration const& converters)
{
...
BOOST_PYTHON_DECL void*
    pointer_result_from_python(PyObject* source, registration const& converters)
{
    if (source == Py_None)
    {
        Py_DECREF(source);
...
BOOST_PYTHON_DECL PyObject* pytype_check(PyTypeObject* type_, PyObject* source)
{
