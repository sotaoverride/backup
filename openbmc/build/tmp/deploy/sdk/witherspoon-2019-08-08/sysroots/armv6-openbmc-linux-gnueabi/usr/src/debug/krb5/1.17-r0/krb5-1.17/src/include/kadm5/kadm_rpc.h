...
extern enum clnt_stat create_principal_2(cprinc_arg*, generic_ret*, CLIENT*);
extern bool_t create_principal_2_svc(cprinc_arg*, generic_ret*,
                                     struct svc_req*);
#define DELETE_PRINCIPAL 2
extern enum clnt_stat delete_principal_2(dprinc_arg*, generic_ret*, CLIENT*);
extern bool_t delete_principal_2_svc(dprinc_arg*, generic_ret*,
                                     struct svc_req*);
#define MODIFY_PRINCIPAL 3
extern enum clnt_stat modify_principal_2(mprinc_arg*, generic_ret*, CLIENT*);
extern bool_t modify_principal_2_svc(mprinc_arg*, generic_ret*,
                                     struct svc_req*);
#define RENAME_PRINCIPAL 4
extern enum clnt_stat rename_principal_2(rprinc_arg*, generic_ret*, CLIENT*);
...
extern bool_t get_principal_2_svc(gprinc_arg*, gprinc_ret*, struct svc_req*);
#define CHPASS_PRINCIPAL 6
extern enum clnt_stat chpass_principal_2(chpass_arg*, generic_ret*, CLIENT*);
extern bool_t chpass_principal_2_svc(chpass_arg*, generic_ret*,
                                     struct svc_req*);
#define CHRAND_PRINCIPAL 7
extern enum clnt_stat chrand_principal_2(chrand_arg*, chrand_ret*, CLIENT*);
extern bool_t chrand_principal_2_svc(chrand_arg*, chrand_ret*, struct svc_req*);
#define CREATE_POLICY 8
extern enum clnt_stat create_policy_2(cpol_arg*, generic_ret*, CLIENT*);
extern bool_t create_policy_2_svc(cpol_arg*, generic_ret*, struct svc_req*);
#define DELETE_POLICY 9
extern enum clnt_stat delete_policy_2(dpol_arg*, generic_ret*, CLIENT*);
extern bool_t delete_policy_2_svc(dpol_arg*, generic_ret*, struct svc_req*);
#define MODIFY_POLICY 10
extern enum clnt_stat modify_policy_2(mpol_arg*, generic_ret*, CLIENT*);
extern bool_t modify_policy_2_svc(mpol_arg*, generic_ret*, struct svc_req*);
...
extern bool_t get_princs_2_svc(gprincs_arg*, gprincs_ret*, struct svc_req*);
#define GET_POLS 15
...
extern enum clnt_stat setkey_principal_2(setkey_arg*, generic_ret*, CLIENT*);
...
extern enum clnt_stat create_principal3_2(cprinc3_arg*, generic_ret*, CLIENT*);
extern bool_t create_principal3_2_svc(cprinc3_arg*, generic_ret*,
                                      struct svc_req*);
#define CHPASS_PRINCIPAL3 19
extern enum clnt_stat chpass_principal3_2(chpass3_arg*, generic_ret*, CLIENT*);
extern bool_t chpass_principal3_2_svc(chpass3_arg*, generic_ret*,
                                      struct svc_req*);
#define CHRAND_PRINCIPAL3 20
extern enum clnt_stat chrand_principal3_2(chrand3_arg*, chrand_ret*, CLIENT*);
extern bool_t chrand_principal3_2_svc(chrand3_arg*, chrand_ret*,
                                      struct svc_req*);
#define SETKEY_PRINCIPAL3 21
extern enum clnt_stat setkey_principal3_2(setkey3_arg*, generic_ret*, CLIENT*);
...
extern bool_t purgekeys_2_svc(purgekeys_arg*, generic_ret*, struct svc_req*);
#define GET_STRINGS 23
extern enum clnt_stat get_strings_2(gstrings_arg*, gstrings_ret*, CLIENT*);
extern bool_t get_strings_2_svc(gstrings_arg*, gstrings_ret*, struct svc_req*);
#define SET_STRING 24
extern enum clnt_stat set_string_2(sstring_arg*, generic_ret*, CLIENT*);
extern bool_t set_string_2_svc(sstring_arg*, generic_ret*, struct svc_req*);
#define SETKEY_PRINCIPAL4 25
extern enum clnt_stat setkey_principal4_2(setkey4_arg*, generic_ret*, CLIENT*);
