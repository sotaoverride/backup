...
typedef int (*sd_resolve_getaddrinfo_handler_t)(sd_resolve_query* q, int ret,
                                                ...
                                                void* userdata);
typedef int (*sd_resolve_getnameinfo_handler_t)(sd_resolve_query* q, int ret,
                                                const char* host,
                                                const char* serv,
                                                void* userdata);
...
int sd_resolve_getaddrinfo(sd_resolve* resolve, sd_resolve_query** q,
...
int sd_resolve_getnameinfo(sd_resolve* resolve, sd_resolve_query** q,
...
int sd_resolve_query_get_destroy_callback(
    sd_resolve_query* q, sd_resolve_destroy_t* destroy_callback);
int sd_resolve_query_set_destroy_callback(
    sd_resolve_query* q, sd_resolve_destroy_t destroy_callback);
