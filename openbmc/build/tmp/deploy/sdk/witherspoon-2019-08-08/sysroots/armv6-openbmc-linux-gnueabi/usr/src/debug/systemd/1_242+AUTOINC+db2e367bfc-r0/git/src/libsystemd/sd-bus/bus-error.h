...
#define BUS_ERROR_OOM                                                          \
    SD_BUS_ERROR_MAKE_CONST(SD_BUS_ERROR_NO_MEMORY, "Out of memory")
#define BUS_ERROR_FAILED                                                       \
    SD_BUS_ERROR_MAKE_CONST(SD_BUS_ERROR_FAILED, "Operation failed")
...
#define BUS_ERROR_MAP_ELF_REGISTER                                             \
    _section_("SYSTEMD_BUS_ERROR_MAP")                                         \
        _used_ _alignptr_ _variable_no_sanitize_address_

#define BUS_ERROR_MAP_ELF_USE(errors)                                          \
    extern const sd_bus_error_map errors[];                                    \
    _used_ static const sd_bus_error_map* const CONCATENATE(                   \
        errors##_copy_, __COUNTER__) = errors;
