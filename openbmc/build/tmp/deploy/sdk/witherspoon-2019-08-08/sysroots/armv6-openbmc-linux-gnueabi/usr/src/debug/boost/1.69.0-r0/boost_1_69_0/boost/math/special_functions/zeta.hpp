...
inline T zeta_imp_prec(T s, T sc, const Policy&, const mpl::int_<53>&)
{
    ...
    if (s < 1)
    {
        ...
        result = tools::evaluate_polynomial(P, sc) /
                 tools::evaluate_polynomial(Q, sc);
    ...
    else if (s <= 2)
    {
        ...
        result = tools::evaluate_polynomial(P, T(-sc)) /
                 tools::evaluate_polynomial(Q, T(-sc));
        result += 1 / (-sc);
    }
    else if (s <= 4)
    {
        ...
        result = tools::evaluate_polynomial(P, T(s - 2)) /
                 tools::evaluate_polynomial(Q, T(s - 2));
        result += Y + 1 / (-sc);
    }
    else if (s <= 7)
    {
        ...
        result = tools::evaluate_polynomial(P, T(s - 4)) /
                 tools::evaluate_polynomial(Q, T(s - 4));
        result = 1 + exp(result);
    }
    else if (s < 15)
    {
        ...
        result = tools::evaluate_polynomial(P, T(s - 7)) /
                 tools::evaluate_polynomial(Q, T(s - 7));
        result = 1 + exp(result);
    }
    else if (s < 36)
    {
        ...
        result = tools::evaluate_polynomial(P, T(s - 15)) /
                 tools::evaluate_polynomial(Q, T(s - 15));
        result = 1 + exp(result);
    }
    else if (s < 56)
    {
...
T zeta_imp_prec(T s, T sc, const Policy&, const mpl::int_<113>&)
{
    ...
    if (s < 1)
    {
        ...
        static const T P[10] = {
            ...
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0107795651204927743049369868548706909),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.000523961870530500751114866884685172975),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.661805838304910731947595897966487515e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.658932670403818558510656304189164638e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.103437265642266106533814021041010453e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.116818787212666457105375746642927737e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.660690993901506912123512551294239036e-9),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.113103113698388531428914333768142527e-10),
        };
        static const T Q[11] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.387483472099602327112637481818565459),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0802265315091063135271497708694776875),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0110727276164171919280036408995078164),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.00112552716946286252000434849173787243),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.874554160748626916455655180296834352e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.530097847491828379568636739662278322e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.248461553590496154705565904497247452e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.881834921354014787309644951507523899e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.217062446168217797598596496310953025e-9),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.315823200002384492377987848307151168e-11),
        };
        result = tools::evaluate_polynomial(P, sc) /
                 tools::evaluate_polynomial(Q, sc);
        result += (sc);
    ...
    else if (s <= 2)
    {
        ...
        static const T P[10] = {
            ...
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.268562259154821957743669387915239528e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.109249633923016310141743084480436612e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.273895554345300227466534378753023924e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.583103205551702720149237384027795038e-9),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.835774625259919268768735944711219256e-11),
        };
        static const T Q[11] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.316661751179735502065583176348292881),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0540401806533507064453851182728635272),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.00598621274107420237785899476374043797),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.000474907812321704156213038740142079615),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.272125421722314389581695715835862418e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.112649552156479800925522445229212933e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.301838975502992622733000078063330461e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.422960728687211282539769943184270106e-9),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.377105263588822468076813329270698909e-11),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.581926559304525152432462127383600681e-13),
        };
        result = tools::evaluate_polynomial(P, T(-sc)) /
                 tools::evaluate_polynomial(Q, T(-sc));
        result += 1 / (-sc);
    ...
    else if (s <= 4)
    {
        ...
        static const T P[11] = {
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0537258300023595010275848333539748089),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0429086930802630159457448174466342553),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0136148228754303412510213395034056857),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.00190231601036042925183751238033763915),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.000186880390916311438818302549192456581),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.145347370745893262394287982691323657e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.805843276446813106414036600485884885e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.340818159286739137503297172091882574e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.115762357488748996526167305116837246e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.231904754577648077579913403645767214e-10),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.340169592866058506675897646629036044e-12),
        };
        static const T Q[12] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
            ...
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0696581979014242539385695131258321598),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.00882208914484611029571547753782014817),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.000815405623261946661762236085660996718),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.571366167062457197282642344940445452e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.309278269271853502353954062051797838e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.12822982083479010834070516053794262e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.397876357325018976733953479182110033e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.8484432107648683277598472295289279e-10),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.105677416606909614301995218444080615e-11),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.547223964564003701979951154093005354e-15),
        };
        result = tools::evaluate_polynomial(P, T(s - 2)) /
                 tools::evaluate_polynomial(Q, T(s - 2));
        result += Y + 1 / (-sc);
    ...
    else if (s <= 6)
    {
        ...
        static const T P[13] = {
            ...
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.495766593395271370974685959652073976),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.409116737851754766422360889037532228),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.57340744006238263817895456842655987),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.280479899797421910694892949057963111),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0753148409447590257157585696212649869),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0122934003684672788499099362823748632),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.00126148398446193639247961370266962927),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.828465038179772939844657040917364896e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.361008916706050977143208468690645684e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.109879825497910544424797771195928112e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.214539416789686920918063075528797059e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.15090220092460596872172844424267351e-10),
        };
        static const T Q[14] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1.69490865837142338462982225731926485),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    1.22697696630994080733321401255942464),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.495409420862526540074366618006341533),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.122368084916843823462872905024259633),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0191412993625268971656513890888208623),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.00191401538628980617753082598351559642),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.000123318142456272424148930280876444459),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.531945488232526067889835342277595709e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.161843184071894368337068779669116236e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.305796079600152506743828859577462778e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.233582592298450202680170811044408894e-10),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.275363878344548055574209713637734269e-13),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.221564186807357535475441900517843892e-15),
        };
        result = tools::evaluate_polynomial(P, T(s - 4)) /
                 tools::evaluate_polynomial(Q, T(s - 4));
        result -= Y;
    ...
    else if (s < 10)
    {
        ...
        static const T P[13] = {
            ...
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -4.70088348734699134347906176097717782),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -2.36921550900925512951976617607678789),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.684322583796369508367726293719322866),
            BOOST_MATH_BIG_CONSTANT(T, 113,
            ...
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.842793965853572134365031384646117061e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.385602133791111663372015460784978351e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.130458500394692067189883214401478539e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.315861074947230418778143153383660035e-8),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.500334720512030826996373077844707164e-10),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.420204769185233365849253969097184005e-12),
        };
        static const T Q[14] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.97663511666410096104783358493318814),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.40878780231201806504987368939673249),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0963890666609396058945084107597727252),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0142207619090854604824116070866614505),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.00139010220902667918476773423995750877),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.940669540194694997889636696089994734e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.458220848507517004399292480807026602e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.16345521617741789012782420625435495e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.414007452533083304371566316901024114e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.68701473543366328016953742622661377e-10),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.603461891080716585087883971886075863e-12),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.294670713571839023181857795866134957e-16),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.147003914536437243143096875069813451e-18),
        };
        result = tools::evaluate_polynomial(P, T(s - 6)) /
                 tools::evaluate_polynomial(Q, T(s - 6));
        result = 1 + exp(result);
    }
    else if (s < 17)
    {
        ...
        static const T P[13] = {
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -6.91319491921722925920883787894829678),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -3.65491257639481960248690596951049048),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.813557553449954526442644544105257881),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0994317301685870959473658713841138083),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.00726896610245676520248617014211734906),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.000317253318715075854811266230916762929),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.66851422826636750855184211580127133e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.879464154730985406003332577806849971e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.113838903158254250631678791998294628e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.379184410304927316385211327537817583e-9),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.612992858643904887150527613446403867e-11),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.347873737198164757035457841688594788e-13),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.289187187441625868404494665572279364e-15),
        };
        static const T Q[14] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
            ...
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.00688651562174480772901425121653945942),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.000360174847635115036351323894321880445),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.973556847713307543918865405758248777e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.853455848314516117964634714780874197e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.118203513654855112421673192194622826e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.462521662511754117095006543363328159e-9),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.834212591919475633107355719369463143e-11),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.5354594751002702935740220218582929e-13),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.406451690742991192964889603000756203e-15),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.887948682401000153828241615760146728e-19),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.34980761098820347103967203948619072e-21),
        };
        result = tools::evaluate_polynomial(P, T(s - 10)) /
                 tools::evaluate_polynomial(Q, T(s - 10));
        result = 1 + exp(result);
    }
    else if (s < 30)
    {
        ...
        static const T P[13] = {
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -11.7824798233959252791987402769438322),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -4.36131215284987731928174218354118102),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.732260980060982349410898496846972204),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0744985185694913074484248803015717388),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.00517228281320594683022294996292250527),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.000260897206152101522569969046299309939),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.989553462123121764865178453128769948e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.286916799741891410827712096608826167e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.637262477796046963617949532211619729e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.106796831465628373325491288787760494e-9),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.129343095511091870860498356205376823e-11),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.102397936697965977221267881716672084e-13),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.402663128248642002351627980255756363e-16),
        };
        static const T Q[14] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.311288325355705609096155335186466508),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0438318468940415543546769437752132748),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.00374396349183199548610264222242269536),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.000218707451200585197339671707189281302),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.927578767487930747532953583797351219e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.294145760625753561951137473484889639e-6),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.704618586690874460082739479535985395e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.126333332872897336219649130062221257e-9),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.16317315713773503718315435769352765e-11),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.137846712823719515148344938160275695e-13),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.580975420554224366450994232723910583e-16),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.291354445847552426900293580511392459e-22),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.73614324724785855925025452085443636e-25),
        };
        result = tools::evaluate_polynomial(P, T(s - 17)) /
                 tools::evaluate_polynomial(Q, T(s - 17));
        result = 1 + exp(result);
    }
    else if (s < 74)
    {
        ...
        static const T P[14] = {
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -20.7944102007844314586649688802236072),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -4.95759941987499442499908748130192187),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.563290752832461751889194629200298688),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0406197001137935911912457120706122877),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.0020846534789473022216888863613422293),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.808095978462109173749395599401375667e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.244706022206249301640890603610060959e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.589477682919645930544382616501666572e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    -0.113699573675553496343617442433027672e-8),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.174767860183598149649901223128011828e-10),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.210051620306761367764549971980026474e-12),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.189187969537370950337212675466400599e-14),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.116313253429564048145641663778121898e-16),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.376708747782400769427057630528578187e-19),
        };
        static const T Q[16] = {
            BOOST_MATH_BIG_CONSTANT(T, 113, 1.0),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.205076752981410805177554569784219717),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.0202526722696670378999575738524540269),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.001278305290005994980069466658219057),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.576404779858501791742255670403304787e-4),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.196477049872253010859712483984252067e-5),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.521863830500876189501054079974475762e-7),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.109524209196868135198775445228552059e-8),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.181698713448644481083966260949267825e-10),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.234793316975091282090312036524695562e-12),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.227490441461460571047545264251399048e-14),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.151500292036937400913870642638520668e-16),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.543475775154780935815530649335936121e-19),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.241647013434111434636554455083309352e-28),
            BOOST_MATH_BIG_CONSTANT(
                T, 113, -0.557103423021951053707162364713587374e-31),
            BOOST_MATH_BIG_CONSTANT(T, 113,
                                    0.618708773442584843384712258199645166e-34),
        };
        result = tools::evaluate_polynomial(P, T(s - 30)) /
                 tools::evaluate_polynomial(Q, T(s - 30));
        result = 1 + exp(result);
    }
    else if (s < 117)
    {
...
T zeta_imp_odd_integer(int s, const T&, const Policy&, const mpl::true_&)
{
    static const T results[] = {
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.2020569031595942853997381615114500),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0369277551433699263313654864570342),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0083492773819228268397975498497968),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0020083928260822144178527692324121),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0004941886041194645587022825264699),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0001227133475784891467518365263574),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000305882363070204935517285106451),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000076371976378997622736002935630),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000019082127165539389256569577951),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000004769329867878064631167196044),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000001192199259653110730677887189),
        ...
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000004656629065033784072989233),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000001164155017270051977592974),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000291038504449709968692943),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000072759598350574810145209),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000018189896503070659475848),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000004547473783042154026799),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000001136868407680227849349),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000284217097688930185546),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000071054273952108527129),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000017763568435791203275),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000004440892103143813364),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000001110223025141066134),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000277555756213612417),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000069388939045441537),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000017347234760475766),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000004336808690020650),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000001084202172494241),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000271050543122347),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000067762635780452),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000016940658945098),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000004235164736273),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000001058791184068),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000264697796017),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000066174449004),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000016543612251),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000004135903063),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000001033975766),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000258493941),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000064623485),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000016155871),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000004038968),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000001009742),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000252435),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000063109),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000015777),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000003944),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000000986),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000000247),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000000062),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000000015),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000000004),
        BOOST_MATH_BIG_CONSTANT(T, 113, 1.0000000000000000000000000000000001),
    };
    return s > 113 ? 1 : results[(s - 3) / 2];
}

template <class T, class Policy>
T zeta_imp_odd_integer(int s, const T& sc, const Policy& pol,
                       const mpl::false_&)
{
    ...
    return index >= sizeof(results) / sizeof(results[0])
               ? zeta_polynomial_series(T(s), sc, pol)
               : results[index];
}
...
T zeta_imp(T s, T sc, const Policy& pol, const Tag& tag)
{
    ...
    if (sc == 0)
        return policies::raise_pole_error<T>(
            function, "Evaluation of zeta function at pole %1%", s, pol);
    T result;
    //
    // Trivial case:
    //
            ...
            if (v == s)
            {
                if (v < 0)
                {
                    ...
                    if (n <= (int)boost::math::max_bernoulli_b2n<T>::value)
                        return T((-v & 1) ? -1 : 1) *
                               boost::math::unchecked_bernoulli_b2n<T>(n) /
                               (1 - v);
                }
                else if ((v & 1) == 0)
                {
                    if (((v / 2) <=
                         (int)boost::math::max_bernoulli_b2n<T>::value) &&
                        (v <= (int)boost::math::max_factorial<T>::value))
                        return T(((v / 2 - 1) & 1) ? -1 : 1) *
                               ldexp(T(1), v - 1) *
                               pow(constants::pi<T, Policy>(), v) *
                               boost::math::unchecked_bernoulli_b2n<T>(v / 2) /
                               boost::math::unchecked_factorial<T>(v);
                    return T(((v / 2 - 1) & 1) ? -1 : 1) * ldexp(T(1), v - 1) *
                           pow(constants::pi<T, Policy>(), v) *
                           boost::math::bernoulli_b2n<T>(v / 2) /
                           boost::math::factorial<T>(v);
                }
                else
                    return zeta_imp_odd_integer(
                        v, sc, pol,
                        mpl::bool_ < (Tag::value <= 113) && Tag::value > ());
            }
#ifndef BOOST_NO_EXCEPTIONS
        }
        catch (const boost::math::rounding_error&)
        {
        } // Just fall through, s is too large to round
    ...
    else if (s < 0)
    {
        ...
        else
        {
            ...
            {
                T mult = boost::math::sin_pi(0.5f * sc, pol) * 2 *
                ...
                if (tools::max_value<T>() / fabs(mult) < result)
                    return boost::math::sign(mult) *
                           policies::raise_overflow_error<T>(function, 0, pol);
                result *= mult;
            }
            else
            {
                result = boost::math::sin_pi(0.5f * sc, pol) * 2 *
                         pow(2 * constants::pi<T>(), -s) *
...
template <class T, class Policy, class tag>
const typename zeta_initializer<T, Policy, tag>::init
    zeta_initializer<T, Policy, tag>::initializer;
...
inline typename tools::promote_args<T>::type zeta(T s, const Policy&)
{
    ...
    detail::zeta_initializer<value_type, forwarding_policy,
