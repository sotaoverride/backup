 ...
 * a specific style.
 */
typedef FT_Error (*AF_WritingSystem_InitMetricsFunc)(AF_StyleMetrics metrics,
                                                     FT_Face face);

typedef void (*AF_WritingSystem_ScaleMetricsFunc)(AF_StyleMetrics metrics,
                                                  AF_Scaler scaler);

typedef void (*AF_WritingSystem_DoneMetricsFunc)(AF_StyleMetrics metrics);

typedef void (*AF_WritingSystem_GetStdWidthsFunc)(AF_StyleMetrics metrics,
                                                  FT_Pos* stdHW, FT_Pos* stdVW);

typedef FT_Error (*AF_WritingSystem_InitHintsFunc)(AF_GlyphHints hints,
                                                   AF_StyleMetrics metrics);

typedef FT_Error (*AF_WritingSystem_ApplyHintsFunc)(FT_UInt glyph_index,
                                                    AF_GlyphHints hints,
                                                    FT_Outline* outline,
                                                    AF_StyleMetrics metrics);
...
#define AF_DEFINE_WRITING_SYSTEM_CLASS(writing_system_class, system, m_size,   \
...
#define AF_DECLARE_SCRIPT_CLASS(script_class)                                  \
    FT_CALLBACK_TABLE const AF_ScriptClassRec script_class;

#define AF_DEFINE_SCRIPT_CLASS(script_class, script, ranges, nonbase_ranges,   \
                               top_to_bottom, std_charstring)                  \
    FT_CALLBACK_TABLE_DEF                                                      \
...
#define AF_DECLARE_STYLE_CLASS(style_class)                                    \
    FT_CALLBACK_TABLE const AF_StyleClassRec style_class;

#define AF_DEFINE_STYLE_CLASS(style_class, style, writing_system, script,      \
                              blue_stringset, coverage)                        \
    FT_CALLBACK_TABLE_DEF                                                      \
    const AF_StyleClassRec style_class = {style, writing_system, script,       \
                                          blue_stringset, coverage};
