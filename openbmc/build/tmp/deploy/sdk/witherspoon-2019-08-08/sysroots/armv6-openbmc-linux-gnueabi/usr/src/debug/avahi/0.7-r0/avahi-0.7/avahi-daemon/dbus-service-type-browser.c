...
void avahi_dbus_service_type_browser_free(ServiceTypeBrowserInfo* i)
{
    ...
    AVAHI_LLIST_REMOVE(ServiceTypeBrowserInfo, service_type_browsers,
                       i->client->service_type_browsers, i);
                                                           ...
                                                           void* userdata)
{
    ...
    if (dbus_message_is_method_call(m, DBUS_INTERFACE_INTROSPECTABLE,
        ...
        return avahi_dbus_handle_introspect(
            c, m, "org.freedesktop.Avahi.ServiceTypeBrowser.xml");
    ...
    if (dbus_message_is_method_call(
            m, AVAHI_DBUS_INTERFACE_SERVICE_TYPE_BROWSER, "Free"))
    {
    ...
    AvahiLookupResultFlags flags, void* userdata)
{
    ...
    m = dbus_message_new_signal(i->path,
