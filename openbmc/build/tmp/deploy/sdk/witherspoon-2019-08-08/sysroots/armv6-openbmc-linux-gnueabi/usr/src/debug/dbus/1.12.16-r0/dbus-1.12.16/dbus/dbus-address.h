...
/**
 * Clear a variable or struct member that contains an array of
 * #DBusAddressEntry. If it does not contain #NULL, the entries that were
 * previously there are freed with dbus_address_entries_free().
 *
