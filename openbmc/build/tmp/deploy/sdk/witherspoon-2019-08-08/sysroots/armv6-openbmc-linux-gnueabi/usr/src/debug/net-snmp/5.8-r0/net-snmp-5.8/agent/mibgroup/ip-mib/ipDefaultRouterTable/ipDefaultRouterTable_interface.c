...
netsnmp_feature_require(row_merge) netsnmp_feature_require(baby_steps)
...
static void _ipDefaultRouterTable_container_init(
    ipDefaultRouterTable_interface_ctx* if_ctx);
static void _ipDefaultRouterTable_container_shutdown(
    ipDefaultRouterTable_interface_ctx* if_ctx);
...
ipDefaultRouterTable_registration* ipDefaultRouterTable_registration_get(void)
{
    return ipDefaultRouterTable_if_ctx.user_ctx;
}

ipDefaultRouterTable_registration* ipDefaultRouterTable_registration_set(
 ...
 */
void _ipDefaultRouterTable_initialize_interface(
    ipDefaultRouterTable_registration* reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:ipDefaultRouterTable:_ipDefaultRouterTable_"
 ...
 */
void _ipDefaultRouterTable_shutdown_interface(
    ipDefaultRouterTable_registration* reg_ptr)
{
    /*
...
void ipDefaultRouterTable_valid_columns_set(netsnmp_column_info* vc)
{
 ...
 */
int ipDefaultRouterTable_index_to_oid(netsnmp_index* oid_idx,
                                      ipDefaultRouterTable_mib_index* mib_idx)
{
     ...
     */
    var_ipDefaultRouterAddressType.next_variable = &var_ipDefaultRouterAddress;
    var_ipDefaultRouterAddress.next_variable = &var_ipDefaultRouterIfIndex;
    var_ipDefaultRouterIfIndex.next_variable = NULL;

    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_index_to_oid",
         "called\n"));
 ...
 */
int ipDefaultRouterTable_index_from_oid(netsnmp_index* oid_idx,
                                        ipDefaultRouterTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL(
        ("verbose:ipDefaultRouterTable:ipDefaultRouterTable_index_from_oid",
         "called\n"));
                                             ...
                                             void* user_init_ctx)
{
    ...
    DEBUGMSGTL(("internal:ipDefaultRouterTable:ipDefaultRouterTable_allocate_"
                "rowreq_ctx",
                "called\n"));
    ...
    else
    {
        if (NULL != data)
        {
            ...
            rowreq_ctx->data = data;
                 ...
                 (rowreq_ctx->data = ipDefaultRouterTable_allocate_data()))
        {
    ...
    {
        if (SNMPERR_SUCCESS !=
            ipDefaultRouterTable_rowreq_ctx_init(rowreq_ctx, user_init_ctx))
        {
 ...
 */
void ipDefaultRouterTable_release_rowreq_ctx(
    ipDefaultRouterTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL((
        "internal:ipDefaultRouterTable:ipDefaultRouterTable_release_rowreq_ctx",
        "called\n"));
 ...
 * wrapper
 */
static int _mfd_ipDefaultRouterTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(
        ("internal:ipDefaultRouterTable:_mfd_ipDefaultRouterTable_pre_request",
         "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL(("ipDefaultRouterTable",
                    "error %d from "
 ...
 * wrapper
 */
static int _mfd_ipDefaultRouterTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipDefaultRouterTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:ipDefaultRouterTable:_mfd_ipDefaultRouterTable_post_request",
         "called\n"));
    ...
    rc = ipDefaultRouterTable_post_request(ipDefaultRouterTable_if_ctx.user_ctx,
                                           packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
 ...
 * wrapper
 */
static int _mfd_ipDefaultRouterTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL((
        "internal:ipDefaultRouterTable:_mfd_ipDefaultRouterTable_object_lookup",
        "called\n"));
 ...
 */
NETSNMP_STATIC_INLINE int _ipDefaultRouterTable_get_column(
    ipDefaultRouterTable_rowreq_ctx* rowreq_ctx, netsnmp_variable_list* var,
    int column)
{
    ...
    switch (column)
    {
        ...
        default:
            ...
            {
                DEBUGMSGTL(("internal:ipDefaultRouterTable:_mfd_"
                            "ipDefaultRouterTable_get_column",
...
int _mfd_ipDefaultRouterTable_get_values(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipDefaultRouterTable_rowreq_ctx* rowreq_ctx =
    ...
    DEBUGMSGTL(
        ("internal:ipDefaultRouterTable:_mfd_ipDefaultRouterTable_get_values",
         "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipDefaultRouterTable_get_column(rowreq_ctx, requests->requestvb,
                                              tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
     ...
     * call user code
     */
    return ipDefaultRouterTable_container_load(
...
static void _cache_free(netsnmp_cache* cache, void* magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log(LOG_ERR, "invalid cache in ipDefaultRouterTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free(ipDefaultRouterTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(
        ("internal:ipDefaultRouterTable:_container_item_free", "called\n"));
...
static void _container_free(netsnmp_container* container)
{
    DEBUGMSGTL(("internal:ipDefaultRouterTable:_container_free", "called\n"));
 ...
 */
void _ipDefaultRouterTable_container_init(
    ipDefaultRouterTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(
        ("internal:ipDefaultRouterTable:_ipDefaultRouterTable_container_init",
         "called\n"));
    ...
    if_ctx->cache =
        netsnmp_cache_create(30, /* timeout in seconds */
                             _cache_load, _cache_free, ipDefaultRouterTable_oid,
                             ipDefaultRouterTable_oid_size);

    if (NULL == if_ctx->cache)
    {
        snmp_log(LOG_ERR, "error creating cache for ipDefaultRouterTable\n");
        return;
    }
 ...
 */
void _ipDefaultRouterTable_container_shutdown(
    ipDefaultRouterTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(("internal:ipDefaultRouterTable:_ipDefaultRouterTable_container_"
                "shutdown",
                "called\n"));
...
ipDefaultRouterTable_rowreq_ctx* ipDefaultRouterTable_row_find_by_mib_index(
    ipDefaultRouterTable_mib_index* mib_idx)
{
    ipDefaultRouterTable_rowreq_ctx* rowreq_ctx;
