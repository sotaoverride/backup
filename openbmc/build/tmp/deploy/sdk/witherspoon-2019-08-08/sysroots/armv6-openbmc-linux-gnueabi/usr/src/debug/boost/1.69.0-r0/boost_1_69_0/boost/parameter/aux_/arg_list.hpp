...
struct empty_arg_list
{
    ...
    empty_arg_list(BOOST_PP_ENUM_PARAMS(BOOST_PARAMETER_MAX_ARITY,
                                        void_ BOOST_PP_INTERCEPT))
    {
    }
    ...
    typename result_of0<F>::type get(lazy_default<K, F> x) const
    {
...
struct arg_list : Next
{
    ...
    typedef typename mpl::eval_if<holds_maybe,
                                  get_reference<typename TaggedArg::value_type>,
                                  get_reference<TaggedArg>>::type reference;

    typedef typename mpl::if_<holds_maybe, reference,
                              typename TaggedArg::value_type>::type value_type;
    ...
    // operator.
    arg_list(TaggedArg head, Next const& tail) : Next(tail), arg(head)
    {
    }
    ...
    BOOST_MPL_ASSERT_MSG(sizeof(Next::has_key((key_type*)0)) == sizeof(no_tag),
    ...
    struct key_owner
    {
        ...
        struct apply
        {
            typedef typename mpl::eval_if<
                ...
                mpl::apply_wrap1<typename Next::key_owner, KW>>::type type;
        };
    };
    ...
    typename mpl::apply_wrap3<binding, KW, typename result_of0<F>::type,
                              mpl::true_>::type
    ...
    static typename mpl::apply_wrap2<
        typename mpl::lambda<Predicate, lambda_tag>::type, value_type,
        ArgPack>::type
...
struct end_impl<parameter::aux::arg_list_tag>
{
    ...
    struct apply
    {
        typedef parameter::aux::arg_list_iterator<
            parameter::aux::empty_arg_list>
            type;
    };
};
} // namespace mpl
