 ...
 * Do not edit.  Generated from gpg-error.h.in for:
                 arm-unknown-linux-gnueabi (arm-openbmc-linux-gnueabi)
 */
...
typedef ssize_t (*gpgrt_cookie_read_function_t)(void* cookie, void* buffer,
                                                size_t size);
typedef ssize_t (*gpgrt_cookie_write_function_t)(void* cookie,
                                                 const void* buffer,
                                                 size_t size);
typedef int (*gpgrt_cookie_seek_function_t)(void* cookie, gpgrt_off_t* pos,
                                            int whence);
...
int gpgrt_fclose_snatch(gpgrt_stream_t stream, void** r_buffer,
                        size_t* r_buflen);
...
#define gpgrt_assert(expr)                                                     \
    ((expr) ? (void)0 : _gpgrt_log_assert(#expr, __FILE__, __LINE__, NULL))
...
#define ARGPARSE_FLAG_ALL                                                      \
    2                               /* Do not stop at last option but return   \
...
#define ARGPARSE_op(s, l, t, d)                                                \
    {                                                                          \
        (s), (l),                                                              \
            (ARGPARSE_TYPE_##t | ARGPARSE_OPT_OPTIONAL | ARGPARSE_OPT_PREFIX), \
            (d)                                                                \
    }
#define ARGPARSE_op_n(s, l, d)                                                 \
    {                                                                          \
        (s), (l),                                                              \
            (ARGPARSE_TYPE_NONE | ARGPARSE_OPT_OPTIONAL |                      \
             ARGPARSE_OPT_PREFIX),                                             \
            (d)                                                                \
    }
#define ARGPARSE_op_i(s, l, d)                                                 \
    {                                                                          \
        (s), (l),                                                              \
            (ARGPARSE_TYPE_INT | ARGPARSE_OPT_OPTIONAL | ARGPARSE_OPT_PREFIX), \
            (d)                                                                \
    }
#define ARGPARSE_op_s(s, l, d)                                                 \
    {                                                                          \
        (s), (l),                                                              \
            (ARGPARSE_TYPE_STRING | ARGPARSE_OPT_OPTIONAL |                    \
             ARGPARSE_OPT_PREFIX),                                             \
            (d)                                                                \
    }
#define ARGPARSE_op_l(s, l, d)                                                 \
    {                                                                          \
        (s), (l),                                                              \
            (ARGPARSE_TYPE_LONG | ARGPARSE_OPT_OPTIONAL |                      \
             ARGPARSE_OPT_PREFIX),                                             \
            (d)                                                                \
    }
#define ARGPARSE_op_u(s, l, d)                                                 \
    {                                                                          \
        (s), (l),                                                              \
            (ARGPARSE_TYPE_ULONG | ARGPARSE_OPT_OPTIONAL |                     \
             ARGPARSE_OPT_PREFIX),                                             \
            (d)                                                                \
    }
