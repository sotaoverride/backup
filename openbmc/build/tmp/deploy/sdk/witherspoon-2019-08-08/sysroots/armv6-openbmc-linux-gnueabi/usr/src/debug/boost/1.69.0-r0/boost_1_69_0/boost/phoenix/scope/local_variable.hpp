...
struct local_variable : expression::terminal<detail::local<Key>>
{
...
namespace rule
{
struct local_variable : expression::local_variable<proto::_>
{
};

struct local_var_def : proto::assign<local_variable, meta_grammar>
{
};
} // namespace rule
...
{
template <typename Key>
struct is_nullary<custom_terminal<detail::local<Key>>> : mpl::false_
{
};
} // namespace result_of
...
struct scope_is_nullary_actions::when<boost::phoenix::rule::custom_terminal,
                                      Dummy>
    : proto::or_<
...
template <typename Key>
struct is_custom_terminal<detail::local<Key>> : mpl::true_
{
};
...
struct custom_terminal<detail::local<Key>>
{
    ...
    struct result<This(Local, Context)> : result<This(Local const&, Context)>
    {
    };
    ...
    struct result<This(Local&, Context)>
    {
        typedef typename remove_reference<
            typename result_of::env<Context>::type>::type env_type;

        typedef typename detail::apply_local<detail::local<Key>, env_type>::type
            type;
    };
        ...
        operator()(Local, Context const& ctx)
    {
        ...
        static const int index_value =
            detail::get_index<typename env_type::map_type,
