 ...
 *   DESCRIPTION: Declares regular expression traits class that wraps the global
 * C locale.
 */
...
struct BOOST_REGEX_DECL c_regex_traits<char>
{
    ...
    static string_type BOOST_REGEX_CALL transform(const char* p1,
                                                  const char* p2);
    static string_type BOOST_REGEX_CALL transform_primary(const char* p1,
                                                          const char* p2);

    static char_class_type BOOST_REGEX_CALL lookup_classname(const char* p1,
                                                             const char* p2);
    static string_type BOOST_REGEX_CALL lookup_collatename(const char* p1,
                                                           const char* p2);
...
struct BOOST_REGEX_DECL c_regex_traits<wchar_t>
{
    ...
    static string_type BOOST_REGEX_CALL transform(const wchar_t* p1,
                                                  const wchar_t* p2);
    static string_type BOOST_REGEX_CALL transform_primary(const wchar_t* p1,
                                                          const wchar_t* p2);

    static char_class_type BOOST_REGEX_CALL lookup_classname(const wchar_t* p1,
                                                             const wchar_t* p2);
    static string_type BOOST_REGEX_CALL lookup_collatename(const wchar_t* p1,
                                                           const wchar_t* p2);
...
struct BOOST_REGEX_DECL c_regex_traits<unsigned short>
{
    ...
    static string_type BOOST_REGEX_CALL transform(const unsigned short* p1,
                                                  const unsigned short* p2);
    static string_type BOOST_REGEX_CALL
        transform_primary(const unsigned short* p1, const unsigned short* p2);

    static char_class_type BOOST_REGEX_CALL
        lookup_classname(const unsigned short* p1, const unsigned short* p2);
    static string_type BOOST_REGEX_CALL
        lookup_collatename(const unsigned short* p1, const unsigned short* p2);
