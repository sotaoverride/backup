...
class OperationalStatus
{
    ...
    private:
        ...
        static int _callback_get_Functional(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);
        /** @brief sd-bus callback for set-property 'Functional' */
        static int _callback_set_Functional(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);


        static constexpr auto _interface = "xyz.openbmc_project.State.Decorator.OperationalStatus";
