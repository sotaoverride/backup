...
static void rfbTranslateWithSingleTable24to24(char* table, rfbPixelFormat* in,
                                              rfbPixelFormat* out, char* iptr,
                                              char* optr,
...
static void rfbTranslateWithRGBTables24to24(char* table, rfbPixelFormat* in,
                                            rfbPixelFormat* out, char* iptr,
                                            char* optr,
                                            int bytesBetweenInputLines,
                                            int width, int height)
...
static void rfbTranslateWithSingleTable24toOUT(char* table, rfbPixelFormat* in,
                                               rfbPixelFormat* out, char* iptr,
                                               char* optr,
                                               int bytesBetweenInputLines,
                                               int width, int height)
...
static void rfbTranslateWithRGBTables24toOUT(char* table, rfbPixelFormat* in,
                                             rfbPixelFormat* out, char* iptr,
                                             char* optr,
                                             int bytesBetweenInputLines,
                                             int width, int height)
...
static void rfbTranslateWithSingleTableINto24(char* table, rfbPixelFormat* in,
                                              rfbPixelFormat* out, char* iptr,
                                              char* optr,
                                              int bytesBetweenInputLines,
                                              int width, int height)
...
static void rfbTranslateWithRGBTablesINto24(char* table, rfbPixelFormat* in,
                                            rfbPixelFormat* out, char* iptr,
                                            char* optr,
                                            int bytesBetweenInputLines,
                                            int width, int height)
