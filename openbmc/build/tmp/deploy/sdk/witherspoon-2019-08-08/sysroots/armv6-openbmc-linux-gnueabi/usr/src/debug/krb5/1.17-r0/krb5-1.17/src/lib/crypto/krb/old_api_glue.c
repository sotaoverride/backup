                                           ...
                                           krb5_pointer ivec)
{
    ...
    return krb5_c_encrypt(context, eblock->key, 0, ivec ? &ivecd : 0, &inputd,
                          &outputd);
}
                                           ...
                                           krb5_pointer ivec)
{
    ...
    return krb5_c_decrypt(context, eblock->key, 0, ivec ? &ivecd : 0, &inputd,
                          &outputd);
}
...
krb5_enctype KRB5_CALLCONV krb5_eblock_enctype(krb5_context context,
                                               const krb5_encrypt_block* eblock)
{
...
static krb5_enctype guess_enctype(krb5_cksumtype ctype)
{
...
krb5_error_code KRB5_CALLCONV krb5_random_confounder(size_t size,
                                                     krb5_pointer ptr)
{
...
krb5_boolean KRB5_CALLCONV valid_enctype(krb5_enctype etype)
{
