...
#define G_INPUT_STREAM(o)                                                      \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_INPUT_STREAM, GInputStream))
#define G_INPUT_STREAM_CLASS(k)                                                \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_INPUT_STREAM, GInputStreamClass))
#define G_IS_INPUT_STREAM(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_INPUT_STREAM))
#define G_IS_INPUT_STREAM_CLASS(k)                                             \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_INPUT_STREAM))
#define G_INPUT_STREAM_GET_CLASS(o)                                            \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_INPUT_STREAM, GInputStreamClass))
...
struct _GInputStreamClass
{
    ...
    gssize (*skip)(GInputStream* stream, gsize count, GCancellable* cancellable,
                   GError** error);
