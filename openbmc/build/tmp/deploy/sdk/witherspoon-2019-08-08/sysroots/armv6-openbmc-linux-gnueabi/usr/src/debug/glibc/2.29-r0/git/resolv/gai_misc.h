...
extern struct requestlist*
    __gai_enqueue_request(struct gaicb* gaicbp) attribute_hidden;

/* Find request on wait list.  */
extern struct requestlist*
    __gai_find_request(const struct gaicb* gaicbp) attribute_hidden;

/* Remove request from waitlist.  */
extern int __gai_remove_request(struct gaicb* gaicbp) attribute_hidden;

/* Notify initiator of request and tell this everybody listening.  */
extern void __gai_notify(struct requestlist* req) attribute_hidden;

/* Notify initiator of request.  */
extern int __gai_notify_only(struct sigevent* sigev,
