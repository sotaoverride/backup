...
struct tm* __gmtime64_r(const __time64_t* t, struct tm* tp)
{
...
libc_hidden_def(__gmtime64_r)
    ...
    struct tm* __gmtime_r(const time_t* t, struct tm* tp)
{
    __time64_t t64 = *t;
...
libc_hidden_def(__gmtime_r) weak_alias(__gmtime_r, gmtime_r)
