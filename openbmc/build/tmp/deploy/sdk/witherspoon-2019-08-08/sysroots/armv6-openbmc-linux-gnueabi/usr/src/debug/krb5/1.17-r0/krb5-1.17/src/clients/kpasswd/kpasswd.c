...
static void get_name_from_passwd_file(char* program_name, krb5_context context,
                                      krb5_principal* me)
{
    struct passwd* pw;
    krb5_error_code ret;
...
#else  /* HAVE_PWD_H */
static void get_name_from_passwd_file(krb5_context context, krb5_principal* me)
{
...
int main(int argc, char* argv[])
{
    ...
    if (result_code)
    {
        ...
        printf("%.*s%s%s\n", (int)result_code_string.length,
               result_code_string.data, message ? ": " : "",
