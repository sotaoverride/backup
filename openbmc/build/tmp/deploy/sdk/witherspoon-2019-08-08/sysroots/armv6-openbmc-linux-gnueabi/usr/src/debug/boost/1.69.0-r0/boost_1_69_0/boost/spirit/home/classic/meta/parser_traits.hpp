...
struct is_parser
{
    BOOST_STATIC_CONSTANT(
        bool, value = (::boost::is_base_and_derived<parser<T>, T>::value));
...
struct is_unary_composite
{
    ...
    BOOST_STATIC_CONSTANT(
        bool,
        value = (::boost::is_convertible<typename UnaryT::parser_category_t,
                                         unary_parser_category>::value));
};
...
struct is_action_parser
{
    ...
    BOOST_STATIC_CONSTANT(
        bool,
        value = (::boost::is_convertible<typename ActionT::parser_category_t,
...
struct is_binary_composite
{
    ...
    BOOST_STATIC_CONSTANT(
        bool,
        value = (::boost::is_convertible<typename BinaryT::parser_category_t,
    ...
    BOOST_STATIC_CONSTANT(
        ...
        value =
            (::BOOST_SPIRIT_CLASSIC_NS::is_unary_composite<CompositeT>::value ||
             ::BOOST_SPIRIT_CLASSIC_NS::is_binary_composite<
                 CompositeT>::value));
};
...
struct is_alternative
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<
                       ParserT>::is_alternative));
};
...
struct unary_subject
{
    ...
    BOOST_STATIC_ASSERT(
        BOOST_SPIRIT_CLASSIC_NS::is_unary_composite<UnaryT>::value);
...
struct binary_left_subject
{
    ...
    BOOST_STATIC_ASSERT(
        ::BOOST_SPIRIT_CLASSIC_NS::is_binary_composite<BinaryT>::value);
...
struct action_subject
{
    ...
    BOOST_STATIC_ASSERT(
        ::BOOST_SPIRIT_CLASSIC_NS::is_action_parser<ActionT>::value);
