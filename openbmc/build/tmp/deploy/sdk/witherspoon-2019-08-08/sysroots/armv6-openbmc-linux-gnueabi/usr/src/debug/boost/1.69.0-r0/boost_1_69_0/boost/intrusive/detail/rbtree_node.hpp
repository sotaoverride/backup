...
struct compact_rbtree_node
{
    ...
    typedef
        typename pointer_rebind<VoidPointer, const node>::type const_node_ptr;
    enum color
    {
        red_t,
        black_t
...
struct default_rbtree_node_traits_impl
{
    ...
    BOOST_INTRUSIVE_FORCEINLINE static node_ptr
        get_parent(const const_node_ptr& n)
    {
        return n->parent_;
    }
    ...
    BOOST_INTRUSIVE_FORCEINLINE static node_ptr
        get_left(const const_node_ptr& n)
    {
        return n->left_;
    }
    ...
    BOOST_INTRUSIVE_FORCEINLINE static node_ptr
        get_right(const const_node_ptr& n)
    {
        return n->right_;
    }
    ...
    BOOST_INTRUSIVE_FORCEINLINE static void set_color(const node_ptr& n,
                                                      color c)
    {
        n->color_ = c;
    }
...
// Inherit from rbtree_node_traits_dispatch depending on the embedding
// capabilities
