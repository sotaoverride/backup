...
#pragma warning(push)
#pragma warning(disable : 4251) // 'boost::program_options::variable_value::v' :
                                // class 'boost::any' needs to have
      ...
      public std::map<std::string, variable_value>
{
  ...
  private:
    ...
    /** Names of required options, filled by parser which has
        ...
        This is useful in creating diagnostic messages when the option is
       absent. */
