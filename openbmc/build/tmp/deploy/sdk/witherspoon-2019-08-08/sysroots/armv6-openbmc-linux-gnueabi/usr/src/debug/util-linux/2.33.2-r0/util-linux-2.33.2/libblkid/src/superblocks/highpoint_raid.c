                              ...
                              __attribute__((__unused__)))
{
    ...
    hpt = (struct hpt45x_metadata*)blkid_probe_get_buffer(
        pr, off, sizeof(struct hpt45x_metadata));
    if (!hpt)
...
const struct blkid_idinfo highpoint45x_idinfo = {.name = "hpt45x_raid_member",
