                           ...
                           size_t mac_secret_length, char is_sslv3)
{
    ...
    size_t sslv3_pad_length = 40, header_length, variance_blocks, len,
    ...
    switch (EVP_MD_CTX_type(ctx))
    {
        ...
        case NID_sha224:
            ...
            md_transform = (void (*)(
                void* ctx, const unsigned char* block))SHA256_Transform;
            md_size = 224 / 8;
            break;
        case NID_sha256:
        ...
        case NID_sha384:
            ...
            md_transform = (void (*)(
                void* ctx, const unsigned char* block))SHA512_Transform;
            md_size = 384 / 8;
            md_block_size = 128;
            md_length_size = 16;
            break;
