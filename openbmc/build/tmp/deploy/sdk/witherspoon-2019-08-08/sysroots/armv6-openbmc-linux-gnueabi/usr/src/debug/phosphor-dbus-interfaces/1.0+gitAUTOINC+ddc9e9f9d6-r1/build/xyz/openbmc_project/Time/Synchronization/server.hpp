...
class Synchronization
{
  public:
    ...
    using PropertiesVariant = std::variant<Method>;
    ...
    virtual Method timeSyncMethod(Method value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_TimeSyncMethod(sd_bus*, const char*, const char*,
                                            const char*, sd_bus_message*, void*,
                                            sd_bus_error*);
    /** @brief sd-bus callback for set-property 'TimeSyncMethod' */
    static int _callback_set_TimeSyncMethod(sd_bus*, const char*, const char*,
                                            const char*, sd_bus_message*, void*,
                                            sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Time_Synchronization_interface;
