...
GLIB_AVAILABLE_IN_ALL
void g_variant_type_info_query(GVariantTypeInfo* typeinfo, guint* alignment,
                               gsize* size);
...
const GVariantMemberInfo*
    g_variant_type_info_member_info(GVariantTypeInfo* typeinfo, gsize index);
