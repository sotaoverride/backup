...
/*!
    ...
    The supplied predicate is used to determine which characters are considered
   spaces. The result is a trimmed copy of the input. It is returned as a
                                         ...
                                         PredicateT IsSpace)
{
    ...
    std::copy(::boost::algorithm::detail::trim_begin(
...
{
    return SequenceT(::boost::algorithm::detail::trim_begin(
...
{
    Input.erase(::boost::algorithm::detail::trim_end(
                    ::boost::begin(Input), ::boost::end(Input), IsSpace),
                ::boost::end(Input));
}
...
inline SequenceT trim_copy_if(const SequenceT& Input, PredicateT IsSpace)
{
    ...
    return SequenceT(
        detail::trim_begin(::boost::begin(Input), TrimEnd, IsSpace), TrimEnd);
}
