...
#define DBUS_UINT16_SWAP_LE_BE_CONSTANT(val)                                   \
    ((dbus_uint16_t)((dbus_uint16_t)((dbus_uint16_t)(val) >> 8) |              \
...
#define DBUS_UINT64_SWAP_LE_BE_CONSTANT(val)                                   \
    ((dbus_uint64_t)(                                                          \
        (((dbus_uint64_t)(val) &                                               \
          (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x00000000000000ff))             \
         << 56) |                                                              \
        (((dbus_uint64_t)(val) &                                               \
          (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x000000000000ff00))             \
         << 40) |                                                              \
        (((dbus_uint64_t)(val) &                                               \
          (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x0000000000ff0000))             \
         << 24) |                                                              \
        (((dbus_uint64_t)(val) &                                               \
          (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x00000000ff000000))             \
         << 8) |                                                               \
        (((dbus_uint64_t)(val) &                                               \
          (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x000000ff00000000)) >>          \
         8) |                                                                  \
        (((dbus_uint64_t)(val) &                                               \
          (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x0000ff0000000000)) >>          \
         24) |                                                                 \
        (((dbus_uint64_t)(val) &                                               \
          (dbus_uint64_t)DBUS_UINT64_CONSTANT(0x00ff000000000000)) >>          \
         40) |                                                                 \
        (((dbus_uint64_t)(val) &                                               \
          (dbus_uint64_t)DBUS_UINT64_CONSTANT(0xff00000000000000)) >>          \
         56)))

#endif /* HAVE_BYTESWAP_H */

#define DBUS_UINT16_SWAP_LE_BE(val) (DBUS_UINT16_SWAP_LE_BE_CONSTANT(val))
#define DBUS_INT16_SWAP_LE_BE(val)                                             \
    ((dbus_int16_t)DBUS_UINT16_SWAP_LE_BE_CONSTANT(val))

#define DBUS_UINT32_SWAP_LE_BE(val) (DBUS_UINT32_SWAP_LE_BE_CONSTANT(val))
#define DBUS_INT32_SWAP_LE_BE(val)                                             \
    ((dbus_int32_t)DBUS_UINT32_SWAP_LE_BE_CONSTANT(val))

#define DBUS_UINT64_SWAP_LE_BE(val) (DBUS_UINT64_SWAP_LE_BE_CONSTANT(val))
#define DBUS_INT64_SWAP_LE_BE(val)                                             \
    ((dbus_int64_t)DBUS_UINT64_SWAP_LE_BE_CONSTANT(val))
...
void _dbus_pack_uint32(dbus_uint32_t value, int byte_order,
                       unsigned char* data);
