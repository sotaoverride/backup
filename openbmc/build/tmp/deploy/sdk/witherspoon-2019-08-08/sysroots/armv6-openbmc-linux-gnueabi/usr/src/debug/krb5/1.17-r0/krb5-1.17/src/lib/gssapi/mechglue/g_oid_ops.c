...
OM_uint32 KRB5_CALLCONV
    gss_create_empty_oid_set(minor_status, oid_set) OM_uint32* minor_status;
gss_OID_set* oid_set;
{
    OM_uint32 status;
...
OM_uint32 KRB5_CALLCONV gss_add_oid_set_member(minor_status, member_oid,
                                               oid_set) OM_uint32* minor_status;
gss_OID member_oid;
gss_OID_set* oid_set;
{
    OM_uint32 status;
...
OM_uint32
    KRB5_CALLCONV gss_test_oid_set_member(minor_status, member, set,
                                          present) OM_uint32* minor_status;
gss_OID member;
gss_OID_set set;
int* present;
{
...
OM_uint32 KRB5_CALLCONV gss_oid_to_str(minor_status, oid,
                                       oid_str) OM_uint32* minor_status;
gss_OID oid;
...
OM_uint32 KRB5_CALLCONV gss_str_to_oid(minor_status, oid_str,
