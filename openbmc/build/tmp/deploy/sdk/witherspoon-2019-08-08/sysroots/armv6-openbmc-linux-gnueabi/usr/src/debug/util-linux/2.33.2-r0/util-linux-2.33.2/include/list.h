 ...
 */
_INLINE_ void __list_add(struct list_head* add, struct list_head* prev,
...
#define list_first_entry(head, type, member)                                   \
    ((head) && (head)->next != (head) ? list_entry((head)->next, type, member) \
                                      : NULL)
 ...
 */
_INLINE_ struct list_head*
    merge(int (*cmp)(struct list_head* a, struct list_head* b, void* data),
 ...
 * throughout.
 */
_INLINE_ void merge_and_restore_back_links(
    int (*cmp)(struct list_head* a, struct list_head* b, void* data),
    void* data, struct list_head* head, struct list_head* a,
    struct list_head* b)
{
