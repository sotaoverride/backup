                             ...
                             void* user_init_ctx)
{
    ...
    /*
     * TODO:210:o: |-> Perform extra ifXTable rowreq initialization. (eg
     * DEFVALS) should never get here - ifTable should handle this
     */
    netsnmp_assert(0);
 ...
 */
int ifXTable_container_should_save(ifXTable_rowreq_ctx* rowreq_ctx)
{
...
int ifXTable_indexes_set(ifXTable_rowreq_ctx* rowreq_ctx, long ifIndex_val)
{
    ...
    if (0 != ifXTable_index_to_oid(&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
               ...
               size_t* ifName_val_ptr_len_ptr)
{
     ...
     * copy (* ifName_val_ptr_ptr ) data and (* ifName_val_ptr_len_ptr ) from
     * rowreq_ctx->data
     */
    /*
                     ...
                     struct counter64* ifHCInOctets_val_ptr)
{
     ...
     * get (* ifHCInOctets_val_ptr ).low and (* ifHCInOctets_val_ptr ).high from
     * rowreq_ctx->data
     */
                        ...
                        struct counter64* ifHCInUcastPkts_val_ptr)
{
     ...
     * ).high from rowreq_ctx->data
     */
    (*ifHCInUcastPkts_val_ptr).high = rowreq_ctx->data.ifHCInUcastPkts.high;
                            ...
                            struct counter64* ifHCInMulticastPkts_val_ptr)
{
     ...
     * get (* ifHCInMulticastPkts_val_ptr ).low and (*
     * ifHCInMulticastPkts_val_ptr ).high from rowreq_ctx->data
     */
                            ...
                            struct counter64* ifHCInBroadcastPkts_val_ptr)
{
     ...
     * get (* ifHCInBroadcastPkts_val_ptr ).low and (*
     * ifHCInBroadcastPkts_val_ptr ).high from rowreq_ctx->data
     */
                      ...
                      struct counter64* ifHCOutOctets_val_ptr)
{
     ...
     * get (* ifHCOutOctets_val_ptr ).low and (* ifHCOutOctets_val_ptr ).high
                         ...
                         struct counter64* ifHCOutUcastPkts_val_ptr)
{
     ...
     * get (* ifHCOutUcastPkts_val_ptr ).low and (* ifHCOutUcastPkts_val_ptr
     * ).high from rowreq_ctx->data
     */
    (*ifHCOutUcastPkts_val_ptr).high = rowreq_ctx->data.ifHCOutUcastPkts.high;
    (*ifHCOutUcastPkts_val_ptr).low = rowreq_ctx->data.ifHCOutUcastPkts.low;
                             ...
                             struct counter64* ifHCOutMulticastPkts_val_ptr)
{
     ...
     * get (* ifHCOutMulticastPkts_val_ptr ).low and (*
     * ifHCOutMulticastPkts_val_ptr ).high from rowreq_ctx->data
     */
                             ...
                             struct counter64* ifHCOutBroadcastPkts_val_ptr)
{
     ...
     * get (* ifHCOutBroadcastPkts_val_ptr ).low and (*
     * ifHCOutBroadcastPkts_val_ptr ).high from rowreq_ctx->data
     */
                               ...
                               u_long* ifLinkUpDownTrapEnable_val_ptr)
{
    ...
    /*
     * TODO:231:o: |-> Extract the current value of the ifLinkUpDownTrapEnable
     * data. copy (* ifLinkUpDownTrapEnable_val_ptr ) from rowreq_ctx->data
     */
                           ...
                           u_long* ifConnectorPresent_val_ptr)
{
    ...
    (*ifConnectorPresent_val_ptr) =
        rowreq_ctx->data.ifConnectorPresent ? TV_TRUE : TV_FALSE;
                ...
                size_t* ifAlias_val_ptr_len_ptr)
{
     ...
     * copy (* ifAlias_val_ptr_ptr ) data and (* ifAlias_val_ptr_len_ptr ) from
     * rowreq_ctx->data
     */
    /*
         ...
         (rowreq_ctx->data.ifAlias_len * sizeof(rowreq_ctx->data.ifAlias[0]))))
    {
         ...
         */
        (*ifAlias_val_ptr_ptr) = (char*)malloc(
            rowreq_ctx->data.ifAlias_len * sizeof(rowreq_ctx->data.ifAlias[0]));
        if (NULL == (*ifAlias_val_ptr_ptr))
        {
            snmp_log(LOG_ERR, "could not allocate memory\n");
                                   ...
                                   u_long* ifCounterDiscontinuityTime_val_ptr)
{
     ...
     * ifCounterDiscontinuityTime data. copy (*
     * ifCounterDiscontinuityTime_val_ptr ) from rowreq_ctx->data
     */
...
int ifXTable_commit(ifXTable_rowreq_ctx* rowreq_ctx)
{
    ...
    {
        save_flags &=
            ~COLUMN_IFLINKUPDOWNTRAPENABLE_FLAG; /* clear ifLinkUpDownTrapEnable
                                                  */
        /*
    ...
    {
        save_flags &=
            ~COLUMN_IFPROMISCUOUSMODE_FLAG; /* clear ifPromiscuousMode */
        /*
 ...
 *
 */
int ifLinkUpDownTrapEnable_check_value(ifXTable_rowreq_ctx* rowreq_ctx,
                                       u_long ifLinkUpDownTrapEnable_val)
{
    DEBUGMSGTL(
        ("verbose:ifXTable:ifLinkUpDownTrapEnable_check_value", "called\n"));
...
{
    DEBUGMSGTL(
        ("verbose:ifXTable:ifLinkUpDownTrapEnable_undo_setup", "called\n"));
     ...
     * set rowreq_ctx->undo->ifLinkUpDownTrapEnable from
 ...
 *        A long containing the new value.
 */
int ifLinkUpDownTrapEnable_set(ifXTable_rowreq_ctx* rowreq_ctx,
                               u_long ifLinkUpDownTrapEnable_val)
{
...
int ifLinkUpDownTrapEnable_undo(ifXTable_rowreq_ctx* rowreq_ctx)
{
    ...
    /*
     * copy ifLinkUpDownTrapEnable data
     * set rowreq_ctx->data.ifLinkUpDownTrapEnable from
     * rowreq_ctx->undo->ifLinkUpDownTrapEnable
     */
    rowreq_ctx->data.ifLinkUpDownTrapEnable =
        rowreq_ctx->undo->ifLinkUpDownTrapEnable;
 ...
 *
 */
int ifPromiscuousMode_check_value(ifXTable_rowreq_ctx* rowreq_ctx,
...
int ifPromiscuousMode_undo_setup(ifXTable_rowreq_ctx* rowreq_ctx)
{
     ...
     * set rowreq_ctx->undo->ifPromiscuousMode from
...
int ifPromiscuousMode_undo(ifXTable_rowreq_ctx* rowreq_ctx)
{
    ...
    /*
     * copy ifPromiscuousMode data
     * set rowreq_ctx->data.ifPromiscuousMode from
 ...
 *
 */
int ifAlias_check_value(ifXTable_rowreq_ctx* rowreq_ctx, char* ifAlias_val_ptr,
...
int ifAlias_undo_setup(ifXTable_rowreq_ctx* rowreq_ctx)
{
     ...
     */
    memcpy(
        rowreq_ctx->undo->ifAlias, rowreq_ctx->data.ifAlias,
 ...
 *        The size (in bytes) of the data pointed to by ifAlias_val_ptr
 */
int ifAlias_set(ifXTable_rowreq_ctx* rowreq_ctx, char* ifAlias_val_ptr,
                size_t ifAlias_val_ptr_len)
{
...
int ifAlias_undo(ifXTable_rowreq_ctx* rowreq_ctx)
{
     ...
     */
    memcpy(
        rowreq_ctx->data.ifAlias, rowreq_ctx->undo->ifAlias,
 ...
 */
int ifXTable_check_dependencies(ifXTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("internal:ifXTable:ifXTable_check_dependencies", "called\n"));
