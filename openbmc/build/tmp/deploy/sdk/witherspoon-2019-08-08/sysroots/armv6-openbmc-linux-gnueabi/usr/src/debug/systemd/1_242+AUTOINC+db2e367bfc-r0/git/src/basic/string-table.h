...
#define _DEFINE_STRING_TABLE_LOOKUP_FROM_STRING_WITH_BOOLEAN(name, type, yes,  \
                                                             scope)            \
    scope type name##_from_string(const char* s)                               \
    {                                                                          \
        int b;                                                                 \
...
#define _DEFINE_STRING_TABLE_LOOKUP_FROM_STRING_FALLBACK(name, type, max,      \
                                                         scope)                \
    scope type name##_from_string(const char* s)                               \
    {                                                                          \
        unsigned u = 0;                                                        \
        ...
        if (!s)                                                                \
            return (type)-1;                                                   \
        i = (type)string_table_lookup(name##_table, ELEMENTSOF(name##_table),  \
                                      s);                                      \
        if (i >= 0)                                                            \
            return i;                                                          \
...
#define DEFINE_STRING_TABLE_LOOKUP_WITH_BOOLEAN(name, type, yes)               \
    _DEFINE_STRING_TABLE_LOOKUP_WITH_BOOLEAN(name, type, yes, )
...
#define DEFINE_PRIVATE_STRING_TABLE_LOOKUP_FROM_STRING_FALLBACK(name, type,    \
                                                                max)           \
