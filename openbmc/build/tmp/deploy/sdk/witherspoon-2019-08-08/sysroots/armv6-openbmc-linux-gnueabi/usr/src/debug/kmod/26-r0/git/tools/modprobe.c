...
static void help(void)
{
    printf(
        ...
        "\t    --first-time            Fail if module already inserted or "
        "removed\n"
        ...
        "\n"
        "Query Options:\n"
        "\t-D, --show-depends          Only print module dependencies and "
        "exit\n"
        "\t-c, --showconfig            Print out known configuration and exit\n"
        "\t-c, --show-config           Same as --showconfig\n"
        "\t    --show-modversions      Dump module symbol version and exit\n"
        "\t    --dump-modversions      Same as --show-modversions\n"
        "\t    --show-exports          Only print module exported symbol "
        "versions and exit\n"
        "\n"
        "General Options:\n"
        "\t-n, --dry-run               Do not execute operations, just print "
        "out\n"
        "\t-n, --show                  Same as --dry-run\n"

        "\t-C, --config=FILE           Use FILE instead of default search "
        "paths\n"
                  ...
                  const char* extra_options)
{
    ...
    void (*show)(struct kmod_module * m, bool install, const char* options) =
        NULL;
