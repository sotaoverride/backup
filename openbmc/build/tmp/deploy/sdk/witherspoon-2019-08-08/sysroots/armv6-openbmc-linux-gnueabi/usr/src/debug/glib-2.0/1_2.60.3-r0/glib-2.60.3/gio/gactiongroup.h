...
#define G_ACTION_GROUP(inst)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_ACTION_GROUP, GActionGroup))
#define G_IS_ACTION_GROUP(inst)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_ACTION_GROUP))
#define G_ACTION_GROUP_GET_IFACE(inst)                                         \
    (G_TYPE_INSTANCE_GET_INTERFACE((inst), G_TYPE_ACTION_GROUP,                \
