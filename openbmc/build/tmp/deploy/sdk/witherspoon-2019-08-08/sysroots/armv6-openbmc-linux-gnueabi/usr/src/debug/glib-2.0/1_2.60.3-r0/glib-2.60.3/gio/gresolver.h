...
#define G_RESOLVER(o)                                                          \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_RESOLVER, GResolver))
#define G_RESOLVER_CLASS(k)                                                    \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_RESOLVER, GResolverClass))
...
#define G_RESOLVER_GET_CLASS(o)                                                \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_RESOLVER, GResolverClass))
 ...
 * @G_RESOLVER_NAME_LOOKUP_FLAGS_DEFAULT: default behavior (same as
...
struct _GResolverClass
{
     ...
     *
     * Returns: (element-type GInetAddress) (transfer full): List of
     * #GInetAddress. Since: 2.60
     */
     ...
     * @flags which modifies the behavior of the lookup. See
     * #GResolverNameLookupFlags for more details.
     *
     * Returns: (element-type GInetAddress) (transfer full): List of
     * #GInetAddress. Since: 2.60
     */
