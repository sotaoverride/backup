...
static FT_Error ft_raster1_set_mode(FT_Renderer render, FT_ULong mode_tag,
                                    FT_Pointer data)
{
...
static FT_Error ft_raster1_transform(FT_Renderer render, FT_GlyphSlot slot,
...
static void ft_raster1_get_cbox(FT_Renderer render, FT_GlyphSlot slot,
                                FT_BBox* cbox)
{
    FT_ZERO(cbox);
...
static FT_Error ft_raster1_render(FT_Renderer render, FT_GlyphSlot slot,
