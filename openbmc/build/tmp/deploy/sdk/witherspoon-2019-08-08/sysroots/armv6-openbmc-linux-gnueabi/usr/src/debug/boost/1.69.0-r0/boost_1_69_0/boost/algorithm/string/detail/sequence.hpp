...
inline void insert(InputT& Input, BOOST_STRING_TYPENAME InputT::iterator At,
...
inline typename InputT::iterator
    erase(InputT& Input, BOOST_STRING_TYPENAME InputT::iterator From,
...
inline void replace(InputT& Input, BOOST_STRING_TYPENAME InputT::iterator From,
                    ...
                    ForwardIteratorT Begin, ForwardIteratorT End)
{
    replace_native_helper<has_native_replace<InputT>::value>()(Input, From, To,
                                                               Begin, End);
}
                    ...
                    const InsertT& Insert)
{
    if (From != To)
    {
        ::boost::algorithm::detail::replace(
