...
///
/// \brief This namespase contains all operations required for boundary analysis
/// of text
///
namespace boundary
{
...
///
/// This module contains all operations required for boundary analysis of text:
/// character, word, like and sentence boundaries
///
/// @{
///
...
///
/// \brief Flags used with word boundary analysis -- the type of the word, line
/// or sentence boundary found.
///
/// It is a bit-mask that represents various combinations of rules used to
/// select this specific boundary.
///
...
static const rule_type
    ...
    word_letter = 0x00F00, ///< Word that contains letters, excluding kana and
                           ///< ideographic characters
    word_kana = 0x0F000,   ///< Word that contains kana characters
    word_ideo = 0xF0000,   ///< Word that contains ideographic characters
    word_any = 0xFFFF0,    ///< Any word including numbers, 0 is special flag,
                           ///< equivalent to 15
    word_letters = 0xFFF00, ///< Any word, excluding numbers but including
                            ///< letters, kana and ideograms.
    word_kana_ideo =
        0xFF000,         ///< Word that includes kana or ideographic characters
...
static const rule_type line_soft =
                           0x0F, ///< Soft line break: optional but not required
    line_hard =
        0xF0,        ///< Hard line break: like break is required (as per CR/LF)
...
static const rule_type
    sentence_term =
        0x0F, ///< \brief The sentence was terminated with a sentence terminator
              ///  like ".", "!" possible followed by hard separator like CR,
              ///  LF, PS
    sentence_sep = 0xF0,  ///< \brief The sentence does not contain terminator
                          ///< like ".", "!" but ended with hard separator
...
static const rule_type character_any =
                           0xF, ///< Not in use, just for consistency
    character_mask = 0xF;       ///< Select all character breaking points

///@}

///
/// This function returns the mask that covers all variants for specific
/// boundary type
///
