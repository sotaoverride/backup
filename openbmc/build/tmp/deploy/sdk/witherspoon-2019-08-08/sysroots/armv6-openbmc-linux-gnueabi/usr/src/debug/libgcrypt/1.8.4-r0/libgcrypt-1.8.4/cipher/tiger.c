...
static void do_init(void* context, int variant)
{
...
static void tiger_init(void* context, unsigned int flags)
{
    (void)flags;
...
static void tiger1_init(void* context, unsigned int flags)
{
    (void)flags;
...
static void tiger2_init(void* context, unsigned int flags)
{
    (void)flags;
 ...
 */
static void tiger_final(void* context)
{
    TIGER_CONTEXT* hd = context;
    u32 t, th, msb, lsb;
    byte* p;
...
static byte* tiger_read(void* context)
{
    TIGER_CONTEXT* hd = context;
...
gcry_md_spec_t _gcry_digest_spec_tiger = {GCRY_MD_TIGER,
                                          {0, 0},
                                          "TIGER192",
                                          NULL,
                                          0,
...
gcry_md_spec_t _gcry_digest_spec_tiger1 = {GCRY_MD_TIGER1,
                                           {0, 0},
                                           "TIGER",
                                           asn1,
                                           DIM(asn1),
...
gcry_md_spec_t _gcry_digest_spec_tiger2 = {GCRY_MD_TIGER2,
                                           {0, 0},
                                           "TIGER2",
                                           NULL,
                                           0,
