...
inline std::ostream& operator<<(std::ostream& os,
                                basic_cstring<CharT> const& str)
{
    typedef typename ut_detail::bcs_base_char<CharT>::type char_type;
    char_type const* const beg =
        reinterpret_cast<char_type const* const>(str.begin());
    char_type const* const end =
        reinterpret_cast<char_type const* const>(str.end());
...
{
    CharT1 const* const beg =
        reinterpret_cast<CharT1 const*>(str.begin()); // !!
