...
extern struct ltc_prng_descriptor
{
    ...
    */
    ...
    /** Export a PRNG state
        ...
        @param outlen  [in/out] The max size and resulting size of the PRNG
       state
...
int chacha20_prng_add_entropy(const unsigned char* in, unsigned long inlen,
                              prng_state* prng);
...
int chacha20_prng_export(unsigned char* out, unsigned long* outlen,
                         prng_state* prng);
int chacha20_prng_import(const unsigned char* in, unsigned long inlen,
                         prng_state* prng);
