...
class Association
{
  public:
    ...
    using PropertiesVariant =
        std::variant<std::vector<sdbusplus::message::object_path>>;
    ...
    virtual std::vector<sdbusplus::message::object_path>
        endpoints(std::vector<sdbusplus::message::object_path> value,
                  bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_Endpoints(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Endpoints' */
    static int _callback_set_Endpoints(sd_bus*, const char*, const char*,
                                       const char*, sd_bus_message*, void*,
                                       sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Association_interface;
