...
bool basic_serializer_map::type_info_pointer_compare::
    operator()(const basic_serializer* lhs, const basic_serializer* rhs) const
{
    return *lhs < *rhs;
}
...
BOOST_ARCHIVE_DECL void basic_serializer_map::erase(const basic_serializer* bs)
{
