...
#define G_MENU_ITEM(inst)                                                      \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_MENU_ITEM, GMenuItem))
#define G_IS_MENU_ITEM(inst)                                                   \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_MENU_ITEM))
...
void g_menu_prepend_section(GMenu* menu, const gchar* label,
                            GMenuModel* section);
GLIB_AVAILABLE_IN_2_32
void g_menu_append_section(GMenu* menu, const gchar* label,
                           GMenuModel* section);
...
void g_menu_prepend_submenu(GMenu* menu, const gchar* label,
                            GMenuModel* submenu);
GLIB_AVAILABLE_IN_2_32
void g_menu_append_submenu(GMenu* menu, const gchar* label,
                           GMenuModel* submenu);
