...
#define G_UNIX_FD_LIST(inst)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_UNIX_FD_LIST, GUnixFDList))
#define G_UNIX_FD_LIST_CLASS(class)                                            \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_UNIX_FD_LIST, GUnixFDListClass))
#define G_IS_UNIX_FD_LIST(inst)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_UNIX_FD_LIST))
#define G_IS_UNIX_FD_LIST_CLASS(class)                                         \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_UNIX_FD_LIST))
#define G_UNIX_FD_LIST_GET_CLASS(inst)                                         \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_UNIX_FD_LIST, GUnixFDListClass))
