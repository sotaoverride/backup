...
void snmpNotifyFilterTable_container_init(
...
int snmpNotifyFilterTable_snmpNotifyFilterProfileName_check_index(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx); /* external */
int snmpNotifyFilterSubtree_check_index(
    snmpNotifyFilterTable_rowreq_ctx* rowreq_ctx); /* internal */
