...
#define G_DBUS_INTERFACE(o)                                                    \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_INTERFACE, GDBusInterface))
#define G_IS_DBUS_INTERFACE(o)                                                 \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_INTERFACE))
#define G_DBUS_INTERFACE_GET_IFACE(o)                                          \
    (G_TYPE_INSTANCE_GET_INTERFACE((o), G_TYPE_DBUS_INTERFACE,                 \
                                   GDBusInterfaceIface))
 ...
 * @get_object: Gets the enclosing #GDBusObject. See
 * g_dbus_interface_get_object().
 * @set_object: Sets the enclosing #GDBusObject. See
 * g_dbus_interface_set_object().
 * @dup_object: Gets a reference to the enclosing #GDBusObject. See
 * g_dbus_interface_dup_object(). Added in 2.32.
 *
 * Base type for D-Bus interfaces.
 *
 * Since: 2.30
