...
template <class Key, class Eq, class Hash, class Alloc>
unstable_tag
    iterator_stability(const boost::unordered_set<Key, Eq, Hash, Alloc>&)
{
    return unstable_tag();
}
...
template <class Key, class T, class Eq, class Hash, class Alloc>
unstable_tag
    iterator_stability(const boost::unordered_map<Key, T, Eq, Hash, Alloc>&)
{
    return unstable_tag();
}
template <class Key, class Eq, class Hash, class Alloc>
...
template <class Key, class T, class Eq, class Hash, class Alloc>
unstable_tag
    iterator_stability(const std::unordered_map<Key, T, Eq, Hash, Alloc>&)
{
    return unstable_tag();
}
#endif
...
void erase_if_dispatch(Sequence& c, Predicate p, sequence_tag,
                       IteratorStability)
{
#if 0
...
std::pair<typename Container::iterator, bool>
    push_dispatch(Container& c, BOOST_PENDING_FWD_TYPE(T) v,
...
template <class Container, class T>
std::pair<typename Container::iterator, bool> push(Container& c,
                                                   BOOST_PENDING_FWD_TYPE(T) v)
{
...
typename Container::iterator find_dispatch(Container& c, const Value& value,
                                           container_tag)
{
...
typename AssociativeContainer::iterator find_dispatch(AssociativeContainer& c,
                                                      const Value& value,
                                                      associative_container_tag)
{
    return c.find(value);
...
typename Container::const_iterator
    find_dispatch(const Container& c, const Value& value, container_tag)
{
    return std::find(c.begin(), c.end(), value);
}
...
typename AssociativeContainer::const_iterator
    find_dispatch(const AssociativeContainer& c, const Value& value,
                  associative_container_tag)
{
    return c.find(value);
}
...
template <class Container, class Value>
typename Container::const_iterator find(const Container& c, const Value& value)
{
    return find_dispatch(c, value, graph_detail::container_category(c));
}
...
std::pair<typename AssociativeContainer::iterator,
    ...
    equal_range_dispatch(AssociativeContainer& c, const Value& value,
                         associative_container_tag)
{
