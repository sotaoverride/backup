...
netsnmp_feature_child_of(ipv6ScopeZoneIndexTable_external_access,
                         libnetsnmpmibs)
    ...
    netsnmp_feature_require(row_merge) netsnmp_feature_require(
        ...
        netsnmp_feature_require(check_all_requests_error)
            ...
            netsnmp_feature_child_of(ipv6ScopeZoneIndexTable_container_size,
...
static ipv6ScopeZoneIndexTable_interface_ctx ipv6ScopeZoneIndexTable_if_ctx;

static void _ipv6ScopeZoneIndexTable_container_init(
    ipv6ScopeZoneIndexTable_interface_ctx* if_ctx);
static void _ipv6ScopeZoneIndexTable_container_shutdown(
    ipv6ScopeZoneIndexTable_interface_ctx* if_ctx);
 ...
 */
void _ipv6ScopeZoneIndexTable_initialize_interface(
    ipv6ScopeZoneIndexTable_registration* reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:ipv6ScopeZoneIndexTable:_ipv6ScopeZoneIndexTable_"
    ...
    handler = netsnmp_container_table_handler_get(
        tbl_info, ipv6ScopeZoneIndexTable_if_ctx.container,
 ...
 */
void _ipv6ScopeZoneIndexTable_shutdown_interface(
...
void ipv6ScopeZoneIndexTable_valid_columns_set(netsnmp_column_info* vc)
{
 ...
 */
int ipv6ScopeZoneIndexTable_index_to_oid(
    netsnmp_index* oid_idx, ipv6ScopeZoneIndexTable_mib_index* mib_idx)
{
    ...
    DEBUGMSGTL(
        ("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_index_to_oid",
         "called\n"));
 ...
 */
int ipv6ScopeZoneIndexTable_index_from_oid(
    netsnmp_index* oid_idx, ipv6ScopeZoneIndexTable_mib_index* mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL(("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_index_"
                "from_oid",
                "called\n"));
 ...
 */
ipv6ScopeZoneIndexTable_rowreq_ctx* ipv6ScopeZoneIndexTable_allocate_rowreq_ctx(
    ipv6ScopeZoneIndexTable_data* data, void* user_init_ctx)
{
    ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx =
        SNMP_MALLOC_TYPEDEF(ipv6ScopeZoneIndexTable_rowreq_ctx);
    DEBUGMSGTL(("internal:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_"
                "allocate_rowreq_ctx",
                "called\n"));
    ...
    else
    {
        if (NULL != data)
        {
            ...
            rowreq_ctx->data = data;
                 ...
                 (rowreq_ctx->data = ipv6ScopeZoneIndexTable_allocate_data()))
        {
    ...
    {
        if (SNMPERR_SUCCESS !=
            ipv6ScopeZoneIndexTable_rowreq_ctx_init(rowreq_ctx, user_init_ctx))
        {
 ...
 */
void ipv6ScopeZoneIndexTable_release_rowreq_ctx(
    ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(("internal:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_"
                "release_rowreq_ctx",
 ...
 * wrapper
 */
static int _mfd_ipv6ScopeZoneIndexTable_pre_request(
    ...
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ...
    DEBUGMSGTL(("internal:ipv6ScopeZoneIndexTable:_mfd_ipv6ScopeZoneIndexTable_"
                "pre_request",
                "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL(("ipv6ScopeZoneIndexTable",
                    "error %d from "
 ...
 * wrapper
 */
static int _mfd_ipv6ScopeZoneIndexTable_post_request(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx =
 ...
 * wrapper
 */
static int _mfd_ipv6ScopeZoneIndexTable_object_lookup(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
 ...
 */
NETSNMP_STATIC_INLINE int _ipv6ScopeZoneIndexTable_get_column(
    ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx, netsnmp_variable_list* var,
    int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPV6SCOPEZONEINDEX3:
            var->val_len = sizeof(u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6ScopeZoneIndex3_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPV6SCOPEZONEINDEX6:
            var->val_len = sizeof(u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6ScopeZoneIndex6_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPV6SCOPEZONEINDEX7:
            var->val_len = sizeof(u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6ScopeZoneIndex7_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPV6SCOPEZONEINDEX9:
            var->val_len = sizeof(u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6ScopeZoneIndex9_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPV6SCOPEZONEINDEXA:
            var->val_len = sizeof(u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6ScopeZoneIndexA_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPV6SCOPEZONEINDEXB:
            var->val_len = sizeof(u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6ScopeZoneIndexB_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPV6SCOPEZONEINDEXC:
            var->val_len = sizeof(u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6ScopeZoneIndexC_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        case COLUMN_IPV6SCOPEZONEINDEXD:
            var->val_len = sizeof(u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6ScopeZoneIndexD_get(rowreq_ctx, (u_long*)var->val.string);
            break;
        ...
        default:
            ...
            {
                DEBUGMSGTL(("internal:ipv6ScopeZoneIndexTable:_mfd_"
                            "ipv6ScopeZoneIndexTable_get_column",
...
int _mfd_ipv6ScopeZoneIndexTable_get_values(
    netsnmp_mib_handler* handler, netsnmp_handler_registration* reginfo,
    netsnmp_agent_request_info* agtreq_info, netsnmp_request_info* requests)
{
    ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx =
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv6ScopeZoneIndexTable_get_column(
 ...
 * @internal
 */
static void _container_item_free(ipv6ScopeZoneIndexTable_rowreq_ctx* rowreq_ctx,
                                 void* context)
{
    DEBUGMSGTL(
        ("internal:ipv6ScopeZoneIndexTable:_container_item_free", "called\n"));
...
{
    DEBUGMSGTL(
        ("internal:ipv6ScopeZoneIndexTable:_container_free", "called\n"));
 ...
 */
void _ipv6ScopeZoneIndexTable_container_init(
    ipv6ScopeZoneIndexTable_interface_ctx* if_ctx)
{
    DEBUGMSGTL(("internal:ipv6ScopeZoneIndexTable:_ipv6ScopeZoneIndexTable_"
                "container_init",
    ...
    {
        if_ctx->container =
            netsnmp_container_find("ipv6ScopeZoneIndexTable:table_container");
        if (if_ctx->container)
        ...
        ipv6ScopeZoneIndexTable_mib_index* mib_idx)
{
    ...
    rowreq_ctx = (ipv6ScopeZoneIndexTable_rowreq_ctx*)CONTAINER_FIND(
        ipv6ScopeZoneIndexTable_if_ctx.container, &oid_idx);
...
static int _cache_load(netsnmp_cache* cache, void* vmagic)
{
     ...
     * call user code
     */
    return ipv6ScopeZoneIndexTable_container_load(
