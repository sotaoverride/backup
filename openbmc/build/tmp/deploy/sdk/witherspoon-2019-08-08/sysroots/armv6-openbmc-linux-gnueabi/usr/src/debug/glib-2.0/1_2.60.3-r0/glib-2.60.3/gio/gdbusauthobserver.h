...
#define G_DBUS_AUTH_OBSERVER(o)                                                \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_DBUS_AUTH_OBSERVER,                \
                                GDBusAuthObserver))
#define G_IS_DBUS_AUTH_OBSERVER(o)                                             \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_AUTH_OBSERVER))
