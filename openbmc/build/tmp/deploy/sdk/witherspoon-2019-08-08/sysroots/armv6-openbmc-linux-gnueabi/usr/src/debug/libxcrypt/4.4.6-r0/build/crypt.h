...
/* One-way hash the passphrase PHRASE as specified by SETTING, and
   ...
   will not begin with '*'.  */
extern char* crypt(const char* __phrase, const char* __setting) __THROW;
...
extern char* crypt_rn(const char* __phrase, const char* __setting, void* __data,
                      int __size) __THROW;
...
extern char* crypt_ra(const char* __phrase, const char* __setting,
                      void** __data, int* __size) __THROW;
...
extern char* crypt_gensalt(const char* __prefix, unsigned long __count,
                           const char* __rbytes, int __nrbytes) __THROW;
...
extern char* crypt_gensalt_rn(const char* __prefix, unsigned long __count,
                              ...
                              char* __output, int __output_size) __THROW;
...
extern char* __REDIRECT_NTH(crypt_gensalt_r,
                            (const char* __prefix, unsigned long __count,
                             const char* __rbytes, int __nrbytes,
