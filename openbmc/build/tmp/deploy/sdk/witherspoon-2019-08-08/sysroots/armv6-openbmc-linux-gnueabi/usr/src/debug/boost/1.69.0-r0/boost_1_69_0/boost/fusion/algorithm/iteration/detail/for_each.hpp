...
BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED inline void
...
{
    detail::for_each_linear(
        fusion::begin(seq), fusion::end(seq), f,
        result_of::equal_to<typename result_of::begin<Sequence>::type,
...
struct for_each_unrolled
{
    ...
    BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED static void
        call(I0 const& i0, F& f)
    {
        f(*i0);
...
struct for_each_unrolled<0>
{
    ...
    BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED static void call(It const&,
                                                                    F const&)
    {
    }
};
    ...
    for_each_dispatch(Sequence& seq, F& f, random_access_traversal_tag)
{
    ...
    for_each_unrolled<result_of::distance<begin, end>::type::value>::call(
        fusion::begin(seq), f);
}
...
{
    detail::for_each_dispatch(seq, f,
