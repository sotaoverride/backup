...
static krb5_error_code k5identity_init(krb5_context context,
                                       krb5_ccselect_moddata* data_out,
                                       int* priority_out)
{
    *data_out = NULL;
...
static krb5_boolean fnmatch_data(const char* pattern, krb5_data* data,
                                 krb5_boolean fold_case)
{
    krb5_error_code ret;
    char *str, *p;
    int res;
...
static krb5_boolean check_constraint(krb5_context context, const char* name,
                                     const char* value, krb5_principal server)
{
 ...
 */
static krb5_boolean parse_line(krb5_context context, char* line,
                               krb5_principal server, krb5_principal* princ_out)
{
...
static char* get_homedir(krb5_context context)
{
...
static krb5_error_code k5identity_choose(krb5_context context,
