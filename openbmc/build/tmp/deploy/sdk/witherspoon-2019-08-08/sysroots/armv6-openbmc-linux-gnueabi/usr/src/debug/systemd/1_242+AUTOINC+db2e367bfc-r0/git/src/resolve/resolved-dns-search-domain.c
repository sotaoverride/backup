...
int dns_search_domain_new(Manager* m, DnsSearchDomain** ret,
                          DnsSearchDomainType type, Link* l, const char* name)
{
...
DEFINE_TRIVIAL_REF_UNREF_FUNC(DnsSearchDomain, dns_search_domain,
...
int dns_search_domain_find(DnsSearchDomain* first, const char* name,
                           DnsSearchDomain** ret)
{
    DnsSearchDomain* d;
    int r;
