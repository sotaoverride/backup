...
struct pj_winberger_hash
{
    ...
    static state_type update_state(state_type value, char const* begin,
                                   char const* end)
    {
        while (begin != end)
...
inline pj_winberger_hash::state_type
    pj_winberger_hash_function(char const* begin, char const* end)
{
    pj_winberger_hash::state_type state = pj_winberger_hash::initial_state;
