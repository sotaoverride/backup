    ...
    : public boost::date_time::date_duration<date_duration_rep>
{
  ...
  public:
    ...
    //  NOTE: Because of date_time::date_duration< T > design choice we don't
    //  use Boost.Operators here, because we need the class to be a direct base.
    //  Either lose EBO, or define operators by hand. The latter is more
    //  effecient.
