                                ...
                                const char* safechars)
{
    ...
    *width = 0;
    ...
    while (p && *p)
    {
        ...
        if ((*p == '\\' && *(p + 1) == 'x') || iscntrl((unsigned char)*p))
        {
...
static char* mbs_align_pad(char* dest, const char* dest_end, size_t n_spaces,
                           int padchar)
{
...
size_t mbsalign(const char* src, char* dest, size_t dest_size, size_t* width,
...
size_t mbsalign_with_padding(const char* src, char* dest, size_t dest_size,
