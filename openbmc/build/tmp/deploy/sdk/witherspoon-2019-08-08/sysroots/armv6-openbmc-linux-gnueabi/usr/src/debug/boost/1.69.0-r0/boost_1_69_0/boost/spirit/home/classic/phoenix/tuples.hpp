...
//
///////////////////////////////////////////////////////////////////////////////
template <typename A = nil_t, typename B = nil_t, typename C = nil_t
...
struct tuple_base
{
    ...
    {
        return tuple_element<N, DerivedT>::get(
             ...
             > : public tuple_base<tuple<A>>
{
    ...
    tuple(typename call_traits<A>::param_type a_) : a(a_)
    {
    }

    template <typename TupleT>
    tuple(TupleT const& init) : a(init[tuple_index<0>()])
    {
             ...
             > : public tuple_base<tuple<A, B, C, D, E, F, G, H>>
{
    ...
    tuple(typename call_traits<A>::param_type a_,
        ...
        a(a_),
        b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_)
    {
    }
             ...
             > : public tuple_base<tuple<A, B, C, D, E, F, G, H, I>>
{
    ...
    tuple(typename call_traits<A>::param_type a_,
        ...
        a(a_),
        b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_), i(i_)
    {
    }
             ...
             > : public tuple_base<tuple<A, B, C, D, E, F, G, H, I, J>>
{
    ...
    tuple(typename call_traits<A>::param_type a_,
        ...
        a(a_),
        b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_), i(i_), j(j_)
    {
    }
             ...
             > : public tuple_base<tuple<A, B, C, D, E, F, G, H, I, J, K>>
{
    ...
    tuple(typename call_traits<A>::param_type a_,
        ...
        a(a_),
        b(b_), c(c_), d(d_), e(e_), f(f_), g(g_), h(h_), i(i_), j(j_), k(k_)
    {
    }
