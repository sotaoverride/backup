 ...
 */
struct sysfs_attribute* sysfs_get_module_attr(struct sysfs_module* module,
                                              const char* name)
{
 ...
 */
struct sysfs_attribute* sysfs_get_module_parm(struct sysfs_module* module,
                                              const char* parm)
{
    ...
    return (struct sysfs_attribute*)dlist_find_custom(parm_list, (void*)parm,
                                                      mod_name_equal);
}
 ...
 * Returns sysfs_attribute * on SUCCESS and NULL on error
 */
struct sysfs_attribute* sysfs_get_module_section(struct sysfs_module* module,
                                                 const char* section)
{
    ...
    return (struct sysfs_attribute*)dlist_find_custom(sect_list, (void*)section,
                                                      mod_name_equal);
}
