...
static char** create_word_array_helper(const char* cptr, size_t idx, char* tmp,
                                       size_t tmplen)
{
    char* item;
    char** res;
...
static char** create_word_array(const char* cptr)
{
...
int netsnmp_register_default_domain(const char* application, const char* domain)
{
...
static void netsnmp_register_user_domain(const char* token, char* cptr)
{
    struct netsnmp_lookup_domain *run = domains, *prev = NULL;
...
static void netsnmp_clear_user_domain(void)
{
    struct netsnmp_lookup_domain *run = domains, *prev = NULL;
...
const char* const* netsnmp_lookup_default_domains(const char* application)
{
    ...
    DEBUGMSGTL(("defaults", "netsnmp_lookup_default_domain(\"%s\") ->",
 ...
 */
int netsnmp_register_default_target(const char* application, const char* domain,
                                    const char* target)
{
...
static void netsnmp_register_user_target(const char* token, char* cptr)
{
    struct netsnmp_lookup_target *run = targets, *prev = NULL;
    size_t len = strlen(cptr) + 1;
    char* application = (char*)malloc(len);
...
static void netsnmp_clear_user_target(void)
{
    struct netsnmp_lookup_target *run = targets, *prev = NULL;
                                          ...
                                          const char* domain)
{
    ...
    DEBUGMSGTL(("defaults",
                ...
                application ? application : "[NIL]", domain ? domain : "[NIL]",
                res ? res : "[NIL]"));
    return res;
}
...
{
    register_config_handler("snmp:", "defDomain", netsnmp_register_user_domain,
                            netsnmp_clear_user_domain, "application domain");
    register_config_handler("snmp:", "defTarget", netsnmp_register_user_target,
