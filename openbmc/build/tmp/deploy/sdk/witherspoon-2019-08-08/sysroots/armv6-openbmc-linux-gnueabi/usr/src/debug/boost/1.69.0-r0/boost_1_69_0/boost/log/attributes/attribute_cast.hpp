...
/*!
 * The class holds a reference to the attribute factory implementation being
 * casted
 */
class cast_source
{
  ...
  public:
    /*!
     * Initializing constructor. Creates a source that refers to the specified
    ...
    /*!
     * The function attempts to cast the aggregated pointer to the
     * implementation to the specified type.
     *
