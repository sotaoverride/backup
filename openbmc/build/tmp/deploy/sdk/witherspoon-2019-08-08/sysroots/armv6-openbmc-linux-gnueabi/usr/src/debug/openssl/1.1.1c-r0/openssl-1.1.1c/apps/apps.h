...
#define OPT_V_ENUM                                                             \
    ...
    OPT_V_VERIFY_DEPTH, OPT_V_ATTIME, OPT_V_VERIFY_HOSTNAME,                   \
    OPT_V_VERIFY_EMAIL, OPT_V_VERIFY_IP, OPT_V_IGNORE_CRITICAL,                \
    OPT_V_ISSUER_CHECKS, OPT_V_CRL_CHECK, OPT_V_CRL_CHECK_ALL,                 \
    OPT_V_POLICY_CHECK, OPT_V_EXPLICIT_POLICY, OPT_V_INHIBIT_ANY,              \
    OPT_V_INHIBIT_MAP, OPT_V_X509_STRICT, OPT_V_EXTENDED_CRL,                  \
    OPT_V_USE_DELTAS, OPT_V_POLICY_PRINT, OPT_V_CHECK_SS_SIG,                  \
    OPT_V_TRUSTED_FIRST, OPT_V_SUITEB_128_ONLY, OPT_V_SUITEB_128,              \
    OPT_V_SUITEB_192, OPT_V_PARTIAL_CHAIN, OPT_V_NO_ALT_CHAINS,                \
    OPT_V_NO_CHECK_TIME, OPT_V_VERIFY_AUTH_LEVEL, OPT_V_ALLOW_PROXY_CERTS,     \
    OPT_V__LAST
...
#define OPT_S_ENUM                                                             \
    ...
    OPT_S_NOLEGACYCONN, OPT_S_ALLOW_NO_DHE_KEX, OPT_S_PRIORITIZE_CHACHA,       \
...
#define OPT_S_OPTIONS                                                          \
    {"no_ssl3", OPT_S_NOSSL3, '-', "Just disable SSLv3"},                      \
        ...
        {"ciphersuites", OPT_S_CIPHERSUITES, 's',                              \
         "Specify TLSv1.3 ciphersuites to be used"},                           \
        {"min_protocol", OPT_S_MINPROTO, 's',                                  \
         "Specify the minimum protocol version to be used"},                   \
        {"max_protocol", OPT_S_MAXPROTO, 's',                                  \
 ...
 */
#define OPT_R_ENUM OPT_R__FIRST = 1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST

#define OPT_R_OPTIONS                                                          \
    {"rand", OPT_R_RAND, 's',                                                  \
     "Load the file(s) into the random number generator"},                     \
    {                                                                          \
        "writerand", OPT_R_WRITERAND, '>',                                     \
...
#define OPT_FMT_ANY                                                            \
    (OPT_FMT_PEMDER | OPT_FMT_PKCS12 | OPT_FMT_SMIME | OPT_FMT_ENGINE |        \
     OPT_FMT_MSBLOB | OPT_FMT_NSS | OPT_FMT_TEXT | OPT_FMT_HTTP | OPT_FMT_PVK)
...
#endif
void print_bignum_var(BIO*, const BIGNUM*, const char*, int, unsigned char*);
