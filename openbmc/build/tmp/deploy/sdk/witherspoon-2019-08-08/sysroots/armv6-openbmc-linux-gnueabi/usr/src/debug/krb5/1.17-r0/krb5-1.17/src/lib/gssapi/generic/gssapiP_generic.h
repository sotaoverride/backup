...
#define G_SET_INIT                                                             \
    {                                                                          \
        K5_MUTEX_PARTIAL_INITIALIZER, 0                                        \
    }
...
gss_int32 g_verify_token_header(const gss_OID_desc* mech,
                                unsigned int* body_size, unsigned char** buf,
                                int tok_type, unsigned int toksize_in,
                                int flags);
...
long g_seqstate_init(g_seqnum_state* state_out, uint64_t seqnum, int do_replay,
...
OM_uint32 generic_gss_release_buffer(OM_uint32*,    /* minor_status */
                                     gss_buffer_t); /* buffer */

OM_uint32 generic_gss_release_oid_set(OM_uint32*,    /* minor_status */
                                      gss_OID_set*); /* set */

OM_uint32 generic_gss_release_oid(OM_uint32*, /* minor_status */
                                  gss_OID*);  /* set */
...
OM_uint32 generic_gss_str_to_oid(OM_uint32*,   /* minor_status */
                                 gss_buffer_t, /* oid_str */
                                 gss_OID*);    /* oid */

OM_uint32 generic_gss_oid_compose(OM_uint32*,     /* minor_status */
                                  const char*,    /* prefix */
                                  size_t,         /* prefix_len */
                                  int,            /* suffix */
                                  gss_OID_desc*); /* oid */

OM_uint32 generic_gss_oid_decompose(OM_uint32*,    /* minor_status */
                                    const char*,   /*prefix */
                                    size_t,        /* prefix_len */
                                    gss_OID_desc*, /* oid */
                                    int*);         /* suffix */
 ...
 */
static inline OM_uint32 k5buf_to_gss(OM_uint32* minor,
...
OM_uint32 generic_gss_create_empty_buffer_set(OM_uint32* /*minor_status*/,
...
OM_uint32 generic_gss_release_buffer_set(OM_uint32* /*minor_status*/,
                                         gss_buffer_set_t* /*buffer_set*/);
...
OM_uint32 generic_gss_display_mech_attr(OM_uint32* minor_status,
