...
kadm5_ret_t kadm5_create_policy(void* server_handle, kadm5_policy_ent_t policy,
                                long mask)
{
    cpol_arg arg;
    generic_ret r = {0, 0};
...
kadm5_ret_t kadm5_delete_policy(void* server_handle, char* name)
{
    dpol_arg arg;
    generic_ret r = {0, 0};
    kadm5_server_handle_t handle = server_handle;
...
kadm5_ret_t kadm5_modify_policy(void* server_handle, kadm5_policy_ent_t policy,
                                long mask)
{
    mpol_arg arg;
    generic_ret r = {0, 0};
...
kadm5_ret_t kadm5_get_policy(void* server_handle, char* name,
