 ...
 * @G_PARAM_CONSTRUCT_ONLY: the parameter can only be set upon object
 * construction
...
/**
 * GParamSpec: (ref-func g_param_spec_ref_sink) (unref-func g_param_spec_uref)
 * (set-value-func g_value_set_param) (get-value-func g_value_get_param)
...
GType _g_param_type_register_static_constant(
    const gchar* name, const GParamSpecTypeInfo* pspec_info, GType opt_type);
