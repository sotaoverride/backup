 ...
 * Utility routines
 */
static int store_snmpTargetParamsEntry(int majorID, int minorID,
...
struct targetParamTable_struct* snmpTargetParamTable_create(void)
{
    ...
    newEntry = (struct targetParamTable_struct*)calloc(
        1, sizeof(struct targetParamTable_struct));
 ...
 */
void snmpTargetParamTable_dispose(struct targetParamTable_struct* reaped)
{
 ...
 */
void snmpTargetParamTable_addToList(struct targetParamTable_struct* newEntry,
                                    struct targetParamTable_struct** listPtr)
{
    ...
    else
    {
        ...
        {
            i = netsnmp_compare_mem(
                newEntry->paramNameData, newEntry->paramNameLen,
                curr_struct->paramNameData, curr_struct->paramNameLen);
            if (i == 0)
 ...
 */
void snmpTargetParamTable_remFromList(struct targetParamTable_struct* oldEntry,
                                      struct targetParamTable_struct** listPtr)
{
...
struct targetParamTable_struct*
    search_snmpTargetParamsTable(oid* baseName, size_t baseNameLen, oid* name,
...
{
    DEBUGMSGTL(
        ("trap:targetParam:shutdown", "clearing %d object(s)\n", _active));
