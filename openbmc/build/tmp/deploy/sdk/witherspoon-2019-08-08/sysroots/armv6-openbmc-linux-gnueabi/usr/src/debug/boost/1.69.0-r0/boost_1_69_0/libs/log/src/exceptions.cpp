...
// 'boost::error_info<boost::throw_line_,int>::value_type', possible loss of
// data No idea why line number is stored as a signed integer in the error
// info...
...
BOOST_LOG_API void attach_attribute_name_info(exception& e,
...
bad_alloc::bad_alloc(const char* descr) : m_message(descr)
{
}

bad_alloc::bad_alloc(std::string const& descr) : m_message(descr)
{
}
...
void bad_alloc::throw_(const char* file, std::size_t line,
...
void capacity_limit_reached::throw_(const char* file, std::size_t line,
                                    const char* descr)
{
    boost::throw_exception(
        boost::enable_error_info(capacity_limit_reached(descr))
...
missing_value::missing_value() : runtime_error("Requested value not found")
{
}

missing_value::missing_value(std::string const& descr) : runtime_error(descr)
{
}
...
void missing_value::throw_(const char* file, std::size_t line,
                           const char* descr, attribute_name const& name)
{
    boost::throw_exception(boost::enable_error_info(missing_value(descr))
                           << boost::throw_file(file) << boost::throw_line(line)
...
void missing_value::throw_(const char* file, std::size_t line,
                           std::string const& descr, attribute_name const& name)
{
    boost::throw_exception(boost::enable_error_info(missing_value(descr))
                           << boost::throw_file(file) << boost::throw_line(line)
                           << attribute_name_info(name));
...
invalid_type::invalid_type() : runtime_error("Requested value has invalid type")
{
}

invalid_type::invalid_type(std::string const& descr) : runtime_error(descr)
{
}
...
void invalid_type::throw_(const char* file, std::size_t line, const char* descr,
                          typeindex::type_index const& type)
{
    boost::throw_exception(boost::enable_error_info(invalid_type(descr))
                           << boost::throw_file(file) << boost::throw_line(line)
                           << type_info_info(type));
...
invalid_value::invalid_value() : runtime_error("The value is invalid")
{
}

invalid_value::invalid_value(std::string const& descr) : runtime_error(descr)
{
}
...
parse_error::parse_error() : runtime_error("Failed to parse content")
{
}

parse_error::parse_error(std::string const& descr) : runtime_error(descr)
{
}
...
void parse_error::throw_(const char* file, std::size_t line,
                         std::string const& descr, std::size_t content_line)
{
    boost::throw_exception(boost::enable_error_info(parse_error(descr))
                           << boost::throw_file(file) << boost::throw_line(line)
                           << boost::errinfo_at_line(content_line));
...
system_error::system_error(boost::system::error_code code,
                           std::string const& descr) :
...
void system_error::throw_(const char* file, std::size_t line, const char* descr,
...
void system_error::throw_(const char* file, std::size_t line,
                          std::string const& descr, int system_error_code)
{
    boost::throw_exception(
        boost::enable_error_info(system_error(
            boost::system::error_code(system_error_code,
...
logic_error::logic_error(std::string const& descr) : std::logic_error(descr)
{
}
...
void logic_error::throw_(const char* file, std::size_t line,
                         std::string const& descr)
{
    boost::throw_exception(boost::enable_error_info(logic_error(descr))
                           << boost::throw_file(file)
...
odr_violation::odr_violation() : logic_error("ODR violation detected")
{
}

odr_violation::odr_violation(std::string const& descr) : logic_error(descr)
{
}
...
unexpected_call::unexpected_call() : logic_error("Invalid call sequence")
{
}

unexpected_call::unexpected_call(std::string const& descr) : logic_error(descr)
{
}
...
setup_error::setup_error(std::string const& descr) : logic_error(descr)
{
}
