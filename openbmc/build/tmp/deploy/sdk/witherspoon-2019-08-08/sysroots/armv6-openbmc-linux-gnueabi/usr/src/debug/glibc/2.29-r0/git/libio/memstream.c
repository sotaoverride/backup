...
libc_hidden_def(__open_memstream) weak_alias(__open_memstream, open_memstream)

    static int _IO_mem_sync(FILE* fp)
{
...
static void _IO_mem_finish(FILE* fp, int dummy)
{
    struct _IO_FILE_memstream* mp = (struct _IO_FILE_memstream*)fp;
