...
struct sysfs_blkdev
{
    ...
    unsigned int scsi_host, scsi_channel, scsi_target, scsi_lun;

    unsigned int has_hctl : 1, hctl_error : 1;
};
...
int sysfs_devno_to_wholedisk(dev_t dev, char* diskname, size_t len,
                             dev_t* diskdevno);
