    ...
    if (g_once_init_enter(&g_define_type_id__volatile))
    {
        static const GEnumValue values[] = {
            ...
            {G_UNICODE_CLOSE_PUNCTUATION, "G_UNICODE_CLOSE_PUNCTUATION",
             "close-punctuation"},
            {G_UNICODE_FINAL_PUNCTUATION, "G_UNICODE_FINAL_PUNCTUATION",
             "final-punctuation"},
            {G_UNICODE_INITIAL_PUNCTUATION, "G_UNICODE_INITIAL_PUNCTUATION",
             "initial-punctuation"},
            {G_UNICODE_OTHER_PUNCTUATION, "G_UNICODE_OTHER_PUNCTUATION",
             "other-punctuation"},
            {G_UNICODE_OPEN_PUNCTUATION, "G_UNICODE_OPEN_PUNCTUATION",
             "open-punctuation"},
            ...
            {G_UNICODE_LINE_SEPARATOR, "G_UNICODE_LINE_SEPARATOR",
             "line-separator"},
            {G_UNICODE_PARAGRAPH_SEPARATOR, "G_UNICODE_PARAGRAPH_SEPARATOR",
             "paragraph-separator"},
            {G_UNICODE_SPACE_SEPARATOR, "G_UNICODE_SPACE_SEPARATOR",
             "space-separator"},
            {0, NULL, NULL}};
        GType g_define_type_id = g_enum_register_static(
            g_intern_static_string("GUnicodeType"), values);
...
GType g_unicode_break_type_get_type(void)
{
    ...
    {
        static const GEnumValue values[] = {
            {G_UNICODE_BREAK_MANDATORY, "G_UNICODE_BREAK_MANDATORY",
             "mandatory"},
            {G_UNICODE_BREAK_CARRIAGE_RETURN, "G_UNICODE_BREAK_CARRIAGE_RETURN",
             "carriage-return"},
            {G_UNICODE_BREAK_LINE_FEED, "G_UNICODE_BREAK_LINE_FEED",
             "line-feed"},
            {G_UNICODE_BREAK_COMBINING_MARK, "G_UNICODE_BREAK_COMBINING_MARK",
             "combining-mark"},
            {G_UNICODE_BREAK_SURROGATE, "G_UNICODE_BREAK_SURROGATE",
             "surrogate"},
            {G_UNICODE_BREAK_ZERO_WIDTH_SPACE,
             "G_UNICODE_BREAK_ZERO_WIDTH_SPACE", "zero-width-space"},
            {G_UNICODE_BREAK_INSEPARABLE, "G_UNICODE_BREAK_INSEPARABLE",
             "inseparable"},
            {G_UNICODE_BREAK_NON_BREAKING_GLUE,
             "G_UNICODE_BREAK_NON_BREAKING_GLUE", "non-breaking-glue"},
            {G_UNICODE_BREAK_CONTINGENT, "G_UNICODE_BREAK_CONTINGENT",
             "contingent"},
            ...
            {G_UNICODE_BREAK_BEFORE_AND_AFTER,
             "G_UNICODE_BREAK_BEFORE_AND_AFTER", "before-and-after"},
            {G_UNICODE_BREAK_HYPHEN, "G_UNICODE_BREAK_HYPHEN", "hyphen"},
            {G_UNICODE_BREAK_NON_STARTER, "G_UNICODE_BREAK_NON_STARTER",
             "non-starter"},
            {G_UNICODE_BREAK_OPEN_PUNCTUATION,
             "G_UNICODE_BREAK_OPEN_PUNCTUATION", "open-punctuation"},
            {G_UNICODE_BREAK_CLOSE_PUNCTUATION,
             "G_UNICODE_BREAK_CLOSE_PUNCTUATION", "close-punctuation"},
            ...
            {G_UNICODE_BREAK_NEXT_LINE, "G_UNICODE_BREAK_NEXT_LINE",
             "next-line"},
            {G_UNICODE_BREAK_WORD_JOINER, "G_UNICODE_BREAK_WORD_JOINER",
             "word-joiner"},
            ...
            {G_UNICODE_BREAK_HANGUL_LV_SYLLABLE,
             "G_UNICODE_BREAK_HANGUL_LV_SYLLABLE", "hangul-lv-syllable"},
            {G_UNICODE_BREAK_HANGUL_LVT_SYLLABLE,
             "G_UNICODE_BREAK_HANGUL_LVT_SYLLABLE", "hangul-lvt-syllable"},
            {G_UNICODE_BREAK_CLOSE_PARANTHESIS,
             "G_UNICODE_BREAK_CLOSE_PARANTHESIS", "close-paranthesis"},
            ...
            {G_UNICODE_BREAK_REGIONAL_INDICATOR,
             "G_UNICODE_BREAK_REGIONAL_INDICATOR", "regional-indicator"},
            {G_UNICODE_BREAK_EMOJI_BASE, "G_UNICODE_BREAK_EMOJI_BASE",
             "emoji-base"},
            {G_UNICODE_BREAK_EMOJI_MODIFIER, "G_UNICODE_BREAK_EMOJI_MODIFIER",
             "emoji-modifier"},
            {G_UNICODE_BREAK_ZERO_WIDTH_JOINER,
             "G_UNICODE_BREAK_ZERO_WIDTH_JOINER", "zero-width-joiner"},
            {0, NULL, NULL}};
        GType g_define_type_id = g_enum_register_static(
            g_intern_static_string("GUnicodeBreakType"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
...
GType g_unicode_script_get_type(void)
{
    ...
    {
        static const GEnumValue values[] = {
            {G_UNICODE_SCRIPT_INVALID_CODE, "G_UNICODE_SCRIPT_INVALID_CODE",
             "invalid-code"},
            {G_UNICODE_SCRIPT_COMMON, "G_UNICODE_SCRIPT_COMMON", "common"},
            {G_UNICODE_SCRIPT_INHERITED, "G_UNICODE_SCRIPT_INHERITED",
             "inherited"},
            {G_UNICODE_SCRIPT_ARABIC, "G_UNICODE_SCRIPT_ARABIC", "arabic"},
            {G_UNICODE_SCRIPT_ARMENIAN, "G_UNICODE_SCRIPT_ARMENIAN",
             "armenian"},
            {G_UNICODE_SCRIPT_BENGALI, "G_UNICODE_SCRIPT_BENGALI", "bengali"},
            {G_UNICODE_SCRIPT_BOPOMOFO, "G_UNICODE_SCRIPT_BOPOMOFO",
             "bopomofo"},
            {G_UNICODE_SCRIPT_CHEROKEE, "G_UNICODE_SCRIPT_CHEROKEE",
             "cherokee"},
            {G_UNICODE_SCRIPT_COPTIC, "G_UNICODE_SCRIPT_COPTIC", "coptic"},
            {G_UNICODE_SCRIPT_CYRILLIC, "G_UNICODE_SCRIPT_CYRILLIC",
             "cyrillic"},
            {G_UNICODE_SCRIPT_DESERET, "G_UNICODE_SCRIPT_DESERET", "deseret"},
            {G_UNICODE_SCRIPT_DEVANAGARI, "G_UNICODE_SCRIPT_DEVANAGARI",
             "devanagari"},
            {G_UNICODE_SCRIPT_ETHIOPIC, "G_UNICODE_SCRIPT_ETHIOPIC",
             "ethiopic"},
            {G_UNICODE_SCRIPT_GEORGIAN, "G_UNICODE_SCRIPT_GEORGIAN",
             "georgian"},
            {G_UNICODE_SCRIPT_GOTHIC, "G_UNICODE_SCRIPT_GOTHIC", "gothic"},
            {G_UNICODE_SCRIPT_GREEK, "G_UNICODE_SCRIPT_GREEK", "greek"},
            {G_UNICODE_SCRIPT_GUJARATI, "G_UNICODE_SCRIPT_GUJARATI",
             "gujarati"},
            {G_UNICODE_SCRIPT_GURMUKHI, "G_UNICODE_SCRIPT_GURMUKHI",
             "gurmukhi"},
            ...
            {G_UNICODE_SCRIPT_HIRAGANA, "G_UNICODE_SCRIPT_HIRAGANA",
             "hiragana"},
            {G_UNICODE_SCRIPT_KANNADA, "G_UNICODE_SCRIPT_KANNADA", "kannada"},
            {G_UNICODE_SCRIPT_KATAKANA, "G_UNICODE_SCRIPT_KATAKANA",
             "katakana"},
            ...
            {G_UNICODE_SCRIPT_MALAYALAM, "G_UNICODE_SCRIPT_MALAYALAM",
             "malayalam"},
            ...
            {G_UNICODE_SCRIPT_OLD_ITALIC, "G_UNICODE_SCRIPT_OLD_ITALIC",
             "old-italic"},
            ...
            {G_UNICODE_SCRIPT_TAGBANWA, "G_UNICODE_SCRIPT_TAGBANWA",
             "tagbanwa"},
            ...
            {G_UNICODE_SCRIPT_LINEAR_B, "G_UNICODE_SCRIPT_LINEAR_B",
             "linear-b"},
            {G_UNICODE_SCRIPT_TAI_LE, "G_UNICODE_SCRIPT_TAI_LE", "tai-le"},
            {G_UNICODE_SCRIPT_UGARITIC, "G_UNICODE_SCRIPT_UGARITIC",
             "ugaritic"},
            {G_UNICODE_SCRIPT_NEW_TAI_LUE, "G_UNICODE_SCRIPT_NEW_TAI_LUE",
             "new-tai-lue"},
            {G_UNICODE_SCRIPT_BUGINESE, "G_UNICODE_SCRIPT_BUGINESE",
             "buginese"},
            {G_UNICODE_SCRIPT_GLAGOLITIC, "G_UNICODE_SCRIPT_GLAGOLITIC",
             "glagolitic"},
            {G_UNICODE_SCRIPT_TIFINAGH, "G_UNICODE_SCRIPT_TIFINAGH",
             "tifinagh"},
            {G_UNICODE_SCRIPT_SYLOTI_NAGRI, "G_UNICODE_SCRIPT_SYLOTI_NAGRI",
             "syloti-nagri"},
            {G_UNICODE_SCRIPT_OLD_PERSIAN, "G_UNICODE_SCRIPT_OLD_PERSIAN",
             "old-persian"},
            {G_UNICODE_SCRIPT_KHAROSHTHI, "G_UNICODE_SCRIPT_KHAROSHTHI",
             "kharoshthi"},
            ...
            {G_UNICODE_SCRIPT_CUNEIFORM, "G_UNICODE_SCRIPT_CUNEIFORM",
             "cuneiform"},
            {G_UNICODE_SCRIPT_PHOENICIAN, "G_UNICODE_SCRIPT_PHOENICIAN",
             "phoenician"},
            {G_UNICODE_SCRIPT_PHAGS_PA, "G_UNICODE_SCRIPT_PHAGS_PA",
             "phags-pa"},
            {G_UNICODE_SCRIPT_NKO, "G_UNICODE_SCRIPT_NKO", "nko"},
            {G_UNICODE_SCRIPT_KAYAH_LI, "G_UNICODE_SCRIPT_KAYAH_LI",
             "kayah-li"},
            {G_UNICODE_SCRIPT_LEPCHA, "G_UNICODE_SCRIPT_LEPCHA", "lepcha"},
            {G_UNICODE_SCRIPT_REJANG, "G_UNICODE_SCRIPT_REJANG", "rejang"},
            {G_UNICODE_SCRIPT_SUNDANESE, "G_UNICODE_SCRIPT_SUNDANESE",
             "sundanese"},
            {G_UNICODE_SCRIPT_SAURASHTRA, "G_UNICODE_SCRIPT_SAURASHTRA",
             "saurashtra"},
            {G_UNICODE_SCRIPT_CHAM, "G_UNICODE_SCRIPT_CHAM", "cham"},
            {G_UNICODE_SCRIPT_OL_CHIKI, "G_UNICODE_SCRIPT_OL_CHIKI",
             "ol-chiki"},
            ...
            {G_UNICODE_SCRIPT_MEROITIC_CURSIVE,
             "G_UNICODE_SCRIPT_MEROITIC_CURSIVE", "meroitic-cursive"},
            {G_UNICODE_SCRIPT_MEROITIC_HIEROGLYPHS,
             "G_UNICODE_SCRIPT_MEROITIC_HIEROGLYPHS", "meroitic-hieroglyphs"},
            {G_UNICODE_SCRIPT_MIAO, "G_UNICODE_SCRIPT_MIAO", "miao"},
            {G_UNICODE_SCRIPT_SHARADA, "G_UNICODE_SCRIPT_SHARADA", "sharada"},
            {G_UNICODE_SCRIPT_SORA_SOMPENG, "G_UNICODE_SCRIPT_SORA_SOMPENG",
             "sora-sompeng"},
            {G_UNICODE_SCRIPT_TAKRI, "G_UNICODE_SCRIPT_TAKRI", "takri"},
            {G_UNICODE_SCRIPT_BASSA_VAH, "G_UNICODE_SCRIPT_BASSA_VAH",
             "bassa-vah"},
            {G_UNICODE_SCRIPT_CAUCASIAN_ALBANIAN,
             "G_UNICODE_SCRIPT_CAUCASIAN_ALBANIAN", "caucasian-albanian"},
            {G_UNICODE_SCRIPT_DUPLOYAN, "G_UNICODE_SCRIPT_DUPLOYAN",
             "duployan"},
            ...
            {G_UNICODE_SCRIPT_KHUDAWADI, "G_UNICODE_SCRIPT_KHUDAWADI",
             "khudawadi"},
            {G_UNICODE_SCRIPT_LINEAR_A, "G_UNICODE_SCRIPT_LINEAR_A",
             "linear-a"},
            {G_UNICODE_SCRIPT_MAHAJANI, "G_UNICODE_SCRIPT_MAHAJANI",
             "mahajani"},
            {G_UNICODE_SCRIPT_MANICHAEAN, "G_UNICODE_SCRIPT_MANICHAEAN",
             "manichaean"},
            {G_UNICODE_SCRIPT_MENDE_KIKAKUI, "G_UNICODE_SCRIPT_MENDE_KIKAKUI",
             "mende-kikakui"},
            {G_UNICODE_SCRIPT_MODI, "G_UNICODE_SCRIPT_MODI", "modi"},
            {G_UNICODE_SCRIPT_MRO, "G_UNICODE_SCRIPT_MRO", "mro"},
            {G_UNICODE_SCRIPT_NABATAEAN, "G_UNICODE_SCRIPT_NABATAEAN",
             "nabataean"},
            {G_UNICODE_SCRIPT_OLD_NORTH_ARABIAN,
             "G_UNICODE_SCRIPT_OLD_NORTH_ARABIAN", "old-north-arabian"},
            {G_UNICODE_SCRIPT_OLD_PERMIC, "G_UNICODE_SCRIPT_OLD_PERMIC",
             "old-permic"},
            {G_UNICODE_SCRIPT_PAHAWH_HMONG, "G_UNICODE_SCRIPT_PAHAWH_HMONG",
             "pahawh-hmong"},
            {G_UNICODE_SCRIPT_PALMYRENE, "G_UNICODE_SCRIPT_PALMYRENE",
             "palmyrene"},
            {G_UNICODE_SCRIPT_PAU_CIN_HAU, "G_UNICODE_SCRIPT_PAU_CIN_HAU",
             "pau-cin-hau"},
            {G_UNICODE_SCRIPT_PSALTER_PAHLAVI,
             "G_UNICODE_SCRIPT_PSALTER_PAHLAVI", "psalter-pahlavi"},
            {G_UNICODE_SCRIPT_SIDDHAM, "G_UNICODE_SCRIPT_SIDDHAM", "siddham"},
            {G_UNICODE_SCRIPT_TIRHUTA, "G_UNICODE_SCRIPT_TIRHUTA", "tirhuta"},
            {G_UNICODE_SCRIPT_WARANG_CITI, "G_UNICODE_SCRIPT_WARANG_CITI",
             "warang-citi"},
            {G_UNICODE_SCRIPT_AHOM, "G_UNICODE_SCRIPT_AHOM", "ahom"},
            {G_UNICODE_SCRIPT_ANATOLIAN_HIEROGLYPHS,
             "G_UNICODE_SCRIPT_ANATOLIAN_HIEROGLYPHS", "anatolian-hieroglyphs"},
            {G_UNICODE_SCRIPT_HATRAN, "G_UNICODE_SCRIPT_HATRAN", "hatran"},
            {G_UNICODE_SCRIPT_MULTANI, "G_UNICODE_SCRIPT_MULTANI", "multani"},
            {G_UNICODE_SCRIPT_OLD_HUNGARIAN, "G_UNICODE_SCRIPT_OLD_HUNGARIAN",
             "old-hungarian"},
            {G_UNICODE_SCRIPT_SIGNWRITING, "G_UNICODE_SCRIPT_SIGNWRITING",
             "signwriting"},
            {G_UNICODE_SCRIPT_ADLAM, "G_UNICODE_SCRIPT_ADLAM", "adlam"},
            {G_UNICODE_SCRIPT_BHAIKSUKI, "G_UNICODE_SCRIPT_BHAIKSUKI",
             "bhaiksuki"},
            ...
            {G_UNICODE_SCRIPT_MASARAM_GONDI, "G_UNICODE_SCRIPT_MASARAM_GONDI",
             "masaram-gondi"},
            ...
            {G_UNICODE_SCRIPT_ZANABAZAR_SQUARE,
             "G_UNICODE_SCRIPT_ZANABAZAR_SQUARE", "zanabazar-square"},
            {G_UNICODE_SCRIPT_DOGRA, "G_UNICODE_SCRIPT_DOGRA", "dogra"},
            {G_UNICODE_SCRIPT_GUNJALA_GONDI, "G_UNICODE_SCRIPT_GUNJALA_GONDI",
             "gunjala-gondi"},
            {G_UNICODE_SCRIPT_HANIFI_ROHINGYA,
             "G_UNICODE_SCRIPT_HANIFI_ROHINGYA", "hanifi-rohingya"},
            {G_UNICODE_SCRIPT_MAKASAR, "G_UNICODE_SCRIPT_MAKASAR", "makasar"},
            {G_UNICODE_SCRIPT_MEDEFAIDRIN, "G_UNICODE_SCRIPT_MEDEFAIDRIN",
             "medefaidrin"},
            {G_UNICODE_SCRIPT_OLD_SOGDIAN, "G_UNICODE_SCRIPT_OLD_SOGDIAN",
             "old-sogdian"},
            {G_UNICODE_SCRIPT_SOGDIAN, "G_UNICODE_SCRIPT_SOGDIAN", "sogdian"},
            {0, NULL, NULL}};
        GType g_define_type_id = g_enum_register_static(
            g_intern_static_string("GUnicodeScript"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
...
GType g_normalize_mode_get_type(void)
{
    ...
    if (g_once_init_enter(&g_define_type_id__volatile))
    {
        static const GEnumValue values[] = {
            ...
            {G_NORMALIZE_DEFAULT_COMPOSE, "G_NORMALIZE_DEFAULT_COMPOSE",
             "default-compose"},
            ...
            {0, NULL, NULL}};
        GType g_define_type_id = g_enum_register_static(
            g_intern_static_string("GNormalizeMode"), values);
        g_once_init_leave(&g_define_type_id__volatile, g_define_type_id);
    }
