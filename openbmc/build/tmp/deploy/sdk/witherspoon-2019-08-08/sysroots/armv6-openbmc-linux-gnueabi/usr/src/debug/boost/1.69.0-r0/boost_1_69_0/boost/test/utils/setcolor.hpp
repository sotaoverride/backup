...
class setcolor
{
  public:
    ...
    {
        m_command_size = std::sprintf(m_control_command, "%c[%d;%d;%dm", 0x1B,
                                      attr, fg + 30, bg + 40);
    }
...
struct scope_setcolor
{
    ...
    explicit scope_setcolor(bool is_color_output, std::ostream& os,
                            term_attr::_ attr = term_attr::NORMAL,
                            term_color::_ fg = term_color::ORIGINAL,
                            term_color::_ bg = term_color::ORIGINAL) :
        m_os(&os),
...
#define BOOST_TEST_SCOPE_SETCOLOR(is_color_output, os, attr, color)            \
    utils::scope_setcolor const sc(is_color_output, os, utils::attr,           \
                                   utils::color);                              \
