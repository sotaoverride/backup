 ...
 * constructing <tt>shared_ptr</tt>s that point to some object that should not
 * be deleted (i.e. a variable on the stack or some global singleton, like
 * <tt>std::cout</tt>).
 */
...
//! A function object that does nothing and can be used as an empty deleter for
//! \c shared_ptr
struct null_deleter
{
