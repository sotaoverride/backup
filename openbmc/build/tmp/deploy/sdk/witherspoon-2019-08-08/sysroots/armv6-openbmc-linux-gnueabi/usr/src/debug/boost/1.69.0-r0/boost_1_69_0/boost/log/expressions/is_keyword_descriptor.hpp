...
/*!
 * Base class for keyword descriptors. All keyword descriptors must derive from
 * this class to support the \c is_keyword_descriptor trait.
 */
...
struct is_keyword_descriptor : public mpl::false_
{
};
