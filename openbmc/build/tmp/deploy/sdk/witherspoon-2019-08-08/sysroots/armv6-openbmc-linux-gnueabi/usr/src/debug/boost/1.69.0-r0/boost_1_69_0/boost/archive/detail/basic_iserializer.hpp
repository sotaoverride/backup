...
class BOOST_SYMBOL_VISIBLE basic_iserializer : public basic_serializer
{
  private:
  ...
  protected:
    explicit BOOST_ARCHIVE_DECL
        basic_iserializer(const boost::serialization::extended_type_info& type);
  ...
  public:
    ...
    virtual void load_object_data(basic_iarchive& ar, void* x,
                                  const unsigned int file_version) const = 0;
