...
#define GA_SERVICE_RESOLVER(obj)                                               \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), GA_TYPE_SERVICE_RESOLVER,               \
                                GaServiceResolver))
#define GA_SERVICE_RESOLVER_CLASS(klass)                                       \
    (G_TYPE_CHECK_CLASS_CAST((klass), GA_TYPE_SERVICE_RESOLVER,                \
                             GaServiceResolverClass))
...
#define GA_SERVICE_RESOLVER_GET_CLASS(obj)                                     \
    (G_TYPE_INSTANCE_GET_CLASS((obj), GA_TYPE_SERVICE_RESOLVER,                \
                               GaServiceResolverClass))
