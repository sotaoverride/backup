      ...
      public boost::archive::detail::helper_collection
{
  ...
  public:
    ...
    BOOST_ARCHIVE_DECL void
        register_basic_serializer(const basic_oserializer& bos);
    BOOST_ARCHIVE_DECL void save_object(const void* x,
                                        const basic_oserializer& bos);
    BOOST_ARCHIVE_DECL void
        save_pointer(const void* t, const basic_pointer_oserializer* bpos_ptr);
    ...
    BOOST_ARCHIVE_DECL void
        end_preamble(); // default implementation does nothing
