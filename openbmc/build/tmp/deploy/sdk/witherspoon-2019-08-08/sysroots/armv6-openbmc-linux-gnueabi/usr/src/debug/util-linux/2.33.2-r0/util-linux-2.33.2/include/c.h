...
#define __ul_calloc_size(n, s)                                                 \
    __attribute__((alloc_size(n, s), warn_unused_result))
#else
#define __ul_calloc_size(n, s)
#endif
#endif
...
#define errexec(name)                                                          \
    err(errno == ENOENT ? EX_EXEC_ENOENT : EX_EXEC_FAILED,                     \
...
static inline int xusleep(useconds_t usec)
{
    ...
    struct timespec waittime = {.tv_sec = usec / 1000000L,
...
#define USAGE_HELP_OPTIONS(marg_dsc)                                           \
    "%-" #marg_dsc "s%s\n"                                                     \
    "%-" #marg_dsc "s%s\n",                                                    \
        " -h, --help", USAGE_OPTSTR_HELP, " -V, --version",                    \
