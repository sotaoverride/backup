...
class unordered_map
{
  ...
  public:
    ...
    template <class InputIt>
    unordered_map(InputIt, InputIt, size_type, const hasher&,
    ...
    std::pair<iterator, bool>
        emplace(boost::unordered::detail::empty_emplace =
    ...
    iterator emplace_hint(const_iterator hint, BOOST_FWD_REF(Args)... args)
    {
        return table_.emplace_hint_unique(
            hint, table::extractor::extract(boost::forward<Args>(args)...),
            boost::forward<Args>(args)...);
    }
    ...
    {
        return table_.emplace_hint_unique(
            hint, table::extractor::extract(boost::forward<A0>(a0)),
            boost::unordered::detail::create_emplace_args(
                boost::forward<A0>(a0)));
    }
...
#undef BOOST_UNORDERED_EMPLACE
    ...
    {
        return node_type(table_.extract_by_iterator_unique(position),
                         table_.node_alloc());
    }
  ...
  public:
    ...
    template <typename A0, typename A1, typename A2>
    std::pair<iterator, bool>
        try_emplace(key_type const& k, BOOST_FWD_REF(A0) a0,
                    BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
    {
        return table_.try_emplace_unique(
            k, boost::unordered::detail::create_emplace_args(
    ...
    template <typename A0, typename A1, typename A2>
    std::pair<iterator, bool>
        try_emplace(BOOST_RV_REF(key_type) k, BOOST_FWD_REF(A0) a0,
                    BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
    {
        return table_.try_emplace_unique(
            boost::move(k), boost::unordered::detail::create_emplace_args(
...
#undef BOOST_UNORDERED_TRY_EMPLACE
    ...
    template <class M>
    std::pair<iterator, bool> insert_or_assign(key_type const& k,
                                               BOOST_FWD_REF(M) obj)
    {
    ...
    template <class M>
    std::pair<iterator, bool> insert_or_assign(BOOST_RV_REF(key_type) k,
                                               BOOST_FWD_REF(M) obj)
    {
        return table_.insert_or_assign_unique(boost::move(k),
                                              boost::forward<M>(obj));
    }

    template <class M>
    iterator insert_or_assign(const_iterator, key_type const& k,
                              BOOST_FWD_REF(M) obj)
    {
    ...
    template <class M>
    iterator insert_or_assign(const_iterator, BOOST_RV_REF(key_type) k,
                              BOOST_FWD_REF(M) obj)
    {
        return table_
...
unordered_map(std::initializer_list<std::pair<const Key, T>>, std::size_t, Hash,
              Allocator)
...
class unordered_multimap
{
  ...
  public:
    ...
    explicit unordered_multimap(size_type, const hasher&,
                                const allocator_type&);
...
#undef BOOST_UNORDERED_EMPLACE
    ...
    node_type extract(const_iterator position)
    {
        return node_type(table_.extract_by_iterator_equiv(position),
                         table_.node_alloc());
    }
...
template <class InputIterator, class Hash, class Allocator>
unordered_multimap(InputIterator, InputIterator, std::size_t, Hash, Allocator)
    ->unordered_multimap<
        boost::unordered::detail::iter_key_t<InputIterator>,
        boost::unordered::detail::iter_val_t<InputIterator>, Hash,
        std::equal_to<boost::unordered::detail::iter_key_t<InputIterator>>,
...
template <class Key, class T, typename Allocator>
unordered_multimap(std::initializer_list<std::pair<const Key, T>>, std::size_t,
                   Allocator)
    ->unordered_multimap<Key, T, boost::hash<Key>, std::equal_to<Key>,
                         Allocator>;

template <class Key, class T, typename Allocator>
unordered_multimap(std::initializer_list<std::pair<const Key, T>>, Allocator)
    ->unordered_multimap<Key, T, boost::hash<Key>, std::equal_to<Key>,
                         Allocator>;
...
template <class K, class T, class H, class P, class A>
unordered_map<K, T, H, P, A>::unordered_map(BOOST_RV_REF(unordered_map) other,
                                            allocator_type const& a) :
...
unordered_map<K, T, H, P, A>::unordered_map(
    ...
    table_(boost::unordered::detail::initial_size(list.begin(), list.end(), n),
           hf, eql, a)
{
...
template <class K, class T, class H, class P, class A>
unordered_map<K, T, H, P, A>::unordered_map(size_type n,
                                            const allocator_type& a) :
...
void unordered_map<K, T, H, P, A>::insert(InputIt first, InputIt last)
{
    if (first != last)
    {
        table_.insert_range_unique(table::extractor::extract(*first), first,
                                   last);
    }
}
...
template <class K, class T, class H, class P, class A>
typename unordered_map<K, T, H, P, A>::iterator
    unordered_map<K, T, H, P, A>::erase(const_iterator first,
                                        const_iterator last)
{
    ...
    unordered_map<K, T, H, P, A>::equal_range(const key_type& k) const
{
    ...
    return std::make_pair(const_iterator(n),
                          const_iterator(n ? table::next_node(n) : n));
}
...
template <class K, class T, class H, class P, class A>
typename unordered_multimap<K, T, H, P, A>::iterator
    unordered_multimap<K, T, H, P, A>::erase(const_iterator first,
                                             const_iterator last)
{
    node_pointer last_node = table::get_node(last);
    if (first == last)
    ...
    unordered_multimap<K, T, H, P, A>::equal_range(const key_type& k) const
{
    node_pointer n = table_.find_node(k);
    return std::make_pair(const_iterator(n),
                          const_iterator(n ? table_.next_group(n) : n));
}
...
class node_handle_map
{
    ...
    typedef typename boost::unordered::detail::rebind_wrap<
        A, std::pair<K const, T>>::type value_allocator;
  ...
  public:
    ...
    ~node_handle_map()
    {
        if (ptr_)
        {
            ...
            boost::unordered::detail::node_tmp<node_allocator> tmp(ptr_,
                                                                   node_alloc);
        }
    }
