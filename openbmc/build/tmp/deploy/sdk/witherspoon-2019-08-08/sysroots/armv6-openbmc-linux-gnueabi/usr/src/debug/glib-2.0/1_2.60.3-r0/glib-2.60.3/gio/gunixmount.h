...
#define G_UNIX_MOUNT(o)                                                        \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_UNIX_MOUNT, GUnixMount))
#define G_UNIX_MOUNT_CLASS(k)                                                  \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_UNIX_MOUNT, GUnixMountClass))
#define G_IS_UNIX_MOUNT(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_UNIX_MOUNT))
#define G_IS_UNIX_MOUNT_CLASS(k)                                               \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_UNIX_MOUNT))
