...
#define G_NETWORK_ADDRESS(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_NETWORK_ADDRESS, GNetworkAddress))
#define G_NETWORK_ADDRESS_CLASS(k)                                             \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_NETWORK_ADDRESS, GNetworkAddressClass))
#define G_IS_NETWORK_ADDRESS(o)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_NETWORK_ADDRESS))
#define G_IS_NETWORK_ADDRESS_CLASS(k)                                          \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_NETWORK_ADDRESS))
#define G_NETWORK_ADDRESS_GET_CLASS(o)                                         \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_NETWORK_ADDRESS,                    \
