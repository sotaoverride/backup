...
extern void rtnl_ematch_text_set_from(struct rtnl_ematch*, uint8_t, uint16_t);
...
extern void rtnl_ematch_text_set_to(struct rtnl_ematch*, uint8_t, uint16_t);
...
extern void rtnl_ematch_text_set_pattern(struct rtnl_ematch*, char*, size_t);
