...
#else
static inline u32 _gcry_bswap32(u32 x)
{
...
#else
static inline u64 _gcry_bswap64(u64 x)
{
...
/* Count trailing zero bits in an unsigend int.  We return an int
   ...
   bits in X if X is 0. */
static inline int _gcry_ctz(unsigned int x)
{
     ...
     */
    static const unsigned char mod37[] = {sizeof(unsigned int) * 8,
                                          0,
                                          1,
                                          26,
                                          2,
...
/* Count trailing zero bits in an u64.  We return an int because that
   ...
   is 0.  */
static inline int _gcry_ctz64(u64 x)
{
