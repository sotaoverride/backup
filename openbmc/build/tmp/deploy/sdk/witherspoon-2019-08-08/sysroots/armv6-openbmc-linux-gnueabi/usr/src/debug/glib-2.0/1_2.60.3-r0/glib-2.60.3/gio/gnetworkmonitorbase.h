...
#define G_NETWORK_MONITOR_BASE(o)                                              \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_NETWORK_MONITOR_BASE,              \
                                GNetworkMonitorBase))
#define G_NETWORK_MONITOR_BASE_CLASS(k)                                        \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_NETWORK_MONITOR_BASE,                 \
                             GNetworkMonitorBaseClass))
#define G_IS_NETWORK_MONITOR_BASE(o)                                           \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_NETWORK_MONITOR_BASE))
#define G_IS_NETWORK_MONITOR_BASE_CLASS(k)                                     \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_NETWORK_MONITOR_BASE))
#define G_NETWORK_MONITOR_BASE_GET_CLASS(o)                                    \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_NETWORK_MONITOR_BASE,               \
                               GNetworkMonitorBaseClass))
