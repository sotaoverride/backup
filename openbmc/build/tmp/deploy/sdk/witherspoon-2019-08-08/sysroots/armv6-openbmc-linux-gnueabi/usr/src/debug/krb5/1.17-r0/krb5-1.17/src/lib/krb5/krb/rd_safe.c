...
*/
static krb5_error_code rd_safe_basic(krb5_context context, krb5_auth_context ac,
                                     ...
                                     krb5_data* outbuf)
{
    ...
    retval = krb5_k_verify_checksum(context, key, KRB5_KEYUSAGE_KRB_SAFE_CKSUM,
                                           ...
                                           krb5_replay_data* outdata)
{
    ...
    retval =
        rd_safe_basic(context, auth_context, inbuf, key, &replaydata, outbuf);
    if (retval)
        return retval;
