...
extern int blkid_parttable_set_uuid(blkid_parttable tab,
...
extern blkid_partition blkid_partlist_get_partition_by_start(blkid_partlist ls,
                                                             uint64_t start);

extern int blkid_partitions_do_subprobe(blkid_probe pr, blkid_partition parent,
...
extern int blkid_is_nested_dimension(blkid_partition par, uint64_t start,
                                     uint64_t size);
...
extern int blkid_partition_set_flags(blkid_partition par,
