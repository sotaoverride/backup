...
#define _DB_DELAYTIMEONERROR                                                   \
    20 /* If an error occur we stop logging until                              \
...
{
    intTiny
        timeType; /* 0 - unitinialized , 1 - RFC 3164, 2 - syslog-protocol */
    intTiny month;
    intTiny day;
    intTiny wday;
    ...
    intTiny
        OffsetHour;  /* UTC offset in hours
                      * full UTC offset minutes = OffsetHours*60 + OffsetMinute.
