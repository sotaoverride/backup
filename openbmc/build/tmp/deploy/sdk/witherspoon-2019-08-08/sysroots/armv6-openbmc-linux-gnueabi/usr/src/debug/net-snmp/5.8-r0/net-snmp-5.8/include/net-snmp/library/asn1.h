...
NETSNMP_IMPORT
u_char* asn_build_int(u_char*, size_t*, u_char, const long*, size_t);
NETSNMP_IMPORT
...
NETSNMP_IMPORT
u_char* asn_build_bitstring(u_char*, size_t*, u_char, const u_char*, size_t);
NETSNMP_IMPORT
u_char* asn_parse_unsigned_int64(u_char*, size_t*, u_char*, struct counter64*,
                                 size_t);
NETSNMP_IMPORT
u_char* asn_build_unsigned_int64(u_char*, size_t*, u_char,
                                 const struct counter64*, size_t);
NETSNMP_IMPORT
u_char* asn_parse_signed_int64(u_char*, size_t*, u_char*, struct counter64*,
                               size_t);
NETSNMP_IMPORT
u_char* asn_build_signed_int64(u_char*, size_t*, u_char,
                               const struct counter64*, size_t);
NETSNMP_IMPORT
u_char* asn_build_float(u_char*, size_t*, u_char, const float*, size_t);
NETSNMP_IMPORT
u_char* asn_parse_float(u_char*, size_t*, u_char*, float*, size_t);
NETSNMP_IMPORT
u_char* asn_build_double(u_char*, size_t*, u_char, const double*, size_t);
NETSNMP_IMPORT
...
NETSNMP_IMPORT
int asn_realloc_rbuild_int(u_char** pkt, size_t* pkt_len, size_t* offset,
                           int allow_realloc, u_char type, const long* data,
                           size_t data_size);
...
int asn_realloc_rbuild_unsigned_int(u_char** pkt, size_t* pkt_len,
                                    ...
                                    u_char type, const u_long* data,
                                    size_t data_size);

NETSNMP_IMPORT
int asn_realloc_rbuild_header(u_char** pkt, size_t* pkt_len, size_t* offset,
                              int allow_realloc, u_char type, size_t data_size);
...
int asn_realloc_rbuild_length(u_char** pkt, size_t* pkt_len, size_t* offset,
                              int allow_realloc, size_t data_size);

NETSNMP_IMPORT
int asn_realloc_rbuild_objid(u_char** pkt, size_t* pkt_len, size_t* offset,
                             int allow_realloc, u_char type, const oid*,
                             size_t);
