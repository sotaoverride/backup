...
static __always_inline bool futex_supports_exact_relative_timeouts(void);
...
static __always_inline int futex_wait(unsigned int* futex_word,
                                      unsigned int expected, int private);
...
static __always_inline void futex_wait_simple(unsigned int* futex_word,
...
static __always_inline int futex_wait_cancelable(unsigned int* futex_word,
                                                 unsigned int expected,
                                                 int private);
...
/* Like futex_wait, but will eventually time out (i.e., stop being
   ...
   */
static __always_inline int futex_reltimed_wait(unsigned int* futex_word,
                                               unsigned int expected,
...
static __always_inline int futex_abstimed_wait(unsigned int* futex_word,
                                               unsigned int expected,
...
/* Atomically wrt other futex operations on the same futex, this unblocks the
   ...
   on most errors.  */
static __always_inline void futex_wake(unsigned int* futex_word,
                                       int processes_to_wake, int private);
