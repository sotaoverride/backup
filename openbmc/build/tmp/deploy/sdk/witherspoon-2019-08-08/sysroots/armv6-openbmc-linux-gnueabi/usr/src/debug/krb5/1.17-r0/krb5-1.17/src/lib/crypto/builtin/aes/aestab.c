...
const uint32_t rcon_tab[29] = {w0(0x01), w0(0x02), w0(0x04), w0(0x08), w0(0x10),
                               w0(0x20), w0(0x40), w0(0x80), w0(0x1b), w0(0x36),
                               w0(0x6c), w0(0xd8), w0(0xab), w0(0x4d), w0(0x9a),
                               w0(0x2f), w0(0x5e), w0(0xbc), w0(0x63), w0(0xc6),
                               w0(0x97), w0(0x35), w0(0x6a), w0(0xd4), w0(0xb3),
                               w0(0x7d), w0(0xfa), w0(0xef), w0(0xc5)};
...
#define fwd_affine(x)                                                          \
    (w = (uint32_t)x, w ^= (w << 1) ^ (w << 2) ^ (w << 3) ^ (w << 4),          \
     0x63 ^ (uint8_t)(w ^ (w >> 8)))

#define inv_affine(x)                                                          \
    (w = (uint32_t)x, w = (w << 1) ^ (w << 3) ^ (w << 6),                      \
     0x05 ^ (uint8_t)(w ^ (w >> 8)))
