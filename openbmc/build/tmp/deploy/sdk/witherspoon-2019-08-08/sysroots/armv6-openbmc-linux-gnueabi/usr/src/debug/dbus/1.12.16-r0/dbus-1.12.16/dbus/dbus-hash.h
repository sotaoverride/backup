...
static inline void* _dbus_hash_table_lookup_pollable(DBusHashTable* table,
                                                     DBusPollable key)
{
#ifdef DBUS_WIN
...
static inline dbus_bool_t _dbus_hash_table_remove_pollable(DBusHashTable* table,
                                                           DBusPollable key)
{
#ifdef DBUS_WIN
...
static inline dbus_bool_t _dbus_hash_table_insert_pollable(DBusHashTable* table,
                                                           DBusPollable key,
                                                           void* value)
{
#ifdef DBUS_WIN
