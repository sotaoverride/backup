...
/* We need lots of variants for MIPS, to cover all versions and perversions
   of OSes for MIPS.  */
    ...
    defined(__alpha) || defined(__sparc) || defined(sparc) || defined(__ksr__)
#include <alloca.h>
#define HAVE_ALLOCA
#endif
#if defined(_IBMR2)
...
#if (!defined(alloca) && !defined(HAVE_ALLOCA)) || defined(USE_STACK_ALLOC)
...
extern void impn_mul_n _PROTO((mp_ptr prodp, mp_srcptr up, mp_srcptr vp,
                               mp_size_t size, mp_ptr tspace)) attribute_hidden;
