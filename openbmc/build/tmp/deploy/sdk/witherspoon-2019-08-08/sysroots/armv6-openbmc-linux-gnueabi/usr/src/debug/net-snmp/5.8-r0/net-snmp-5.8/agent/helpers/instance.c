...
static void netsnmp_num_file_instance_deref(netsnmp_num_file_instance* nfi)
{
    if (--nfi->refcnt == 0)
    {
        free(nfi->file_name);
...
static netsnmp_handler_registration*
    get_reg(const char* name, const char* ourname, const oid* reg_oid,
            size_t reg_oid_len, netsnmp_num_file_instance* it, int modes,
            ...
            const char* contextName)
{
    ...
    if (subhandler)
    {
        myreg = netsnmp_create_handler_registration(name, subhandler, reg_oid,
                                                    reg_oid_len, modes);
        if (!myreg)
            return NULL;
...
netsnmp_feature_child_of(read_only_ulong_instance, instance)
    ...
    int netsnmp_register_read_only_ulong_instance(
        const char* name, const oid* reg_oid, size_t reg_oid_len, u_long* it,
        Netsnmp_Node_Handler* subhandler)
{
    return netsnmp_register_watched_instance2(
        netsnmp_create_handler_registration(name, subhandler, reg_oid,
                                            reg_oid_len, HANDLER_CAN_RONLY),
        netsnmp_create_watcher_info((void*)it, sizeof(u_long), ASN_UNSIGNED,
                                    WATCHER_FIXED_SIZE));
}
...
netsnmp_feature_child_of(ulong_instance, instance)
    ...
    int netsnmp_register_ulong_instance(const char* name, const oid* reg_oid,
...
netsnmp_feature_child_of(read_only_counter32_instance, instance)
    ...
    int netsnmp_register_read_only_counter32_instance(
        const char* name, const oid* reg_oid, size_t reg_oid_len, u_long* it,
        Netsnmp_Node_Handler* subhandler)
{
    return netsnmp_register_watched_instance2(
        netsnmp_create_handler_registration(name, subhandler, reg_oid,
                                            reg_oid_len, HANDLER_CAN_RONLY),
        netsnmp_create_watcher_info((void*)it, sizeof(u_long), ASN_COUNTER,
                                    WATCHER_FIXED_SIZE));
}
...
netsnmp_feature_child_of(read_only_long_instance, instance)
    ...
    int netsnmp_register_read_only_long_instance(
        const char* name, const oid* reg_oid, size_t reg_oid_len, long* it,
        Netsnmp_Node_Handler* subhandler)
{
    return netsnmp_register_watched_instance2(
        netsnmp_create_handler_registration(name, subhandler, reg_oid,
                                            reg_oid_len, HANDLER_CAN_RONLY),
        netsnmp_create_watcher_info((void*)it, sizeof(long), ASN_INTEGER,
                                    WATCHER_FIXED_SIZE));
}
...
netsnmp_feature_child_of(long_instance, instance)
    ...
    int netsnmp_register_long_instance(const char* name, const oid* reg_oid,
                                       size_t reg_oid_len, long* it,
                                       Netsnmp_Node_Handler* subhandler)
{
    return netsnmp_register_watched_instance2(
        netsnmp_create_handler_registration(name, subhandler, reg_oid,
...
netsnmp_feature_child_of(read_only_uint_instance, instance)
    ...
    int netsnmp_register_read_only_uint_instance(
        const char* name, const oid* reg_oid, size_t reg_oid_len,
        unsigned int* it, Netsnmp_Node_Handler* subhandler)
{
    return netsnmp_register_watched_instance2(
        netsnmp_create_handler_registration(name, subhandler, reg_oid,
                                            reg_oid_len, HANDLER_CAN_RONLY),
        netsnmp_create_watcher_info((void*)it, sizeof(unsigned int),
...
netsnmp_feature_child_of(uint_instance, instance)
    ...
    int netsnmp_register_uint_instance(const char* name, const oid* reg_oid,
                                       size_t reg_oid_len, unsigned int* it,
                                       Netsnmp_Node_Handler* subhandler)
{
    return netsnmp_register_watched_instance2(
        netsnmp_create_handler_registration(name, subhandler, reg_oid,
...
netsnmp_feature_child_of(read_only_int_instance, instance)
    ...
    int netsnmp_register_read_only_int_instance(
        const char* name, const oid* reg_oid, size_t reg_oid_len, int* it,
        Netsnmp_Node_Handler* subhandler)
{
    return netsnmp_register_watched_instance2(
        netsnmp_create_handler_registration(name, subhandler, reg_oid,
                                            reg_oid_len, HANDLER_CAN_RONLY),
        netsnmp_create_watcher_info((void*)it, sizeof(int), ASN_INTEGER,
                                    WATCHER_FIXED_SIZE));
}
...
netsnmp_feature_child_of(register_read_only_int_instance, netsnmp_unused)
    ...
    int register_read_only_int_instance(const char* name, const oid* reg_oid,
                                        size_t reg_oid_len, int* it,
                                        Netsnmp_Node_Handler* subhandler)
{
    return netsnmp_register_read_only_int_instance(name, reg_oid, reg_oid_len,
                                                   it, subhandler);
}
...
netsnmp_feature_child_of(register_read_only_ulong_instance_context, instance)
    ...
    int netsnmp_register_read_only_ulong_instance_context(
        const char* name, const oid* reg_oid, size_t reg_oid_len, u_long* it,
        Netsnmp_Node_Handler* subhandler, const char* contextName)
{
    netsnmp_handler_registration* myreg = netsnmp_create_handler_registration(
        name, subhandler, reg_oid, reg_oid_len, HANDLER_CAN_RONLY);
    if (myreg && contextName)
        myreg->contextName = strdup(contextName);
    return netsnmp_register_watched_instance2(
        myreg, netsnmp_create_watcher_info((void*)it, sizeof(u_long),
                                           ASN_UNSIGNED, WATCHER_FIXED_SIZE));
}
...
netsnmp_feature_child_of(register_ulong_instance_context, instance)
    ...
    int netsnmp_register_ulong_instance_context(
        const char* name, const oid* reg_oid, size_t reg_oid_len, u_long* it,
        Netsnmp_Node_Handler* subhandler, const char* contextName)
{
    netsnmp_handler_registration* myreg = netsnmp_create_handler_registration(
...
netsnmp_feature_child_of(register_read_only_counter32_instance_context,
                         instance)
#ifndef NETSNMP_FEATURE_REMOVE_REGISTER_READ_ONLY_COUNTER32_INSTANCE_CONTEXT
    int netsnmp_register_read_only_counter32_instance_context(
        const char* name, const oid* reg_oid, size_t reg_oid_len, u_long* it,
        Netsnmp_Node_Handler* subhandler, const char* contextName)
{
    netsnmp_handler_registration* myreg = netsnmp_create_handler_registration(
...
netsnmp_feature_child_of(register_read_only_long_instance_context, instance)
    ...
    int netsnmp_register_read_only_long_instance_context(
        const char* name, const oid* reg_oid, size_t reg_oid_len, long* it,
        Netsnmp_Node_Handler* subhandler, const char* contextName)
{
    netsnmp_handler_registration* myreg = netsnmp_create_handler_registration(
    ...
    if (myreg && contextName)
        myreg->contextName = strdup(contextName);
    return netsnmp_register_watched_instance2(
        myreg, netsnmp_create_watcher_info((void*)it, sizeof(long), ASN_INTEGER,
                                           WATCHER_FIXED_SIZE));
}
                                              ...
                                              const char* contextName)
{
    ...
    if (myreg && contextName)
        myreg->contextName = strdup(contextName);
    return netsnmp_register_watched_instance2(
        myreg, netsnmp_create_watcher_info((void*)it, sizeof(int), ASN_INTEGER,
                                           WATCHER_FIXED_SIZE));
}
...
netsnmp_feature_child_of(register_read_only_int_instance_context, instance)
    ...
    int netsnmp_register_read_only_int_instance_context(
        const char* name, const oid* reg_oid, size_t reg_oid_len, int* it,
        Netsnmp_Node_Handler* subhandler, const char* contextName)
{
    netsnmp_handler_registration* myreg = netsnmp_create_handler_registration(
...
netsnmp_feature_child_of(read_only_int_instance_context, instance)
    ...
    int register_read_only_int_instance_context(
        const char* name, const oid* reg_oid, size_t reg_oid_len, int* it,
        Netsnmp_Node_Handler* subhandler, const char* contextName)
{
    return netsnmp_register_read_only_int_instance_context(
        name, reg_oid, reg_oid_len, it, subhandler, contextName);
}
#endif /* NETSNMP_FEATURE_REMOVE_READ_ONLY_INT_INSTANCE_CONTEXT */

netsnmp_feature_child_of(register_num_file_instance, instance)
#ifndef NETSNMP_FEATURE_REMOVE_REGISTER_NUM_FILE_INSTANCE
    int netsnmp_register_num_file_instance(const char* name, const oid* reg_oid,
                                           size_t reg_oid_len,
                                           const char* file_name, int asn_type,
                                           int mode,
                                           Netsnmp_Node_Handler* subhandler,
                                           const char* contextName)
{
    ...
    if ((NULL == nfi) || (NULL == (nfi->file_name = strdup(file_name))))
    {
    ...
    nfi->refcnt = 1;
    myreg = get_reg(name, "file_num_handler", reg_oid, reg_oid_len, nfi, mode,
                    netsnmp_instance_num_file_handler, subhandler, contextName);
    if (NULL == myreg)
    {
...
netsnmp_feature_child_of(register_int_instance, instance)
     ...
     *
     * @param it           the integer value to be registered during
     *initialization
     *
     * @param subhandler   a handler to do whatever you want to do, otherwise
     *use NULL to use the default int handler.
     *
     * @return
     *      MIB_REGISTERED_OK is returned if the registration was a success.
     *	Failures are MIB_REGISTRATION_FAILED and MIB_DUPLICATE_REGISTRATION.
    ...
    switch (reqinfo->mode)
    {
        ...
        case MODE_SET_RESERVE2:
            ...
            netsnmp_request_add_list_data(
                requests, netsnmp_create_data_list(INSTANCE_HANDLER_NAME,
                                                   it_save, &free_wrapper));
            break;
        ...
        case MODE_SET_ACTION:
            ...
            DEBUGMSGTL(("helper:instance", "updated %s -> %ld\n",
                        nfi->file_name, *(requests->requestvb->val.integer)));
            it = *(requests->requestvb->val.integer);
            rewind(
                nfi->filep); /* rewind to make sure we are at the beginning */
        ...
        case MODE_SET_UNDO:
            it = *((u_int*)netsnmp_request_get_list_data(
                                    ...
                                    netsnmp_request_info* requests)
{
    ...
    cmp = snmp_oid_compare(requests->requestvb->name,
                           requests->requestvb->name_length, reginfo->rootoid,
                           reginfo->rootoid_len);
