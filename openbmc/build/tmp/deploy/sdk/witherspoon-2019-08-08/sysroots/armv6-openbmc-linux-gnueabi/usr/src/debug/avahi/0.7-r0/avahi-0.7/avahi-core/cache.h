...
typedef void* AvahiCacheWalkCallback(AvahiCache* c, AvahiKey* pattern,
...
void avahi_cache_start_poof(AvahiCache* c, AvahiKey* key,
                            const AvahiAddress* a);

/* Stop a previously started POOF algorithm for a record. (Used for response
 * suppresions records */
