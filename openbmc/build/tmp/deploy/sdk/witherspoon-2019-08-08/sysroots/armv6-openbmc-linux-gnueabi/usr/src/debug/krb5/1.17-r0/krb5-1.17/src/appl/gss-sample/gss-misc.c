 ...
 */
int send_token(s, flags, tok) int s;
int flags;
gss_buffer_t tok;
{
    int ret;
 ...
 */
int recv_token(s, flags, tok) int s;
int* flags;
gss_buffer_t tok;
{
    int ret;
...
static void display_status_1(m, code, type) char* m;
OM_uint32 code;
int type;
{
    OM_uint32 min_stat;
 ...
 */
void display_status(msg, maj_stat, min_stat) char* msg;
OM_uint32 maj_stat;
OM_uint32 min_stat;
{
...
void display_ctx_flags(flags) OM_uint32 flags;
{
