...
#define G_DBUS_INTERFACE_SKELETON_CLASS(k)                                     \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_DBUS_INTERFACE_SKELETON,              \
                             GDBusInterfaceSkeletonClass))
#define G_DBUS_INTERFACE_SKELETON_GET_CLASS(o)                                 \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DBUS_INTERFACE_SKELETON,            \
                               GDBusInterfaceSkeletonClass))
#define G_IS_DBUS_INTERFACE_SKELETON(o)                                        \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_DBUS_INTERFACE_SKELETON))
#define G_IS_DBUS_INTERFACE_SKELETON_CLASS(k)                                  \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_DBUS_INTERFACE_SKELETON))
 ...
 * @get_info: Returns a #GDBusInterfaceInfo. See
 * g_dbus_interface_skeleton_get_info() for details.
 * @get_vtable: Returns a #GDBusInterfaceVTable. See
 * g_dbus_interface_skeleton_get_vtable() for details.
 * @get_properties: Returns a #GVariant with all properties. See
 * g_dbus_interface_skeleton_get_properties().
 * @flush: Emits outstanding changes, if any. See
 * g_dbus_interface_skeleton_flush().
 * @g_authorize_method: Signal class handler for the
