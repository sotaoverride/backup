...
#define UBIFS_MIN_LEB_CNT                                                      \
    (UBIFS_SB_LEBS + UBIFS_MST_LEBS + UBIFS_MIN_LOG_LEBS +                     \
     UBIFS_MIN_LPT_LEBS + UBIFS_MIN_ORPH_LEBS + UBIFS_MIN_MAIN_LEBS)
...
#define UBIFS_FLG_MASK                                                         \
    (UBIFS_FLG_BIGLPT | UBIFS_FLG_SPACE_FIXUP | UBIFS_FLG_DOUBLE_HASH |        \
