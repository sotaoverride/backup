...
struct extract_from_attribute_base<Attribute, Exposed, true>
{
    typedef typename remove_const<typename remove_reference<
        typename fusion::result_of::at_c<Attribute, 0>::type>::type>::type
        elem_type;
...
struct extract_from_container
{
    ...
    typedef typename mpl::if_<
        ...
        Exposed const&, Exposed>::type type;
    ...
    static type call(Attribute const& attr, Context& ctx)
    {
        typedef typename mpl::and_<traits::is_string<Exposed>,
                                   traits::is_string<Attribute>>::type
            handle_strings;
...
struct extract_from
    : mpl::if_<mpl::and_<traits::is_container<Attribute>,
