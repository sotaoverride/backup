...
static const GOptionEntry entries[] = {{"parent", 'p', 0, G_OPTION_ARG_NONE,
                                        &parent,
                                        N_("Create parent directories"), NULL},
                                       {NULL}};
...
int handle_mkdir(int argc, char* argv[], gboolean do_help)
{
    ...
    g_option_context_set_description(
        context, _("gio mkdir is similar to the traditional mkdir utility, but "
                   "using GIO\n"
