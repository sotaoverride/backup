...
#define G_SOCKET_ADDRESS(o)                                                    \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_SOCKET_ADDRESS, GSocketAddress))
#define G_SOCKET_ADDRESS_CLASS(k)                                              \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_SOCKET_ADDRESS, GSocketAddressClass))
#define G_IS_SOCKET_ADDRESS(o)                                                 \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_SOCKET_ADDRESS))
#define G_IS_SOCKET_ADDRESS_CLASS(k)                                           \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_SOCKET_ADDRESS))
#define G_SOCKET_ADDRESS_GET_CLASS(o)                                          \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_SOCKET_ADDRESS, GSocketAddressClass))
...
struct _GSocketAddressClass
{
    ...
    gboolean (*to_native)(GSocketAddress* address, gpointer dest, gsize destlen,
                          GError** error);
};
