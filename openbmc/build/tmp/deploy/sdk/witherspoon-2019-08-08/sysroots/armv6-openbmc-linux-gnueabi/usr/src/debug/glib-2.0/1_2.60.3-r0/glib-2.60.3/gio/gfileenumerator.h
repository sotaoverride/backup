...
#define G_FILE_ENUMERATOR(o)                                                   \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_FILE_ENUMERATOR, GFileEnumerator))
#define G_FILE_ENUMERATOR_CLASS(k)                                             \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_FILE_ENUMERATOR, GFileEnumeratorClass))
#define G_IS_FILE_ENUMERATOR(o)                                                \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_FILE_ENUMERATOR))
#define G_IS_FILE_ENUMERATOR_CLASS(k)                                          \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_FILE_ENUMERATOR))
#define G_FILE_ENUMERATOR_GET_CLASS(o)                                         \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_FILE_ENUMERATOR,                    \
...
struct _GFileEnumeratorClass
{
    ...
    gboolean (*close_fn)(GFileEnumerator* enumerator, GCancellable* cancellable,
                         GError** error);
