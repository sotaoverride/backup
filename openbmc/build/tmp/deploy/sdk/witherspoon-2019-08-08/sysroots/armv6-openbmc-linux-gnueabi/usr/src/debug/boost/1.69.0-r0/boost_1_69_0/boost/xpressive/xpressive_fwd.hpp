...
typedef proto::expr<proto::tag::terminal, proto::term<mark_placeholder>, 0>
    basic_mark_tag;
...
template <typename BidiIter,
          typename RegexTraits =
              regex_traits<typename iterator_value<BidiIter>::type>,
...
typedef regex_id_filter_predicate<std::string::const_iterator>
    sregex_id_filter_predicate;
typedef regex_id_filter_predicate<char const*> cregex_id_filter_predicate;

#ifndef BOOST_XPRESSIVE_NO_WREGEX
typedef regex_id_filter_predicate<std::wstring::const_iterator>
