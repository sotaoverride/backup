 ...
 */
int tcpListenerTable_init_data(
    tcpListenerTable_registration* tcpListenerTable_reg)
{
    DEBUGMSGTL(
        ("verbose:tcpListenerTable:tcpListenerTable_init_data", "called\n"));
 ...
 */
void tcpListenerTable_container_init(netsnmp_container** container_ptr_ptr,
                                     netsnmp_cache* cache)
{
 ...
 */
void tcpListenerTable_container_shutdown(netsnmp_container* container_ptr)
{
    DEBUGMSGTL(("verbose:tcpListenerTable:tcpListenerTable_container_shutdown",
                "called\n"));
                            ...
                            netsnmp_container* container)
{
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS ==
         tcpListenerTable_indexes_set(rowreq_ctx, entry->loc_addr_len,
                                      (char*)entry->loc_addr,
 ...
 *
 */
int tcpListenerTable_container_load(netsnmp_container* container)
{
    netsnmp_container* raw_data = netsnmp_access_tcpconn_container_load(
        NULL, NETSNMP_ACCESS_TCPCONN_LOAD_ONLYLISTEN);
 ...
 *
 */
void tcpListenerTable_container_free(netsnmp_container* container)
{
 ...
 * @retval MFD_ERROR       : other error.
 */
int tcpListenerTable_row_prep(tcpListenerTable_rowreq_ctx* rowreq_ctx)
{
    DEBUGMSGTL(
        ("verbose:tcpListenerTable:tcpListenerTable_row_prep", "called\n"));
