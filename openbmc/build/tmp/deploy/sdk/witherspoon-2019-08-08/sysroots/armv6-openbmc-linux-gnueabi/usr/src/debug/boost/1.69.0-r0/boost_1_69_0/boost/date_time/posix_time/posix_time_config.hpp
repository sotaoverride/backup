...
typedef date_time::time_resolution_traits<
    ...
    boost::date_time::nano, 1000000000, 9>
    time_res_traits;
#else
// set up conditional test compilations
#define BOOST_DATE_TIME_HAS_MILLISECONDS
    ...
    : public date_time::time_duration<time_duration, time_res_traits>
{
  public:
    ...
    time_duration(hour_type hour, min_type min, sec_type sec,
                  fractional_seconds_type fs = 0) :
        date_time::time_duration<time_duration, time_res_traits>(hour, min, sec,
                                                                 fs)
    {
    }
    time_duration() :
