...
struct terminal_ex
{
    ...
    terminal_ex(Args const& args_) : args(args_)
    {
    }
...
struct lazy_terminal
{
    ...
    lazy_terminal(Actor const& actor_) : actor(actor_)
    {
    }
...
template <typename F, typename A0 = unused_type, typename A1 = unused_type,
          typename A2 = unused_type, typename Unused = unused_type>
struct make_lazy;
...
struct make_lazy<F, A0, A1>
{
    ...
    result_type operator()(F f, A0 const& _0_, A1 const& _1_) const
    {
        typedef typename result_type::proto_child0 child_type;
        return result_type::make(child_type(
            phoenix::detail::expression::function_eval<F, A0, A1>::make(f, _0_,
                                                                        _1_),
            f.proto_base().child0));
    }
};
...
struct make_lazy<F, A0, A1, A2>
{
    typedef typename proto::terminal<
        lazy_terminal<typename F::terminal_type,
                      typename phoenix::detail::expression::function_eval<
                          F, A0, A1, A2>::type,
                      3 // arity
                      >>::type result_type;
    typedef result_type type;

    result_type operator()(F f, A0 const& _0_, A1 const& _1_,
                           A2 const& _2_) const
    {
        typedef typename result_type::proto_child0 child_type;
        return result_type::make(child_type(
            phoenix::detail::expression::function_eval<F, A0, A1, A2>::make(
                f, _0_, _1_, _2_),
            f.proto_base().child0));
    }
};
...
struct contains_actor
    : bool_<phoenix::is_actor<A0>::value || phoenix::is_actor<A1>::value ||
...
template <typename Terminal>
struct terminal : proto::extends<typename proto::terminal<Terminal>::type,
                                 terminal<Terminal>>
{
    typedef terminal<Terminal> this_type;
    typedef Terminal terminal_type;

    typedef proto::extends<typename proto::terminal<Terminal>::type,
                           terminal<Terminal>>
        base_type;
...
#pragma warning(push)
// warning C4348: 'boost::spirit::terminal<...>::result_helper': redefinition of
// default parameter: parameter 3, 4
#pragma warning(disable : 4348)
#endif

    template <bool Lazy, typename A0, typename A1 = unused_type,
...
#pragma warning(pop)
    ...
    struct result_helper<false, A0>
    {
        typedef typename proto::terminal<terminal_ex<
            ...
            typename detail::result_of::make_vector<
                typename detail::to_nonlazy_arg<A0>::type>::type>>::type type;
    };
    ...
    struct result_helper<true, A0, A1, A2>
    {
        typedef typename make_lazy<
            this_type, typename detail::to_lazy_arg<A0>::type,
    ...
    template <typename A0, typename A1 = unused_type,
              typename A2 = unused_type // Support up to 3 args
              >
    struct result
    {
        typedef
            typename result_helper<detail::contains_actor<A0, A1, A2>::value,
                                   A0, A1, A2>::type type;
    };
    ...
    struct result<This(A0)>
    {
        typedef typename result_helper<
            detail::contains_actor<A0, unused_type, unused_type>::value, A0,
            unused_type, unused_type>::type type;
    };
    ...
    {
        typedef typename result_helper<
            detail::contains_actor<A0, A1, unused_type>::value, A0, A1,
                   ...
                   typename detail::contains_actor<A0>::is_false = 0) const
    {
        ...
        return result_type::make(
            child_type(detail::make_vector(_0_), this->proto_base().child0));
    }
                   ...
                   typename detail::contains_actor<A0>::is_true = 0) const
    {
        return make_lazy<this_type, typename phoenix::as_actor<A0>::type>()(
            *this, phoenix::as_actor<A0>::convert(_0_));
    }
...
{
    typedef
        typename spirit::terminal<Tag>::template result<A0, A1, A2>::type type;
};
} // namespace result_of
...
namespace tag
{
template <typename Data, typename Tag, typename DataTag1 = unused_type,
          typename DataTag2 = unused_type>
struct stateful_tag
{
    BOOST_SPIRIT_IS_TAG()
    ...
    : spirit::terminal<tag::stateful_tag<Data, Tag, DataTag1, DataTag2>>
{
    ...
    stateful_tag_type(Data const& data) : spirit::terminal<tag_type>(data)
    {
    }
...
#define BOOST_SPIRIT_DEFINE_TERMINALS_NAME_A(r, _, names)                      \
    BOOST_SPIRIT_TERMINAL_NAME(BOOST_PP_TUPLE_ELEM(2, 0, names),               \
...
#define BOOST_SPIRIT_DEFINE_TERMINALS_NAME_EX_A(r, _, names)                   \
    BOOST_SPIRIT_TERMINAL_NAME_EX(BOOST_PP_TUPLE_ELEM(2, 0, names),            \
                                  BOOST_PP_TUPLE_ELEM(2, 1, names))            \
    /***/
