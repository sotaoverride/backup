...
#ifndef _MSC_VER // if forward declared, msvc6.5 does not recognize them as
                 // inline
...
// forward declaration, required (at least) by Tru64 cxx V6.5-042
template <class Generator, class U>
inline typename Generator::result_type unwind_type(boost::type<U>* p = 0,
                                                   Generator* = 0);
#endif

template <class Generator, class U>
inline typename Generator::result_type unwind_type_cv(U* p, cv_unqualified,
                                                      Generator* = 0)
{
...
template <class Generator, class U>
inline typename Generator::result_type unwind_type_cv(U const* p, const_,
                                                      Generator* = 0)
{
...
template <class Generator, class U>
inline typename Generator::result_type unwind_type_cv(U volatile* p, volatile_,
                                                      Generator* = 0)
{
    return unwind_type(const_cast<U*>(p), (Generator*)0);
}
    ...
    BOOST_STATIC_CONSTANT(
        ...
        indirection = (is_pointer<U>::value ? pointer_ : 0) +
                      (indirect_traits::is_reference_to_pointer<U>::value
                           ...
                           : is_lvalue_reference<U>::value ? reference_ : 0));
