...
#define G_FILE_INFO(o)                                                         \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_FILE_INFO, GFileInfo))
#define G_FILE_INFO_CLASS(k)                                                   \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_FILE_INFO, GFileInfoClass))
...
#define G_FILE_INFO_GET_CLASS(o)                                               \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_FILE_INFO, GFileInfoClass))
 ...
 *that might have a different encoding. If the filename is not a valid string in
 *the encoding selected for the filesystem it is in then the copy name will not
 *be set.
 *
 * Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.
 **/
 ...
 *(in trash)" for a file in the trash. This is useful for instance as the window
 *title when displaying a directory or for a bookmarks menu.
 *
 * Corresponding #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_STRING.
 **/
 ...
 * Since: 2.34
 **/
#define G_FILE_ATTRIBUTE_STANDARD_SYMBOLIC_ICON                                \
    "standard::symbolic-icon" /* object (GIcon) */
...
#define G_FILE_ATTRIBUTE_STANDARD_FAST_CONTENT_TYPE                            \
    "standard::fast-content-type" /* string */
...
#define G_FILE_ATTRIBUTE_STANDARD_ALLOCATED_SIZE                               \
    "standard::allocated-size" /* uint64 */
...
#define G_FILE_ATTRIBUTE_STANDARD_SYMLINK_TARGET                               \
    "standard::symlink-target" /* byte string */
 ...
 *G_FILE_TYPE_MOUNTABLE) is mountable. Corresponding #GFileAttributeType is
 *%G_FILE_ATTRIBUTE_TYPE_BOOLEAN.
 **/
#define G_FILE_ATTRIBUTE_MOUNTABLE_CAN_MOUNT                                   \
    "mountable::can-mount" /* boolean */

/**
 * G_FILE_ATTRIBUTE_MOUNTABLE_CAN_UNMOUNT:
 *
 * A key in the "mountable" namespace for checking if a file (of type
 *G_FILE_TYPE_MOUNTABLE)  is unmountable. Corresponding #GFileAttributeType is
 *%G_FILE_ATTRIBUTE_TYPE_BOOLEAN.
 **/
#define G_FILE_ATTRIBUTE_MOUNTABLE_CAN_UNMOUNT                                 \
    "mountable::can-unmount" /* boolean */

/**
 * G_FILE_ATTRIBUTE_MOUNTABLE_CAN_EJECT:
 *
 * A key in the "mountable" namespace for checking if a file (of type
 *G_FILE_TYPE_MOUNTABLE) can be ejected. Corresponding #GFileAttributeType is
 *%G_FILE_ATTRIBUTE_TYPE_BOOLEAN.
 **/
#define G_FILE_ATTRIBUTE_MOUNTABLE_CAN_EJECT                                   \
    "mountable::can-eject" /* boolean */
...
#define G_FILE_ATTRIBUTE_MOUNTABLE_UNIX_DEVICE_FILE                            \
    "mountable::unix-device-file" /* string */
 ...
 *
 * A key in the "mountable" namespace for checking if a file (of type
 * G_FILE_TYPE_MOUNTABLE) can be started. Corresponding #GFileAttributeType is
 * %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.
 *
 * Since: 2.22
 */
#define G_FILE_ATTRIBUTE_MOUNTABLE_CAN_START                                   \
    "mountable::can-start" /* boolean */
...
#define G_FILE_ATTRIBUTE_MOUNTABLE_CAN_START_DEGRADED                          \
    "mountable::can-start-degraded" /* boolean */

/**
 * G_FILE_ATTRIBUTE_MOUNTABLE_CAN_STOP:
 *
 * A key in the "mountable" namespace for checking if a file (of type
 * G_FILE_TYPE_MOUNTABLE) can be stopped. Corresponding #GFileAttributeType is
 * %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.
 *
 * Since: 2.22
 */
...
#define G_FILE_ATTRIBUTE_MOUNTABLE_START_STOP_TYPE                             \
    "mountable::start-stop-type" /* uint32 (GDriveStartStopType) */

/**
 * G_FILE_ATTRIBUTE_MOUNTABLE_CAN_POLL:
 *
 * A key in the "mountable" namespace for checking if a file (of type
 * G_FILE_TYPE_MOUNTABLE) can be polled. Corresponding #GFileAttributeType is
 * %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.
 *
 * Since: 2.22
 */
 ...
 *
 * A key in the "mountable" namespace for checking if a file (of type
 * G_FILE_TYPE_MOUNTABLE) is automatically polled for media. Corresponding
 * #GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.
 *
 * Since: 2.22
 */
#define G_FILE_ATTRIBUTE_MOUNTABLE_IS_MEDIA_CHECK_AUTOMATIC                    \
    "mountable::is-media-check-automatic" /* boolean */
 ...
 *possible reparse tag values. Corresponding #GFileAttributeType is
 *%G_FILE_ATTRIBUTE_TYPE_UINT32.
 *
 * Since: 2.60
 **/
#define G_FILE_ATTRIBUTE_DOS_REPARSE_POINT_TAG                                 \
    "dos::reparse-point-tag" /* uint32 */
 ...
 * outdated. This attribute is %TRUE if the thumbnail is up-to-date with the
 ...
 *the file system, used in g_file_query_filesystem_info(). Corresponding
 *#GFileAttributeType is %G_FILE_ATTRIBUTE_TYPE_UINT64.
 **/
 ...
 *space left on the file system. Corresponding #GFileAttributeType is
 ...
 *
 * A key in the "filesystem" namespace for getting the number of bytes of used
 * on the file system. Corresponding #GFileAttributeType is
 * %G_FILE_ATTRIBUTE_TYPE_UINT64.
 *
 * Since: 2.32
 */
...
#define G_FILE_ATTRIBUTE_FILESYSTEM_USE_PREVIEW                                \
    "filesystem::use-preview" /* uint32 (GFilesystemPreviewType) */
