...
class ebo_functor_holder
{
  ...
  public:
    ...
    BOOST_INTRUSIVE_FORCEINLINE ebo_functor_holder() : t_()
    {
    }

    BOOST_INTRUSIVE_FORCEINLINE explicit ebo_functor_holder(const T& t) : t_(t)
    {
    }
    ...
    BOOST_INTRUSIVE_FORCEINLINE ebo_functor_holder(BOOST_FWD_REF(Arg1) arg1,
    ...
    BOOST_INTRUSIVE_FORCEINLINE ebo_functor_holder&
        operator=(BOOST_COPY_ASSIGN_REF(ebo_functor_holder) x)
    {
        this->get() = x.get();
        return *this;
    }
    ...
    BOOST_INTRUSIVE_FORCEINLINE ebo_functor_holder&
        operator=(BOOST_RV_REF(ebo_functor_holder) x)
    {
    ...
    BOOST_INTRUSIVE_FORCEINLINE T& get()
    {
        return t_;
    }
    BOOST_INTRUSIVE_FORCEINLINE const T& get() const
    {
        return t_;
    }
...
template <typename T>
class ebo_functor_holder<T, false> : public T
{
    BOOST_COPYABLE_AND_MOVABLE(ebo_functor_holder)
  ...
  public:
    ...
    BOOST_INTRUSIVE_FORCEINLINE ebo_functor_holder() : T()
    {
    }

    BOOST_INTRUSIVE_FORCEINLINE explicit ebo_functor_holder(const T& t) : T(t)
    {
    }
