...
krb5_error_code
    cms_contentinfo_create(krb5_context context,                        /* IN */
                           ...
                           int cms_msg_type, unsigned char* in_data,
                           unsigned int in_length, unsigned char** out_data,
 ...
 */
krb5_error_code
    cms_signeddata_create(krb5_context context,                        /* IN */
                          pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                          pkinit_req_crypto_context req_cryptoctx,     /* IN */
                          pkinit_identity_crypto_context id_cryptoctx, /* IN */
                          int cms_msg_type,                            /* IN
 ...
 */
krb5_error_code
    cms_signeddata_verify(krb5_context context,                        /* IN */
                          pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                          pkinit_req_crypto_context req_cryptoctx,     /* IN */
                          pkinit_identity_crypto_context id_cryptoctx, /* IN */
                          int cms_msg_type,                            /* IN
 ...
 */
krb5_error_code
    crypto_check_cert_eku(krb5_context context,                        /* IN */
                          pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                          pkinit_req_crypto_context req_cryptoctx,     /* IN */
                          pkinit_identity_crypto_context id_cryptoctx, /* IN */
 ...
 */
krb5_error_code pkinit_octetstring2key(krb5_context context,    /* IN */
 ...
 */
krb5_error_code
    client_create_dh(krb5_context context,                        /* IN */
                     pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                     pkinit_req_crypto_context req_cryptoctx,     /* IN */
                     pkinit_identity_crypto_context id_cryptoctx, /* IN */
                     int dh_size,                                 /* IN
 ...
 */
krb5_error_code
    client_process_dh(krb5_context context,                        /* IN */
                      pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                      pkinit_req_crypto_context req_cryptoctx,     /* IN */
                      pkinit_identity_crypto_context id_cryptoctx, /* IN */
 ...
 */
krb5_error_code
    server_check_dh(krb5_context context,                        /* IN */
                    pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                    pkinit_req_crypto_context req_cryptoctx,     /* IN */
                    pkinit_identity_crypto_context id_cryptoctx, /* IN */
 ...
 */
krb5_error_code
    server_process_dh(krb5_context context,                        /* IN */
                      pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                      pkinit_req_crypto_context req_cryptoctx,     /* IN */
                      pkinit_identity_crypto_context id_cryptoctx, /* IN */
 ...
 */
krb5_error_code
    create_issuerAndSerial(krb5_context context,                        /* IN */
                           pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                           pkinit_req_crypto_context req_cryptoctx,     /* IN */
                           pkinit_identity_crypto_context id_cryptoctx, /* IN */
 ...
 */
krb5_error_code
    crypto_load_certs(krb5_context context,                        /* IN */
                      pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                      pkinit_req_crypto_context req_cryptoctx,     /* IN */
 ...
 */
krb5_error_code
    pkinit_check_kdc_pkid(krb5_context context,                        /* IN */
                          pkinit_plg_crypto_context plg_cryptoctx,     /* IN */
                          pkinit_req_crypto_context req_cryptoctx,     /* IN */
                          pkinit_identity_crypto_context id_cryptoctx, /* IN */
