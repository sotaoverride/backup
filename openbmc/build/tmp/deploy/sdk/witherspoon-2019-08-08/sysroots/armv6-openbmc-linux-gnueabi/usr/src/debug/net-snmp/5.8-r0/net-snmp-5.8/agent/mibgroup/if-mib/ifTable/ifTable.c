...
static int _if_number_handler(netsnmp_mib_handler* handler,
...
void initialize_table_ifTable(void)
{
     ...
     */
    {
        ...
        myreg = netsnmp_create_handler_registration(
            "if number", _if_number_handler, reg_oid, OID_LENGTH(reg_oid),
            HANDLER_CAN_RONLY);
 ...
 */
int ifTable_rowreq_ctx_init(ifTable_rowreq_ctx* rowreq_ctx, void* user_init_ctx)
{
                ...
                size_t* ifDescr_val_ptr_len_ptr)
{
     ...
     * copy (* ifDescr_val_ptr_ptr ) data and (* ifDescr_val_ptr_len_ptr ) from
     * rowreq_ctx->data
     */
    /*
    ...
    (*ifDescr_val_ptr_len_ptr) = tmp_len * sizeof(rowreq_ctx->data.ifDescr[0]);
 ...
 *   settable   0
 *
 * Enum range: 149/256. Values:  other(1), regular1822(2), hdh1822(3),
ddnX25(4), rfc877x25(5), ethernetCsmacd(6), iso88023Csmacd(7),
iso88024TokenBus(8), iso88025TokenRing(9), iso88026Man(10), starLan(11),
proteon10Mbit(12), proteon80Mbit(13), hyperchannel(14), fddi(15), lapb(16),
sdlc(17), ds1(18), e1(19), basicISDN(20), primaryISDN(21),
propPointToPointSerial(22), ppp(23), softwareLoopback(24), eon(25),
ethernet3Mbit(26), nsip(27), slip(28), ultra(29), ds3(30), sip(31),
...
lapd(77), ipSwitch(78), rsrb(79), atmLogical(80), ds0(81), ds0Bundle(82),
bsc(83), async(84), cnr(85), iso88025Dtr(86), eplrs(87), arap(88), propCnls(89),
hostPad(90), termPad(91), frameRelayMPI(92), x213(93), adsl(94), radsl(95),
sdsl(96), vdsl(97), iso88025CRFPInt(98), myrinet(99), voiceEM(100),
voiceFXO(101), voiceFXS(102), voiceEncap(103), voiceOverIp(104), atmDxi(105),
atmFuni(106), atmIma(107), pppMultilinkBundle(108), ipOverCdlc(109),
ipOverClaw(110), stackToStack(111), virtualIpAddress(112), mpc(113),
ipOverAtm(114), iso88025Fiber(115), tdlc(116), gigabitEthernet(117), hdlc(118),
lapf(119), v37(120), x25mlp(121), x25huntGroup(122), trasnpHdlc(123),
interleave(124), fast(125), ip(126), docsCableMaclayer(127),
docsCableDownstream(128), docsCableUpstream(129), a12MppSwitch(130),
tunnel(131), coffee(132), ces(133), atmSubInterface(134), l2vlan(135),
l3ipvlan(136), l3ipxvlan(137), digitalPowerline(138), mediaMailOverIp(139),
dtm(140), dcn(141), ipForward(142), msdsl(143), ieee1394(144), if_gsn(145),
dvbRccMacLayer(146), dvbRccDownstream(147), dvbRccUpstream(148),
atmVirtual(149), mplsTunnel(150), srp(151), voiceOverAtm(152),
voiceOverFrameRelay(153), idsl(154), compositeLink(155), ss7SigLink(156),
propWirelessP2P(157), frForward(158), rfc1483(159), usb(160),
ieee8023adLag(161), bgppolicyaccounting(162), frf16MfrBundle(163),
h323Gatekeeper(164), h323Proxy(165), mpls(166), mfSigLink(167), hdsl2(168),
shdsl(169), ds1FDL(170), pos(171), dvbAsiIn(172), dvbAsiOut(173), plc(174),
nfas(175), tr008(176), gr303RDT(177), gr303IDT(178), isup(179),
propDocsWirelessMaclayer(180), propDocsWirelessDownstream(181),
...
radioMAC(188), atmRadio(189), imt(190), mvl(191), reachDSL(192),
...
actelisMetaLOOP(223), fcipLink(224)
 *
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifType_get(ifTable_rowreq_ctx* rowreq_ctx, u_long* ifType_val_ptr)
{
                      ...
                      size_t* ifPhysAddress_val_ptr_len_ptr)
{
     ...
     * copy (* ifPhysAddress_val_ptr_ptr ) data and (*
     * ifPhysAddress_val_ptr_len_ptr ) from rowreq_ctx->data
     */
    /*
 ...
 *   settable   0
 *
 * Enum range: 5/8. Values:  up(1), down(2), testing(3), unknown(4), dormant(5),
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifOutOctets_get(ifTable_rowreq_ctx* rowreq_ctx, u_long* ifOutOctets_val_ptr)
{
    /** we should have a non-NULL pointer */
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifOutErrors_get(ifTable_rowreq_ctx* rowreq_ctx, u_long* ifOutErrors_val_ptr)
{
    /** we should have a non-NULL pointer */
                   ...
                   size_t* ifSpecific_val_ptr_len_ptr)
{
     ...
     * copy (* ifSpecific_val_ptr_ptr ) data and (* ifSpecific_val_ptr_len_ptr )
...
int ifTable_commit(ifTable_rowreq_ctx* rowreq_ctx)
{
    ...
    if (save_flags & COLUMN_IFADMINSTATUS_FLAG)
    {
         ...
         */
        rc = netsnmp_access_interface_entry_set_admin_status(
            rowreq_ctx->data.ifentry, rowreq_ctx->data.ifAdminStatus);
        if (0 != rc)
        {
 ...
 *
 */
int ifAdminStatus_check_value(ifTable_rowreq_ctx* rowreq_ctx,
 ...
 */
int ifTable_check_dependencies(ifTable_rowreq_ctx* rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL(("internal:ifTable:ifTable_check_dependencies", "called\n"));
