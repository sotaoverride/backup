...
#define G_VOLUME_MONITOR(o)                                                    \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_VOLUME_MONITOR, GVolumeMonitor))
#define G_VOLUME_MONITOR_CLASS(k)                                              \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_VOLUME_MONITOR, GVolumeMonitorClass))
#define G_VOLUME_MONITOR_GET_CLASS(o)                                          \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_VOLUME_MONITOR, GVolumeMonitorClass))
#define G_IS_VOLUME_MONITOR(o)                                                 \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_VOLUME_MONITOR))
#define G_IS_VOLUME_MONITOR_CLASS(k)                                           \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_VOLUME_MONITOR))
