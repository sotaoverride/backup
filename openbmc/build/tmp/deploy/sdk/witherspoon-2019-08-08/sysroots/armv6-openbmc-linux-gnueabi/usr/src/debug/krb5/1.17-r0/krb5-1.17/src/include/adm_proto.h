...
krb5_error_code krb5_aprof_get_boolean(krb5_pointer, const char**, int,
                                       krb5_boolean*);
krb5_error_code krb5_aprof_get_deltat(krb5_pointer, const char**, krb5_boolean,
                                      krb5_deltat*);
krb5_error_code krb5_aprof_get_string(krb5_pointer, const char**, krb5_boolean,
                                      char**);
krb5_error_code krb5_aprof_get_string_all(krb5_pointer, const char**, char**);
krb5_error_code krb5_aprof_get_int32(krb5_pointer, const char**, krb5_boolean,
                                     krb5_int32*);
krb5_error_code krb5_aprof_finish(krb5_pointer);

/* str_conv.c */
krb5_error_code krb5_flagspec_to_mask(const char*, krb5_flags*, krb5_flags*);
...
krb5_error_code krb5_keysalt_iterate(
    krb5_key_salt_tuple*, krb5_int32, krb5_boolean,
    krb5_error_code (*)(krb5_key_salt_tuple*, krb5_pointer), krb5_pointer);

krb5_error_code krb5_string_to_keysalts(const char*, const char*, const char*,
