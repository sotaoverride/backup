...
static void encrypt_stream(void* context, byte* outbuf, const byte* inbuf,
                           size_t length)
{
    ...
    asm volatile("callq *%0\n\t"
                 : "+a"(fn), "+D"(context), "+S"(length), "+d"(inbuf),
                   "+c"(outbuf)
                 :
...
static void do_encrypt_stream(ARCFOUR_context* ctx, byte* outbuf,
...
static gcry_err_code_t do_arcfour_setkey(void* context, const byte* key,
                                         unsigned int keylen)
{
...
static gcry_err_code_t arcfour_setkey(void* context, const byte* key,
                                      unsigned int keylen)
{
    ARCFOUR_context* ctx = (ARCFOUR_context*)context;
...
static const char* selftest(void)
{
    ...
    static const byte key_1[] = {0x61, 0x8A, 0x63, 0xD2, 0xFB};
    static const byte plaintext_1[] = {0xDC, 0xEE, 0x4C, 0xF9, 0x2C};
    static const byte ciphertext_1[] = {0xF1, 0x38, 0x29, 0xC9, 0xDE};
