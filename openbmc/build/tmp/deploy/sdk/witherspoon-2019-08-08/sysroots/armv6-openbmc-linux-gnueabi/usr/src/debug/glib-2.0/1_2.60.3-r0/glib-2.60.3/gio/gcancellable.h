...
#define G_CANCELLABLE(o)                                                       \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_CANCELLABLE, GCancellable))
#define G_CANCELLABLE_CLASS(k)                                                 \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_CANCELLABLE, GCancellableClass))
#define G_IS_CANCELLABLE(o)                                                    \
    (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_CANCELLABLE))
#define G_IS_CANCELLABLE_CLASS(k)                                              \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_CANCELLABLE))
#define G_CANCELLABLE_GET_CLASS(o)                                             \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_CANCELLABLE, GCancellableClass))
