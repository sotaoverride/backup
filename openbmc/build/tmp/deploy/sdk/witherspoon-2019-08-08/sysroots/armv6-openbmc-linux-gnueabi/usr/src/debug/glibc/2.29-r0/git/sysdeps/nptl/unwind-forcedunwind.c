...
void (*__libgcc_s_resume)(struct _Unwind_Exception* exc) attribute_hidden
    __attribute__((noreturn));
static _Unwind_Reason_Code(*libgcc_s_personality) PERSONALITY_PROTO;
static _Unwind_Reason_Code (*libgcc_s_forcedunwind)(struct _Unwind_Exception*,
...
void __attribute_noinline__ pthread_cancel_init(void)
{
    ...
    if (handle == NULL ||
        ...
        (forcedunwind = __libc_dlsym(handle, "_Unwind_ForcedUnwind")) == NULL ||
...
void __nptl_unwind_freeres(void)
{
                                         ...
                                         void* stop_argument)
{
    ...
    _Unwind_Reason_Code (*forcedunwind)(struct _Unwind_Exception*,
                                        _Unwind_Stop_Fn, void*) =
