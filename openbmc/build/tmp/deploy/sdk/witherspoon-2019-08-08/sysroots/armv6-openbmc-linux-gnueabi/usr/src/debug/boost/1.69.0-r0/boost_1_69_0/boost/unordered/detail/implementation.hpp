...
template <class T>
std::ptrdiff_t const
    prime_list_template<T>::length = BOOST_PP_SEQ_SIZE(BOOST_UNORDERED_PRIMES);
#endif
...
#define BOOST_UNORDERED_EARGS(z, n, _)                                         \
    ...
    {                                                                          \
        BOOST_PP_REPEAT_##z(n, BOOST_UNORDERED_EARGS_MEMBER, _)                \
            BOOST_PP_CAT(emplace_args,                                         \
                         n)(BOOST_PP_ENUM_BINARY_PARAMS_Z(z, n, Arg, b)) :     \
...
template <typename A0, typename A1>
inline emplace_args2<A0, A1> create_emplace_args(BOOST_FWD_REF(A0) b0,
                                                 BOOST_FWD_REF(A1) b1)
{
...
template <typename A0, typename A1, typename A2>
inline emplace_args3<A0, A1, A2> create_emplace_args(BOOST_FWD_REF(A0) b0,
                                                     BOOST_FWD_REF(A1) b1,
                                                     BOOST_FWD_REF(A2) b2)
{
...
struct value_base
{
    ...
    typename boost::aligned_storage<
        sizeof(value_type), boost::alignment_of<value_type>::value>::type data_;
...
struct expr_test;
template <typename T>
struct expr_test<T, sizeof(char)> : T
{
};
} // namespace detail
} // namespace unordered
...
#define BOOST_UNORDERED_DEFAULT_EXPRESSION(count, result)                      \
    template <typename U>                                                      \
    static BOOST_PP_CAT(choice,                                                \
                        result)::type test(BOOST_PP_CAT(choice, count))

#define BOOST_UNORDERED_HAS_FUNCTION(name, thing, args, _)                     \
    struct BOOST_PP_CAT(has_, name)                                            \
    {                                                                          \
        template <typename U>                                                  \
        static char for_expr_test(U const&);                                   \
...
struct rebind_wrap
{
    template <typename X>
    static choice1::type
        test(choice1, typename X::BOOST_NESTED_TEMPLATE rebind<T>::other* = 0);
    template <typename X>
    static choice2::type test(choice2, void* = 0);
...
template <typename T>
BOOST_UNORDERED_HAS_FUNCTION(select_on_container_copy_construction, U const, (),
                             0);
...
template <typename T, typename ValueType>
BOOST_UNORDERED_HAS_FUNCTION(destroy, U,
                             (boost::unordered::detail::make<ValueType*>()), 1);
...
struct allocator_traits
{
    ...
    typedef BOOST_UNORDERED_DEFAULT_TYPE(Alloc, size_type,
  ...
  public:
    ...
    typedef BOOST_UNORDERED_DEFAULT_TYPE(Alloc, is_always_equal,
                                         typename boost::is_empty<Alloc>::type)
        is_always_equal;
};
} // namespace detail
} // namespace unordered
...
{
template <typename T>
inline void construct_value(T* address)
{
    new ((void*)address) T();
}
...
inline typename boost::enable_if_c<use_piecewise<A0>::value &&
    ...
    construct_from_args(Alloc& alloc, std::pair<A, B>* address,
                        BOOST_FWD_REF(A0), BOOST_FWD_REF(A1) a1,
                        BOOST_FWD_REF(A2) a2)
{
...
template <typename Alloc, typename A, typename B, typename A0, typename A1,
          typename A2>
inline void construct_from_args(
    Alloc& alloc, std::pair<A, B>* address,
...
struct node_constructor
{
    ...
    void reclaim(node_pointer p)
    {
        BOOST_ASSERT(!node_);
        node_ = p;
        BOOST_UNORDERED_CALL_DESTROY(node_allocator_traits, alloc_,
                                     node_->value_ptr());
    }
    ...
    construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
{
    ...
    a.create_node();
    boost::unordered::detail::allocator_traits<Alloc>::construct(
        alloc, a.node_->value_ptr(), std::piecewise_construct,
...
inline typename boost::unordered::detail::allocator_traits<Alloc>::pointer
    construct_node_pair_from_args(Alloc& alloc, BOOST_FWD_REF(Key) k,
                                  BOOST_FWD_REF(Args)... args)
{
    node_constructor<Alloc> a(alloc);
    a.create_node();
...
struct cl_iterator
{
  ...
  public:
    ...
    friend bool operator==(cl_iterator const& x,
                           cl_iterator const& y) BOOST_NOEXCEPT
    {
...
struct c_iterator
{
  ...
  public:
    ...
    friend bool operator==(c_iterator const& x,
                           c_iterator const& y) BOOST_NOEXCEPT
    {
  ...
  public:
    ...
    inline node_pointer copy_of(T const& v)
    {
        ...
        BOOST_UNORDERED_CALL_CONSTRUCT1(node_allocator_traits,
                                        constructor_.alloc_,
                                        constructor_.node_->value_ptr(), v);
    ...
    inline node_pointer move_copy_of(T& v)
    {
        ...
        BOOST_UNORDERED_CALL_CONSTRUCT1(
            node_allocator_traits, constructor_.alloc_,
...
node_holder<Alloc>::~node_holder()
{
    while (nodes_)
    {
        ...
        BOOST_UNORDERED_CALL_DESTROY(node_allocator_traits, constructor_.alloc_,
                                     p->value_ptr());
...
class functions
{
  ...
  private:
    ...
    typedef typename boost::aligned_storage<
        sizeof(function_pair), boost::alignment_of<function_pair>::value>::type
        aligned_function;
  ...
  public:
    ...
    functions(functions& bf, boost::unordered::detail::move_tag) : current_(0)
    {
        construct_functions(current_, bf.current_functions(),
    ...
    {
        return current_functions().first();
    }

    P const& key_eq() const
    {
        return current_functions().second();
    }
                                                   ...
                                                   typename Types::key_equal>
{
  ...
  public:
    ...
    typedef typename boost::unordered::detail::rebind_wrap<
        value_allocator, bucket>::type bucket_allocator;
    ...
    static node_pointer get_node(c_iterator it)
    {
        return it.node_;
    }
    ...
    table(std::size_t num_buckets, hasher const& hf, key_equal const& eq,
        ...
        functions(hf, eq),
        allocators_(a, a), bucket_count_(policy::new_bucket_count(num_buckets)),
        size_(0), mlf_(1.0f), max_load_(0), buckets_()
    {
    }

    table(table const& x, node_allocator const& a) :
        functions(x), allocators_(a, a),
        bucket_count_(x.min_buckets_for_size(x.size_)), size_(0), mlf_(x.mlf_),
    ...
    table(table& x, node_allocator const& a,
        ...
        functions(x, m),
        allocators_(a, a), bucket_count_(x.bucket_count_), size_(0),
    ...
    void create_buckets(std::size_t new_count)
    {
        ...
        else if (bucket::extra_node)
        {
            ...
            a.create_node();
            buckets_ = bucket_allocator_traits::allocate(bucket_alloc(),
                                                         new_count + 1);
    ...
    void swap(table& x, false_type)
    {
        ...
        swap_allocators(x, boost::unordered::detail::integral_constant<
                               bool, allocator_traits<node_allocator>::
    ...
    void swap(table& x)
    {
        ...
        swap(x, boost::unordered::detail::integral_constant<
                    bool, functions::nothrow_swappable>());
    }
    ...
    {
        BOOST_UNORDERED_CALL_DESTROY(node_allocator_traits, node_alloc(),
                                     n->value_ptr());
    ...
    void destroy_buckets()
    {
        ...
        bucket_allocator_traits::deallocate(bucket_alloc(), buckets_,
                                            bucket_count_ + 1);
    }
    ...
    node_pointer find_node_impl(std::size_t key_hash, Key const& k,
                                Pred const& eq) const
    {
    ...
    inline node_pointer resize_and_add_node_unique(node_pointer n,
                                                   std::size_t key_hash)
    {
    ...
    iterator emplace_hint_unique(c_iterator hint, const_key_type& k,
                                 BOOST_UNORDERED_EMPLACE_ARGS)
    {
    ...
    template <BOOST_UNORDERED_EMPLACE_TEMPLATE>
    emplace_return emplace_unique(const_key_type& k,
                                  BOOST_UNORDERED_EMPLACE_ARGS)
    {
        std::size_t key_hash = this->hash(k);
    ...
    template <BOOST_UNORDERED_EMPLACE_TEMPLATE>
    iterator emplace_hint_unique(c_iterator hint, no_key,
                                 BOOST_UNORDERED_EMPLACE_ARGS)
    {
    ...
    emplace_return insert_or_assign_unique(BOOST_FWD_REF(Key) k,
                                           BOOST_FWD_REF(M) obj)
    {
        std::size_t key_hash = this->hash(k);
        node_pointer pos = this->find_node(key_hash, k);
    ...
    iterator move_insert_node_type_with_hint_unique(c_iterator hint,
                                                    NodeType& np)
    {
        if (!np)
        {
    ...
    void insert_range_unique(no_key, InputIt i, InputIt j)
    {
        ...
        do
        {
            ...
            BOOST_UNORDERED_CALL_CONSTRUCT1(node_allocator_traits, a.alloc_,
                                            a.node_->value_ptr(), *i);
    ...
    static bool find_equiv(node_pointer n, node_pointer end,
                           value_type const& v)
    {
    ...
    static std::size_t count_equal_equiv(node_pointer n, node_pointer end,
                                         value_type const& v)
    {
        std::size_t count = 0;
        for (; n != end; n = next_node(n))
    ...
    inline node_pointer add_node_equiv(node_pointer n, std::size_t key_hash,
                                       node_pointer pos)
    {
        std::size_t bucket_index = this->hash_to_bucket(key_hash);
        n->bucket_info_ = bucket_index;
        ...
        else
        {
            ...
            if (!b->next_)
            {
                ...
                if (start_node->next_)
                {
                    this->get_bucket_pointer(
                            this->node_bucket(next_node(start_node)))
                        ->next_ = n;
                }
    ...
    template <typename NodeType>
    iterator move_insert_node_type_with_hint_equiv(c_iterator hint,
                                                   NodeType& np)
    {
        iterator result;
    ...
    void assign_buckets(table const& src, false_type)
    {
        ...
        for (node_pointer n = src.begin(); n;)
        {
            std::size_t key_hash = this->hash(this->get_key(n));
            node_pointer group_end(next_group(n));
            node_pointer pos = this->add_node_equiv(holder.copy_of(n->value()),
                                                    key_hash, node_pointer());
            for (n = next_node(n); n != group_end; n = next_node(n))
            {
    ...
    void move_assign_buckets(table& src, false_type)
    {
        ...
        for (node_pointer n = src.begin(); n;)
        {
            ...
            for (n = next_node(n); n != group_end; n = next_node(n))
            {
                this->add_node_equiv(holder.move_copy_of(n->value()), key_hash,
                                     pos);
            }
        }
    }
...
inline void table<Types>::rehash(std::size_t min_buckets)
{
    ...
    {
        min_buckets = policy::new_bucket_count((std::max)(
            min_buckets,
            boost::unordered::detail::double_to_size(
...
struct map_extractor
{
    ...
    static key_type const&
        extract(boost::rv<std::pair<key_type, Second>> const& v)
    {
        return v.first;
    }
    ...
    template <class Second>
    static key_type const&
        extract(boost::rv<std::pair<key_type const, Second>> const& v)
    {
        return v.first;
    }
#endif
...
struct node : boost::unordered::detail::value_base<T>
{
    ...
    typedef typename ::boost::unordered::detail::rebind_wrap<
        A, bucket<node_pointer>>::type bucket_allocator;
    typedef typename ::boost::unordered::detail::allocator_traits<
...
struct ptr_node : boost::unordered::detail::ptr_bucket
{
    ...
    void* address()
    {
        return value_base_.address();
    }
    value_type& value()
    {
        return value_base_.value();
    }
    value_type* value_ptr()
    {
        return value_base_.value_ptr();
    }
...
struct pick_node
{
    ...
    typedef boost::unordered::detail::allocator_traits<
        typename boost::unordered::detail::rebind_wrap<
            A, boost::unordered::detail::ptr_node<nonconst>>::type>
        tentative_node_traits;

    typedef boost::unordered::detail::allocator_traits<
        typename boost::unordered::detail::rebind_wrap<
            A, boost::unordered::detail::ptr_bucket>::type>
