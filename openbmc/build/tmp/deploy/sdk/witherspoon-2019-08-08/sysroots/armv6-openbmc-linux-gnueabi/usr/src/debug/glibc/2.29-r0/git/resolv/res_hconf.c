...
static const char* arg_trimdomain_list(const char* fname, int line_num,
                                       const char* args)
{
    const char* start;
    size_t len;
...
static const char* arg_bool(const char* fname, int line_num, const char* args,
                            unsigned flag)
{
...
libc_freeres_ptr(static struct netaddr {
    int addrtype;
    union
    {
        struct
