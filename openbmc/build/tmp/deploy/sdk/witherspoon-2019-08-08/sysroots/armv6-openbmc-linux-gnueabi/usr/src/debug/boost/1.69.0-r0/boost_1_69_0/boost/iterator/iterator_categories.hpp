...
struct iterator_category_to_traversal
    : mpl::eval_if< // if already convertible to a traversal tag, we're done.
          is_convertible<Cat, incrementable_traversal_tag>, mpl::identity<Cat>,
...
template <>
struct iterator_traversal<mpl::_> : iterator_traversal<mpl::_1>
{
};
#endif
          ...
          mpl::eval_if<
              ...
              mpl::eval_if<
                  ...
                  mpl::eval_if<
                      ...
                      mpl::identity<single_pass_traversal_tag>,
                      mpl::eval_if<is_convertible<Traversal,
                                                  incrementable_traversal_tag>,
...
//
// Trait to retrieve one of the iterator traversal tags from the iterator
...
template <>
struct pure_iterator_traversal<mpl::_> : pure_iterator_traversal<mpl::_1>
{
};
#endif
