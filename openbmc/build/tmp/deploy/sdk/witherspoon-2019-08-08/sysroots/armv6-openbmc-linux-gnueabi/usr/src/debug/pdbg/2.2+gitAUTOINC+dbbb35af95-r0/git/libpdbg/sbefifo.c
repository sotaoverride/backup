...
static void sbefifo_ffdc_set(struct sbefifo* sbefifo, uint8_t* buf,
                             uint32_t buflen, uint32_t status)
{
...
static uint32_t sbefifo_ffdc_get(struct sbefifo* sbefifo, const uint8_t** ffdc,
                                 uint32_t* ffdc_len)
{
    *ffdc = sbefifo->ffdc;
...
static int sbefifo_op(struct sbefifo* sbefifo, uint32_t* msg, uint32_t msg_len,
                      uint16_t cmd, uint8_t** out, uint32_t* out_len,
                      uint32_t* status)
{
    uint8_t* buf;
    uint32_t resp[2];
...
static int sbefifo_op_istep(struct sbefifo* sbefifo, uint32_t major,
                            uint32_t minor)
{
    uint8_t* out;
    uint32_t msg[3];
...
static int sbefifo_op_getmem(struct sbefifo* sbefifo, uint64_t addr,
                             uint8_t* data, uint64_t size, bool ci)
{
    uint8_t* out;
...
static int sbefifo_op_putmem(struct sbefifo* sbefifo, uint64_t addr,
                             uint8_t* data, uint64_t size, bool ci)
{
    uint8_t* out;
    uint32_t* msg;
...
static int sbefifo_op_control(struct sbefifo* sbefifo, uint32_t core_id,
                              uint32_t thread_id, uint32_t oper)
{
    uint8_t* out;
    uint32_t msg[3];
...
static int sbefifo_op_thread_start(struct sbefifo* sbefifo, uint32_t core_id,
                                   uint32_t thread_id)
{
...
static int sbefifo_op_thread_stop(struct sbefifo* sbefifo, uint32_t core_id,
                                  uint32_t thread_id)
{
    return sbefifo_op_control(sbefifo, core_id, thread_id,
...
static int sbefifo_op_thread_step(struct sbefifo* sbefifo, uint32_t core_id,
                                  uint32_t thread_id)
{
    return sbefifo_op_control(sbefifo, core_id, thread_id,
...
static int sbefifo_op_thread_sreset(struct sbefifo* sbefifo, uint32_t core_id,
                                    uint32_t thread_id)
{
    return sbefifo_op_control(sbefifo, core_id, thread_id,
...
static int sbefifo_op_chipop(struct sbefifo* sbefifo, uint32_t* msg,
...
__attribute__((constructor)) static void register_sbefifo(void)
{
