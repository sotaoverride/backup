...
static const serv_response_header disabled = {.version = NSCD_VERSION,
                                              .found = -1,
                                              .s_name_len = 0,
                                              .s_proto_len = 0,
                                              .s_aliases_cnt = 0,
...
const struct iovec serv_iov_disabled = {.iov_base = (void*)&disabled,
                                        .iov_len = sizeof(disabled)};

/* This is the standard reply in case we haven't found the dataset.  */
static const serv_response_header notfound = {.version = NSCD_VERSION,
                                              .found = 0,
                                              .s_name_len = 0,
                                              .s_proto_len = 0,
                                              .s_aliases_cnt = 0,
...
static time_t cache_addserv(struct database_dyn* db, int fd,
                            request_header* req, const void* key,
                            struct servent* serv, uid_t owner,
                            ...
                            int errval)
{
    ...
    else
    {
        ...
        total += (offsetof(struct dataset, strdata) + s_name_len + s_proto_len +
...
time_t readdservbyname(struct database_dyn* db, struct hashentry* he,
                       struct datahead* dh)
{
    request_header req = {.type = GETSERVBYNAME, .key_len = he->len};
...
time_t readdservbyport(struct database_dyn* db, struct hashentry* he,
                       struct datahead* dh)
{
    request_header req = {.type = GETSERVBYPORT, .key_len = he->len};
