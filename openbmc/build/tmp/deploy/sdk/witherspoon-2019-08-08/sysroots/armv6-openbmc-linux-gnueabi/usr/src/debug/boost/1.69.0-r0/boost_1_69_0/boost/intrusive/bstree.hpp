...
struct bstbase3
{
    ...
    typedef boost::intrusive::reverse_iterator<const_iterator>
        const_reverse_iterator;
    typedef BOOST_INTRUSIVE_IMPDEF(typename value_traits::pointer) pointer;
    typedef BOOST_INTRUSIVE_IMPDEF(typename value_traits::const_pointer)
        const_pointer;
    typedef BOOST_INTRUSIVE_IMPDEF(
        typename pointer_traits<pointer>::element_type) value_type;
    typedef BOOST_INTRUSIVE_IMPDEF(
        typename pointer_traits<pointer>::reference) reference;
    typedef BOOST_INTRUSIVE_IMPDEF(
        typename pointer_traits<const_pointer>::reference) const_reference;
    typedef BOOST_INTRUSIVE_IMPDEF(
        typename pointer_traits<const_pointer>::difference_type)
        difference_type;
    ...
    static const bool has_container_from_iterator =
        detail::is_same<header_holder_type,
                        detail::default_header_holder<node_traits>>::value;

    struct holder_t : public ValueTraits
    {
        BOOST_INTRUSIVE_FORCEINLINE explicit holder_t(
            const ValueTraits& vtraits) :
            ValueTraits(vtraits)
        {
        }
    ...
    static bstbase3&
        get_tree_base_from_end_iterator(const const_iterator& end_iterator)
    {
        BOOST_STATIC_ASSERT(has_container_from_iterator);
        node_ptr p = end_iterator.pointed_node();
        header_holder_type* h = header_holder_type::get_holder(p);
        holder_t* holder = get_parent_from_member<holder_t, header_holder_type>(
            h, &holder_t::root);
        bstbase3* base = get_parent_from_member<bstbase3, holder_t>(
            holder, &bstbase3::holder);
        return *base;
    }
    ...
    BOOST_INTRUSIVE_FORCEINLINE const_value_traits_ptr
        priv_value_traits_ptr() const
    {
        return pointer_traits<const_value_traits_ptr>::pointer_to(
            this->get_value_traits());
    }

    iterator begin()
    {
        return iterator(node_algorithms::begin_node(this->header_ptr()),
    ...
    {
        return const_iterator(node_algorithms::begin_node(this->header_ptr()),
                              this->priv_value_traits_ptr());
    }

    iterator end()
    {
        return iterator(node_algorithms::end_node(this->header_ptr()),
                        this->priv_value_traits_ptr());
    }
    ...
    {
        return const_iterator(node_algorithms::end_node(this->header_ptr()),
                              this->priv_value_traits_ptr());
    }

    BOOST_INTRUSIVE_FORCEINLINE iterator root()
    {
        return iterator(node_algorithms::root_node(this->header_ptr()),
                        this->priv_value_traits_ptr());
    }
    ...
    {
        return const_iterator(node_algorithms::root_node(this->header_ptr()),
                              this->priv_value_traits_ptr());
    }
    ...
    {
        node_algorithms::replace_node(
            get_value_traits().to_node_ptr(*replace_this), this->header_ptr(),
    ...
    {
        return iterator(node_algorithms::rebalance_subtree(root.pointed_node()),
                        this->priv_value_traits_ptr());
    }
    ...
    static iterator s_iterator_to(reference value)
    {
        ...
        return iterator(value_traits::to_node_ptr(value),
    ...
    static const_iterator s_iterator_to(const_reference value)
    {
        ...
        return const_iterator(
            value_traits::to_node_ptr(*pointer_traits<pointer>::const_cast_from(
    ...
    {
        return iterator(this->get_value_traits().to_node_ptr(value),
                        this->priv_value_traits_ptr());
    }
    ...
    {
        return const_iterator(
            this->get_value_traits().to_node_ptr(
                *pointer_traits<pointer>::const_cast_from(
                    pointer_traits<const_pointer>::pointer_to(value))),
            this->priv_value_traits_ptr());
    }
...
struct bst_key_types
{
    ...
    typedef typename get_key_of_value<VoidOrKeyOfValue, value_type>::type
        key_of_value;
    typedef typename key_of_value::type key_type;
    typedef typename get_compare<VoidOrKeyComp, key_type>::type key_compare;
    typedef tree_value_compare<ValuePtr, key_compare, key_of_value>
        value_compare;
};
...
struct bstbase2
    ...
    : public detail::ebo_functor_holder<typename bst_key_types<
          typename ValueTraits::pointer, VoidOrKeyOfValue, VoidOrKeyComp
      ...
      public bstbase3<ValueTraits, AlgoType, HeaderHolder>
{
    ...
    bstbase2(const key_compare& comp, const ValueTraits& vtraits) :
        detail::ebo_functor_holder<value_compare>(value_compare(comp)),
        treeheader_t(vtraits)
    {
    }
    ...
    BOOST_INTRUSIVE_FORCEINLINE const_iterator
    ...
    {
        return iterator(node_algorithms::lower_bound(this->header_ptr(), key,
                                                     this->key_node_comp(comp)),
                        this->priv_value_traits_ptr());
    }
    ...
    {
        return const_iterator(
            node_algorithms::lower_bound(this->header_ptr(), key,
                                         this->key_node_comp(comp)),
            this->priv_value_traits_ptr());
    }
    ...
    {
        return iterator(node_algorithms::upper_bound(this->header_ptr(), key,
                                                     this->key_node_comp(comp)),
                        this->priv_value_traits_ptr());
    }
    ...
    {
        return const_iterator(
            node_algorithms::upper_bound(this->header_ptr(), key,
                                         this->key_node_comp(comp)),
            this->priv_value_traits_ptr());
    }
    ...
    {
        typedef detail::key_nodeptr_comp<KeyTypeKeyCompare, value_traits,
                                         key_of_value>
            type;
    };
    ...
    BOOST_INTRUSIVE_FORCEINLINE
        typename key_node_comp_ret<KeyTypeKeyCompare>::type
        key_node_comp(KeyTypeKeyCompare comp) const
    {
        return detail::key_nodeptr_comp<KeyTypeKeyCompare, value_traits,
                                        key_of_value>(
            comp, &this->get_value_traits());
    }
    ...
    {
        return iterator(node_algorithms::find(this->header_ptr(), key,
                                              this->key_node_comp(comp)),
                        this->priv_value_traits_ptr());
    }
    ...
    {
        return const_iterator(node_algorithms::find(this->header_ptr(), key,
                                                    this->key_node_comp(comp)),
                              this->priv_value_traits_ptr());
    }
    ...
    {
        std::pair<node_ptr, node_ptr> ret(node_algorithms::equal_range(
        ...
        equal_range(const KeyType& key, KeyTypeKeyCompare comp) const
    {
        ...
        return std::pair<const_iterator, const_iterator>(
            const_iterator(ret.first, this->priv_value_traits_ptr()),
            const_iterator(ret.second, this->priv_value_traits_ptr()));
    }

    // lower_bound_range
    BOOST_INTRUSIVE_FORCEINLINE std::pair<iterator, iterator>
        lower_bound_range(const key_type& key)
    {
        return this->lower_bound_range(key, this->key_comp());
    }

    template <class KeyType, class KeyTypeKeyCompare>
    std::pair<iterator, iterator> lower_bound_range(const KeyType& key,
                                                    KeyTypeKeyCompare comp)
    {
        std::pair<node_ptr, node_ptr> ret(node_algorithms::lower_bound_range(
            this->header_ptr(), key, this->key_node_comp(comp)));
        return std::pair<iterator, iterator>(
            iterator(ret.first, this->priv_value_traits_ptr()),
            iterator(ret.second, this->priv_value_traits_ptr()));
    ...
    {
        return this->bounded_range(lower_key, upper_key, this->key_comp(),
    ...
    std::pair<iterator, iterator>
        bounded_range(const KeyType& lower_key, const KeyType& upper_key,
                      KeyTypeKeyCompare comp, bool left_closed,
                      bool right_closed)
    {
        std::pair<node_ptr, node_ptr> ret(node_algorithms::bounded_range(
    ...
    // insert_unique_check
    BOOST_INTRUSIVE_FORCEINLINE std::pair<iterator, bool>
        insert_unique_check(const key_type& key,
    ...
    BOOST_INTRUSIVE_FORCEINLINE std::pair<iterator, bool>
        insert_unique_check(const_iterator hint, const key_type& key,
                            insert_commit_data& commit_data)
    {
        return this->insert_unique_check(hint, key, this->key_comp(),
                                         commit_data);
    }
                        ...
                        insert_commit_data& commit_data)
    {
        ...
        return std::pair<iterator, bool>(
            iterator(ret.first, this->priv_value_traits_ptr()), ret.second);
    }
    ...
    {
        std::pair<node_ptr, bool> ret = (node_algorithms::insert_unique_check(
            this->header_ptr(), hint.pointed_node(), key,
...
// Due to MSVC's EBO implementation, to save space and maintain the ABI, we must
// put the non-empty size member in the first position, but if size is not going
// to be stored then we'll use an specialization that doesn't inherit from
// size_holder
template <class ValueTraits, class VoidOrKeyOfValue, class VoidOrKeyComp,
...
{
    typedef bstbase2<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp, AlgoType,
                     HeaderHolder>
        base_type;
    ...
    BOOST_INTRUSIVE_FORCEINLINE bstbase_hack(const key_compare& comp,
                                             const ValueTraits& vtraits) :
...
template <class ValueTraits, class VoidOrKeyOfValue, class VoidOrKeyComp,
          class SizeType, algo_types AlgoType, typename HeaderHolder>
struct bstbase_hack<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp, false,
                    SizeType, AlgoType, HeaderHolder>
...
{
    typedef bstbase_hack<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp,
                         ConstantTimeSize, SizeType, AlgoType, HeaderHolder>
        base_type;
    typedef ValueTraits value_traits;
    typedef typename base_type::value_compare value_compare;
    ...
    BOOST_INTRUSIVE_FORCEINLINE bstbase(const key_compare& comp,
                                        const ValueTraits& vtraits) :
        base_type(comp, vtraits)
    {
    }
    ...
    ~bstbase()
    {
        if (is_safe_autounlink<value_traits::link_mode>::value)
        {
            node_algorithms::clear_and_dispose(
                this->header_ptr(),
                detail::node_disposer<detail::null_disposer, value_traits,
                                      AlgoType>(detail::null_disposer(),
                                                &this->get_value_traits()));
                     ...
                     ConstantTimeSize, SizeType, AlgoType, HeaderHolder>
{
  public:
    /// @cond
    typedef bstbase<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp,
                    ConstantTimeSize, SizeType, AlgoType, HeaderHolder>
        data_type;
    ...
    typedef BOOST_INTRUSIVE_IMPDEF(typename data_type::key_of_value)
        key_of_value;
    typedef BOOST_INTRUSIVE_IMPDEF(
        typename pointer_traits<pointer>::reference) reference;
    typedef BOOST_INTRUSIVE_IMPDEF(
    ...
    typedef BOOST_INTRUSIVE_IMPDEF(typename data_type::value_compare)
        value_compare;
    ...
    typedef BOOST_INTRUSIVE_IMPDEF(boost::intrusive::reverse_iterator<iterator>)
        reverse_iterator;
    typedef BOOST_INTRUSIVE_IMPDEF(
        boost::intrusive::reverse_iterator<const_iterator>)
        const_reverse_iterator;
    typedef BOOST_INTRUSIVE_IMPDEF(typename value_traits::node_traits)
        node_traits;
    ...
    typedef BOOST_INTRUSIVE_IMPDEF(typename node_traits::const_node_ptr)
        const_node_ptr;
    /// @cond
    typedef typename get_algo<AlgoType, node_traits>::type algo_type;
    /// @endcond
  ...
  public:
    ...
    //!   constructor throws (this does not happen with predefined
    //!   Boost.Intrusive hooks) or the copy constructor of the key_compare
    //!   object throws. Basic guarantee.
    bstree_impl() : data_type(key_compare(), value_traits())
    {
    }

    //! <b>Effects</b>: Constructs an empty container with given comparison and
    //! traits.
    //!
    //! <b>Complexity</b>: Constant.
    //!
    ...
    //!   Boost.Intrusive hooks) or the copy constructor of the key_compare
    //!   object throws. Basic guarantee.
    explicit bstree_impl(const key_compare& cmp,
                         const value_traits& v_traits = value_traits()) :
        data_type(cmp, v_traits)
    {
    }

    //! <b>Requires</b>: Dereferencing iterator must yield an lvalue of type
    //! value_type.
    ...
    //!   comp and otherwise N * log N, where N is the distance between first
    //!   and last.
    //!
    //! <b>Throws</b>: If value_traits::node_traits::node
    //!   constructor throws (this does not happen with predefined
    //!   Boost.Intrusive hooks) or the copy constructor/operator() of the
    //!   key_compare object throws. Basic guarantee.
    ...
    //! <b>Effects</b>: Constructs a container moving resources from another
    //! container.
    //!   Internal comparison object and value traits are move constructed and
    //!   nodes belonging to x (except the node representing the "end") are
    //!   linked to *this.
    //!
    //! <b>Complexity</b>: Constant.
    //!
    //! <b>Throws</b>: If value_traits::node_traits::node's
    //!   move constructor throws (this does not happen with predefined
    //!   Boost.Intrusive hooks) or the move constructor of the comparison objet
    //!   throws.
    ...
    //!
    BOOST_INTRUSIVE_FORCEINLINE bstree_impl& operator=(BOOST_RV_REF(bstree_impl)
                                                           x)
    {
        this->swap(x);
        return *this;
    ...
    //!   are not deleted (i.e. no destructors are called), but the nodes
    //!   according to the value_traits template parameter are reinitialized and
    //!   thus can be reused.
    //!
    ...
    //! <b>Effects</b>: Returns an iterator pointing to the beginning of the
    //! container.
    //!
    //! <b>Complexity</b>: Constant.
    //!
    ...
    //! <b>Effects</b>: Returns a const_iterator pointing to the beginning of
    //! the container.
    //!
    //! <b>Complexity</b>: Constant.
    //!
    ...
    //! <b>Effects</b>: Returns an iterator pointing to the end of the
    //! container.
    //!
    //! <b>Complexity</b>: Constant.
    //!
    ...
    //! <b>Effects</b>: Returns a const_iterator pointing to the end of the
    //! container.
    //!
    //! <b>Complexity</b>: Constant.
    //!
    ...
    //! <b>Effects</b>: Returns a reverse_iterator pointing to the beginning of
    //! the
    //!    reversed container.
    //!
    //! <b>Complexity</b>: Constant.
    ...
    //! <b>Effects</b>: Returns a iterator pointing to the root node of the
    //! container or end() if not present.
    //!
    //! <b>Complexity</b>: Constant.
    //!
    //! <b>Throws</b>: Nothing.
    ...
    //! <b>Effects</b>: Returns a const_iterator pointing to the root node of
    //! the container or cend() if not present.
    //!
    //! <b>Complexity</b>: Constant.
    //!
    //! <b>Throws</b>: Nothing.
    ...
    //!   of the container.
    //!
    //! <b>Effects</b>: Returns a const reference to the container associated to
    //! the end iterator
    //!
    //! <b>Throws</b>: Nothing.
    //!
    ...
    void swap(bstree_impl& other)
    {
        ...
        // These can't throw
        node_algorithms::swap_tree(this->header_ptr(),
                                   node_ptr(other.header_ptr()));
    ...
    //!   and inserts them on *this. Copies the predicate from the source
    //!   container.
    //!
    ...
    //!
    //! <b>Throws</b>: If cloner throws or predicate copy assignment throws.
    //! Basic guarantee.
    ...
    void clone_from(const bstree_impl& src, Cloner cloner, Disposer disposer)
    {
        ...
        if (!src.empty())
        {
            detail::exception_disposer<bstree_impl, Disposer> rollback(
                *this, disposer);
            node_algorithms::clone(
                src.header_ptr(), this->header_ptr(),
                detail::node_cloner<Cloner, value_traits, AlgoType>(
                    cloner, &this->get_value_traits()),
                detail::node_disposer<Disposer, value_traits, AlgoType>(
                    disposer, &this->get_value_traits()));
    ...
    //! Basic guarantee.
    //!
    //! <b>Note</b>: This version can modify the source container, useful to
    //! implement
    //!    move semantics.
    template <class Cloner, class Disposer>
    void clone_from(BOOST_RV_REF(bstree_impl) src, Cloner cloner,
                    Disposer disposer)
    {
        this->clear_and_dispose(disposer);
        if (!src.empty())
        {
            ...
            node_algorithms::clone(
                src.header_ptr(), this->header_ptr(),
                detail::node_cloner<Cloner, value_traits, AlgoType, false>(
                    cloner, &this->get_value_traits()),
                detail::node_disposer<Disposer, value_traits, AlgoType>(
                    disposer, &this->get_value_traits()));
            this->sz_traits().set_size(src.sz_traits().get_size());
    ...
    //!   most logarithmic.
    //!
    //! <b>Throws</b>: If the internal key_compare ordering function throws.
    //! Strong guarantee.
    //!
    ...
    iterator insert_equal(const_iterator hint, reference value)
    {
        ...
        iterator ret(node_algorithms::insert_equal(
                         this->header_ptr(), hint.pointed_node(), to_insert,
                         this->key_node_comp(this->key_comp())),
                     this->priv_value_traits_ptr());
        this->sz_traits().increment();
        return ret;
    ...
    //!
    //! <b>Complexity</b>: Insert range is in general O(N * log(N)), where N is
    //! the
    //!   size of the range. However, it is linear in N if the range is already
    ...
    std::pair<iterator, bool> insert_unique(reference value)
    {
        insert_commit_data commit_data;
        std::pair<node_ptr, bool> ret = (node_algorithms::insert_unique_check(
            this->header_ptr(), key_of_value()(value),
            this->key_node_comp(this->key_comp()), commit_data));
        return std::pair<iterator, bool>(
    ...
    //!   a valid iterator
    //!
    //! <b>Effects</b>: Tries to insert x into the container, using "hint" as a
    //! hint
    ...
    iterator insert_unique(const_iterator hint, reference value)
    {
        insert_commit_data commit_data;
        std::pair<node_ptr, bool> ret = (node_algorithms::insert_unique_check(
            this->header_ptr(), hint.pointed_node(), key_of_value()(value),
            this->key_node_comp(this->key_comp()), commit_data));
    ...
    //! <b>Effects</b>: Checks if a value can be inserted in the container,
    //! using
    ...
    //! <b>Throws</b>: If the comp ordering function throws. Strong guarantee.
    //!
    //! <b>Notes</b>: This function is used to improve performance when
    //! constructing
    //!   a value_type is expensive: if there is an equivalent value
    //!   the constructed object must be discarded. Many times, the part of the
    //!   node that is used to impose the order is much cheaper to construct
    //!   than the value_type and this function offers the possibility to use
    //!   that part to check if the insertion will be successful.
    //!
    //!   If the check is successful, the user can construct the value_type and
    //!   use "insert_commit" to insert the object in constant-time. This gives
    //!   a total logarithmic complexity to the insertion: check(O(log(N)) +
    //!   commit(O(1)).
    //!
    //!   "commit_data" remains valid for a subsequent "insert_commit" only if
    //!   no more objects are inserted or erased from the container.
    template <class KeyType, class KeyTypeKeyCompare>
    std::pair<iterator, bool>
        insert_unique_check(const KeyType& key, KeyTypeKeyCompare comp,
                            insert_commit_data& commit_data);
    ...
    //!   a value_type is expensive: if there is an equivalent value
    //!   the constructed object must be discarded. Many times, the part of the
    //!   constructing that is used to impose the order is much cheaper to
    //!   construct than the value_type and this function offers the possibility
    //!   to use that key to check if the insertion will be successful.
    //!
    //!   If the check is successful, the user can construct the value_type and
    //!   use "insert_commit" to insert the object in constant-time. This can
    //!   give a total constant-time complexity to the insertion: check(O(1)) +
    //!   commit(O(1)).
    //!
    //!   "commit_data" remains valid for a subsequent "insert_commit" only if
    //!   no more objects are inserted or erased from the container.
    ...
    //!   No objects should have been inserted or erased from the container
    //!   between the "insert_check" that filled "commit_data" and the call to
    //!   "insert_commit".
    //!
    //! <b>Effects</b>: Inserts the value in the container using the information
    //! obtained
                                  ...
                                  const insert_commit_data& commit_data)
    {
      ...
      (defined(BOOST_ENABLE_ASSERT_DEBUG_HANDLER) && defined(NDEBUG)))
        ...
        node_algorithms::insert_unique_commit(this->header_ptr(), to_insert,
                                              commit_data);
        this->sz_traits().increment();
    ...
    //! <b>Throws</b>: Nothing.
    //!
    //! <b>Note</b>: This function does not check preconditions so if "pos" is
    //! not the successor of "value" container ordering invariant will be
    //! broken. This is a low-level function to be used only for performance
    //! reasons by advanced users.
    ...
    //!   less than the greatest inserted key container ordering invariant will
    //!   be broken. This function is slightly more efficient than using
    //!   "insert_before". This is a low-level function to be used only for
    //!   performance reasons by advanced users.
    ...
    //!
    //! <b>Note</b>: This function does not check preconditions so if value is
    //!   greater than the minimum inserted key container ordering invariant
    //!   will be broken. This function is slightly more efficient than using
    //!   "insert_before". This is a low-level function to be used only for
    //!   performance reasons by advanced users.
    ...
    //!
    //! <b>Complexity</b>: Average complexity for erase element is constant
    //! time.
    //!
    //! <b>Throws</b>: Nothing.
    //!
    ...
    iterator erase(const_iterator i)
    {
        ...
        if (safemode_or_autounlink)
            BOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(
                !node_algorithms::unique(to_erase));
    ...
    //! <b>Requires</b>: key is a value such that `*this` is partitioned with
    //! respect to
    //!   comp(nk, key) and !comp(key, nk), with comp(nk, key) implying
    //!   !comp(key, nk), with nk the key_type of a value_type inserted into
    //!   `*this`.
    //!
    ...
    template <class KeyType, class KeyTypeKeyCompare>
    BOOST_INTRUSIVE_DOC1ST(
        size_type, typename detail::disable_if_convertible<
                       KeyTypeKeyCompare BOOST_INTRUSIVE_I const_iterator
                           BOOST_INTRUSIVE_I size_type>::type)
    ...
    {
        size_type n;
        return this->private_erase(b, e, n, disposer);
    }

    //! <b>Requires</b>: key is a value such that `*this` is partitioned with
    //! respect to
    //!   comp(nk, key) and !comp(key, nk), with comp(nk, key) implying
    //!   !comp(key, nk) and nk the key_type of a value_type inserted into
    //!   `*this`.
    //!
    //! <b>Requires</b>: Disposer::operator()(pointer) shouldn't throw.
    //!
    ...
    BOOST_INTRUSIVE_DOC1ST(
        size_type, typename detail::disable_if_convertible<
                       KeyTypeKeyCompare BOOST_INTRUSIVE_I const_iterator
                           BOOST_INTRUSIVE_I size_type>::type)
    erase_and_dispose(const KeyType& key, KeyTypeKeyCompare comp,
                      Disposer disposer)
    {
        std::pair<iterator, iterator> p = this->equal_range(key, comp);
        size_type n;
    ...
    //!   if it's a safe-mode or auto-unlink value_type. Constant time
    //!   otherwise.
    //!
    //! <b>Throws</b>: Nothing.
    //!
    ...
    // as some algorithms have different behavior when non-const versions are
    // used (like splay trees).
    ...
    //! @copydoc ::boost::intrusive::bstree::lower_bound(const
    //! KeyType&,KeyTypeKeyCompare)
    template <class KeyType, class KeyTypeKeyCompare>
    const_iterator lower_bound(const KeyType& key,
                               KeyTypeKeyCompare comp) const;
    ...
    //! @copydoc ::boost::intrusive::bstree::upper_bound(const
    //! KeyType&,KeyTypeKeyCompare)
    template <class KeyType, class KeyTypeKeyCompare>
    ...
    //! @copydoc ::boost::intrusive::bstree::find(const
    //! KeyType&,KeyTypeKeyCompare)
    template <class KeyType, class KeyTypeKeyCompare>
    const_iterator find(const KeyType& key, KeyTypeKeyCompare comp) const;

    //! <b>Effects</b>: Finds a range containing all elements whose key is k or
    //!   an empty range that indicates the position where those elements would
    //!   be if they there is no elements with key k.
    //!
    //! <b>Complexity</b>: Logarithmic.
    //!
    //! <b>Throws</b>: If `key_compare` throws.
    ...
    //!   [!key_comp()(upper_key, lower_key) && !key_comp()(lower_key,
    //!   upper_key)] then
    //!   ('left_closed' || 'right_closed') must be false.
    //!
    //! <b>Effects</b>: Returns an a pair with the following criteria:
    //!
    //!   first = lower_bound(lower_key) if left_closed, upper_bound(lower_key)
    //!   otherwise
    //!
    //!   second = upper_bound(upper_key) if right_closed,
    //!   lower_bound(upper_key) otherwise
    //!
    //! <b>Complexity</b>: Logarithmic.
    //!
    //! <b>Throws</b>: If `key_compare` throws.
    //!
    //! <b>Note</b>: This function can be more efficient than calling
    //! upper_bound
    //!   and lower_bound for lower_value and upper_value.
    //!
    //! <b>Note</b>: Experimental function, the interface might change in future
    //! releases.
    std::pair<iterator, iterator> bounded_range(const key_type& lower_key,
                                                const key_type& upper_value,
                                                bool left_closed,
                                                bool right_closed);

    //! <b>Requires</b>:
    //!   `lower_key` is a value such that `*this` is partitioned with respect
    //!   to comp(nk, lower_key) if left_closed is true, with respect to
    //!   !comp(lower_key, nk) otherwise.
    //!
    //! `upper_key` is a value such that `*this` is partitioned with respect to
    //!   !comp(upper_key, nk) if right_closed is true, with respect to comp(nk,
    //!   upper_key) otherwise.
    //!
    ...
    //! <b>Effects</b>: Returns an a pair with the following criteria:
    //!
    //!   first = lower_bound(lower_key, comp) if left_closed,
    //!   upper_bound(lower_key, comp) otherwise
    //!
    //!   second = upper_bound(upper_key, comp) if right_closed,
    //!   lower_bound(upper_key, comp) otherwise
    //!
    //! <b>Complexity</b>: Logarithmic.
    //!
    //! <b>Throws</b>: If `comp` throws.
    ...
    //! @copydoc ::boost::intrusive::bstree::bounded_range(const key_type
    //! &,const key_type &,bool,bool)
    std::pair<const_iterator, const_iterator>
        bounded_range(const key_type& lower_key, const key_type& upper_key,
                      bool left_closed, bool right_closed) const;

    //! @copydoc ::boost::intrusive::bstree::bounded_range(const KeyType&,const
    //! KeyType&,KeyTypeKeyCompare,bool,bool)
    template <class KeyType, class KeyTypeKeyCompare>
    std::pair<const_iterator, const_iterator>
        bounded_range(const KeyType& lower_key, const KeyType& upper_key,
                      KeyTypeKeyCompare comp, bool left_closed,
    ...
    //! <b>Throws</b>: Nothing.
    //!
    //! <b>Note</b>: This static function is available only if the <i>value
    //! traits</i>
    //!   is stateless.
    static iterator s_iterator_to(reference value);
    ...
    //!
    //! <b>Effects</b>: init_node puts the hook of a value in a well-known
    //! default
    //!   state.
    //!
    //! <b>Throws</b>: Nothing.
    ...
    {
        node_ptr to_be_disposed(
            node_algorithms::unlink_leftmost_without_rebalance(
                this->header_ptr()));
        if (!to_be_disposed)
            return 0;
        this->sz_traits().decrement();
        if (safemode_or_autounlink) // If this is commented does not work with
                                    // normal_link
    ...
    //!   container with with_this. The container does not need to be
    //!   rebalanced.
    //!
    //! <b>Complexity</b>: Constant.
    //!
...
//! <b>Requires</b>: "source" container's Options can only can differ in the
//! comparison
//!   function from *this.
//!
//! <b>Effects</b>: Attempts to extract each element in source and insert it
//! into a using
//!   the comparison object of *this. If there is an element in a with key
//!   equivalent to the key of an element from source, then that element is not
//!   extracted from source.
//!
//! <b>Postcondition</b>: Pointers and references to the transferred elements of
//! source refer
//!   to those same elements but as members of *this. Iterators referring to the
//!   transferred elements will continue to refer to their elements, but they
//!   now behave as iterators into *this, not into source.
//!
...
//! <b>Complexity</b>: N log(a.size() + N) (N has the value source.size())
    ...
    void merge_unique(
        bstree_impl<ValueTraits, VoidOrKeyOfValue, Compare2, SizeType,
                    ConstantTimeSize, AlgoType, HeaderHolder>& source)
#endif
    {
        ...
        while (it != itend)
        {
            node_ptr const p(it);
            BOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(
                !safemode_or_autounlink || !node_algorithms::unique(p));
...
//! <b>Complexity</b>: N log(a.size() + N) (N has the value source.size())
    ...
    //! <b>Effects</b>: Asserts the integrity of the container with additional
    //! checks provided by the user.
    //!
    //! <b>Complexity</b>: Linear time.
    //!
    //! <b>Note</b>: The method might not have effect when asserts are turned
    //! off (e.g., with NDEBUG).
    ...
    {
        typedef detail::key_nodeptr_comp<key_compare, value_traits,
                                         key_of_value>
            nodeptr_comp_t;
        nodeptr_comp_t nodeptr_comp(this->key_comp(),
                                    &this->get_value_traits());
        typedef typename get_node_checker<AlgoType, ValueTraits, nodeptr_comp_t,
                                          ExtraChecker>::type node_checker_t;
        typename node_checker_t::return_type checker_return;
        node_algorithms::check(this->header_ptr(),
                               node_checker_t(nodeptr_comp, extra_checker),
                               checker_return);
        if (constant_time_size)
            BOOST_INTRUSIVE_INVARIANT_ASSERT(this->sz_traits().get_size() ==
                                             checker_return.node_count);
    }
    ...
    //! <b>Complexity</b>: Linear time.
    //!
    //! <b>Note</b>: The method has no effect when asserts are turned off (e.g.,
    //! with NDEBUG).
    //!   Experimental function, interface might change in future versions.
    void check() const
    {
    ...
    friend bool operator==(const bstree_impl& x, const bstree_impl& y)
    {
        ...
        return boost::intrusive::algo_equal(x.cbegin(), x.cend(), y.cbegin(),
                                            y.cend());
    }
    ...
    friend bool operator<(const bstree_impl& x, const bstree_impl& y)
    {
        return ::boost::intrusive::algo_lexicographical_compare(
...
//! Helper metafunction to define a \c bstree that yields to the same type when
//! the same options (either explicitly or implicitly) are used.
#if defined(BOOST_INTRUSIVE_DOXYGEN_INVOKED) ||                                \
    defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
template <class T, class... Options>
#else
template <class T, class O1 = void, class O2 = void, class O3 = void,
          class O4 = void, class O5 = void, class O6 = void>
#endif
struct make_bstree
{
    /// @cond
    typedef typename pack_options<bstree_defaults,
    ...
    typedef bstree_impl<value_traits, typename packed_options::key_of_value,
                        typename packed_options::compare,
                        typename packed_options::size_type,
                        packed_options::constant_time_size, BsTreeAlgorithms,
...
template <class T, class... Options>
#endif
class bstree : public make_bstree<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                  O1, O2, O3, O4, O5, O6
#else
                                  Options...
                                  ...
                                  >::type
{
    typedef typename make_bstree<T,
#if !defined(BOOST_INTRUSIVE_VARIADIC_TEMPLATES)
                                 O1, O2, O3, O4, O5, O6
#else
                                 Options...
  ...
  public:
    ...
    BOOST_STATIC_ASSERT(
        (detail::is_same<typename value_traits::value_type, T>::value));
    ...
    bstree(BOOST_RV_REF(bstree) x) : Base(BOOST_MOVE_BASE(Base, x))
    {
    }

    bstree& operator=(BOOST_RV_REF(bstree) x)
    {
        return static_cast<bstree&>(
            this->Base::operator=(BOOST_MOVE_BASE(Base, x)));
    }
    ...
    static const bstree&
        container_from_end_iterator(const_iterator end_iterator)
    {
        return static_cast<const bstree&>(
            Base::container_from_end_iterator(end_iterator));
    }
