...
extern struct rtnl_addr* rtnl_addr_get(struct nl_cache*, int, struct nl_addr*);

extern int rtnl_addr_build_add_request(struct rtnl_addr*, int, struct nl_msg**);
...
extern int rtnl_addr_build_delete_request(struct rtnl_addr*, int,
                                          struct nl_msg**);
extern int rtnl_addr_delete(struct nl_sock*, struct rtnl_addr*, int);
...
extern struct rtnl_link* rtnl_addr_get_link(struct rtnl_addr*);
