...
#endif
    static pointer pointer_to(typename detail::ptr_value<element_type>::type& v)
    {
...
struct pointer_traits<T*>
{
    ...
    using rebind = U*;
#endif
    static T* pointer_to(typename detail::ptr_value<T>::type& v) BOOST_NOEXCEPT
    {
...
template <class T>
BOOST_CONSTEXPR inline T* to_address(T* v) BOOST_NOEXCEPT
{
    return v;
}
...
template <class T>
inline T* ptr_address(T* v, int) BOOST_NOEXCEPT
{
    return v;
}

template <class T>
inline auto ptr_address(const T& v, int) BOOST_NOEXCEPT
...
template <class T>
inline auto ptr_address(const T& v, long) BOOST_NOEXCEPT
{
...
template <class T>
inline auto to_address(const T& v) BOOST_NOEXCEPT
{
