...
extern int __REDIRECT_NTH(stat,
...
extern int fstatat(int __fd, const char* __restrict __file,
                   struct stat* __restrict __buf, int __flag) __THROW
    __nonnull((2, 3));
#else
#ifdef __REDIRECT_NTH
extern int __REDIRECT_NTH(fstatat,
...
extern int fstatat64(int __fd, const char* __restrict __file,
                     struct stat64* __restrict __buf, int __flag) __THROW
    __nonnull((2, 3));
#endif
#endif
...
extern int lchmod(const char* __file, __mode_t __mode) __THROW __nonnull((1));
#endif
...
/* Like mkdir, create a new directory with permission bits MODE.  But
   ...
   with FD.  */
extern int mkdirat(int __fd, const char* __path, __mode_t __mode) __THROW
    __nonnull((2));
#endif
...
extern int mkfifo(const char* __path, __mode_t __mode) __THROW __nonnull((1));

#ifdef __USE_ATFILE
/* Like mkfifo, create a new FIFO with permission bits MODE.  But
   interpret relative PATH names relative to the directory associated
   with FD.  */
extern int mkfifoat(int __fd, const char* __path, __mode_t __mode) __THROW
    __nonnull((2));
#endif
...
extern int utimensat(int __fd, const char* __path,
                     const struct timespec __times[2], int __flags) __THROW
    __nonnull((2));
#endif
...
extern int __fxstat64(int __ver, int __fildes,
                      struct stat64* __stat_buf) __THROW __nonnull((3));
extern int __xstat64(int __ver, const char* __filename,
                     struct stat64* __stat_buf) __THROW __nonnull((2, 3));
extern int __lxstat64(int __ver, const char* __filename,
                      struct stat64* __stat_buf) __THROW __nonnull((2, 3));
extern int __fxstatat64(int __ver, int __fildes, const char* __filename,
                        struct stat64* __stat_buf, int __flag) __THROW
    __nonnull((3, 4));
#endif
...
extern int __xmknodat(int __ver, int __fd, const char* __path, __mode_t __mode,
                      __dev_t* __dev) __THROW __nonnull((3, 5));
...
#ifdef __USE_ATFILE
__extern_inline int __NTH(fstatat(int __fd, const char* __filename,
                                  struct stat* __statbuf, int __flag))
{
...
#ifdef __USE_MISC
__extern_inline int __NTH(mknod(const char* __path, __mode_t __mode,
                                __dev_t __dev))
{
...
#ifdef __USE_ATFILE
__extern_inline int __NTH(mknodat(int __fd, const char* __path, __mode_t __mode,
                                  __dev_t __dev))
{
...
#ifdef __USE_ATFILE
__extern_inline int __NTH(fstatat64(int __fd, const char* __filename,
                                    struct stat64* __statbuf, int __flag))
{
