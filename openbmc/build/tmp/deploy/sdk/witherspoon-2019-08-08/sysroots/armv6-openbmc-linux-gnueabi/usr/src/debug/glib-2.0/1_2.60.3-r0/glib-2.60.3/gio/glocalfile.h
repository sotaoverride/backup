...
#define G_LOCAL_FILE(o)                                                        \
    (G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_LOCAL_FILE, GLocalFile))
#define G_LOCAL_FILE_CLASS(k)                                                  \
    (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_LOCAL_FILE, GLocalFileClass))
#define G_IS_LOCAL_FILE(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_LOCAL_FILE))
#define G_IS_LOCAL_FILE_CLASS(k)                                               \
    (G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_LOCAL_FILE))
#define G_LOCAL_FILE_GET_CLASS(o)                                              \
    (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_LOCAL_FILE, GLocalFileClass))
