...
const char* const* k5_response_items_list_questions(const k5_response_items* ri)
{
    if (ri == NULL)
        return NULL;
...
static ssize_t find_question(const k5_response_items* ri, const char* question)
{
    size_t i;
...
static krb5_error_code push_question(k5_response_items* ri,
                                     const char* question,
