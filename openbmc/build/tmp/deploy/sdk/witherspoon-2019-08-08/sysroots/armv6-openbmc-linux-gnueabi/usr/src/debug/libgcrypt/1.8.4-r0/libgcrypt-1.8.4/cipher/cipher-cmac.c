...
static gcry_err_code_t cmac_tag(gcry_cipher_hd_t c, unsigned char* tag,
...
gcry_err_code_t _gcry_cipher_cmac_authenticate(gcry_cipher_hd_t c,
...
gcry_err_code_t _gcry_cipher_cmac_get_tag(gcry_cipher_hd_t c,
                                          unsigned char* outtag, size_t taglen)
{
    return cmac_tag(c, outtag, taglen, 0);
}

gcry_err_code_t _gcry_cipher_cmac_check_tag(gcry_cipher_hd_t c,
...
gcry_err_code_t _gcry_cipher_cmac_set_subkeys(gcry_cipher_hd_t c)
{
