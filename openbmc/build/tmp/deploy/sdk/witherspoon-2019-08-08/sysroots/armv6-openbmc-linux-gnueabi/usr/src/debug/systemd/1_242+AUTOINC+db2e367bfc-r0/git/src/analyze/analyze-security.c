...
struct security_assessor
{
    ...
    int (*assess)(const struct security_assessor* a,
                  const struct security_info* info, const void* data,
                  uint64_t* ret_badness, char** ret_description);
    size_t offset;
    uint64_t parameter;
...
static int assess_protect_home(const struct security_assessor* a,
                               ...
                               const void* data, uint64_t* ret_badness,
                                 ...
                                 char** ret_description)
{
    ...
    if (r < 0)
    {
        ...
        {
            badness = 3;
            description = "Service has very limited write access to the OS "
                          "file hierarchy";
        }
                                 ...
                                 char** ret_description)
{
    ...
    *ret_badness =
        empty_or_root(info->root_directory) || empty_or_root(info->root_image);
    *ret_description = NULL;
                        ...
                        uint64_t* ret_badness, char** ret_description)
{
    ...
    {
        d = "Files created by service are accessible only by service's own "
            "user by default";
        b = 0;
    }
...
static bool syscall_names_in_filter(Set* s, bool whitelist,
                                    const SyscallFilterSet* f)
{
    ...
    NULSTR_FOREACH(syscall, f->value)
    {
        ...
        /* Let's see if the system call actually exists on this platform, before
         * complaining */
                                     ...
                                     char** ret_description)
{
    ...
    if (!info->system_call_filter_whitelist &&
        set_isempty(info->system_call_filter))
    {
    ...
    else
    {
        ...
        log_debug("Analyzing system call filter, checking against: %s",
                  f->name);
        bad = syscall_names_in_filter(info->system_call_filter,
                                      info->system_call_filter_whitelist, f);
        ...
        if (info->system_call_filter_whitelist)
        {
            ...
            {
                (void)asprintf(&d,
                               "System call whitelist defined for service, and "
                               "%s is included",
                               f->name);
                b = 9;
            }
        ...
        else
        {
            ...
            {
                (void)asprintf(&d,
                               "System call blacklist defined for service, and "
                               "%s is not included",
                               f->name);
                b = 10;
            }
                                   ...
                                   char** ret_description)
{
    ...
    {
        d = strdup(
            "Service defines IP address whitelist with non-localhost entries");
        b = 5;
    }
    else if (info->ip_address_allow_localhost)
    {
        d = strdup(
            "Service defines IP address whitelits with only localhost entries");
        b = 2;
    }
    else
    {
...
static const struct security_assessor security_assessor_table[] = {
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#SupplementaryGroups=",
        .weight = 200,
        .range = 1,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#PrivateDevices=",
        .weight = 1000,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#PrivateMounts=",
        .weight = 1000,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#PrivateNetwork=",
        .weight = 2500,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#PrivateUsers=",
        .weight = 1000,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#ProtectControlGroups=",
        .weight = 1000,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#ProtectKernelModules=",
        .weight = 1000,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#ProtectKernelTunables=",
        .weight = 1000,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#ProtectHostname=",
        .weight = 50,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        .id = "ProtectSystem=",
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#ProtectSystem=",
        .weight = 1000,
        .range = 10,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#RootDirectory=",
        .weight = 200,
        .range = 1,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#LockPersonality=",
        .weight = 100,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#MemoryDenyWriteExecute=",
        .weight = 100,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#NoNewPrivileges=",
        .weight = 1000,
        .range = 1,
        .assess = assess_bool,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#CapabilityBoundingSet=",
        .weight = 1500,
        .range = 1,
    ...
    },
    {
        ...
        .assess = assess_capability_bounding_set,
        .parameter =
            (UINT64_C(1) << CAP_SYS_NICE) | (UINT64_C(1) << CAP_SYS_RESOURCE),
    },
    {
    ...
    },
    {
        ...
        .description_bad = "Service may change file ownership/access "
                           "mode/capabilities unrestricted",
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#CapabilityBoundingSet=",
        .weight = 1000,
        .range = 1,
    ...
    },
    {
        ...
        .assess = assess_capability_bounding_set,
        .parameter =
            (UINT64_C(1) << CAP_MAC_ADMIN) | (UINT64_C(1) << CAP_MAC_OVERRIDE),
    },
    {
    ...
    },
    {
        .id = "NotifyAccess=",
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#NotifyAccess=",
        .description_good =
    ...
    },
    {
        .id = "RestrictRealtime=",
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#RestrictRealtime=",
    ...
    },
    {
        .id = "RestrictSUIDSGID=",
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#RestrictSUIDSGID=",
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#RestrictNamespaces=",
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#RestrictAddressFamilies=",
    ...
    },
    {
        ...
        .assess = assess_bool,
        .offset =
            offsetof(struct security_info, restrict_address_family_netlink),
    },
    {
        ...
        .assess = assess_bool,
        .offset =
            offsetof(struct security_info, restrict_address_family_packet),
    },
    {
...
#if HAVE_SECCOMP
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#SystemCallFilter=",
        .weight = 1000,
        .range = 10,
...
#endif
    {
        .id = "IPAddressDeny=",
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#IPAddressDeny=",
        .weight = 1000,
        .range = 10,
    ...
    },
    {
        ...
        .url = "https://www.freedesktop.org/software/systemd/man/"
               "systemd.exec.html#AmbientCapabilities=",
        .description_good =
...
static int assess(const struct security_info* info, Table* overview_table,
                  AnalyzeSecurityFlags flags)
{
    static const struct
    {
        ...
        {75, "EXPOSED", ANSI_HIGHLIGHT_YELLOW,
    ...
    {
        details_table = table_new(" ", "name", "description", "weight",
                                  "badness", "range", "exposure");
        if (!details_table)
            return log_oom();
    ...
    for (i = 0; i < ELEMENTSOF(security_assessor_table); i++)
    {
        ...
        if (details_table)
        {
            ...
            r = table_add_cell_full(details_table, &cell, TABLE_STRING,
                                    checkmark, 1, 1, 0, 0, 0);
            if (r < 0)
    ...
    if (details_table)
    {
        ...
        {
            char buf[DECIMAL_STR_MAX(uint64_t) + 1 + DECIMAL_STR_MAX(uint64_t) +
                     1];
            ...
            x = DIV_ROUND_UP(DIV_ROUND_UP(*badness * *weight * 100U, *range),
                             weight_sum);
    ...
    if (details_table)
    {
        ...
        /* If we shall output the details table, also print the brief summary
         * underneath */
        ...
        printf("\n%s %sOverall exposure level for %s%s: %s%" PRIu64 ".%" PRIu64
               " %s%s %s\n",
               special_glyph(SPECIAL_GLYPH_ARROW), ansi_highlight(), name,
               ansi_normal(),
               colors_enabled() ? strempty(badness_table[i].color) : "",
               exposure / 10, exposure % 10, badness_table[i].name,
               ansi_normal(), special_glyph(badness_table[i].smiley));
    }
    ...
    if (overview_table)
    {
        ...
        r = table_add_cell(overview_table, &cell, TABLE_STRING,
                           badness_table[i].name);
        if (r < 0)
            return log_error_errno(r, "Failed to add cell to table: %m");
        (void)table_set_color(overview_table, cell,
                              strempty(badness_table[i].color));

        r = table_add_cell(overview_table, NULL, TABLE_STRING,
...
static int property_read_restrict_address_families(sd_bus* bus,
                                                   const char* member,
                                                   sd_bus_message* m,
                                                   sd_bus_error* error,
                                                   void* userdata)
...
static int property_read_system_call_filter(sd_bus* bus, const char* member,
                                            sd_bus_message* m,
...
static int property_read_ip_address_allow(sd_bus* bus, const char* member,
                                          sd_bus_message* m,
                                          sd_bus_error* error, void* userdata)
{
...
static int property_read_device_allow(sd_bus* bus, const char* member,
...
static int acquire_security_info(sd_bus* bus, const char* name,
                                 struct security_info* info,
                                 AnalyzeSecurityFlags flags)
{

    static const struct bus_properties_map security_map[] = {
        {"AmbientCapabilities", "t", NULL,
         offsetof(struct security_info, ambient_capabilities)},
        {"CapabilityBoundingSet", "t", NULL,
         offsetof(struct security_info, capability_bounding_set)},
        {"DefaultDependencies", "b", NULL,
         offsetof(struct security_info, default_dependencies)},
        {"Delegate", "b", NULL, offsetof(struct security_info, delegate)},
        {"DeviceAllow", "a(ss)", property_read_device_allow, 0},
        {"DevicePolicy", "s", NULL,
         offsetof(struct security_info, device_policy)},
        {"DynamicUser", "b", NULL,
         offsetof(struct security_info, dynamic_user)},
        {"FragmentPath", "s", NULL,
         offsetof(struct security_info, fragment_path)},
        ...
        {"KeyringMode", "s", NULL,
         offsetof(struct security_info, keyring_mode)},
        {"LoadState", "s", NULL, offsetof(struct security_info, load_state)},
        {"LockPersonality", "b", NULL,
         offsetof(struct security_info, lock_personality)},
        {"MemoryDenyWriteExecute", "b", NULL,
         offsetof(struct security_info, memory_deny_write_execute)},
        {"NoNewPrivileges", "b", NULL,
         offsetof(struct security_info, no_new_privileges)},
        {"NotifyAccess", "s", NULL,
         offsetof(struct security_info, notify_access)},
        {"PrivateDevices", "b", NULL,
         offsetof(struct security_info, private_devices)},
        {"PrivateMounts", "b", NULL,
         offsetof(struct security_info, private_mounts)},
        {"PrivateNetwork", "b", NULL,
         offsetof(struct security_info, private_network)},
        {"PrivateTmp", "b", NULL, offsetof(struct security_info, private_tmp)},
        {"PrivateUsers", "b", NULL,
         offsetof(struct security_info, private_users)},
        {"ProtectControlGroups", "b", NULL,
         offsetof(struct security_info, protect_control_groups)},
        {"ProtectHome", "s", NULL,
         offsetof(struct security_info, protect_home)},
        {"ProtectHostname", "b", NULL,
         offsetof(struct security_info, protect_hostname)},
        {"ProtectKernelModules", "b", NULL,
         offsetof(struct security_info, protect_kernel_modules)},
        {"ProtectKernelTunables", "b", NULL,
         offsetof(struct security_info, protect_kernel_tunables)},
        {"ProtectSystem", "s", NULL,
         offsetof(struct security_info, protect_system)},
        {"RemoveIPC", "b", NULL, offsetof(struct security_info, remove_ipc)},
        {"RestrictAddressFamilies", "(bas)",
         property_read_restrict_address_families, 0},
        {"RestrictNamespaces", "t", NULL,
         offsetof(struct security_info, restrict_namespaces)},
        {"RestrictRealtime", "b", NULL,
         offsetof(struct security_info, restrict_realtime)},
        {"RestrictSUIDSGID", "b", NULL,
         offsetof(struct security_info, restrict_suid_sgid)},
        {"RootDirectory", "s", NULL,
         offsetof(struct security_info, root_directory)},
        {"RootImage", "s", NULL, offsetof(struct security_info, root_image)},
        {"SupplementaryGroups", "as", NULL,
         offsetof(struct security_info, supplementary_groups)},
        {"SystemCallArchitectures", "as", NULL,
    ...
    r = bus_map_all_properties(
        bus, "org.freedesktop.systemd1", path, security_map,
        BUS_MAP_STRDUP | BUS_MAP_BOOLEAN_AS_BOOL, &error, NULL, info);
    if (r < 0)
        return log_error_errno(r, "Failed to get unit properties: %s",
    ...
    if (FLAGS_SET(flags, ANALYZE_SECURITY_ONLY_LONG_RUNNING) &&
        streq_ptr(info->type, "oneshot"))
        return -EMEDIUMTYPE;

    if (info->private_devices || info->private_tmp ||
        info->protect_control_groups || info->protect_kernel_tunables ||
        info->protect_kernel_modules || !streq_ptr(info->protect_home, "no") ||
        !streq_ptr(info->protect_system, "no") || info->root_image)
...
static int analyze_security_one(sd_bus* bus, const char* name,
                                ...
                                AnalyzeSecurityFlags flags)
{
    ...
    if (r == -EMEDIUMTYPE) /* Ignore this one because not loaded or Type is
                              oneshot */
        return 0;
    if (r < 0)
        return r;
...
int analyze_security(sd_bus* bus, char** units, AnalyzeSecurityFlags flags)
{
    ...
    else
    {
        ...
        STRV_FOREACH(i, units)
        {
            ...
            if (r < 0)
                return log_error_errno(r, "Failed to mangle unit name '%s': %m",
                                       *i);
            ...
            {
                r = unit_name_replace_instance(mangled, "test-instance",
                                               &instance);
                if (r < 0)
                    return log_oom();
