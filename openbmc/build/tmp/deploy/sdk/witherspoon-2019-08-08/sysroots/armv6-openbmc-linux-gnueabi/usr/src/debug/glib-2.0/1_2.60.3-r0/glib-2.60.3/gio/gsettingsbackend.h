...
#error                                                                         \
    "You must define G_SETTINGS_ENABLE_BACKEND before including <gio/gsettingsbackend.h>."
#endif
...
#define G_SETTINGS_BACKEND(inst)                                               \
    (G_TYPE_CHECK_INSTANCE_CAST((inst), G_TYPE_SETTINGS_BACKEND,               \
                                GSettingsBackend))
#define G_SETTINGS_BACKEND_CLASS(class)                                        \
    (G_TYPE_CHECK_CLASS_CAST((class), G_TYPE_SETTINGS_BACKEND,                 \
                             GSettingsBackendClass))
#define G_IS_SETTINGS_BACKEND(inst)                                            \
    (G_TYPE_CHECK_INSTANCE_TYPE((inst), G_TYPE_SETTINGS_BACKEND))
#define G_IS_SETTINGS_BACKEND_CLASS(class)                                     \
    (G_TYPE_CHECK_CLASS_TYPE((class), G_TYPE_SETTINGS_BACKEND))
#define G_SETTINGS_BACKEND_GET_CLASS(inst)                                     \
    (G_TYPE_INSTANCE_GET_CLASS((inst), G_TYPE_SETTINGS_BACKEND,                \
                               GSettingsBackendClass))
...
struct _GSettingsBackendClass
{
    ...
    GVariant* (*read_user_value)(GSettingsBackend* backend, const gchar* key,
                                 const GVariantType* expected_type);
