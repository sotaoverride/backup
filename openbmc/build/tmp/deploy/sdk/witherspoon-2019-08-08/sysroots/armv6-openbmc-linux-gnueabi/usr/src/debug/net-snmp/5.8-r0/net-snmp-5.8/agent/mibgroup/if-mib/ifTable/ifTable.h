...
int ifDescr_check_value(ifTable_rowreq_ctx* rowreq_ctx, char* ifDescr_val_ptr,
                        size_t ifDescr_val_ptr_len);
int ifDescr_undo_setup(ifTable_rowreq_ctx* rowreq_ctx);
int ifDescr_set(ifTable_rowreq_ctx* rowreq_ctx, char* ifDescr_val_ptr,
                size_t ifDescr_val_ptr_len);
...
int ifPhysAddress_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifOperStatus_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifLastChange_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifInUcastPkts_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifInNUcastPkts_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifInDiscards_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifInUnknownProtos_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifOutOctets_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifOutUcastPkts_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifOutNUcastPkts_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifOutDiscards_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifOutErrors_check_value(ifTable_rowreq_ctx* rowreq_ctx,
...
int ifSpecific_set(ifTable_rowreq_ctx* rowreq_ctx, oid* ifSpecific_val_ptr,
                   size_t ifSpecific_val_ptr_len);
