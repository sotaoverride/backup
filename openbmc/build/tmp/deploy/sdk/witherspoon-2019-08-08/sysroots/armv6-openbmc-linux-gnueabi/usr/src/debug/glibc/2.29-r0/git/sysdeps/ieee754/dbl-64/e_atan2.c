...
double SECTION __ieee754_atan2(double y, double x)
{
    int i, de, ux, dx, uy, dy;
    static const int pr[MM] = {6, 8, 10, 20, 32};
    double ax, ay, u, du, u9, ua, v, vv, dv, t1, t2, t3, t7, t8, z, zz, cor, s1,
        ss1, s2, ss2;
#ifndef DLA_FMS
    double t4, t5, t6;
#endif
    ...
    if (x > 0)
    {
        ...
        if (ay < ax)
        {
            ...
            zz =
                ...
                (dv * t2 +
                 v * v *
                     (cij[i][3].d +
                      v * (cij[i][4].d + v * (cij[i][5].d + v * cij[i][6].d))));
            if (i < 112)
            {
                if (i < 48)
                    u9 = u91.d; /* u < 1/4	*/
        ...
        if (u < inv16.d)
        {
            ...
            MUL2(u, du, u, du, v, vv, t1, t2, t3, t4, t5, t6, t7, t8);
            s1 = v *
                 (f11.d + v * (f13.d + v * (f15.d + v * (f17.d + v * f19.d))));
            ADD2(f9.d, ff9.d, s1, 0, s2, ss2, t1, t2);
            MUL2(v, vv, s2, ss2, s1, ss1, t1, t2, t3, t4, t5, t6, t7, t8);
            ADD2(f7.d, ff7.d, s1, ss1, s2, ss2, t1, t2);
            MUL2(v, vv, s2, ss2, s1, ss1, t1, t2, t3, t4, t5, t6, t7, t8);
        ...
        s1 = v *
             (hij[i][11].d +
              v * (hij[i][12].d +
                   v * (hij[i][13].d + v * (hij[i][14].d + v * hij[i][15].d))));
    ...
    if (u < inv16.d)
    {
        ...
        zz = u * v *
             (d3.d +
              v * (d5.d + v * (d7.d + v * (d9.d + v * (d11.d + v * d13.d)))));
        ESUB(opi.d, u, t2, cor);
        t3 = ((opi1.d + cor) - du) - zz;
...
strong_alias(__ieee754_atan2, __atan2_finite)
    ...
    static double SECTION normalized(double ax, double ay, double y, double z)
{
    int p;
...
static double SECTION atan2Mp(double x, double y, const int pr[])
{
    double z1, z2;
    int i, p;
