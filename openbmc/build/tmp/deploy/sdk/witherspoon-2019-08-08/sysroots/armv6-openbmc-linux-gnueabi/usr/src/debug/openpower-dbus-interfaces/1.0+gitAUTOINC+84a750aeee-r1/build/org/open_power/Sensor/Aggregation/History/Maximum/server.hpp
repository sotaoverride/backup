...
class Maximum
{
  public:
    ...
    using PropertiesVariant =
        std::variant<std::vector<std::tuple<uint64_t, int64_t>>, Unit, int64_t>;
    ...
    virtual std::vector<std::tuple<uint64_t, int64_t>>
        values(std::vector<std::tuple<uint64_t, int64_t>> value,
               bool skipSignal);
    /** Set value of Values */
    virtual std::vector<std::tuple<uint64_t, int64_t>>
        values(std::vector<std::tuple<uint64_t, int64_t>> value);
     ...
     *                 "org.open_power.Sensor.Aggregation.History.Maximum.<value
     * name>"
  ...
  private:
    ...
    static int _callback_get_Values(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);
    /** @brief sd-bus callback for set-property 'Values' */
    static int _callback_set_Values(sd_bus*, const char*, const char*,
                                    const char*, sd_bus_message*, void*,
                                    sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _org_open_power_Sensor_Aggregation_History_Maximum_interface;
