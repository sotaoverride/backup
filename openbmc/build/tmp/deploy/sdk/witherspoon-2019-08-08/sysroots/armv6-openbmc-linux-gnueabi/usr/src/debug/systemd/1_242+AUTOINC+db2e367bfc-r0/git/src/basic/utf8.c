...
char* utf16_to_utf8(const char16_t* s, size_t length /* bytes! */)
{
    ...
    /* Input length is in bytes, i.e. the shortest possible character takes 2
     * bytes. Each unicode character may
...
char16_t* utf8_to_utf16(const char* s, size_t length)
{
    ...
    for (i = 0; i < length;)
    {
        ...
        if (i + e >
            length) /* sequence longer than input buffer, then copy as-is */
            goto copy;
...
int utf8_encoded_valid_unichar(const char* str, size_t length /* bytes */)
{
    ...
    /* We read until NUL, at most length bytes. (size_t) -1 may be used to
...
size_t utf8_n_codepoints(const char* str)
{
    ...
    /* Returns the number of UTF-8 codepoints in this string, or (size_t) -1 if
...
size_t utf8_console_width(const char* str)
{
    ...
    /* Returns the approximate width a string will take on screen when printed
     * on a character cell terminal/console. */
