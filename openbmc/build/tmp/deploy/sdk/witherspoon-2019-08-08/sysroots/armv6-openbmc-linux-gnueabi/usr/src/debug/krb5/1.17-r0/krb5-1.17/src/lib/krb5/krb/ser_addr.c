 ...
 */
static krb5_error_code krb5_address_size(krb5_context, krb5_pointer, size_t*);
static krb5_error_code krb5_address_externalize(krb5_context, krb5_pointer,
                                                krb5_octet**, size_t*);
static krb5_error_code krb5_address_internalize(krb5_context, krb5_pointer*,
                                                krb5_octet**, size_t*);
 ...
 *                                the krb5_address.
 */
static krb5_error_code krb5_address_size(krb5_context kcontext,
    ...
    if ((address = (krb5_address*)arg))
    {
        *sizep +=
            (sizeof(krb5_int32) + sizeof(krb5_int32) + sizeof(krb5_int32) +
             sizeof(krb5_int32) + (size_t)address->length);
        kret = 0;
    }
    return (kret);
}
 ...
 */
static krb5_error_code krb5_address_externalize(krb5_context kcontext,
                                                krb5_pointer arg,
                                                krb5_octet** buffer,
                                                size_t* lenremain)
{
    ...
    if ((address = (krb5_address*)arg))
    {
            ...
            (required <= remain))
        {
            ...
            /* Our addrtype */
            (void)krb5_ser_pack_int32((krb5_int32)address->addrtype, &bp,
                                      &remain);

            /* Our length */
            (void)krb5_ser_pack_int32((krb5_int32)address->length, &bp,
                                      &remain);

            /* Our contents */
            (void)krb5_ser_pack_bytes(address->contents,
                                      (size_t)address->length, &bp, &remain);
 ...
 */
static krb5_error_code krb5_address_internalize(krb5_context kcontext,
                                                krb5_pointer* argp,
                                                krb5_octet** buffer,
                                                size_t* lenremain)
{
    ...
    if (ibuf == KV5M_ADDRESS)
    {
            ...
            (address = (krb5_address*)calloc(1, sizeof(krb5_address))))
        {
            ...
            if ((address->contents = (krb5_octet*)malloc((size_t)(ibuf))) &&
                !(kret = krb5_ser_unpack_bytes(address->contents, (size_t)ibuf,
                                               &bp, &remain)))
            {
                /* Get the trailer */
 ...
 */
krb5_error_code krb5_ser_address_init(krb5_context kcontext)
{
