...
#pragma warning(disable : 6334)
    ...
    BOOST_STATIC_CONSTANT(bool,
                          value = sizeof(bd_helper<B, D>::check_sig(Host(),
                                                                    0)) ==
...
{
    BOOST_STATIC_CONSTANT(bool,
                          value = (::boost::is_convertible<D*, B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<::boost::is_class<B>::value,
...
struct is_base_and_derived
    : public integral_constant<bool, (::boost::detail::is_base_and_derived_impl<
                                         Base, Derived>::value)>
{
};
