...
struct higher_rank
{
    typedef typename boost::mpl::if_c <
        rank<T0>::value<rank<T1>::value, T1, T0>::type type;
};
...
//////////////////////////////////
template <typename BaseT>
inline typename impl::make_unary<logical_not_op, BaseT>::type operator!(
    actor<BaseT> const& _0)
{
...
template <typename BaseT>
template <typename B>
inline typename impl::make_binary1<assign_op, BaseT, B>::type actor<BaseT>::
...
template <typename BaseT>
template <typename B>
inline typename impl::make_binary1<index_op, BaseT, B>::type actor<BaseT>::
    operator[](B const& _1) const
{
...
struct plus_assign_op
{
    ...
    struct result
    {
        ...
        typedef
            typename binary_operator<plus_assign_op, T0, T1>::result_type type;
    };
...
struct minus_assign_op
{
    ...
    struct result
    {
        ...
        typedef
            typename binary_operator<minus_assign_op, T0, T1>::result_type type;
    };
...
struct times_assign_op
{
    ...
    struct result
    {
        ...
        typedef
            typename binary_operator<times_assign_op, T0, T1>::result_type type;
    };
...
struct divide_assign_op
{
    ...
    struct result
    {
        ...
        typedef typename binary_operator<divide_assign_op, T0, T1>::result_type
            type;
    };
...
struct mod_assign_op
{
    ...
    struct result
    {
        ...
        typedef
            typename binary_operator<mod_assign_op, T0, T1>::result_type type;
    };
...
struct and_assign_op
{
    ...
    struct result
    {
        ...
        typedef
            typename binary_operator<and_assign_op, T0, T1>::result_type type;
    };
...
struct or_assign_op
{
    ...
    struct result
    {
        ...
        typedef
            typename binary_operator<or_assign_op, T0, T1>::result_type type;
    };
...
struct xor_assign_op
{
    ...
    struct result
    {
        ...
        typedef
            typename binary_operator<xor_assign_op, T0, T1>::result_type type;
    };
...
struct shift_l_assign_op
{
    ...
    struct result
    {
        ...
        typedef typename binary_operator<shift_l_assign_op, T0, T1>::result_type
            type;
    };
...
struct shift_r_assign_op
{
    ...
    struct result
    {
        ...
        typedef typename binary_operator<shift_r_assign_op, T0, T1>::result_type
            type;
    };
...
struct logical_and_composite
{
    ...
    struct result
    {
        ...
        typedef typename binary_operator<
            logical_and_op, typename actor_result<A0, TupleT>::plain_type,
            typename actor_result<A1, TupleT>::plain_type>::result_type type;
    };

    logical_and_composite(A0 const& _0, A1 const& _1) : a0(_0), a1(_1)
    {
    }
...
inline actor<logical_and_composite<actor<BaseT>, typename as_actor<T1>::type>>
    operator&&(actor<BaseT> const& _0, T1 CREF _1)
{
    return logical_and_composite<actor<BaseT>, typename as_actor<T1>::type>(
...
inline actor<logical_and_composite<typename as_actor<T0>::type, actor<BaseT>>>
    operator&&(T0 CREF _0, actor<BaseT> const& _1)
{
    return logical_and_composite<typename as_actor<T0>::type, actor<BaseT>>(
...
//////////////////////////////////
template <typename T0, typename T1>
inline actor<logical_and_composite<typename as_actor<T0>::type,
                                   typename as_actor<T1>::type>>
    operator&&(T0 CREF _0, T1 CREF _1)
{
    return logical_and_composite<typename as_actor<T0>::type,
                                 typename as_actor<T1>::type>(
...
struct logical_or_composite
{
    ...
    struct result
    {
        ...
        typedef typename binary_operator<
            logical_or_op, typename actor_result<A0, TupleT>::plain_type,
            typename actor_result<A1, TupleT>::plain_type>::result_type type;
    };

    logical_or_composite(A0 const& _0, A1 const& _1) : a0(_0), a1(_1)
    {
    }
...
inline actor<logical_or_composite<actor<BaseT>, typename as_actor<T1>::type>>
    operator||(actor<BaseT> const& _0, T1 CREF _1)
{
    return logical_or_composite<actor<BaseT>, typename as_actor<T1>::type>(
        _0, as_actor<T1>::convert(_1));
}
...
inline actor<logical_or_composite<typename as_actor<T0>::type, actor<BaseT>>>
    operator||(T0 CREF _0, actor<BaseT> const& _1)
{
    return logical_or_composite<typename as_actor<T0>::type, actor<BaseT>>(
        as_actor<T0>::convert(_0), _1);
}
