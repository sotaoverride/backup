...
_public_ int sd_uid_get_sessions(uid_t uid, int require_active,
                                 char*** sessions)
{
...
static int session_get_string(const char* session, const char* field,
                              char** value)
{
    _cleanup_free_ char *p = NULL, *s = NULL;
    int r;
...
_public_ int sd_seat_get_sessions(const char* seat, char*** sessions,
...
_public_ int sd_login_monitor_get_timeout(sd_login_monitor* m,
