...
GLIB_AVAILABLE_IN_ALL GType g_data_stream_byte_order_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_DATA_STREAM_BYTE_ORDER (g_data_stream_byte_order_get_type())
GLIB_AVAILABLE_IN_ALL GType g_data_stream_newline_type_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_file_attribute_info_flags_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_filesystem_preview_type_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_mount_operation_result_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_MOUNT_OPERATION_RESULT (g_mount_operation_result_get_type())
GLIB_AVAILABLE_IN_ALL GType g_output_stream_splice_flags_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_OUTPUT_STREAM_SPLICE_FLAGS                                      \
    (g_output_stream_splice_flags_get_type())
GLIB_AVAILABLE_IN_ALL GType g_io_stream_splice_flags_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_zlib_compressor_format_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_ZLIB_COMPRESSOR_FORMAT (g_zlib_compressor_format_get_type())
GLIB_AVAILABLE_IN_ALL GType g_unix_socket_address_type_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_bus_name_watcher_flags_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_dbus_message_header_field_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_DBUS_MESSAGE_HEADER_FIELD                                       \
    (g_dbus_message_header_field_get_type())
GLIB_AVAILABLE_IN_ALL GType g_dbus_property_info_flags_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_dbus_send_message_flags_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_dbus_message_byte_order_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_tls_authentication_mode_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_tls_interaction_result_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_TLS_INTERACTION_RESULT (g_tls_interaction_result_get_type())
GLIB_AVAILABLE_IN_ALL GType g_dbus_interface_skeleton_flags_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_DBUS_INTERFACE_SKELETON_FLAGS                                   \
    (g_dbus_interface_skeleton_flags_get_type())
GLIB_AVAILABLE_IN_ALL GType g_dbus_object_manager_client_flags_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_DBUS_OBJECT_MANAGER_CLIENT_FLAGS                                \
    (g_dbus_object_manager_client_flags_get_type())
GLIB_AVAILABLE_IN_ALL GType g_tls_database_verify_flags_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_TLS_DATABASE_VERIFY_FLAGS                                       \
    (g_tls_database_verify_flags_get_type())
GLIB_AVAILABLE_IN_ALL GType g_tls_database_lookup_flags_get_type(void)
    G_GNUC_CONST;
#define G_TYPE_TLS_DATABASE_LOOKUP_FLAGS                                       \
    (g_tls_database_lookup_flags_get_type())
GLIB_AVAILABLE_IN_ALL GType g_tls_certificate_request_flags_get_type(void)
    G_GNUC_CONST;
...
GLIB_AVAILABLE_IN_ALL GType g_resolver_name_lookup_flags_get_type(void)
    G_GNUC_CONST;
