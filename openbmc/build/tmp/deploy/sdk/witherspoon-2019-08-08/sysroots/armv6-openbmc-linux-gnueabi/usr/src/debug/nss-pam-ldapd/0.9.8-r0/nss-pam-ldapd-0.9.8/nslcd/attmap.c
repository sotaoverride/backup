...
const char** attmap_get_var(enum ldap_map_selector map, const char* name)
{
    if (map == LM_ALIASES)
    {
        ...
        if (strcasecmp(name, "rfc822MailMember") == 0)
    ...
    else if (map == LM_ETHERS)
    {
        ...
        if (strcasecmp(name, "macAddress") == 0)
    ...
    else if (map == LM_HOSTS)
    {
        ...
        if (strcasecmp(name, "ipHostNumber") == 0)
    ...
    else if (map == LM_NETGROUP)
    {
        ...
        if (strcasecmp(name, "nisNetgroupTriple") == 0)
            return &attmap_netgroup_nisNetgroupTriple;
        if (strcasecmp(name, "memberNisNetgroup") == 0)
    ...
    else if (map == LM_NETWORKS)
    {
        ...
        if (strcasecmp(name, "ipNetworkNumber") == 0)
    ...
    else if (map == LM_PASSWD)
    {
        ...
        if (strcasecmp(name, "uidNumber") == 0)
            return &attmap_passwd_uidNumber;
        if (strcasecmp(name, "gidNumber") == 0)
            return &attmap_passwd_gidNumber;
        if (strcasecmp(name, "gecos") == 0)
            return &attmap_passwd_gecos;
        if (strcasecmp(name, "homeDirectory") == 0)
            return &attmap_passwd_homeDirectory;
        if (strcasecmp(name, "loginShell") == 0)
    ...
    else if (map == LM_PROTOCOLS)
    {
        ...
        if (strcasecmp(name, "ipProtocolNumber") == 0)
    ...
    else if (map == LM_RPC)
    {
        ...
        if (strcasecmp(name, "oncRpcNumber") == 0)
    ...
    else if (map == LM_SERVICES)
    {
        ...
        if (strcasecmp(name, "ipServicePort") == 0)
            return &attmap_service_ipServicePort;
        if (strcasecmp(name, "ipServiceProtocol") == 0)
    ...
    else if (map == LM_SHADOW)
    {
        ...
        if (strcasecmp(name, "shadowLastChange") == 0)
            return &attmap_shadow_shadowLastChange;
        if (strcasecmp(name, "shadowMin") == 0)
            return &attmap_shadow_shadowMin;
        if (strcasecmp(name, "shadowMax") == 0)
            return &attmap_shadow_shadowMax;
        if (strcasecmp(name, "shadowWarning") == 0)
            return &attmap_shadow_shadowWarning;
        if (strcasecmp(name, "shadowInactive") == 0)
            return &attmap_shadow_shadowInactive;
        if (strcasecmp(name, "shadowExpire") == 0)
            return &attmap_shadow_shadowExpire;
        if (strcasecmp(name, "shadowFlag") == 0)
                             ...
                             char* buffer, size_t buflen)
{
    ...
    if (attr[0] != '"')
    {
        ...
        {
            log_log(LOG_ERR,
                    "attmap_get_value(): buffer too small (%lu required)",
