...
class closure_member
{
  ...
  public:
    ...
    closure_member() : frame(ClosureT::closure_frame_holder_ref())
    {
    }
    ...
    struct result
    {
        ...
        typedef
            typename tuple_element<N, typename ClosureT::tuple_t>::rtype type;
    };
...
#if PHOENIX_LIMIT > 3
          ,
          typename T3 = nil_t, typename T4 = nil_t, typename T5 = nil_t

#if PHOENIX_LIMIT > 6
          ,
          typename T6 = nil_t, typename T7 = nil_t, typename T8 = nil_t

#if PHOENIX_LIMIT > 9
          ,
          typename T9 = nil_t, typename T10 = nil_t, typename T11 = nil_t

#if PHOENIX_LIMIT > 12
          ,
          typename T12 = nil_t, typename T13 = nil_t, typename T14 = nil_t
...
class closure
{
  ...
  private:
    ...
    static void tsp_frame_instance_init()
    {
        tsp_frame_instance();
    }
#endif
