...
int snmpNotifyFilterProfileTable_add(struct snmpNotifyFilterProfileTable_data*);
...
void snmpNotifyFilterProfileTable_free(
    struct snmpNotifyFilterProfileTable_data*);

int snmpNotifyFilterProfileTable_remove(
    struct snmpNotifyFilterProfileTable_data*);

struct snmpNotifyFilterProfileTable_data* snmpNotifyFilterProfileTable_extract(
    struct snmpNotifyFilterProfileTable_data*);

struct snmpNotifyFilterProfileTable_data*
    snmpNotifyFilterProfileTable_oldapi_find(struct variable* vp, oid* name,
