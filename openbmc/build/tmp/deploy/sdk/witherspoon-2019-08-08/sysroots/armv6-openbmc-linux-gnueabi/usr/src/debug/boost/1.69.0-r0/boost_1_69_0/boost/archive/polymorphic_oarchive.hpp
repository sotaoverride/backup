    ...
    : public detail::interface_oarchive<polymorphic_oarchive>
{
  ...
  public:
    ...
    virtual void
        register_basic_serializer(const detail::basic_oserializer& bos) = 0;
  ...
  public:
    ...
    virtual void save_object(const void* x,
                             const detail::basic_oserializer& bos) = 0;
    virtual void
        save_pointer(const void* t,
                     const detail::basic_pointer_oserializer* bpos_ptr) = 0;
};
