...
class ChassisCapabilities
{
  public:
    ...
    virtual uint8_t capabilitiesFlags(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t fRUDeviceAddress(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t sDRDeviceAddress(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t sELDeviceAddress(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t sMDeviceAddress(uint8_t value, bool skipSignal);
    ...
    virtual uint8_t bridgeDeviceAddress(uint8_t value, bool skipSignal);
  ...
  private:
    ...
    static int _callback_get_CapabilitiesFlags(sd_bus*, const char*,
                                               const char*, const char*,
                                               sd_bus_message*, void*,
                                               sd_bus_error*);
    /** @brief sd-bus callback for set-property 'CapabilitiesFlags' */
    static int _callback_set_CapabilitiesFlags(sd_bus*, const char*,
                                               const char*, const char*,
                                               sd_bus_message*, void*,
                                               sd_bus_error*);

    /** @brief sd-bus callback for get-property 'FRUDeviceAddress' */
    static int _callback_get_FRUDeviceAddress(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'FRUDeviceAddress' */
    static int _callback_set_FRUDeviceAddress(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'SDRDeviceAddress' */
    static int _callback_get_SDRDeviceAddress(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'SDRDeviceAddress' */
    static int _callback_set_SDRDeviceAddress(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'SELDeviceAddress' */
    static int _callback_get_SELDeviceAddress(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'SELDeviceAddress' */
    static int _callback_set_SELDeviceAddress(sd_bus*, const char*, const char*,
                                              const char*, sd_bus_message*,
                                              void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'SMDeviceAddress' */
    static int _callback_get_SMDeviceAddress(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);
    /** @brief sd-bus callback for set-property 'SMDeviceAddress' */
    static int _callback_set_SMDeviceAddress(sd_bus*, const char*, const char*,
                                             const char*, sd_bus_message*,
                                             void*, sd_bus_error*);

    /** @brief sd-bus callback for get-property 'BridgeDeviceAddress' */
    static int _callback_get_BridgeDeviceAddress(sd_bus*, const char*,
                                                 const char*, const char*,
                                                 sd_bus_message*, void*,
                                                 sd_bus_error*);
    /** @brief sd-bus callback for set-property 'BridgeDeviceAddress' */
    static int _callback_set_BridgeDeviceAddress(sd_bus*, const char*,
                                                 const char*, const char*,
                                                 sd_bus_message*, void*,
                                                 sd_bus_error*);
    ...
    sdbusplus::server::interface::
        interface _xyz_openbmc_project_Control_ChassisCapabilities_interface;
