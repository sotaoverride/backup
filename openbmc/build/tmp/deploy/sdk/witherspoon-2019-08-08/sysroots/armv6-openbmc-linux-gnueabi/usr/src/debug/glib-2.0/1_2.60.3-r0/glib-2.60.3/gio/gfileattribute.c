...
void _g_file_attribute_value_clear(GFileAttributeValue* attr)
{
    ...
    if (attr->type == G_FILE_ATTRIBUTE_TYPE_OBJECT && attr->u.obj != NULL)
...
char* _g_file_attribute_value_as_string(const GFileAttributeValue* attr)
{
    ...
    switch (attr->type)
    {
        ...
        case G_FILE_ATTRIBUTE_TYPE_OBJECT:
            str = g_strdup_printf(
                "%s:%p", g_type_name_from_instance((GTypeInstance*)attr->u.obj),
                attr->u.obj);
            break;
...
void _g_file_attribute_value_set_from_pointer(GFileAttributeValue* value,
                                              GFileAttributeType type,
                                              gpointer value_p, gboolean dup)
{
...
static int g_file_attribute_info_list_bsearch(GFileAttributeInfoList* list,
                                              const char* name)
{
    int start, end, mid;
...
void g_file_attribute_info_list_add(GFileAttributeInfoList* list,
                                    const char* name, GFileAttributeType type,
