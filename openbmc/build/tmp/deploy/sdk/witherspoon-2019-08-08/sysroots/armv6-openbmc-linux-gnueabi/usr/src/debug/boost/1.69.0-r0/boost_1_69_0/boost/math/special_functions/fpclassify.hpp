...
/*!
  \file fpclassify.hpp
  \brief Classify floating-point value as normal, subnormal, zero, infinite, or
  NaN. \version 1.0 \author John Maddock
 */
...
#ifdef isnan
    return isnan(t);
#elif defined(BOOST_MATH_DISABLE_STD_FPCLASSIFY) ||                            \
...
inline bool is_nan_helper(__float128 f, const boost::true_type&)
{
    return std::isnan(static_cast<double>(f));
}
inline bool is_nan_helper(__float128 f, const boost::false_type&)
{
    return std::isnan(static_cast<double>(f));
...
int fpclassify_imp BOOST_NO_MACRO_EXPAND(T x, ieee_copy_all_bits_tag)
{
    ...
    BOOST_MATH_INSTRUMENT_VARIABLE(
        (traits::exponent | traits::flag | traits::significand));
    BOOST_MATH_INSTRUMENT_VARIABLE(a);
...
int fpclassify_imp BOOST_NO_MACRO_EXPAND(T x, ieee_copy_leading_bits_tag)
{
    ...
    (defined(BOOST_MATH_NO_NATIVE_LONG_DOUBLE_FP_CLASSIFY) ||                  \
     defined(BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS))
inline int fpclassify_imp BOOST_NO_MACRO_EXPAND(long double t,
                                                const native_tag&)
{
...
inline int fpclassify BOOST_NO_MACRO_EXPAND(T t)
{
    ...
    if (std::numeric_limits<T>::is_specialized &&
        ...
        return detail::fpclassify_imp(static_cast<value_type>(t),
                                      detail::generic_tag<true>());
...
#ifdef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
    if (std::numeric_limits<long double>::is_specialized &&
        detail::is_generic_tag_false(static_cast<method*>(0)))
        return detail::fpclassify_imp(static_cast<value_type>(t),
                                      detail::generic_tag<true>());
    return detail::fpclassify_imp(static_cast<value_type>(t), method());
...
#if defined(BOOST_MATH_USE_STD_FPCLASSIFY) &&                                  \
    defined(BOOST_MATH_NO_NATIVE_LONG_DOUBLE_FP_CLASSIFY)
inline bool isfinite_impl BOOST_NO_MACRO_EXPAND(long double t,
                                                const native_tag&)
{
...
#if defined(BOOST_MATH_USE_STD_FPCLASSIFY) &&                                  \
    defined(BOOST_MATH_NO_NATIVE_LONG_DOUBLE_FP_CLASSIFY)
inline bool isnormal_impl BOOST_NO_MACRO_EXPAND(long double t,
                                                const native_tag&)
{
...
{
    (void)x; // in case the compiler thinks that x is unused because
             // std::numeric_limits<T>::has_infinity is false
...
#ifdef isnan
template <>
inline bool isnan BOOST_NO_MACRO_EXPAND<float>(float t)
{
    return ::boost::math_detail::is_nan_helper(t, boost::true_type());
}
template <>
inline bool isnan BOOST_NO_MACRO_EXPAND<double>(double t)
{
    return ::boost::math_detail::is_nan_helper(t, boost::true_type());
}
template <>
inline bool isnan BOOST_NO_MACRO_EXPAND<long double>(long double t)
{
    return ::boost::math_detail::is_nan_helper(t, boost::true_type());
}
